...
function calculateNodeStyling(node: HTMLTextAreaElement, useCache = false): NodeType {
...
export function calculateAutoSizeStyle(
  ...
  // Copy all CSS properties that have an impact on the height of the content
