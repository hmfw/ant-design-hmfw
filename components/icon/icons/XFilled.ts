...
export const XFilled: IconComponent = () =>
  h(
    ...
    [
      ...
      h('path', { d: 'M628 623H484.942L174 179h143.058zm-126.012-37.651h56.96L300.013 216.65h-56.96z', fill: '#FFF' }),
      h('path', { d: 'M219.296885 623 379 437.732409 358.114212 410 174 623z', fill: '#FFF' }),
      h('path', { d: 'M409 348.387347 429.212986 377 603 177 558.330417 177z', fill: '#FFF' }),
    ],
  )
