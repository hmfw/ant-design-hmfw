...
import {
  ...
  GlobalOutlined, LoginOutlined, LogoutOutlined,
  ArrowUpOutlined, ArrowDownOutlined, ArrowLeftOutlined, ArrowRightOutlined,
  CaretUpOutlined, CaretDownOutlined, DoubleLeftOutlined, DoubleRightOutlined,
  CopyOutlined, ReloadOutlined, SyncOutlined, SaveOutlined, FilterOutlined,
  MenuOutlined, BarsOutlined, EllipsisOutlined,
  PictureOutlined, VideoCameraOutlined, MessageOutlined, CloudOutlined,
