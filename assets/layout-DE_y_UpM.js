import{H as m,C as b,F as k,a as s,S as h}from"./Layout-BRaF1WSk.js";import{d as x,o as g,q as v,w as d,c as o,e as n,g as r,f as t,A as f,r as y,b as C,h as S,i as w}from"./index-ChNLT6yU.js";import{B as L}from"./Button-fvFGDJsA.js";import"./MinusOutlined-DQbwYWxZ.js";import"./LeftOutlined-B8qsfH7K.js";import"./RightOutlined-BrNXSM37.js";import"./cls-S9IiI6wd.js";import"./LoadingOutlined-BhI5fn5Z.js";const B=x({__name:"LayoutBasic",setup(c){return(a,l)=>(g(),v(n(s),{style:{"min-height":"200px"}},{default:d(()=>[o(n(m),{style:{background:"#001529",color:"#fff",padding:"0 24px","line-height":"64px"}},{default:d(()=>[...l[0]||(l[0]=[r(" Header ",-1)])]),_:1}),o(n(b),{style:{padding:"24px",background:"#fff"}},{default:d(()=>[...l[1]||(l[1]=[r(" Content ",-1)])]),_:1}),o(n(k),{style:{"text-align":"center",background:"#f5f5f5"}},{default:d(()=>[...l[2]||(l[2]=[r(" Footer ©2026 Created by hmfw ",-1)])]),_:1})]),_:1}))}}),H=`<template>
...
<\/script>
`,T={style:{color:"#fff",padding:"16px","text-align":"center"}},_=x({__name:"LayoutCollapsible",setup(c){const a=y(!1),l=y("clickTrigger"),p=(e,i)=>{l.value=i,console.log("Collapsed:",e,"Type:",i)};return(e,i)=>(g(),v(n(s),{style:{"min-height":"400px"}},{default:d(()=>[o(n(h),{collapsed:a.value,"onUpdate:collapsed":i[0]||(i[0]=u=>a.value=u),collapsible:"",width:200,"collapsed-width":80,style:{background:"#001529"},onCollapse:p},{default:d(()=>[t("div",T,f(a.value?"Menu":"Navigation Menu"),1)]),_:1},8,["collapsed"]),o(n(s),null,{default:d(()=>[o(n(m),{style:{background:"#fff",padding:"0 24px","border-bottom":"1px solid #f0f0f0","line-height":"64px"}},{default:d(()=>[...i[1]||(i[1]=[r(" Header ",-1)])]),_:1}),o(n(b),{style:{padding:"24px",background:"#f5f5f5"}},{default:d(()=>[t("p",null,"Current state: "+f(a.value?"Collapsed":"Expanded"),1),t("p",null,"Collapse type: "+f(l.value),1)]),_:1})]),_:1})]),_:1}))}}),F=`<template>
...
<\/script>
`,R=x({__name:"LayoutSider",setup(c){return(a,l)=>(g(),v(n(s),{style:{"min-height":"300px"}},{default:d(()=>[o(n(m),{style:{background:"#001529",color:"#fff",padding:"0 24px","line-height":"64px"}},{default:d(()=>[...l[0]||(l[0]=[r(" Header ",-1)])]),_:1}),o(n(s),null,{default:d(()=>[o(n(h),{width:200,style:{background:"#fff","border-right":"1px solid #f0f0f0"}},{default:d(()=>[...l[1]||(l[1]=[t("div",{style:{padding:"16px"}},"Sider",-1)])]),_:1}),o(n(b),{style:{padding:"24px",background:"#f5f5f5"}},{default:d(()=>[...l[2]||(l[2]=[r(" Content ",-1)])]),_:1})]),_:1}),o(n(k),{style:{"text-align":"center",background:"#f5f5f5"}},{default:d(()=>[...l[3]||(l[3]=[r(" Footer ©2024 ",-1)])]),_:1})]),_:1}))}}),P=`<template>
...
<\/script>
`,V={style:{"margin-bottom":"16px"}},D=x({__name:"LayoutTheme",setup(c){const a=y("dark"),l=()=>{a.value=a.value==="dark"?"light":"dark"};return(p,e)=>(g(),C("div",null,[t("div",V,[o(n(L),{style:{padding:"8px 16px",cursor:"pointer",border:"1px solid #d9d9d9","border-radius":"4px",background:"#fff"},onClick:l},{default:d(()=>[r(" 切换主题 (当前: "+f(a.value==="dark"?"暗色":"亮色")+") ",1)]),_:1})]),o(n(s),{style:{"min-height":"400px"}},{default:d(()=>[o(n(h),{theme:a.value,collapsible:""},{default:d(()=>[...e[0]||(e[0]=[t("div",{style:{padding:"16px",color:"inherit"}},[t("div",{style:{"margin-bottom":"12px"}},"菜单项 1"),t("div",{style:{"margin-bottom":"12px"}},"菜单项 2"),t("div",{style:{"margin-bottom":"12px"}},"菜单项 3"),t("div",{style:{"margin-bottom":"12px"}},"菜单项 4")],-1)])]),_:1},8,["theme"]),o(n(s),null,{default:d(()=>[o(n(m),{style:{background:"#fff",padding:"0 24px","line-height":"64px","box-shadow":"0 1px 4px rgba(0, 21, 41, 0.08)"}},{default:d(()=>[...e[1]||(e[1]=[t("h2",{style:{margin:"0",color:"#000"}},"主题切换演示",-1)])]),_:1}),o(n(b),{style:{margin:"24px 16px",padding:"24px",background:"#fff"}},{default:d(()=>[...e[2]||(e[2]=[t("p",null,"侧边栏支持 light 和 dark 两种主题。",-1),t("p",null,"主题切换时，背景色、文字颜色和边框颜色会平滑过渡（0.3s），提供流畅的视觉体验。",-1),t("p",null,"宽度变化保持快速响应（0.2s），确保交互的即时反馈。",-1)])]),_:1})]),_:1})]),_:1})]))}}),E=`<template>
  <div>
