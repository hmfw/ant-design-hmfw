import{M as u}from"./index-DcFMBeGb.js";import{n as v,z as m,j as g,F as C,g as e,m as n,J as a,Q as l,D as k,l as s,_ as h,I as B,o as x,G as w,k as M}from"./index-BIkAb7lZ.js";import{B as f}from"./Button-DijKNe_E.js";import"./icons-DLCoPw-s.js";import"./index-DP3NiL_9.js";import"./cls-S9IiI6wd.js";import"./Icon-DOjVoSFw.js";const N=v({__name:"ModalBasic",setup(b){const o=k(!1);function c(){console.log("确认"),o.value=!1}function r(){console.log("取消"),o.value=!1}return(t,d)=>(m(),g(C,null,[e("button",{onClick:d[0]||(d[0]=i=>o.value=!0)},"打开对话框"),n(a(u),{open:o.value,"onUpdate:open":d[1]||(d[1]=i=>o.value=i),title:"基础对话框",onOk:c,onCancel:r},{default:l(()=>[...d[2]||(d[2]=[e("p",null,"对话框内容",-1),e("p",null,"对话框内容",-1),e("p",null,"对话框内容",-1)])]),_:1},8,["open"])],64))}}),O=`<template>
