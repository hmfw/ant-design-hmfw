import{S as h}from"./Space-CWm16sbO.js";import{P as c}from"./Pagination-DeRA1UMG.js";import{k as b,w as m,e as S,M as s,j as r,G as d,d as e,E as v,z as p,B as w,g as P,i as f,h as x}from"./index-BNHhPN23.js";import"./cls-S9IiI6wd.js";const k=b({__name:"PaginationBasic",setup(g){const n=p(1);return(l,o)=>(m(),S(d(h),{direction:"vertical"},{default:s(()=>[r(d(c),{total:50,current:n.value,"onUpdate:current":o[0]||(o[0]=t=>n.value=t)},null,8,["current"]),e("p",null,"当前页："+v(n.value),1)]),_:1}))}}),C=`<template>
