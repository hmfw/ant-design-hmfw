...
<\/script>
`,U={style:{display:"flex","flex-direction":"column",gap:"16px"}},B={style:{display:"flex",gap:"8px"}},E={style:{display:"flex","align-items":"center",gap:"8px"}},F=f({__name:"SwitchLoading",setup(u){const c=s(!1),l=s(!1),a=e=>{l.value=!0,setTimeout(()=>{l.value=!1,c.value=e},1500)};return(e,d)=>(h(),p("div",U,[t("div",B,[n(o(i),{checked:!0,loading:""}),n(o(i),{checked:!1,loading:""})]),t("div",E,[n(o(i),{checked:c.value,"onUpdate:checked":d[0]||(d[0]=r=>c.value=r),loading:l.value,onChange:a},null,8,["checked","loading"]),t("span",null,v(l.value?"切换中...":c.value?"已开启":"已关闭"),1)])]))}}),z=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px">
...
<\/script>
`,V={style:{display:"flex","flex-direction":"column",gap:"16px"}},L={style:{display:"flex","align-items":"center",gap:"16px"}},O={style:{display:"flex","align-items":"center",gap:"16px"}},D=f({__name:"SwitchSize",setup(u){const c=s(!0),l=s(!0);return(a,e)=>(h(),p("div",V,[t("div",L,[n(o(i),{checked:c.value,"onUpdate:checked":e[0]||(e[0]=d=>c.value=d)},null,8,["checked"]),e[2]||(e[2]=t("span",null,"默认大小",-1))]),t("div",O,[n(o(i),{checked:l.value,"onUpdate:checked":e[1]||(e[1]=d=>l.value=d),size:"small"},null,8,["checked"]),e[3]||(e[3]=t("span",null,"小号开关",-1))])]))}}),T=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px">
