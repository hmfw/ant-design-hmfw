...
`,rt={class:"float-btn-showcase"},ut=B({__name:"FloatButtonBadge",setup(t){const o={position:"static"};return(a,c)=>(F(),x("div",rt,[e(d(s),{badge:{count:5},icon:d(G),style:o},null,8,["icon"]),e(d(s),{badge:{count:128,overflowCount:99},icon:d(G),style:o},null,8,["icon"]),e(d(s),{badge:{dot:!0},icon:d(G),style:o},null,8,["icon"])]))}}),pt=O(ut,[["__scopeId","data-v-e2adcfa0"]]),gt=`<template>
...
`,Ft={class:"float-btn-demo"},xt=B({__name:"FloatButtonMenu",setup(t){const o={position:"absolute",insetInlineEnd:"120px",insetBlockEnd:"24px"},a={position:"absolute",insetInlineEnd:"24px",insetBlockEnd:"24px"};return(c,n)=>(F(),x("div",Ft,[e(d(I),{trigger:"click",type:"primary",icon:d(S),style:o},{default:v(()=>[e(d(s),{icon:d(M),tooltip:"编辑"},null,8,["icon"]),e(d(s),{icon:d(z),tooltip:"搜索"},null,8,["icon"])]),_:1},8,["icon"]),e(d(I),{trigger:"hover",style:a},{default:v(()=>[e(d(s),{icon:d(M),tooltip:"编辑"},null,8,["icon"]),e(d(s),{icon:d(V),tooltip:"删除"},null,8,["icon"])]),_:1})]))}}),_t=O(xt,[["__scopeId","data-v-9b1f4366"]]),wt=`<template>
  <div class="float-btn-demo">
