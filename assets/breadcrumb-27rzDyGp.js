import{D as z}from"./index-DZWe05Ol.js";import{o as k,O as K,n as o,F as U,s as I,p as O,r as X,A as f,i as B,L as l,k as V,h as s,_ as Q,K as Y,E as G,Q as m,H as J,m as c,l as Z}from"./index-ON6sqzpw.js";import{c as u}from"./cls-S9IiI6wd.js";import{D as tt}from"./DownOutlined-DckNvu8B.js";import{U as nt}from"./UserOutlined-CYnbLvXf.js";import{H as st}from"./HomeOutlined-CErcvxgL.js";import{S as et}from"./Space-DdHciXh1.js";import"./index-B8tuWzqi.js";import"./Layout-caFWR768.js";import"./MinusOutlined-WasF2EeI.js";import"./LeftOutlined-DkTZZ6d4.js";import"./RightOutlined-CUOf38hr.js";import"./event-CMqgYmge.js";import"./Trigger-DNeGWijK.js";import"./Tooltip-IZkyL-qe.js";import"./Button-BjmJBmDE.js";import"./LoadingOutlined-CiFLsQlT.js";function at(n){return typeof n=="function"||Object.prototype.toString.call(n)==="[object Object]"&&!X(n)}const ot=(n,e)=>{if(e===void 0)return e;let a=(e||"").replace(/^\//,"");return Object.keys(n).forEach(r=>{a=a.replace(`:${r}`,n[r])}),a},rt=(n,e)=>{const{title:a}=n;if(a==null)return null;if(typeof a=="string"){const r=Object.keys(e).join("|");return a.replace(new RegExp(`:(${r})`,"g"),(t,p)=>e[p]||t)}return a},lt=n=>{const e={};return Object.keys(n).forEach(a=>{(a.startsWith("data-")||a.startsWith("aria-"))&&(e[a]=n[a])}),e},pt=(n,e)=>{const{items:a,...r}=n;return{...r,items:a==null?void 0:a.map(({key:t,title:p,label:b,path:x,...g},w)=>{let h=b??p;return x&&(h=O("a",{href:`${e??""}${x}`},h)),{...g,key:String(t??w),label:h}})}},i=k({name:"Breadcrumb",props:{items:Array,separator:{type:[String,Object],default:"/"},params:{type:Object,default:()=>({})},dropdownIcon:Object,itemRender:Function,classNames:Object,styles:Object},setup(n){const e=K("breadcrumb"),a=(r,t,p)=>{var y,E,L,j,A,q,D,$,N,T,P,S;if(t==null)return null;const{className:b,onClick:x,menu:g,dropdownProps:w,...h}=r,d={...lt(h),onClick:x},v=n.dropdownIcon??o(tt,{class:"hmfw-icon"},null);if(g&&g.items&&g.items.length>0){const R=pt(g,p),_=p!==void 0?o("a",I(d,{class:u(`${e}-link`,(y=n.classNames)==null?void 0:y.link,b),style:{...(E=n.styles)==null?void 0:E.link,...r.style},href:p}),[o("span",{class:u(`${e}-overlay-link`,(L=n.classNames)==null?void 0:L.overlayLink),style:(j=n.styles)==null?void 0:j.overlayLink},[t,v])]):o("span",I(d,{class:u(`${e}-link`,(A=n.classNames)==null?void 0:A.link,b),style:{...(q=n.styles)==null?void 0:q.link,...r.style}}),[o("span",{class:u(`${e}-overlay-link`,(D=n.classNames)==null?void 0:D.overlayLink),style:($=n.styles)==null?void 0:$.overlayLink},[t,v])]);return o(z,I({menu:R,trigger:["hover"]},w),at(_)?_:{default:()=>[_]})}return p!==void 0?o("a",I(d,{class:u(`${e}-link`,(N=n.classNames)==null?void 0:N.link,b),style:{...(T=n.styles)==null?void 0:T.link,...r.style},href:p}),[t]):o("span",I(d,{class:u(`${e}-link`,(P=n.classNames)==null?void 0:P.link,b),style:{...(S=n.styles)==null?void 0:S.link,...r.style}}),[t])};return()=>{var x,g,w,h;const r=n.items??[],t=[],p=r.filter(d=>!("type"in d&&d.type==="separator")),b=r.map((d,v)=>{var R,_,F,H,M,W;if("type"in d&&d.type==="separator"){const C=d;return o("li",{key:C.key??`separator-${v}`,class:u(`${e}-separator`,(R=n.classNames)==null?void 0:R.separator),style:(_=n.styles)==null?void 0:_.separator,"aria-hidden":"true"},[C.separator===""?C.separator:C.separator||n.separator])}const y=d,{path:E,key:L,className:j,style:A}=y,q=ot(n.params,E);q!==void 0&&t.push(q);const D=L??v,$=v===r.length-1,N=r[v+1],T=N&&"type"in N&&N.type==="separator";let{href:P}=y;t.length&&q!==void 0&&(P=`#/${t.join("/")}`);let S;if(n.itemRender)S=n.itemRender(y,n.params,p,[...t]);else{const C=rt(y,n.params);S=a(y,C,P)}return o(U,null,[o("li",{key:D,class:u(`${e}-item`,(F=n.classNames)==null?void 0:F.item,j),style:{...(H=n.styles)==null?void 0:H.item,...A},"aria-current":$?"page":void 0},[S]),!$&&!T&&o("li",{class:u(`${e}-separator`,(M=n.classNames)==null?void 0:M.separator),style:(W=n.styles)==null?void 0:W.separator,"aria-hidden":"true"},[n.separator])])});return o("nav",{class:u(e,(x=n.classNames)==null?void 0:x.root),style:(g=n.styles)==null?void 0:g.root,"aria-label":"breadcrumb"},[o("ol",{class:(w=n.classNames)==null?void 0:w.list,style:(h=n.styles)==null?void 0:h.list},[b])])}}}),ct=k({__name:"BreadcrumbBasic",setup(n){const e=[{title:"首页"},{title:"应用列表"},{title:"某应用"}];return(a,r)=>(f(),B(l(i),{items:e}))}}),it=`<template>
...
`,ft={style:{"margin-top":"8px",color:"#666"}},gt=k({__name:"BreadcrumbClick",setup(n){const e=G("无"),a=[{title:"首页",onClick:()=>{e.value="首页"}},{title:"应用列表",onClick:()=>{e.value="应用列表"}},{title:"某应用"}];return(r,t)=>(f(),V(U,null,[o(l(i),{items:a}),s("p",ft,"点击了："+Y(e.value),1)],64))}}),bt=`<template>
  <Breadcrumb :items="items" />
...
<\/script>
`,ht=k({__name:"BreadcrumbIcon",setup(n){const e=[{title:O(st,{class:"hmfw-icon"}),href:"/"},{title:O("span",{},[O(nt,{class:"hmfw-icon"}),O("span",{style:{marginLeft:"4px"}},"用户列表")]),href:"/users"},{title:"用户详情"}];return(a,r)=>(f(),B(l(i),{items:e}))}}),yt=`<template>
  <Breadcrumb :items="items" />
</template>
...
<\/script>
`,xt=k({__name:"BreadcrumbLink",setup(n){const e=[{title:"首页",href:"/"},{title:"应用列表",href:"/apps"},{title:"某应用"}];return(a,r)=>(f(),B(l(i),{items:e}))}}),vt=`<template>
  <Breadcrumb :items="items" />
</template>
...
<\/script>
`,Bt=k({__name:"BreadcrumbParams",setup(n){const e={id:"123"},a=[{title:"用户管理",href:"/users"},{title:"用户 :id"}];return(r,t)=>(f(),B(l(i),{items:a,params:e}))}}),wt=`<template>
...
<\/script>
`,qt=k({__name:"BreadcrumbPath",setup(n){const e=[{path:"home",title:"首页"},{path:"user",title:"用户"},{path:"profile",title:"个人资料"}];return(a,r)=>(f(),B(l(i),{items:e}))}}),Nt=`<template>
  <Breadcrumb :items="items" />
</template>
...
<\/script>
`,St=k({__name:"BreadcrumbSeparator",setup(n){const e=[{title:"首页",href:"/"},{title:"一级菜单",href:"/level1"},{title:"二级菜单"}];return(a,r)=>(f(),B(l(et),{direction:"vertical"},{default:m(()=>[o(l(i),{items:e,separator:">"}),o(l(i),{items:e,separator:"/"}),o(l(i),{items:e,separator:"|"})]),_:1}))}}),_t=`<template>
...
<\/script>
`,Ct=k({__name:"BreadcrumbSeparatorType",setup(n){const e=[{title:"位置"},{type:"separator",separator:":"},{title:"应用中心",href:"/app"},{type:"separator"},{title:"应用列表",href:"/app/list"},{type:"separator"},{title:"某应用"}];return(a,r)=>(f(),B(l(i),{items:e,separator:""}))}}),$t=`<template>
  <Breadcrumb :items="items" separator="" />
</template>
