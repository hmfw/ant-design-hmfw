import{o as O,N as gn,M as vn,E as v,Q as yn,x as hn,y as fn,n as s,m as i,T as bn,F as wn,f as y,t as xn,A as H,k as I,K as g,h as r,J as Z,_ as Dn,H as Sn,R as j,l as Cn}from"./index-DVYL9B-3.js";import{c}from"./cls-S9IiI6wd.js";function _(a){return String(a).padStart(2,"0")}function la(a,o="YYYY-MM-DD"){return o.replace("YYYY",String(a.getFullYear())).replace("MM",_(a.getMonth()+1)).replace("DD",_(a.getDate())).replace("HH",_(a.getHours())).replace("mm",_(a.getMinutes())).replace("ss",_(a.getSeconds()))}function z(a){if(!a)return null;const o=new Date(a);return isNaN(o.getTime())?null:o}function Va(a,o){return a.getFullYear()===o.getFullYear()&&a.getMonth()===o.getMonth()&&a.getDate()===o.getDate()}function qn(a,o){return a.getFullYear()===o.getFullYear()&&a.getMonth()===o.getMonth()}function Pn(a,o){return a.getFullYear()===o.getFullYear()}function Ua(a,o){return new Date(a,o+1,0).getDate()}function Nn(a,o){return new Date(a,o,1).getDay()}function $n(a,o){const n=[],u=Nn(a,o),e=Ua(a,o),k=Ua(a,o-1);for(let p=u-1;p>=0;p--)n.push({date:new Date(a,o-1,k-p),inCurrentMonth:!1});for(let p=1;p<=e;p++)n.push({date:new Date(a,o,p),inCurrentMonth:!0});const h=42-n.length;for(let p=1;p<=h;p++)n.push({date:new Date(a,o+1,p),inCurrentMonth:!1});return n}const S=O({name:"DatePicker",props:{value:String,defaultValue:String,format:String,disabled:Boolean,size:{type:String,default:"middle"},placeholder:String,allowClear:{type:Boolean,default:!0},picker:{type:String,default:"date"},showTime:[Boolean,Object],showToday:{type:Boolean,default:!0},showNow:Boolean,disabledDate:Function,status:{type:String,default:""},open:{type:Boolean,default:void 0},defaultOpen:Boolean,presets:Array,minDate:String,maxDate:String,renderExtraFooter:Function,cellRender:Function,classNames:Object,styles:Object},emits:["update:value","change","openChange","panelChange"],setup(a,{emit:o}){var ka,ma,ga;const n=gn("date-picker"),u=vn(),e=new Date,k=y(()=>a.format?a.format:a.picker==="year"?"YYYY":a.picker==="month"?"YYYY-MM":a.picker==="quarter"?"YYYY-[Q]Q":a.showTime?"YYYY-MM-DD HH:mm:ss":"YYYY-MM-DD"),h=y(()=>{if(a.placeholder)return a.placeholder;const t=u.value.DatePicker;return a.picker==="year"?t.yearPlaceholder:a.picker==="month"?t.monthPlaceholder:t.placeholder}),p=v(z(a.defaultValue??a.value)),A=v(((ka=p.value)==null?void 0:ka.getHours())??0),R=v(((ma=p.value)==null?void 0:ma.getMinutes())??0),V=v(((ga=p.value)==null?void 0:ga.getSeconds())??0),U=y(()=>a.showTime?typeof a.showTime=="boolean"?{}:a.showTime:null),L=y(()=>!!a.showTime),b=v((p.value??e).getFullYear()),T=v((p.value??e).getMonth()),aa=v(a.defaultOpen??!1),C=v(a.picker==="year"?"year":a.picker==="month"?"month":"date"),K=v(),pa=v(),na=v({top:0,left:0}),ta=y(()=>a.open!==void 0?a.open:aa.value),Y=y(()=>a.value?z(a.value):p.value),ca=y(()=>a.minDate?z(a.minDate):null),ra=y(()=>a.maxDate?z(a.maxDate):null),ua=y(()=>{const t=Y.value;if(!t)return"";if(a.picker==="quarter"){const l=Math.floor(t.getMonth()/3)+1;return`${t.getFullYear()}-Q${l}`}return la(t,k.value)});yn(()=>a.value,t=>{p.value=z(t)});const ja=()=>{if(!K.value)return;const t=K.value.getBoundingClientRect();na.value={top:t.bottom+window.scrollY+4,left:t.left+window.scrollX}},Qa=()=>{if(a.disabled)return;ja();const t=Y.value??e;b.value=t.getFullYear(),T.value=t.getMonth(),C.value=a.picker==="year"?"year":a.picker==="month"?"month":"date",L.value&&t&&(A.value=t.getHours(),R.value=t.getMinutes(),V.value=t.getSeconds()),aa.value=!0,o("openChange",!0)},X=()=>{aa.value=!1,o("openChange",!1)},da=t=>{var l,m;!((l=K.value)!=null&&l.contains(t.target))&&!((m=pa.value)!=null&&m.contains(t.target))&&X()},ia=t=>{t.key==="Escape"&&ta.value&&(X(),t.preventDefault())};hn(()=>{document.addEventListener("mousedown",da),document.addEventListener("keydown",ia)}),fn(()=>{document.removeEventListener("mousedown",da),document.removeEventListener("keydown",ia)});const Q=t=>{var m;if((m=a.disabledDate)!=null&&m.call(a,t)||ca.value&&t<ca.value||ra.value&&t>ra.value)return;if(L.value){const w=new Date(t.getFullYear(),t.getMonth(),t.getDate(),A.value,R.value,V.value);p.value=w;return}p.value=t;const l=a.picker==="quarter"?`${t.getFullYear()}-Q${Math.floor(t.getMonth()/3)+1}`:la(t,k.value);o("update:value",l),o("change",l,t),X()},za=t=>{if(A.value=t,p.value){const l=p.value;p.value=new Date(l.getFullYear(),l.getMonth(),l.getDate(),t,R.value,V.value)}},La=t=>{if(R.value=t,p.value){const l=p.value;p.value=new Date(l.getFullYear(),l.getMonth(),l.getDate(),A.value,t,V.value)}},Wa=t=>{if(V.value=t,p.value){const l=p.value;p.value=new Date(l.getFullYear(),l.getMonth(),l.getDate(),A.value,R.value,t)}},Ka=()=>{if(!p.value)return;const t=la(p.value,k.value);o("update:value",t),o("change",t,p.value),X()},Xa=t=>{t.stopPropagation(),p.value=null,o("update:value",void 0),o("change",void 0,null)},Ja=t=>{const l=typeof t.value=="function"?t.value():t.value,m=z(l);m&&Q(m)},Ga=()=>{T.value===0?(b.value--,T.value=11):T.value--,o("panelChange",null,C.value)},Za=()=>{T.value===11?(b.value++,T.value=0):T.value++,o("panelChange",null,C.value)},sa=()=>{b.value--,o("panelChange",null,C.value)},ea=()=>{b.value++,o("panelChange",null,C.value)},an=y(()=>$n(b.value,T.value)),nn=y(()=>{const t=U.value;return t&&typeof t=="object"&&"hourStep"in t&&t.hourStep?t.hourStep:1}),tn=y(()=>{const t=U.value;return t&&typeof t=="object"&&"minuteStep"in t&&t.minuteStep?t.minuteStep:1}),sn=y(()=>{const t=U.value;return t&&typeof t=="object"&&"secondStep"in t&&t.secondStep?t.secondStep:1}),en=y(()=>{const t=[];for(let l=0;l<24;l+=nn.value)t.push(l);return t}),on=y(()=>{const t=[];for(let l=0;l<60;l+=tn.value)t.push(l);return t}),ln=y(()=>{const t=[];for(let l=0;l<60;l+=sn.value)t.push(l);return t}),pn=y(()=>{if(!L.value)return!1;const t=U.value&&"format"in U.value&&U.value.format?U.value.format:k.value;return t.includes("ss")||t.includes("s")}),J=y(()=>{const t=Math.floor(b.value/10)*10;return Array.from({length:10},(l,m)=>t+m)}),oa=(t,l)=>{t&&xn(()=>{const m=t.querySelector(`[data-value="${l}"]`);m&&typeof m.scrollIntoView=="function"&&m.scrollIntoView({block:"nearest"})})},cn=()=>{var t,l,m,w,q,P,N,$,f,M,F,B,E,W,va,ya,ha,fa,ba,wa,xa,Da,Sa,Ca,qa,Pa,Na,$a,Ma,Ya,Ta,Fa,Ba,Ea,_a;return s("div",{class:c(`${n}-panel`,{[`${n}-panel-has-time`]:L.value},(t=a.classNames)==null?void 0:t.panel),style:(l=a.styles)==null?void 0:l.panel},[s("div",{class:c(`${n}-panel-header`,(m=a.classNames)==null?void 0:m.panelHeader),style:(w=a.styles)==null?void 0:w.panelHeader},[s("button",{class:`${n}-panel-header-btn`,onClick:sa},[i("«")]),s("button",{class:`${n}-panel-header-btn`,onClick:Ga},[i("‹")]),s("span",{class:`${n}-panel-header-title`},[s("button",{class:`${n}-panel-header-title-btn`,onClick:()=>{C.value="year",o("panelChange",null,"year")}},[b.value,i("年")]),s("button",{class:`${n}-panel-header-title-btn`,onClick:()=>{C.value="month",o("panelChange",null,"month")}},[u.value.DatePicker.months[T.value]])]),s("button",{class:`${n}-panel-header-btn`,onClick:Za},[i("›")]),s("button",{class:`${n}-panel-header-btn`,onClick:ea},[i("»")])]),s("div",{class:c(`${n}-panel-body`,(q=a.classNames)==null?void 0:q.panelBody),style:(P=a.styles)==null?void 0:P.panelBody},[s("div",{class:c(`${n}-weekdays`,(N=a.classNames)==null?void 0:N.weekdays),style:($=a.styles)==null?void 0:$.weekdays},[u.value.DatePicker.weekdays.map(d=>{var D,x;return s("span",{key:d,class:c(`${n}-weekday`,(D=a.classNames)==null?void 0:D.weekday),style:(x=a.styles)==null?void 0:x.weekday},[d])})]),s("div",{class:c(`${n}-days`,(f=a.classNames)==null?void 0:f.days),style:(M=a.styles)==null?void 0:M.days},[an.value.map(({date:d,inCurrentMonth:D},x)=>{var Ia,Aa,Ra;const G=Va(d,e),kn=Y.value?Va(d,Y.value):!1,Oa=((Ia=a.disabledDate)==null?void 0:Ia.call(a,d))??!1,Ha=s("span",null,[d.getDate()]),mn=a.cellRender?a.cellRender(d,{originNode:Ha,today:e,type:"date"}):Ha;return s("button",{key:x,class:c(`${n}-day`,{[`${n}-day-other-month`]:!D,[`${n}-day-today`]:G,[`${n}-day-selected`]:kn,[`${n}-day-disabled`]:Oa},(Aa=a.classNames)==null?void 0:Aa.day),style:(Ra=a.styles)==null?void 0:Ra.day,disabled:Oa,onClick:()=>Q(d)},[mn])})])]),L.value&&s("div",{class:c(`${n}-time-panel`,(F=a.classNames)==null?void 0:F.timePanel),style:(B=a.styles)==null?void 0:B.timePanel},[s("div",{class:c(`${n}-time-content`,(E=a.classNames)==null?void 0:E.timeContent),style:(W=a.styles)==null?void 0:W.timeContent},[s("ul",{class:c(`${n}-time-column`,(va=a.classNames)==null?void 0:va.timeColumn),style:(ya=a.styles)==null?void 0:ya.timeColumn,ref:d=>oa(d,A.value)},[en.value.map(d=>{var D,x;return s("li",{key:d,"data-value":d,class:c(`${n}-time-cell`,{[`${n}-time-cell-selected`]:A.value===d},(D=a.classNames)==null?void 0:D.timeCell),style:(x=a.styles)==null?void 0:x.timeCell,onClick:()=>za(d)},[_(d)])})]),s("ul",{class:c(`${n}-time-column`,(ha=a.classNames)==null?void 0:ha.timeColumn),style:(fa=a.styles)==null?void 0:fa.timeColumn,ref:d=>oa(d,R.value)},[on.value.map(d=>{var D,x;return s("li",{key:d,"data-value":d,class:c(`${n}-time-cell`,{[`${n}-time-cell-selected`]:R.value===d},(D=a.classNames)==null?void 0:D.timeCell),style:(x=a.styles)==null?void 0:x.timeCell,onClick:()=>La(d)},[_(d)])})]),pn.value&&s("ul",{class:c(`${n}-time-column`,(ba=a.classNames)==null?void 0:ba.timeColumn),style:(wa=a.styles)==null?void 0:wa.timeColumn,ref:d=>oa(d,V.value)},[ln.value.map(d=>{var D,x;return s("li",{key:d,"data-value":d,class:c(`${n}-time-cell`,{[`${n}-time-cell-selected`]:V.value===d},(D=a.classNames)==null?void 0:D.timeCell),style:(x=a.styles)==null?void 0:x.timeCell,onClick:()=>Wa(d)},[_(d)])})])])]),(a.showToday||a.showNow||a.showTime||((xa=a.presets)==null?void 0:xa.length)||a.renderExtraFooter)&&s("div",{class:c(`${n}-panel-footer`,(Da=a.classNames)==null?void 0:Da.panelFooter),style:(Sa=a.styles)==null?void 0:Sa.panelFooter},[s("div",{class:c(`${n}-panel-footer-extra`,(Ca=a.classNames)==null?void 0:Ca.panelFooterExtra),style:(qa=a.styles)==null?void 0:qa.panelFooterExtra},[((Pa=a.presets)==null?void 0:Pa.length)&&s("div",{class:c(`${n}-presets`,(Na=a.classNames)==null?void 0:Na.presets),style:($a=a.styles)==null?void 0:$a.presets},[a.presets.map((d,D)=>{var x,G;return s("button",{key:D,class:c(`${n}-preset-btn`,(x=a.classNames)==null?void 0:x.presetBtn),style:(G=a.styles)==null?void 0:G.presetBtn,onClick:()=>Ja(d)},[d.label])})]),(Ma=a.renderExtraFooter)==null?void 0:Ma.call(a)]),s("div",{class:c(`${n}-panel-footer-actions`,(Ya=a.classNames)==null?void 0:Ya.panelFooterActions),style:(Ta=a.styles)==null?void 0:Ta.panelFooterActions},[(a.showToday||a.showNow)&&s("button",{class:c(`${n}-panel-footer-today`,(Fa=a.classNames)==null?void 0:Fa.today),style:(Ba=a.styles)==null?void 0:Ba.today,onClick:()=>Q(new Date)},[a.showNow?u.value.DatePicker.now:u.value.DatePicker.today]),a.showTime&&s("button",{class:c(`${n}-panel-footer-ok`,(Ea=a.classNames)==null?void 0:Ea.ok),style:(_a=a.styles)==null?void 0:_a.ok,onClick:Ka},[u.value.DatePicker.ok])])])])},rn=()=>{var t,l,m,w,q,P,N,$;return s("div",{class:c(`${n}-panel`,(t=a.classNames)==null?void 0:t.panel),style:(l=a.styles)==null?void 0:l.panel},[s("div",{class:c(`${n}-panel-header`,(m=a.classNames)==null?void 0:m.panelHeader),style:(w=a.styles)==null?void 0:w.panelHeader},[s("button",{class:`${n}-panel-header-btn`,onClick:sa},[i("«")]),s("span",{class:`${n}-panel-header-title`},[s("button",{class:`${n}-panel-header-title-btn`,onClick:()=>{C.value="year",o("panelChange",null,"year")}},[b.value,i("年")])]),s("button",{class:`${n}-panel-header-btn`,onClick:ea},[i("»")])]),s("div",{class:c(`${n}-panel-body`,(q=a.classNames)==null?void 0:q.panelBody),style:(P=a.styles)==null?void 0:P.panelBody},[s("div",{class:c(`${n}-months`,(N=a.classNames)==null?void 0:N.months),style:($=a.styles)==null?void 0:$.months},[u.value.DatePicker.months.map((f,M)=>{var E,W;const F=new Date(b.value,M,1),B=Y.value?qn(F,Y.value):!1;return s("button",{key:M,class:c(`${n}-month`,{[`${n}-month-selected`]:B},(E=a.classNames)==null?void 0:E.month),style:(W=a.styles)==null?void 0:W.month,onClick:()=>{T.value=M,a.picker==="month"?Q(F):(C.value="date",o("panelChange",null,"date"))}},[f])})])])])},un=()=>{var t,l,m,w,q,P,N,$;return s("div",{class:c(`${n}-panel`,(t=a.classNames)==null?void 0:t.panel),style:(l=a.styles)==null?void 0:l.panel},[s("div",{class:c(`${n}-panel-header`,(m=a.classNames)==null?void 0:m.panelHeader),style:(w=a.styles)==null?void 0:w.panelHeader},[s("button",{class:`${n}-panel-header-btn`,onClick:()=>{b.value-=10}},[i("«")]),s("span",{class:`${n}-panel-header-title`},[J.value[0],i("年 - "),J.value[J.value.length-1],i("年")]),s("button",{class:`${n}-panel-header-btn`,onClick:()=>{b.value+=10}},[i("»")])]),s("div",{class:c(`${n}-panel-body`,(q=a.classNames)==null?void 0:q.panelBody),style:(P=a.styles)==null?void 0:P.panelBody},[s("div",{class:c(`${n}-years`,(N=a.classNames)==null?void 0:N.years),style:($=a.styles)==null?void 0:$.years},[J.value.map(f=>{var F,B;const M=Y.value?Pn(new Date(f,0,1),Y.value):!1;return s("button",{key:f,class:c(`${n}-year`,{[`${n}-year-selected`]:M},(F=a.classNames)==null?void 0:F.year),style:(B=a.styles)==null?void 0:B.year,onClick:()=>{b.value=f,a.picker==="year"?Q(new Date(f,0,1)):(C.value="month",o("panelChange",null,"month"))}},[f,i("年")])})])])])},dn=()=>{var t,l,m,w,q,P,N,$;return s("div",{class:c(`${n}-panel`,(t=a.classNames)==null?void 0:t.panel),style:(l=a.styles)==null?void 0:l.panel},[s("div",{class:c(`${n}-panel-header`,(m=a.classNames)==null?void 0:m.panelHeader),style:(w=a.styles)==null?void 0:w.panelHeader},[s("button",{class:`${n}-panel-header-btn`,onClick:sa},[i("«")]),s("span",{class:`${n}-panel-header-title`},[b.value,i("年")]),s("button",{class:`${n}-panel-header-btn`,onClick:ea},[i("»")])]),s("div",{class:c(`${n}-panel-body`,(q=a.classNames)==null?void 0:q.panelBody),style:(P=a.styles)==null?void 0:P.panelBody},[s("div",{class:c(`${n}-quarters`,(N=a.classNames)==null?void 0:N.quarters),style:($=a.styles)==null?void 0:$.quarters},[[1,2,3,4].map(f=>{var B,E;const M=new Date(b.value,(f-1)*3,1),F=Y.value?Y.value.getFullYear()===b.value&&Math.floor(Y.value.getMonth()/3)+1===f:!1;return s("button",{key:f,class:c(`${n}-quarter`,{[`${n}-quarter-selected`]:F},(B=a.classNames)==null?void 0:B.quarter),style:(E=a.styles)==null?void 0:E.quarter,onClick:()=>Q(M)},[i("Q"),f])})])])])};return()=>{var t,l,m,w,q,P,N,$;return s(wn,null,[s("div",{ref:K,class:c(n,`${n}-${a.size}`,{[`${n}-open`]:ta.value,[`${n}-disabled`]:a.disabled,[`${n}-status-error`]:a.status==="error",[`${n}-status-warning`]:a.status==="warning"},(t=a.classNames)==null?void 0:t.root),style:(l=a.styles)==null?void 0:l.root,onClick:Qa},[s("span",{class:c(`${n}-input`,(m=a.classNames)==null?void 0:m.input),style:(w=a.styles)==null?void 0:w.input},[s("input",{readonly:!0,value:ua.value,placeholder:h.value,disabled:a.disabled,class:`${n}-input-inner`},null),a.allowClear&&ua.value&&!a.disabled&&s("span",{class:c(`${n}-clear`,(q=a.classNames)==null?void 0:q.clear),style:(P=a.styles)==null?void 0:P.clear,onClick:Xa},[i("✕")]),s("span",{class:c(`${n}-suffix`,(N=a.classNames)==null?void 0:N.suffix),style:($=a.styles)==null?void 0:$.suffix},[i("📅")])])]),ta.value&&s(bn,{to:"body"},{default:()=>{var f,M;return[s("div",{ref:pa,class:c(`${n}-popup`,(f=a.classNames)==null?void 0:f.popup),style:{position:"absolute",top:`${na.value.top}px`,left:`${na.value.left}px`,zIndex:1050,...(M=a.styles)==null?void 0:M.popup}},[C.value==="date"&&a.picker!=="quarter"&&cn(),C.value==="month"&&rn(),C.value==="year"&&un(),a.picker==="quarter"&&C.value==="date"&&dn()])]}})])}}}),Mn={style:{display:"flex","flex-direction":"column",gap:"16px",width:"300px"}},Yn=O({__name:"DatePickerBasic",setup(a){const o=v(""),n=u=>{console.log("选中日期：",u)};return(u,e)=>(H(),I("div",Mn,[s(g(S),{value:o.value,"onUpdate:value":e[0]||(e[0]=k=>o.value=k),placeholder:"请选择日期",onChange:n},null,8,["value"]),r("p",null,"选中日期："+Z(o.value),1)]))}}),Tn=`<template>
...
<\/script>
`,Fn={style:{display:"flex","flex-direction":"column",gap:"24px"}},Bn=O({__name:"DatePickerClassNames",setup(a){return(o,n)=>(H(),I("div",Fn,[r("div",null,[n[0]||(n[0]=r("div",{style:{"margin-bottom":"8px",color:"#666"}},"渐变触发器：",-1)),s(g(S),{placeholder:"选择日期","class-names":{root:"custom-root",input:"custom-input",suffix:"custom-suffix"}})]),r("div",null,[n[1]||(n[1]=r("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义弹层面板：",-1)),s(g(S),{placeholder:"选择日期","class-names":{popup:"custom-popup",panel:"custom-panel",panelHeader:"custom-header"}})]),r("div",null,[n[2]||(n[2]=r("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义日期单元格：",-1)),s(g(S),{placeholder:"选择日期","class-names":{day:"custom-day",weekday:"custom-weekday"}})]),r("div",null,[n[3]||(n[3]=r("div",{style:{"margin-bottom":"8px",color:"#666"}},"带时间选择：",-1)),s(g(S),{placeholder:"选择日期时间","show-time":!0,"class-names":{root:"custom-datetime-root",timePanel:"custom-time-panel",timeColumn:"custom-time-column",timeCell:"custom-time-cell"}})]),r("div",null,[n[4]||(n[4]=r("div",{style:{"margin-bottom":"8px",color:"#666"}},"使用内联样式：",-1)),s(g(S),{placeholder:"选择日期",styles:{root:{borderRadius:"20px",borderColor:"#722ed1"},input:{color:"#722ed1",fontWeight:500},popup:{borderRadius:"16px"},panel:{boxShadow:"0 8px 24px rgba(114, 46, 209, 0.15)"}}})])]))}}),En=Dn(Bn,[["__scopeId","data-v-def2708d"]]),_n=`<template>
...
`,On={style:{display:"flex","flex-direction":"column",gap:"16px",width:"300px"}},Hn=O({__name:"DatePickerDisabledDate",setup(a){const o=v(""),n=v(""),u=k=>new Date(k)<new Date(new Date().toDateString()),e=k=>new Date(k)>new Date(new Date().toDateString());return(k,h)=>(H(),I("div",On,[s(g(S),{value:o.value,"onUpdate:value":h[0]||(h[0]=p=>o.value=p),"disabled-date":u,placeholder:"不可选择过去日期"},null,8,["value"]),s(g(S),{value:n.value,"onUpdate:value":h[1]||(h[1]=p=>n.value=p),"disabled-date":e,placeholder:"不可选择未来日期"},null,8,["value"])]))}}),In=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; width: 300px">
...
<\/script>
`,An={style:{display:"flex","flex-direction":"column",gap:"16px",width:"300px"}},Rn=O({__name:"DatePickerMinMax",setup(a){const o=v(""),n=y(()=>{const e=new Date;return e.setDate(1),e.toISOString().split("T")[0]}),u=y(()=>{const e=new Date;return e.setMonth(e.getMonth()+1,0),e.toISOString().split("T")[0]});return(e,k)=>(H(),I("div",An,[s(g(S),{value:o.value,"onUpdate:value":k[0]||(k[0]=h=>o.value=h),"min-date":n.value,"max-date":u.value,placeholder:"只能选择本月"},null,8,["value","min-date","max-date"]),r("p",null,"选中日期："+Z(o.value),1)]))}}),Vn=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; width: 300px">
...
<\/script>
`,Un={style:{display:"flex","flex-direction":"column",gap:"16px",width:"300px"}},jn=O({__name:"DatePickerPicker",setup(a){const o=v(""),n=v(""),u=v(""),e=v("");return(k,h)=>(H(),I("div",Un,[s(g(S),{value:o.value,"onUpdate:value":h[0]||(h[0]=p=>o.value=p),picker:"date",placeholder:"选择日期"},null,8,["value"]),s(g(S),{value:n.value,"onUpdate:value":h[1]||(h[1]=p=>n.value=p),picker:"month",placeholder:"选择月份"},null,8,["value"]),s(g(S),{value:u.value,"onUpdate:value":h[2]||(h[2]=p=>u.value=p),picker:"quarter",placeholder:"选择季度"},null,8,["value"]),s(g(S),{value:e.value,"onUpdate:value":h[3]||(h[3]=p=>e.value=p),picker:"year",placeholder:"选择年份"},null,8,["value"])]))}}),Qn=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; width: 300px">
...
const year = ref('')
<\/script>
`,zn={style:{display:"flex","flex-direction":"column",gap:"16px",width:"300px"}},Ln=O({__name:"DatePickerPresets",setup(a){const o=v(""),n=[{label:"昨天",value:()=>{const u=new Date;return u.setDate(u.getDate()-1),u.toISOString().split("T")[0]}},{label:"今天",value:()=>new Date().toISOString().split("T")[0]},{label:"明天",value:()=>{const u=new Date;return u.setDate(u.getDate()+1),u.toISOString().split("T")[0]}},{label:"一周后",value:()=>{const u=new Date;return u.setDate(u.getDate()+7),u.toISOString().split("T")[0]}}];return(u,e)=>(H(),I("div",zn,[s(g(S),{value:o.value,"onUpdate:value":e[0]||(e[0]=k=>o.value=k),presets:n,placeholder:"选择日期"},null,8,["value"]),r("p",null,"选中日期："+Z(o.value),1)]))}}),Wn=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; width: 300px">
...
<\/script>
`,Kn={style:{width:"300px"}},Xn={style:{"margin-top":"8px"}},Jn=O({__name:"DatePickerShowTime",setup(a){const o=v(""),n=u=>{console.log("选中日期时间：",u)};return(u,e)=>(H(),I("div",Kn,[s(g(S),{value:o.value,"onUpdate:value":e[0]||(e[0]=k=>o.value=k),"show-time":!0,placeholder:"选择日期和时间",onChange:n},null,8,["value"]),r("p",Xn,"选中："+Z(o.value),1)]))}}),Gn=`<template>
