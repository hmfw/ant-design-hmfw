...
import { Popconfirm, Button } from '@hmfw/ant-design'
<\/script>
`,Mt=k({__name:"PopconfirmCustomText",setup(a){function c(){console.log("已提交")}return(t,m)=>(g(),et(s(p),{title:"确定要提交吗？",description:"提交后将无法修改，请确认信息无误。","ok-text":"提交","cancel-text":"再想想",onConfirm:c},{default:e(()=>[n(s(d),null,{default:e(()=>[...m[0]||(m[0]=[i("提交",-1)])]),_:1})]),_:1}))}}),jt=`<template>
  <Popconfirm
    title="确定要提交吗？"
...
<\/script>
`,Lt={style:{display:"flex",gap:"16px","align-items":"center"}},Ft=k({__name:"PopconfirmDanger",setup(a){function c(){console.log("已确认操作")}return(t,m)=>(g(),x("div",Lt,[n(s(p),{title:"确定要删除吗？",description:"删除后数据将无法恢复","ok-type":"danger","ok-text":"删除","cancel-text":"取消",onConfirm:c},{default:e(()=>[n(s(d),null,{default:e(()=>[...m[0]||(m[0]=[i("删除（danger）",-1)])]),_:1})]),_:1}),n(s(p),{title:"确定要保存吗？","ok-type":"primary","ok-text":"保存","cancel-text":"取消",onConfirm:c},{default:e(()=>[n(s(d),null,{default:e(()=>[...m[1]||(m[1]=[i("保存（primary）",-1)])]),_:1})]),_:1}),n(s(p),{title:"确定要继续吗？","ok-type":"default","ok-text":"继续","cancel-text":"取消",onConfirm:c},{default:e(()=>[n(s(d),null,{default:e(()=>[...m[2]||(m[2]=[i("继续（default）",-1)])]),_:1})]),_:1})]))}}),It=`<template>
  <div style="display: flex; gap: 16px; align-items: center">
    <!-- 危险操作 - 使用 danger 简写 -->
    <Popconfirm
      title="确定要删除吗？"
...
<\/script>
`,Vt={style:{display:"flex",gap:"16px"}},Ht=k({__name:"PopconfirmIcon",setup(a){return(c,t)=>(g(),x("div",Vt,[n(s(p),{title:"确定要删除吗？",icon:"🗑️","ok-text":"删除","cancel-text":"取消"},{default:e(()=>[n(s(d),null,{default:e(()=>[...t[0]||(t[0]=[i("自定义图标",-1)])]),_:1})]),_:1}),n(s(p),{title:"确定要继续吗？","ok-text":"继续","cancel-text":"取消"},{icon:e(()=>[...t[1]||(t[1]=[l("span",{style:{color:"#1890ff","font-size":"16px"}},"ℹ️",-1)])]),default:e(()=>[n(s(d),null,{default:e(()=>[...t[2]||(t[2]=[i("插槽图标",-1)])]),_:1})]),_:1}),n(s(p),{title:"确定要提交吗？",icon:"","ok-text":"提交","cancel-text":"取消"},{default:e(()=>[n(s(d),null,{default:e(()=>[...t[3]||(t[3]=[i("无图标",-1)])]),_:1})]),_:1})]))}}),Wt=`<template>
...
<\/script>
`,Gt={style:{display:"flex",gap:"16px","align-items":"center"}},Jt=k({__name:"PopconfirmTrigger",setup(a){return(c,t)=>(g(),x("div",Gt,[n(s(p),{title:"确定要删除吗？",trigger:"hover","ok-text":"删除","cancel-text":"取消",onConfirm:t[0]||(t[0]=()=>console.log("hover 确认"))},{default:e(()=>[n(s(d),null,{default:e(()=>[...t[4]||(t[4]=[i("鼠标悬停触发",-1)])]),_:1})]),_:1}),n(s(p),{title:"确定要删除吗？",trigger:"click","ok-text":"删除","cancel-text":"取消",onConfirm:t[1]||(t[1]=()=>console.log("click 确认"))},{default:e(()=>[n(s(d),null,{default:e(()=>[...t[5]||(t[5]=[i("点击触发",-1)])]),_:1})]),_:1}),n(s(p),{title:"确定要删除吗？",trigger:"focus","ok-text":"删除","cancel-text":"取消",onConfirm:t[2]||(t[2]=()=>console.log("focus 确认"))},{default:e(()=>[n(s(d),null,{default:e(()=>[...t[6]||(t[6]=[i("聚焦触发",-1)])]),_:1})]),_:1}),n(s(p),{title:"确定要删除吗？",trigger:"contextMenu","ok-text":"删除","cancel-text":"取消",onConfirm:t[3]||(t[3]=()=>console.log("contextMenu 确认"))},{default:e(()=>[n(s(d),null,{default:e(()=>[...t[7]||(t[7]=[i("右键触发",-1)])]),_:1})]),_:1})]))}}),Kt=`<template>
  <div style="display: flex; gap: 16px; align-items: center">
    <!-- hover 触发 -->
    <Popconfirm
      title="确定要删除吗？"
