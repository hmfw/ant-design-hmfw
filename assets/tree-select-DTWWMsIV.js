...
`,Je=V({__name:"TreeSelectMultiple",setup(e){const c=x([]),a=[{value:"parent1",label:"父节点 1",children:[{value:"child1-1",label:"子节点 1-1"},{value:"child1-2",label:"子节点 1-2"}]},{value:"parent2",label:"父节点 2",children:[{value:"child2-1",label:"子节点 2-1"}]}];return(E,r)=>(L(),se(y(ae),{direction:"vertical",style:{width:"300px"}},{default:M(()=>[l(y(P),{value:c.value,"onUpdate:value":r[0]||(r[0]=f=>c.value=f),"tree-data":a,multiple:"",placeholder:"请选择",style:{width:"100%"}},null,8,["value"]),h("span",null,"选中："+le(c.value),1)]),_:1}))}}),Qe=`<template>
  <Space direction="vertical" style="width: 300px">
