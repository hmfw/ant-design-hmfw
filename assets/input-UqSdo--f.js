import{I as f,T as v,b as I,c as q}from"./Input-dzBIcKxa.js";import{o as y,A as g,k,n as a,L as s,E as d,h as e,Q as x,m as b,K as S,j as E,_ as N,H as U,l as P}from"./index-lneS_oZ6.js";import{S as C}from"./Space-C6j8fgWe.js";import{C as W}from"./CloseCircleOutlined-cLUq9qKG.js";import{S as A}from"./SearchOutlined-BSqGHJWp.js";import{U as V}from"./UserOutlined-C9tLlvb3.js";import"./cls-S9IiI6wd.js";import"./CloseOutlined-pIkoQNJR.js";import"./LoadingOutlined-BE1i3WFZ.js";const z={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"400px"}},$=y({__name:"InputAddon",setup(h){const p=d(""),u=d(""),r=d("");return(t,l)=>(g(),k("div",z,[a(s(f),{value:p.value,"onUpdate:value":l[0]||(l[0]=i=>p.value=i),placeholder:"请输入用户名",prefix:"👤"},null,8,["value"]),a(s(f),{value:u.value,"onUpdate:value":l[1]||(l[1]=i=>u.value=i),placeholder:"请输入金额",prefix:"¥",suffix:"元"},null,8,["value"]),a(s(f),{value:r.value,"onUpdate:value":l[2]||(l[2]=i=>r.value=i),placeholder:"支持清除","allow-clear":""},null,8,["value"])]))}}),B=`<template>
...
`,K={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"400px"}},M=y({__name:"InputBasic",setup(h){const p=d("");return(u,r)=>(g(),k("div",K,[a(s(f),{value:p.value,"onUpdate:value":r[0]||(r[0]=t=>p.value=t),placeholder:"请输入内容"},null,8,["value"]),a(s(f),{value:p.value,"onUpdate:value":r[1]||(r[1]=t=>p.value=t),placeholder:"禁用状态",disabled:""},null,8,["value"]),a(s(f),{value:p.value,"onUpdate:value":r[2]||(r[2]=t=>p.value=t),placeholder:"只读状态",readonly:""},null,8,["value"]),e("p",null,"当前值："+S(p.value),1)]))}}),j=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; max-width: 400px">
...
const value = ref('')
<\/script>
`,H={style:{display:"flex","flex-direction":"column",gap:"20px"}},Q=y({__name:"InputClassNames",setup(h){const p=d(""),u=d(""),r=d(""),t=d(""),l=d(""),i=d("");return(m,n)=>(g(),k("div",H,[e("div",null,[n[6]||(n[6]=e("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义前缀和后缀图标样式：",-1)),a(s(f),{value:p.value,"onUpdate:value":n[0]||(n[0]=o=>p.value=o),placeholder:"搜索内容",prefix:s(A),suffix:s(W),"class-names":{prefix:"custom-prefix",suffix:"custom-suffix"},style:{width:"300px"}},null,8,["value","prefix","suffix"])]),e("div",null,[n[7]||(n[7]=e("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义输入框样式：",-1)),a(s(f),{value:u.value,"onUpdate:value":n[1]||(n[1]=o=>u.value=o),placeholder:"特殊样式输入框","class-names":{input:"custom-input"},style:{width:"300px"}},null,8,["value"])]),e("div",null,[n[8]||(n[8]=e("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义外层容器样式：",-1)),a(s(f),{value:r.value,"onUpdate:value":n[2]||(n[2]=o=>r.value=o),placeholder:"渐变边框",prefix:s(V),"class-names":{affixWrapper:"custom-wrapper"},style:{width:"300px"}},null,8,["value","prefix"])]),e("div",null,[n[9]||(n[9]=e("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义字数统计样式：",-1)),a(s(f),{value:t.value,"onUpdate:value":n[3]||(n[3]=o=>t.value=o),placeholder:"最多 50 字","max-length":50,"show-count":"","class-names":{count:"custom-count"},style:{width:"300px"}},null,8,["value"])]),e("div",null,[n[10]||(n[10]=e("div",{style:{"margin-bottom":"8px",color:"#666"}},"使用内联样式（styles）：",-1)),a(s(f),{value:l.value,"onUpdate:value":n[4]||(n[4]=o=>l.value=o),placeholder:"内联样式控制",prefix:s(A),styles:{affixWrapper:{borderColor:"#722ed1",borderRadius:"8px"},prefix:{color:"#722ed1",fontSize:"16px"},input:{fontWeight:"500"}},style:{width:"300px"}},null,8,["value","prefix"])]),e("div",null,[n[11]||(n[11]=e("div",{style:{"margin-bottom":"8px",color:"#666"}},"TextArea 自定义样式：",-1)),a(s(v),{value:i.value,"onUpdate:value":n[5]||(n[5]=o=>i.value=o),placeholder:"多行文本输入",rows:4,"max-length":200,"show-count":"","class-names":{textarea:"custom-textarea",count:"custom-textarea-count"},style:{width:"400px"}},null,8,["value"])])]))}}),G=N(Q,[["__scopeId","data-v-cc1c8761"]]),J=`<template>
