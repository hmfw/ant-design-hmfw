...
`,W={class:"statistic-demo"},G=g({__name:"StatisticCountdown",setup(t){const d=x(Date.now()+72e5),i=x(Date.now()+1e3*60*60*24*2+1e3*30*30),l=x(Date.now()+1e3*10),n=()=>{P.success("倒计时结束！")};return(o,c)=>(h(),_("div",W,[e(a(y),{direction:"vertical",size:16},{default:r(()=>[e(a(D),{title:"倒计时",value:d.value,format:"HH:mm:ss"},null,8,["value"]),e(a(D),{title:"天数倒计时",value:i.value,format:"DD 天 HH 时 mm 分 ss 秒"},null,8,["value"]),e(a(D),{title:"毫秒倒计时",value:l.value,format:"HH:mm:ss:SSS",onFinish:n},null,8,["value"])]),_:1})]))}}),J=w(G,[["__scopeId","data-v-10227bd6"]]),K=`<template>
  <div class="statistic-demo">
...
`,Q={class:"statistic-demo"},Y=g({__name:"StatisticCustom",setup(t){const d=i=>C("span",{style:{color:"#cf1322",fontWeight:"bold"}},[C("span","💰 "),i,C("span"," 元")]);return(i,l)=>(h(),_("div",Q,[e(a(y),{size:32},{default:r(()=>[e(a(u),{title:"自定义渲染",value:112893,"value-render":d}),e(a(u),{title:"增长率",value:9.3,precision:2,suffix:"%","value-style":{color:"#3f8600"},prefix:C("span",{style:{color:"#3f8600"}},"↑")},null,8,["prefix"])]),_:1})]))}}),X=w(Y,[["__scopeId","data-v-ea587276"]]),Z=`<template>
  <div class="statistic-demo">
    <Space :size="32">
