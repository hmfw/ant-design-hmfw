import{B as l}from"./Button-B7cCICCq.js";import{o as m,A as r,k as u,n,L as s,Q as e,m as a,_ as x,h as d,E as B,K as b,H as h,l as y}from"./index-Bxt2WIDN.js";import{S as g}from"./SearchOutlined-s4pI7Eaw.js";import{C as w}from"./CheckOutlined-DqOME6Da.js";import{C as v}from"./CloseOutlined-U1-bOQkR.js";import{D as k}from"./DownloadOutlined-n-uw7I4l.js";import"./cls-S9IiI6wd.js";import"./LoadingOutlined-T50wZmIy.js";const _={style:{display:"flex",gap:"8px","flex-wrap":"wrap"}},S=m({__name:"ButtonBasic",setup(c){return(p,t)=>(r(),u("div",_,[n(s(l),{type:"primary"},{default:e(()=>[...t[0]||(t[0]=[a(" Primary Button ",-1)])]),_:1}),n(s(l),null,{default:e(()=>[...t[1]||(t[1]=[a("Default Button",-1)])]),_:1}),n(s(l),{type:"dashed"},{default:e(()=>[...t[2]||(t[2]=[a(" Dashed Button ",-1)])]),_:1}),n(s(l),{type:"text"},{default:e(()=>[...t[3]||(t[3]=[a(" Text Button ",-1)])]),_:1}),n(s(l),{type:"link"},{default:e(()=>[...t[4]||(t[4]=[a(" Link Button ",-1)])]),_:1})]))}}),D=`<template>
...
import { Button } from '@hmfw/ant-design'
<\/script>
`,H={style:{display:"flex","flex-direction":"column",gap:"16px"}},K={style:{display:"flex",gap:"8px"}},Q={style:{display:"flex",gap:"8px"}},U=m({__name:"ButtonHref",setup(c){return(p,t)=>(r(),u("div",H,[d("div",K,[n(s(l),{type:"primary",href:"https://ant.design",target:"_blank"},{default:e(()=>[...t[0]||(t[0]=[a(" Link Button ",-1)])]),_:1}),n(s(l),{type:"link",href:"https://ant.design",target:"_blank"},{default:e(()=>[...t[1]||(t[1]=[a(" Link Type ",-1)])]),_:1})]),d("div",Q,[n(s(l),{type:"primary",href:"https://ant.design",disabled:""},{default:e(()=>[...t[2]||(t[2]=[a(" Disabled Link ",-1)])]),_:1})])]))}}),j=`<template>
...
import { Button } from '@hmfw/ant-design'
<\/script>
`,J={style:{display:"flex",gap:"8px","flex-wrap":"wrap"}},W=m({__name:"ButtonIcon",setup(c){return(p,t)=>(r(),u("div",J,[n(s(l),{type:"primary",icon:s(g)},{default:e(()=>[...t[0]||(t[0]=[a(" Search ",-1)])]),_:1},8,["icon"]),n(s(l),{type:"primary",icon:s(g)},null,8,["icon"]),n(s(l),{type:"primary",icon:s(w)},{default:e(()=>[...t[1]||(t[1]=[a(" Confirm ",-1)])]),_:1},8,["icon"]),n(s(l),{type:"dashed",icon:s(v)},{default:e(()=>[...t[2]||(t[2]=[a(" Cancel ",-1)])]),_:1},8,["icon"])]))}}),X=`<template>
  <div style="display: flex; gap: 8px; flex-wrap: wrap">
