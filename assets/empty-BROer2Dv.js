import{B as g}from"./Button-Bkc4rV1H.js";import{E as i,P as k}from"./Empty-DAuXKY_r.js";import{o as u,A as l,i as f,R as r,n as e,K as s,m as o,k as y,h as t,_ as x,J as h,v as b,E,H as v,l as w}from"./index-DVYL9B-3.js";import"./cls-S9IiI6wd.js";import"./Icon-DOBD7t4S.js";import"./LoadingOutlined-Cfvvdn-g.js";const S=u({__name:"EmptyAction",setup(c){function p(){console.log("创建")}return(a,d)=>(l(),f(s(i),{description:"暂无数据"},{default:r(()=>[e(s(g),{onClick:p},{default:r(()=>[...d[0]||(d[0]=[o("立即创建",-1)])]),_:1})]),_:1}))}}),_=`<template>
...
import { Empty } from 'ant-design-hmfw'
<\/script>
`,R=["data-theme"],T={style:{"margin-left":"12px"}},M=["data-theme"],$=u({__name:"EmptyDark",setup(c){const p=E("dark");return(a,d)=>(l(),y("div",null,[d[4]||(d[4]=t("p",{style:{"margin-bottom":"12px"}},"切换主题预览插画配色（暗黑模式下默认插画自动适配深色背景）：",-1)),t("div",{"data-theme":p.value,style:{"margin-bottom":"12px"}},[e(s(g),{onClick:d[0]||(d[0]=n=>p.value="light")},{default:r(()=>[...d[2]||(d[2]=[o("浅色",-1)])]),_:1}),e(s(g),{onClick:d[1]||(d[1]=n=>p.value="dark")},{default:r(()=>[...d[3]||(d[3]=[o("暗黑",-1)])]),_:1}),t("span",T,"当前："+h(p.value),1)],8,R),t("div",{"data-theme":p.value,style:b({padding:"24px",borderRadius:"8px",background:p.value==="dark"?"#141414":"#ffffff",color:p.value==="dark"?"rgba(255,255,255,0.65)":"inherit"})},[e(s(i),{description:"暗黑模式下的空状态"})],12,M)]))}}),z=`<template>
  <div>
...
<\/script>
`,G={style:{display:"flex",gap:"32px","align-items":"flex-end","flex-wrap":"wrap"}},L=u({__name:"EmptyImageSize",setup(c){return(p,a)=>(l(),y("div",G,[e(s(i),{"image-width":48,"image-height":32,description:"小尺寸"}),e(s(i),{description:"默认尺寸"}),e(s(i),{"image-width":160,"image-height":100,description:"大尺寸"}),e(s(i),{"image-style":{height:"64px"},description:"imageStyle 控制"})]))}}),W=`<template>
