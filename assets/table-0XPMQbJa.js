import{k as _,I as ne,H as ae,L as G,z as $,j as o,i as M,c as B,w as z,e as W,G as I,g as X,F as de,d as i,E as oe,B as le,M as E,h as re}from"./index-BNHhPN23.js";import{c as p}from"./cls-S9IiI6wd.js";import{E as se}from"./Empty-vYQdLy9t.js";import{P as ce}from"./Pagination-DeRA1UMG.js";import{S as ie}from"./Spin-_FNCP3u9.js";const F=_({name:"Table",props:{dataSource:{type:Array,default:()=>[]},columns:{type:Array,default:()=>[]},rowKey:[String,Function],loading:Boolean,bordered:Boolean,size:{type:String,default:"default"},scroll:Object,pagination:{type:[Boolean,Object],default:void 0},rowSelection:Object,expandable:Object,locale:Object,showHeader:{type:Boolean,default:!0},sticky:Boolean,onChange:Function},emits:["change"],setup(n,{emit:u}){var A;const d=ne("table"),v=ae(),t=$({key:"",order:null}),m=$({}),j=$(1),P=$(10);G(()=>n.columns,e=>{e&&e.forEach(a=>{const l=a.key??a.dataIndex??"";a.filteredValue!==void 0&&(m.value[l]=a.filteredValue)})},{immediate:!0});const C=(e,a)=>typeof n.rowKey=="function"?n.rowKey(e):typeof n.rowKey=="string"?e[n.rowKey]:e.key??String(a),q=(e,a)=>{if(a.dataIndex)return e[a.dataIndex]},J=B(()=>{var a;let e=[...n.dataSource??[]];return(a=n.columns)==null||a.forEach(l=>{const s=l.key??l.dataIndex??"",c=m.value[s];c!=null&&c.length&&l.onFilter&&(e=e.filter(g=>c.some(y=>l.onFilter(y,g))))}),e}),R=B(()=>{var s;const e=[...J.value];if(!t.value.key||!t.value.order)return e;const a=(s=n.columns)==null?void 0:s.find(c=>(c.key??c.dataIndex)===t.value.key);if(!(a!=null&&a.sorter))return e;const l=typeof a.sorter=="function"?a.sorter:void 0;return l&&e.sort((c,g)=>{const y=l(c,g);return t.value.order==="descend"?-y:y}),e}),f=B(()=>{if(n.pagination===!1)return null;const e=typeof n.pagination=="object"?n.pagination:{};return{pageSize:(e==null?void 0:e.pageSize)??P.value,current:(e==null?void 0:e.current)??j.value,total:(e==null?void 0:e.total)??R.value.length,onChange:e==null?void 0:e.onChange}}),w=B(()=>{if(!f.value)return R.value;const{current:e,pageSize:a}=f.value,l=(e-1)*a;return R.value.slice(l,l+a)}),Q=e=>{if(!e.sorter)return;const a=e.key??e.dataIndex??"";t.value.key!==a?t.value={key:a,order:"ascend"}:t.value.order==="ascend"?t.value={key:a,order:"descend"}:t.value={key:"",order:null},u("change",f.value,m.value,t.value)},U=(e,a)=>{var l,s;j.value=e,P.value=a,(s=(l=f.value)==null?void 0:l.onChange)==null||s.call(l,e,a),u("change",{...f.value,current:e,pageSize:a},m.value,t.value)},h=$(((A=n.rowSelection)==null?void 0:A.selectedRowKeys)??[]);G(()=>{var e;return(e=n.rowSelection)==null?void 0:e.selectedRowKeys},e=>{e&&(h.value=e)});const Y=(e,a,l)=>{var g,y,T;if(!n.rowSelection)return;let s;n.rowSelection.type==="radio"?s=l?[e]:[]:s=l?[...h.value,e]:h.value.filter(S=>S!==e),h.value=s;const c=((g=n.dataSource)==null?void 0:g.filter((S,K)=>s.includes(C(S,K))))??[];(T=(y=n.rowSelection).onChange)==null||T.call(y,s,c)},Z=e=>{var s,c;if(!n.rowSelection)return;const a=e?w.value.map((g,y)=>C(g,y)):[];h.value=a;const l=e?[...w.value]:[];(c=(s=n.rowSelection).onChange)==null||c.call(s,a,l)};return()=>{var y,T,S,K,D,V,O;const e=w.value.length===0,a=!!n.rowSelection,l=((y=n.rowSelection)==null?void 0:y.type)==="radio",s=w.value.length>0&&w.value.every((r,k)=>h.value.includes(C(r,k))),c=w.value.some((r,k)=>h.value.includes(C(r,k))),g=o("div",{class:p(d,`${d}-${n.size}`,{[`${d}-bordered`]:n.bordered,[`${d}-loading`]:n.loading,[`${d}-scroll-horizontal`]:!!((T=n.scroll)!=null&&T.x)})},[o("div",{class:`${d}-container`},[o("div",{class:`${d}-content`,style:(S=n.scroll)!=null&&S.x?{overflowX:"auto"}:{}},[o("table",{style:(K=n.scroll)!=null&&K.x?{minWidth:typeof n.scroll.x=="number"?`${n.scroll.x}px`:n.scroll.x}:{}},[n.showHeader&&o("thead",{class:`${d}-thead`},[o("tr",null,[a&&o("th",{class:`${d}-cell ${d}-selection-column`},[!l&&o("input",{type:"checkbox",checked:s,indeterminate:c&&!s,onChange:r=>Z(r.target.checked)},null)]),(D=n.columns)==null?void 0:D.map(r=>{const k=r.key??r.dataIndex??"",x=t.value.key===k;return o("th",{key:k,scope:"col","aria-sort":x?t.value.order==="ascend"?"ascending":"descending":r.sorter?"none":void 0,class:p(`${d}-cell`,{[`${d}-column-sort`]:x,[`${d}-column-has-sorters`]:!!r.sorter}),style:{width:r.width?typeof r.width=="number"?`${r.width}px`:r.width:void 0,textAlign:r.align??"left"},onClick:()=>Q(r)},[o("div",{class:`${d}-column-title`},[r.title,r.sorter&&o("span",{class:`${d}-column-sorter`},[o("span",{class:p(`${d}-column-sorter-up`,{active:x&&t.value.order==="ascend"})},[M("▲")]),o("span",{class:p(`${d}-column-sorter-down`,{active:x&&t.value.order==="descend"})},[M("▼")])])])])})])]),o("tbody",{class:`${d}-tbody`},[e?o("tr",{class:`${d}-placeholder`},[o("td",{colspan:(((V=n.columns)==null?void 0:V.length)??0)+(a?1:0)},[o(se,{description:((O=n.locale)==null?void 0:O.emptyText)??v.value.Table.emptyText},null)])]):w.value.map((r,k)=>{var H;const x=C(r,k),N=h.value.includes(x);return o("tr",{key:x,class:p(`${d}-row`,{[`${d}-row-selected`]:N})},[a&&o("td",{class:`${d}-cell ${d}-selection-column`},[o("input",{type:l?"radio":"checkbox",checked:N,onChange:b=>Y(x,r,b.target.checked)},null)]),(H=n.columns)==null?void 0:H.map(b=>{const ee=b.key??b.dataIndex??"",L=q(r,b),te=b.render?b.render(L,r,k):L;return o("td",{key:ee,class:p(`${d}-cell`,{[`${d}-cell-ellipsis`]:b.ellipsis}),style:{textAlign:b.align??"left"}},[te])})])})])])])]),f.value&&!e&&o("div",{class:`${d}-pagination ${d}-pagination-right`},[o(ce,{total:f.value.total,pageSize:f.value.pageSize,current:f.value.current,onChange:U},null)])]);return n.loading?o("div",{style:{position:"relative"}},[o(ie,{style:{position:"absolute",top:"50%",left:"50%",transform:"translate(-50%, -50%)",zIndex:10}},null),o("div",{style:{opacity:.5}},[g])]):g}}}),ue=_({__name:"TableBasic",setup(n){const u=[{key:"1",name:"胡彦斌",age:32,address:"西湖区湖底公园1号"},{key:"2",name:"胡彦祖",age:42,address:"西湖区湖底公园2号"}],d=[{title:"姓名",dataIndex:"name",key:"name"},{title:"年龄",dataIndex:"age",key:"age"},{title:"住址",dataIndex:"address",key:"address"}];return(v,t)=>(z(),W(I(F),{"data-source":u,columns:d,"row-key":"key"}))}}),ye=`<template>
...
<\/script>
`,me=_({__name:"TableRowSelection",setup(n){const u=$([]),d={selectedRowKeys:u,onChange:m=>{u.value=m}},v=[{key:"1",name:"胡彦斌",age:32,address:"西湖区湖底公园1号"},{key:"2",name:"胡彦祖",age:42,address:"西湖区湖底公园2号"}],t=[{title:"姓名",dataIndex:"name",key:"name"},{title:"年龄",dataIndex:"age",key:"age"},{title:"住址",dataIndex:"address",key:"address"}];return(m,j)=>(z(),X(de,null,[o(I(F),{"data-source":v,columns:t,"row-key":"key","row-selection":d}),i("p",null,"已选择："+oe(u.value.join(", ")),1)],64))}}),ge=`<template>
  <Table
