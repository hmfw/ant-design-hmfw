import{B as a}from"./Button-8pevJcSq.js";import{D as p}from"./index-CTEpDb9q.js";import{m as b,y as s,i as f,l as t,I as d,P as o,k as r,g as w,E as g,f as l,j as D}from"./index-B2-fWtt3.js";import{I as k}from"./Icon-BgwCb1-e.js";import{S as y}from"./Space-DM35qXYa.js";import"./icons-B7DG7jjo.js";import"./cls-S9IiI6wd.js";import"./Menu-COQIU0pW.js";const B={style:{display:"flex",gap:"16px","align-items":"center"}},x=b({__name:"DropdownArrow",setup(m){const u={items:[{key:"1",label:"Menu Item 1"},{key:"2",label:"Menu Item 2"},{key:"3",label:"Menu Item 3"}]};return(i,e)=>(s(),f("div",B,[t(d(p),{menu:u,arrow:!0},{default:o(()=>[t(d(a),null,{default:o(()=>[...e[0]||(e[0]=[r("With Arrow",-1)])]),_:1})]),_:1}),t(d(p),{menu:u,arrow:{pointAtCenter:!0}},{default:o(()=>[t(d(a),null,{default:o(()=>[...e[1]||(e[1]=[r("Arrow Point at Center",-1)])]),_:1})]),_:1})]))}}),_=`<template>
...
<\/script>
`,v=b({__name:"DropdownBasic",setup(m){const u={items:[{key:"1",label:"菜单项一"},{key:"2",label:"菜单项二"},{key:"3",label:"菜单项三"}],onClick:({key:i})=>{console.log("点击了:",i)}};return(i,e)=>(s(),w(d(p),{menu:u},{default:o(()=>[t(d(a),null,{default:o(()=>[e[0]||(e[0]=r(" 下拉菜单 ",-1)),t(d(k),{type:"down"})]),_:1})]),_:1}))}}),h=`<template>
  <Dropdown :menu="menu">
    <Button>
      下拉菜单
      <Icon type="down" />
...
<\/script>
`,C={style:{display:"flex",gap:"16px","flex-wrap":"wrap"}},N=b({__name:"DropdownButton",setup(m){const u={items:[{key:"1",label:"Action 1"},{key:"2",label:"Action 2"},{key:"3",label:"Action 3"}]};return(i,e)=>(s(),f("div",C,[t(d(p).Button,{menu:u},{default:o(()=>[...e[0]||(e[0]=[r(" Dropdown ",-1)])]),_:1}),t(d(p).Button,{menu:u,type:"primary"},{default:o(()=>[...e[1]||(e[1]=[r(" Primary ",-1)])]),_:1}),t(d(p).Button,{menu:u,danger:""},{default:o(()=>[...e[2]||(e[2]=[r(" Danger ",-1)])]),_:1}),t(d(p).Button,{menu:u,disabled:""},{default:o(()=>[...e[3]||(e[3]=[r(" Disabled ",-1)])]),_:1})]))}}),S=`<template>
...
<\/script>
`,A=b({__name:"DropdownDanger",setup(m){const u={items:[{key:"edit",label:"编辑"},{key:"copy",label:"复制"},{type:"divider"},{key:"delete",label:"删除",danger:!0}],onClick:({key:i})=>{console.log("点击了:",i)}};return(i,e)=>(s(),w(d(p),{menu:u,trigger:"click"},{default:o(()=>[t(d(a),null,{default:o(()=>[...e[0]||(e[0]=[r("操作菜单",-1)])]),_:1})]),_:1}))}}),P=`<template>
...
<\/script>
`,V=b({__name:"DropdownPlacement",setup(m){const u={items:[{key:"1",label:"菜单项一"},{key:"2",label:"菜单项二"}]};return(i,e)=>(s(),w(d(y),{wrap:""},{default:o(()=>[t(d(p),{menu:u,placement:"bottomLeft"},{default:o(()=>[t(d(a),null,{default:o(()=>[...e[0]||(e[0]=[r("左下",-1)])]),_:1})]),_:1}),t(d(p),{menu:u,placement:"bottom"},{default:o(()=>[t(d(a),null,{default:o(()=>[...e[1]||(e[1]=[r("居中下",-1)])]),_:1})]),_:1}),t(d(p),{menu:u,placement:"bottomRight"},{default:o(()=>[t(d(a),null,{default:o(()=>[...e[2]||(e[2]=[r("右下",-1)])]),_:1})]),_:1}),t(d(p),{menu:u,placement:"topLeft"},{default:o(()=>[t(d(a),null,{default:o(()=>[...e[3]||(e[3]=[r("左上",-1)])]),_:1})]),_:1}),t(d(p),{menu:u,placement:"top"},{default:o(()=>[t(d(a),null,{default:o(()=>[...e[4]||(e[4]=[r("居中上",-1)])]),_:1})]),_:1}),t(d(p),{menu:u,placement:"topRight"},{default:o(()=>[t(d(a),null,{default:o(()=>[...e[5]||(e[5]=[r("右上",-1)])]),_:1})]),_:1})]),_:1}))}}),I=`<template>
  <Space wrap>
...
<\/script>
`,M=b({__name:"DropdownTrigger",setup(m){const u={items:[{key:"1",label:"菜单项一"},{key:"2",label:"菜单项二"},{key:"3",label:"菜单项三"}]};return(i,e)=>(s(),w(d(y),null,{default:o(()=>[t(d(p),{menu:u,trigger:"hover"},{default:o(()=>[t(d(a),null,{default:o(()=>[...e[0]||(e[0]=[r("悬停触发",-1)])]),_:1})]),_:1}),t(d(p),{menu:u,trigger:"click"},{default:o(()=>[t(d(a),null,{default:o(()=>[...e[1]||(e[1]=[r("点击触发",-1)])]),_:1})]),_:1})]),_:1}))}}),R=`<template>
  <Space>
