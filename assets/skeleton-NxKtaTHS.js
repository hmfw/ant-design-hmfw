import{S as l,b as k,d as h,a as v,c as f}from"./index-CtJsT-zx.js";import{o as u,A as c,i as b,K as s,k as m,n as a,h as t,_ as y,R as p,m as g,E as S,H as x,l as w}from"./index-Bd8h9-ea.js";import{B as N}from"./Button-CzDMRACP.js";import"./cls-S9IiI6wd.js";import"./Icon-Dxbx6miQ.js";import"./LoadingOutlined-CasBxDZw.js";const q=u({__name:"SkeletonActive",setup(d){return(o,e)=>(c(),b(s(l),{active:""}))}}),C=`<template>
  <Skeleton active />
</template>
...
<\/script>
`,R={style:{display:"flex","flex-direction":"column",gap:"32px"}},F={style:{display:"flex",gap:"12px","align-items":"center"}},$={style:{display:"flex","flex-direction":"column",gap:"12px"}},T={style:{display:"flex",gap:"16px","align-items":"center"}},V=u({__name:"SkeletonClassNames",setup(d){return(o,e)=>(c(),m("div",R,[t("div",null,[e[0]||(e[0]=t("div",{style:{"margin-bottom":"12px",color:"#666","font-weight":"500"}},"主组件：自定义头部与段落样式",-1)),a(s(l),{avatar:"",paragraph:{rows:3},active:"","class-names":{root:"custom-skeleton-root",header:"custom-header",avatar:"custom-avatar",section:"custom-section",title:"custom-title",paragraph:"custom-paragraph",row:"custom-row"}})]),t("div",null,[e[1]||(e[1]=t("div",{style:{"margin-bottom":"12px",color:"#666","font-weight":"500"}},"主组件：使用内联样式",-1)),a(s(l),{avatar:"",paragraph:{rows:2},active:"",styles:{root:{padding:"16px",backgroundColor:"#fafafa",borderRadius:"8px"},avatar:{borderRadius:"12px"},title:{height:"20px",backgroundColor:"#1890ff20"},row:{height:"14px",backgroundColor:"#52c41a20"}}})]),t("div",null,[e[2]||(e[2]=t("div",{style:{"margin-bottom":"12px",color:"#666","font-weight":"500"}},"SkeletonButton：自定义按钮骨架",-1)),t("div",F,[a(s(k),{active:"",size:"large","class-names":{root:"custom-button-root",button:"custom-button"}}),a(s(k),{active:"",shape:"round",styles:{button:{background:"linear-gradient(135deg, #667eea 0%, #764ba2 100%)"}}}),a(s(k),{active:"",shape:"circle","class-names":{button:"custom-button-circle"}})])]),t("div",null,[e[3]||(e[3]=t("div",{style:{"margin-bottom":"12px",color:"#666","font-weight":"500"}},"SkeletonInput：自定义输入框骨架",-1)),t("div",$,[a(s(h),{active:"",size:"large",block:"","class-names":{input:"custom-input"}}),a(s(h),{active:"",styles:{input:{backgroundColor:"#ff4d4f20",borderRadius:"6px"}}})])]),t("div",null,[e[4]||(e[4]=t("div",{style:{"margin-bottom":"12px",color:"#666","font-weight":"500"}},"SkeletonAvatar 与 SkeletonImage：组合样式",-1)),t("div",T,[a(s(v),{active:"",size:64,"class-names":{avatar:"custom-large-avatar"}}),a(s(f),{active:"","class-names":{image:"custom-image",svg:"custom-svg",path:"custom-path"}}),a(s(v),{active:"",shape:"square",size:"large",styles:{avatar:{borderRadius:"16px",background:"linear-gradient(135deg, #ffd89b 0%, #19547b 100%)"}}})])])]))}}),j=y(V,[["__scopeId","data-v-95973ede"]]),G=`<template>
...
`,W={style:{display:"flex",gap:"16px"}},H=u({__name:"SkeletonImageNode",setup(d){return(o,e)=>(c(),m("div",W,[a(s(l).Image,{active:""}),a(s(l).Node,{active:""},{default:p(()=>[...e[0]||(e[0]=[t("div",{style:{width:"96px",height:"96px",display:"flex","align-items":"center","justify-content":"center",color:"#bfbfbf"}}," Node ",-1)])]),_:1})]))}}),K=`<template>
