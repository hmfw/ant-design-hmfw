...
<\/script>
`,Dt={style:{"margin-bottom":"16px"}},jt=h({__name:"TabsPosition",setup(t){const s=B("top"),i=[{value:"top",label:"top"},{value:"bottom",label:"bottom"},{value:"left",label:"left"},{value:"right",label:"right"}],n=[{key:"1",label:"Tab 1",children:"Content of Tab 1"},{key:"2",label:"Tab 2",children:"Content of Tab 2"},{key:"3",label:"Tab 3",children:"Content of Tab 3"}];return(e,d)=>(y(),z("div",null,[o("div",Dt,[d[1]||(d[1]=o("span",{style:{"margin-right":"8px"}},"Tab Position: ",-1)),a(c(ft),{value:s.value,"onUpdate:value":d[0]||(d[0]=b=>s.value=b),options:i,style:{width:"120px"}},null,8,["value"])]),a(c(m),{items:n,"tab-position":s.value},null,8,["tab-position"])]))}}),Lt=`<template>
  <div>
