import{I as f,T as v,b as I,c as q}from"./Input-BQ_Xkswx.js";import{o as y,A as g,k,n as a,L as s,E as d,h as e,Q as x,m as b,K as S,j as E,_ as N,H as U,l as P}from"./index-Bxt2WIDN.js";import{S as C}from"./Space-3bEPr88J.js";import{C as W}from"./CloseCircleOutlined-FqGZEiFq.js";import{S as A}from"./SearchOutlined-s4pI7Eaw.js";import{U as V}from"./UserOutlined-BUOH_rJj.js";import"./cls-S9IiI6wd.js";import"./CloseOutlined-U1-bOQkR.js";import"./LoadingOutlined-T50wZmIy.js";const z={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"400px"}},$=y({__name:"InputAddon",setup(h){const p=d(""),u=d(""),r=d("");return(t,l)=>(g(),k("div",z,[a(s(f),{value:p.value,"onUpdate:value":l[0]||(l[0]=i=>p.value=i),placeholder:"请输入用户名",prefix:"👤"},null,8,["value"]),a(s(f),{value:u.value,"onUpdate:value":l[1]||(l[1]=i=>u.value=i),placeholder:"请输入金额",prefix:"¥",suffix:"元"},null,8,["value"]),a(s(f),{value:r.value,"onUpdate:value":l[2]||(l[2]=i=>r.value=i),placeholder:"支持清除","allow-clear":""},null,8,["value"])]))}}),B=`<template>
