import{S as x}from"./Space-ChZCQvS5.js";import{P as i}from"./Pagination-CiBS9p1b.js";import{d as h,o as m,q as b,w as r,f as n,c as a,e,A as y,r as v,b as w,_ as q,v as f,h as S,g as d,i as P}from"./index-cgVI-orz.js";import"./cls-S9IiI6wd.js";import"./LeftOutlined-Bpw_AXza.js";import"./RightOutlined-CAi0GUia.js";import"./Select-DDreAcsa.js";import"./LoadingOutlined-BnULcwLn.js";import"./DownOutlined-Lt7RJDf6.js";import"./Trigger-WY8NmOER.js";import"./VirtualList-L6q9UIex.js";const z=h({__name:"PaginationAlign",setup(g){return(o,s)=>(m(),b(e(x),{direction:"vertical",style:{width:"100%"}},{default:r(()=>[n("div",null,[s[0]||(s[0]=n("h4",null,"左对齐（默认）",-1)),a(e(i),{total:50})]),n("div",null,[s[1]||(s[1]=n("h4",null,"居中对齐",-1)),a(e(i),{total:50,align:"center"})]),n("div",null,[s[2]||(s[2]=n("h4",null,"右对齐",-1)),a(e(i),{total:50,align:"end"})]),n("div",null,[s[3]||(s[3]=n("h4",null,"完整功能 + 居中对齐",-1)),a(e(i),{total:500,"show-size-changer":"","show-quick-jumper":"","show-total":c=>`共 ${c} 条`,align:"center"},null,8,["show-total"])])]),_:1}))}}),C=`<template>
...
<\/script>
`,N=h({__name:"PaginationBasic",setup(g){const o=v(1);return(s,c)=>(m(),b(e(x),{direction:"vertical"},{default:r(()=>[a(e(i),{current:o.value,"onUpdate:current":c[0]||(c[0]=t=>o.value=t),total:50},null,8,["current"]),n("p",null,"当前页："+y(o.value),1)]),_:1}))}}),j=`<template>
...
const current = ref(1)
<\/script>
`,$={style:{display:"flex","flex-direction":"column",gap:"24px"}},E=h({__name:"PaginationClassNames",setup(g){return(o,s)=>(m(),w("div",$,[n("div",null,[s[0]||(s[0]=n("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义根容器与页码项：",-1)),a(e(i),{total:50,"class-names":{root:"custom-root",item:"custom-item",itemActive:"custom-item-active"}})]),n("div",null,[s[1]||(s[1]=n("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义上一页/下一页按钮：",-1)),a(e(i),{total:100,"class-names":{prev:"custom-prev",next:"custom-next"}})]),n("div",null,[s[2]||(s[2]=n("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义完整功能（显示总数、尺寸切换、快速跳转）：",-1)),a(e(i),{total:200,"show-size-changer":"","show-quick-jumper":"","show-total":c=>`共 ${c} 条`,"class-names":{root:"custom-full-root",total:"custom-total",sizeChanger:"custom-size-changer",quickJumper:"custom-quick-jumper"}},null,8,["show-total"])]),n("div",null,[s[3]||(s[3]=n("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义向前/向后跳转按钮：",-1)),a(e(i),{total:150,"class-names":{jumpPrev:"custom-jump",jumpNext:"custom-jump"}})]),n("div",null,[s[4]||(s[4]=n("div",{style:{"margin-bottom":"8px",color:"#666"}},"使用内联样式：",-1)),a(e(i),{total:80,styles:{root:{padding:"16px",background:"#f0f5ff",borderRadius:"8px"},item:{fontWeight:"bold"},itemActive:{background:"linear-gradient(135deg, #667eea 0%, #764ba2 100%)",border:"none"}}})])]))}}),R=q(E,[["__scopeId","data-v-c02cebbe"]]),A=`<template>
...
`,T={style:{"margin-top":"8px",color:"#666"}},V=h({__name:"PaginationItemRender",setup(g){const o=v(1),s=(l,p,k)=>p==="prev"?f("a","上一页"):p==="next"?f("a","下一页"):k,c=(l,p,k)=>p==="page"?f("a",{style:{display:"inline-block",padding:"0 8px",border:"1px solid #d9d9d9",borderRadius:"4px",fontWeight:"bold"}},`[${l}]`):k,t=(l,p,k)=>p==="page"?f("a",{href:`#page-${l}`},l):p==="prev"?f("a",{href:"#prev"},"← 上一页"):p==="next"?f("a",{href:"#next"},"下一页 →"):k,u=l=>{o.value=l};return(l,p)=>(m(),b(e(x),{direction:"vertical",style:{width:"100%"}},{default:r(()=>[n("div",null,[p[0]||(p[0]=n("h4",null,"自定义上一页/下一页文本",-1)),a(e(i),{total:50,"item-render":s})]),n("div",null,[p[1]||(p[1]=n("h4",null,"自定义页码样式",-1)),a(e(i),{total:100,"item-render":c})]),n("div",null,[p[2]||(p[2]=n("h4",null,"链接模式",-1)),a(e(i),{total:50,"item-render":t,onChange:u}),n("p",T,"点击页码查看链接效果（当前页："+y(o.value)+"）",1)])]),_:1}))}}),_=`<template>
  <Space direction="vertical" style="width: 100%">
    <div>
      <h4>自定义上一页/下一页文本</h4>
...
<\/script>
`,B=h({__name:"PaginationMore",setup(g){const o=v(1),s=v(10),c=(u,l)=>{console.log("页码变化:",u,l)},t=(u,l)=>{console.log("每页条数变化:",u,l)};return(u,l)=>(m(),b(e(x),{direction:"vertical"},{default:r(()=>[a(e(i),{current:o.value,"onUpdate:current":l[0]||(l[0]=p=>o.value=p),"page-size":s.value,"onUpdate:pageSize":l[1]||(l[1]=p=>s.value=p),total:500,"show-size-changer":"","show-quick-jumper":"","show-total":(p,k)=>`第 ${k[0]}-${k[1]} 条，共 ${p} 条`,onChange:c,onShowSizeChange:t},null,8,["current","page-size","show-total"]),n("p",null,"当前页："+y(o.value)+"，每页条数："+y(s.value),1)]),_:1}))}}),J=`<template>
  <Space direction="vertical">
    <Pagination
...
<\/script>
`,D=h({__name:"PaginationSimple",setup(g){const o=v(1);return(s,c)=>(m(),b(e(i),{current:o.value,"onUpdate:current":c[0]||(c[0]=t=>o.value=t),simple:"",total:50},null,8,["current"]))}}),U=`<template>
...
const current = ref(1)
<\/script>
`,W=h({__name:"PaginationSmall",setup(g){const o=v(1);return(s,c)=>(m(),b(e(x),{direction:"vertical"},{default:r(()=>[a(e(i),{current:o.value,"onUpdate:current":c[0]||(c[0]=t=>o.value=t),size:"small",total:50},null,8,["current"]),a(e(i),{current:o.value,"onUpdate:current":c[1]||(c[1]=t=>o.value=t),size:"small",total:50,"show-size-changer":"","show-quick-jumper":""},null,8,["current"])]),_:1}))}}),I=`<template>
  <Space direction="vertical">
...
<span class="token keyword">const</span> <span class="token function-variable function">itemRender</span> <span class="token operator">=</span> <span class="token punctuation">(</span><span class="token parameter">page<span class="token punctuation">,</span> type<span class="token punctuation">,</span> originalElement</span><span class="token punctuation">)</span> <span class="token operator">=&gt;</span> <span class="token punctuation">{</span>
  <span class="token keyword">if</span> <span class="token punctuation">(</span>type <span class="token operator">===</span> <span class="token string">&#39;prev&#39;</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token keyword">return</span> <span class="token function">h</span><span class="token punctuation">(</span><span class="token string">&#39;a&#39;</span><span class="token punctuation">,</span> <span class="token string">&#39;上一页&#39;</span><span class="token punctuation">)</span>
  <span class="token punctuation">}</span>
  <span class="token keyword">if</span> <span class="token punctuation">(</span>type <span class="token operator">===</span> <span class="token string">&#39;next&#39;</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token keyword">return</span> <span class="token function">h</span><span class="token punctuation">(</span><span class="token string">&#39;a&#39;</span><span class="token punctuation">,</span> <span class="token string">&#39;下一页&#39;</span><span class="token punctuation">)</span>
  <span class="token punctuation">}</span>
  <span class="token comment">// 其他情况返回原始元素</span>
  <span class="token keyword">return</span> originalElement
<span class="token punctuation">}</span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>ul</span><span class="token punctuation">&gt;</span></span>
  ...
  <span class="token comment">&lt;!-- 自定义根容器和页码项 --&gt;</span>
  ...
  <span class="token comment">&lt;!-- 自定义上一页/下一页按钮 --&gt;</span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>Pagination</span>
    <span class="token attr-name">:total</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>100<span class="token punctuation">&quot;</span></span>
    <span class="token attr-name">:class-names</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>{
      prev: &#39;custom-prev&#39;,
  ...
  <span class="token comment">&lt;!-- 自定义完整功能 --&gt;</span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>Pagination</span>
    ...
    <span class="token attr-name">show-size-changer</span>
    <span class="token attr-name">show-quick-jumper</span>
    <span class="token attr-name">:show-total</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>(total) =&gt; \`共 \${total} 条\`<span class="token punctuation">&quot;</span></span>
    <span class="token attr-name">:class-names</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>{
      total: &#39;custom-total&#39;,
      sizeChanger: &#39;custom-size-changer&#39;,
      quickJumper: &#39;custom-quick-jumper&#39;,
...
<span class="token selector">:deep(.custom-pagination)</span> <span class="token punctuation">{</span>
...
<span class="token selector">:deep(.custom-active)</span> <span class="token punctuation">{</span>
  <span class="token property">background</span><span class="token punctuation">:</span> <span class="token function">linear-gradient</span><span class="token punctuation">(</span>135deg<span class="token punctuation">,</span> #1677ff 0%<span class="token punctuation">,</span> #096dd9 100%<span class="token punctuation">)</span> <span class="token important">!important</span><span class="token punctuation">;</span>
  ...
  <span class="token property">box-shadow</span><span class="token punctuation">:</span> 0 4px 12px <span class="token function">rgba</span><span class="token punctuation">(</span>22<span class="token punctuation">,</span> 119<span class="token punctuation">,</span> 255<span class="token punctuation">,</span> 0.4<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>

<span class="token selector">:deep(.custom-prev),
:deep(.custom-next)</span> <span class="token punctuation">{</span>
...
<span class="token selector">:deep(.custom-total)</span> <span class="token punctuation">{</span>
  <span class="token property">color</span><span class="token punctuation">:</span> #d46b08<span class="token punctuation">;</span>
  <span class="token property">font-weight</span><span class="token punctuation">:</span> bold<span class="token punctuation">;</span>
<span class="token punctuation">}</span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>style</span><span class="token punctuation">&gt;</span></span>
  ...
  <span class="token comment">&lt;!-- 内联样式控制根容器和页码项 --&gt;</span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>Pagination</span>
    <span class="token attr-name">:total</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>80<span class="token punctuation">&quot;</span></span>
  ...
  <span class="token comment">&lt;!-- 自定义上一页/下一页按钮样式 --&gt;</span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>Pagination</span>
    <span class="token attr-name">:total</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>100<span class="token punctuation">&quot;</span></span>
    <span class="token attr-name">:styles</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>{
  ...
  <span class="token comment">&lt;!-- 自定义总数和选项样式 --&gt;</span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>Pagination</span>
    <span class="token attr-name">:total</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>200<span class="token punctuation">&quot;</span></span>
    <span class="token attr-name">show-size-changer</span>
    <span class="token attr-name">:show-total</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>(total) =&gt; \`共 \${total} 条\`<span class="token punctuation">&quot;</span></span>
