...
<\/script>
`,w={style:{display:"flex",gap:"12px","margin-bottom":"16px"}},z={style:{display:"flex","flex-direction":"column",gap:"12px"}},D=u({__name:"ConfigProviderSize",setup(s){const r=y("middle");return(c,e)=>(p(),f(x,null,[o("div",w,[n(d(i),{onClick:e[0]||(e[0]=t=>r.value="small")},{default:l(()=>[...e[3]||(e[3]=[a("小",-1)])]),_:1}),n(d(i),{onClick:e[1]||(e[1]=t=>r.value="middle")},{default:l(()=>[...e[4]||(e[4]=[a("中",-1)])]),_:1}),n(d(i),{onClick:e[2]||(e[2]=t=>r.value="large")},{default:l(()=>[...e[5]||(e[5]=[a("大",-1)])]),_:1})]),n(d(g),{"component-size":r.value},{default:l(()=>[o("div",z,[n(d(S),{placeholder:"输入框"}),n(d(i),null,{default:l(()=>[...e[6]||(e[6]=[a("按钮",-1)])]),_:1})])]),_:1},8,["component-size"])],64))}}),A=`<template>
  <div style="display: flex; gap: 12px; margin-bottom: 16px">
...
<\/script>
`,E={style:{display:"flex","flex-direction":"column",gap:"12px"}},F=u({__name:"ConfigProviderTheme",setup(s){const r={token:{colorPrimary:"#00b96b",borderRadius:2}};return(c,e)=>(p(),C(d(g),{theme:r},{default:l(()=>[o("div",E,[n(d(i),{style:{background:"var(--hmfw-color-primary)",color:"white",border:"none",padding:"8px 16px","border-radius":"6px",cursor:"pointer"}},{default:l(()=>[...e[0]||(e[0]=[a(" 主色按钮 ",-1)])]),_:1}),e[1]||(e[1]=o("p",{style:{color:"var(--hmfw-color-primary)"}},"主色文字",-1))])]),_:1}))}}),$=`<template>
