import{C as u,a as f}from"./Checkbox-CM6itQWk.js";import{d as v,o as h,b as x,c as a,e as d,w as c,g as l,f as e,A as k,r as b,_ as y,D as w,h as G,i as N}from"./index-DZWA4HiS.js";import"./cls-S9IiI6wd.js";const S={style:{display:"flex","flex-direction":"column",gap:"8px"}},A=v({__name:"CheckboxBasic",setup(g){const p=b(!1),t=b(!1),r=b(!0);return(n,s)=>(h(),x("div",S,[a(d(u),{checked:p.value,"onUpdate:checked":s[0]||(s[0]=o=>p.value=o)},{default:c(()=>[...s[3]||(s[3]=[l(" 普通复选框 ",-1)])]),_:1},8,["checked"]),a(d(u),{checked:t.value,"onUpdate:checked":s[1]||(s[1]=o=>t.value=o),disabled:""},{default:c(()=>[...s[4]||(s[4]=[l(" 禁用复选框 ",-1)])]),_:1},8,["checked"]),a(d(u),{checked:r.value,"onUpdate:checked":s[2]||(s[2]=o=>r.value=o),disabled:""},{default:c(()=>[...s[5]||(s[5]=[l(" 禁用选中 ",-1)])]),_:1},8,["checked"]),e("p",null,"checked1: "+k(p.value)+", checked2: "+k(t.value)+", checked3: "+k(r.value),1)]))}}),q=`<template>
...
`,K={style:{display:"flex","flex-direction":"column",gap:"16px"}},R=v({__name:"CheckboxGroup",setup(g){const p=b(["apple"]),t=b([]),r=[{label:"苹果",value:"apple"},{label:"香蕉",value:"banana"},{label:"橙子",value:"orange"},{label:"葡萄",value:"grape",disabled:!0}],n=[{label:"红色",value:"red"},{label:"绿色",value:"green"},{label:"蓝色",value:"blue"}];return(s,o)=>(h(),x("div",K,[e("div",null,[o[2]||(o[2]=e("p",{style:{"margin-bottom":"8px"}},"水平排列：",-1)),a(d(f),{value:p.value,"onUpdate:value":o[0]||(o[0]=i=>p.value=i),options:r},null,8,["value"])]),e("div",null,[o[3]||(o[3]=e("p",{style:{"margin-bottom":"8px"}},"垂直排列（通过 style 控制）：",-1)),a(d(f),{value:t.value,"onUpdate:value":o[1]||(o[1]=i=>t.value=i),options:n,style:{display:"flex",flexDirection:"column",gap:"8px"}},null,8,["value"])]),e("p",null,"水果："+k(p.value)+"，颜色："+k(t.value),1)]))}}),Y=`<template>
