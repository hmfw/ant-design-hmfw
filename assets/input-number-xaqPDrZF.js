import{I as r}from"./InputNumber-ctrXwm6H.js";import{o as b,A as v,k as f,n as e,K as o,E as c,h as t,J as h,_ as N,H as I,R as k,m as u,l as q}from"./index-Bd8h9-ea.js";import"./cls-S9IiI6wd.js";const S={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"300px"}},U=b({__name:"InputNumberAddon",setup(g){const s=c(null),d=c(null),l=c(null);return(n,a)=>(v(),f("div",S,[e(o(r),{value:s.value,"onUpdate:value":a[0]||(a[0]=m=>s.value=m),min:0,prefix:"¥","addon-after":"元",placeholder:"请输入价格",style:{width:"100%"}},null,8,["value"]),e(o(r),{value:d.value,"onUpdate:value":a[1]||(a[1]=m=>d.value=m),min:0,max:100,"addon-after":"%",placeholder:"请输入百分比",style:{width:"100%"}},null,8,["value"]),e(o(r),{value:l.value,"onUpdate:value":a[2]||(a[2]=m=>l.value=m),min:0,"addon-before":"重量","addon-after":"kg",placeholder:"请输入重量",style:{width:"100%"}},null,8,["value"])]))}}),$=`<template>
