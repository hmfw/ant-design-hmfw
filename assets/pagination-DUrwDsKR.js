import{S as x}from"./Space-Dz5A7DSP.js";import{P as p}from"./Pagination-DKRY7awZ.js";import{n as b,z as g,h as S,Q as u,g as e,m as n,J as o,I as z,D as h,o as f,G as P,j as w,l as m,k as y}from"./index-DBrYVvYd.js";import"./cls-S9IiI6wd.js";import"./icons-CTzpiRs0.js";import"./Icon-CiCvy_Uq.js";import"./Select-DsldShrq.js";import"./VirtualList-zT4uJSQ6.js";const k=b({__name:"PaginationAlign",setup(v){return(r,i)=>(g(),S(o(x),{direction:"vertical",style:{width:"100%"}},{default:u(()=>[e("div",null,[i[0]||(i[0]=e("h4",null,"左对齐（默认）",-1)),n(o(p),{total:50})]),e("div",null,[i[1]||(i[1]=e("h4",null,"居中对齐",-1)),n(o(p),{total:50,align:"center"})]),e("div",null,[i[2]||(i[2]=e("h4",null,"右对齐",-1)),n(o(p),{total:50,align:"end"})]),e("div",null,[i[3]||(i[3]=e("h4",null,"完整功能 + 居中对齐",-1)),n(o(p),{total:500,"show-size-changer":"","show-quick-jumper":"","show-total":a=>`共 ${a} 条`,align:"center"},null,8,["show-total"])])]),_:1}))}}),C=`<template>
...
<\/script>
`,$=b({__name:"PaginationBasic",setup(v){const r=h(1);return(i,a)=>(g(),S(o(x),{direction:"vertical"},{default:u(()=>[n(o(p),{current:r.value,"onUpdate:current":a[0]||(a[0]=t=>r.value=t),total:50},null,8,["current"]),e("p",null,"当前页："+z(r.value),1)]),_:1}))}}),R=`<template>
...
<\/script>
`,B=b({__name:"PaginationSimple",setup(v){const r=h(1);return(i,a)=>(g(),S(o(p),{current:r.value,"onUpdate:current":a[0]||(a[0]=t=>r.value=t),simple:"",total:50},null,8,["current"]))}}),q=`<template>
...
const current = ref(1)
<\/script>
`,T=b({__name:"PaginationSmall",setup(v){const r=h(1);return(i,a)=>(g(),S(o(x),{direction:"vertical"},{default:u(()=>[n(o(p),{current:r.value,"onUpdate:current":a[0]||(a[0]=t=>r.value=t),size:"small",total:50},null,8,["current"]),n(o(p),{current:r.value,"onUpdate:current":a[1]||(a[1]=t=>r.value=t),size:"small",total:50,"show-size-changer":"","show-quick-jumper":""},null,8,["current"])]),_:1}))}}),U=`<template>
  <Space direction="vertical">
