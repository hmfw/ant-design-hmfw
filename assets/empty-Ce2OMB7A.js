import{B as g}from"./Button-BJ4qjE3i.js";import{E as i,P as k}from"./Empty-Exi_iPK7.js";import{d as u,o as l,q as f,w as r,c as e,e as s,g as o,b as y,f as t,_ as x,A as h,J as b,r as E,h as v,i as w}from"./index-DZWA4HiS.js";import"./cls-S9IiI6wd.js";import"./LoadingOutlined-_M72e6LV.js";const S=u({__name:"EmptyAction",setup(c){function p(){console.log("创建")}return(a,d)=>(l(),f(s(i),{description:"暂无数据"},{default:r(()=>[e(s(g),{onClick:p},{default:r(()=>[...d[0]||(d[0]=[o("立即创建",-1)])]),_:1})]),_:1}))}}),_=`<template>
...
import { Empty } from '@hmfw/ant-design'
<\/script>
`,V=u({__name:"EmptySimple",setup(c){return(p,a)=>(l(),f(s(i),{image:s(k),description:"简约空状态"},null,8,["image"]))}}),F=`<template>
