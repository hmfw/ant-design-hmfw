...
<\/script>
`,_t={style:{display:"flex",gap:"16px"}},Ft=N({__name:"ProgressCircle",setup(t){return(c,n)=>(B(),A("div",_t,[s(o(i),{type:"circle",percent:75}),s(o(i),{type:"circle",percent:70,status:"exception"}),s(o(i),{type:"circle",percent:100})]))}}),Rt=`<template>
...
`,Xt={style:{display:"flex","flex-direction":"column",gap:"16px"}},Yt=N({__name:"ProgressCustom",setup(t){return(c,n)=>(B(),A("div",Xt,[e("div",null,[n[0]||(n[0]=e("div",{style:{"margin-bottom":"8px"}},"Custom Size (number)",-1)),s(o(i),{type:"circle",percent:75,size:80})]),e("div",null,[n[1]||(n[1]=e("div",{style:{"margin-bottom":"8px"}},"Small Size",-1)),s(o(i),{type:"circle",percent:75,size:"small"})]),e("div",null,[n[2]||(n[2]=e("div",{style:{"margin-bottom":"8px"}},"Custom Gap Degree",-1)),s(o(i),{type:"dashboard",percent:75,"gap-degree":30})]),e("div",null,[n[3]||(n[3]=e("div",{style:{"margin-bottom":"8px"}},"Square Linecap",-1)),s(o(i),{type:"circle",percent:75,"stroke-linecap":"square"})])]))}}),Zt=`<template>
...
import { Progress } from '@hmfw/ant-design'
<\/script>
`,tn={style:{display:"flex",gap:"16px"}},nn=N({__name:"ProgressDashboard",setup(t){return(c,n)=>(B(),A("div",tn,[s(o(i),{type:"dashboard",percent:75}),s(o(i),{type:"dashboard",percent:75,"gap-degree":30})]))}}),en=`<template>
  <div style="display: flex; gap: 16px">
...
import { Progress } from '@hmfw/ant-design'
<\/script>
`,sn={style:{display:"flex",gap:"8px","margin-top":"12px"}},an=N({__name:"ProgressDynamic",setup(t){const c=dt(0);function n(){c.value=Math.min(c.value+10,100)}function p(){c.value=Math.max(c.value-10,0)}return(a,d)=>(B(),A(Pt,null,[s(o(i),{percent:c.value},null,8,["percent"]),e("div",sn,[s(o(V),{onClick:p},{default:b(()=>[...d[0]||(d[0]=[w("-",-1)])]),_:1}),s(o(V),{onClick:n},{default:b(()=>[...d[1]||(d[1]=[w("+",-1)])]),_:1})])],64))}}),on=`<template>
...
`,dn={style:{display:"flex","flex-direction":"column",gap:"16px"}},pn={style:{display:"flex",gap:"24px"}},un=N({__name:"ProgressGradient",setup(t){return(c,n)=>(B(),A("div",dn,[e("div",null,[n[0]||(n[0]=e("div",{style:{"margin-bottom":"8px"}},"线形渐变（from-to）",-1)),s(o(i),{percent:60,"stroke-color":{from:"#108ee9",to:"#87d068"}})]),e("div",null,[n[1]||(n[1]=e("div",{style:{"margin-bottom":"8px"}},"线形渐变（多色 stop）",-1)),s(o(i),{percent:80,"stroke-color":{"0%":"#108ee9","50%":"#87d068","100%":"#ffcb00"}})]),e("div",null,[n[2]||(n[2]=e("div",{style:{"margin-bottom":"8px"}},"成功分段 success.percent",-1)),s(o(i),{percent:60,success:{percent:30,strokeColor:"#52c41a"}})]),e("div",null,[n[3]||(n[3]=e("div",{style:{"margin-bottom":"8px"}},"圆形 / 仪表盘渐变",-1)),e("div",pn,[s(o(i),{type:"circle",percent:70,"stroke-color":{"0%":"#108ee9","100%":"#87d068"}}),s(o(i),{type:"dashboard",percent:70,"stroke-color":{"0%":"#108ee9","100%":"#87d068"}}),s(o(i),{type:"circle",percent:90,"stroke-color":{from:"#1677ff",to:"#ff4d4f"}})])])]))}}),mn=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px">
    <div>
