import{d as w,u as tt,x as et,m as G,k as nt,n as R,y as st,c as s,r,a as M,B as at,o as q,b as $,F as ot,e as c,f as l,A as lt,q as V,v as m,_ as dt,h as it,w as N,g as B,i as ct}from"./index-DZWA4HiS.js";import{c as U}from"./cls-S9IiI6wd.js";import{T as pt}from"./Tooltip-Dpun1Uyv.js";import{H as L}from"./HomeOutlined-DF6dHnnz.js";import{U as I}from"./UserOutlined-DNkh_kwG.js";import{S as P}from"./SettingOutlined-CyWR3vWt.js";import{B as ut,P as rt}from"./PictureOutlined-DkSZzSFv.js";import"./Trigger-B9GAuuS8.js";function mt(e){return typeof e=="function"||Object.prototype.toString.call(e)==="[object Object]"&&!at(e)}const v=w({name:"Segmented",props:{value:[String,Number],defaultValue:[String,Number],options:{type:Array,default:()=>[]},disabled:Boolean,block:Boolean,size:{type:String,default:"middle"},vertical:Boolean,orientation:String,shape:{type:String,default:"default"},name:String,classNames:Object,styles:Object},emits:["update:value","change"],setup(e,{emit:d}){var j;const o=tt("segmented"),g=et(),t=r(),a=r(),h=M(()=>e.options.map(n=>typeof n=="object"?n:{label:String(n),value:n})),S=e.defaultValue??e.value??((j=h.value[0])==null?void 0:j.value),C=r(S),A=M(()=>e.value!==void 0),i=M(()=>A.value?e.value:C.value);G(()=>e.value,n=>{n!==void 0&&(C.value=n)});const p=M(()=>e.orientation?e.orientation==="vertical":e.vertical),K=M(()=>e.name||`segmented-${Math.random().toString(36).slice(2,9)}`),E=(n,y)=>{e.disabled||n.disabled||(C.value=n.value,d("update:value",n.value),d("change",n.value),R(()=>W(y)))},X=(n,y,f)=>{var O;if(e.disabled||y.disabled)return;const b=h.value,u=!p.value,x=g.value.direction==="rtl";let k=-1;if(u&&n.key==="ArrowRight"||!u&&n.key==="ArrowDown"?k=x&&u?f-1:f+1:(u&&n.key==="ArrowLeft"||!u&&n.key==="ArrowUp")&&(k=x&&u?f+1:f-1),k>=0&&k<b.length){n.preventDefault();const D=b[k];if(!D.disabled){E(D,k);const z=(O=t.value)==null?void 0:O.querySelectorAll('input[type="radio"]');z!=null&&z[k]&&z[k].focus()}}},W=n=>{if(!a.value||!t.value)return;const f=t.value.querySelectorAll(`.${o}-item`)[n];if(!f)return;const b=t.value.getBoundingClientRect(),u=f.getBoundingClientRect();if(p.value){const x=u.top-b.top+t.value.scrollTop;a.value.style.transform=`translateY(${x}px)`,a.value.style.height=`${u.height}px`,a.value.style.width="100%"}else{const x=u.left-b.left+t.value.scrollLeft;a.value.style.transform=`translateX(${x}px)`,a.value.style.width=`${u.width}px`,a.value.style.height="100%"}},_=()=>{const n=h.value.findIndex(y=>y.value===i.value);n>=0&&W(n)};let T=null;nt(()=>{_(),t.value&&typeof ResizeObserver<"u"&&(T=new ResizeObserver(()=>{R(()=>_())}),T.observe(t.value))}),st(()=>{T&&(T.disconnect(),T=null)}),G([i,h,p],()=>{R(()=>_())});const J=n=>{var b,u,x,k,O,D;const y=!!n.icon,f=n.label!==void 0&&n.label!==null;return s("div",{class:U(`${o}-item-label`,(b=e.classNames)==null?void 0:b.itemLabel,{[`${o}-item-icon-only`]:y&&!f}),style:(u=e.styles)==null?void 0:u.itemLabel},[y&&s("span",{class:U(`${o}-item-icon`,(x=e.classNames)==null?void 0:x.itemIcon),style:(k=e.styles)==null?void 0:k.itemIcon},[n.icon]),f&&s("span",{class:U(`${o}-item-text`,(O=e.classNames)==null?void 0:O.itemText),style:(D=e.styles)==null?void 0:D.itemText},[n.label])])},Z=(n,y)=>{var x,k,O,D,z,Y,F,Q;const f=n.value===i.value,b=e.disabled||n.disabled,u=s("label",{key:n.value,class:U(`${o}-item`,n.className,(x=e.classNames)==null?void 0:x.item,{[`${o}-item-selected`]:f,[`${o}-item-disabled`]:b},f&&((k=e.classNames)==null?void 0:k.itemSelected),b&&((O=e.classNames)==null?void 0:O.itemDisabled)),style:{...n.style,...(D=e.styles)==null?void 0:D.item,...f?(z=e.styles)==null?void 0:z.itemSelected:{},...b?(Y=e.styles)==null?void 0:Y.itemDisabled:{}},title:n.title},[s("input",{type:"radio",class:U(`${o}-item-input`,(F=e.classNames)==null?void 0:F.itemInput),style:(Q=e.styles)==null?void 0:Q.itemInput,name:K.value,value:n.value,checked:f,disabled:b,onChange:()=>E(n,y),onKeydown:H=>X(H,n,y)},null),J(n)]);if(n.tooltip){const H=typeof n.tooltip=="string"?{title:n.tooltip}:n.tooltip;return s(pt,H,mt(u)?u:{default:()=>[u]})}return u};return()=>{var n,y,f,b,u,x;return s("div",{class:U(o,(n=e.classNames)==null?void 0:n.root,`${o}-${e.size}`,{[`${o}-disabled`]:e.disabled,[`${o}-block`]:e.block,[`${o}-vertical`]:p.value,[`${o}-rtl`]:g.value.direction==="rtl",[`${o}-shape-${e.shape}`]:e.shape==="round"}),style:(y=e.styles)==null?void 0:y.root},[s("div",{ref:t,class:U(`${o}-group`,(f=e.classNames)==null?void 0:f.group),style:(b=e.styles)==null?void 0:b.group},[s("div",{ref:a,class:U(`${o}-thumb`,(u=e.classNames)==null?void 0:u.thumb),style:(x=e.styles)==null?void 0:x.thumb},null),h.value.map((k,O)=>Z(k,O))])])}}}),vt=w({__name:"SegmentedBasic",setup(e){const d=r("Daily"),o=["Daily","Weekly","Monthly","Quarterly","Yearly"];return(g,t)=>(q(),$(ot,null,[s(c(v),{value:d.value,"onUpdate:value":t[0]||(t[0]=a=>d.value=a),options:o},null,8,["value"]),l("p",null,"当前选中："+lt(d.value),1)],64))}}),gt=`<template>
...
<\/script>
`,ft=w({__name:"SegmentedBlock",setup(e){const d=r("Map"),o=["Map","Transit","Satellite"];return(g,t)=>(q(),V(c(v),{value:d.value,"onUpdate:value":t[0]||(t[0]=a=>d.value=a),options:o,block:""},null,8,["value"]))}}),bt=`<template>
...
`,qt=w({__name:"SegmentedDisabled",setup(e){const d=r("Daily"),o=[{value:"Daily",label:"每日"},{value:"Weekly",label:"每周",disabled:!0},{value:"Monthly",label:"每月"}];return(g,t)=>(q(),V(c(v),{value:d.value,"onUpdate:value":t[0]||(t[0]=a=>d.value=a),options:o},null,8,["value"]))}}),Ot=`<template>
  <Segmented v-model:value="value" :options="options" />
</template>
...
<\/script>
`,At={style:{display:"flex","flex-direction":"column",gap:"16px"}},_t=w({__name:"SegmentedWithIcon",setup(e){const d=r("home"),o=[{value:"home",icon:m(L,{class:"hmfw-icon"}),tooltip:"Home Page"},{value:"user",icon:m(I,{class:"hmfw-icon"}),tooltip:"User Profile"},{value:"settings",icon:m(P,{class:"hmfw-icon"}),tooltip:"Settings"}];return(g,t)=>(q(),$("div",At,[s(c(v),{value:d.value,"onUpdate:value":t[0]||(t[0]=a=>d.value=a),options:o},null,8,["value"])]))}}),Ht=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px">
    <Segmented v-model:value="value" :options="options" />
  </div>
</template>
