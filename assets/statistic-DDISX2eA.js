import{S as V}from"./Space-BIBt6cjD.js";import{S as L}from"./index-B1kyZpmo.js";import{o as y,N as W,L as U,n,Q as Y,x as J,y as K,E as q,A as h,k as w,K as i,R as f,_ as N,h as o,p as F,m as b,J as Q,H as G,l as X}from"./index-B9Ix0zQ8.js";import{c}from"./cls-S9IiI6wd.js";import{m as Z}from"./message-CK5Sce9z.js";import{B as tt}from"./Button-D9PdcFa1.js";import"./LoadingOutlined-aeZz6k73.js";import"./ExclamationCircleFilled-D1Qor_SV.js";import"./CloseCircleFilled-BM35gEFb.js";import"./InfoCircleFilled-KhOcrXqz.js";import"./Icon-D0ODznex.js";function nt(t,a,s=",",d="."){if(t==null||t==="")return"";const e=typeof t=="string"?parseFloat(t):t;if(isNaN(e))return String(t);const u=(a!==void 0?e.toFixed(a):String(e)).split("."),g=u[0],m=u[1],v=g.replace(/\B(?=(\d{3})+(?!\d))/g,s);return m!==void 0?`${v}${d}${m}`:v}const r=y({name:"Statistic",props:{title:[String,Object],value:[String,Number],precision:Number,prefix:[String,Object],suffix:[String,Object],valueStyle:Object,groupSeparator:{type:String,default:","},decimalSeparator:{type:String,default:"."},loading:Boolean,valueRender:Function,classNames:Object,styles:Object},setup(t){const a=W("statistic"),s=U();return()=>{var l,u,g,m,v,x,k,p,S,_,C,D,$,H,z,B;if(t.loading)return n("div",{class:c(a,(l=t.classNames)==null?void 0:l.root,{[`${a}-rtl`]:s.value.direction==="rtl"}),style:(u=t.styles)==null?void 0:u.root},[t.title&&n("div",{class:c(`${a}-title`,(g=t.classNames)==null?void 0:g.title),style:(m=t.styles)==null?void 0:m.title},[t.title]),n(L,{active:!0,title:!1,paragraph:{rows:1,width:"100%"}},null)]);const d=nt(t.value,t.precision,t.groupSeparator,t.decimalSeparator),e=()=>t.valueRender?t.valueRender(d):d;return n("div",{class:c(a,(v=t.classNames)==null?void 0:v.root,{[`${a}-rtl`]:s.value.direction==="rtl"}),style:(x=t.styles)==null?void 0:x.root},[t.title&&n("div",{class:c(`${a}-title`,(k=t.classNames)==null?void 0:k.title),style:(p=t.styles)==null?void 0:p.title},[t.title]),n("div",{class:c(`${a}-content`,(S=t.classNames)==null?void 0:S.content),style:{...t.valueStyle,...(_=t.styles)==null?void 0:_.content}},[t.prefix&&n("span",{class:c(`${a}-content-prefix`,(C=t.classNames)==null?void 0:C.prefix),style:(D=t.styles)==null?void 0:D.prefix},[t.prefix]),n("span",{class:c(`${a}-content-value`,($=t.classNames)==null?void 0:$.value),style:(H=t.styles)==null?void 0:H.value},[e()]),t.suffix&&n("span",{class:c(`${a}-content-suffix`,(z=t.classNames)==null?void 0:z.suffix),style:(B=t.styles)==null?void 0:B.suffix},[t.suffix])])])}}});function et(t,a="HH:mm:ss"){if(t<=0)return a.replace(/Y+|M+|D+|H+|m+|s+|S+/g,x=>"0".repeat(x.length));const s=Math.floor(t/1e3),d=Math.floor(s/60),e=Math.floor(d/60),l=Math.floor(e/24),u=s%60,g=d%60,m=e%24,v={DD:String(l).padStart(2,"0"),D:String(l),HH:String(m).padStart(2,"0"),H:String(m),mm:String(g).padStart(2,"0"),m:String(g),ss:String(u).padStart(2,"0"),s:String(u),SSS:String(t%1e3).padStart(3,"0")};return a.replace(/DD|D|HH|H|mm|m|ss|s|SSS/g,x=>v[x]??x)}const R=y({name:"Countdown",props:{title:[String,Object],value:[Number,Date],format:{type:String,default:"HH:mm:ss"},prefix:[String,Object],suffix:[String,Object],valueStyle:Object,loading:Boolean,valueRender:Function,classNames:Object,styles:Object,onFinish:Function,onChange:Function},setup(t,{emit:a}){const s=W("statistic"),d=U(),e=q(0);let l=null,u=0;const g=()=>{if(!t.value)return 0;const k=t.value instanceof Date?t.value.getTime():t.value,p=Date.now();return Math.max(0,k-p)},m=k=>{var S;const p=g();if(e.value=p,t.onChange&&p!==u&&(t.onChange(p),u=p),p<=0){l!==null&&(cancelAnimationFrame(l),l=null),(S=t.onFinish)==null||S.call(t),a("finish");return}l=requestAnimationFrame(m)},v=()=>{l!==null&&cancelAnimationFrame(l),e.value=g(),u=e.value,l=requestAnimationFrame(m)},x=()=>{l!==null&&(cancelAnimationFrame(l),l=null)};return Y(()=>t.value,()=>{v()}),J(()=>{v()}),K(()=>{x()}),()=>{var S,_,C,D,$,H,z,B,P,E,O,j,A,I,M,T;if(t.loading)return n("div",{class:c(s,(S=t.classNames)==null?void 0:S.root,{[`${s}-rtl`]:d.value.direction==="rtl"}),style:(_=t.styles)==null?void 0:_.root},[t.title&&n("div",{class:c(`${s}-title`,(C=t.classNames)==null?void 0:C.title),style:(D=t.styles)==null?void 0:D.title},[t.title]),n(L,{active:!0,title:!1,paragraph:{rows:1,width:"100%"}},null)]);const k=et(e.value,t.format),p=()=>t.valueRender?t.valueRender(k):k;return n("div",{class:c(s,`${s}-countdown`,($=t.classNames)==null?void 0:$.root,{[`${s}-rtl`]:d.value.direction==="rtl"}),style:(H=t.styles)==null?void 0:H.root},[t.title&&n("div",{class:c(`${s}-title`,(z=t.classNames)==null?void 0:z.title),style:(B=t.styles)==null?void 0:B.title},[t.title]),n("div",{class:c(`${s}-content`,(P=t.classNames)==null?void 0:P.content),style:{...t.valueStyle,...(E=t.styles)==null?void 0:E.content}},[t.prefix&&n("span",{class:c(`${s}-content-prefix`,(O=t.classNames)==null?void 0:O.prefix),style:(j=t.styles)==null?void 0:j.prefix},[t.prefix]),n("span",{class:c(`${s}-content-value`,(A=t.classNames)==null?void 0:A.value),style:(I=t.styles)==null?void 0:I.value},[p()]),t.suffix&&n("span",{class:c(`${s}-content-suffix`,(M=t.classNames)==null?void 0:M.suffix),style:(T=t.styles)==null?void 0:T.suffix},[t.suffix])])])}}}),st={class:"statistic-demo"},at=y({__name:"StatisticBasic",setup(t){return(a,s)=>(h(),w("div",st,[n(i(V),{size:32},{default:f(()=>[n(i(r),{title:"用户数",value:112893}),n(i(r),{title:"账户余额（元）",value:112893,precision:2}),n(i(r),{title:"活跃用户",value:93,suffix:"/ 100"})]),_:1})]))}}),ot=N(at,[["__scopeId","data-v-1ee31567"]]),it=`<template>
...
`,ut={class:"statistic-demo"},pt=y({__name:"StatisticCountdown",setup(t){const a=q(Date.now()+72e5),s=q(Date.now()+1e3*60*60*24*2+1e3*30*30),d=q(Date.now()+1e3*10),e=()=>{Z.success("倒计时结束！")};return(l,u)=>(h(),w("div",ut,[n(i(V),{direction:"vertical",size:16},{default:f(()=>[n(i(R),{title:"倒计时",value:a.value,format:"HH:mm:ss"},null,8,["value"]),n(i(R),{title:"天数倒计时",value:s.value,format:"DD 天 HH 时 mm 分 ss 秒"},null,8,["value"]),n(i(R),{title:"毫秒倒计时",value:d.value,format:"HH:mm:ss:SSS",onFinish:e},null,8,["value"])]),_:1})]))}}),ft=N(pt,[["__scopeId","data-v-28500cd1"]]),mt=`<template>
  <div class="statistic-demo">
...
`,gt={class:"statistic-demo"},vt=y({__name:"StatisticCustom",setup(t){const a=s=>F("span",{style:{color:"#cf1322",fontWeight:"bold"}},[F("span","💰 "),s,F("span"," 元")]);return(s,d)=>(h(),w("div",gt,[n(i(V),{size:32},{default:f(()=>[n(i(r),{title:"自定义渲染",value:112893,"value-render":a}),n(i(r),{title:"增长率",value:9.3,precision:2,suffix:"%","value-style":{color:"#3f8600"},prefix:F("span",{style:{color:"#3f8600"}},"↑")},null,8,["prefix"])]),_:1})]))}}),xt=N(vt,[["__scopeId","data-v-96d954f0"]]),kt=`<template>
  <div class="statistic-demo">
    <Space :size="32">
...
`,St={class:"statistic-demo"},bt={style:{"margin-top":"16px"}},yt=y({__name:"StatisticLoading",setup(t){const a=q(!0),s=q(112893),d=()=>{a.value=!a.value};return(e,l)=>(h(),w("div",St,[n(i(V),{size:32},{default:f(()=>[n(i(r),{title:"用户数",value:s.value,loading:a.value},null,8,["value","loading"]),n(i(r),{title:"活跃用户",value:93,suffix:"/ 100",loading:a.value},null,8,["loading"]),n(i(R),{title:"倒计时",value:Date.now()+6e4,loading:a.value},null,8,["value","loading"])]),_:1}),o("div",bt,[n(i(tt),{onClick:d},{default:f(()=>[b(Q(a.value?"显示内容":"显示加载"),1)]),_:1})])]))}}),ht=N(yt,[["__scopeId","data-v-5e9bf3f5"]]),wt=`<template>
  <div class="statistic-demo">
    <Space :size="32">
...
`,qt={class:"statistic-demo"},Nt=y({__name:"StatisticUnit",setup(t){return(a,s)=>(h(),w("div",qt,[n(i(V),{size:32},{default:f(()=>[n(i(r),{title:"账户余额",value:112893,precision:2,prefix:"$"}),n(i(r),{title:"增长率",value:9.3,precision:2,suffix:"%"}),n(i(r),{title:"价格",value:568.08,precision:2,prefix:"¥","value-style":{color:"#3f8600"}})]),_:1})]))}}),_t=N(Nt,[["__scopeId","data-v-944ed558"]]),Ct=`<template>
  <div class="statistic-demo">
    <Space :size="32">
