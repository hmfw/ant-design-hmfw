import{I as i,T as h,a as q,b}from"./Input-DBDg35qS.js";import{o as k,A as v,k as x,n as a,L as s,E as d,h as e,S as f,m as y,K as w,j as N,_ as C,H as A,l as E}from"./index-7wnt1Cyk.js";import{S}from"./Space-Ck9WDQtu.js";import{C as T}from"./CloseCircleOutlined-EoQoggcP.js";import{S as I}from"./SearchOutlined-CixgyIJJ.js";import{U as P}from"./UserOutlined-nHnAGjJt.js";import"./cls-S9IiI6wd.js";import"./CloseOutlined-C4ZHTMg1.js";import"./EyeOutlined-Bx0TY-o2.js";import"./LoadingOutlined-VcPrAqG4.js";const U={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"400px"}},W=k({__name:"InputAddon",setup(g){const l=d(""),u=d(""),r=d("");return(t,o)=>(v(),x("div",U,[a(s(i),{value:l.value,"onUpdate:value":o[0]||(o[0]=c=>l.value=c),placeholder:"请输入用户名",prefix:"👤"},null,8,["value"]),a(s(i),{value:u.value,"onUpdate:value":o[1]||(o[1]=c=>u.value=c),placeholder:"请输入金额",prefix:"¥",suffix:"元"},null,8,["value"]),a(s(i),{value:r.value,"onUpdate:value":o[2]||(o[2]=c=>r.value=c),placeholder:"支持清除","allow-clear":""},null,8,["value"])]))}}),V=`<template>
...
`,G={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"400px"}},J=k({__name:"InputPassword",setup(g){const l=d(""),u=d("");return(r,t)=>(v(),x("div",G,[a(s(q),{value:l.value,"onUpdate:value":t[0]||(t[0]=o=>l.value=o),placeholder:"请输入密码"},null,8,["value"]),a(s(q),{value:u.value,"onUpdate:value":t[1]||(t[1]=o=>u.value=o),placeholder:"不可切换可见性","visibility-toggle":!1},null,8,["value"]),e("p",null,"密码："+w(l.value),1)]))}}),Q=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; max-width: 400px">
