import{S as l}from"./Spin-BRWj8Xxz.js";import{d as k,o as d,q as f,e as a,b as m,f as s,c as t,w as c,_ as y,r as g,g as i,k as b,l as S,s as x,h,i as q}from"./index-dV6GQSVR.js";import{B as v}from"./Button-CbNYWpGi.js";import"./cls-S9IiI6wd.js";import"./LoadingOutlined-CdSjzm5S.js";const w=k({__name:"SpinBasic",setup(r){return(e,p)=>(d(),f(a(l)))}}),N=`<template>
  <Spin />
</template>
...
const loading = ref(true)
<\/script>
`,A={style:{display:"flex",gap:"32px","align-items":"center"}},I=k({__name:"SpinPercent",setup(r){const e=g(0),p=g(!0);let o;b(()=>{o=setInterval(()=>{e.value=e.value>=100?0:e.value+10},500)}),S(()=>{o&&clearInterval(o)});function n(){p.value=!p.value}return(u,W)=>(d(),m("div",A,[t(a(l),{percent:e.value},null,8,["percent"]),t(a(l),{percent:e.value,size:"large"},null,8,["percent"]),t(a(l),{percent:"auto",spinning:p.value},null,8,["spinning"]),t(a(v),{onClick:n},{default:c(()=>[i(x(p.value?"停止 auto":"开始 auto"),1)]),_:1})]))}}),T=`<template>
