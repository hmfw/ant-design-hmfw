import{I as m,T as f,a as I,b as q}from"./Input-CVty-Qey.js";import{d as y,o as x,b as g,c as a,e,r as c,f as s,w as v,g as b,A as S,K as E,_ as N,h as U,i as P}from"./index-D5KOSvVL.js";import{S as C}from"./Space-CnBAwhpS.js";import{C as W}from"./CloseCircleOutlined-DE04m0-N.js";import{S as A}from"./SearchOutlined-kxQP0EDy.js";import{U as V}from"./UserOutlined-CBB6yXAs.js";import"./cls-S9IiI6wd.js";import"./CloseOutlined-CRKH_6re.js";import"./EyeOutlined-Ch7OltgP.js";import"./LoadingOutlined-BFlxA5_9.js";const z={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"400px"}},$=y({__name:"InputAddon",setup(h){const l=c(""),r=c(""),u=c("");return(n,p)=>(x(),g("div",z,[a(e(m),{value:l.value,"onUpdate:value":p[0]||(p[0]=i=>l.value=i),placeholder:"请输入用户名",prefix:"👤"},null,8,["value"]),a(e(m),{value:r.value,"onUpdate:value":p[1]||(p[1]=i=>r.value=i),placeholder:"请输入金额",prefix:"¥",suffix:"元"},null,8,["value"]),a(e(m),{value:u.value,"onUpdate:value":p[2]||(p[2]=i=>u.value=i),placeholder:"支持清除","allow-clear":""},null,8,["value"])]))}}),B=`<template>
