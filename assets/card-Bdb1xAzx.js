import{C as l,a as c}from"./index-DxUpn7a2.js";import{m,y as s,g as C,P as n,f as d,I as o,l as e,k as a,B as b,E as x,i as g,j as y}from"./index-BZxHTh1S.js";import"./cls-S9IiI6wd.js";const h=m({__name:"CardBasic",setup(p){return(i,r)=>(s(),C(o(l),{title:"卡片标题",style:{width:"300px"}},{default:n(()=>[...r[0]||(r[0]=[d("p",null,"卡片内容",-1),d("p",null,"卡片内容",-1),d("p",null,"卡片内容",-1)])]),_:1}))}}),G=`<template>
