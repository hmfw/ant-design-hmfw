import{S as Va}from"./Space-DvJIwRnu.js";import{o as Q,N as on,M as pn,E as w,Q as ln,x as cn,y as rn,n as t,m as i,T as dn,F as un,f,A as G,i as ga,R as $,K as k,h as c,J as Ha,k as _a,_ as kn,H as gn,l as mn}from"./index-DVYL9B-3.js";import{c as u}from"./cls-S9IiI6wd.js";function Oa(a){return String(a).padStart(2,"0")}function ia(a,e="YYYY-MM-DD"){return e.replace("YYYY",String(a.getFullYear())).replace("MM",Oa(a.getMonth()+1)).replace("DD",Oa(a.getDate()))}function I(a){if(!a)return null;const e=new Date(a);return isNaN(e.getTime())?null:e}function ka(a,e){return a.getFullYear()===e.getFullYear()&&a.getMonth()===e.getMonth()&&a.getDate()===e.getDate()}function Aa(a,e){return new Date(a,e+1,0).getDate()}function yn(a,e){return new Date(a,e,1).getDay()}function fn(a,e){const n=[],p=yn(a,e),o=Aa(a,e),g=Aa(a,e-1);for(let r=p-1;r>=0;r--)n.push({date:new Date(a,e-1,g-r),inCurrentMonth:!1});for(let r=1;r<=o;r++)n.push({date:new Date(a,e,r),inCurrentMonth:!0});const S=42-n.length;for(let r=1;r<=S;r++)n.push({date:new Date(a,e+1,r),inCurrentMonth:!1});return n}const x=Q({name:"RangePicker",props:{value:Array,defaultValue:Array,format:{type:String,default:"YYYY-MM-DD"},disabled:{type:[Boolean,Array],default:!1},placeholder:{type:Array},allowClear:{type:Boolean,default:!0},allowEmpty:{type:Array},order:{type:Boolean,default:!0},separator:{type:String,default:"→"},presets:{type:Array},size:{type:String,default:"middle"},disabledDate:Function,status:{type:String,default:""},open:{type:Boolean,default:void 0},classNames:Object,styles:Object},emits:["update:value","change","openChange","calendarChange"],setup(a,{emit:e}){const n=on("date-picker"),p=pn(),o=new Date,g=f(()=>a.placeholder?a.placeholder:p.value.DatePicker.rangePlaceholder??["Start date","End date"]),S=s=>s?[I(s[0]),I(s[1])]:[null,null],r=w(S(a.defaultValue??a.value));ln(()=>a.value,s=>{r.value=S(s)});const R=f(()=>a.value?I(a.value[0]):r.value[0]),Z=f(()=>a.value?I(a.value[1]):r.value[1]),ma=w(!1),aa=f(()=>a.open!==void 0?a.open:ma.value),D=w("start"),E=w(null),P=w((R.value??o).getFullYear()),b=w((R.value??o).getMonth()),Fa=f(()=>b.value===11?P.value+1:P.value),Wa=f(()=>b.value===11?0:b.value+1),na=w(),ya=w(),la=w({top:0,left:0}),ca=f(()=>typeof a.disabled=="boolean"&&a.disabled),za=f(()=>Array.isArray(a.disabled)?!!a.disabled[0]:!!a.disabled),La=f(()=>Array.isArray(a.disabled)?!!a.disabled[1]:!!a.disabled),ja=f(()=>R.value?ia(R.value,a.format):""),Ka=f(()=>Z.value?ia(Z.value,a.format):""),Ua=f(()=>!!(R.value||Z.value)),Xa=()=>{if(!na.value)return;const s=na.value.getBoundingClientRect();la.value={top:s.bottom+window.scrollY+4,left:s.left+window.scrollX}},fa=s=>{a.open===void 0&&(ma.value=s),e("openChange",s)},Ja=()=>{if(ca.value||aa.value)return;Xa();const s=R.value??o;P.value=s.getFullYear(),b.value=s.getMonth(),D.value=R.value&&!Z.value?"end":"start",fa(!0)},sa=()=>{E.value=null,fa(!1)},ba=s=>{var l,d;!((l=na.value)!=null&&l.contains(s.target))&&!((d=ya.value)!=null&&d.contains(s.target))&&sa()},va=s=>{s.key==="Escape"&&aa.value&&(sa(),s.preventDefault())};cn(()=>{document.addEventListener("mousedown",ba),document.addEventListener("keydown",va)}),rn(()=>{document.removeEventListener("mousedown",ba),document.removeEventListener("keydown",va)});const ta=s=>s?ia(s,a.format):null,ra=(s,l)=>{e("calendarChange",[ta(s[0]),ta(s[1])],s,{range:l})},ha=s=>{const l=[ta(s[0]),ta(s[1])];r.value=s,e("update:value",l),e("change",l,s)},Qa=s=>{var l;if(!((l=a.disabledDate)!=null&&l.call(a,s,{type:"date",from:r.value[0]??void 0})))if(D.value==="start")r.value=[s,null],D.value="end",ra([s,null],"start");else{let d=r.value[0],v=s;a.order&&d&&v<d&&([d,v]=[v,d]);const h=[d,v];ra(h,"end"),ha(h),sa()}},Ga=s=>{const l=typeof s.value=="function"?s.value():s.value,d=[I(l[0]),I(l[1])];ra(d,"end"),ha(d),sa()},Za=s=>{s.stopPropagation(),r.value=[null,null],D.value="start",e("update:value",[null,null]),e("change",[null,null],[null,null])},an=()=>{b.value===0?(P.value--,b.value=11):b.value--},nn=()=>{b.value===11?(P.value++,b.value=0):b.value++};function sn(s){const l=r.value[0],d=D.value==="end"?E.value??r.value[1]:r.value[1];if(!l||!d)return!1;const[v,h]=l<=d?[l,d]:[d,l];return s>v&&s<h}function tn(s){const l=r.value[0];return!!(l&&ka(s,l))}function en(s){const l=D.value==="end"?E.value??r.value[1]:r.value[1];return!!(l&&ka(s,l))}function wa(s,l,d){var h,B,T,M,Y,H,O,A,V,_,F,W,z,L,j,K,U,X,q,J;const v=fn(s,l);return t("div",{class:u(`${n}-panel`,(h=a.classNames)==null?void 0:h.panel),style:(B=a.styles)==null?void 0:B.panel},[t("div",{class:u(`${n}-panel-header`,(T=a.classNames)==null?void 0:T.panelHeader),style:(M=a.styles)==null?void 0:M.panelHeader},[d==="left"&&t("button",{class:u(`${n}-panel-header-btn`,(Y=a.classNames)==null?void 0:Y.panelHeaderBtn),style:(H=a.styles)==null?void 0:H.panelHeaderBtn,onClick:an},[i("‹")]),d==="right"&&t("span",{class:u(`${n}-panel-header-btn`,(O=a.classNames)==null?void 0:O.panelHeaderBtn),style:{visibility:"hidden",...(A=a.styles)==null?void 0:A.panelHeaderBtn}},[i("‹")]),t("span",{class:u(`${n}-panel-header-title`,(V=a.classNames)==null?void 0:V.panelHeaderTitle),style:(_=a.styles)==null?void 0:_.panelHeaderTitle},[s,i("年 "),p.value.DatePicker.months[l]]),d==="right"&&t("button",{class:u(`${n}-panel-header-btn`,(F=a.classNames)==null?void 0:F.panelHeaderBtn),style:(W=a.styles)==null?void 0:W.panelHeaderBtn,onClick:nn},[i("›")]),d==="left"&&t("span",{class:u(`${n}-panel-header-btn`,(z=a.classNames)==null?void 0:z.panelHeaderBtn),style:{visibility:"hidden",...(L=a.styles)==null?void 0:L.panelHeaderBtn}},[i("›")])]),t("div",{class:u(`${n}-panel-body`,(j=a.classNames)==null?void 0:j.panelBody),style:(K=a.styles)==null?void 0:K.panelBody},[t("div",{class:u(`${n}-weekdays`,(U=a.classNames)==null?void 0:U.weekdays),style:(X=a.styles)==null?void 0:X.weekdays},[p.value.DatePicker.weekdays.map(m=>{var ea,oa;return t("span",{key:m,class:u(`${n}-weekday`,(ea=a.classNames)==null?void 0:ea.weekday),style:(oa=a.styles)==null?void 0:oa.weekday},[m])})]),t("div",{class:u(`${n}-days`,(q=a.classNames)==null?void 0:q.days),style:(J=a.styles)==null?void 0:J.days},[v.map(({date:m,inCurrentMonth:ea},oa)=>{var Sa,xa,Da,Ra,Pa,qa,Na,Ca,Ia,$a,Ea,Ba,Ta,Ma,Ya;const da=ka(m,o),pa=((Sa=a.disabledDate)==null?void 0:Sa.call(a,m,{type:"date",from:r.value[0]??void 0}))??!1,ua=sn(m),N=tn(m),C=en(m);let y=(xa=a.styles)==null?void 0:xa.day;return da&&((Da=a.styles)!=null&&Da.dayToday)&&(y={...y,...a.styles.dayToday}),(N||C)&&((Ra=a.styles)!=null&&Ra.daySelected)&&(y={...y,...a.styles.daySelected}),ua&&((Pa=a.styles)!=null&&Pa.dayInRange)&&(y={...y,...a.styles.dayInRange}),N&&((qa=a.styles)!=null&&qa.dayRangeStart)&&(y={...y,...a.styles.dayRangeStart}),C&&((Na=a.styles)!=null&&Na.dayRangeEnd)&&(y={...y,...a.styles.dayRangeEnd}),pa&&((Ca=a.styles)!=null&&Ca.dayDisabled)&&(y={...y,...a.styles.dayDisabled}),t("button",{key:oa,class:u(`${n}-day`,{[`${n}-day-other-month`]:!ea,[`${n}-day-today`]:da,[`${n}-day-selected`]:N||C,[`${n}-day-disabled`]:pa,[`${n}-day-in-range`]:ua,[`${n}-day-range-start`]:N,[`${n}-day-range-end`]:C},(Ia=a.classNames)==null?void 0:Ia.day,da&&(($a=a.classNames)==null?void 0:$a.dayToday),(N||C)&&((Ea=a.classNames)==null?void 0:Ea.daySelected),ua&&((Ba=a.classNames)==null?void 0:Ba.dayInRange),N&&((Ta=a.classNames)==null?void 0:Ta.dayRangeStart),C&&((Ma=a.classNames)==null?void 0:Ma.dayRangeEnd),pa&&((Ya=a.classNames)==null?void 0:Ya.dayDisabled)),style:y,disabled:pa,onClick:()=>Qa(m),onMouseenter:()=>{D.value==="end"&&(E.value=m)},onMouseleave:()=>{D.value==="end"&&(E.value=null)}},[m.getDate()])})])])])}return()=>{var s,l,d,v,h,B,T,M,Y,H,O,A,V,_;return t(un,null,[t("div",{ref:na,class:u(`${n}`,`${n}-range`,`${n}-${a.size}`,{[`${n}-open`]:aa.value,[`${n}-disabled`]:ca.value,[`${n}-status-error`]:a.status==="error",[`${n}-status-warning`]:a.status==="warning"},(s=a.classNames)==null?void 0:s.root),style:(l=a.styles)==null?void 0:l.root,onClick:Ja},[t("span",{class:u(`${n}-input`,(d=a.classNames)==null?void 0:d.input),style:(v=a.styles)==null?void 0:v.input},[t("input",{readonly:!0,value:ja.value,placeholder:g.value[0],disabled:za.value,class:u(`${n}-input-inner`,(h=a.classNames)==null?void 0:h.startInput),style:(B=a.styles)==null?void 0:B.startInput},null),t("span",{class:u(`${n}-range-separator`,(T=a.classNames)==null?void 0:T.separator),style:(M=a.styles)==null?void 0:M.separator},[a.separator]),t("input",{readonly:!0,value:Ka.value,placeholder:g.value[1],disabled:La.value,class:u(`${n}-input-inner`,(Y=a.classNames)==null?void 0:Y.endInput),style:(H=a.styles)==null?void 0:H.endInput},null),a.allowClear&&Ua.value&&!ca.value&&t("span",{class:u(`${n}-clear`,(O=a.classNames)==null?void 0:O.clear),style:(A=a.styles)==null?void 0:A.clear,onClick:Za},[i("✕")]),t("span",{class:u(`${n}-suffix`,(V=a.classNames)==null?void 0:V.suffix),style:(_=a.styles)==null?void 0:_.suffix},[i("📅")])])]),aa.value&&t(dn,{to:"body"},{default:()=>{var F,W,z,L,j,K,U,X;return[t("div",{ref:ya,class:u(`${n}-popup`,`${n}-range-popup`,(F=a.classNames)==null?void 0:F.popup),style:{position:"absolute",top:`${la.value.top}px`,left:`${la.value.left}px`,zIndex:1050,...(W=a.styles)==null?void 0:W.popup}},[t("div",{class:u(`${n}-range-wrapper`,(z=a.classNames)==null?void 0:z.rangeWrapper),style:(L=a.styles)==null?void 0:L.rangeWrapper},[a.presets&&a.presets.length>0&&t("div",{class:u(`${n}-presets`,(j=a.classNames)==null?void 0:j.presets),style:(K=a.styles)==null?void 0:K.presets},[t("ul",null,[a.presets.map(q=>{var J,m;return t("li",{key:q.label,class:u(`${n}-preset`,(J=a.classNames)==null?void 0:J.preset),style:(m=a.styles)==null?void 0:m.preset,onClick:()=>Ga(q)},[q.label])})])]),t("div",{class:u(`${n}-range-panels`,(U=a.classNames)==null?void 0:U.rangePanels),style:(X=a.styles)==null?void 0:X.rangePanels},[wa(P.value,b.value,"left"),wa(Fa.value,Wa.value,"right")])])])]}})])}}}),bn=Q({__name:"RangePickerBasic",setup(a){const e=w([null,null]);return(n,p)=>(G(),ga(k(Va),{direction:"vertical"},{default:$(()=>[t(k(x),{value:e.value,"onUpdate:value":p[0]||(p[0]=o=>e.value=o)},null,8,["value"]),c("span",null,"选择范围："+Ha(e.value[0])+" ~ "+Ha(e.value[1]),1)]),_:1}))}}),vn=`<template>
...
`,Dn=Q({__name:"RangePickerDisabled",setup(a){return(e,n)=>(G(),ga(k(Va),{direction:"vertical"},{default:$(()=>[t(k(x),{disabled:[!0,!1]}),t(k(x),{disabled:"",value:["2024-01-01","2024-01-31"]})]),_:1}))}}),Rn=`<template>
  <Space direction="vertical">
...
import { RangePicker, Space } from 'ant-design-hmfw'
<\/script>
`,Pn=Q({__name:"RangePickerPresets",setup(a){function e(g){const S=new Date;return S.setDate(S.getDate()-g),S.toISOString().slice(0,10)}function n(){return new Date().toISOString().slice(0,10)}const p=[{label:"最近 7 天",value:[e(7),n()]},{label:"最近 14 天",value:[e(14),n()]},{label:"最近 30 天",value:()=>[e(30),n()]}];function o(g){console.log("range:",g)}return(g,S)=>(G(),ga(k(x),{presets:p,onChange:o}))}}),qn=`<template>
