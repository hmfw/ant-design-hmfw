import{C as o,a as y}from"./index-D-ih3MRU.js";import{o as m,A as p,i as c,R as n,h as d,K as a,n as r,m as s,E as g,k as f,J as h,H as x,l as v}from"./index-C7r7ERgN.js";import"./cls-S9IiI6wd.js";const w=m({__name:"CardBasic",setup(u){return(i,e)=>(p(),c(a(o),{title:"卡片标题",style:{width:"300px"}},{default:n(()=>[...e[0]||(e[0]=[d("p",null,"卡片内容",-1),d("p",null,"卡片内容",-1),d("p",null,"卡片内容",-1)])]),_:1}))}}),_=`<template>
...
<\/script>
`,k=m({__name:"CardCover",setup(u){return(i,e)=>(p(),c(a(o),{style:{width:"300px"}},{cover:n(()=>[...e[0]||(e[0]=[d("img",{alt:"example",src:"https://gw.alipayobjects.com/zos/rmsportal/JiqGstEfoWAOHiTxclqi.png",style:{width:"100%"}},null,-1)])]),default:n(()=>[r(a(y),{title:"卡片标题",description:"这是卡片的描述信息"})]),_:1}))}}),G=`<template>
...
<\/script>
`,S=m({__name:"CardGrid",setup(u){return(i,e)=>(p(),c(a(o),{title:"网格卡片"},{default:n(()=>[r(a(o).Grid,null,{default:n(()=>[...e[0]||(e[0]=[s("内容 1",-1)])]),_:1}),r(a(o).Grid,null,{default:n(()=>[...e[1]||(e[1]=[s("内容 2",-1)])]),_:1}),r(a(o).Grid,null,{default:n(()=>[...e[2]||(e[2]=[s("内容 3",-1)])]),_:1}),r(a(o).Grid,null,{default:n(()=>[...e[3]||(e[3]=[s("内容 4",-1)])]),_:1}),r(a(o).Grid,null,{default:n(()=>[...e[4]||(e[4]=[s("内容 5",-1)])]),_:1}),r(a(o).Grid,null,{default:n(()=>[...e[5]||(e[5]=[s("内容 6",-1)])]),_:1})]),_:1}))}}),T=`<template>
  <Card title="网格卡片">
...
import { Card } from 'ant-design-hmfw'
<\/script>
`,B=m({__name:"CardInner",setup(u){return(i,e)=>(p(),c(a(o),{type:"inner",title:"内部卡片"},{default:n(()=>[...e[0]||(e[0]=[d("p",null,'type="inner" 用于卡片内部嵌套展示。',-1)])]),_:1}))}}),M=`<template>
...
import { Card } from 'ant-design-hmfw'
<\/script>
`,K=m({__name:"CardLoading",setup(u){const i=g(!0);return(e,b)=>(p(),c(a(o),{title:"卡片标题",loading:i.value,style:{width:"300px"}},{default:n(()=>[...b[0]||(b[0]=[d("p",null,"卡片内容",-1),d("p",null,"卡片内容",-1)])]),_:1},8,["loading"]))}}),A=`<template>
...
import { Card } from 'ant-design-hmfw'
<\/script>
`,P=m({__name:"CardTabs",setup(u){const i=[{key:"tab1",label:"选项卡一"},{key:"tab2",label:"选项卡二"},{key:"tab3",label:"选项卡三"}],e={tab1:"选项卡一的内容",tab2:"选项卡二的内容",tab3:"选项卡三的内容"},b=g("tab1"),t=l=>{b.value=l,console.log("Tab changed:",l)};return(l,C)=>(p(),c(a(o),{title:"卡片标题","tab-list":i,"active-tab-key":b.value,onTabChange:t},{tabBarExtraContent:n(()=>[...C[0]||(C[0]=[d("a",{href:"#"},"更多",-1)])]),default:n(()=>[d("p",null,h(e[b.value]),1)]),_:1},8,["active-tab-key"]))}}),q=`<template>
