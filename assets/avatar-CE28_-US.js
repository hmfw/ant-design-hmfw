import{A as p,a as g}from"./Avatar-RBkJ9MAy.js";import{d as m,o as r,b as i,c as s,e as n,w as o,g as l,f as t,_ as k,h as v,i as x}from"./index-DCNtHlH3.js";import{U as f}from"./UserOutlined-CikfPcWP.js";import"./cls-S9IiI6wd.js";const y={style:{display:"flex",gap:"16px","align-items":"center"}},b=m({__name:"AvatarBasic",setup(d){return(c,a)=>(r(),i("div",y,[s(n(p),{size:64,src:"https://api.dicebear.com/7.x/miniavs/svg?seed=1"}),s(n(p),{size:64},{default:o(()=>[...a[0]||(a[0]=[l(" U ",-1)])]),_:1}),s(n(p),{size:64,style:{"background-color":"#87d068"}},{default:o(()=>[...a[1]||(a[1]=[l(" USER ",-1)])]),_:1})]))}}),A=`<template>
...
<\/script>
`,h={style:{display:"flex","flex-direction":"column",gap:"24px"}},q={style:{display:"flex",gap:"16px","align-items":"center"}},w={style:{display:"flex",gap:"16px","align-items":"center"}},z={style:{display:"flex",gap:"16px","align-items":"center"}},S={style:{display:"flex",gap:"16px","align-items":"center"}},N={style:{display:"flex",gap:"16px","align-items":"center"}},C=m({__name:"AvatarClassNames",setup(d){return(c,a)=>(r(),i("div",h,[t("div",null,[a[2]||(a[2]=t("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义根容器样式：",-1)),t("div",q,[s(n(p),{"class-names":{root:"gradient-avatar"}},{default:o(()=>[...a[0]||(a[0]=[l("U",-1)])]),_:1}),s(n(p),{"class-names":{root:"gradient-avatar"},shape:"square"},{default:o(()=>[...a[1]||(a[1]=[l("U",-1)])]),_:1}),s(n(p),{src:"https://i.pravatar.cc/150?img=1","class-names":{root:"gradient-avatar"}})])]),t("div",null,[a[3]||(a[3]=t("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义图片样式：",-1)),t("div",w,[s(n(p),{src:"https://i.pravatar.cc/150?img=2","class-names":{img:"custom-img"},size:"{64}"}),s(n(p),{src:"https://i.pravatar.cc/150?img=3","class-names":{img:"custom-img"},size:"{64}",shape:"square"})])]),t("div",null,[a[7]||(a[7]=t("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义文本容器样式：",-1)),t("div",z,[s(n(p),{"class-names":{string:"text-glow"},size:"{64}"},{default:o(()=>[...a[4]||(a[4]=[l("A",-1)])]),_:1}),s(n(p),{"class-names":{string:"text-glow"},size:"{64}"},{default:o(()=>[...a[5]||(a[5]=[l("李",-1)])]),_:1}),s(n(p),{"class-names":{string:"text-glow"},size:"{64}",shape:"square"},{default:o(()=>[...a[6]||(a[6]=[l("Vue",-1)])]),_:1})])]),t("div",null,[a[9]||(a[9]=t("div",{style:{"margin-bottom":"8px",color:"#666"}},"组合使用多个 key：",-1)),t("div",S,[s(n(p),{"class-names":{root:"gradient-avatar",string:"text-glow"},size:"{64}"},{default:o(()=>[...a[8]||(a[8]=[l(" K ",-1)])]),_:1}),s(n(p),{src:"https://i.pravatar.cc/150?img=4","class-names":{root:"gradient-avatar",img:"custom-img"},size:"{64}"})])]),t("div",null,[a[11]||(a[11]=t("div",{style:{"margin-bottom":"8px",color:"#666"}},"使用内联样式：",-1)),t("div",N,[s(n(p),{styles:{root:{background:"linear-gradient(135deg, #667eea 0%, #764ba2 100%)",border:"3px solid #fff",boxShadow:"0 4px 12px rgba(102, 126, 234, 0.4)"},string:{color:"#fff",fontWeight:"bold"}},size:"{64}"},{default:o(()=>[...a[10]||(a[10]=[l(" JS ",-1)])]),_:1}),s(n(p),{src:"https://i.pravatar.cc/150?img=5",styles:{root:{borderRadius:"12px",boxShadow:"0 4px 16px rgba(0, 0, 0, 0.15)"},img:{filter:"grayscale(50%)"}},size:"{64}",shape:"square"})])])]))}}),_=k(C,[["__scopeId","data-v-6edf3561"]]),B=`<template>
