import{C as d,a as h}from"./index-vZ0hVjoJ.js";import{d as u,o as i,q as b,w as s,f as t,e as o,b as g,c as e,_ as y,g as l,r as f,A as x,h as C,i as v}from"./index-DZWA4HiS.js";import"./cls-S9IiI6wd.js";const w=u({__name:"CardBasic",setup(c){return(p,n)=>(i(),b(o(d),{title:"卡片标题",style:{width:"300px"}},{default:s(()=>[...n[0]||(n[0]=[t("p",null,"卡片内容",-1),t("p",null,"卡片内容",-1),t("p",null,"卡片内容",-1)])]),_:1}))}}),q=`<template>
...
`,K=u({__name:"CardCover",setup(c){return(p,n)=>(i(),b(o(d),{style:{width:"300px"}},{cover:s(()=>[...n[0]||(n[0]=[t("img",{alt:"example",src:"https://gw.alipayobjects.com/zos/rmsportal/JiqGstEfoWAOHiTxclqi.png",style:{width:"100%"}},null,-1)])]),default:s(()=>[e(o(h),{title:"卡片标题",description:"这是卡片的描述信息"})]),_:1}))}}),L=`<template>
...
import { Card } from '@hmfw/ant-design'
<\/script>
`,W=u({__name:"CardLoading",setup(c){const p=f(!0);return(n,m)=>(i(),b(o(d),{title:"卡片标题",loading:p.value,style:{width:"300px"}},{default:s(()=>[...m[0]||(m[0]=[t("p",null,"卡片内容",-1),t("p",null,"卡片内容",-1)])]),_:1},8,["loading"]))}}),O=`<template>
