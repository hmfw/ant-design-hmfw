import{B as I}from"./Button-D7tvIoj2.js";import{S as W}from"./Space-ChZCQvS5.js";import{d as T,u as H,j as X,c as o,g as y,a as C,r as B,p as Z,o as q,b as $,f as c,e as l,w as r,A as Y,K as U,L as P,_ as z,q as _,m as G,h as ee,i as te}from"./index-cgVI-orz.js";import{c as E}from"./cls-S9IiI6wd.js";import{I as F,a as ne}from"./Input-D_nx9wMp.js";import{S as ae}from"./Select-DDreAcsa.js";import{S as se}from"./Switch-DczXr117.js";import{I as Q}from"./InputNumber-vT8DnS1h.js";import"./LoadingOutlined-BnULcwLn.js";import"./CloseOutlined-H_Tga8k8.js";import"./EyeOutlined-DUMo4AyN.js";import"./SearchOutlined-D1bsU5bV.js";import"./DownOutlined-Lt7RJDf6.js";import"./Trigger-WY8NmOER.js";import"./VirtualList-L6q9UIex.js";const D=Symbol("form-context");function oe(e){return e==null||e===""?"":Array.isArray(e)?e.join("."):String(e)}function le(e,n){if(!e)return;if(!Array.isArray(n))return e[String(n)];let t=e;for(const s of n){if(t==null)return;t=t[String(s)]}return t}async function re(e,n){for(const t of n){if(t.required&&(e==null||e===""))return t.message??"此字段为必填项";if(t.min!==void 0&&typeof e=="string"&&e.length<t.min)return t.message??`最少 ${t.min} 个字符`;if(t.max!==void 0&&typeof e=="string"&&e.length>t.max)return t.message??`最多 ${t.max} 个字符`;if(t.pattern&&!t.pattern.test(String(e??"")))return t.message??"格式不正确";if(t.type==="email"&&e&&!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(String(e)))return t.message??"请输入有效的邮箱地址";if(t.validator)try{await t.validator(t,e)}catch(s){return(s==null?void 0:s.message)??String(s)??"验证失败"}}return null}function de(){const e=X(D,void 0);return{validate:async n=>{if(!e)return!0;const t=n??Object.keys(e.rules);return(await Promise.all(t.map(a=>e.validateField(a)))).every(Boolean)},validateFields:async n=>{if(!e)return{};const t=n??Object.keys(e.rules);if((await Promise.all(t.map(a=>e.validateField(a)))).every(Boolean))return e.model;throw{values:e.model,errorFields:Object.entries(e.errors).map(([a,d])=>({name:a,errors:[d]}))}},resetFields:()=>{e&&Object.keys(e.errors).forEach(n=>e.clearError(n))},clearValidate:n=>{if(!e)return;(n??Object.keys(e.errors)).forEach(s=>e.clearError(s))},getFieldValue:n=>{var t;return(t=e==null?void 0:e.model)==null?void 0:t[n]},getFieldsValue:()=>(e==null?void 0:e.model)??{},setFieldValue:(n,t)=>{e!=null&&e.model&&(e.model[n]=t)},setFieldsValue:n=>{e!=null&&e.model&&Object.entries(n).forEach(([t,s])=>{e.model[t]=s})},getFieldsError:n=>e?(n??Object.keys(e.rules)).map(s=>({name:s,errors:e.errors[s]?[e.errors[s]]:[]})):[],getFieldError:n=>e!=null&&e.errors[n]?[e.errors[n]]:[],isFieldsTouched:(n,t=!1)=>{if(!e)return!1;const s=n??Object.keys(e.rules);return t?s.every(a=>e.touched[a]):s.some(a=>e.touched[a])},isFieldTouched:n=>(e==null?void 0:e.touched[n])??!1,isFieldsValidating:n=>!1,scrollToField:n=>{var a;const s=document.querySelector(`[data-field-name="${n}"]`)??document.querySelector(".hmfw-form-item-has-error");(a=s==null?void 0:s.scrollIntoView)==null||a.call(s,{block:"nearest",behavior:"smooth"})}}}const S=T({name:"Form",props:{model:Object,rules:Object,layout:{type:String,default:"horizontal"},labelCol:Object,wrapperCol:Object,colon:{type:Boolean,default:!0},labelAlign:{type:String,default:"right"},size:{type:String,default:"middle"},disabled:Boolean,scrollToFirstError:Boolean,validateTrigger:{type:[String,Array],default:"change"},requiredMark:{type:[Boolean,String],default:!0},preserve:{type:Boolean,default:!1},classNames:Object,styles:Object},emits:["finish","finishFailed","valuesChange"],setup(e,{slots:n,emit:t,expose:s}){const a=H("form"),d=B({}),k=B({}),g=async u=>{var O;const m=(O=e.rules)==null?void 0:O[u];if(!m)return!0;const b=Array.isArray(m)?m:[m],x=u.includes(".")?u.split("."):u,N=le(e.model,x),R=await re(N,b);if(R)return d.value={...d.value,[u]:R},!1;const A={...d.value};return delete A[u],d.value=A,!0},v=()=>{var m;const u=document.querySelector(`.${a}-item-has-error`);(m=u==null?void 0:u.scrollIntoView)==null||m.call(u,{block:"nearest",behavior:"smooth"})};Z(D,{get model(){return e.model??{}},get rules(){return e.rules??{}},get layout(){return e.layout},get colon(){return e.colon},get labelAlign(){return e.labelAlign},get size(){return e.size},get disabled(){return e.disabled??!1},get labelCol(){return e.labelCol},get wrapperCol(){return e.wrapperCol},get validateTrigger(){return e.validateTrigger??"change"},get requiredMark(){return e.requiredMark??!0},get preserve(){return e.preserve??!1},get errors(){return d.value},get touched(){return k.value},setError:(u,m)=>{d.value={...d.value,[u]:m}},clearError:u=>{const m={...d.value};delete m[u],d.value=m},validateField:g,notifyValueChange:(u,m)=>{t("valuesChange",{[u]:m},e.model??{})},setFieldTouched:(u,m)=>{k.value={...k.value,[u]:m}}});const i=async()=>{const u=Object.keys(e.rules??{});(await Promise.all(u.map(g))).every(Boolean)?t("finish",e.model):(t("finishFailed",{values:e.model,errorFields:Object.entries(d.value).map(([x,N])=>({name:x,errors:[N]}))}),e.scrollToFirstError&&v())},p=u=>{u.preventDefault(),i()},w=async u=>{const m=u??Object.keys(e.rules??{});if((await Promise.all(m.map(g))).every(Boolean))return e.model;throw{values:e.model,errorFields:Object.entries(d.value).map(([x,N])=>({name:x,errors:[N]}))}},h=u=>{const m=u??Object.keys(d.value),b={...d.value};m.forEach(x=>{delete b[x]}),d.value=b};return s({validate:w,validateFields:w,clearValidate:h,resetFields:()=>h(),submit:i,scrollToField:u=>{var b;const m=document.querySelector(`[data-field-name="${u}"]`)??document.querySelector(`.${a}-item-has-error`);(b=m==null?void 0:m.scrollIntoView)==null||b.call(m,{block:"nearest",behavior:"smooth"})},getFieldsValue:()=>e.model??{},getFieldsError:u=>(u??Object.keys(e.rules??{})).map(b=>({name:b,errors:d.value[b]?[d.value[b]]:[]})),isFieldsTouched:(u,m=!1)=>{const b=u??Object.keys(e.rules??{});return m?b.every(x=>k.value[x]):b.some(x=>k.value[x])}}),()=>{var u,m,b;return o("form",{class:E(a,`${a}-${e.layout}`,{[`${a}-${e.size}`]:e.size!=="middle",[`${a}-hide-required-mark`]:e.requiredMark===!1},(u=e.classNames)==null?void 0:u.root),style:(m=e.styles)==null?void 0:m.root,onSubmit:p},[(b=n.default)==null?void 0:b.call(n)])}}});function K(e){if(!e)return;const n={};return e.span!==void 0&&(n.flex=`0 0 ${e.span/24*100}%`),e.offset!==void 0&&(n.marginLeft=`${e.offset/24*100}%`),n}const f=T({name:"FormItem",props:{name:[String,Number,Array],label:String,rules:[Object,Array],required:Boolean,colon:{type:Boolean,default:void 0},labelCol:Object,wrapperCol:Object,validateStatus:String,help:String,extra:String,hasFeedback:Boolean,noStyle:Boolean,hidden:Boolean,tooltip:String,validateTrigger:[String,Array],classNames:Object,styles:Object},setup(e,{slots:n}){const t=H("form"),s=X(D,void 0),a=C(()=>oe(e.name)),d=C(()=>e.validateStatus==="error"&&e.help?e.help:a.value?s==null?void 0:s.errors[a.value]:void 0),k=C(()=>e.validateStatus?e.validateStatus:d.value?"error":""),g=C(()=>{if(e.required)return!0;const h=e.rules??(s==null?void 0:s.rules[a.value]);return h?(Array.isArray(h)?h:[h]).some(V=>V.required):!1}),v=C(()=>e.colon!==void 0?e.colon:(s==null?void 0:s.colon)??!0),i=C(()=>e.labelCol??(s==null?void 0:s.labelCol)),p=C(()=>e.wrapperCol??(s==null?void 0:s.wrapperCol)),w=C(()=>(s==null?void 0:s.layout)==="horizontal"||(s==null?void 0:s.layout)===void 0);return e.noStyle?()=>{var h;return(h=n.default)==null?void 0:h.call(n)}:e.hidden?()=>{var h;return o("div",{style:{display:"none"}},[(h=n.default)==null?void 0:h.call(n)])}:()=>{var u,m,b,x,N,R,A,O,L,M,J;const h=w.value?K(i.value):void 0,j=w.value?K(p.value):void 0,V=(s==null?void 0:s.requiredMark)==="optional"&&!g.value;return o("div",{class:E(`${t}-item`,{[`${t}-item-has-error`]:k.value==="error",[`${t}-item-has-warning`]:k.value==="warning",[`${t}-item-has-success`]:k.value==="success",[`${t}-item-required`]:g.value&&(s==null?void 0:s.requiredMark)!==!1},(u=e.classNames)==null?void 0:u.root),style:(m=e.styles)==null?void 0:m.root},[(e.label!==void 0||n.label)&&o("div",{class:E(`${t}-item-label`,(b=e.classNames)==null?void 0:b.label),style:{...h,...(x=e.styles)==null?void 0:x.label}},[o("label",{class:E({[`${t}-item-no-colon`]:!v.value})},[n.label?n.label():e.label,e.tooltip&&o("span",{class:`${t}-item-tooltip`,title:e.tooltip},[y("ⓘ")]),V&&o("span",{class:`${t}-item-optional`},[y("（可选）")])])]),o("div",{class:E(`${t}-item-control`,(N=e.classNames)==null?void 0:N.control),style:{...j,...(R=e.styles)==null?void 0:R.control}},[o("div",{class:`${t}-item-control-input`},[(A=n.default)==null?void 0:A.call(n)]),(d.value||e.help)&&o("div",{class:E(`${t}-item-explain`,{[`${t}-item-explain-error`]:k.value==="error",[`${t}-item-explain-warning`]:k.value==="warning",[`${t}-item-explain-success`]:k.value==="success"},(O=e.classNames)==null?void 0:O.feedback),style:(L=e.styles)==null?void 0:L.feedback},[d.value??e.help]),e.extra&&o("div",{class:E(`${t}-item-extra`,(M=e.classNames)==null?void 0:M.extra),style:(J=e.styles)==null?void 0:J.extra},[e.extra])])])}}});S.Item=f;S.useForm=de;const pe={class:"form-advanced-api-demo"},ce={key:0,style:{"margin-top":"16px",padding:"12px",background:"#f5f5f5","border-radius":"4px"}},ue=T({__name:"FormAdvancedApi",setup(e){const n=B(),t=P({username:"",email:"",password:""}),s={username:[{required:!0,message:"请输入用户名"}],email:[{required:!0,message:"请输入邮箱"},{type:"email",message:"请输入有效的邮箱地址"}],password:[{required:!0,message:"请输入密码"},{min:6,message:"密码至少6个字符"}]},a=B(""),d=async()=>{var i;try{await((i=n.value)==null?void 0:i.validate()),a.value="✅ 表单验证通过"}catch(p){a.value=`❌ 表单验证失败
`+JSON.stringify(p,null,2)}},k=()=>{var p;const i=(p=n.value)==null?void 0:p.getFieldsError();a.value=`getFieldsError() 结果：
`+JSON.stringify(i,null,2)},g=()=>{var w,h;const i=(w=n.value)==null?void 0:w.isFieldsTouched(),p=(h=n.value)==null?void 0:h.isFieldsTouched(["username","email","password"],!0);a.value=`isFieldsTouched(): ${i}
isFieldsTouched(所有字段, true): ${p}`},v=()=>{var i;(i=n.value)==null||i.resetFields(),t.username="",t.email="",t.password="",a.value="表单已重置"};return(i,p)=>(q(),$("div",pe,[p[8]||(p[8]=c("h4",null,"批量查询 API 演示",-1)),o(l(S),{ref_key:"formRef",ref:n,model:t,rules:s,layout:"vertical",style:{"max-width":"600px"}},{default:r(()=>[o(l(f),{label:"用户名",name:"username"},{default:r(()=>[o(l(F),{value:t.username,"onUpdate:value":p[0]||(p[0]=w=>t.username=w),placeholder:"请输入用户名"},null,8,["value"])]),_:1}),o(l(f),{label:"邮箱",name:"email"},{default:r(()=>[o(l(F),{value:t.email,"onUpdate:value":p[1]||(p[1]=w=>t.email=w),placeholder:"请输入邮箱"},null,8,["value"])]),_:1}),o(l(f),{label:"密码",name:"password"},{default:r(()=>[o(l(F),{value:t.password,"onUpdate:value":p[2]||(p[2]=w=>t.password=w),type:"password",placeholder:"请输入密码"},null,8,["value"])]),_:1}),o(l(f),null,{default:r(()=>[o(l(W),null,{default:r(()=>[o(l(I),{type:"primary",onClick:d},{default:r(()=>[...p[3]||(p[3]=[y(" 验证表单 ",-1)])]),_:1}),o(l(I),{onClick:k},{default:r(()=>[...p[4]||(p[4]=[y(" 获取错误 ",-1)])]),_:1}),o(l(I),{onClick:g},{default:r(()=>[...p[5]||(p[5]=[y(" 检查触摸状态 ",-1)])]),_:1}),o(l(I),{onClick:v},{default:r(()=>[...p[6]||(p[6]=[y(" 重置 ",-1)])]),_:1})]),_:1})]),_:1})]),_:1},8,["model"]),a.value?(q(),$("div",ce,[p[7]||(p[7]=c("h5",null,"输出结果：",-1)),c("pre",null,Y(a.value),1)])):U("",!0)]))}}),ie=z(ue,[["__scopeId","data-v-4cd3ff97"]]),me=`<template>
...
`,fe=T({__name:"FormBasic",setup(e){const n=P({username:"",password:""}),t=a=>{console.log("表单提交：",a)},s=()=>{n.username="",n.password=""};return(a,d)=>(q(),_(l(S),{model:n,"label-col":{span:6},"wrapper-col":{span:18},style:{"max-width":"480px"},onFinish:t},{default:r(()=>[o(l(f),{label:"用户名",name:"username",rules:[{required:!0,message:"请输入用户名"}]},{default:r(()=>[o(l(F),{value:n.username,"onUpdate:value":d[0]||(d[0]=k=>n.username=k),placeholder:"请输入用户名"},null,8,["value"])]),_:1}),o(l(f),{label:"密码",name:"password",rules:[{required:!0,message:"请输入密码"}]},{default:r(()=>[o(l(ne),{value:n.password,"onUpdate:value":d[1]||(d[1]=k=>n.password=k),placeholder:"请输入密码"},null,8,["value"])]),_:1}),o(l(f),{"wrapper-col":{offset:6,span:18}},{default:r(()=>[o(l(I),{type:"primary","html-type":"submit"},{default:r(()=>[...d[2]||(d[2]=[y(" 提交 ",-1)])]),_:1}),o(l(I),{style:{"margin-left":"8px"},onClick:s},{default:r(()=>[...d[3]||(d[3]=[y(" 重置 ",-1)])]),_:1})]),_:1})]),_:1},8,["model"]))}}),ke=`<template>
  <Form
    :model="formState"
    :label-col="{ span: 6 }"
    :wrapper-col="{ span: 18 }"
...
<\/script>
`,ge={class:"demo-form-classnames"},ve={class:"demo-section"},be={class:"demo-section"},ye={class:"demo-section"},he={class:"demo-section"},Fe={class:"demo-section"},we={class:"demo-section"},xe=T({__name:"FormClassNames",setup(e){const n=P({username:"",email:"",required:"",nickname:"",address:"",combined:""});return(t,s)=>(q(),$("div",ge,[c("section",ve,[s[6]||(s[6]=c("h3",null,"1. 自定义标签样式",-1)),o(l(S),{model:n,"label-col":{span:6},"wrapper-col":{span:18},style:{"max-width":"480px"}},{default:r(()=>[o(l(f),{label:"用户名",name:"username","class-names":{label:"custom-label"}},{default:r(()=>[o(l(F),{value:n.username,"onUpdate:value":s[0]||(s[0]=a=>n.username=a),placeholder:"请输入用户名"},null,8,["value"])]),_:1})]),_:1},8,["model"])]),c("section",be,[s[7]||(s[7]=c("h3",null,"2. 自定义控件区域样式",-1)),o(l(S),{model:n,"label-col":{span:6},"wrapper-col":{span:18},style:{"max-width":"480px"}},{default:r(()=>[o(l(f),{label:"邮箱",name:"email","class-names":{control:"custom-control"}},{default:r(()=>[o(l(F),{value:n.email,"onUpdate:value":s[1]||(s[1]=a=>n.email=a),placeholder:"请输入邮箱"},null,8,["value"])]),_:1})]),_:1},8,["model"])]),c("section",ye,[s[8]||(s[8]=c("h3",null,"3. 自定义错误反馈样式",-1)),o(l(S),{model:n,"label-col":{span:6},"wrapper-col":{span:18},style:{"max-width":"480px"}},{default:r(()=>[o(l(f),{label:"必填项",name:"required","validate-status":"error",help:"这是一个自定义样式的错误信息","class-names":{feedback:"custom-feedback"}},{default:r(()=>[o(l(F),{value:n.required,"onUpdate:value":s[2]||(s[2]=a=>n.required=a),placeholder:"触发错误"},null,8,["value"])]),_:1})]),_:1},8,["model"])]),c("section",he,[s[9]||(s[9]=c("h3",null,"4. 自定义额外提示样式",-1)),o(l(S),{model:n,"label-col":{span:6},"wrapper-col":{span:18},style:{"max-width":"480px"}},{default:r(()=>[o(l(f),{label:"昵称",name:"nickname",extra:"这是额外的提示信息，可自定义样式","class-names":{extra:"custom-extra"}},{default:r(()=>[o(l(F),{value:n.nickname,"onUpdate:value":s[3]||(s[3]=a=>n.nickname=a),placeholder:"请输入昵称"},null,8,["value"])]),_:1})]),_:1},8,["model"])]),c("section",Fe,[s[10]||(s[10]=c("h3",null,"5. 自定义表单项根节点样式",-1)),o(l(S),{model:n,"label-col":{span:6},"wrapper-col":{span:18},style:{"max-width":"480px"}},{default:r(()=>[o(l(f),{label:"地址",name:"address","class-names":{root:"custom-item-root"}},{default:r(()=>[o(l(F),{value:n.address,"onUpdate:value":s[4]||(s[4]=a=>n.address=a),placeholder:"请输入地址"},null,8,["value"])]),_:1})]),_:1},8,["model"])]),c("section",we,[s[11]||(s[11]=c("h3",null,"6. 组合使用 + Form 根节点 styles",-1)),o(l(S),{model:n,"label-col":{span:6},"wrapper-col":{span:18},style:{"max-width":"480px"},styles:{root:{padding:"24px",background:"#f9f0ff",borderRadius:"12px"}}},{default:r(()=>[o(l(f),{label:"综合",name:"combined",extra:"组合演示","class-names":{root:"combined-item-root",label:"combined-label",control:"combined-control",extra:"combined-extra"}},{default:r(()=>[o(l(F),{value:n.combined,"onUpdate:value":s[5]||(s[5]=a=>n.combined=a),placeholder:"组合样式"},null,8,["value"])]),_:1})]),_:1},8,["model"])])]))}}),Se=z(xe,[["__scopeId","data-v-f9a7dbb6"]]),Ie=`<template>
...
`,qe={class:"form-dependency-demo"},Ce={key:0,style:{"margin-top":"16px",padding:"12px",background:"#f0f9ff","border-radius":"4px",border:"1px solid #91d5ff"}},Ne=T({__name:"FormDependency",setup(e){const n=B(),t=P({contactType:"email",contact:"",password:"",confirmPassword:"",needNotify:!1,notifyEmail:""}),s=[{value:"email",label:"邮箱"},{value:"phone",label:"手机号"}],a=B(""),d=C(()=>({contactType:[{required:!0,message:"请选择联系方式类型"}],contact:[{required:!0,message:"请输入联系方式"},t.contactType==="email"?{type:"email",message:"请输入有效的邮箱地址"}:{pattern:/^1[3-9]\d{9}$/,message:"请输入有效的手机号"}],password:[{required:!0,message:"请输入密码"},{min:6,message:"密码至少6个字符"}],confirmPassword:[{required:!0,message:"请确认密码"},{validator:(v,i)=>i&&i!==t.password?Promise.reject("两次输入的密码不一致"):Promise.resolve()}],notifyEmail:t.needNotify?[{required:!0,message:"请输入通知邮箱"},{type:"email",message:"请输入有效的邮箱地址"}]:[]}));G(()=>t.password,()=>{var v;t.confirmPassword&&((v=n.value)==null||v.validateFields(["confirmPassword"]).catch(()=>{}))}),G(()=>t.contactType,()=>{t.contact="",n.value&&n.value.clearValidate(["contact"])});const k=async()=>{var v;try{await((v=n.value)==null?void 0:v.validate()),a.value=`✅ 提交成功！
`+JSON.stringify(t,null,2)}catch{a.value="❌ 验证失败，请检查表单"}},g=()=>{var v;(v=n.value)==null||v.resetFields(),t.contactType="email",t.contact="",t.password="",t.confirmPassword="",t.needNotify=!1,t.notifyEmail="",a.value=""};return(v,i)=>(q(),$("div",qe,[i[8]||(i[8]=c("h4",null,"表单联动场景演示",-1)),o(l(S),{ref_key:"formRef",ref:n,model:t,rules:d.value,layout:"vertical",style:{"max-width":"600px"}},{default:r(()=>[o(l(f),{label:"联系方式类型",name:"contactType"},{default:r(()=>[o(l(ae),{value:t.contactType,"onUpdate:value":i[0]||(i[0]=p=>t.contactType=p),options:s,placeholder:"请选择"},null,8,["value"])]),_:1}),o(l(f),{label:t.contactType==="email"?"邮箱地址":"手机号码",name:"contact"},{default:r(()=>[o(l(F),{value:t.contact,"onUpdate:value":i[1]||(i[1]=p=>t.contact=p),placeholder:t.contactType==="email"?"请输入邮箱":"请输入手机号"},null,8,["value","placeholder"])]),_:1},8,["label"]),o(l(f),{label:"密码",name:"password"},{default:r(()=>[o(l(F),{value:t.password,"onUpdate:value":i[2]||(i[2]=p=>t.password=p),type:"password",placeholder:"请输入密码"},null,8,["value"])]),_:1}),o(l(f),{label:"确认密码",name:"confirmPassword"},{default:r(()=>[o(l(F),{value:t.confirmPassword,"onUpdate:value":i[3]||(i[3]=p=>t.confirmPassword=p),type:"password",placeholder:"请再次输入密码"},null,8,["value"])]),_:1}),o(l(f),{label:"是否需要通知",name:"needNotify"},{default:r(()=>[o(l(se),{checked:t.needNotify,"onUpdate:checked":i[4]||(i[4]=p=>t.needNotify=p)},null,8,["checked"])]),_:1}),t.needNotify?(q(),_(l(f),{key:0,label:"通知邮箱",name:"notifyEmail"},{default:r(()=>[o(l(F),{value:t.notifyEmail,"onUpdate:value":i[5]||(i[5]=p=>t.notifyEmail=p),placeholder:"请输入通知邮箱"},null,8,["value"])]),_:1})):U("",!0),o(l(f),null,{default:r(()=>[o(l(W),null,{default:r(()=>[o(l(I),{type:"primary",onClick:k},{default:r(()=>[...i[6]||(i[6]=[y(" 提交 ",-1)])]),_:1}),o(l(I),{onClick:g},{default:r(()=>[...i[7]||(i[7]=[y(" 重置 ",-1)])]),_:1})]),_:1})]),_:1})]),_:1},8,["model","rules"]),a.value?(q(),$("div",Ce,[c("pre",null,Y(a.value),1)])):U("",!0)]))}}),Te=z(Ne,[["__scopeId","data-v-7ad3e812"]]),Ee=`<template>
...
`,Be=T({__name:"FormInline",setup(e){const n=P({name:"",age:null}),t=s=>{console.log("搜索：",s)};return(s,a)=>(q(),_(l(S),{model:n,layout:"inline",onFinish:t},{default:r(()=>[o(l(f),{label:"姓名",name:"name"},{default:r(()=>[o(l(F),{value:n.name,"onUpdate:value":a[0]||(a[0]=d=>n.name=d),placeholder:"请输入姓名"},null,8,["value"])]),_:1}),o(l(f),{label:"年龄",name:"age"},{default:r(()=>[o(l(Q),{value:n.age,"onUpdate:value":a[1]||(a[1]=d=>n.age=d),placeholder:"年龄",style:{width:"100px"}},null,8,["value"])]),_:1}),o(l(f),null,{default:r(()=>[o(l(I),{type:"primary","html-type":"submit"},{default:r(()=>[...a[2]||(a[2]=[y(" 搜索 ",-1)])]),_:1})]),_:1})]),_:1},8,["model"]))}}),$e=`<template>
...
<\/script>
`,Pe=T({__name:"FormValidation",setup(e){const n=B(),t=P({email:"",phone:"",age:null}),s={email:[{required:!0,message:"请输入邮箱"},{type:"email",message:"请输入有效的邮箱地址"}],phone:[{required:!0,message:"请输入手机号"},{pattern:/^1[3-9]\d{9}$/,message:"请输入有效的手机号"}],age:[{required:!0,message:"请输入年龄"}]},a=async()=>{var k;try{await((k=n.value)==null?void 0:k.validate()),console.log("校验通过")}catch(g){console.log("校验失败：",g)}},d=()=>{var k;(k=n.value)==null||k.clearValidate()};return(k,g)=>(q(),_(l(S),{ref_key:"formRef",ref:n,model:t,rules:s,"label-col":{span:5},"wrapper-col":{span:19},style:{"max-width":"480px"}},{default:r(()=>[o(l(f),{label:"邮箱",name:"email"},{default:r(()=>[o(l(F),{value:t.email,"onUpdate:value":g[0]||(g[0]=v=>t.email=v),placeholder:"请输入邮箱"},null,8,["value"])]),_:1}),o(l(f),{label:"手机号",name:"phone"},{default:r(()=>[o(l(F),{value:t.phone,"onUpdate:value":g[1]||(g[1]=v=>t.phone=v),placeholder:"请输入手机号"},null,8,["value"])]),_:1}),o(l(f),{label:"年龄",name:"age"},{default:r(()=>[o(l(Q),{value:t.age,"onUpdate:value":g[2]||(g[2]=v=>t.age=v),min:1,max:120,placeholder:"请输入年龄",style:{width:"100%"}},null,8,["value"])]),_:1}),o(l(f),{"wrapper-col":{offset:5,span:19}},{default:r(()=>[o(l(I),{type:"primary",onClick:a},{default:r(()=>[...g[3]||(g[3]=[y(" 校验 ",-1)])]),_:1}),o(l(I),{style:{"margin-left":"8px"},onClick:d},{default:r(()=>[...g[4]||(g[4]=[y(" 清除校验 ",-1)])]),_:1})]),_:1})]),_:1},8,["model"]))}}),Re=`<template>
  <Form
    ref="formRef"
    :model="formState"
    :rules="rules"
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>form</span><span class="token punctuation">&gt;</span></span>
  ...
  <span class="token comment">&lt;!-- Form 级别 classNames --&gt;</span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>Form</span> <span class="token attr-name">:model</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>state<span class="token punctuation">&quot;</span></span> <span class="token attr-name">:class-names</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>{ root: &#39;my-form-root&#39; }<span class="token punctuation">&quot;</span></span><span class="token punctuation">&gt;</span></span>
    <span class="token comment">&lt;!-- FormItem 级别 classNames --&gt;</span>
    ...
    <span class="token punctuation">&gt;</span></span>
      <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>Input</span> <span class="token attr-name"><span class="token namespace">v-model:</span>value</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>state.username<span class="token punctuation">&quot;</span></span> <span class="token punctuation">/&gt;</span></span>
...
<span class="token selector">:deep(.my-form-root)</span> <span class="token punctuation">{</span>
...
<span class="token selector">:deep(.my-label)</span> <span class="token punctuation">{</span>
  <span class="token property">font-weight</span><span class="token punctuation">:</span> 600<span class="token punctuation">;</span>
<span class="token punctuation">}</span>

<span class="token selector">:deep(.my-control)</span> <span class="token punctuation">{</span>
  <span class="token property">border-left</span><span class="token punctuation">:</span> 2px solid #1890ff<span class="token punctuation">;</span>
  <span class="token property">padding-left</span><span class="token punctuation">:</span> 8px<span class="token punctuation">;</span>
<span class="token punctuation">}</span>

<span class="token selector">:deep(.my-feedback)</span> <span class="token punctuation">{</span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>style</span><span class="token punctuation">&gt;</span></span>
  ...
  <span class="token comment">&lt;!-- Form 级别 styles --&gt;</span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>Form</span> <span class="token attr-name">:model</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>state<span class="token punctuation">&quot;</span></span> <span class="token attr-name">:styles</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>{ root: { padding: &#39;24px&#39;, backgroundColor: &#39;#fafafa&#39; } }<span class="token punctuation">&quot;</span></span><span class="token punctuation">&gt;</span></span>
    <span class="token comment">&lt;!-- FormItem 级别 styles --&gt;</span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>FormItem</span>
      <span class="token attr-name">label</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>用户名<span class="token punctuation">&quot;</span></span>
      <span class="token attr-name">name</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>username<span class="token punctuation">&quot;</span></span>
