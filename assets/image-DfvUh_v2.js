import{S as B}from"./Space-BxAy7a4l.js";import{o as S,N as at,q as bt,Q as J,w as A,n as e,m as F,E as N,f as i,F as kt,c as ht,T as wt,t as yt,r as xt,B as It,A as U,i as W,R as x,K as p,h as _,H as Ct,k as jt,l as X}from"./index-Dewmb7_Q.js";import{I as R}from"./Icon-Dgvr5Blx.js";import{Z as ot,S as et,R as Rt,a as Pt,b as Vt}from"./ZoomOutOutlined-CzrwtUhD.js";import{c as D}from"./cls-S9IiI6wd.js";import{L as St}from"./LeftOutlined-BSF2yIO_.js";import{R as Et}from"./RightOutlined-ZZ0TtTWb.js";import{K as G}from"./event-CZUxRbwU.js";import{C as Tt}from"./CloseOutlined-z6AYgBVy.js";import{B as zt}from"./Button-DUKwImBM.js";import"./LoadingOutlined-BZSBBEZE.js";let L=0,st="";function _t(){typeof document>"u"||(L===0&&(st=document.body.style.overflow,document.body.style.overflow="hidden"),L+=1)}function nt(){typeof document>"u"||(L=Math.max(0,L-1),L===0&&(document.body.style.overflow=st))}function q(t){return t==null?null:typeof t=="function"?t():t}function H(t){return typeof t=="boolean"?t?{}:null:t??{}}function lt(t){let r=q(t.cover),l;xt(t.mask)?r||(r=t.mask):l=t.mask;let o=!0,u=!0;return typeof l=="boolean"?o=l:l&&typeof l=="object"&&(l.enabled!==void 0&&(o=l.enabled),l.closable!==void 0&&(u=l.closable)),{enabled:o,closable:u,coverNode:r}}const Y=()=>({x:0,y:0,rotate:0,scale:1,flipX:!1,flipY:!1}),rt=Symbol("PreviewGroup"),ct=S({name:"ImagePreview",props:{prefixCls:{type:String,required:!0},src:{type:String,default:""},alt:String,config:{type:Object,default:()=>({})},visible:{type:Boolean,default:!1},onClose:{type:Function,required:!0},onPrev:Function,onNext:Function,hasPrev:Boolean,hasNext:Boolean,current:Number,total:Number,countRender:Function},setup(t){const a=N(Y()),r=N(!1),l=i(()=>t.config.scaleStep??.5),o=i(()=>t.config.minScale??1),u=i(()=>t.config.maxScale??50),I=i(()=>t.config.movable!==!1),h=n=>{var f,g;(g=(f=t.config).onTransform)==null||g.call(f,{transform:{...a.value},action:n})},v=()=>{a.value=Y(),h("reset")};J(()=>t.visible,n=>{n?(a.value=Y(),_t()):nt()}),J(()=>t.src,()=>{r.value=!0,a.value=Y(),yt(()=>{r.value=!1})});const C=(n,f)=>{a.value={...a.value,scale:Math.min(Math.max(n,o.value),u.value)},h(f)},b=()=>C(a.value.scale*(1+l.value),"zoomIn"),y=()=>C(a.value.scale/(1+l.value),"zoomOut"),P=()=>{a.value={...a.value,rotate:a.value.rotate-90},h("rotateLeft")},E=()=>{a.value={...a.value,rotate:a.value.rotate+90},h("rotateRight")},$=()=>{a.value={...a.value,flipX:!a.value.flipX},h("flipX")},T=()=>{a.value={...a.value,flipY:!a.value.flipY},h("flipY")},z=n=>{var f,g;t.visible&&(n.key===G.ESCAPE?t.onClose():n.key===G.ARROW_LEFT&&t.hasPrev?(f=t.onPrev)==null||f.call(t):n.key===G.ARROW_RIGHT&&t.hasNext&&((g=t.onNext)==null||g.call(t)))};typeof window<"u"&&(window.addEventListener("keydown",z),A(()=>window.removeEventListener("keydown",z))),A(()=>{t.visible&&nt()});const s=n=>{n.preventDefault(),n.deltaY<0?b():y(),h("wheel")};let d=!1,j=0,V=0,M=0,c=0;const k=n=>{I.value&&(n.preventDefault(),d=!0,j=n.clientX,V=n.clientY,M=a.value.x,c=a.value.y,window.addEventListener("mousemove",Z),window.addEventListener("mouseup",O))},Z=n=>{d&&(a.value={...a.value,x:M+(n.clientX-j),y:c+(n.clientY-V)})},O=()=>{d&&(d=!1,window.removeEventListener("mousemove",Z),window.removeEventListener("mouseup",O),h("move"))};A(()=>{window.removeEventListener("mousemove",Z),window.removeEventListener("mouseup",O)});const dt=()=>{a.value.scale!==1?v():C(2,"doubleClick")},K=i(()=>lt(t.config)),Q=n=>{n.target===n.currentTarget&&K.value.closable&&t.onClose()},m=`${t.prefixCls}-preview`,it=()=>{const n=t.config.closeIcon;return n===!1?null:n?q(n):e(R,{component:Tt},null)},pt=i(()=>{const n=a.value,f=n.scale*(n.flipX?-1:1),g=n.scale*(n.flipY?-1:1);return{transform:`translate3d(${n.x}px, ${n.y}px, 0) scale3d(${f}, ${g}, 1) rotate(${n.rotate}deg)`,transition:d||r.value?"none":"transform 0.3s",willChange:"transform",cursor:I.value?"grab":"default"}}),tt=i(()=>({url:t.src,alt:t.alt})),ut=n=>{var f,g;n<0?(f=t.onPrev)==null||f.call(t):n>0&&((g=t.onNext)==null||g.call(t))},ft={onFlipY:T,onFlipX:$,onRotateLeft:P,onRotateRight:E,onZoomOut:y,onZoomIn:b,onReset:v,onClose:t.onClose,onActive:ut},mt=()=>e("div",{class:`${m}-operations`,onClick:n=>n.stopPropagation()},[e("button",{class:`${m}-op-btn`,onClick:$,title:"左右翻转"},[e(R,{component:et},null)]),e("button",{class:`${m}-op-btn`,onClick:T,title:"上下翻转"},[e(R,{component:et,rotate:90},null)]),e("button",{class:`${m}-op-btn`,onClick:P,title:"向左旋转"},[e(R,{component:Rt},null)]),e("button",{class:`${m}-op-btn`,onClick:E,title:"向右旋转"},[e(R,{component:Pt},null)]),e("button",{class:D(`${m}-op-btn`,{[`${m}-op-btn-disabled`]:a.value.scale<=o.value}),onClick:y,title:"缩小"},[e(R,{component:Vt},null)]),e("button",{class:D(`${m}-op-btn`,{[`${m}-op-btn-disabled`]:a.value.scale>=u.value}),onClick:b,title:"放大"},[e(R,{component:ot},null)])]),gt=()=>{const n=mt(),f=t.config.toolbarRender??t.config.actionsRender;return f?f(n,{transform:{...a.value},current:t.current,total:t.total,image:tt.value,actions:ft}):n},vt=()=>{const n=e("img",{src:t.src,alt:t.alt,class:`${m}-img`,style:pt.value,draggable:!1,onMousedown:k,onDblclick:dt,onClick:f=>f.stopPropagation()},null);return t.config.imageRender?t.config.imageRender(n,{transform:{...a.value},current:t.current,total:t.total,image:tt.value}):n};return()=>{const n=t.total!=null&&t.total>1;return e(wt,{to:"body"},{default:()=>[e(ht,{name:`${m}-fade`},{default:()=>[t.visible&&e("div",{class:`${m}-root`,style:t.config.zIndex!=null?{zIndex:t.config.zIndex}:void 0,onClick:Q},[e("div",{class:D(`${m}-mask`,{[`${m}-mask-hidden`]:!K.value.enabled})},null),e("button",{class:`${m}-close`,onClick:t.onClose,title:"关闭"},[it()]),e("div",{class:`${m}-wrap`,onClick:Q,onWheel:s},[vt()]),gt(),n&&e("div",{class:`${m}-count`},[t.countRender?t.countRender((t.current??0)+1,t.total):`${(t.current??0)+1} / ${t.total}`]),t.hasPrev&&e("button",{class:`${m}-switch ${m}-switch-left`,onClick:f=>{var g;f.stopPropagation(),(g=t.onPrev)==null||g.call(t)}},[e(R,{component:St},null)]),t.hasNext&&e("button",{class:`${m}-switch ${m}-switch-right`,onClick:f=>{var g;f.stopPropagation(),(g=t.onNext)==null||g.call(t)}},[e(R,{component:Et},null)])])]})]})}}}),w=S({name:"Image",inheritAttrs:!1,props:{src:String,alt:String,width:[Number,String],height:[Number,String],preview:{type:[Boolean,Object],default:!0},fallback:String,placeholder:{type:[Boolean,Object,Function],default:!1},rootClassName:String,onError:Function},setup(t,{attrs:a}){const r=at("image"),l=N("loading"),o=N(!1),u=bt(rt,null);J(()=>t.src,()=>{l.value="loading"});const I=()=>{l.value="loaded"},h=c=>{var k;l.value="error",(k=t.onError)==null||k.call(t,c)},v=i(()=>H(u?u.preview():t.preview)),C=i(()=>v.value!==null&&l.value!=="error"),b=i(()=>{var c,k;return((c=v.value)==null?void 0:c.open)??((k=v.value)==null?void 0:k.visible)}),y=i(()=>b.value!==void 0),P=i(()=>y.value?!!b.value:o.value),E=c=>{var Z,O;const k=v.value;k&&((Z=k.onOpenChange)==null||Z.call(k,c),(O=k.onVisibleChange)==null||O.call(k,c,!c))},$=c=>{y.value||(o.value=c),E(c)},T=()=>{var c;return{url:((c=v.value)==null?void 0:c.src)??t.src??"",alt:t.alt,width:t.width,height:t.height}},z=()=>{C.value&&(u?u.open(T):$(!0))};if(u){const c=u.register(T);A(c)}const s=i(()=>({width:typeof t.width=="number"?`${t.width}px`:t.width,height:typeof t.height=="number"?`${t.height}px`:t.height})),d=i(()=>l.value==="error"&&t.fallback?t.fallback:t.src),j=i(()=>{var c;return((c=v.value)==null?void 0:c.src)??t.src??""}),V=i(()=>v.value?lt(v.value):null),M=()=>{const c=t.placeholder;return c?c===!0?e("div",{class:`${r}-placeholder`},null):e("div",{class:`${r}-placeholder`},[q(c)]):null};return()=>{var c;return e("div",{class:D(r,t.rootClassName,a.class,{[`${r}-preview`]:C.value,[`${r}-error`]:l.value==="error"&&!t.fallback}),style:[s.value,a.style]},[l.value==="loading"&&M(),l.value==="error"&&!t.fallback?e("div",{class:`${r}-error-placeholder`},[e("span",null,[F("图片加载失败")])]):e("img",{src:d.value,alt:t.alt,class:`${r}-img`,onLoad:I,onError:h,onClick:z},null),C.value&&l.value==="loaded"&&((c=V.value)==null?void 0:c.enabled)&&e("div",{class:`${r}-mask`,onClick:z},[V.value.coverNode??e("span",{class:`${r}-mask-info`},[e(R,{component:ot},null),F(" "),e("span",null,[F("预览")])])]),!u&&v.value&&e(ct,{prefixCls:r,src:j.value,alt:t.alt,config:v.value,visible:P.value,onClose:()=>$(!1)},null)])}}}),Nt=S({name:"PreviewGroup",props:{preview:{type:[Boolean,Object],default:!0},items:{type:Array,default:void 0},current:Number,onChange:Function},setup(t,{slots:a}){const r=at("image"),l=N([]),o=N(0),u=N(!1),I=i(()=>H(t.preview)),h=i(()=>{var s,d;return((s=I.value)==null?void 0:s.open)??((d=I.value)==null?void 0:d.visible)}),v=i(()=>h.value!==void 0?!!h.value:u.value),C=i(()=>t.current),b=i(()=>C.value!==void 0?C.value:o.value),y=i(()=>t.items?t.items.map(s=>typeof s=="string"?{url:s}:s):l.value.map(s=>s())),P=s=>{var j;const d=b.value;t.current===void 0&&(o.value=s),s!==d&&((j=t.onChange)==null||j.call(t,s,d))},E=s=>{var j,V;h.value===void 0&&(u.value=s);const d=I.value;d&&((j=d.onOpenChange)==null||j.call(d,s),(V=d.onVisibleChange)==null||V.call(d,s,!s))};It(rt,{preview:()=>t.preview,register(s){return l.value.push(s),()=>{const d=l.value.indexOf(s);d>=0&&l.value.splice(d,1)}},open(s){const d=l.value.indexOf(s);P(d>=0?d:0),E(!0)}});const T=i(()=>{var s;return((s=y.value[b.value])==null?void 0:s.url)??""}),z=i(()=>{var s;return(s=y.value[b.value])==null?void 0:s.alt});return()=>{var s;return e(kt,null,[(s=a.default)==null?void 0:s.call(a),I.value&&e(ct,{prefixCls:r,src:T.value,alt:z.value,config:I.value,visible:v.value,current:b.value,total:y.value.length,hasPrev:b.value>0,hasNext:b.value<y.value.length-1,onPrev:()=>P(b.value-1),onNext:()=>P(b.value+1),onClose:()=>E(!1)},null)])}}}),$t=S({__name:"ImageBasic",setup(t){return(a,r)=>(U(),W(p(B),{wrap:""},{default:x(()=>[e(p(w),{src:"https://zos.alipayobjects.com/rmsportal/jkjgkEfvpUPVyRjUImniVslZfWPnJuuZ.png",width:"200"}),e(p(w),{src:"https://zos.alipayobjects.com/rmsportal/jkjgkEfvpUPVyRjUImniVslZfWPnJuuZ.png",width:"200",preview:!1}),e(p(w),{src:"error.jpg",width:"200",fallback:"https://zos.alipayobjects.com/rmsportal/jkjgkEfvpUPVyRjUImniVslZfWPnJuuZ.png"})]),_:1}))}}),Zt=`<template>
  <Space wrap>
...
<\/script>
`,Ot=S({__name:"ImageCustomPreview",setup(t){return(a,r)=>(U(),W(p(B),{wrap:""},{default:x(()=>[e(p(w),{src:"https://zos.alipayobjects.com/rmsportal/jkjgkEfvpUPVyRjUImniVslZfWPnJuuZ.png",width:"200",preview:{src:"https://zos.alipayobjects.com/rmsportal/jkjgkEfvpUPVyRjUImniVslZfWPnJuuZ.png",minScale:.5,maxScale:10,scaleStep:.2}}),e(p(w),{src:"https://gw.alipayobjects.com/zos/antfincdn/LlvErxo8H9/photo-1503185912284-5271ff81b9a8.webp",width:"200",preview:{mask:{enabled:!1}}}),e(p(w),{src:"https://gw.alipayobjects.com/zos/antfincdn/cV16ZqzMjW/photo-1473091540282-9b846e7965e3.webp",width:"200",preview:{closeIcon:!1}})]),_:1}))}}),Ft=`<template>
  <Space wrap>
    <Image
      src="https://zos.alipayobjects.com/rmsportal/jkjgkEfvpUPVyRjUImniVslZfWPnJuuZ.png"
      width="200"
...
import { Image, Space } from 'ant-design-hmfw'
<\/script>
`,Ut=S({__name:"ImagePlaceholder",setup(t){return(a,r)=>(U(),W(p(B),{direction:"vertical",size:16},{default:x(()=>[e(p(B),{wrap:""},{default:x(()=>[e(p(w),{src:"https://zos.alipayobjects.com/rmsportal/jkjgkEfvpUPVyRjUImniVslZfWPnJuuZ.png",width:"200",placeholder:""}),e(p(w),{src:"https://gw.alipayobjects.com/zos/antfincdn/LlvErxo8H9/photo-1503185912284-5271ff81b9a8.webp",width:"200",placeholder:""}),e(p(w),{src:"https://gw.alipayobjects.com/zos/antfincdn/cV16ZqzMjW/photo-1473091540282-9b846e7965e3.webp",width:"200",placeholder:""})]),_:1}),r[0]||(r[0]=_("p",{style:{color:"#999","font-size":"14px"}},"大图加载时显示占位动画",-1))]),_:1}))}}),Lt=`<template>
...
import { Image, Space } from 'ant-design-hmfw'
<\/script>
`,Bt=S({__name:"ImagePreviewGroup",setup(t){return(a,r)=>(U(),W(p(Nt),null,{default:x(()=>[e(p(B),null,{default:x(()=>[e(p(w),{src:"https://zos.alipayobjects.com/rmsportal/jkjgkEfvpUPVyRjUImniVslZfWPnJuuZ.png",width:"200"}),e(p(w),{src:"https://gw.alipayobjects.com/zos/antfincdn/LlvErxo8H9/photo-1503185912284-5271ff81b9a8.webp",width:"200"}),e(p(w),{src:"https://gw.alipayobjects.com/zos/antfincdn/cV16ZqzMjW/photo-1473091540282-9b846e7965e3.webp",width:"200"})]),_:1})]),_:1}))}}),Wt=`<template>
  <PreviewGroup>
    <Space>
      <Image src="https://zos.alipayobjects.com/rmsportal/jkjgkEfvpUPVyRjUImniVslZfWPnJuuZ.png" width="200" />
      <Image
...
<\/script>
`,Mt=S({__name:"ImageToolbarRender",setup(t){function a(l,o){return e("div",{style:"display:flex;flex-direction:column;align-items:center;gap:8px"},[l,e("div",{style:"display:flex;gap:12px;color:#fff;font-size:13px;align-items:center"},[e("span",null,[F("缩放 "),Math.round(o.transform.scale*100),F("%")]),e(zt,{onClick:o.actions.onReset,style:"padding:2px 10px;border:none;border-radius:4px;background:rgba(255,255,255,.2);color:#fff;cursor:pointer"},{default:()=>[F("重置")]})])])}function r(l,o){return e("div",{style:"padding:8px;border-radius:8px;background:rgba(255,255,255,.08)"},[l])}return(l,o)=>(U(),W(p(w),{src:"https://gw.alipayobjects.com/zos/antfincdn/LlvErxo8H9/photo-1503185912284-5271ff81b9a8.webp",width:"200",preview:{toolbarRender:a,imageRender:r}},null,8,["preview"]))}}),Yt=`<template>
  <Image
    src="https://gw.alipayobjects.com/zos/antfincdn/LlvErxo8H9/photo-1503185912284-5271ff81b9a8.webp"
    width="200"
