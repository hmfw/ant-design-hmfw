import{D as E}from"./index-Bm5kfGpi.js";import{o as f,N as L,n as r,F as j,s as S,r as H,A as b,i as g,K as o,k as V,h as n,J as F,E as K,p as $,R as u,H as U,m as l,l as z}from"./index-B09KCCs0.js";import{c as x}from"./cls-S9IiI6wd.js";import{I}from"./Icon-BGDem5mI.js";import{u as P,ak as W,O as J}from"./icons-n88SZ_u-.js";import{S as M}from"./Space-BXFZnpuO.js";import"./Menu-g55WhDag.js";import"./Button-mNkoEchB.js";function q(s){return typeof s=="function"||Object.prototype.toString.call(s)==="[object Object]"&&!H(s)}const G=(s,e)=>{if(e===void 0)return e;let a=(e||"").replace(/^\//,"");return Object.keys(s).forEach(d=>{a=a.replace(`:${d}`,s[d])}),a},Q=(s,e)=>{const{title:a}=s;if(a==null)return null;if(typeof a=="string"){const d=Object.keys(e).join("|");return a.replace(new RegExp(`:(${d})`,"g"),(t,i)=>e[i]||t)}return a},X=s=>{const e={};return Object.keys(s).forEach(a=>{(a.startsWith("data-")||a.startsWith("aria-"))&&(e[a]=s[a])}),e},p=f({name:"Breadcrumb",props:{items:Array,separator:{type:[String,Object],default:"/"},params:{type:Object,default:()=>({})},itemRender:Function},setup(s){const e=L("breadcrumb"),a=(d,t,i)=>{if(t==null)return null;const{className:y,onClick:c,menu:m,...h}=d,B={...X(h),onClick:c};if(m&&m.items&&m.items.length>0){const k=i!==void 0?r("a",S(B,{class:x(`${e}-link`,y),href:i}),[r("span",{class:`${e}-overlay-link`},[t,r(I,{component:P,style:"margin-left: 4px; font-size: 10px;"},null)])]):r("span",S(B,{class:x(`${e}-link`,y)}),[r("span",{class:`${e}-overlay-link`},[t,r(I,{component:P,style:"margin-left: 4px; font-size: 10px;"},null)])]);return r(E,{menu:m,trigger:["hover"]},q(k)?k:{default:()=>[k]})}return i!==void 0?r("a",S(B,{class:x(`${e}-link`,y),href:i}),[t]):r("span",S(B,{class:x(`${e}-link`,y)}),[t])};return()=>{const d=s.items??[],t=[],i=d.filter(c=>!("type"in c&&c.type==="separator")),y=d.map((c,m)=>{if("type"in c&&c.type==="separator"){const _=c;return r("li",{key:_.key??`separator-${m}`,class:`${e}-separator`,"aria-hidden":"true"},[_.separator===""?_.separator:_.separator||s.separator])}const h=c,{path:B,key:k,className:R,style:T}=h,v=G(s.params,B);v!==void 0&&t.push(v);const A=k??m,w=m===d.length-1,C=d[m+1],D=C&&"type"in C&&C.type==="separator";let{href:N}=h;t.length&&v!==void 0&&(N=`#/${t.join("/")}`);let O;if(s.itemRender)O=s.itemRender(h,s.params,i,[...t]);else{const _=Q(h,s.params);O=a(h,_,N)}return r(j,null,[r("li",{key:A,class:x(`${e}-item`,R),style:T,"aria-current":w?"page":void 0},[O]),!w&&!D&&r("li",{class:`${e}-separator`,"aria-hidden":"true"},[s.separator])])});return r("nav",{class:e,"aria-label":"breadcrumb"},[r("ol",null,[y])])}}}),Y=f({__name:"BreadcrumbBasic",setup(s){const e=[{title:"首页"},{title:"应用列表"},{title:"某应用"}];return(a,d)=>(b(),g(o(p),{items:e}))}}),Z=`<template>
...
<\/script>
`,tt={style:{"margin-top":"8px",color:"#666"}},et=f({__name:"BreadcrumbClick",setup(s){const e=K("无"),a=[{title:"首页",onClick:()=>{e.value="首页"}},{title:"应用列表",onClick:()=>{e.value="应用列表"}},{title:"某应用"}];return(d,t)=>(b(),V(j,null,[r(o(p),{items:a}),n("p",tt,"点击了："+F(e.value),1)],64))}}),rt=`<template>
  <Breadcrumb :items="items" />
...
<\/script>
`,nt=f({__name:"BreadcrumbIcon",setup(s){const e=[{title:$(I,{component:J}),href:"/"},{title:$("span",{},[$(I,{component:W}),$("span",{style:{marginLeft:"4px"}},"用户列表")]),href:"/users"},{title:"用户详情"}];return(a,d)=>(b(),g(o(p),{items:e}))}}),st=`<template>
  <Breadcrumb :items="items" />
</template>
...
<\/script>
`,ct=f({__name:"BreadcrumbSeparator",setup(s){const e=[{title:"首页",href:"/"},{title:"一级菜单",href:"/level1"},{title:"二级菜单"}];return(a,d)=>(b(),g(o(M),{direction:"vertical"},{default:u(()=>[r(o(p),{items:e,separator:">"}),r(o(p),{items:e,separator:"/"}),r(o(p),{items:e,separator:"|"})]),_:1}))}}),mt=`<template>
