...
<\/script>
`,S={style:{"border-bottom":"1px solid #e8e8e8","padding-bottom":"8px","margin-bottom":"8px"}},U={style:{"margin-top":"8px"}},w=f({__name:"CheckboxCheckAll",setup(m){const l=[{label:"选项 A",value:"A"},{label:"选项 B",value:"B"},{label:"选项 C",value:"C"},{label:"选项 D",value:"D"}],r=s(["A","B"]),a=s(!1),d=s(!0),o=c=>{r.value=c?l.map(k=>k.value):[],d.value=!1},t=c=>{d.value=!!c.length&&c.length<l.length,a.value=c.length===l.length};return(c,k)=>(h(),x("div",null,[e("div",S,[n(i(b),{checked:a.value,"onUpdate:checked":k[0]||(k[0]=C=>a.value=C),indeterminate:d.value,onChange:o},{default:p(()=>[...k[2]||(k[2]=[u(" 全选 ",-1)])]),_:1},8,["checked","indeterminate"])]),n(i(g),{value:r.value,"onUpdate:value":k[1]||(k[1]=C=>r.value=C),options:l,onChange:t},null,8,["value"]),e("p",U,"已选："+v(r.value),1)]))}}),E=`<template>
  <div>
...
<\/script>
`,q={style:{display:"flex","flex-direction":"column",gap:"16px"}},M=f({__name:"CheckboxSkipGroup",setup(m){const l=s(["a"]),r=s(!1),a=s(!0);return(d,o)=>(h(),x("div",q,[e("div",null,[o[7]||(o[7]=e("p",{style:{"margin-bottom":"8px"}},"基本用法：skipGroup 跳过 CheckboxGroup 控制",-1)),n(i(g),{value:l.value,"onUpdate:value":o[2]||(o[2]=t=>l.value=t)},{default:p(()=>[n(i(b),{value:"a"},{default:p(()=>[...o[3]||(o[3]=[u("A（受组控制）",-1)])]),_:1}),n(i(b),{value:"b"},{default:p(()=>[...o[4]||(o[4]=[u("B（受组控制）",-1)])]),_:1}),n(i(b),{value:"c","skip-group":"",checked:r.value,"onUpdate:checked":o[0]||(o[0]=t=>r.value=t)},{default:p(()=>[...o[5]||(o[5]=[u("C（独立控制，skipGroup）",-1)])]),_:1},8,["checked"]),n(i(b),{value:"d","skip-group":"",checked:a.value,"onUpdate:checked":o[1]||(o[1]=t=>a.value=t)},{default:p(()=>[...o[6]||(o[6]=[u("D（独立控制，skipGroup）",-1)])]),_:1},8,["checked"])]),_:1},8,["value"])]),e("div",null,[e("p",null,"组值："+v(l.value),1),e("p",null,"C 独立值："+v(r.value),1),e("p",null,"D 独立值："+v(a.value),1)]),o[8]||(o[8]=e("div",null,[e("p",{style:{"margin-bottom":"8px"}},"用例说明："),e("ul",{style:{margin:"0","padding-left":"20px"}},[e("li",null,"A 和 B 由 CheckboxGroup 统一管理，选中状态反映在 groupValue 中"),e("li",null,"C 和 D 设置了 skipGroup，不受组控制，需要各自的 v-model:checked"),e("li",null,"适用场景：表单中有些复选框需要独立验证或特殊处理")])],-1))]))}}),K=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px;">
    <div>
      ...
      <CheckboxGroup v-model:value="groupValue">
        ...
        <Checkbox value="c" skip-group v-model:checked="independentC">C（独立控制，skipGroup）</Checkbox>
        <Checkbox value="d" skip-group v-model:checked="independentD">D（独立控制，skipGroup）</Checkbox>
      </CheckboxGroup>
    </div>
    <div>
      <p>组值：{{ groupValue }}</p>
