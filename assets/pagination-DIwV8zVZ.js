import{S as x}from"./Space-BXFZnpuO.js";import{P as p}from"./Pagination-BLqQGhOq.js";import{o as b,A as g,i as S,R as u,h as e,n,K as o,J as z,E as h,p as f,H as P,k as w,m,l as y}from"./index-B09KCCs0.js";import"./cls-S9IiI6wd.js";import"./icons-n88SZ_u-.js";import"./Icon-BGDem5mI.js";import"./Select-BZuMXyo3.js";import"./VirtualList-DoIsak3W.js";const k=b({__name:"PaginationAlign",setup(v){return(r,i)=>(g(),S(o(x),{direction:"vertical",style:{width:"100%"}},{default:u(()=>[e("div",null,[i[0]||(i[0]=e("h4",null,"左对齐（默认）",-1)),n(o(p),{total:50})]),e("div",null,[i[1]||(i[1]=e("h4",null,"居中对齐",-1)),n(o(p),{total:50,align:"center"})]),e("div",null,[i[2]||(i[2]=e("h4",null,"右对齐",-1)),n(o(p),{total:50,align:"end"})]),e("div",null,[i[3]||(i[3]=e("h4",null,"完整功能 + 居中对齐",-1)),n(o(p),{total:500,"show-size-changer":"","show-quick-jumper":"","show-total":a=>`共 ${a} 条`,align:"center"},null,8,["show-total"])])]),_:1}))}}),C=`<template>
...
const current = ref(1)
<\/script>
`,N={style:{"margin-top":"8px",color:"#666"}},V=b({__name:"PaginationItemRender",setup(v){const r=h(1),i=(l,d,c)=>d==="prev"?f("a","上一页"):d==="next"?f("a","下一页"):c,a=(l,d,c)=>d==="page"?f("a",{style:{display:"inline-block",padding:"0 8px",border:"1px solid #d9d9d9",borderRadius:"4px",fontWeight:"bold"}},`[${l}]`):c,t=(l,d,c)=>d==="page"?f("a",{href:`#page-${l}`},l):d==="prev"?f("a",{href:"#prev"},"← 上一页"):d==="next"?f("a",{href:"#next"},"下一页 →"):c,s=l=>{r.value=l};return(l,d)=>(g(),S(o(x),{direction:"vertical",style:{width:"100%"}},{default:u(()=>[e("div",null,[d[0]||(d[0]=e("h4",null,"自定义上一页/下一页文本",-1)),n(o(p),{total:50,"item-render":i})]),e("div",null,[d[1]||(d[1]=e("h4",null,"自定义页码样式",-1)),n(o(p),{total:100,"item-render":a})]),e("div",null,[d[2]||(d[2]=e("h4",null,"链接模式",-1)),n(o(p),{total:50,"item-render":t,onChange:s}),e("p",N,"点击页码查看链接效果（当前页："+z(r.value)+"）",1)])]),_:1}))}}),j=`<template>
  <Space direction="vertical" style="width: 100%">
    <div>
      <h4>自定义上一页/下一页文本</h4>
