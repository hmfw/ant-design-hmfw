...
<\/script>
`,D={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"300px"}},A=y({__name:"InputNumberMinMax",setup(b){const n=p(5),u=p(.5);return(o,t)=>(f(),x("div",D,[e("div",null,[t[2]||(t[2]=e("p",{style:{"margin-bottom":"4px"}},"范围 1-10，步长 1：",-1)),l(r(i),{value:n.value,"onUpdate:value":t[0]||(t[0]=d=>n.value=d),min:1,max:10,step:1,style:{width:"100%"}},null,8,["value"])]),e("div",null,[t[3]||(t[3]=e("p",{style:{"margin-bottom":"4px"}},"范围 0-1，步长 0.1，精度 1：",-1)),l(r(i),{value:u.value,"onUpdate:value":t[1]||(t[1]=d=>u.value=d),min:0,max:1,step:.1,precision:1,style:{width:"100%"}},null,8,["value"])]),e("p",null,"value1: "+w(n.value)+"，value2: "+w(u.value),1)]))}}),C=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; max-width: 300px;">
    <div>
...
<\/script>
`,T={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"300px"}},z=y({__name:"InputNumberMode",setup(b){const n=p(3),u=p(3);return(o,t)=>(f(),x("div",T,[e("div",null,[t[2]||(t[2]=e("p",{style:{"margin-bottom":"4px"}},"Input 模式（默认）：",-1)),l(r(i),{value:n.value,"onUpdate:value":t[0]||(t[0]=d=>n.value=d),min:1,max:10,style:{width:"100%"}},null,8,["value"])]),e("div",null,[t[3]||(t[3]=e("p",{style:{"margin-bottom":"4px"}},"Spinner 模式：",-1)),l(r(i),{value:u.value,"onUpdate:value":t[1]||(t[1]=d=>u.value=d),mode:"spinner",min:1,max:10,style:{width:"100%"}},null,8,["value"])])]))}}),P=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; max-width: 300px;">
    <div>
...
<\/script>
`,R={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"300px"}},j=y({__name:"InputNumberSuffix",setup(b){const n=p(100),u=p(200),o=p(300);return(t,d)=>(f(),x("div",R,[e("div",null,[d[3]||(d[3]=e("p",{style:{"margin-bottom":"4px"}},"带前缀：",-1)),l(r(i),{value:n.value,"onUpdate:value":d[0]||(d[0]=s=>n.value=s),prefix:"¥",style:{width:"100%"}},null,8,["value"])]),e("div",null,[d[4]||(d[4]=e("p",{style:{"margin-bottom":"4px"}},"带后缀：",-1)),l(r(i),{value:u.value,"onUpdate:value":d[1]||(d[1]=s=>u.value=s),suffix:"RMB",style:{width:"100%"}},null,8,["value"])]),e("div",null,[d[5]||(d[5]=e("p",{style:{"margin-bottom":"4px"}},"前缀 + 后缀：",-1)),l(r(i),{value:o.value,"onUpdate:value":d[2]||(d[2]=s=>o.value=s),prefix:"¥",suffix:"元",style:{width:"100%"}},null,8,["value"])])]))}}),G=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; max-width: 300px;">
    <div>
