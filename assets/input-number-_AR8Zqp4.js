import{I as r}from"./InputNumber-DMDr4X6a.js";import{o as b,A as v,k as f,n as e,L as o,E as c,h as t,K as h,_ as N,H as I,Q as k,m as u,l as q}from"./index-CEDKhEzr.js";import"./cls-S9IiI6wd.js";const S={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"300px"}},U=b({__name:"InputNumberAddon",setup(g){const s=c(null),d=c(null),l=c(null);return(n,a)=>(v(),f("div",S,[e(o(r),{value:s.value,"onUpdate:value":a[0]||(a[0]=m=>s.value=m),min:0,prefix:"¥","addon-after":"元",placeholder:"请输入价格",style:{width:"100%"}},null,8,["value"]),e(o(r),{value:d.value,"onUpdate:value":a[1]||(a[1]=m=>d.value=m),min:0,max:100,"addon-after":"%",placeholder:"请输入百分比",style:{width:"100%"}},null,8,["value"]),e(o(r),{value:l.value,"onUpdate:value":a[2]||(a[2]=m=>l.value=m),min:0,"addon-before":"重量","addon-after":"kg",placeholder:"请输入重量",style:{width:"100%"}},null,8,["value"])]))}}),$=`<template>
...
<\/script>
`,K={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"300px"}},R=b({__name:"InputNumberMode",setup(g){const s=c(3),d=c(3);return(l,n)=>(v(),f("div",K,[t("div",null,[n[2]||(n[2]=t("p",{style:{"margin-bottom":"4px"}},"Input 模式（默认）：",-1)),e(o(r),{value:s.value,"onUpdate:value":n[0]||(n[0]=a=>s.value=a),min:1,max:10,style:{width:"100%"}},null,8,["value"])]),t("div",null,[n[3]||(n[3]=t("p",{style:{"margin-bottom":"4px"}},"Spinner 模式：",-1)),e(o(r),{value:d.value,"onUpdate:value":n[1]||(n[1]=a=>d.value=a),mode:"spinner",min:1,max:10,style:{width:"100%"}},null,8,["value"])])]))}}),H=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; max-width: 300px">
    <div>
...
<\/script>
`,L={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"300px"}},Q=b({__name:"InputNumberSuffix",setup(g){const s=c(100),d=c(200),l=c(300);return(n,a)=>(v(),f("div",L,[t("div",null,[a[3]||(a[3]=t("p",{style:{"margin-bottom":"4px"}},"带前缀：",-1)),e(o(r),{value:s.value,"onUpdate:value":a[0]||(a[0]=m=>s.value=m),prefix:"¥",style:{width:"100%"}},null,8,["value"])]),t("div",null,[a[4]||(a[4]=t("p",{style:{"margin-bottom":"4px"}},"带后缀：",-1)),e(o(r),{value:d.value,"onUpdate:value":a[1]||(a[1]=m=>d.value=m),suffix:"RMB",style:{width:"100%"}},null,8,["value"])]),t("div",null,[a[5]||(a[5]=t("p",{style:{"margin-bottom":"4px"}},"前缀 + 后缀：",-1)),e(o(r),{value:l.value,"onUpdate:value":a[2]||(a[2]=m=>l.value=m),prefix:"¥",suffix:"元",style:{width:"100%"}},null,8,["value"])])]))}}),Y=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; max-width: 300px">
    <div>
...
<\/script>
`,j={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"300px"}},G=b({__name:"InputNumberVariant",setup(g){const s=c(100);return(d,l)=>(v(),f("div",j,[e(o(r),{value:s.value,"onUpdate:value":l[0]||(l[0]=n=>s.value=n),placeholder:"Outlined (默认)",style:{width:"100%"}},null,8,["value"]),e(o(r),{value:s.value,"onUpdate:value":l[1]||(l[1]=n=>s.value=n),variant:"filled",placeholder:"Filled",style:{width:"100%"}},null,8,["value"]),e(o(r),{value:s.value,"onUpdate:value":l[2]||(l[2]=n=>s.value=n),variant:"borderless",placeholder:"Borderless",style:{width:"100%"}},null,8,["value"]),e(o(r),{value:s.value,"onUpdate:value":l[3]||(l[3]=n=>s.value=n),variant:"underlined",placeholder:"Underlined",style:{width:"100%"}},null,8,["value"])]))}}),J=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; max-width: 300px">
