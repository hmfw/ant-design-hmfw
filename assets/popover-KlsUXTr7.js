import{B as v}from"./Button-DSSb4voj.js";import{o as P,N as S,p as k,f as C,A as x,i as _,R as a,n as e,K as s,m as i,k as B,h as o,E as T,_ as D,F as I,G as F,J as $,H as j,l as z}from"./index-GV1C9GBE.js";import{T as A}from"./Tooltip-CqLSUo__.js";import"./cls-S9IiI6wd.js";import"./Icon-m2YBXu_N.js";import"./LoadingOutlined-Bntwy_Yd.js";const E=P({name:"PopoverPurePanel",inheritAttrs:!1,props:{title:[String,Number,Object,Function],content:[String,Number,Object,Function],placement:{type:String,default:"top"},arrow:{type:[Boolean,Object],default:!0},color:String,overlayInnerStyle:Object,classNames:[Object,Function],styles:[Object,Function]},setup(n,{slots:l,attrs:p}){const u=S("popover"),t=C(()=>n.arrow!==!1),g=(f,d)=>typeof f=="function"?f():f!=null&&f!==""?f:d==null?void 0:d();return()=>{const f=r=>typeof r=="function"?r({props:n}):r,d=f(n.classNames)??{},m=f(n.styles)??{},b=g(n.title,l.title),y=g(n.content,l.content),h=b!=null&&b!=="",O=y!=null&&y!=="",q=[h&&k("div",{class:[`${u}-title`,d.title],style:m.title},b),O&&k("div",{class:[`${u}-inner-content`,d.content],style:m.content},y)].filter(Boolean),N=n.overlayInnerStyle?[k("div",{style:n.overlayInnerStyle},q)]:q,w={};return n.color&&(w["--tooltip-bg"]=n.color),k("div",{...p,class:[`${u}-pure`,u,`${u}-placement-${n.placement}`],style:w},[k("div",{class:`${u}-content`},[t.value&&k("div",{class:`${u}-arrow`}),k("div",{class:`${u}-inner`,role:"tooltip"},N)].filter(Boolean))])}}}),H=P({name:"Popover",inheritAttrs:!1,props:{title:[String,Number,Object,Function],content:[String,Number,Object,Function],placement:{type:String,default:"top"},trigger:{type:[String,Array],default:"hover"},open:{type:Boolean,default:void 0},defaultOpen:Boolean,arrow:{type:[Boolean,Object],default:!0},mouseEnterDelay:{type:Number,default:.1},mouseLeaveDelay:{type:Number,default:.1},disabled:Boolean,overlayStyle:Object,overlayInnerStyle:Object,autoAdjustOverflow:{type:Boolean,default:!0},zIndex:Number,destroyOnHidden:Boolean,destroyTooltipOnHide:Boolean,getPopupContainer:Function,color:String,classNames:[Object,Function],styles:[Object,Function]},emits:["update:open","openChange","afterOpenChange"],setup(n,{slots:l,emit:p,attrs:u}){const t=S("popover"),g=C(()=>{const d=n.title,m=n.content,b=d!=null&&d!==""||!!l.title,y=m!=null&&m!==""||!!l.content;return b||y}),f=(d,m)=>typeof d=="function"?d():d!=null&&d!==""?d:m==null?void 0:m();return()=>{const d=r=>typeof r=="function"?r({props:n}):r,m=d(n.classNames)??{},b=d(n.styles)??{},y=f(n.title,l.title),h=f(n.content,l.content),O=y!=null&&y!=="",q=h!=null&&h!=="",N=[O&&k("div",{class:[`${t}-title`,m.title],style:b.title},y),q&&k("div",{class:[`${t}-inner-content`,m.content],style:b.content},h)].filter(Boolean),w=g.value?n.overlayInnerStyle?k("div",{style:n.overlayInnerStyle},N):N:null;return k(A,{...u,customPrefixCls:t,placement:n.placement,trigger:n.trigger,open:n.open,defaultOpen:n.defaultOpen,arrow:n.arrow,mouseEnterDelay:n.mouseEnterDelay,mouseLeaveDelay:n.mouseLeaveDelay,disabled:n.disabled,autoAdjustOverflow:n.autoAdjustOverflow,zIndex:n.zIndex,destroyOnHidden:n.destroyOnHidden,destroyTooltipOnHide:n.destroyTooltipOnHide,getPopupContainer:n.getPopupContainer,color:n.color,popupStyle:n.overlayStyle,"onUpdate:open":r=>p("update:open",r),onOpenChange:r=>p("openChange",r),onAfterOpenChange:r=>p("afterOpenChange",r)},g.value?{default:()=>{var r;return(r=l.default)==null?void 0:r.call(l)},title:()=>w}:{default:()=>{var r;return(r=l.default)==null?void 0:r.call(l)}})}}}),c=H;c._InternalPanelDoNotUseOrYouWillBeFired=E;const L=P({__name:"PopoverBasic",setup(n){return(l,p)=>(x(),_(s(c),{title:"标题",content:"这是气泡卡片的内容"},{default:a(()=>[e(s(v),null,{default:a(()=>[...p[0]||(p[0]=[i("鼠标移入",-1)])]),_:1})]),_:1}))}}),R=`<template>
...
`,M={style:{display:"flex",gap:"8px","flex-wrap":"wrap"}},G=P({__name:"PopoverPlacement",setup(n){const l=["topLeft","top","topRight","leftTop","left","leftBottom","rightTop","right","rightBottom","bottomLeft","bottom","bottomRight"];return(p,u)=>(x(),B("div",M,[(x(),B(I,null,F(l,t=>e(s(c),{key:t,placement:t,title:"标题",content:"内容"},{default:a(()=>[e(s(v),null,{default:a(()=>[i($(t),1)]),_:2},1024)]),_:2},1032,["placement"])),64))]))}}),J=`<template>
...
<\/script>
`,K={style:{display:"flex",gap:"24px","flex-wrap":"wrap"}},Q=P({__name:"PopoverPurePanel",setup(n){return(l,p)=>(x(),B("div",K,[e(s(c)._InternalPanelDoNotUseOrYouWillBeFired,{title:"标题",content:"这是直接内联渲染的气泡卡片面板"}),e(s(c)._InternalPanelDoNotUseOrYouWillBeFired,{title:"仅标题",placement:"bottom"}),e(s(c)._InternalPanelDoNotUseOrYouWillBeFired,{content:"无箭头 + 自定义背景色",arrow:!1,color:"#1677ff",styles:{content:{color:"#fff"}}})]))}}),X=`<template>
...
</code></pre><h3 id="dom--classname" tabindex="-1">DOM 结构与默认 className</h3><pre class="language-html"><code class="language-html"><span class="token comment">&lt;!-- 浮层容器（Teleport 到 body） --&gt;</span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>hmfw-popover<span class="token punctuation">&quot;</span></span><span class="token punctuation">&gt;</span></span>
  ...
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">&gt;</span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">&gt;</span></span>
</code></pre><h3 id="-7" tabindex="-1">使用示例</h3><pre class="language-vue"><code class="language-vue">&lt;template&gt;
  &lt;!-- 自定义标题样式 --&gt;
...
&lt;/style&gt;
</code></pre><hr><h2 id="-style" tabindex="-1">语义化 style</h2><p>通过 <code>styles</code> 属性可以对气泡卡片的子节点应用内联样式。</p><h3 id="-8" tabindex="-1">类型定义</h3><pre class="language-typescript"><code class="language-typescript"><span class="token keyword">interface</span> <span class="token class-name">PopoverStyles</span> <span class="token punctuation">{</span>
