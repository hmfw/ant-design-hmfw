import{C as d,a as h}from"./index-DP1fi7bO.js";import{o as u,A as i,i as b,Q as s,h as t,L as o,k as g,n as e,_ as y,m as l,E as f,K as x,H as C,l as v}from"./index-aeAUYztw.js";import"./cls-S9IiI6wd.js";const w=u({__name:"CardBasic",setup(c){return(p,n)=>(i(),b(o(d),{title:"卡片标题",style:{width:"300px"}},{default:s(()=>[...n[0]||(n[0]=[t("p",null,"卡片内容",-1),t("p",null,"卡片内容",-1),t("p",null,"卡片内容",-1)])]),_:1}))}}),S=`<template>
