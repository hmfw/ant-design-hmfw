import{B as c}from"./Button-D9PdcFa1.js";import{S as w}from"./Space-BIBt6cjD.js";import{n as f}from"./notification-lah21GXk.js";import{m as h}from"./message-CK5Sce9z.js";import{q as M,o as r,n as d,s as _,F as y,I as B,B as C,A,i as E,R as g,K as l,p as i,H as x,k as P,l as m}from"./index-B9Ix0zQ8.js";import{M as N}from"./index-bbp-bTid.js";import"./cls-S9IiI6wd.js";import"./Icon-D0ODznex.js";import"./LoadingOutlined-aeZz6k73.js";import"./CloseOutlined-wdRsSn_L.js";import"./CloseCircleFilled-BM35gEFb.js";import"./ExclamationCircleFilled-D1Qor_SV.js";import"./InfoCircleFilled-KhOcrXqz.js";import"./index-B1kyZpmo.js";const p=()=>{},S={confirm:p,info:p,success:p,warning:p,error:p},k=Symbol("App"),I={message:h,notification:f,modal:S};function v(){return M(k,I)}const T=r({name:"App",setup(u,{slots:e}){const o=B({open:!1,type:"info",props:{}});function n(t,s){o.type=t,o.props=s,o.open=!0}return C(k,{message:h,notification:f,modal:{confirm:t=>n("confirm",t),info:t=>n("info",t),success:t=>n("success",t),warning:t=>n("warning",t),error:t=>n("error",t)}}),()=>{var t;return d(y,null,[(t=e.default)==null?void 0:t.call(e),d(N,_({open:o.open},o.props,{"onUpdate:open":s=>{o.open=s},onCancel:()=>{o.open=!1}}),null)])}}}),F=r({__name:"AppBasic",setup(u){const e=r({setup(){const{message:o,notification:n,modal:a}=v();function t(){o.success("操作成功！")}function s(){n.info({message:"系统通知",description:"这是通过 useApp() 触发的通知。"})}function b(){a.info({title:"提示",content:"这是通过 useApp() 触发的对话框。"})}return()=>i(w,null,{default:()=>[i(c,{type:"primary",onClick:t},{default:()=>"Message"}),i(c,{onClick:s},{default:()=>"Notification"}),i(c,{onClick:b},{default:()=>"Modal"})]})}});return(o,n)=>(A(),E(l(T),null,{default:g(()=>[d(l(e))]),_:1}))}}),D=`<template>
  <App>
    <AppActions />
  </App>
</template>
