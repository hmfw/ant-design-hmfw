import{B as k}from"./Button-Ddb1eo4r.js";import{E as l,P as y}from"./Empty-SLwLg-bW.js";import{d as m,o as r,q as g,w as i,c as s,e as a,g as p,b as f,f as n,_ as x,A as h,J as b,r as E,h as v,i as w}from"./index-BOp1Gurx.js";import"./cls-S9IiI6wd.js";import"./LoadingOutlined-DpyU4f5h.js";const S=m({__name:"EmptyAction",setup(d){function o(){console.log("创建")}return(e,c)=>(r(),g(a(l),{description:"暂无数据"},{default:i(()=>[s(a(k),{onClick:o},{default:i(()=>[...c[0]||(c[0]=[p("立即创建",-1)])]),_:1})]),_:1}))}}),q=`<template>
