...
`,Nn={style:{display:"flex","flex-direction":"column",gap:"16px",width:"300px"}},$n=B({__name:"DatePickerDisabledDate",setup(a){const o=f(""),n=f(""),u=k=>new Date(k)<new Date(new Date().toDateString()),e=k=>new Date(k)>new Date(new Date().toDateString());return(k,y)=>(E(),_("div",Nn,[s(g(q),{value:o.value,"onUpdate:value":y[0]||(y[0]=p=>o.value=p),"disabled-date":u,placeholder:"不可选择过去日期"},null,8,["value"]),s(g(q),{value:n.value,"onUpdate:value":y[1]||(y[1]=p=>n.value=p),"disabled-date":e,placeholder:"不可选择未来日期"},null,8,["value"])]))}}),Mn=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; width: 300px">
...
<\/script>
`,Bn={style:{display:"flex","flex-direction":"column",gap:"16px",width:"300px"}},En=B({__name:"DatePickerPicker",setup(a){const o=f(""),n=f(""),u=f(""),e=f("");return(k,y)=>(E(),_("div",Bn,[s(g(q),{value:o.value,"onUpdate:value":y[0]||(y[0]=p=>o.value=p),picker:"date",placeholder:"选择日期"},null,8,["value"]),s(g(q),{value:n.value,"onUpdate:value":y[1]||(y[1]=p=>n.value=p),picker:"month",placeholder:"选择月份"},null,8,["value"]),s(g(q),{value:u.value,"onUpdate:value":y[2]||(y[2]=p=>u.value=p),picker:"quarter",placeholder:"选择季度"},null,8,["value"]),s(g(q),{value:e.value,"onUpdate:value":y[3]||(y[3]=p=>e.value=p),picker:"year",placeholder:"选择年份"},null,8,["value"])]))}}),_n=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; width: 300px">
...
const year = ref('')
<\/script>
`,On={style:{display:"flex","flex-direction":"column",gap:"16px",width:"300px"}},Hn=B({__name:"DatePickerPresets",setup(a){const o=f(""),n=[{label:"昨天",value:()=>{const u=new Date;return u.setDate(u.getDate()-1),u.toISOString().split("T")[0]}},{label:"今天",value:()=>new Date().toISOString().split("T")[0]},{label:"明天",value:()=>{const u=new Date;return u.setDate(u.getDate()+1),u.toISOString().split("T")[0]}},{label:"一周后",value:()=>{const u=new Date;return u.setDate(u.getDate()+7),u.toISOString().split("T")[0]}}];return(u,e)=>(E(),_("div",On,[s(g(q),{value:o.value,"onUpdate:value":e[0]||(e[0]=k=>o.value=k),presets:n,placeholder:"选择日期"},null,8,["value"]),c("p",null,"选中日期："+J(o.value),1)]))}}),An=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; width: 300px">
...
<\/script>
`,In={style:{width:"300px"}},Rn={style:{"margin-top":"8px"}},Vn=B({__name:"DatePickerShowTime",setup(a){const o=f(""),n=u=>{console.log("选中日期时间：",u)};return(u,e)=>(E(),_("div",In,[s(g(q),{value:o.value,"onUpdate:value":e[0]||(e[0]=k=>o.value=k),"show-time":!0,placeholder:"选择日期和时间",onChange:n},null,8,["value"]),c("p",Rn,"选中："+J(o.value),1)]))}}),Un=`<template>
