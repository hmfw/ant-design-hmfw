...
<\/script>
`,se=C({__name:"CollapseCustomIcon",setup(d){const l=[{key:"1",label:"自定义展开图标 1",children:"这是面板内容 1"},{key:"2",label:"自定义展开图标 2",children:"这是面板内容 2"},{key:"3",label:"自定义展开图标 3",children:"这是面板内容 3"}],u=({isActive:e})=>J(B,{component:H,style:{transform:e?"rotate(0deg)":"rotate(-90deg)",transition:"transform 0.3s"}});return(e,t)=>(k(),w(o(y),{"default-active-key":["1"],"expand-icon":u,items:l}))}}),re=`<template>
