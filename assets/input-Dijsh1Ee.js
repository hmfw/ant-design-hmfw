import{I as i,T as h,a as q,b}from"./Input-6b2cf6p_.js";import{o as k,A as v,k as x,n as a,K as s,E as d,h as e,R as f,m as y,J as w,j as N,_ as C,H as A,l as T}from"./index-GV1C9GBE.js";import{S}from"./Space-Di9klTqF.js";import{C as E}from"./CloseCircleOutlined-Bil7eSB-.js";import{S as I}from"./SearchOutlined-CpISnoU0.js";import{U as P}from"./UserOutlined-B8yXBCqK.js";import"./cls-S9IiI6wd.js";import"./CloseOutlined-qamoVtn_.js";import"./EyeOutlined-CDpUofBj.js";import"./LoadingOutlined-Bntwy_Yd.js";import"./Icon-m2YBXu_N.js";const U={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"400px"}},W=k({__name:"InputAddon",setup(g){const l=d(""),u=d(""),r=d("");return(t,o)=>(v(),x("div",U,[a(s(i),{value:l.value,"onUpdate:value":o[0]||(o[0]=c=>l.value=c),placeholder:"请输入用户名",prefix:"👤"},null,8,["value"]),a(s(i),{value:u.value,"onUpdate:value":o[1]||(o[1]=c=>u.value=c),placeholder:"请输入金额",prefix:"¥",suffix:"元"},null,8,["value"]),a(s(i),{value:r.value,"onUpdate:value":o[2]||(o[2]=c=>r.value=c),placeholder:"支持清除","allow-clear":""},null,8,["value"])]))}}),V=`<template>
...
const value4 = ref('')
<\/script>
`,O={class:"input-advanced-demo"},z={key:0,style:{padding:"8px",background:"#f0f9ff","border-radius":"4px"}},R=k({__name:"InputAdvanced",setup(g){const l=d(""),u=d(""),r=d(""),t=d(""),o=d(0),c=m=>{!m.ctrlKey&&!m.metaKey&&!m.shiftKey&&o.value++};return(m,n)=>(v(),x("div",O,[n[6]||(n[6]=e("h4",null,"细粒度样式控制（classNames / styles）",-1)),a(s(S),{direction:"vertical",style:{width:"100%","max-width":"400px"}},{default:f(()=>[a(s(i),{value:l.value,"onUpdate:value":n[0]||(n[0]=p=>l.value=p),placeholder:"自定义样式的 Input","class-names":{affixWrapper:"custom-wrapper",input:"custom-input",prefix:"custom-prefix",suffix:"custom-suffix"},styles:{affixWrapper:{border:"2px solid #1890ff",borderRadius:"8px"},input:{color:"#1890ff",fontWeight:"bold"}},prefix:"🔍",suffix:"✨"},null,8,["value"]),a(s(i),{value:u.value,"onUpdate:value":n[1]||(n[1]=p=>u.value=p),placeholder:"带字符计数","max-length":50,"show-count":!0,"class-names":{count:"custom-count"},styles:{count:{color:"#52c41a",fontWeight:"bold"}}},null,8,["value"])]),_:1}),n[7]||(n[7]=e("h4",{style:{"margin-top":"32px"}},"TextArea 按键事件",-1)),a(s(S),{direction:"vertical",style:{width:"100%","max-width":"400px"}},{default:f(()=>[a(s(h),{value:r.value,"onUpdate:value":n[2]||(n[2]=p=>r.value=p),placeholder:"按 Enter 键触发事件（可以用 Ctrl+Enter 换行）",rows:4,onPressEnter:c},null,8,["value"]),o.value>0?(v(),x("div",z,[e("span",null,[n[4]||(n[4]=y("Enter 键被按下了 ",-1)),e("strong",null,w(o.value),1),n[5]||(n[5]=y(" 次",-1))])])):N("",!0)]),_:1}),n[8]||(n[8]=e("h4",{style:{"margin-top":"32px"}},"TextArea 自定义样式",-1)),a(s(h),{value:t.value,"onUpdate:value":n[3]||(n[3]=p=>t.value=p),placeholder:"带样式的 TextArea",rows:3,"show-count":!0,"max-length":200,"class-names":{textarea:"custom-textarea",count:"custom-count"},styles:{textarea:{borderColor:"#722ed1",borderRadius:"8px"},count:{color:"#722ed1",fontSize:"14px"}}},null,8,["value"])]))}}),$=C(R,[["__scopeId","data-v-3c1e3a90"]]),B=`<template>
...
const value = ref('')
<\/script>
`,M={style:{display:"flex","flex-direction":"column",gap:"20px"}},L=k({__name:"InputClassNames",setup(g){const l=d(""),u=d(""),r=d(""),t=d(""),o=d(""),c=d("");return(m,n)=>(v(),x("div",M,[e("div",null,[n[6]||(n[6]=e("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义前缀和后缀图标样式：",-1)),a(s(i),{value:l.value,"onUpdate:value":n[0]||(n[0]=p=>l.value=p),placeholder:"搜索内容",prefix:s(I),suffix:s(E),"class-names":{prefix:"custom-prefix",suffix:"custom-suffix"},style:{width:"300px"}},null,8,["value","prefix","suffix"])]),e("div",null,[n[7]||(n[7]=e("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义输入框样式：",-1)),a(s(i),{value:u.value,"onUpdate:value":n[1]||(n[1]=p=>u.value=p),placeholder:"特殊样式输入框","class-names":{input:"custom-input"},style:{width:"300px"}},null,8,["value"])]),e("div",null,[n[8]||(n[8]=e("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义外层容器样式：",-1)),a(s(i),{value:r.value,"onUpdate:value":n[2]||(n[2]=p=>r.value=p),placeholder:"渐变边框",prefix:s(P),"class-names":{affixWrapper:"custom-wrapper"},style:{width:"300px"}},null,8,["value","prefix"])]),e("div",null,[n[9]||(n[9]=e("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义字数统计样式：",-1)),a(s(i),{value:t.value,"onUpdate:value":n[3]||(n[3]=p=>t.value=p),placeholder:"最多 50 字","max-length":50,"show-count":"","class-names":{count:"custom-count"},style:{width:"300px"}},null,8,["value"])]),e("div",null,[n[10]||(n[10]=e("div",{style:{"margin-bottom":"8px",color:"#666"}},"使用内联样式（styles）：",-1)),a(s(i),{value:o.value,"onUpdate:value":n[4]||(n[4]=p=>o.value=p),placeholder:"内联样式控制",prefix:s(I),styles:{affixWrapper:{borderColor:"#722ed1",borderRadius:"8px"},prefix:{color:"#722ed1",fontSize:"16px"},input:{fontWeight:"500"}},style:{width:"300px"}},null,8,["value","prefix"])]),e("div",null,[n[11]||(n[11]=e("div",{style:{"margin-bottom":"8px",color:"#666"}},"TextArea 自定义样式：",-1)),a(s(h),{value:c.value,"onUpdate:value":n[5]||(n[5]=p=>c.value=p),placeholder:"多行文本输入",rows:4,"max-length":200,"show-count":"","class-names":{textarea:"custom-textarea",count:"custom-textarea-count"},style:{width:"400px"}},null,8,["value"])])]))}}),j=C(L,[["__scopeId","data-v-689dde6e"]]),H=`<template>
...
</code></pre><h3 id="input-dom--classname" tabindex="-1">Input DOM 结构与默认 className</h3><p><strong>普通输入框（无前后缀）</strong></p><pre class="language-html"><code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>input</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>hmfw-input<span class="token punctuation">&quot;</span></span> <span class="token punctuation">/&gt;</span></span>
<span class="token comment">&lt;!-- ↑ classNames.input 应用于此 --&gt;</span>
</code></pre><p><strong>带前缀/后缀的输入框</strong></p><pre class="language-html"><code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>span</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>hmfw-input-affix-wrapper<span class="token punctuation">&quot;</span></span><span class="token punctuation">&gt;</span></span>
  <span class="token comment">&lt;!-- ↑ classNames.affixWrapper 应用于此 --&gt;</span>
  ...
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>span</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>hmfw-input-prefix<span class="token punctuation">&quot;</span></span><span class="token punctuation">&gt;</span></span>
    <span class="token comment">&lt;!-- ↑ classNames.prefix 应用于此 --&gt;</span>
  ...
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>span</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>hmfw-input-suffix<span class="token punctuation">&quot;</span></span><span class="token punctuation">&gt;</span></span>
    <span class="token comment">&lt;!-- ↑ classNames.suffix 应用于此 --&gt;</span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>span</span><span class="token punctuation">&gt;</span></span>
  ...
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>span</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>hmfw-input-show-count-suffix<span class="token punctuation">&quot;</span></span><span class="token punctuation">&gt;</span></span>
    <span class="token comment">&lt;!-- ↑ classNames.count 应用于此 --&gt;</span>
    10 / 100
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>span</span><span class="token punctuation">&gt;</span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>span</span><span class="token punctuation">&gt;</span></span>
</code></pre><h3 id="textarea-" tabindex="-1">TextArea 类型定义</h3><pre class="language-typescript"><code class="language-typescript"><span class="token keyword">interface</span> <span class="token class-name">TextAreaClassNames</span> <span class="token punctuation">{</span>
  ...
  count<span class="token operator">?</span><span class="token operator">:</span> <span class="token builtin">string</span> <span class="token comment">// 字数统计容器</span>
<span class="token punctuation">}</span>
</code></pre><h3 id="textarea-dom--classname" tabindex="-1">TextArea DOM 结构与默认 className</h3><pre class="language-html"><code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>textarea</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>hmfw-input hmfw-input-textarea<span class="token punctuation">&quot;</span></span><span class="token punctuation">&gt;</span></span>
  <span class="token comment">&lt;!-- ↑ classNames.textarea 应用于此 --&gt;</span>
...
&lt;script setup lang=&quot;ts&quot;&gt;
import { ref } from &#39;vue&#39;
import { Input, TextArea, SearchOutlined, UserOutlined } from &#39;ant-design-hmfw&#39;
...
&lt;/style&gt;
</code></pre><hr><h2 id="-style" tabindex="-1">语义化 style</h2><p>通过 <code>styles</code> 属性可以对输入框的各个子节点应用内联样式。</p><h3 id="input--2" tabindex="-1">Input 类型定义</h3><pre class="language-typescript"><code class="language-typescript"><span class="token keyword">import</span> <span class="token keyword">type</span> <span class="token punctuation">{</span> CSSProperties <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&#39;vue&#39;</span>
...
<span class="token punctuation">}</span>
</code></pre><h3 id="textarea--1" tabindex="-1">TextArea 类型定义</h3><pre class="language-typescript"><code class="language-typescript"><span class="token keyword">interface</span> <span class="token class-name">TextAreaStyles</span> <span class="token punctuation">{</span>
