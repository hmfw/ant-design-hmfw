import{B as m}from"./Button-CnMq9a0G.js";import{d as D,u as en,r as y,m as W,y as an,c as s,T as sn,s as on,I as pn,a as B,o as $,b as q,F as L,e as r,w as o,g as d,f as a,_ as ln,A as rn,h as dn,i as un}from"./index-Dhlw_h7w.js";import{S as cn}from"./index-CsB0XnK0.js";import{c as h}from"./cls-S9IiI6wd.js";import{C as kn}from"./CloseOutlined-N_iBbuHV.js";import"./LoadingOutlined-BpH-uTyr.js";class fn{constructor(){this.drawers=new Map,this.uidCounter=0}register(){const p=++this.uidCounter,f=this.drawers.size;return this.drawers.set(p,f),p}unregister(p){this.drawers.delete(p)}getZIndex(p,i){const f=this.drawers.get(p)??0;return i+f*2}get size(){return this.drawers.size}}const F=new fn,mn='a[href],button:not([disabled]),input:not([disabled]),select:not([disabled]),textarea:not([disabled]),[tabindex]:not([tabindex="-1"])';function gn(e,p){var c;const i=document.activeElement,f=()=>Array.from(e.querySelectorAll(mn));(c=f()[0])==null||c.focus();const t=b=>{if(b.key!=="Tab")return;const u=f();if(!u.length)return;const g=u[0],x=u[u.length-1];b.shiftKey?document.activeElement===g&&(b.preventDefault(),x.focus()):document.activeElement===x&&(b.preventDefault(),g.focus())};return e.addEventListener("keydown",t),()=>{e.removeEventListener("keydown",t),p&&(i==null||i.focus())}}let A=0,K="";function bn(){typeof document>"u"||(A===0&&(K=document.body.style.overflow,document.body.style.overflow="hidden"),A+=1)}function V(){typeof document>"u"||(A=Math.max(0,A-1),A===0&&(document.body.style.overflow=K))}let yn=0;const M=378,wn=736;function Z(e,p){if(p){const i=p();if(i&&i.length)return i}if(!(e==null||e===""))return typeof e=="function"?e():e}function vn(e){return typeof e=="number"?`${e}px`:e}const v=D({name:"Drawer",inheritAttrs:!1,props:{open:{type:Boolean,default:void 0},defaultOpen:Boolean,title:{type:[String,Number,Object,Function],default:void 0},placement:{type:String,default:"right"},size:{type:[String,Number],default:void 0},width:{type:[Number,String],default:M},height:{type:[Number,String],default:M},closable:{type:Boolean,default:!0},closeIcon:{type:Function,default:void 0},maskClosable:{type:Boolean,default:!0},mask:{type:Boolean,default:!0},keyboard:{type:Boolean,default:!0},loading:Boolean,zIndex:{type:Number,default:1e3},destroyOnClose:Boolean,destroyOnHidden:{type:Boolean,default:void 0},forceRender:Boolean,focusTriggerAfterClose:{type:Boolean,default:!0},getContainer:{type:[String,Object,Function,Boolean],default:void 0},rootClassName:{type:String,default:void 0},rootStyle:{type:Object,default:void 0},bodyStyle:{type:Object,default:void 0},headerStyle:{type:Object,default:void 0},footerStyle:{type:Object,default:void 0},maskStyle:{type:Object,default:void 0},contentWrapperStyle:{type:Object,default:void 0},classNames:{type:Object,default:void 0},styles:{type:Object,default:void 0}},emits:["update:open","close","afterOpenChange"],setup(e,{slots:p,emit:i,attrs:f}){const t=en("drawer"),c=`${t}-title-${yn+=1}`,b=y(e.defaultOpen??!1),u=y(null);let g=null,x=!1;const n=F.register(),k=B(()=>F.getZIndex(n,e.zIndex));W(()=>e.open,l=>{l!==void 0&&(b.value=l)});const N=B(()=>e.open!==void 0?e.open:b.value);W(N,async l=>{l?(e.mask&&(bn(),x=!0),await Promise.resolve(),u.value&&(g=gn(u.value,e.focusTriggerAfterClose))):(g==null||g(),g=null,x&&(V(),x=!1)),setTimeout(()=>i("afterOpenChange",l),0)},{flush:"post"}),an(()=>{g==null||g(),g=null,x&&(V(),x=!1),F.unregister(n)});const U=l=>{e.open===void 0&&(b.value=!1),i("update:open",!1),i("close",l)},G=l=>{e.mask&&e.maskClosable&&U(l)},Y=l=>{l.key==="Escape"&&e.keyboard&&N.value&&U(l)},j=B(()=>e.placement==="left"||e.placement==="right"),H=B(()=>{const{size:l}=e;return l==="large"?`${wn}px`:l==="default"?`${M}px`:typeof l=="number"?`${l}px`:typeof l=="string"?/^\d+(\.\d+)?$/.test(l)?`${l}px`:l:vn(j.value?e.width:e.height)}),J=B(()=>j.value?{width:H.value}:{height:H.value}),Q=B(()=>{const l=e.getContainer;return l===!1?"body":typeof l=="function"?l():typeof l=="string"||l instanceof HTMLElement?l:"body"}),X=()=>{if(!e.closable)return null;const l=e.closeIcon??kn;return s("button",{type:"button",class:`${t}-close`,onClick:w=>U(w),"aria-label":"Close"},[s(l,{class:"hmfw-icon"},null)])},_=()=>{var S,z,E,O,P,T,I;const l=Z(e.title,p.title),w=(S=p.extra)==null?void 0:S.call(p),C=l!=null&&l!=="";return!C&&!e.closable&&!w?null:s("div",{class:h(`${t}-header`,{[`${t}-header-close-only`]:e.closable&&!C&&!w},(z=e.classNames)==null?void 0:z.header),style:{...e.headerStyle,...(E=e.styles)==null?void 0:E.header}},[s("div",{class:`${t}-header-title`},[X(),C&&s("div",{id:c,class:h(`${t}-title`,(O=e.classNames)==null?void 0:O.title),style:(P=e.styles)==null?void 0:P.title},[l])]),w&&s("div",{class:h(`${t}-extra`,(T=e.classNames)==null?void 0:T.extra),style:(I=e.styles)==null?void 0:I.extra},[w])])},nn=()=>{var w,C,S;const l=(w=p.footer)==null?void 0:w.call(p);return!l||Array.isArray(l)&&!l.length?null:s("div",{class:h(`${t}-footer`,(C=e.classNames)==null?void 0:C.footer),style:{...e.footerStyle,...(S=e.styles)==null?void 0:S.footer}},[l])},tn=()=>{var w;return e.loading?s(cn,{active:!0,title:!1,paragraph:{rows:5},class:`${t}-body-skeleton`},null):(e.destroyOnHidden??e.destroyOnClose)&&!N.value?null:(w=p.default)==null?void 0:w.call(p)};return()=>{const l=Z(e.title,p.title)!=null,w={zIndex:k.value,...e.rootStyle},C=e.getContainer===!1;return s(pn,{to:Q.value,disabled:C},{default:()=>[s(sn,{name:`hmfw-drawer-${e.placement}`,appear:!0},{default:()=>{var S,z,E,O,P,T,I,R;return[(N.value||e.forceRender)&&s("div",{class:h(`${t}-root`,e.rootClassName,{[`${t}-no-mask`]:!e.mask}),style:{...w,display:N.value?"":"none"},onKeydown:Y},[e.mask&&s("div",{class:h(`${t}-mask`,(S=e.classNames)==null?void 0:S.mask),style:{...e.maskStyle,...(z=e.styles)==null?void 0:z.mask},onClick:G},null),s("div",on({ref:u,class:h(`${t}-content-wrapper`,`${t}-${e.placement}`,(E=e.classNames)==null?void 0:E.wrapper),style:{...J.value,...e.contentWrapperStyle,...(O=e.styles)==null?void 0:O.wrapper},role:"dialog","aria-modal":"true","aria-labelledby":l?c:void 0},f),[s("div",{class:h(`${t}-content`,(P=e.classNames)==null?void 0:P.content),style:(T=e.styles)==null?void 0:T.content},[_(),s("div",{class:h(`${t}-body`,(I=e.classNames)==null?void 0:I.body),style:{...e.bodyStyle,...(R=e.styles)==null?void 0:R.body}},[tn()]),nn()])])])]}})]})}}}),xn=D({__name:"DrawerBasic",setup(e){const p=y(!1);return(i,f)=>($(),q(L,null,[s(r(m),{type:"primary",onClick:f[0]||(f[0]=t=>p.value=!0)},{default:o(()=>[...f[2]||(f[2]=[d(" 打开抽屉 ",-1)])]),_:1}),s(r(v),{open:p.value,"onUpdate:open":f[1]||(f[1]=t=>p.value=t),title:"基础抽屉"},{default:o(()=>[...f[3]||(f[3]=[a("p",null,"抽屉内容",-1),a("p",null,"抽屉内容",-1),a("p",null,"抽屉内容",-1)])]),_:1},8,["open"])],64))}}),hn=`<template>
...
<\/script>
`,Cn={class:"demo-drawer-classnames"},Sn={class:"demo-section"},Bn={class:"demo-section"},Dn={class:"demo-section"},$n={class:"demo-section"},qn={class:"demo-section"},Nn={class:"demo-section"},zn={class:"demo-section"},En={class:"demo-section"},On=D({__name:"DrawerClassNames",setup(e){const p=y(!1),i=y(!1),f=y(!1),t=y(!1),c=y(!1),b=y(!1),u=y(!1),g=y(!1);return(x,n)=>($(),q("div",Cn,[a("section",Sn,[n[24]||(n[24]=a("h3",null,"1. 自定义遮罩样式",-1)),s(r(m),{type:"primary",onClick:n[0]||(n[0]=k=>p.value=!0)},{default:o(()=>[...n[22]||(n[22]=[d("打开抽屉（自定义遮罩）",-1)])]),_:1}),s(r(v),{open:p.value,"onUpdate:open":n[1]||(n[1]=k=>p.value=k),title:"自定义遮罩","class-names":{mask:"custom-mask"}},{default:o(()=>[...n[23]||(n[23]=[a("p",null,"这是一个自定义遮罩样式的抽屉",-1),a("p",null,"遮罩层使用渐变效果",-1)])]),_:1},8,["open"])]),a("section",Bn,[n[27]||(n[27]=a("h3",null,"2. 自定义包裹层样式",-1)),s(r(m),{type:"primary",onClick:n[2]||(n[2]=k=>i.value=!0)},{default:o(()=>[...n[25]||(n[25]=[d("打开抽屉（自定义包裹层）",-1)])]),_:1}),s(r(v),{open:i.value,"onUpdate:open":n[3]||(n[3]=k=>i.value=k),title:"自定义包裹层","class-names":{wrapper:"custom-wrapper"}},{default:o(()=>[...n[26]||(n[26]=[a("p",null,"这是一个自定义包裹层样式的抽屉",-1),a("p",null,"包裹层带有阴影和圆角效果",-1)])]),_:1},8,["open"])]),a("section",Dn,[n[30]||(n[30]=a("h3",null,"3. 自定义内容区样式",-1)),s(r(m),{type:"primary",onClick:n[4]||(n[4]=k=>f.value=!0)},{default:o(()=>[...n[28]||(n[28]=[d("打开抽屉（自定义内容区）",-1)])]),_:1}),s(r(v),{open:f.value,"onUpdate:open":n[5]||(n[5]=k=>f.value=k),title:"自定义内容区","class-names":{content:"custom-content"}},{default:o(()=>[...n[29]||(n[29]=[a("p",null,"这是一个自定义内容区样式的抽屉",-1),a("p",null,"内容区背景使用渐变色",-1)])]),_:1},8,["open"])]),a("section",$n,[n[35]||(n[35]=a("h3",null,"4. 自定义头部和标题样式",-1)),s(r(m),{type:"primary",onClick:n[6]||(n[6]=k=>t.value=!0)},{default:o(()=>[...n[31]||(n[31]=[d("打开抽屉（自定义头部）",-1)])]),_:1}),s(r(v),{open:t.value,"onUpdate:open":n[7]||(n[7]=k=>t.value=k),title:"渐变标题","class-names":{header:"custom-header",title:"custom-title"}},{extra:o(()=>[...n[32]||(n[32]=[a("a",{href:"#"},"操作",-1)])]),default:o(()=>[n[33]||(n[33]=a("p",null,"这是一个自定义头部和标题样式的抽屉",-1)),n[34]||(n[34]=a("p",null,"头部使用渐变背景，标题使用渐变文字",-1))]),_:1},8,["open"])]),a("section",qn,[n[41]||(n[41]=a("h3",null,"5. 自定义主体和页脚样式",-1)),s(r(m),{type:"primary",onClick:n[8]||(n[8]=k=>c.value=!0)},{default:o(()=>[...n[36]||(n[36]=[d("打开抽屉（自定义主体和页脚）",-1)])]),_:1}),s(r(v),{open:c.value,"onUpdate:open":n[11]||(n[11]=k=>c.value=k),title:"自定义主体和页脚","class-names":{body:"custom-body",footer:"custom-footer"}},{footer:o(()=>[s(r(m),{style:{"margin-right":"8px"},onClick:n[9]||(n[9]=k=>c.value=!1)},{default:o(()=>[...n[37]||(n[37]=[d("取消",-1)])]),_:1}),s(r(m),{type:"primary",onClick:n[10]||(n[10]=k=>c.value=!1)},{default:o(()=>[...n[38]||(n[38]=[d("确定",-1)])]),_:1})]),default:o(()=>[n[39]||(n[39]=a("p",null,"这是一个自定义主体和页脚样式的抽屉",-1)),n[40]||(n[40]=a("p",null,"主体区域使用柔和的背景色",-1))]),_:1},8,["open"])]),a("section",Nn,[n[46]||(n[46]=a("h3",null,"6. 自定义扩展区域样式",-1)),s(r(m),{type:"primary",onClick:n[12]||(n[12]=k=>b.value=!0)},{default:o(()=>[...n[42]||(n[42]=[d("打开抽屉（自定义扩展区域）",-1)])]),_:1}),s(r(v),{open:b.value,"onUpdate:open":n[13]||(n[13]=k=>b.value=k),title:"自定义扩展区域","class-names":{extra:"custom-extra"}},{extra:o(()=>[...n[43]||(n[43]=[a("a",{href:"#"},"链接 1",-1),a("a",{href:"#",style:{"margin-left":"8px"}},"链接 2",-1)])]),default:o(()=>[n[44]||(n[44]=a("p",null,"这是一个自定义扩展区域样式的抽屉",-1)),n[45]||(n[45]=a("p",null,"右上角的操作链接使用自定义样式",-1))]),_:1},8,["open"])]),a("section",zn,[n[53]||(n[53]=a("h3",null,"7. 组合使用多个 classNames",-1)),s(r(m),{type:"primary",onClick:n[14]||(n[14]=k=>u.value=!0)},{default:o(()=>[...n[47]||(n[47]=[d("打开抽屉（综合样式）",-1)])]),_:1}),s(r(v),{open:u.value,"onUpdate:open":n[17]||(n[17]=k=>u.value=k),title:"综合样式抽屉","class-names":{mask:"combined-mask",wrapper:"combined-wrapper",content:"combined-content",header:"combined-header",title:"combined-title",body:"combined-body",footer:"combined-footer"}},{extra:o(()=>[...n[48]||(n[48]=[a("a",{href:"#"},"操作",-1)])]),footer:o(()=>[s(r(m),{style:{"margin-right":"8px"},onClick:n[15]||(n[15]=k=>u.value=!1)},{default:o(()=>[...n[49]||(n[49]=[d("取消",-1)])]),_:1}),s(r(m),{type:"primary",onClick:n[16]||(n[16]=k=>u.value=!1)},{default:o(()=>[...n[50]||(n[50]=[d("确定",-1)])]),_:1})]),default:o(()=>[n[51]||(n[51]=a("p",null,"这是一个组合多个自定义样式的抽屉",-1)),n[52]||(n[52]=a("p",null,"所有部分都有自定义样式",-1))]),_:1},8,["open"])]),a("section",En,[n[59]||(n[59]=a("h3",null,"8. 使用 styles 动态样式",-1)),s(r(m),{type:"primary",onClick:n[18]||(n[18]=k=>g.value=!0)},{default:o(()=>[...n[54]||(n[54]=[d("打开抽屉（动态样式）",-1)])]),_:1}),s(r(v),{open:g.value,"onUpdate:open":n[21]||(n[21]=k=>g.value=k),title:"动态样式抽屉",styles:{mask:{background:"rgba(0, 0, 0, 0.6)"},wrapper:{boxShadow:"0 8px 32px rgba(0, 0, 0, 0.3)"},content:{borderLeft:"4px solid #1890ff"},header:{background:"linear-gradient(135deg, #667eea 0%, #764ba2 100%)",color:"white"},title:{fontWeight:"bold",fontSize:"18px"},body:{padding:"32px",background:"#f0f2f5"},footer:{background:"#fafafa",borderTop:"2px solid #1890ff"}}},{footer:o(()=>[s(r(m),{style:{"margin-right":"8px"},onClick:n[19]||(n[19]=k=>g.value=!1)},{default:o(()=>[...n[55]||(n[55]=[d("取消",-1)])]),_:1}),s(r(m),{type:"primary",onClick:n[20]||(n[20]=k=>g.value=!1)},{default:o(()=>[...n[56]||(n[56]=[d("确定",-1)])]),_:1})]),default:o(()=>[n[57]||(n[57]=a("p",null,"这是一个使用动态样式的抽屉",-1)),n[58]||(n[58]=a("p",null,"通过 styles 属性设置内联样式",-1))]),_:1},8,["open"])])]))}}),Pn=ln(On,[["__scopeId","data-v-22fe6e3f"]]),Tn=`<template>
...
`,In={style:{display:"flex",gap:"8px"}},An={style:{"text-align":"right"}},Ln=D({__name:"DrawerExtraFooter",setup(e){const p=y(!1),i=y("default");return(f,t)=>($(),q(L,null,[a("div",In,[s(r(m),{onClick:t[0]||(t[0]=()=>{p.value=!0,i.value="default"})},{default:o(()=>[...t[6]||(t[6]=[d(" 默认 378px ",-1)])]),_:1}),s(r(m),{onClick:t[1]||(t[1]=()=>{p.value=!0,i.value="large"})},{default:o(()=>[...t[7]||(t[7]=[d(" 大号 736px ",-1)])]),_:1})]),s(r(v),{open:p.value,"onUpdate:open":t[5]||(t[5]=c=>p.value=c),size:i.value,title:"尺寸"},{extra:o(()=>[s(r(m),{type:"primary",onClick:t[2]||(t[2]=c=>p.value=!1)},{default:o(()=>[...t[8]||(t[8]=[d(" 确定 ",-1)])]),_:1})]),footer:o(()=>[a("div",An,[s(r(m),{style:{"margin-right":"8px"},onClick:t[3]||(t[3]=c=>p.value=!1)},{default:o(()=>[...t[9]||(t[9]=[d(" 取消 ",-1)])]),_:1}),s(r(m),{type:"primary",onClick:t[4]||(t[4]=c=>p.value=!1)},{default:o(()=>[...t[10]||(t[10]=[d(" 提交 ",-1)])]),_:1})])]),default:o(()=>[a("p",null,"当前尺寸："+rn(i.value),1)]),_:1},8,["open","size"])],64))}}),Un=`<template>
...
<\/script>
`,Fn=D({__name:"DrawerLoading",setup(e){const p=y(!1),i=y(!1);function f(){p.value=!0,i.value=!0,setTimeout(()=>{i.value=!1},2e3)}return(t,c)=>($(),q(L,null,[s(r(m),{onClick:f},{default:o(()=>[...c[1]||(c[1]=[d(" 打开（加载中） ",-1)])]),_:1}),s(r(v),{open:p.value,"onUpdate:open":c[0]||(c[0]=b=>p.value=b),title:"加载中",loading:i.value},{default:o(()=>[...c[2]||(c[2]=[a("p",null,"数据加载完成后的抽屉内容。",-1)])]),_:1},8,["open","loading"])],64))}}),Mn=`<template>
...
<\/script>
`,jn={style:{display:"flex",gap:"8px"}},Hn=D({__name:"DrawerPlacement",setup(e){const p=y(!1),i=y("right"),f=y("右侧"),t={top:"顶部",right:"右侧",bottom:"底部",left:"左侧"};function c(b){i.value=b,f.value=t[b],p.value=!0}return(b,u)=>($(),q(L,null,[a("div",jn,[s(r(m),{onClick:u[0]||(u[0]=g=>c("top"))},{default:o(()=>[...u[5]||(u[5]=[d(" 上 ",-1)])]),_:1}),s(r(m),{onClick:u[1]||(u[1]=g=>c("right"))},{default:o(()=>[...u[6]||(u[6]=[d(" 右 ",-1)])]),_:1}),s(r(m),{onClick:u[2]||(u[2]=g=>c("bottom"))},{default:o(()=>[...u[7]||(u[7]=[d(" 下 ",-1)])]),_:1}),s(r(m),{onClick:u[3]||(u[3]=g=>c("left"))},{default:o(()=>[...u[8]||(u[8]=[d(" 左 ",-1)])]),_:1})]),s(r(v),{open:p.value,"onUpdate:open":u[4]||(u[4]=g=>p.value=g),placement:i.value,title:`从${f.value}滑出`},{default:o(()=>[...u[9]||(u[9]=[a("p",null,"抽屉内容",-1)])]),_:1},8,["open","placement","title"])],64))}}),Rn=`<template>
  <div style="display: flex; gap: 8px">
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">&gt;</span></span>
  ...
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>Drawer</span>
    ...
    <span class="token attr-name">title</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>自定义抽屉<span class="token punctuation">&quot;</span></span>
  ...
  <span class="token punctuation">&gt;</span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>p</span><span class="token punctuation">&gt;</span></span>抽屉内容<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>p</span><span class="token punctuation">&gt;</span></span>
...
<span class="token selector">:deep(.custom-mask)</span> <span class="token punctuation">{</span>
  <span class="token property">background</span><span class="token punctuation">:</span> <span class="token function">linear-gradient</span><span class="token punctuation">(</span>135deg<span class="token punctuation">,</span> <span class="token function">rgba</span><span class="token punctuation">(</span>102<span class="token punctuation">,</span> 126<span class="token punctuation">,</span> 234<span class="token punctuation">,</span> 0.7<span class="token punctuation">)</span> 0%<span class="token punctuation">,</span> <span class="token function">rgba</span><span class="token punctuation">(</span>118<span class="token punctuation">,</span> 75<span class="token punctuation">,</span> 162<span class="token punctuation">,</span> 0.7<span class="token punctuation">)</span> 100%<span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<span class="token selector">:deep(.custom-wrapper)</span> <span class="token punctuation">{</span>
  <span class="token property">border-radius</span><span class="token punctuation">:</span> 16px 0 0 16px<span class="token punctuation">;</span>
  <span class="token property">box-shadow</span><span class="token punctuation">:</span> 0 8px 32px <span class="token function">rgba</span><span class="token punctuation">(</span>0<span class="token punctuation">,</span> 0<span class="token punctuation">,</span> 0<span class="token punctuation">,</span> 0.3<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
...
<span class="token selector">:deep(.custom-body)</span> <span class="token punctuation">{</span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>style</span><span class="token punctuation">&gt;</span></span>
  ...
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>Drawer</span>
    <span class="token attr-name"><span class="token namespace">v-model:</span>open</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>open<span class="token punctuation">&quot;</span></span>
    <span class="token attr-name">title</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>动态样式<span class="token punctuation">&quot;</span></span>
