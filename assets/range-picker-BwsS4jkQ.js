import{S as Ma}from"./Space-BKN9zjbj.js";import{o as W,O as nn,N as sn,E as I,P as tn,n as e,m as k,f as b,A as z,i as ea,Q as H,L as g,h as c,K as Ta,k as Ha,_ as en,H as on,l as pn}from"./index-aeAUYztw.js";import{c as d}from"./cls-S9IiI6wd.js";import{T as ln}from"./Trigger-DUHNd6y-.js";function Ba(a){return String(a).padStart(2,"0")}function sa(a,t="YYYY-MM-DD"){return t.replace("YYYY",String(a.getFullYear())).replace("MM",Ba(a.getMonth()+1)).replace("DD",Ba(a.getDate()))}function M(a){if(!a)return null;const t=new Date(a);return isNaN(t.getTime())?null:t}function ta(a,t){return a.getFullYear()===t.getFullYear()&&a.getMonth()===t.getMonth()&&a.getDate()===t.getDate()}function Ea(a,t){return new Date(a,t+1,0).getDate()}function cn(a,t){return new Date(a,t,1).getDay()}function rn(a,t){const n=[],p=cn(a,t),o=Ea(a,t),m=Ea(a,t-1);for(let r=p-1;r>=0;r--)n.push({date:new Date(a,t-1,m-r),inCurrentMonth:!1});for(let r=1;r<=o;r++)n.push({date:new Date(a,t,r),inCurrentMonth:!0});const w=42-n.length;for(let r=1;r<=w;r++)n.push({date:new Date(a,t+1,r),inCurrentMonth:!1});return n}const D=W({name:"RangePicker",props:{value:Array,defaultValue:Array,format:{type:String,default:"YYYY-MM-DD"},disabled:{type:[Boolean,Array],default:!1},placeholder:{type:Array},allowClear:{type:Boolean,default:!0},allowEmpty:{type:Array},order:{type:Boolean,default:!0},separator:{type:String,default:"→"},presets:{type:Array},size:{type:String,default:"middle"},disabledDate:Function,status:{type:String,default:""},open:{type:Boolean,default:void 0},classNames:Object,styles:Object},emits:["update:value","change","openChange","calendarChange"],setup(a,{emit:t}){const n=nn("date-picker"),p=sn(),o=new Date,m=b(()=>a.placeholder?a.placeholder:p.value.DatePicker.rangePlaceholder??["Start date","End date"]),w=s=>s?[M(s[0]),M(s[1])]:[null,null],r=I(w(a.defaultValue??a.value));tn(()=>a.value,s=>{r.value=w(s)});const $=b(()=>a.value?M(a.value[0]):r.value[0]),L=b(()=>a.value?M(a.value[1]):r.value[1]),oa=I(!1),G=b(()=>a.open!==void 0?a.open:oa.value),x=I("start"),Y=I(null),T=I(($.value??o).getFullYear()),v=I(($.value??o).getMonth()),Ya=b(()=>v.value===11?T.value+1:T.value),Oa=b(()=>v.value===11?0:v.value+1),Aa=I(),j=b(()=>typeof a.disabled=="boolean"&&a.disabled),Va=b(()=>Array.isArray(a.disabled)?!!a.disabled[0]:!!a.disabled),_a=b(()=>Array.isArray(a.disabled)?!!a.disabled[1]:!!a.disabled),Fa=b(()=>$.value?sa($.value,a.format):""),Wa=b(()=>L.value?sa(L.value,a.format):""),za=b(()=>!!($.value||L.value)),pa=s=>{a.open===void 0&&(oa.value=s),t("openChange",s)},La=()=>{if(j.value||G.value)return;const s=$.value??o;T.value=s.getFullYear(),v.value=s.getMonth(),x.value=$.value&&!L.value?"end":"start",pa(!0)},J=()=>{Y.value=null,pa(!1)},K=s=>s?sa(s,a.format):null,Z=(s,l)=>{t("calendarChange",[K(s[0]),K(s[1])],s,{range:l})},la=s=>{const l=[K(s[0]),K(s[1])];r.value=s,t("update:value",l),t("change",l,s)},ja=s=>{var l;if(!((l=a.disabledDate)!=null&&l.call(a,s,{type:"date",from:r.value[0]??void 0})))if(x.value==="start")r.value=[s,null],x.value="end",Z([s,null],"start");else{let u=r.value[0],y=s;a.order&&u&&y<u&&([u,y]=[y,u]);const i=[u,y];Z(i,"end"),la(i),J()}},Ka=s=>{const l=typeof s.value=="function"?s.value():s.value,u=[M(l[0]),M(l[1])];Z(u,"end"),la(u),J()},Qa=s=>{s.stopPropagation(),r.value=[null,null],x.value="start",t("update:value",[null,null]),t("change",[null,null],[null,null])},Ua=()=>{v.value===0?(T.value--,v.value=11):v.value--},Xa=()=>{v.value===11?(T.value++,v.value=0):v.value++};function Ga(s){const l=r.value[0],u=x.value==="end"?Y.value??r.value[1]:r.value[1];if(!l||!u)return!1;const[y,i]=l<=u?[l,u]:[u,l];return s>y&&s<i}function Ja(s){const l=r.value[0];return!!(l&&ta(s,l))}function Za(s){const l=x.value==="end"?Y.value??r.value[1]:r.value[1];return!!(l&&ta(s,l))}function ca(s,l,u){var i,R,P,q,S,N,C,O,A,V,_,F,ra,da,ua,ia,ka,ga,ma,ya;const y=rn(s,l);return e("div",{class:d(`${n}-panel`,(i=a.classNames)==null?void 0:i.panel),style:(R=a.styles)==null?void 0:R.panel},[e("div",{class:d(`${n}-panel-header`,(P=a.classNames)==null?void 0:P.panelHeader),style:(q=a.styles)==null?void 0:q.panelHeader},[u==="left"&&e("button",{class:d(`${n}-panel-header-btn`,(S=a.classNames)==null?void 0:S.panelHeaderBtn),style:(N=a.styles)==null?void 0:N.panelHeaderBtn,onClick:Ua},[k("‹")]),u==="right"&&e("span",{class:d(`${n}-panel-header-btn`,(C=a.classNames)==null?void 0:C.panelHeaderBtn),style:{visibility:"hidden",...(O=a.styles)==null?void 0:O.panelHeaderBtn}},[k("‹")]),e("span",{class:d(`${n}-panel-header-title`,(A=a.classNames)==null?void 0:A.panelHeaderTitle),style:(V=a.styles)==null?void 0:V.panelHeaderTitle},[s,k("年 "),p.value.DatePicker.months[l]]),u==="right"&&e("button",{class:d(`${n}-panel-header-btn`,(_=a.classNames)==null?void 0:_.panelHeaderBtn),style:(F=a.styles)==null?void 0:F.panelHeaderBtn,onClick:Xa},[k("›")]),u==="left"&&e("span",{class:d(`${n}-panel-header-btn`,(ra=a.classNames)==null?void 0:ra.panelHeaderBtn),style:{visibility:"hidden",...(da=a.styles)==null?void 0:da.panelHeaderBtn}},[k("›")])]),e("div",{class:d(`${n}-panel-body`,(ua=a.classNames)==null?void 0:ua.panelBody),style:(ia=a.styles)==null?void 0:ia.panelBody},[e("div",{class:d(`${n}-weekdays`,(ka=a.classNames)==null?void 0:ka.weekdays),style:(ga=a.styles)==null?void 0:ga.weekdays},[p.value.DatePicker.weekdays.map(h=>{var Q,U;return e("span",{key:h,class:d(`${n}-weekday`,(Q=a.classNames)==null?void 0:Q.weekday),style:(U=a.styles)==null?void 0:U.weekday},[h])})]),e("div",{class:d(`${n}-days`,(ma=a.classNames)==null?void 0:ma.days),style:(ya=a.styles)==null?void 0:ya.days},[y.map(({date:h,inCurrentMonth:Q},U)=>{var fa,ba,va,ha,wa,Sa,Da,xa,Ra,Pa,qa,Na,Ca,Ia,$a;const aa=ta(h,o),X=((fa=a.disabledDate)==null?void 0:fa.call(a,h,{type:"date",from:r.value[0]??void 0}))??!1,na=Ga(h),B=Ja(h),E=Za(h);let f=(ba=a.styles)==null?void 0:ba.day;return aa&&((va=a.styles)!=null&&va.dayToday)&&(f={...f,...a.styles.dayToday}),(B||E)&&((ha=a.styles)!=null&&ha.daySelected)&&(f={...f,...a.styles.daySelected}),na&&((wa=a.styles)!=null&&wa.dayInRange)&&(f={...f,...a.styles.dayInRange}),B&&((Sa=a.styles)!=null&&Sa.dayRangeStart)&&(f={...f,...a.styles.dayRangeStart}),E&&((Da=a.styles)!=null&&Da.dayRangeEnd)&&(f={...f,...a.styles.dayRangeEnd}),X&&((xa=a.styles)!=null&&xa.dayDisabled)&&(f={...f,...a.styles.dayDisabled}),e("button",{key:U,class:d(`${n}-day`,{[`${n}-day-other-month`]:!Q,[`${n}-day-today`]:aa,[`${n}-day-selected`]:B||E,[`${n}-day-disabled`]:X,[`${n}-day-in-range`]:na,[`${n}-day-range-start`]:B,[`${n}-day-range-end`]:E},(Ra=a.classNames)==null?void 0:Ra.day,aa&&((Pa=a.classNames)==null?void 0:Pa.dayToday),(B||E)&&((qa=a.classNames)==null?void 0:qa.daySelected),na&&((Na=a.classNames)==null?void 0:Na.dayInRange),B&&((Ca=a.classNames)==null?void 0:Ca.dayRangeStart),E&&((Ia=a.classNames)==null?void 0:Ia.dayRangeEnd),X&&(($a=a.classNames)==null?void 0:$a.dayDisabled)),style:f,disabled:X,onClick:()=>ja(h),onMouseenter:()=>{x.value==="end"&&(Y.value=h)},onMouseleave:()=>{x.value==="end"&&(Y.value=null)}},[h.getDate()])})])])])}const an=()=>{var s,l,u,y,i,R,P,q;return e("div",{ref:Aa,class:d(`${n}-popup`,`${n}-range-popup`,(s=a.classNames)==null?void 0:s.popup),style:(l=a.styles)==null?void 0:l.popup},[e("div",{class:d(`${n}-range-wrapper`,(u=a.classNames)==null?void 0:u.rangeWrapper),style:(y=a.styles)==null?void 0:y.rangeWrapper},[a.presets&&a.presets.length>0&&e("div",{class:d(`${n}-presets`,(i=a.classNames)==null?void 0:i.presets),style:(R=a.styles)==null?void 0:R.presets},[e("ul",null,[a.presets.map(S=>{var N,C;return e("li",{key:S.label,class:d(`${n}-preset`,(N=a.classNames)==null?void 0:N.preset),style:(C=a.styles)==null?void 0:C.preset,onClick:()=>Ka(S)},[S.label])})])]),e("div",{class:d(`${n}-range-panels`,(P=a.classNames)==null?void 0:P.rangePanels),style:(q=a.styles)==null?void 0:q.rangePanels},[ca(T.value,v.value,"left"),ca(Ya.value,Oa.value,"right")])])])};return()=>{var s,l,u,y;return e(ln,{open:G.value,trigger:"click",placement:"bottomLeft",disabled:j.value,destroyOnHidden:!0,triggerClass:d(`${n}`,`${n}-range`,`${n}-${a.size}`,{[`${n}-open`]:G.value,[`${n}-disabled`]:j.value,[`${n}-status-error`]:a.status==="error",[`${n}-status-warning`]:a.status==="warning"},(s=a.classNames)==null?void 0:s.root),triggerStyle:(l=a.styles)==null?void 0:l.root,popupClass:d(`${n}-popup`,`${n}-range-popup`,(u=a.classNames)==null?void 0:u.popup),popupStyle:(y=a.styles)==null?void 0:y.popup,onOpenChange:i=>{i?La():J()}},{default:()=>{var i,R,P,q,S,N,C,O,A,V,_,F;return e("span",{class:d(`${n}-input`,(i=a.classNames)==null?void 0:i.input),style:(R=a.styles)==null?void 0:R.input},[e("input",{readonly:!0,value:Fa.value,placeholder:m.value[0],disabled:Va.value,class:d(`${n}-input-inner`,(P=a.classNames)==null?void 0:P.startInput),style:(q=a.styles)==null?void 0:q.startInput},null),e("span",{class:d(`${n}-range-separator`,(S=a.classNames)==null?void 0:S.separator),style:(N=a.styles)==null?void 0:N.separator},[a.separator]),e("input",{readonly:!0,value:Wa.value,placeholder:m.value[1],disabled:_a.value,class:d(`${n}-input-inner`,(C=a.classNames)==null?void 0:C.endInput),style:(O=a.styles)==null?void 0:O.endInput},null),a.allowClear&&za.value&&!j.value&&e("span",{class:d(`${n}-clear`,(A=a.classNames)==null?void 0:A.clear),style:(V=a.styles)==null?void 0:V.clear,onClick:Qa},[k("✕")]),e("span",{class:d(`${n}-suffix`,(_=a.classNames)==null?void 0:_.suffix),style:(F=a.styles)==null?void 0:F.suffix},[k("📅")])])},popup:({placement:i})=>an()})}}}),dn=W({__name:"RangePickerBasic",setup(a){const t=I([null,null]);return(n,p)=>(z(),ea(g(Ma),{direction:"vertical"},{default:H(()=>[e(g(D),{value:t.value,"onUpdate:value":p[0]||(p[0]=o=>t.value=o)},null,8,["value"]),c("span",null,"选择范围："+Ta(t.value[0])+" ~ "+Ta(t.value[1]),1)]),_:1}))}}),un=`<template>
