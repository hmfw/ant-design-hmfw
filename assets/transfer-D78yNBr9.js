import{B as kn}from"./Button-Bf04Y6dy.js";import{D as yn}from"./index-C6IUJRQ0.js";import{C as mn}from"./Checkbox-3_nH2HqT.js";import{D as vn}from"./DownOutlined-BfyIF5yt.js";import{D as bn}from"./DeleteOutlined-C3ChhOJJ.js";import{S as hn}from"./SearchOutlined-BQExkVTi.js";import{I as xn}from"./Input-C0krVijE.js";import{c as $}from"./cls-S9IiI6wd.js";import{P as Sn}from"./Pagination-CXfEQbEK.js";import{E as wn}from"./Empty-D-gjwqDd.js";import{d as _,r as x,m as nn,c as e,s as gn,F as pn,a as f,u as Tn,C as Kn,o as E,q as X,e as u,b as cn,f as i,_ as qn,A as Cn,h as An,w as U,g as H,i as In}from"./index-DpCWj_RH.js";import{R as $n}from"./RightOutlined-B3rpRsMI.js";import{L as Dn}from"./LeftOutlined-Dmhui-oM.js";import"./LoadingOutlined-BZTKujXV.js";import"./index-DsyBsvbF.js";import"./Layout-CBNy-KCH.js";import"./MinusOutlined-CS9u7csd.js";import"./event-CMqgYmge.js";import"./Trigger-BvJ5OT70.js";import"./Tooltip-CGkZ9PxR.js";import"./CloseOutlined-BtOkW6a2.js";import"./Select-BD79ShA_.js";import"./VirtualList-DQXrAMvZ.js";function Nn(t){return!!t&&typeof t=="object"&&!("__v_isVNode"in t)&&"value"in t}function Rn(t,l){for(const c of[t,l.title,l.key]){if(typeof c=="string")return c;if(typeof c=="number")return String(c)}return""}function W(t){return t.filter(l=>!l.disabled).map(l=>l.key)}const fn=_({name:"TransferList",props:{prefixCls:{type:String,required:!0},direction:{type:String,required:!0},titleText:{type:[String,Object],default:""},dataSource:{type:Array,default:()=>[]},checkedKeys:{type:Array,default:()=>[]},disabled:Boolean,showSearch:{type:[Boolean,Object],default:!1},showSelectAll:{type:Boolean,default:!0},showRemove:Boolean,draggable:Boolean,pagination:{type:[Boolean,Object],default:void 0},selectAllLabel:{type:[String,Object,Function],default:void 0},render:Function,filterOption:Function,footer:Function,listStyle:{type:Object,default:()=>({})},classNames:{type:Object,default:()=>({})},styles:{type:Object,default:()=>({})},searchPlaceholder:{type:String,default:"请输入搜索内容"},notFoundContent:{type:[String,Object,Array],default:void 0},itemUnit:{type:String,default:"项"},itemsUnit:{type:String,default:"项"},selectAll:{type:String,default:"全选所有"},deselectAll:{type:String,default:"取消全选"},selectCurrent:{type:String,default:"全选当页"},selectInvert:{type:String,default:"反选当页"},removeAll:{type:String,default:"删除全部"},removeCurrent:{type:String,default:"删除当页"}},emits:["itemSelect","itemSelectAll","itemRemove","reorder","filter","scroll"],setup(t,{emit:l}){const c=f(()=>`${t.prefixCls}-list`),y=f(()=>`${t.prefixCls}-section`),a=f(()=>t.showSearch&&typeof t.showSearch=="object"?{defaultValue:"",placeholder:"",...t.showSearch}:{defaultValue:"",placeholder:""}),p=x(a.value.defaultValue||"");nn(()=>a.value.defaultValue,n=>{p.value=n||""});const T=x(1),b=f(()=>t.pagination?{simple:!0,showSizeChanger:!1,showLessItems:!1,pageSize:10,...typeof t.pagination=="object"?t.pagination:{}}:null);function F(n){const s=t.render?t.render(n):null,o=Nn(s),r=o?s.label:s,v=o?s.value:Rn(s,n);return{item:n,renderedEl:r??n.title??String(n.key),renderedText:v}}function d(n,s){return t.filterOption?t.filterOption(p.value,s,t.direction):n.toLowerCase().includes(p.value.toLowerCase())}const h=f(()=>{const n=[];return t.dataSource.forEach(s=>{const o=F(s);p.value&&!d(o.renderedText,s)||n.push(o)}),n}),R=f(()=>h.value.map(n=>n.item));nn([h,b],()=>{const n=b.value;if(n){const s=Math.max(1,Math.ceil(h.value.length/n.pageSize));T.value=Math.min(T.value,s)}});const O=f(()=>{const n=b.value;return n?h.value.slice((T.value-1)*n.pageSize,T.value*n.pageSize):h.value}),q=f(()=>R.value.filter(n=>t.checkedKeys.includes(n.key)&&!n.disabled)),K=f(()=>{if(q.value.length===0)return"none";const n=new Set(t.checkedKeys);return R.value.every(s=>n.has(s.key)||!!s.disabled)?"all":"part"});function V(n){p.value=n,l("filter",t.direction,n)}function Y(){const n=W(R.value);l("itemSelectAll",n,K.value!=="all")}function G(n,s){const o=t.selectAllLabel;if(o)return typeof o=="function"?o({selectedCount:n,totalCount:s}):o;const r=s>1?t.itemsUnit:t.itemUnit;return`${n>0?`${n}/`:""}${s} ${r}`}const tn=f(()=>{const n=b.value;return t.showRemove?[n&&{key:"removeCurrent",label:t.removeCurrent,onClick:()=>l("itemRemove",W(O.value.map(s=>s.item)))},{key:"removeAll",label:t.removeAll,onClick:()=>l("itemRemove",W(R.value))}].filter(Boolean):[{key:"selectAll",label:K.value==="all"?t.deselectAll:t.selectAll,onClick:()=>{const s=W(R.value);l("itemSelectAll",s,s.length!==t.checkedKeys.length)}},n&&{key:"selectCurrent",label:t.selectCurrent,onClick:()=>l("itemSelectAll",W(O.value.map(s=>s.item)),!0)},{key:"selectInvert",label:t.selectInvert,onClick:()=>{const s=W(O.value.map(r=>r.item)),o=new Set(t.checkedKeys);s.forEach(r=>o.has(r)?o.delete(r):o.add(r)),l("itemSelectAll",[...o],"replace")}}].filter(Boolean)});function A(n){return t.classNames[n]}function S(n){return t.styles[n]}const P=x(null),L=x(null),z=x(!1);function an(n){return!!t.draggable&&!t.disabled&&!n.disabled}function sn(n,s){if(P.value=s,n.dataTransfer){n.dataTransfer.effectAllowed="move";try{n.dataTransfer.setData("text/plain",String(s))}catch{}}}function en(n,s){if(P.value===null||P.value===s)return;n.preventDefault(),n.dataTransfer&&(n.dataTransfer.dropEffect="move");const r=n.currentTarget.getBoundingClientRect(),k=n.clientY-r.top>r.height/2;(L.value!==s||z.value!==k)&&(L.value=s,z.value=k)}function on(n,s){L.value===s&&(L.value=null)}function J(n,s){n.preventDefault();const o=P.value,r=z.value;P.value=null,L.value=null,!(o===null||o===s)&&l("reorder",o,s,r)}function Q(){P.value=null,L.value=null}return()=>{const n=c.value,s=t.dataSource.some(w=>!w.disabled),o=e(mn,{class:`${n}-checkbox`,disabled:!s||t.disabled,checked:K.value==="all",indeterminate:K.value==="part",onChange:Y},null),r=e(yn,{class:`${n}-header-dropdown`,disabled:t.disabled,menu:{items:tn.value}},{default:()=>[e("span",{class:`${n}-header-dropdown-trigger`},[e(vn,{class:"hmfw-icon"},null)])]}),v=t.showSearch?e("div",{class:`${n}-body-search-wrapper`},[e(xn,{class:`${n}-search`,value:p.value,placeholder:a.value.placeholder||t.searchPlaceholder,disabled:t.disabled,allowClear:!0,prefix:e(hn,{class:"hmfw-icon"},null),onInput:w=>V(w.target.value),onClear:()=>V("")},null)]):null,k=O.value.map(({item:w,renderedEl:j})=>{const C=w.key,I=t.disabled||w.disabled,M=t.checkedKeys.includes(C),Z=P.value===C,ln=L.value===C,rn=an(w)?{draggable:!0,onDragstart:B=>sn(B,C),onDragover:B=>en(B,C),onDragleave:B=>on(B,C),onDrop:B=>J(B,C),onDragend:()=>Q()}:{},dn={[`${n}-content-item-draggable`]:!!t.draggable&&!I,[`${n}-content-item-dragging`]:Z,[`${n}-content-item-drag-over`]:ln&&!Z,[`${n}-content-item-drag-over-after`]:ln&&!Z&&z.value,[`${n}-content-item-drag-over-before`]:ln&&!Z&&!z.value},un=e("span",{class:$(`${n}-content-item-text`,A("itemContent")),style:S("itemContent")},[j]);return t.showRemove?e("li",gn({key:C,class:$(`${n}-content-item`,A("item"),dn,{[`${n}-content-item-disabled`]:I}),style:S("item")},rn),[un,e("button",{type:"button",disabled:I,class:`${n}-content-item-remove`,"aria-label":t.removeCurrent,onClick:()=>!I&&l("itemRemove",[C])},[e(bn,{class:"hmfw-icon"},null)])]):e("li",gn({key:C,class:$(`${n}-content-item`,A("item"),dn,{[`${n}-content-item-disabled`]:I,[`${n}-content-item-checked`]:M&&!I}),style:S("item")},rn,{onClick:B=>!I&&l("itemSelect",C,!M,B)}),[e(mn,{class:$(`${n}-checkbox`,A("itemIcon")),style:S("itemIcon"),checked:M,disabled:I},null),un])}),m=Array.isArray(t.notFoundContent)?t.notFoundContent[t.direction==="left"?0:1]:t.notFoundContent,g=O.value.length?e(pn,null,[e("ul",{class:$(`${n}-content`,A("list"),{[`${n}-content-show-remove`]:t.showRemove}),style:S("list"),onScroll:w=>l("scroll",t.direction,w)},[k]),b.value&&e(Sn,{size:"small",disabled:t.disabled,simple:b.value.simple,pageSize:b.value.pageSize,showSizeChanger:b.value.showSizeChanger,class:`${n}-pagination`,total:h.value.length,current:T.value,onChange:w=>{T.value=w}},null)]):e("div",{class:`${n}-body-not-found`},[m??e(wn,{description:!1},null)]),D=t.footer?t.footer({direction:t.direction,filteredItems:R.value,selectedKeys:t.checkedKeys,disabled:t.disabled}):null;return e("div",{class:$(y.value,A("section"),{[`${y.value}-with-pagination`]:!!b.value,[`${y.value}-with-footer`]:!!D}),style:{...t.listStyle,...S("section")}},[e("div",{class:$(`${n}-header`,A("header")),style:S("header")},[t.showSelectAll?e(pn,null,[!t.showRemove&&!b.value&&o,r]):null,e("span",{class:`${n}-header-selected`},[G(q.value.length,R.value.length)]),e("span",{class:$(`${n}-header-title`,A("title")),style:S("title")},[t.titleText])]),e("div",{class:$(`${n}-body`,A("body"),{[`${n}-body-with-search`]:!!t.showSearch}),style:S("body")},[v,g]),D&&e("div",{class:$(`${n}-footer`,A("footer")),style:S("footer")},[D])])}}}),N=_({name:"Transfer",props:{dataSource:{type:Array,default:()=>[]},targetKeys:Array,defaultTargetKeys:{type:Array,default:()=>[]},selectedKeys:Array,defaultSelectedKeys:{type:Array,default:()=>[]},titles:{type:Array,default:()=>["",""]},operations:{type:Array,default:()=>[]},render:Function,rowKey:Function,showSearch:{type:[Boolean,Object],default:!1},filterOption:Function,footer:Function,listStyle:{type:[Object,Function],default:()=>({})},disabled:Boolean,showSelectAll:{type:Boolean,default:!0},selectAllLabels:{type:Array,default:()=>[]},oneWay:Boolean,draggable:Boolean,pagination:{type:[Boolean,Object],default:void 0},status:String,locale:{type:Object,default:()=>({})},rootClassName:String,classNames:{type:Object,default:()=>({})},styles:{type:Object,default:()=>({})}},emits:["update:targetKeys","change","update:selectedKeys","selectChange","search","scroll","reorder"],setup(t,{emit:l}){const c=Tn("transfer"),y=Kn(),a=f(()=>({...y.value.Transfer,...t.locale})),p=x([...t.defaultTargetKeys]),T=x([...t.defaultSelectedKeys]);nn(()=>t.targetKeys,n=>{n&&(p.value=[...n])}),nn(()=>t.selectedKeys,n=>{n&&(T.value=[...n])});const b=f(()=>t.targetKeys??p.value),F=f(()=>t.selectedKeys??T.value),d=f(()=>t.dataSource.map(n=>({...n,key:t.rowKey?t.rowKey(n):n.key}))),h=f(()=>d.value.filter(n=>!b.value.includes(n.key))),R=f(()=>new Map(d.value.map(n=>[n.key,n]))),O=f(()=>b.value.map(n=>R.value.get(n)).filter(Boolean)),q=f(()=>F.value.filter(n=>h.value.some(s=>s.key===n))),K=f(()=>F.value.filter(n=>O.value.some(s=>s.key===n)));function V(n){T.value=n,l("update:selectedKeys",n)}function Y(n,s){const o=n==="left"?K.value:q.value,r=n==="left"?[...s,...o]:[...o,...s];V(r),n==="left"?l("selectChange",s,K.value):l("selectChange",q.value,s)}function G(n){const s=n==="right"?q.value:K.value,o=new Set(d.value.filter(g=>g.disabled).map(g=>g.key)),r=s.filter(g=>!o.has(g)),v=new Set(r),k=n==="right"?[...r,...b.value]:b.value.filter(g=>!v.has(g));p.value=k,l("update:targetKeys",k);const m=n==="right"?K.value:q.value;V(m),n==="right"?l("selectChange",[],K.value):l("selectChange",q.value,[]),l("change",k,n,r)}const tn=()=>G("right"),A=()=>G("left"),S={left:null,right:null};function P(n,s,o,r){var w;const v=n==="left",k=v?q.value:K.value,m=(v?h.value:O.value).filter(j=>!j.disabled),g=m.findIndex(j=>j.key===s),D=new Set(k);if(r&&S[n]!==null){const j=Math.min(S[n],g),C=Math.max(S[n],g);for(let I=j;I<=C;I++){const M=(w=m[I])==null?void 0:w.key;M!==void 0&&D.add(M)}}else D.has(s)&&D.delete(s),o&&D.add(s),S[n]=o?g:null;Y(n,[...D])}function L(n,s,o){const r=n==="left"?q.value:K.value;let v;if(o==="replace")v=s;else if(o)v=[...new Set([...r,...s])];else{const k=new Set(s);v=r.filter(m=>!k.has(m))}S[n]=null,Y(n,v)}function z(n){const s=new Set(n),o=b.value.filter(r=>!s.has(r));p.value=o,l("update:targetKeys",o),V(q.value),l("change",o,"left",[...n])}function an(n,s,o){if(n===s)return;const r=[...b.value],v=r.indexOf(n),k=r.indexOf(s);if(v<0||k<0)return;const m=r.slice();m.splice(v,1);const g=m.indexOf(s),D=o?g+1:g;m.splice(D,0,n),p.value=m,l("update:targetKeys",m);const w={direction:"right",oldTargetKeys:r,newTargetKeys:m,activeKey:n,fromIndex:v,toIndex:m.indexOf(n)};l("reorder",w)}function sn(n){return typeof t.listStyle=="function"?t.listStyle({direction:n}):t.listStyle}const en=f(()=>q.value.length>0),on=f(()=>K.value.length>0),J=f(()=>t.operations||[]);function Q(n){var r,v;const s=n==="left",o=a.value;return{prefixCls:c,direction:n,titleText:((r=t.titles)==null?void 0:r[s?0:1])??"",dataSource:s?h.value:O.value,checkedKeys:s?q.value:K.value,disabled:t.disabled,showSearch:t.showSearch,showSelectAll:t.showSelectAll,showRemove:t.oneWay&&!s,draggable:!!t.draggable&&!s,pagination:t.pagination,selectAllLabel:(v=t.selectAllLabels)==null?void 0:v[s?0:1],render:t.render,filterOption:t.filterOption,footer:t.footer,listStyle:sn(n),classNames:t.classNames,styles:t.styles,searchPlaceholder:o.searchPlaceholder,notFoundContent:t.locale.notFoundContent??o.notFoundContent,itemUnit:o.itemUnit,itemsUnit:o.itemsUnit,selectAll:o.selectAll,deselectAll:o.deselectAll,selectCurrent:o.selectCurrent,selectInvert:o.selectInvert,removeAll:o.removeAll,removeCurrent:o.removeCurrent,onItemSelect:(k,m,g)=>P(n,k,m,g==null?void 0:g.shiftKey),onItemSelectAll:(k,m)=>L(n,k,m),onItemRemove:k=>z(k),onReorder:(k,m,g)=>an(k,m,g),onFilter:(k,m)=>l("search",k,m),onScroll:(k,m)=>l("scroll",k,m)}}return()=>e("div",{class:$(c,t.rootClassName,t.classNames.root,{[`${c}-disabled`]:t.disabled,[`${c}-status-error`]:t.status==="error",[`${c}-status-warning`]:t.status==="warning"}),style:t.styles.root},[e(fn,Q("left"),null),e("div",{class:$(`${c}-actions`,t.classNames.actions),style:t.styles.actions},[e(kn,{type:"primary",size:"small",icon:$n,disabled:!en.value||t.disabled,onClick:tn},{default:()=>[J.value[0]]}),!t.oneWay&&e(kn,{type:"primary",size:"small",icon:Dn,disabled:!on.value||t.disabled,onClick:A},{default:()=>[J.value[1]]})]),e(fn,Q("right"),null)])}}),On=_({__name:"TransferBasic",setup(t){const l=Array.from({length:10},(y,a)=>({key:String(a),title:`选项 ${a+1}`,description:`描述 ${a+1}`,disabled:a===3})),c=x(["1","3","5"]);return(y,a)=>(E(),X(u(N),{"target-keys":c.value,"onUpdate:targetKeys":a[0]||(a[0]=p=>c.value=p),"data-source":u(l),titles:["待选","已选"],"show-search":""},null,8,["target-keys","data-source"]))}}),Pn=`<template>
...
<\/script>
`,Ln={style:{display:"flex","flex-direction":"column",gap:"24px"}},Bn=_({__name:"TransferClassNames",setup(t){const c=(()=>{const F=[];for(let d=1;d<=10;d++)F.push({key:`item-${d}`,title:`选项 ${d}`,description:`这是选项 ${d} 的描述`});return F})(),y=x(["item-2","item-4"]),a=x(["item-1","item-3"]),p=x(["item-5","item-6"]),T=x(["item-7","item-8"]),b=x(["item-9","item-10"]);return(F,d)=>(E(),cn("div",Ln,[i("div",null,[d[5]||(d[5]=i("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义列表容器和项：",-1)),e(u(N),{"target-keys":y.value,"onUpdate:targetKeys":d[0]||(d[0]=h=>y.value=h),"data-source":u(c),"class-names":{list:"custom-list",item:"custom-item"},titles:["源列表","目标列表"]},null,8,["target-keys","data-source"])]),i("div",null,[d[6]||(d[6]=i("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义头部和标题：",-1)),e(u(N),{"target-keys":a.value,"onUpdate:targetKeys":d[1]||(d[1]=h=>a.value=h),"data-source":u(c),"class-names":{header:"custom-header",title:"custom-title"},titles:["可选项","已选项"]},null,8,["target-keys","data-source"])]),i("div",null,[d[7]||(d[7]=i("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义操作按钮区：",-1)),e(u(N),{"target-keys":p.value,"onUpdate:targetKeys":d[2]||(d[2]=h=>p.value=h),"data-source":u(c),"class-names":{actions:"custom-actions"},titles:["左侧","右侧"]},null,8,["target-keys","data-source"])]),i("div",null,[d[8]||(d[8]=i("div",{style:{"margin-bottom":"8px",color:"#666"}},"完整自定义（组合使用）：",-1)),e(u(N),{"target-keys":T.value,"onUpdate:targetKeys":d[3]||(d[3]=h=>T.value=h),"data-source":u(c),"class-names":{root:"complete-root",section:"complete-section",header:"complete-header",title:"complete-title",body:"complete-body",list:"complete-list",item:"complete-item",actions:"complete-actions"},titles:["待选区","已选区"]},null,8,["target-keys","data-source"])]),i("div",null,[d[9]||(d[9]=i("div",{style:{"margin-bottom":"8px",color:"#666"}},"使用内联样式（styles）：",-1)),e(u(N),{"target-keys":b.value,"onUpdate:targetKeys":d[4]||(d[4]=h=>b.value=h),"data-source":u(c),styles:{section:{border:"2px solid #1890ff",borderRadius:"8px"},header:{background:"linear-gradient(135deg, #667eea 0%, #764ba2 100%)",color:"white",padding:"12px 16px"},list:{background:"#fafafa"},item:{padding:"12px 16px",borderRadius:"4px"}},titles:["来源","目标"]},null,8,["target-keys","data-source"])])]))}}),_n=qn(Bn,[["__scopeId","data-v-736c8795"]]),Fn=`<template>
...
`,En=_({__name:"TransferCustom",setup(t){const l=Array.from({length:10},(y,a)=>({key:String(a),title:`选项 ${a+1}`})),c=x(["1","3"]);return(y,a)=>(E(),X(u(N),{"target-keys":c.value,"onUpdate:targetKeys":a[0]||(a[0]=p=>c.value=p),"data-source":u(l),titles:["待选","已选"],render:p=>`[${p.title}]`},null,8,["target-keys","data-source","render"]))}}),zn=`<template>
  <Transfer
...
<\/script>
`,jn={style:{"margin-top":"12px",color:"rgba(0, 0, 0, 0.45)","font-size":"12px"}},Un=_({__name:"TransferDraggable",setup(t){const l=Array.from({length:8},(a,p)=>({key:String(p),title:`Item ${p+1}`})),c=x(["0","1","2","3"]);function y(a){console.log("reorder",a)}return(a,p)=>(E(),cn(pn,null,[e(u(N),{"target-keys":c.value,"onUpdate:targetKeys":p[0]||(p[0]=T=>c.value=T),"data-source":u(l),titles:["源","目标（可拖拽排序）"],draggable:"",onReorder:y},null,8,["target-keys","data-source"]),i("p",jn," 当前顺序："+Cn(c.value.join(", ")||"（空）"),1)],64))}}),Vn=`<template>
  <Transfer
    v-model:target-keys="targetKeys"
    :data-source="dataSource"
    :titles="['源', '目标（可拖拽排序）']"
...
<\/script>
`,Mn=_({__name:"TransferOneWay",setup(t){const l=Array.from({length:10},(y,a)=>({key:String(a),title:`Item ${a+1}`})),c=x(["1","3"]);return(y,a)=>(E(),X(u(N),{"target-keys":c.value,"onUpdate:targetKeys":a[0]||(a[0]=p=>c.value=p),"data-source":u(l),titles:["源","目标"],"one-way":""},null,8,["target-keys","data-source"]))}}),Wn=`<template>
...
const targetKeys = ref<string[]>(['1', '3'])
<\/script>
`,Hn=_({__name:"TransferPagination",setup(t){const l=Array.from({length:20},(y,a)=>({key:String(a),title:`选项 ${a+1}`})),c=x(["2","5","8"]);return(y,a)=>(E(),X(u(N),{"target-keys":c.value,"onUpdate:targetKeys":a[0]||(a[0]=p=>c.value=p),"data-source":u(l),titles:["源","目标"],pagination:{pageSize:5}},null,8,["target-keys","data-source"]))}}),Xn=`<template>
  <Transfer
    v-model:target-keys="targetKeys"
    :data-source="dataSource"
    :titles="['源', '目标']"
...
<\/script>
`,Yn=_({__name:"TransferSearch",setup(t){const l=Array.from({length:20},(y,a)=>({key:String(a),title:`选项 ${a+1}`,description:`描述 ${a+1}`,disabled:a%8===3})),c=x(["1","3","5"]);return(y,a)=>(E(),X(u(N),{"target-keys":c.value,"onUpdate:targetKeys":a[0]||(a[0]=p=>c.value=p),"data-source":u(l),titles:["待选","已选"],"show-search":""},null,8,["target-keys","data-source"]))}}),Gn=`<template>
  <Transfer v-model:target-keys="targetKeys" :data-source="dataSource" :titles="['待选', '已选']" show-search />
</template>
