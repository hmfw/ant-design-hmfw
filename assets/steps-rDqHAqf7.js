import{B as J}from"./Button-BJ4qjE3i.js";import{S as K}from"./Space-DxoCbPXb.js";import{d as h,u as tt,c as a,a as x,v as q,o as y,q as w,w as g,e as i,g as l,f as s,A as nt,r as st,b as C,_ as et,h as at,i as ot}from"./index-DZWA4HiS.js";import{c as m}from"./cls-S9IiI6wd.js";import{C as it}from"./CloseOutlined-Kr3orOYj.js";import{C as ct}from"./CheckOutlined-_g32GbF7.js";import"./LoadingOutlined-_M72e6LV.js";const v=h({name:"Steps",props:{current:{type:Number,default:0},initial:{type:Number,default:0},items:{type:Array,default:()=>[]},direction:{type:String},orientation:{type:String},size:{type:String,default:"default"},status:{type:String,default:"process"},type:{type:String,default:"default"},labelPlacement:{type:String},titlePlacement:{type:String},progressDot:{type:[Boolean,Function]},variant:{type:String,default:"filled"},responsive:{type:Boolean,default:!0},ellipsis:Boolean,offset:{type:Number,default:0},iconRender:Function,classNames:Object,styles:Object},emits:["change"],setup(n,{emit:o}){const e=tt("steps"),k=x(()=>n.type&&n.type!=="default"?n.type:n.progressDot?"dot":n.type),t=x(()=>k.value==="dot"||k.value==="inline"),f=x(()=>k.value==="inline"),N=x(()=>(n.orientation||n.direction)==="vertical"?"vertical":"horizontal"),$=x(()=>t.value||N.value==="vertical"?N.value==="vertical"?"horizontal":"vertical":n.titlePlacement||n.labelPlacement||"horizontal"),L=(p,d)=>{if(d.status)return d.status;const r=p+n.initial;return r<n.current?"finish":r===n.current?n.status:"wait"},Q=(p,d,r)=>{const c=`${e}-item-icon`;let u=null;if(t.value||r.icon)u=r.icon||q("span",{class:`${e}-icon-dot`});else switch(d){case"finish":u=q(ct,{class:m("hmfw-icon",`${c}-finish`)});break;case"error":u=q(it,{class:m("hmfw-icon",`${c}-error`)});break;default:u=q("span",{class:`${c}-number`},p+n.initial+1)}let b=u;if(n.iconRender){const S={index:p,active:p+n.initial===n.current,item:{...r,status:d}};b=n.iconRender(b,S)}else if(typeof n.progressDot=="function"){const S={index:p,active:p+n.initial===n.current,item:{...r,status:d}};b=n.progressDot(b,S)}return b},U=(p,d,r)=>{if(d.disabled)return;d.onClick&&d.onClick(r);const c=p+n.initial;c!==n.current&&o("change",c)};return()=>{var d,r;const p=n.items??[];return a("div",{class:m(e,`${e}-${N.value}`,`${e}-${n.variant}`,{[`${e}-${n.size}`]:n.size!=="default",[`${e}-label-${$.value}`]:$.value!=="horizontal",[`${e}-dot`]:t.value,[`${e}-inline`]:f.value,[`${e}-ellipsis`]:n.ellipsis},(d=n.classNames)==null?void 0:d.root),style:(r=n.styles)==null?void 0:r.root,role:"list","aria-label":"步骤条"},[p.map((c,u)=>{var z,B,P,D,I,E,V,T,A,F,O,R,W,j,M,X,G,H;const b=L(u,c),S=Q(u,b,c),Y=!c.disabled,_=c.content||c.description;return a("div",{key:u,class:m(`${e}-item`,`${e}-item-${b}`,{[`${e}-item-disabled`]:c.disabled,[`${e}-item-active`]:u+n.initial===n.current},(z=n.classNames)==null?void 0:z.item),style:(B=n.styles)==null?void 0:B.item,role:"listitem","aria-current":u+n.initial===n.current?"step":void 0,"aria-disabled":c.disabled||void 0,onClick:Z=>Y&&U(u,c,Z)},[a("div",{class:m(`${e}-item-header`,(P=n.classNames)==null?void 0:P.header),style:(D=n.styles)==null?void 0:D.header},[a("div",{class:m(`${e}-item-icon`,(I=n.classNames)==null?void 0:I.icon),style:(E=n.styles)==null?void 0:E.icon},[S]),a("div",{class:m(`${e}-item-title`,(V=n.classNames)==null?void 0:V.title),style:(T=n.styles)==null?void 0:T.title},[c.title,c.subTitle&&a("span",{class:m(`${e}-item-subtitle`,(A=n.classNames)==null?void 0:A.subtitle),style:(F=n.styles)==null?void 0:F.subtitle},[c.subTitle])]),a("div",{class:m(`${e}-item-tail`,(O=n.classNames)==null?void 0:O.tail),style:(R=n.styles)==null?void 0:R.tail},null)]),a("div",{class:m(`${e}-item-content`,(W=n.classNames)==null?void 0:W.content),style:(j=n.styles)==null?void 0:j.content},[a("div",{class:m(`${e}-item-icon`,`${e}-item-icon-placeholder`,(M=n.classNames)==null?void 0:M.icon),style:(X=n.styles)==null?void 0:X.icon},null),_&&a("div",{class:m(`${e}-item-description`,(G=n.classNames)==null?void 0:G.description),style:(H=n.styles)==null?void 0:H.description},[_])])])})])}}}),lt=h({__name:"StepsBasic",setup(n){const o=st(0),e=[{title:"第一步",description:"填写基本信息"},{title:"第二步",description:"确认订单信息"},{title:"第三步",description:"完成支付"}];return(k,t)=>(y(),w(i(K),{direction:"vertical",style:{width:"100%"}},{default:g(()=>[a(i(v),{current:o.value,items:e},null,8,["current"]),a(i(K),null,{default:g(()=>[a(i(J),{disabled:o.value===0,onClick:t[0]||(t[0]=f=>o.value--)},{default:g(()=>[...t[2]||(t[2]=[l(" 上一步 ",-1)])]),_:1},8,["disabled"]),a(i(J),{type:"primary",disabled:o.value===e.length-1,onClick:t[1]||(t[1]=f=>o.value++)},{default:g(()=>[...t[3]||(t[3]=[l(" 下一步 ",-1)])]),_:1},8,["disabled"])]),_:1}),s("p",null,"当前步骤："+nt(o.value+1),1)]),_:1}))}}),dt=`<template>
...
`,kt=h({__name:"StepsDot",setup(n){const o=[{title:"已完成",description:"2024-01-01"},{title:"进行中",description:"2024-01-02"},{title:"待处理",description:"2024-01-03"},{title:"待处理",description:"2024-01-04"}];return(e,k)=>(y(),w(i(v),{"progress-dot":"",current:1,items:o}))}}),ft=`<template>
...
<\/script>
`,gt=h({__name:"StepsError",setup(n){const o=[{title:"已完成",description:"操作成功"},{title:"处理中",description:"操作失败",status:"error"},{title:"待处理",description:"等待处理"}];return(e,k)=>(y(),w(i(v),{current:1,status:"error",items:o}))}}),vt=`<template>
...
<\/script>
`,bt={style:{padding:"20px"}},ht=h({__name:"StepsInline",setup(n){const o=[{title:"Step 1",content:"First step"},{title:"Step 2",content:"Second step"},{title:"Step 3",content:"Third step"},{title:"Step 4",content:"Fourth step"}];return(e,k)=>(y(),C("div",bt,[a(i(v),{items:o,type:"inline",current:1})]))}}),yt=`<template>
...
<\/script>
`,St=h({__name:"StepsSmall",setup(n){const o=[{title:"第一步"},{title:"第二步"},{title:"第三步"}];return(e,k)=>(y(),w(i(v),{size:"small",current:1,items:o}))}}),xt=`<template>
...
<\/script>
`,wt=h({__name:"StepsVertical",setup(n){const o=[{title:"已完成",description:"这是一段描述文字。"},{title:"进行中",description:"这是一段描述文字。"},{title:"待处理",description:"这是一段描述文字。"}];return(e,k)=>(y(),w(i(v),{direction:"vertical",current:1,items:o}))}}),qt=`<template>
