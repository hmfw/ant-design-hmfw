import{C as u,a as f}from"./Checkbox-DyJ5TAU-.js";import{d as v,o as h,b as x,c as a,e as d,w as c,g as l,f as t,A as b,r as k,_ as y,D as w,h as G,i as N}from"./index-Bp9Mx9oa.js";import"./cls-S9IiI6wd.js";const S={style:{display:"flex","flex-direction":"column",gap:"8px"}},A=v({__name:"CheckboxBasic",setup(g){const p=k(!1),e=k(!1),r=k(!0);return(n,o)=>(h(),x("div",S,[a(d(u),{checked:p.value,"onUpdate:checked":o[0]||(o[0]=s=>p.value=s)},{default:c(()=>[...o[3]||(o[3]=[l(" 普通复选框 ",-1)])]),_:1},8,["checked"]),a(d(u),{checked:e.value,"onUpdate:checked":o[1]||(o[1]=s=>e.value=s),disabled:""},{default:c(()=>[...o[4]||(o[4]=[l(" 禁用复选框 ",-1)])]),_:1},8,["checked"]),a(d(u),{checked:r.value,"onUpdate:checked":o[2]||(o[2]=s=>r.value=s),disabled:""},{default:c(()=>[...o[5]||(o[5]=[l(" 禁用选中 ",-1)])]),_:1},8,["checked"]),t("p",null,"checked1: "+b(p.value)+", checked2: "+b(e.value)+", checked3: "+b(r.value),1)]))}}),q=`<template>
