import{m as g,L as T,B as s,O as N,v as W,w as M,l as d,k as O,T as K,F as j,d as _,y as b,i as w,I as v,E as X,j as U,P as $,f}from"./index-CsoOETlJ.js";import{c as L}from"./cls-S9IiI6wd.js";const m=g({name:"AutoComplete",inheritAttrs:!1,props:{value:String,defaultValue:{type:String,default:""},options:{type:Array,default:()=>[]},disabled:Boolean,placeholder:String,allowClear:{type:Boolean,default:!1},size:{type:String,default:"middle"},status:{type:String,default:""},filterOption:{type:[Boolean,Function],default:!0},backfill:Boolean,open:{type:Boolean,default:void 0}},emits:["update:value","change","select","search","focus","blur","clear"],setup(o,{slots:i,emit:u,attrs:c}){const t=T("auto-complete"),l=T("input"),n=s(o.defaultValue??o.value??""),p=s(!1),r=s(-1),x=s(),B=s(),E=s(),C=s({top:0,left:0,width:0}),J=_(()=>o.value!==void 0),A=_(()=>J.value?o.value:n.value),V=_(()=>o.open!==void 0?o.open:p.value);N(()=>o.value,e=>{e!==void 0&&(n.value=e)});const k=_(()=>{const e=A.value;return!e||o.filterOption===!1?o.options:typeof o.filterOption=="function"?o.options.filter(a=>o.filterOption(e,a)):o.options.filter(a=>a.value.toLowerCase().includes(e.toLowerCase())||(a.label??a.value).toLowerCase().includes(e.toLowerCase()))}),P=()=>{if(!x.value)return;const e=x.value.getBoundingClientRect();C.value={top:e.bottom+window.scrollY+4,left:e.left+window.scrollX,width:e.width}},z=()=>{P(),p.value=!0},S=()=>{p.value=!1,r.value=-1},h=e=>{n.value=e,u("update:value",e),u("change",e)},F=e=>{const a=e.target.value;h(a),u("search",a),z(),r.value=-1},R=e=>{h(e.value),u("select",e.value,e),S()},I=e=>{var a;e.stopPropagation(),h(""),u("clear"),(a=B.value)==null||a.focus()},q=e=>{if(!V.value){(e.key==="ArrowDown"||e.key==="ArrowUp")&&z();return}const a=k.value;e.key==="ArrowDown"?(e.preventDefault(),r.value=(r.value+1)%a.length,o.backfill&&a[r.value]&&h(a[r.value].value)):e.key==="ArrowUp"?(e.preventDefault(),r.value=(r.value-1+a.length)%a.length,o.backfill&&a[r.value]&&h(a[r.value].value)):e.key==="Enter"?r.value>=0&&a[r.value]?R(a[r.value]):S():e.key==="Escape"&&S()},D=e=>{var a,y;!((a=x.value)!=null&&a.contains(e.target))&&!((y=E.value)!=null&&y.contains(e.target))&&S()};return W(()=>document.addEventListener("mousedown",D)),M(()=>document.removeEventListener("mousedown",D)),()=>d(j,null,[d("div",{ref:x,class:L(t,`${l}-affix-wrapper`,`${l}-affix-wrapper-${o.size}`,{[`${l}-affix-wrapper-disabled`]:o.disabled,[`${l}-affix-wrapper-status-error`]:o.status==="error",[`${l}-affix-wrapper-status-warning`]:o.status==="warning",[`${l}-affix-wrapper-focused`]:V.value}),style:c.style},[i.prefix&&d("span",{class:`${l}-prefix`},[i.prefix()]),d("input",{ref:B,class:L(l,`${l}-${o.size}`),value:A.value,disabled:o.disabled,placeholder:o.placeholder,onInput:F,onFocus:()=>{z(),u("focus")},onBlur:()=>u("blur"),onKeydown:q,autocomplete:"off"},null),o.allowClear&&A.value&&!o.disabled&&d("span",{class:`${l}-clear-icon`,onMousedown:I},[O("✕")]),i.suffix&&d("span",{class:`${l}-suffix`},[i.suffix()])]),V.value&&k.value.length>0&&d(K,{to:"body"},{default:()=>[d("div",{ref:E,class:`${t}-dropdown`,style:{position:"absolute",top:`${C.value.top}px`,left:`${C.value.left}px`,width:`${C.value.width}px`,zIndex:1050}},[k.value.map((e,a)=>d("div",{key:e.value,class:L(`${t}-dropdown-item`,{[`${t}-dropdown-item-active`]:r.value===a,[`${t}-dropdown-item-disabled`]:e.disabled,[`${t}-dropdown-item-selected`]:e.value===A.value}),onMousedown:y=>{y.preventDefault(),!e.disabled&&R(e)}},[e.label??e.value]))])]})])}}),Y={style:{width:"300px"}},G=g({__name:"AutoCompleteBasic",setup(o){const i=s(""),u=s([{value:"Vue"},{value:"React"},{value:"Angular"},{value:"Svelte"}]),c=t=>{const l=["Vue","React","Angular","Svelte","Solid"];u.value=l.filter(n=>n.toLowerCase().includes(t.toLowerCase())).map(n=>({value:n}))};return(t,l)=>(b(),w("div",Y,[d(v(m),{value:i.value,"onUpdate:value":l[0]||(l[0]=n=>i.value=n),options:u.value,placeholder:"请输入内容",onSearch:c},null,8,["value","options"])]))}}),H=`<template>
