import{R as G,C as it}from"./Col-LdLQoRyc.js";import{p as rt,A as at,n as I,M as K,D as N,P as F,m as r,e as w,F as O,q as Z,r as dt,z as L,h as T,J as s,o as p,j as z,g as o,Q as v,i as Q,I as W,l as h,_ as ot,G as st,k as lt}from"./index-i0jnWELi.js";import{V as ct}from"./VirtualList-Cm94Yyr9.js";import{E as mt}from"./Empty-VIClFYt1.js";import{P as ut}from"./Pagination-B0t23Wby.js";import{c as J}from"./cls-S9IiI6wd.js";import{S as Y}from"./Spin-DuYAEpoI.js";import{A as tt}from"./Avatar-7doi-ZKw.js";import{C as et}from"./index-BKN6uVb5.js";import"./icons-DkTSuFEr.js";import"./Icon-D9pw0Su_.js";import"./Select-Eah8NrZx.js";const nt=Symbol("ListContext");function pt(e){at(nt,e)}function gt(){return rt(nt,{})}function X(e){return typeof e=="function"||Object.prototype.toString.call(e)==="[object Object]"&&!Z(e)}const ht=I({name:"List",props:{dataSource:Array,renderItem:Function,header:[String,Object],footer:[String,Object],bordered:Boolean,size:{type:String,default:"default"},split:{type:Boolean,default:!0},loading:[Boolean,Object],locale:Object,pagination:[Boolean,Object],grid:Object,itemLayout:{type:String,default:"horizontal"},rowKey:[String,Function],loadMore:Object,virtual:Boolean,height:[Number,String],itemHeight:{type:Number,default:48}},setup(e,{slots:n}){const a=K("list"),i=w(()=>typeof e.pagination=="object"?e.pagination:{}),t=N(i.value.defaultCurrent||1),d=N(i.value.defaultPageSize||10);F(()=>i.value.current,l=>{l!==void 0&&(t.value=l)}),F(()=>i.value.pageSize,l=>{l!==void 0&&(d.value=l)});const m=w(()=>i.value.current??t.value),_=w(()=>i.value.pageSize??d.value),g=(l,D)=>{var f,b;t.value=l,d.value=D,(b=(f=i.value).onChange)==null||b.call(f,l,D)},c=w(()=>typeof e.loading=="boolean"?{spinning:e.loading}:e.loading||{}),$=w(()=>!!c.value.spinning);pt({grid:e.grid,itemLayout:e.itemLayout});const C=(l,D)=>typeof e.rowKey=="function"?e.rowKey(l):typeof e.rowKey=="string"?l[e.rowKey]:l&&typeof l=="object"&&"key"in l?l.key:`list-item-${D}`;return()=>{var q,U,R;const l=e.dataSource??[],D=l.length===0&&!n.default;let f=l;if(e.pagination&&l.length>0){const x=(m.value-1)*_.value,k=x+_.value;f=l.slice(x,k)}const b=(x,k)=>{if(!e.renderItem)return null;const V=C(x,k);return r(O,{key:V},[e.renderItem(x,k)])},y=f.map(b);let S=null;$.value&&f.length===0?S=r("div",{style:{minHeight:"53px"}},null):f.length>0?e.virtual&&e.height?e.grid?S=r(G,{class:`${a}-container`,gutter:e.grid.gutter},X(y)?y:{default:()=>[y]}):S=r(ct,{data:f,height:e.height,itemHeight:e.itemHeight,renderItem:(x,k)=>{var V;return((V=e.renderItem)==null?void 0:V.call(e,x,k))||null},itemKey:(x,k)=>C(x,k)},null):e.grid?S=r(G,{class:`${a}-container`,gutter:e.grid.gutter},X(y)?y:{default:()=>[y]}):S=r("ul",{class:`${a}-items`},[y]):D&&(S=r("div",{class:`${a}-empty-text`},[((q=e.locale)==null?void 0:q.emptyText)||r(mt,{description:"暂无数据"},null)]));const M=i.value.position||"bottom";i.value.align;const j=!!e.pagination&&l.length>0,E=j?r("div",{class:`${a}-pagination`},[r(ut,{current:m.value,pageSize:_.value,total:i.value.total??l.length,onChange:g},null)]):null,H=!!(e.loadMore||j||e.footer||n.footer);e.size==="small"||e.size;const A=J(a,{[`${a}-sm`]:e.size==="small",[`${a}-lg`]:e.size==="large",[`${a}-bordered`]:!!e.bordered,[`${a}-split`]:!!e.split,[`${a}-loading`]:!!$.value,[`${a}-grid`]:!!e.grid,[`${a}-vertical`]:e.itemLayout==="vertical",[`${a}-something-after-last-item`]:!!H});return r("div",{class:A},[(M==="top"||M==="both")&&E,(e.header||n.header)&&r("div",{class:`${a}-header`},[((U=n.header)==null?void 0:U.call(n))??e.header]),r(Y,{spinning:$.value},{default:()=>{var x;return[S,(x=n.default)==null?void 0:x.call(n)]}}),(e.footer||n.footer)&&r("div",{class:`${a}-footer`},[((R=n.footer)==null?void 0:R.call(n))??e.footer]),e.loadMore||(M==="bottom"||M==="both")&&E])}}});function ft(e){return typeof e=="function"||Object.prototype.toString.call(e)==="[object Object]"&&!Z(e)}const P=I({name:"ListItem",props:{extra:Object,actions:Array},setup(e,{slots:n}){const a=K("list"),i=gt(),t=w(()=>{var g;if(i.itemLayout==="vertical")return!!e.extra||!!n.extra;const d=(g=n.default)==null?void 0:g.call(n);if(!d||d.length===0)return!0;const m=d.length>1;return!(d.some(c=>typeof c.children=="string"||typeof c.type=="symbol")&&m)});return()=>{var l,D;const d=((l=n.extra)==null?void 0:l.call(n))??e.extra,m=((D=n.actions)==null?void 0:D.call(n))??e.actions,g=m&&(Array.isArray(m)?m.length>0:!0)?r("ul",{class:`${a}-item-action`,key:"actions"},[(Array.isArray(m)?m:[m]).map((f,b,y)=>r("li",{key:`action-${b}`},[f,b!==y.length-1&&r("em",{class:`${a}-item-action-split`},null)]))]):null,c=i.grid?"div":"li",$=J(`${a}-item`,{[`${a}-item-no-flex`]:!t.value}),C=r(c,{class:$},{default:()=>{var f,b;return[i.itemLayout==="vertical"&&d?r(O,null,[r("div",{class:`${a}-item-main`,key:"content"},[(f=n.default)==null?void 0:f.call(n),g]),r("div",{class:`${a}-item-extra`,key:"extra"},[d])]):r(O,null,[(b=n.default)==null?void 0:b.call(n),g,d&&r("div",{class:`${a}-item-extra`},[d])])]}});if(i.grid){const{column:f,xs:b,sm:y,md:S,lg:M,xl:j,xxl:E,gutter:H}=i.grid,A={};return f&&(A.span=24/f),b&&(A.xs=24/b),y&&(A.sm=24/y),S&&(A.md=24/S),M&&(A.lg=24/M),j&&(A.xl=24/j),E&&(A.xxl=24/E),r(it,dt(A,{style:{marginBottom:`${H||0}px`}}),ft(C)?C:{default:()=>[C]})}return C}}}),B=I({name:"ListItemMeta",props:{avatar:Object,title:[String,Object],description:[String,Object]},setup(e,{slots:n}){const a=K("list");return()=>{var _,g,c;const i=((_=n.avatar)==null?void 0:_.call(n))??e.avatar,t=((g=n.title)==null?void 0:g.call(n))??e.title,d=((c=n.description)==null?void 0:c.call(n))??e.description,m=t||d?r("div",{class:`${a}-item-meta-content`},[t&&r("h4",{class:`${a}-item-meta-title`},[t]),d&&r("div",{class:`${a}-item-meta-description`},[d])]):null;return r("div",{class:`${a}-item-meta`},[i&&r("div",{class:`${a}-item-meta-avatar`},[i]),m])}}}),u=ht;u.Item=P;u.Item.Meta=B;const vt=I({__name:"ListActions",setup(e){const n=[{title:"列表项 1"},{title:"列表项 2"},{title:"列表项 3"}];function a(d){console.log("编辑",d)}function i(d){console.log("删除",d)}const t=d=>p(u.Item,{actions:[p("a",{onClick:()=>a(d)},"编辑"),p("a",{onClick:()=>i(d)},"删除")]},()=>d.title);return(d,m)=>(L(),T(s(u),{"data-source":n,"render-item":t,bordered:""}))}}),bt=`<template>
...
<\/script>
`,Lt=I({__name:"ListBasic",setup(e){const n=["Racing car sprays burning fuel into crowd.","Japanese princess to wed commoner.","Australian walks 100km after outback crash.","Man charged over missing wedding girl."],a=i=>p(u.Item,null,()=>i);return(i,t)=>(L(),T(s(u),{"data-source":n,"render-item":a,bordered:""}))}}),It=`<template>
  <List
    :data-source="data"
...
<\/script>
`,$t=I({__name:"ListGrid",setup(e){const n=["Content 1","Content 2","Content 3","Content 4","Content 5","Content 6","Content 7","Content 8"],a=i=>p(u.Item,null,()=>p(et,{title:i},()=>`Card content for ${i}`));return(i,t)=>(L(),T(s(u),{"data-source":n,"render-item":a,grid:{gutter:16,column:4}}))}}),_t=`<template>
  <List
    :data-source="data"
    :render-item="renderItem"
...
<\/script>
`,Ct={key:0,style:{"text-align":"center",padding:"12px"}},St={key:1,style:{"text-align":"center",padding:"12px",color:"#999"}},At={style:{"margin-top":"16px",color:"#666"}},Dt=I({__name:"ListInfiniteScroll",setup(e){const n=Array.from({length:1e3},(g,c)=>({id:`item-${c}`,name:`Item ${c+1}`,description:`Description for item ${c+1} - Lorem ipsum dolor sit amet`})),a=N(n.slice(0,20)),i=N(!1),t=N(),d=w(()=>a.value.length>=n.length),m=()=>{i.value||d.value||(i.value=!0,setTimeout(()=>{const g=a.value.length,c=n.slice(g,g+20);a.value=[...a.value,...c],i.value=!1},1e3))},_=g=>{const c=g.target,$=c.scrollTop,C=c.scrollHeight,l=c.clientHeight;C-$-l<100&&m()};return(g,c)=>(L(),z("div",null,[c[0]||(c[0]=o("h3",null,"无限滚动示例",-1)),o("div",{ref_key:"scrollContainer",ref:t,style:{height:"400px",overflow:"auto",border:"1px solid #d9d9d9","border-radius":"4px"},onScroll:_},[r(s(u),{"data-source":a.value,loading:i.value},{renderItem:v(({item:$,index:C})=>[r(s(P),null,{default:v(()=>[r(s(B),{avatar:`https://api.dicebear.com/7.x/miniavs/svg?seed=${$.id}`,title:`${$.name}`,description:`${$.description}`},null,8,["avatar","title","description"])]),_:2},1024)]),_:1},8,["data-source","loading"]),i.value?(L(),z("div",Ct,[r(s(Y))])):Q("",!0),d.value?(L(),z("div",St," 已加载全部数据 ")):Q("",!0)],544),o("div",At," 已加载: "+W(a.value.length)+" / "+W(s(n).length)+" 项 ",1)]))}}),wt=`<template>
  <div>
    <h3>无限滚动示例</h3>
    <div
      ref="scrollContainer"
...
<\/script>
`,kt=I({__name:"ListPagination",setup(e){const n=Array.from({length:10},(i,t)=>`Item ${t+1}`),a=i=>p(u.Item,null,()=>i);return(i,t)=>(L(),T(s(u),{"data-source":s(n),"render-item":a,pagination:{pageSize:3},bordered:""},null,8,["data-source"]))}}),Mt=`<template>
  <List
    :data-source="data"
    :render-item="renderItem"
...
const renderItem = (item: string) => h(List.Item, null, () => item)
<\/script>
`,zt={class:"list-responsive-grid-demo"},Tt=I({__name:"ListResponsiveGrid",setup(e){const n=Array.from({length:12},(i,t)=>({id:t+1,title:`项目 ${t+1}`,content:`这是第 ${t+1} 个项目的内容`})),a=i=>p(u.Item,null,()=>p(et,{title:i.title,hoverable:!0},()=>i.content));return(i,t)=>(L(),z("div",zt,[t[0]||(t[0]=o("h4",null,"响应式网格布局",-1)),t[1]||(t[1]=o("p",{style:{"margin-bottom":"16px",color:"#666"}},[h(" 调整浏览器窗口大小查看响应式效果： "),o("br"),h(" • 超小屏 (xs < 576px): 1 列 "),o("br"),h(" • 小屏 (sm ≥ 576px): 2 列 "),o("br"),h(" • 中屏 (md ≥ 768px): 3 列 "),o("br"),h(" • 大屏 (lg ≥ 992px): 4 列 "),o("br"),h(" • 超大屏 (xl ≥ 1200px): 6 列 ")],-1)),r(s(u),{"data-source":s(n),"render-item":a,grid:{gutter:16,xs:1,sm:2,md:3,lg:4,xl:6}},null,8,["data-source"])]))}}),jt=ot(Tt,[["__scopeId","data-v-0acfbafb"]]),Et=`<template>
...
const renderItem = (item: { id: number; title: string; content: string }) =>
  h(List.Item, null, () =>
    h(
      Card,
      { title: item.title, hoverable: true },
      () => item.content
    )
  )
<\/script>
