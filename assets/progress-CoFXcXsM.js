...
<\/script>
`,Re={style:{display:"flex",gap:"16px"}},Ve=L({__name:"ProgressCircle",setup(e){return(l,t)=>(I(),O("div",Re,[r(i(d),{type:"circle",percent:75}),r(i(d),{type:"circle",percent:70,status:"exception"}),r(i(d),{type:"circle",percent:100})]))}}),ze=`<template>
...
import { Progress } from 'ant-design-hmfw'
<\/script>
`,Ee={style:{display:"flex","flex-direction":"column",gap:"16px"}},Ue=L({__name:"ProgressCustom",setup(e){return(l,t)=>(I(),O("div",Ee,[n("div",null,[t[0]||(t[0]=n("div",{style:{"margin-bottom":"8px"}},"Custom Size (number)",-1)),r(i(d),{type:"circle",percent:75,size:80})]),n("div",null,[t[1]||(t[1]=n("div",{style:{"margin-bottom":"8px"}},"Small Size",-1)),r(i(d),{type:"circle",percent:75,size:"small"})]),n("div",null,[t[2]||(t[2]=n("div",{style:{"margin-bottom":"8px"}},"Custom Gap Degree",-1)),r(i(d),{type:"dashboard",percent:75,"gap-degree":30})]),n("div",null,[t[3]||(t[3]=n("div",{style:{"margin-bottom":"8px"}},"Square Linecap",-1)),r(i(d),{type:"circle",percent:75,"stroke-linecap":"square"})])]))}}),Je=`<template>
...
import { Progress } from 'ant-design-hmfw'
<\/script>
`,Ke={style:{display:"flex",gap:"16px"}},Qe=L({__name:"ProgressDashboard",setup(e){return(l,t)=>(I(),O("div",Ke,[r(i(d),{type:"dashboard",percent:75}),r(i(d),{type:"dashboard",percent:75,"gap-degree":30})]))}}),He=`<template>
  <div style="display: flex; gap: 16px">
