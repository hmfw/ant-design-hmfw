import{B as un}from"./Button-DewbofvJ.js";import{d as S,u as xn,r as P,k as wn,y as Sn,m as O,c as e,F as V,a as u,n as Cn,o as w,q as _,w as c,f as n,e as i,b as E,z as kn,A as gn,_ as Nn,h as qn,g as m,i as An}from"./index-D5KOSvVL.js";import{c as f}from"./cls-S9IiI6wd.js";import{L as $n}from"./LeftOutlined-BU6UmVXs.js";import{R as Pn}from"./RightOutlined-C0zrLGsX.js";import"./LoadingOutlined-BFlxA5_9.js";const v=S({name:"Carousel",props:{autoplay:{type:[Boolean,Object],default:!1},autoplaySpeed:{type:Number,default:3e3},dots:{type:[Boolean,Object],default:!0},dotPosition:String,dotPlacement:String,effect:{type:String,default:"scrollx"},fade:Boolean,infinite:{type:Boolean,default:!0},speed:{type:Number,default:500},easing:{type:String,default:"ease"},initialSlide:{type:Number,default:0},arrows:{type:Boolean,default:!1},prevArrow:Object,nextArrow:Object,waitForAnimate:{type:Boolean,default:!1},adaptiveHeight:{type:Boolean,default:!1},rootClassName:String,classNames:Object,styles:Object},emits:["beforeChange","afterChange"],setup(s,{slots:k,emit:t,expose:h}){const a=xn("carousel"),l=P(s.initialSlide),y=P(!1),mn=P(),B=P(),D=P(void 0);let R=null,b=null;const L=u(()=>{var g;return(((g=k.default)==null?void 0:g.call(k))??[]).flatMap(p=>Array.isArray(p.children)?p.children:[p])}),d=u(()=>L.value.length),z=u(()=>{const o=s.dotPlacement??s.dotPosition??"bottom";return o==="left"?"start":o==="right"?"end":o}),j=u(()=>{const o=z.value;return o==="start"||o==="end"}),fn=u(()=>s.fade?"fade":s.effect),F=u(()=>fn.value==="fade"),vn=u(()=>!!s.dots),hn=u(()=>typeof s.dots=="object"&&s.dots.className?s.dots.className:""),yn=u(()=>!!s.autoplay),H=u(()=>!!(typeof s.autoplay=="object"&&s.autoplay.dotDuration));function T(){if(!s.adaptiveHeight||j.value||!B.value){D.value=void 0;return}Cn(()=>{if(!B.value)return;const g=B.value.querySelectorAll(`.${a}-slide`)[l.value];g&&(D.value=g.offsetHeight)})}function C(o,g=!1){if(d.value===0||!g&&s.waitForAnimate&&y.value)return;let p=o;s.infinite?p=(o%d.value+d.value)%d.value:p=Math.max(0,Math.min(o,d.value-1)),p!==l.value&&(t("beforeChange",l.value,p),g?(l.value=p,t("afterChange",p)):(b&&(clearTimeout(b),b=null),y.value=!0,l.value=p,b=setTimeout(()=>{y.value=!1,t("afterChange",p),b=null},s.speed)))}const M=()=>C(l.value-1),I=()=>C(l.value+1);function Y(){!yn.value||d.value<=1||(R=setInterval(()=>C(l.value+1),s.autoplaySpeed))}function G(){R&&(clearInterval(R),R=null),b&&(clearTimeout(b),b=null)}wn(()=>{if(d.value>0&&s.initialSlide>0){const o=s.infinite?s.initialSlide%d.value:Math.min(s.initialSlide,d.value-1);l.value=o}T(),Y()}),Sn(G),O(()=>s.autoplay,o=>{o?Y():G()}),O(l,()=>{T()}),O(()=>s.adaptiveHeight,()=>{T()}),h({goTo:C,next:I,prev:M});const bn=u(()=>{const o=z.value;return o==="start"?"left":o==="end"?"right":o});return()=>{var p,U,X,J,K,Q,W,Z,nn,sn,an,tn,en,on,ln,pn,cn,dn;if(d.value===0)return e("div",{class:f(a,s.rootClassName,(p=s.classNames)==null?void 0:p.root),style:(U=s.styles)==null?void 0:U.root},null);const o=`${s.speed/1e3}s`,g=H.value?{"--carousel-dot-duration":`${s.autoplaySpeed}ms`}:{};return e("div",{class:f(a,s.rootClassName,(X=s.classNames)==null?void 0:X.root,{[`${a}-vertical`]:j.value,[`${a}-fade`]:F.value}),style:{...g,...(J=s.styles)==null?void 0:J.root},role:"region","aria-roledescription":"carousel","aria-label":"Carousel"},[e("div",{ref:mn,class:f(`${a}-list`,(K=s.classNames)==null?void 0:K.list),style:{...s.adaptiveHeight&&D.value!==void 0?{height:`${D.value}px`,transition:y.value?`height ${o} ${s.easing}`:"none"}:{},...(Q=s.styles)==null?void 0:Q.list}},[e("div",{ref:B,class:f(`${a}-track`,(W=s.classNames)==null?void 0:W.track),style:{...F.value?{}:{transform:j.value?`translateY(-${l.value*100}%)`:`translateX(-${l.value*100}%)`,transition:y.value?`transform ${o} ${s.easing}`:"none"},...(Z=s.styles)==null?void 0:Z.track}},[L.value.map((rn,x)=>{var N,q,A,$;const r=x===l.value;return e("div",{key:x,class:f(`${a}-slide`,(N=s.classNames)==null?void 0:N.slide,{[`${a}-slide-active`]:r},r&&((q=s.classNames)==null?void 0:q.slideActive)),style:{...F.value?{opacity:r?1:0,transform:"translate3d(0, 0, 0)",transition:`opacity ${o} ${s.easing}`,position:r?"relative":"absolute",inset:r?"auto":"0",contentVisibility:"auto"}:{contentVisibility:"auto"},...(A=s.styles)==null?void 0:A.slide,...r&&(($=s.styles)==null?void 0:$.slideActive)},role:"group","aria-roledescription":"slide","aria-label":`${x+1} / ${d.value}`,"aria-hidden":!r},[rn])})])]),s.arrows&&d.value>1&&e(V,null,[s.prevArrow??e(un,{class:f(`${a}-arrow`,`${a}-arrow-left`,(nn=s.classNames)==null?void 0:nn.arrow,(sn=s.classNames)==null?void 0:sn.arrowLeft),style:{...(an=s.styles)==null?void 0:an.arrow,...(tn=s.styles)==null?void 0:tn.arrowLeft},type:"text",icon:$n,onClick:M,disabled:s.waitForAnimate&&y.value,"aria-label":"Previous slide"},null),s.nextArrow??e(un,{class:f(`${a}-arrow`,`${a}-arrow-right`,(en=s.classNames)==null?void 0:en.arrow,(on=s.classNames)==null?void 0:on.arrowRight),style:{...(ln=s.styles)==null?void 0:ln.arrow,...(pn=s.styles)==null?void 0:pn.arrowRight},type:"text",icon:Pn,onClick:I,disabled:s.waitForAnimate&&y.value,"aria-label":"Next slide"},null)]),vn.value&&d.value>1&&e("ul",{class:f(`${a}-dots`,`${a}-dots-${bn.value}`,hn.value,(cn=s.classNames)==null?void 0:cn.dots,{[`${a}-dots-progress`]:H.value,[`${a}-dots-disabled`]:s.waitForAnimate&&y.value}),style:(dn=s.styles)==null?void 0:dn.dots},[L.value.map((rn,x)=>{var N,q,A,$;const r=x===l.value;return e("li",{key:x,class:f((N=s.classNames)==null?void 0:N.dot,{[`${a}-dot-active`]:r},r&&((q=s.classNames)==null?void 0:q.dotActive)),style:{...(A=s.styles)==null?void 0:A.dot,...r&&(($=s.styles)==null?void 0:$.dotActive)},onClick:()=>C(x)},[e("button",{"aria-label":`Go to slide ${x+1}`},null)])})])])}}}),Bn=S({__name:"CarouselArrows",setup(s){return(k,t)=>(w(),_(i(v),{arrows:""},{default:c(()=>[...t[0]||(t[0]=[n("div",{class:"carousel-item",style:{background:"#364d79",color:"#fff",height:"160px","line-height":"160px","text-align":"center"}}," Slide 1 ",-1),n("div",{class:"carousel-item",style:{background:"#7dbcea",color:"#fff",height:"160px","line-height":"160px","text-align":"center"}}," Slide 2 ",-1),n("div",{class:"carousel-item",style:{background:"#00a0e9",color:"#fff",height:"160px","line-height":"160px","text-align":"center"}}," Slide 3 ",-1),n("div",{class:"carousel-item",style:{background:"#1890ff",color:"#fff",height:"160px","line-height":"160px","text-align":"center"}}," Slide 4 ",-1)])]),_:1}))}}),Dn=`<template>
  <Carousel arrows>
    <div
      class="carousel-item"
...
<\/script>
`,Rn=S({__name:"CarouselBasic",setup(s){return(k,t)=>(w(),_(i(v),{style:{height:"160px",background:"#364d79","border-radius":"4px",overflow:"hidden"}},{default:c(()=>[(w(),E(V,null,kn(4,h=>n("div",{key:h,style:{height:"160px",display:"flex","align-items":"center","justify-content":"center",color:"#fff","font-size":"24px"}},gn(h),1)),64))]),_:1}))}}),_n=`<template>
...
import { Carousel } from '@hmfw/ant-design'
<\/script>
`,En={style:{display:"flex","flex-direction":"column",gap:"24px"}},Ln=S({__name:"CarouselClassNames",setup(s){return(k,t)=>(w(),E("div",En,[n("div",null,[t[1]||(t[1]=n("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义根容器圆角与阴影：",-1)),e(i(v),{"class-names":{root:"custom-root"}},{default:c(()=>[...t[0]||(t[0]=[n("div",{class:"demo-slide",style:{background:"linear-gradient(135deg, #667eea 0%, #764ba2 100%)"}},[n("h3",null,"Slide 1")],-1),n("div",{class:"demo-slide",style:{background:"linear-gradient(135deg, #f093fb 0%, #f5576c 100%)"}},[n("h3",null,"Slide 2")],-1),n("div",{class:"demo-slide",style:{background:"linear-gradient(135deg, #4facfe 0%, #00f2fe 100%)"}},[n("h3",null,"Slide 3")],-1)])]),_:1})]),n("div",null,[t[3]||(t[3]=n("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义指示器：圆形 dots 与渐变色：",-1)),e(i(v),{"class-names":{dots:"custom-dots",dot:"custom-dot",dotActive:"custom-dot-active"}},{default:c(()=>[...t[2]||(t[2]=[n("div",{class:"demo-slide",style:{background:"linear-gradient(to right, #f857a6, #ff5858)"}},[n("h3",null,"Slide 1")],-1),n("div",{class:"demo-slide",style:{background:"linear-gradient(to right, #a8edea, #fed6e3)"}},[n("h3",null,"Slide 2")],-1),n("div",{class:"demo-slide",style:{background:"linear-gradient(to right, #ffecd2, #fcb69f)"}},[n("h3",null,"Slide 3")],-1)])]),_:1})]),n("div",null,[t[5]||(t[5]=n("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义箭头：渐变背景与圆形：",-1)),e(i(v),{arrows:"","class-names":{arrow:"custom-arrow",arrowLeft:"custom-arrow-left",arrowRight:"custom-arrow-right"}},{default:c(()=>[...t[4]||(t[4]=[n("div",{class:"demo-slide",style:{background:"linear-gradient(135deg, #667eea 0%, #764ba2 100%)"}},[n("h3",null,"Slide 1")],-1),n("div",{class:"demo-slide",style:{background:"linear-gradient(135deg, #fa709a 0%, #fee140 100%)"}},[n("h3",null,"Slide 2")],-1),n("div",{class:"demo-slide",style:{background:"linear-gradient(135deg, #30cfd0 0%, #330867 100%)"}},[n("h3",null,"Slide 3")],-1)])]),_:1})]),n("div",null,[t[7]||(t[7]=n("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义幻灯片缩放与激活态边框：",-1)),e(i(v),{"class-names":{list:"custom-list",slide:"custom-slide",slideActive:"custom-slide-active"}},{default:c(()=>[...t[6]||(t[6]=[n("div",{class:"demo-slide",style:{background:"linear-gradient(to right, #6a11cb, #2575fc)"}},[n("h3",null,"Slide 1")],-1),n("div",{class:"demo-slide",style:{background:"linear-gradient(to right, #ff6a00, #ee0979)"}},[n("h3",null,"Slide 2")],-1),n("div",{class:"demo-slide",style:{background:"linear-gradient(to right, #00c9ff, #92fe9d)"}},[n("h3",null,"Slide 3")],-1)])]),_:1})]),n("div",null,[t[9]||(t[9]=n("div",{style:{"margin-bottom":"8px",color:"#666"}},"使用 styles 内联样式控制：",-1)),e(i(v),{arrows:"",styles:{root:{borderRadius:"16px",overflow:"hidden"},dots:{bottom:"20px"},dot:{opacity:.8},arrow:{background:"rgba(255,255,255,0.9)",color:"#1677ff"}}},{default:c(()=>[...t[8]||(t[8]=[n("div",{class:"demo-slide",style:{background:"linear-gradient(135deg, #667eea 0%, #764ba2 100%)"}},[n("h3",null,"Slide 1")],-1),n("div",{class:"demo-slide",style:{background:"linear-gradient(135deg, #f093fb 0%, #f5576c 100%)"}},[n("h3",null,"Slide 2")],-1),n("div",{class:"demo-slide",style:{background:"linear-gradient(135deg, #4facfe 0%, #00f2fe 100%)"}},[n("h3",null,"Slide 3")],-1)])]),_:1})])]))}}),jn=Nn(Ln,[["__scopeId","data-v-f007851c"]]),Fn=`<template>
...
`,Tn=S({__name:"CarouselFade",setup(s){return(k,t)=>(w(),_(i(v),{effect:"fade",style:{height:"160px",background:"#364d79","border-radius":"4px",overflow:"hidden"}},{default:c(()=>[(w(),E(V,null,kn(4,h=>n("div",{key:h,style:{height:"160px",display:"flex","align-items":"center","justify-content":"center",color:"#fff","font-size":"24px"}},gn(h),1)),64))]),_:1}))}}),On=`<template>
...
import { Carousel } from '@hmfw/ant-design'
<\/script>
`,Vn=S({__name:"CarouselProgress",setup(s){return(k,t)=>(w(),_(i(v),{autoplay:{dotDuration:!0},"autoplay-speed":2e3},{default:c(()=>[...t[0]||(t[0]=[n("div",{class:"carousel-item",style:{background:"#364d79",color:"#fff",height:"160px","line-height":"160px","text-align":"center"}}," Slide 1 ",-1),n("div",{class:"carousel-item",style:{background:"#7dbcea",color:"#fff",height:"160px","line-height":"160px","text-align":"center"}}," Slide 2 ",-1),n("div",{class:"carousel-item",style:{background:"#00a0e9",color:"#fff",height:"160px","line-height":"160px","text-align":"center"}}," Slide 3 ",-1),n("div",{class:"carousel-item",style:{background:"#1890ff",color:"#fff",height:"160px","line-height":"160px","text-align":"center"}}," Slide 4 ",-1)])]),_:1}))}}),zn=`<template>
