import{B as c}from"./Button-dLk1ExkL.js";import{n as x,M as E,L as I,D as B,o as k,e as w,z as g,j as b,m as n,J as l,Q as e,l as i,h as N,g as d,I as C,F as V,E as F,G as H,k as R}from"./index-DBrYVvYd.js";import{T as U}from"./Tooltip-naksvY3s.js";import"./icons-CTzpiRs0.js";import"./cls-S9IiI6wd.js";import"./Icon-CiCvy_Uq.js";const u=x({name:"Popconfirm",inheritAttrs:!1,props:{title:[String,Number,Object,Function],description:[String,Number,Object,Function],icon:{type:[String,Number,Object,Function],default:"⚠"},okText:String,cancelText:String,okType:{type:String,default:"primary"},okButtonProps:Object,cancelButtonProps:Object,showCancel:{type:Boolean,default:!0},trigger:{type:[String,Array],default:"click"},placement:{type:String,default:"top"},open:{type:Boolean,default:void 0},defaultOpen:Boolean,disabled:Boolean,arrow:{type:[Boolean,Object],default:!0},mouseEnterDelay:{type:Number,default:.1},mouseLeaveDelay:{type:Number,default:.1},autoAdjustOverflow:{type:Boolean,default:!0},zIndex:Number,destroyOnHidden:Boolean,destroyTooltipOnHide:Boolean,getPopupContainer:Function,overlayStyle:Object,overlayInnerStyle:Object},emits:["update:open","openChange","afterOpenChange","confirm","cancel"],setup(r,{slots:a,emit:o,attrs:f}){const t=E("popconfirm"),m=I(),s=B(r.defaultOpen??!1),P=w(()=>r.open!==void 0),z=w(()=>P.value?r.open:s.value),_=p=>{r.disabled&&p||(P.value||(s.value=p),o("update:open",p),o("openChange",p))},T=(p,y)=>{if(y)return y();if(typeof p=="function")return p();if(p!=null&&p!=="")return p},h=p=>{o("confirm",p),_(!1)},D=p=>{o("cancel",p),_(!1)},M=w(()=>{const p=r.title,y=r.description;return p!=null&&p!==""||y!=null&&y!==""||!!a.title||!!a.description});return()=>{const p=T(r.title,a.title),y=T(r.description,a.description),S=T(r.icon,a.icon),A=r.cancelText??m.value.Modal.cancelText,L=r.okText??m.value.Modal.okText,$=r.okType==="danger",j=$?"primary":r.okType,O=[k("div",{class:`${t}-message`},[S&&k("span",{class:`${t}-message-icon`},S),k("div",{class:`${t}-message-title`},p)])];return y&&O.push(k("div",{class:`${t}-description`},y)),O.push(k("div",{class:`${t}-buttons`},[r.showCancel&&k(c,{size:"small",...r.cancelButtonProps,onClick:D},{default:()=>A}),k(c,{size:"small",type:j,danger:$,...r.okButtonProps,onClick:h},{default:()=>L})])),k(U,{...f,customPrefixCls:t,arrow:r.arrow,placement:r.placement,trigger:r.trigger,open:z.value,defaultOpen:r.defaultOpen,mouseEnterDelay:r.mouseEnterDelay,mouseLeaveDelay:r.mouseLeaveDelay,disabled:r.disabled,autoAdjustOverflow:r.autoAdjustOverflow,zIndex:r.zIndex,destroyOnHidden:r.destroyOnHidden,destroyTooltipOnHide:r.destroyTooltipOnHide,getPopupContainer:r.getPopupContainer,popupStyle:r.overlayStyle,"onUpdate:open":v=>_(v),onAfterOpenChange:v=>o("afterOpenChange",v)},M.value&&!r.disabled?{default:()=>{var v;return(v=a.default)==null?void 0:v.call(a)},title:()=>O}:{default:()=>{var v;return(v=a.default)==null?void 0:v.call(a)}})}}}),W={style:{display:"flex",gap:"16px","align-items":"center"}},G=x({__name:"PopconfirmAsync",setup(r){const a=B(!1),o=B(!1);function f(){a.value=!0,setTimeout(()=>{console.log("提交成功"),a.value=!1},2e3)}function t(){o.value=!0,setTimeout(()=>{console.log("删除成功"),o.value=!1},2e3)}return(m,s)=>(g(),b("div",W,[n(l(u),{title:"确定要提交吗？",description:"提交后将发送到服务器","ok-text":"提交","cancel-text":"取消","ok-button-props":{loading:a.value},onConfirm:f},{default:e(()=>[n(l(c),null,{default:e(()=>[...s[0]||(s[0]=[i("异步提交",-1)])]),_:1})]),_:1},8,["ok-button-props"]),n(l(u),{title:"确定要执行吗？","ok-text":"确定","cancel-text":"取消","ok-button-props":{disabled:!0}},{default:e(()=>[n(l(c),null,{default:e(()=>[...s[1]||(s[1]=[i("确定按钮禁用",-1)])]),_:1})]),_:1}),n(l(u),{title:"确定要删除吗？","ok-type":"danger","ok-text":"强制删除","cancel-text":"取消","ok-button-props":{loading:o.value},"cancel-button-props":{disabled:o.value},onConfirm:t},{default:e(()=>[n(l(c),null,{default:e(()=>[...s[2]||(s[2]=[i("强制删除",-1)])]),_:1})]),_:1},8,["ok-button-props","cancel-button-props"])]))}}),J=`<template>
...
<\/script>
`,Q=x({__name:"PopconfirmBasic",setup(r){function a(){console.log("已确认删除")}function o(){console.log("已取消")}return(f,t)=>(g(),N(l(u),{title:"确定要删除吗？","ok-text":"确定","cancel-text":"取消",onConfirm:a,onCancel:o},{default:e(()=>[n(l(c),null,{default:e(()=>[...t[0]||(t[0]=[i("删除",-1)])]),_:1})]),_:1}))}}),q=`<template>
