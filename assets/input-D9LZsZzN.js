import{I as i,T as h,a as q,b}from"./Input-i0ITQP_t.js";import{o as k,A as v,k as x,n as a,K as s,E as d,h as e,R as f,m as y,J as w,j as N,_ as C,H as A,l as E}from"./index-0wAKNcUB.js";import{S}from"./Space-BU3Kkzda.js";import{C as T}from"./CloseCircleOutlined-uCyLiZEa.js";import{S as I}from"./SearchOutlined-Dj1YeEev.js";import{U as P}from"./UserOutlined-C43NTMxM.js";import"./cls-S9IiI6wd.js";import"./CloseOutlined-gVBUVFC5.js";import"./EyeOutlined-CjdSCucN.js";import"./LoadingOutlined-8a6xi408.js";import"./Icon-BHSpInk3.js";const U={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"400px"}},W=k({__name:"InputAddon",setup(g){const l=d(""),u=d(""),r=d("");return(t,o)=>(v(),x("div",U,[a(s(i),{value:l.value,"onUpdate:value":o[0]||(o[0]=c=>l.value=c),placeholder:"请输入用户名",prefix:"👤"},null,8,["value"]),a(s(i),{value:u.value,"onUpdate:value":o[1]||(o[1]=c=>u.value=c),placeholder:"请输入金额",prefix:"¥",suffix:"元"},null,8,["value"]),a(s(i),{value:r.value,"onUpdate:value":o[2]||(o[2]=c=>r.value=c),placeholder:"支持清除","allow-clear":""},null,8,["value"])]))}}),V=`<template>
