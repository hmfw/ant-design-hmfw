import{i as e,j as d,y as n}from"./index-Qxz1plB-.js";const a={class:"markdown-body"},i={__name:"theming",setup(s,{expose:o}){return o({frontmatter:{}}),(r,t)=>(n(),e("div",a,[...t[0]||(t[0]=[d(`<h1 id="" tabindex="-1">主题定制</h1><p>ant-design-hmfw 基于 CSS Variables 实现主题定制，通过 <code>ConfigProvider</code> 传入自定义 Token 即可覆盖默认样式。</p><h2 id="-token-" tabindex="-1">设计 Token 系统</h2><p>Token 分为三层：</p><ul><li><strong>Seed Token</strong>：最基础的设计变量，如主色、字体大小、圆角等</li><li><strong>Map Token</strong>：由 Seed Token 派生的中间层 Token</li><li><strong>CSS Variables</strong>：最终注入到 <code>:root</code> 的 CSS 变量</li></ul><h2 id="-configprovider-" tabindex="-1">通过 ConfigProvider 定制</h2><pre class="language-vue"><code class="language-vue">&lt;template&gt;
