import{S as y}from"./Space-Bgt0TEg4.js";import{S as N}from"./index-fkmUQj8S.js";import{n as g,M as B,K as F,m as e,P as k,w as R,x as z,D as x,z as h,j as b,J as a,Q as r,_ as w,o as C,g as s,l as H,I as j,G as I,k as M}from"./index-i0jnWELi.js";import{c as $}from"./cls-S9IiI6wd.js";import{m as P}from"./message-D_gKKLEQ.js";import{B as O}from"./Button-BxE2sJbo.js";import"./icons-DkTSuFEr.js";import"./Icon-D9pw0Su_.js";function A(t,d,i=",",l="."){if(t==null||t==="")return"";const n=typeof t=="string"?parseFloat(t):t;if(isNaN(n))return String(t);const c=(d!==void 0?n.toFixed(d):String(n)).split("."),v=c[0],m=c[1],p=v.replace(/\B(?=(\d{3})+(?!\d))/g,i);return m!==void 0?`${p}${l}${m}`:p}const u=g({name:"Statistic",props:{title:[String,Object],value:[String,Number],precision:Number,prefix:[String,Object],suffix:[String,Object],valueStyle:Object,groupSeparator:{type:String,default:","},decimalSeparator:{type:String,default:"."},loading:Boolean,valueRender:Function},setup(t){const d=B("statistic"),i=F();return()=>{if(t.loading)return e("div",{class:$(d,{[`${d}-rtl`]:i.value.direction==="rtl"})},[t.title&&e("div",{class:`${d}-title`},[t.title]),e(N,{active:!0,title:!1,paragraph:{rows:1,width:"100%"}},null)]);const l=A(t.value,t.precision,t.groupSeparator,t.decimalSeparator),n=()=>t.valueRender?t.valueRender(l):l;return e("div",{class:$(d,{[`${d}-rtl`]:i.value.direction==="rtl"})},[t.title&&e("div",{class:`${d}-title`},[t.title]),e("div",{class:`${d}-content`,style:t.valueStyle},[t.prefix&&e("span",{class:`${d}-content-prefix`},[t.prefix]),e("span",{class:`${d}-content-value`},[n()]),t.suffix&&e("span",{class:`${d}-content-suffix`},[t.suffix])])])}}});function L(t,d="HH:mm:ss"){if(t<=0)return d.replace(/Y+|M+|D+|H+|m+|s+|S+/g,S=>"0".repeat(S.length));const i=Math.floor(t/1e3),l=Math.floor(i/60),n=Math.floor(l/60),o=Math.floor(n/24),c=i%60,v=l%60,m=n%24,p={DD:String(o).padStart(2,"0"),D:String(o),HH:String(m).padStart(2,"0"),H:String(m),mm:String(v).padStart(2,"0"),m:String(v),ss:String(c).padStart(2,"0"),s:String(c),SSS:String(t%1e3).padStart(3,"0")};return d.replace(/DD|D|HH|H|mm|m|ss|s|SSS/g,S=>p[S]??S)}const D=g({name:"Countdown",props:{title:[String,Object],value:[Number,Date],format:{type:String,default:"HH:mm:ss"},prefix:[String,Object],suffix:[String,Object],valueStyle:Object,loading:Boolean,valueRender:Function,onFinish:Function,onChange:Function},setup(t,{emit:d}){const i=B("statistic"),l=F(),n=x(0);let o=null,c=0;const v=()=>{if(!t.value)return 0;const _=t.value instanceof Date?t.value.getTime():t.value,f=Date.now();return Math.max(0,_-f)},m=_=>{var V;const f=v();if(n.value=f,t.onChange&&f!==c&&(t.onChange(f),c=f),f<=0){o!==null&&(cancelAnimationFrame(o),o=null),(V=t.onFinish)==null||V.call(t),d("finish");return}o=requestAnimationFrame(m)},p=()=>{o!==null&&cancelAnimationFrame(o),n.value=v(),c=n.value,o=requestAnimationFrame(m)},S=()=>{o!==null&&(cancelAnimationFrame(o),o=null)};return k(()=>t.value,()=>{p()}),R(()=>{p()}),z(()=>{S()}),()=>{if(t.loading)return e("div",{class:$(i,{[`${i}-rtl`]:l.value.direction==="rtl"})},[t.title&&e("div",{class:`${i}-title`},[t.title]),e(N,{active:!0,title:!1,paragraph:{rows:1,width:"100%"}},null)]);const _=L(n.value,t.format),f=()=>t.valueRender?t.valueRender(_):_;return e("div",{class:$(i,`${i}-countdown`,{[`${i}-rtl`]:l.value.direction==="rtl"})},[t.title&&e("div",{class:`${i}-title`},[t.title]),e("div",{class:`${i}-content`,style:t.valueStyle},[t.prefix&&e("span",{class:`${i}-content-prefix`},[t.prefix]),e("span",{class:`${i}-content-value`},[f()]),t.suffix&&e("span",{class:`${i}-content-suffix`},[t.suffix])])])}}}),T={class:"statistic-demo"},U=g({__name:"StatisticBasic",setup(t){return(d,i)=>(h(),b("div",T,[e(a(y),{size:32},{default:r(()=>[e(a(u),{title:"用户数",value:112893}),e(a(u),{title:"账户余额（元）",value:112893,precision:2}),e(a(u),{title:"活跃用户",value:93,suffix:"/ 100"})]),_:1})]))}}),q=w(U,[["__scopeId","data-v-55cb24ae"]]),E=`<template>
...
`,W={class:"statistic-demo"},G=g({__name:"StatisticCountdown",setup(t){const d=x(Date.now()+72e5),i=x(Date.now()+1e3*60*60*24*2+1e3*30*30),l=x(Date.now()+1e3*10),n=()=>{P.success("倒计时结束！")};return(o,c)=>(h(),b("div",W,[e(a(y),{direction:"vertical",size:16},{default:r(()=>[e(a(D),{title:"倒计时",value:d.value,format:"HH:mm:ss"},null,8,["value"]),e(a(D),{title:"天数倒计时",value:i.value,format:"DD 天 HH 时 mm 分 ss 秒"},null,8,["value"]),e(a(D),{title:"毫秒倒计时",value:l.value,format:"HH:mm:ss:SSS",onFinish:n},null,8,["value"])]),_:1})]))}}),J=w(G,[["__scopeId","data-v-8078238b"]]),K=`<template>
  <div class="statistic-demo">
...
`,Q={class:"statistic-demo"},Y=g({__name:"StatisticCustom",setup(t){const d=i=>C("span",{style:{color:"#cf1322",fontWeight:"bold"}},[C("span","💰 "),i,C("span"," 元")]);return(i,l)=>(h(),b("div",Q,[e(a(y),{size:32},{default:r(()=>[e(a(u),{title:"自定义渲染",value:112893,"value-render":d}),e(a(u),{title:"增长率",value:9.3,precision:2,suffix:"%","value-style":{color:"#3f8600"},prefix:C("span",{style:{color:"#3f8600"}},"↑")},null,8,["prefix"])]),_:1})]))}}),X=w(Y,[["__scopeId","data-v-6335d6bd"]]),Z=`<template>
  <div class="statistic-demo">
    <Space :size="32">
      <Statistic
        title="自定义渲染"
...
`,tt={class:"statistic-demo"},et={style:{"margin-top":"16px"}},nt=g({__name:"StatisticLoading",setup(t){const d=x(!0),i=x(112893),l=()=>{d.value=!d.value};return(n,o)=>(h(),b("div",tt,[e(a(y),{size:32},{default:r(()=>[e(a(u),{title:"用户数",value:i.value,loading:d.value},null,8,["value","loading"]),e(a(u),{title:"活跃用户",value:93,suffix:"/ 100",loading:d.value},null,8,["loading"]),e(a(D),{title:"倒计时",value:Date.now()+6e4,loading:d.value},null,8,["value","loading"])]),_:1}),s("div",et,[e(a(O),{onClick:l},{default:r(()=>[H(j(d.value?"显示内容":"显示加载"),1)]),_:1})])]))}}),dt=w(nt,[["__scopeId","data-v-f5bfc611"]]),it=`<template>
  <div class="statistic-demo">
    <Space :size="32">
      <Statistic
        title="用户数"
...
`,at={class:"statistic-demo"},ot=g({__name:"StatisticUnit",setup(t){return(d,i)=>(h(),b("div",at,[e(a(y),{size:32},{default:r(()=>[e(a(u),{title:"账户余额",value:112893,precision:2,prefix:"$"}),e(a(u),{title:"增长率",value:9.3,precision:2,suffix:"%"}),e(a(u),{title:"价格",value:568.08,precision:2,prefix:"¥","value-style":{color:"#3f8600"}})]),_:1})]))}}),st=w(ot,[["__scopeId","data-v-8d84ad83"]]),lt=`<template>
  <div class="statistic-demo">
    <Space :size="32">
      <Statistic
        title="账户余额"
