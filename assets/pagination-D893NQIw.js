import{S as x}from"./Space-CLLuvOfj.js";import{P as p}from"./Pagination-DMxHG5Um.js";import{n as b,z as g,h as S,Q as u,g as e,m as n,J as o,I as z,D as h,o as f,G as P,j as w,l as m,k as y}from"./index-BIkAb7lZ.js";import"./cls-S9IiI6wd.js";import"./icons-DLCoPw-s.js";import"./Icon-DOjVoSFw.js";import"./Select-U8hIkWZA.js";import"./VirtualList-6vtixCj9.js";const k=b({__name:"PaginationAlign",setup(v){return(r,i)=>(g(),S(o(x),{direction:"vertical",style:{width:"100%"}},{default:u(()=>[e("div",null,[i[0]||(i[0]=e("h4",null,"左对齐（默认）",-1)),n(o(p),{total:50})]),e("div",null,[i[1]||(i[1]=e("h4",null,"居中对齐",-1)),n(o(p),{total:50,align:"center"})]),e("div",null,[i[2]||(i[2]=e("h4",null,"右对齐",-1)),n(o(p),{total:50,align:"end"})]),e("div",null,[i[3]||(i[3]=e("h4",null,"完整功能 + 居中对齐",-1)),n(o(p),{total:500,"show-size-changer":"","show-quick-jumper":"","show-total":a=>`共 ${a} 条`,align:"center"},null,8,["show-total"])])]),_:1}))}}),C=`<template>
...
<\/script>
`,$=b({__name:"PaginationBasic",setup(v){const r=h(1);return(i,a)=>(g(),S(o(x),{direction:"vertical"},{default:u(()=>[n(o(p),{total:50,current:r.value,"onUpdate:current":a[0]||(a[0]=t=>r.value=t)},null,8,["current"]),e("p",null,"当前页："+z(r.value),1)]),_:1}))}}),R=`<template>
...
const current = ref(1)
<\/script>
`,j={style:{"margin-top":"8px",color:"#666"}},N=b({__name:"PaginationItemRender",setup(v){const r=h(1),i=(l,d,c)=>d==="prev"?f("a","上一页"):d==="next"?f("a","下一页"):c,a=(l,d,c)=>d==="page"?f("a",{style:{display:"inline-block",padding:"0 8px",border:"1px solid #d9d9d9",borderRadius:"4px",fontWeight:"bold"}},`[${l}]`):c,t=(l,d,c)=>d==="page"?f("a",{href:`#page-${l}`},l):d==="prev"?f("a",{href:"#prev"},"← 上一页"):d==="next"?f("a",{href:"#next"},"下一页 →"):c,s=l=>{r.value=l};return(l,d)=>(g(),S(o(x),{direction:"vertical",style:{width:"100%"}},{default:u(()=>[e("div",null,[d[0]||(d[0]=e("h4",null,"自定义上一页/下一页文本",-1)),n(o(p),{total:50,"item-render":i})]),e("div",null,[d[1]||(d[1]=e("h4",null,"自定义页码样式",-1)),n(o(p),{total:100,"item-render":a})]),e("div",null,[d[2]||(d[2]=e("h4",null,"链接模式",-1)),n(o(p),{total:50,"item-render":t,onChange:s}),e("p",j," 点击页码查看链接效果（当前页："+z(r.value)+"） ",1)])]),_:1}))}}),V=`<template>
  <Space direction="vertical" style="width: 100%">
    <div>
      <h4>自定义上一页/下一页文本</h4>
...
`,E=b({__name:"PaginationMore",setup(v){const r=h(1),i=h(10),a=(s,l)=>{console.log("页码变化:",s,l)},t=(s,l)=>{console.log("每页条数变化:",s,l)};return(s,l)=>(g(),S(o(x),{direction:"vertical"},{default:u(()=>[n(o(p),{current:r.value,"onUpdate:current":l[0]||(l[0]=d=>r.value=d),"page-size":i.value,"onUpdate:pageSize":l[1]||(l[1]=d=>i.value=d),total:500,"show-size-changer":"","show-quick-jumper":"","show-total":(d,c)=>`第 ${c[0]}-${c[1]} 条，共 ${d} 条`,onChange:a,onShowSizeChange:t},null,8,["current","page-size","show-total"]),e("p",null,"当前页："+z(r.value)+"，每页条数："+z(i.value),1)]),_:1}))}}),_=`<template>
  <Space direction="vertical">
    <Pagination
...
<\/script>
`,B=b({__name:"PaginationSimple",setup(v){const r=h(1);return(i,a)=>(g(),S(o(p),{simple:"",total:50,current:r.value,"onUpdate:current":a[0]||(a[0]=t=>r.value=t)},null,8,["current"]))}}),q=`<template>
...
const current = ref(1)
<\/script>
`,T=b({__name:"PaginationSmall",setup(v){const r=h(1);return(i,a)=>(g(),S(o(x),{direction:"vertical"},{default:u(()=>[n(o(p),{size:"small",total:50,current:r.value,"onUpdate:current":a[0]||(a[0]=t=>r.value=t)},null,8,["current"]),n(o(p),{size:"small",total:50,current:r.value,"onUpdate:current":a[1]||(a[1]=t=>r.value=t),"show-size-changer":"","show-quick-jumper":""},null,8,["current"])]),_:1}))}}),U=`<template>
  <Space direction="vertical">
