import{M as b}from"./Modal-WhfTUAmZ.js";import{m as v,y as p,i as f,F as g,f as e,l as a,I as u,P as s,B as i,H as k,E as M,j as x}from"./index-CsoOETlJ.js";import"./cls-S9IiI6wd.js";const C=v({__name:"ModalBasic",setup(c){const o=i(!1);function r(){console.log("确认"),o.value=!1}function d(){console.log("取消"),o.value=!1}return(t,n)=>(p(),f(g,null,[e("button",{onClick:n[0]||(n[0]=l=>o.value=!0)},"打开对话框"),a(u(b),{open:o.value,"onUpdate:open":n[1]||(n[1]=l=>o.value=l),title:"基础对话框",onOk:r,onCancel:d},{default:s(()=>[...n[2]||(n[2]=[e("p",null,"对话框内容",-1),e("p",null,"对话框内容",-1),e("p",null,"对话框内容",-1)])]),_:1},8,["open"])],64))}}),h=`<template>
