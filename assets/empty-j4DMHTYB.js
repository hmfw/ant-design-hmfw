import{B as k}from"./Button-CbNYWpGi.js";import{E as l,P as y}from"./Empty-CSgz3Wkq.js";import{d as m,o as r,q as g,w as i,c as s,e as a,g as p,b as f,f as n,_ as x,s as h,K as b,r as E,h as v,i as w}from"./index-dV6GQSVR.js";import"./cls-S9IiI6wd.js";import"./LoadingOutlined-CdSjzm5S.js";const S=m({__name:"EmptyAction",setup(d){function o(){console.log("创建")}return(e,c)=>(r(),g(a(l),{description:"暂无数据"},{default:i(()=>[s(a(k),{onClick:o},{default:i(()=>[...c[0]||(c[0]=[p("立即创建",-1)])]),_:1})]),_:1}))}}),q=`<template>
...
`,I=m({__name:"EmptyCustomDescription",setup(d){return(o,e)=>(r(),g(a(l),{description:"暂无数据，请稍后再试"}))}}),A=`<template>
