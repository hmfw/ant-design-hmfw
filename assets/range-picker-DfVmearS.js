import{S as Ma}from"./Space-DxoCbPXb.js";import{d as W,u as nn,C as sn,r as I,m as tn,c as t,a as b,g as f,o as z,q as ea,w as Y,e as k,f as c,A as Ta,b as Ya,_ as en,h as on,i as pn}from"./index-DZWA4HiS.js";import{c as d}from"./cls-S9IiI6wd.js";import{C as ln}from"./CloseCircleFilled-DiZVqLZC.js";import{C as cn}from"./CalendarOutlined-Bop964ys.js";import{T as rn}from"./Trigger-B9GAuuS8.js";function Ba(a){return String(a).padStart(2,"0")}function sa(a,e="YYYY-MM-DD"){return e.replace("YYYY",String(a.getFullYear())).replace("MM",Ba(a.getMonth()+1)).replace("DD",Ba(a.getDate()))}function M(a){if(!a)return null;const e=new Date(a);return isNaN(e.getTime())?null:e}function ta(a,e){return a.getFullYear()===e.getFullYear()&&a.getMonth()===e.getMonth()&&a.getDate()===e.getDate()}function Ea(a,e){return new Date(a,e+1,0).getDate()}function dn(a,e){return new Date(a,e,1).getDay()}function un(a,e){const n=[],p=dn(a,e),o=Ea(a,e),g=Ea(a,e-1);for(let r=p-1;r>=0;r--)n.push({date:new Date(a,e-1,g-r),inCurrentMonth:!1});for(let r=1;r<=o;r++)n.push({date:new Date(a,e,r),inCurrentMonth:!0});const w=42-n.length;for(let r=1;r<=w;r++)n.push({date:new Date(a,e+1,r),inCurrentMonth:!1});return n}const x=W({name:"RangePicker",props:{value:Array,defaultValue:Array,format:{type:String,default:"YYYY-MM-DD"},disabled:{type:[Boolean,Array],default:!1},placeholder:{type:Array},allowClear:{type:Boolean,default:!0},allowEmpty:{type:Array},order:{type:Boolean,default:!0},separator:{type:String,default:"→"},presets:{type:Array},size:{type:String,default:"middle"},disabledDate:Function,status:{type:String,default:""},open:{type:Boolean,default:void 0},classNames:Object,styles:Object},emits:["update:value","change","openChange","calendarChange"],setup(a,{emit:e}){const n=nn("date-picker"),p=sn(),o=new Date,g=b(()=>a.placeholder?a.placeholder:p.value.DatePicker.rangePlaceholder??["Start date","End date"]),w=s=>s?[M(s[0]),M(s[1])]:[null,null],r=I(w(a.defaultValue??a.value));tn(()=>a.value,s=>{r.value=w(s)});const $=b(()=>a.value?M(a.value[0]):r.value[0]),j=b(()=>a.value?M(a.value[1]):r.value[1]),oa=I(!1),K=b(()=>a.open!==void 0?a.open:oa.value),R=I("start"),H=I(null),T=I(($.value??o).getFullYear()),v=I(($.value??o).getMonth()),Ha=b(()=>v.value===11?T.value+1:T.value),Oa=b(()=>v.value===11?0:v.value+1),Aa=I(),L=b(()=>typeof a.disabled=="boolean"&&a.disabled),Va=b(()=>Array.isArray(a.disabled)?!!a.disabled[0]:!!a.disabled),_a=b(()=>Array.isArray(a.disabled)?!!a.disabled[1]:!!a.disabled),Fa=b(()=>$.value?sa($.value,a.format):""),Wa=b(()=>j.value?sa(j.value,a.format):""),za=b(()=>!!($.value||j.value)),pa=s=>{a.open===void 0&&(oa.value=s),e("openChange",s)},ja=()=>{if(L.value||K.value)return;const s=$.value??o;T.value=s.getFullYear(),v.value=s.getMonth(),R.value=$.value&&!j.value?"end":"start",pa(!0)},Q=()=>{H.value=null,pa(!1)},U=s=>s?sa(s,a.format):null,Z=(s,l)=>{e("calendarChange",[U(s[0]),U(s[1])],s,{range:l})},la=s=>{const l=[U(s[0]),U(s[1])];r.value=s,e("update:value",l),e("change",l,s)},La=s=>{var l;if(!((l=a.disabledDate)!=null&&l.call(a,s,{type:"date",from:r.value[0]??void 0})))if(R.value==="start")r.value=[s,null],R.value="end",Z([s,null],"start");else{let u=r.value[0],m=s;a.order&&u&&m<u&&([u,m]=[m,u]);const i=[u,m];Z(i,"end"),la(i),Q()}},Ua=s=>{const l=typeof s.value=="function"?s.value():s.value,u=[M(l[0]),M(l[1])];Z(u,"end"),la(u),Q()},Xa=s=>{s.stopPropagation(),r.value=[null,null],R.value="start",e("update:value",[null,null]),e("change",[null,null],[null,null])},Ga=()=>{v.value===0?(T.value--,v.value=11):v.value--},Ja=()=>{v.value===11?(T.value++,v.value=0):v.value++};function Ka(s){const l=r.value[0],u=R.value==="end"?H.value??r.value[1]:r.value[1];if(!l||!u)return!1;const[m,i]=l<=u?[l,u]:[u,l];return s>m&&s<i}function Qa(s){const l=r.value[0];return!!(l&&ta(s,l))}function Za(s){const l=R.value==="end"?H.value??r.value[1]:r.value[1];return!!(l&&ta(s,l))}function ca(s,l,u){var i,D,q,P,S,N,C,O,A,V,_,F,ra,da,ua,ia,ka,ga,ma,ya;const m=un(s,l);return t("div",{class:d(`${n}-panel`,(i=a.classNames)==null?void 0:i.panel),style:(D=a.styles)==null?void 0:D.panel},[t("div",{class:d(`${n}-panel-header`,(q=a.classNames)==null?void 0:q.panelHeader),style:(P=a.styles)==null?void 0:P.panelHeader},[u==="left"&&t("button",{class:d(`${n}-panel-header-btn`,(S=a.classNames)==null?void 0:S.panelHeaderBtn),style:(N=a.styles)==null?void 0:N.panelHeaderBtn,onClick:Ga},[f("‹")]),u==="right"&&t("span",{class:d(`${n}-panel-header-btn`,(C=a.classNames)==null?void 0:C.panelHeaderBtn),style:{visibility:"hidden",...(O=a.styles)==null?void 0:O.panelHeaderBtn}},[f("‹")]),t("span",{class:d(`${n}-panel-header-title`,(A=a.classNames)==null?void 0:A.panelHeaderTitle),style:(V=a.styles)==null?void 0:V.panelHeaderTitle},[s,f("年 "),p.value.DatePicker.months[l]]),u==="right"&&t("button",{class:d(`${n}-panel-header-btn`,(_=a.classNames)==null?void 0:_.panelHeaderBtn),style:(F=a.styles)==null?void 0:F.panelHeaderBtn,onClick:Ja},[f("›")]),u==="left"&&t("span",{class:d(`${n}-panel-header-btn`,(ra=a.classNames)==null?void 0:ra.panelHeaderBtn),style:{visibility:"hidden",...(da=a.styles)==null?void 0:da.panelHeaderBtn}},[f("›")])]),t("div",{class:d(`${n}-panel-body`,(ua=a.classNames)==null?void 0:ua.panelBody),style:(ia=a.styles)==null?void 0:ia.panelBody},[t("div",{class:d(`${n}-weekdays`,(ka=a.classNames)==null?void 0:ka.weekdays),style:(ga=a.styles)==null?void 0:ga.weekdays},[p.value.DatePicker.weekdays.map(h=>{var X,G;return t("span",{key:h,class:d(`${n}-weekday`,(X=a.classNames)==null?void 0:X.weekday),style:(G=a.styles)==null?void 0:G.weekday},[h])})]),t("div",{class:d(`${n}-days`,(ma=a.classNames)==null?void 0:ma.days),style:(ya=a.styles)==null?void 0:ya.days},[m.map(({date:h,inCurrentMonth:X},G)=>{var fa,ba,va,ha,wa,Sa,xa,Ra,Da,qa,Pa,Na,Ca,Ia,$a;const aa=ta(h,o),J=((fa=a.disabledDate)==null?void 0:fa.call(a,h,{type:"date",from:r.value[0]??void 0}))??!1,na=Ka(h),B=Qa(h),E=Za(h);let y=(ba=a.styles)==null?void 0:ba.day;return aa&&((va=a.styles)!=null&&va.dayToday)&&(y={...y,...a.styles.dayToday}),(B||E)&&((ha=a.styles)!=null&&ha.daySelected)&&(y={...y,...a.styles.daySelected}),na&&((wa=a.styles)!=null&&wa.dayInRange)&&(y={...y,...a.styles.dayInRange}),B&&((Sa=a.styles)!=null&&Sa.dayRangeStart)&&(y={...y,...a.styles.dayRangeStart}),E&&((xa=a.styles)!=null&&xa.dayRangeEnd)&&(y={...y,...a.styles.dayRangeEnd}),J&&((Ra=a.styles)!=null&&Ra.dayDisabled)&&(y={...y,...a.styles.dayDisabled}),t("button",{key:G,class:d(`${n}-day`,{[`${n}-day-other-month`]:!X,[`${n}-day-today`]:aa,[`${n}-day-selected`]:B||E,[`${n}-day-disabled`]:J,[`${n}-day-in-range`]:na,[`${n}-day-range-start`]:B,[`${n}-day-range-end`]:E},(Da=a.classNames)==null?void 0:Da.day,aa&&((qa=a.classNames)==null?void 0:qa.dayToday),(B||E)&&((Pa=a.classNames)==null?void 0:Pa.daySelected),na&&((Na=a.classNames)==null?void 0:Na.dayInRange),B&&((Ca=a.classNames)==null?void 0:Ca.dayRangeStart),E&&((Ia=a.classNames)==null?void 0:Ia.dayRangeEnd),J&&(($a=a.classNames)==null?void 0:$a.dayDisabled)),style:y,disabled:J,onClick:()=>La(h),onMouseenter:()=>{R.value==="end"&&(H.value=h)},onMouseleave:()=>{R.value==="end"&&(H.value=null)}},[h.getDate()])})])])])}const an=()=>{var s,l,u,m,i,D,q,P;return t("div",{ref:Aa,class:d(`${n}-popup`,`${n}-range-popup`,(s=a.classNames)==null?void 0:s.popup),style:(l=a.styles)==null?void 0:l.popup},[t("div",{class:d(`${n}-range-wrapper`,(u=a.classNames)==null?void 0:u.rangeWrapper),style:(m=a.styles)==null?void 0:m.rangeWrapper},[a.presets&&a.presets.length>0&&t("div",{class:d(`${n}-presets`,(i=a.classNames)==null?void 0:i.presets),style:(D=a.styles)==null?void 0:D.presets},[t("ul",null,[a.presets.map(S=>{var N,C;return t("li",{key:S.label,class:d(`${n}-preset`,(N=a.classNames)==null?void 0:N.preset),style:(C=a.styles)==null?void 0:C.preset,onClick:()=>Ua(S)},[S.label])})])]),t("div",{class:d(`${n}-range-panels`,(q=a.classNames)==null?void 0:q.rangePanels),style:(P=a.styles)==null?void 0:P.rangePanels},[ca(T.value,v.value,"left"),ca(Ha.value,Oa.value,"right")])])])};return()=>{var s,l,u,m;return t(rn,{open:K.value,trigger:"click",placement:"bottomLeft",disabled:L.value,destroyOnHidden:!0,triggerClass:d(`${n}`,`${n}-range`,`${n}-${a.size}`,{[`${n}-open`]:K.value,[`${n}-disabled`]:L.value,[`${n}-status-error`]:a.status==="error",[`${n}-status-warning`]:a.status==="warning"},(s=a.classNames)==null?void 0:s.root),triggerStyle:(l=a.styles)==null?void 0:l.root,popupClass:d(`${n}-popup`,`${n}-range-popup`,(u=a.classNames)==null?void 0:u.popup),popupStyle:(m=a.styles)==null?void 0:m.popup,onOpenChange:i=>{i?ja():Q()}},{default:()=>{var i,D,q,P,S,N,C,O,A,V,_,F;return t("span",{class:d(`${n}-input`,(i=a.classNames)==null?void 0:i.input),style:(D=a.styles)==null?void 0:D.input},[t("input",{readonly:!0,value:Fa.value,placeholder:g.value[0],disabled:Va.value,class:d(`${n}-input-inner`,(q=a.classNames)==null?void 0:q.startInput),style:(P=a.styles)==null?void 0:P.startInput},null),t("span",{class:d(`${n}-range-separator`,(S=a.classNames)==null?void 0:S.separator),style:(N=a.styles)==null?void 0:N.separator},[a.separator]),t("input",{readonly:!0,value:Wa.value,placeholder:g.value[1],disabled:_a.value,class:d(`${n}-input-inner`,(C=a.classNames)==null?void 0:C.endInput),style:(O=a.styles)==null?void 0:O.endInput},null),a.allowClear&&za.value&&!L.value&&t("span",{class:d(`${n}-clear`,(A=a.classNames)==null?void 0:A.clear),style:(V=a.styles)==null?void 0:V.clear,onClick:Xa},[t(ln,null,null)]),t("span",{class:d(`${n}-suffix`,(_=a.classNames)==null?void 0:_.suffix),style:(F=a.styles)==null?void 0:F.suffix},[t(cn,null,null)])])},popup:({placement:i})=>an()})}}}),kn=W({__name:"RangePickerBasic",setup(a){const e=I([null,null]);return(n,p)=>(z(),ea(k(Ma),{direction:"vertical"},{default:Y(()=>[t(k(x),{value:e.value,"onUpdate:value":p[0]||(p[0]=o=>e.value=o)},null,8,["value"]),c("span",null,"选择范围："+Ta(e.value[0])+" ~ "+Ta(e.value[1]),1)]),_:1}))}}),gn=`<template>
...
`,vn=W({__name:"RangePickerDisabled",setup(a){return(e,n)=>(z(),ea(k(Ma),{direction:"vertical"},{default:Y(()=>[t(k(x),{disabled:[!0,!1]}),t(k(x),{disabled:"",value:["2024-01-01","2024-01-31"]})]),_:1}))}}),hn=`<template>
  <Space direction="vertical">
