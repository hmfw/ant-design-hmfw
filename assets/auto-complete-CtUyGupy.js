import{o as S,N,E as i,Q as q,x as ee,y as te,n as d,T as le,F as oe,f as C,t as ne,A as y,k as O,K as p,H as ae,l as M,R as $,h as g,m as E}from"./index-C69_RY61.js";import{c as F}from"./cls-S9IiI6wd.js";const de=t=>t==="large"?"lg":t==="small"?"sm":"",b=S({name:"AutoComplete",inheritAttrs:!1,props:{value:String,defaultValue:{type:String,default:""},options:{type:Array,default:()=>[]},disabled:Boolean,placeholder:String,allowClear:{type:[Boolean,Object],default:!1},size:{type:String,default:"middle"},status:{type:String,default:""},filterOption:{type:[Boolean,Function],default:!0},backfill:Boolean,defaultActiveFirstOption:{type:Boolean,default:!0},notFoundContent:String,defaultOpen:Boolean,open:{type:Boolean,default:void 0}},emits:["update:value","change","select","search","focus","blur","clear","openChange"],setup(t,{slots:r,emit:u,attrs:f,expose:l}){const a=N("auto-complete"),n=N("input"),m=i(t.value??t.defaultValue??""),A=i(t.defaultOpen??!1),s=i(-1),w=i(),c=i(),v=i(),_=i({top:0,left:0,width:0}),W=C(()=>t.value!==void 0),R=C(()=>W.value?t.value:m.value),k=C(()=>t.open!==void 0?t.open:A.value);q(()=>t.value,e=>{e!==void 0&&(m.value=e)});const x=C(()=>{const e=R.value;return!e||t.filterOption===!1?t.options:typeof t.filterOption=="function"?t.options.filter(o=>t.filterOption(e,o)):t.options.filter(o=>o.value.toLowerCase().includes(e.toLowerCase())||(o.label??o.value).toLowerCase().includes(e.toLowerCase()))}),K=C(()=>x.value.length>0||!!t.notFoundContent),j=C(()=>x.value.findIndex(e=>!e.disabled)),V=()=>{s.value=t.defaultActiveFirstOption?j.value:-1};q(()=>x.value,e=>{var o;k.value&&(s.value>=e.length||s.value>=0&&((o=e[s.value])!=null&&o.disabled)||s.value===-1)&&V()});const D=e=>{A.value!==e&&(A.value=e,u("openChange",e))},H=()=>{if(!w.value)return;const e=w.value.getBoundingClientRect();_.value={top:e.bottom+window.scrollY+4,left:e.left+window.scrollX,width:e.width}},I=()=>{H(),D(!0)},L=()=>{D(!1),s.value=-1},z=e=>{m.value=e,u("update:value",e),u("change",e)},Q=e=>{const o=e.target.value;z(o),u("search",o),I(),V()},T=e=>{e.disabled||(z(e.value),u("select",e.value,e),L())},X=e=>{var o;e.preventDefault(),e.stopPropagation(),z(""),u("clear"),(o=c.value)==null||o.focus()},Y=()=>{ne(()=>{var o;const e=(o=v.value)==null?void 0:o.querySelector(`.${a}-dropdown-item-active`);e&&typeof e.scrollIntoView=="function"&&e.scrollIntoView({block:"nearest"})})},U=e=>{const o=x.value;if(!o.length)return;let h=s.value;for(let P=0;P<o.length&&(h=(h+e+o.length)%o.length,!!o[h].disabled);P++);s.value=h,t.backfill&&o[h]&&!o[h].disabled&&z(o[h].value),Y()},G=e=>{if(!k.value){(e.key==="ArrowDown"||e.key==="ArrowUp")&&(e.preventDefault(),I(),V());return}const o=x.value;e.key==="ArrowDown"?(e.preventDefault(),U(1)):e.key==="ArrowUp"?(e.preventDefault(),U(-1)):e.key==="Enter"?s.value>=0&&o[s.value]&&!o[s.value].disabled?(e.preventDefault(),T(o[s.value])):L():e.key==="Escape"&&L()},J=e=>{var o,h;!((o=w.value)!=null&&o.contains(e.target))&&!((h=v.value)!=null&&h.contains(e.target))&&L()};ee(()=>document.addEventListener("mousedown",J)),te(()=>document.removeEventListener("mousedown",J)),l({focus:()=>{var e;return(e=c.value)==null?void 0:e.focus()},blur:()=>{var e;return(e=c.value)==null?void 0:e.blur()}});const Z=()=>typeof t.allowClear=="object"&&t.allowClear.clearIcon?t.allowClear.clearIcon:"✕",B=C(()=>de(t.size));return()=>d(oe,null,[d("div",{ref:w,class:F(a,`${n}-affix-wrapper`,B.value&&`${n}-affix-wrapper-${B.value}`,{[`${n}-affix-wrapper-disabled`]:t.disabled,[`${n}-affix-wrapper-status-error`]:t.status==="error",[`${n}-affix-wrapper-status-warning`]:t.status==="warning",[`${n}-affix-wrapper-focused`]:k.value}),style:f.style},[r.prefix&&d("span",{class:`${n}-prefix`},[r.prefix()]),d("input",{ref:c,class:F(n,B.value&&`${n}-${B.value}`),value:R.value,disabled:t.disabled,placeholder:t.placeholder,onInput:Q,onFocus:e=>{I(),V(),u("focus",e)},onBlur:e=>u("blur",e),onKeydown:G,autocomplete:"off"},null),!!t.allowClear&&R.value&&!t.disabled&&d("span",{class:`${n}-clear-icon`,onMousedown:X},[Z()]),r.suffix&&d("span",{class:`${n}-suffix`},[r.suffix()])]),k.value&&K.value&&d(le,{to:"body"},{default:()=>[d("div",{ref:v,class:`${a}-dropdown`,style:{position:"absolute",top:`${_.value.top}px`,left:`${_.value.left}px`,width:`${_.value.width}px`,zIndex:1050}},[x.value.length>0?x.value.map((e,o)=>d("div",{key:e.value,class:F(`${a}-dropdown-item`,{[`${a}-dropdown-item-active`]:s.value===o,[`${a}-dropdown-item-disabled`]:e.disabled,[`${a}-dropdown-item-selected`]:e.value===R.value}),onMouseenter:()=>{e.disabled||(s.value=o)},onMousedown:h=>{h.preventDefault(),T(e)}},[e.label??e.value])):d("div",{class:`${a}-dropdown-empty`},[t.notFoundContent])])]})])}}),ue={style:{display:"flex","flex-direction":"column",gap:"16px",width:"300px"}},ie=S({__name:"AutoCompleteAdvanced",setup(t){const r=i(""),u=i(""),f=i("Vue"),l=i(""),a=i([{value:"Vue"},{value:"React"},{value:"Angular"}]),n=i([{value:"TypeScript"},{value:"JavaScript"},{value:"Python"}]),m=i([{value:"Vue"},{value:"React"},{value:"Angular"}]),A=i([{value:"Vue"},{value:"React"},{value:"Angular"}]),s=w=>{const c=["Vue","React","Angular"];A.value=c.filter(v=>v.toLowerCase().includes(w.toLowerCase())).map(v=>({value:v}))};return(w,c)=>(y(),O("div",ue,[d(p(b),{value:r.value,"onUpdate:value":c[0]||(c[0]=v=>r.value=v),options:a.value,placeholder:"默认高亮第一项","default-active-first-option":!0},null,8,["value","options"]),d(p(b),{value:u.value,"onUpdate:value":c[1]||(c[1]=v=>u.value=v),options:n.value,placeholder:"不高亮第一项","default-active-first-option":!1},null,8,["value","options"]),d(p(b),{value:f.value,"onUpdate:value":c[2]||(c[2]=v=>f.value=v),options:m.value,placeholder:"自定义清除图标","allow-clear":{clearIcon:"🗑️"}},null,8,["value","options"]),d(p(b),{value:l.value,"onUpdate:value":c[3]||(c[3]=v=>l.value=v),options:A.value,placeholder:"无匹配时显示提示","not-found-content":"无匹配结果",onSearch:s},null,8,["value","options"])]))}}),re=`<template>
...
<\/script>
`,se={style:{width:"300px"}},ce=S({__name:"AutoCompleteBasic",setup(t){const r=i(""),u=i([{value:"Vue"},{value:"React"},{value:"Angular"},{value:"Svelte"}]),f=l=>{const a=["Vue","React","Angular","Svelte","Solid"];u.value=a.filter(n=>n.toLowerCase().includes(l.toLowerCase())).map(n=>({value:n}))};return(l,a)=>(y(),O("div",se,[d(p(b),{value:r.value,"onUpdate:value":a[0]||(a[0]=n=>r.value=n),options:u.value,placeholder:"请输入内容",onSearch:f},null,8,["value","options"])]))}}),ve=`<template>
...
<\/script>
`,we={style:{display:"flex","flex-direction":"column",gap:"16px",width:"300px"}},xe=S({__name:"AutoCompleteSize",setup(t){const r=i(""),u=i(""),f=i(""),l=i([{value:"Vue"},{value:"React"},{value:"Angular"}]);return(a,n)=>(y(),O("div",we,[d(p(b),{value:r.value,"onUpdate:value":n[0]||(n[0]=m=>r.value=m),options:l.value,size:"large",placeholder:"Large size"},null,8,["value","options"]),d(p(b),{value:u.value,"onUpdate:value":n[1]||(n[1]=m=>u.value=m),options:l.value,placeholder:"Default size"},null,8,["value","options"]),d(p(b),{value:f.value,"onUpdate:value":n[2]||(n[2]=m=>f.value=m),options:l.value,size:"small",placeholder:"Small size"},null,8,["value","options"])]))}}),Ce=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; width: 300px">
