...
<\/script>
`,Un={style:{display:"flex","flex-direction":"column",gap:"24px"}},Fn=O({__name:"TimePickerClassNames",setup(n){return(c,i)=>(E(),A("div",Un,[s("div",null,[i[0]||(i[0]=s("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义触发器与输入区域：",-1)),l(k(v),{placeholder:"选择时间","class-names":{root:"custom-trigger",input:"custom-input",suffix:"custom-suffix"}})]),s("div",null,[i[1]||(i[1]=s("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义弹层与时间列：",-1)),l(k(v),{placeholder:"选择时间","class-names":{popup:"custom-popup",panel:"custom-panel",column:"custom-column",cell:"custom-cell"}})]),s("div",null,[i[2]||(i[2]=s("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义底部按钮样式：",-1)),l(k(v),{placeholder:"选择时间","need-confirm":!0,"class-names":{footer:"custom-footer",now:"custom-now-btn",ok:"custom-ok-btn"}})]),s("div",null,[i[3]||(i[3]=s("div",{style:{"margin-bottom":"8px",color:"#666"}},"使用内联样式对象：",-1)),l(k(v),{placeholder:"选择时间",styles:{root:{borderRadius:"20px",borderColor:"#722ed1"},input:{color:"#722ed1",fontWeight:500},suffix:{color:"#722ed1",fontSize:"18px"}}})]),s("div",null,[i[4]||(i[4]=s("div",{style:{"margin-bottom":"8px",color:"#666"}},"组合 classNames 与 styles：",-1)),l(k(v),{placeholder:"选择时间","need-confirm":!0,"class-names":{root:"gradient-trigger",popup:"gradient-popup",ok:"gradient-ok"},styles:{panel:{borderRadius:"12px"},cell:{fontWeight:500}}})])]))}}),Dn=Nn(Fn,[["__scopeId","data-v-8e2f9a88"]]),Rn=`<template>
...
const time2 = ref('')
<\/script>
`,Ln={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"300px"}},jn=O({__name:"TimePickerDisabled",setup(n){const c=u(""),i=u(""),p=()=>({disabledHours:()=>[0,1,2,3,4,5]}),t=()=>({disabledHours:()=>[0,1,2,3,4,5]});return(e,o)=>(E(),A("div",Ln,[s("div",null,[o[2]||(o[2]=s("p",{style:{"margin-bottom":"4px"}},"禁用部分小时：",-1)),l(k(v),{value:c.value,"onUpdate:value":o[0]||(o[0]=f=>c.value=f),"disabled-time":p,placeholder:"禁用 0-5 时"},null,8,["value"])]),s("div",null,[o[3]||(o[3]=s("p",{style:{"margin-bottom":"4px"}},"隐藏禁用选项：",-1)),l(k(v),{value:i.value,"onUpdate:value":o[1]||(o[1]=f=>i.value=f),"disabled-time":t,"hide-disabled-options":!0,placeholder:"隐藏 0-5 时"},null,8,["value"])])]))}}),Xn=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; max-width: 300px">
    <div>
...
<\/script>
`,Yn={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"300px"}},Gn=O({__name:"TimePickerFormat",setup(n){const c=u(""),i=u(""),p=u("");return(t,e)=>(E(),A("div",Yn,[s("div",null,[e[3]||(e[3]=s("p",{style:{"margin-bottom":"4px"}},"只显示时分（HH:mm）：",-1)),l(k(v),{value:c.value,"onUpdate:value":e[0]||(e[0]=o=>c.value=o),format:"HH:mm",placeholder:"选择时分"},null,8,["value"])]),s("div",null,[e[4]||(e[4]=s("p",{style:{"margin-bottom":"4px"}},"12 小时制：",-1)),l(k(v),{value:i.value,"onUpdate:value":e[1]||(e[1]=o=>i.value=o),"use12-hours":!0,format:"h:mm a",placeholder:"12 小时制"},null,8,["value"])]),s("div",null,[e[5]||(e[5]=s("p",{style:{"margin-bottom":"4px"}},"不显示秒：",-1)),l(k(v),{value:p.value,"onUpdate:value":e[2]||(e[2]=o=>p.value=o),format:"HH:mm","show-now":!1,placeholder:"不显示秒"},null,8,["value"])])]))}}),Jn=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; max-width: 300px">
    <div>
