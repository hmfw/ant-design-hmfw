...
<\/script>
`,F={style:{display:"flex",gap:"8px"}},M=h({__name:"PopoverTrigger",setup(e){return(d,n)=>(f(),y("div",F,[a(p(m),{title:"悬停触发",content:"鼠标悬停时显示",trigger:"hover"},{default:c(()=>[...n[0]||(n[0]=[o("button",null,"悬停",-1)])]),_:1}),a(p(m),{title:"点击触发",content:"点击时显示",trigger:"click"},{default:c(()=>[...n[1]||(n[1]=[o("button",null,"点击",-1)])]),_:1}),a(p(m),{title:"聚焦触发",content:"聚焦时显示",trigger:"focus"},{default:c(()=>[...n[2]||(n[2]=[o("button",null,"聚焦",-1)])]),_:1})]))}}),$=`<template>
