import{I as a}from"./InputNumber-ChDhesp8.js";import{k as x,w as m,g as v,j as l,G as o,z as i,d as e,E as f,B as y,M as b,i as s,h as g}from"./index-DvxRruME.js";import"./cls-S9IiI6wd.js";const h={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"300px"}},w=x({__name:"InputNumberAddon",setup(c){const d=i(null),u=i(null),r=i(null);return(t,n)=>(m(),v("div",h,[l(o(a),{value:d.value,"onUpdate:value":n[0]||(n[0]=p=>d.value=p),min:0,prefix:"¥","addon-after":"元",placeholder:"请输入价格",style:{width:"100%"}},null,8,["value"]),l(o(a),{value:u.value,"onUpdate:value":n[1]||(n[1]=p=>u.value=p),min:0,max:100,"addon-after":"%",placeholder:"请输入百分比",style:{width:"100%"}},null,8,["value"]),l(o(a),{value:r.value,"onUpdate:value":n[2]||(n[2]=p=>r.value=p),min:0,"addon-before":"重量","addon-after":"kg",placeholder:"请输入重量",style:{width:"100%"}},null,8,["value"])]))}}),N=`<template>
