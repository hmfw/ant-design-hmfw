import{B as f}from"./Button-dLk1ExkL.js";import{E as s,P as y}from"./Empty-V4fysCjT.js";import{n as c,z as m,h as g,Q as p,m as n,J as d,l as r,j as E,g as e,I as h,u as x,D as _,G as b,k as S}from"./index-DBrYVvYd.js";import"./icons-CTzpiRs0.js";import"./cls-S9IiI6wd.js";import"./Icon-CiCvy_Uq.js";const k=c({__name:"EmptyAction",setup(a){function i(){console.log("创建")}return(l,o)=>(m(),g(d(s),{description:"暂无数据"},{default:p(()=>[n(d(f),{onClick:i},{default:p(()=>[...o[0]||(o[0]=[r("立即创建",-1)])]),_:1})]),_:1}))}}),v=`<template>
...
<\/script>
`,D=c({__name:"EmptyCustomDescription",setup(a){return(i,l)=>(m(),g(d(s),{description:"暂无数据，请稍后再试"}))}}),I=`<template>
...
import { Empty } from 'ant-design-hmfw'
<\/script>
`,P=["data-theme"],C={style:{"margin-left":"12px"}},M=["data-theme"],A=c({__name:"EmptyDark",setup(a){const i=_("dark");return(l,o)=>(m(),E("div",null,[o[4]||(o[4]=e("p",{style:{"margin-bottom":"12px"}},"切换主题预览插画配色（暗黑模式下默认插画自动适配深色背景）：",-1)),e("div",{"data-theme":i.value,style:{"margin-bottom":"12px"}},[n(d(f),{onClick:o[0]||(o[0]=t=>i.value="light")},{default:p(()=>[...o[2]||(o[2]=[r("浅色",-1)])]),_:1}),n(d(f),{onClick:o[1]||(o[1]=t=>i.value="dark")},{default:p(()=>[...o[3]||(o[3]=[r("暗黑",-1)])]),_:1}),e("span",C,"当前："+h(i.value),1)],8,P),e("div",{"data-theme":i.value,style:x({padding:"24px",borderRadius:"8px",background:i.value==="dark"?"#141414":"#ffffff",color:i.value==="dark"?"rgba(255,255,255,0.65)":"inherit"})},[n(d(s),{description:"暗黑模式下的空状态"})],12,M)]))}}),N=`<template>
  <div>
