...
<\/script>
`,I={style:{display:"flex","flex-direction":"column",gap:"12px"}},$=u({__name:"ConfigProviderTheme",setup(s){const d={token:{colorPrimary:"#00b96b",borderRadius:2}};return(c,e)=>(p(),C(r(g),{theme:d},{default:l(()=>[o("div",I,[n(r(i),{style:{background:"var(--hmfw-color-primary)",color:"white",border:"none",padding:"8px 16px","border-radius":"6px",cursor:"pointer"}},{default:l(()=>[...e[0]||(e[0]=[a(" 主色按钮 ",-1)])]),_:1}),e[1]||(e[1]=o("p",{style:{color:"var(--hmfw-color-primary)"}},"主色文字",-1))])]),_:1}))}}),A=`<template>
