...
`,kt={style:{display:"flex",gap:"16px"}},Ct=Q({__name:"QRCodeCustomColor",setup(n){return(e,d)=>(q(),M("div",kt,[c(g(b),{value:"https://ant.design",color:"#1677ff"}),c(g(b),{value:"https://ant.design",color:"#52c41a","bg-color":"#f0f0f0"})]))}}),St=`<template>
...
import { QRCode } from '@hmfw/ant-design'
<\/script>
`,wt={style:{display:"flex",gap:"16px"}},Qt=Q({__name:"QRCodeCustomStatusRender",setup(n){const e=s=>s.status==="expired"?C("div",{style:{color:"#ff4d4f"}},[C("div","❌ 已过期"),s.onRefresh&&C("button",{onClick:s.onRefresh,style:{marginTop:"8px",padding:"4px 12px",border:"1px solid #ff4d4f",borderRadius:"4px",background:"transparent",color:"#ff4d4f",cursor:"pointer"}},"重新生成")]):s.status==="loading"?C("div",{style:{color:"#1677ff"}},"⏳ 加载中..."):s.status==="scanned"?C("div",{style:{color:"#52c41a"}},"✅ 扫描成功"):null,d=()=>{console.log("刷新二维码")};return(s,t)=>(q(),M("div",wt,[c(g(b),{value:"https://ant.design",status:"expired","status-render":e,"on-refresh":d}),c(g(b),{value:"https://ant.design",status:"loading","status-render":e}),c(g(b),{value:"https://ant.design",status:"scanned","status-render":e})]))}}),qt=`<template>
  <div style="display: flex; gap: 16px">
    <QRCode
      value="https://ant.design"
      status="expired"
...
<\/script>
`,Et={style:{display:"flex",gap:"16px"}},zt=Q({__name:"QRCodeStatus",setup(n){function e(){console.log("刷新二维码")}return(d,s)=>(q(),M("div",Et,[c(g(b),{value:"https://ant.design",status:"active"}),c(g(b),{value:"https://ant.design",status:"expired",onRefresh:e}),c(g(b),{value:"https://ant.design",status:"loading"}),c(g(b),{value:"https://ant.design",status:"scanned"})]))}}),Mt=`<template>
  <div style="display: flex; gap: 16px">
...
<\/script>
`,At={style:{display:"flex",gap:"16px"}},Pt=Q({__name:"QRCodeType",setup(n){return(e,d)=>(q(),M("div",At,[c(g(b),{value:"https://ant.design",type:"canvas"}),c(g(b),{value:"https://ant.design",type:"svg"})]))}}),Bt=`<template>
  <div style="display: flex; gap: 16px">
