...
<\/script>
`,D={style:{display:"flex",gap:"12px","margin-bottom":"16px"}},M={style:{display:"flex","flex-direction":"column",gap:"12px"}},F=g({__name:"ConfigProviderSize",setup(p){const d=S("middle"),c={small:"24px",middle:"32px",large:"40px"},o=b(()=>({height:c[d.value],padding:"0 8px",border:"1px solid #d9d9d9",borderRadius:"6px"})),e=b(()=>({height:c[d.value],padding:"0 16px",border:"1px solid #d9d9d9",borderRadius:"6px",cursor:"pointer"}));return(u,l)=>(m(),f(C,null,[t("div",D,[n(r(a),{onClick:l[0]||(l[0]=v=>d.value="small")},{default:i(()=>[...l[3]||(l[3]=[s("小",-1)])]),_:1}),n(r(a),{onClick:l[1]||(l[1]=v=>d.value="middle")},{default:i(()=>[...l[4]||(l[4]=[s("中",-1)])]),_:1}),n(r(a),{onClick:l[2]||(l[2]=v=>d.value="large")},{default:i(()=>[...l[5]||(l[5]=[s("大",-1)])]),_:1})]),n(r(x),{"component-size":d.value},{default:i(()=>[t("div",M,[t("input",{style:y(o.value),placeholder:"输入框"},null,4),n(r(a),{style:y(e.value)},{default:i(()=>[...l[6]||(l[6]=[s("按钮",-1)])]),_:1},8,["style"])])]),_:1},8,["component-size"])],64))}}),U=`<template>
  <div style="display: flex; gap: 12px; margin-bottom: 16px">
...
<\/script>
`,$={style:{display:"flex","flex-direction":"column",gap:"12px"}},A=g({__name:"ConfigProviderTheme",setup(p){const d={token:{colorPrimary:"#00b96b",borderRadius:2}};return(c,o)=>(m(),k(r(x),{theme:d},{default:i(()=>[t("div",$,[n(r(a),{style:{background:"var(--hmfw-color-primary)",color:"white",border:"none",padding:"8px 16px","border-radius":"6px",cursor:"pointer"}},{default:i(()=>[...o[0]||(o[0]=[s(" 主色按钮 ",-1)])]),_:1}),o[1]||(o[1]=t("p",{style:{color:"var(--hmfw-color-primary)"}},"主色文字",-1))])]),_:1}))}}),E=`<template>
