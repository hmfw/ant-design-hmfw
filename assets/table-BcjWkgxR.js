...
<\/script>
`,gt=J({__name:"TableRowSelection",setup(e){const c=C([]),d={selectedRowKeys:c,onChange:r=>{c.value=r}},u=[{key:"1",name:"胡彦斌",age:32,address:"西湖区湖底公园1号"},{key:"2",name:"胡彦祖",age:42,address:"西湖区湖底公园2号"}],n=[{title:"姓名",dataIndex:"name",key:"name"},{title:"年龄",dataIndex:"age",key:"age"},{title:"住址",dataIndex:"address",key:"address"}];return(r,f)=>(j(),ce(Ne,null,[a(k(H),{"data-source":u,columns:n,"row-key":"key","row-selection":d}),m("p",null,"已选择："+Je(c.value.join(", ")),1)],64))}}),xt=`<template>
...
`,bt=J({__name:"TableSummary",setup(e){const c=[{key:1,name:"笔记本电脑",category:"电子产品",price:5999,quantity:3},{key:2,name:"机械键盘",category:"电子产品",price:599,quantity:5},{key:3,name:"显示器",category:"电子产品",price:1999,quantity:2},{key:4,name:"鼠标",category:"电子产品",price:199,quantity:10},{key:5,name:"耳机",category:"电子产品",price:399,quantity:6}],d=[{title:"商品名称",dataIndex:"name",key:"name"},{title:"类别",dataIndex:"category",key:"category"},{title:"单价（元）",dataIndex:"price",key:"price",align:"right",render:n=>`¥${n.toFixed(2)}`},{title:"数量",dataIndex:"quantity",key:"quantity",align:"right"},{title:"总价（元）",key:"total",align:"right",render:(n,r)=>`¥${(r.price*r.quantity).toFixed(2)}`}],u=n=>{const r=n.reduce((B,w)=>B+w.quantity,0),f=n.reduce((B,w)=>B+w.price*w.quantity,0);return a("tr",null,[a("td",{colspan:"3",style:"text-align: right; font-weight: 600;"},[E("总计：")]),a("td",{style:"text-align: right; font-weight: 600;"},[r]),a("td",{style:"text-align: right; font-weight: 600;"},[E("¥"),f.toFixed(2)])])};return(n,r)=>(j(),X(k(H),{"data-source":c,columns:d,pagination:!1,summary:u,bordered:""}))}}),wt=`<script setup lang="tsx">
import { Table } from '../../../components'
import type { TableColumn } from '../../../components'
