...
<\/script>
`,Kt={style:{display:"flex",gap:"16px","align-items":"center"}},Yt=k({__name:"PopconfirmTrigger",setup(a){return(c,t)=>(g(),x("div",Kt,[n(s(p),{title:"确定要删除吗？",trigger:"hover","ok-text":"删除","cancel-text":"取消",onConfirm:t[0]||(t[0]=()=>console.log("hover 确认"))},{default:e(()=>[n(s(d),null,{default:e(()=>[...t[4]||(t[4]=[i("鼠标悬停触发",-1)])]),_:1})]),_:1}),n(s(p),{title:"确定要删除吗？",trigger:"click","ok-text":"删除","cancel-text":"取消",onConfirm:t[1]||(t[1]=()=>console.log("click 确认"))},{default:e(()=>[n(s(d),null,{default:e(()=>[...t[5]||(t[5]=[i("点击触发",-1)])]),_:1})]),_:1}),n(s(p),{title:"确定要删除吗？",trigger:"focus","ok-text":"删除","cancel-text":"取消",onConfirm:t[2]||(t[2]=()=>console.log("focus 确认"))},{default:e(()=>[n(s(d),null,{default:e(()=>[...t[6]||(t[6]=[i("聚焦触发",-1)])]),_:1})]),_:1}),n(s(p),{title:"确定要删除吗？",trigger:"contextMenu","ok-text":"删除","cancel-text":"取消",onConfirm:t[3]||(t[3]=()=>console.log("contextMenu 确认"))},{default:e(()=>[n(s(d),null,{default:e(()=>[...t[7]||(t[7]=[i("右键触发",-1)])]),_:1})]),_:1})]))}}),Jt=`<template>
  <div style="display: flex; gap: 16px; align-items: center">
    <!-- hover 触发 -->
    <Popconfirm
      title="确定要删除吗？"
