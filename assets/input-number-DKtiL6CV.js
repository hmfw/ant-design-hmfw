import{I as d}from"./InputNumber-Dp18PgdW.js";import{d as b,o as k,b as v,c as e,e as o,f as t,A as y,r as i,_ as N,h as q,w as g,g as r,i as I}from"./index-Dhlw_h7w.js";import"./cls-S9IiI6wd.js";const S={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"300px"}},$=b({__name:"InputNumberBasic",setup(f){const p=i(null);return(u,c)=>(k(),v("div",S,[e(o(d),{value:p.value,"onUpdate:value":c[0]||(c[0]=n=>p.value=n),placeholder:"请输入数字",style:{width:"100%"}},null,8,["value"]),e(o(d),{value:p.value,"onUpdate:value":c[1]||(c[1]=n=>p.value=n),disabled:"",placeholder:"禁用状态",style:{width:"100%"}},null,8,["value"]),t("p",null,"当前值："+y(p.value),1)]))}}),C=`<template>
