import{k as G}from"./icons-DjAiWXKu.js";import{m as z,L as V,v as D,O as W,l as c,q as K,B as U,n as S,k as B,F as X,d as N,y as A,g as q,I as p,i as L,E as Y,f as m,P as E,j as J}from"./index-3tP9IO2U.js";import{c as Z}from"./cls-S9IiI6wd.js";import{S as tt}from"./Spin-PtC3JWDz.js";import{I as et}from"./Icon-Cuh3Bp-R.js";const j=new Array(512),H=new Array(256);(()=>{let t=1;for(let o=0;o<255;o++)j[o]=t,H[t]=o,t<<=1,t&256&&(t^=285);for(let o=255;o<512;o++)j[o]=j[o-255]})();function F(t,o){return t===0||o===0?0:j[(H[t]+H[o])%255]}function nt(t){let o=[1];for(let d=0;d<t.length;d++){const n=[1,j[d]],e=new Array(o.length+1).fill(0);for(let s=0;s<o.length;s++)for(let r=0;r<n.length;r++)e[s+r]^=F(o[s],n[r]);o=e}return o}function ot(t,o){const d=nt(Array.from({length:o},(e,s)=>s)),n=[...t,...new Array(o).fill(0)];for(let e=0;e<t.length;e++){const s=n[e];if(s!==0)for(let r=1;r<d.length;r++)n[e+r]^=F(d[r],s)}return n.slice(t.length)}const st={1:{L:[19,7],M:[16,10],Q:[13,13],H:[9,17]},2:{L:[34,10],M:[28,16],Q:[22,22],H:[16,28]},3:{L:[55,15],M:[44,26],Q:[34,18],H:[26,22]},4:{L:[80,20],M:[64,18],Q:[48,26],H:[36,16]},5:{L:[108,26],M:[86,24],Q:[62,18],H:[46,22]},6:{L:[136,18],M:[108,16],Q:[76,24],H:[60,28]},7:{L:[156,20],M:[124,18],Q:[88,18],H:[66,26]}},rt={L:1,M:0,Q:3,H:2},dt=21522;function at(t){const o=new TextEncoder().encode(t),d=[],n=(e,s)=>{for(let r=s-1;r>=0;r--)d.push(e>>r&1)};return n(4,4),n(o.length,8),o.forEach(e=>n(e,8)),n(0,4),d}function it(t,o){return[...t,...o]}function lt(t){return Array.from({length:t},()=>new Array(t).fill(-1))}function P(t,o,d){for(let n=0;n<7;n++)for(let e=0;e<7;e++){const s=n===0||n===6||e===0||e===6||n>=2&&n<=4&&e>=2&&e<=4?1:0;t[o+n][d+e]=s}}function ct(t,o){for(let d=8;d<o-8;d++)t[6][d]=t[d][6]=d%2===0?1:0}function ut(t,o,d){for(let n=-2;n<=2;n++)for(let e=-2;e<=2;e++)t[o+n][d+e]=n===-2||n===2||e===-2||e===2||n===0&&e===0?1:0}const ft={1:[],2:[6,18],3:[6,22],4:[6,26],5:[6,30],6:[6,34],7:[6,22,38]};function ht(t,o,d){const e=[(s,r)=>(s+r)%2===0,s=>s%2===0,(s,r)=>r%3===0,(s,r)=>(s+r)%3===0,(s,r)=>(Math.floor(s/2)+Math.floor(r/3))%2===0,(s,r)=>s*r%2+s*r%3===0,(s,r)=>(s*r%2+s*r%3)%2===0,(s,r)=>((s+r)%2+s*r%3)%2===0][o];for(let s=0;s<d;s++)for(let r=0;r<d;r++)t[s][r]!==-1&&e(s,r)&&(t[s][r]^=1)}function T(t,o,d,n){let s=rt[o]<<3|d,r=s;for(let u=0;u<10;u++)r=r<<1^(r>>9&1?1335:0);s=(s<<10|r)^dt;const Q=Array.from({length:15},(u,a)=>s>>14-a&1),y=[[8,0],[8,1],[8,2],[8,3],[8,4],[8,5],[8,7],[8,8],[7,8],[5,8],[4,8],[3,8],[2,8],[1,8],[0,8]],h=[[n-1,8],[n-2,8],[n-3,8],[n-4,8],[n-5,8],[n-6,8],[n-7,8],[n-8,8],[8,n-8],[8,n-7],[8,n-6],[8,n-5],[8,n-4],[8,n-3],[8,n-2]];Q.forEach((u,a)=>{t[y[a][0]][y[a][1]]=u,t[h[a][0]][h[a][1]]=u})}function gt(t,o="M"){var g,w,$,M,I;const d=at(t);let n=1,e=0,s=0;for(;n<=7;n++){const l=(g=st[n])==null?void 0:g[o];if(!l)return null;if(e=l[0],s=l[1],d.length<=e*8)break}if(n>7)return null;const r=e*8,Q=[...d];for(;Q.length<r;)Q.push(0);const y=[];for(let l=0;l<Q.length;l+=8){let f=0;for(let _=0;_<8;_++)f=f<<1|(Q[l+_]??0);y.push(f)}for(;y.length<e;)y.push(y.length%2===0?236:17);const h=ot(y,s),u=[];it(y,h).forEach(l=>{for(let f=7;f>=0;f--)u.push(l>>f&1)});const a=n*4+17,i=lt(a);P(i,0,0),P(i,0,a-7),P(i,a-7,0);for(let l=0;l<8;l++)[0,a-8].forEach(f=>{i[l][f]===-1&&(i[l][f]=0)}),[0,a-8].forEach(f=>{i[f][l]===-1&&(i[f][l]=0)}),((w=i[a-1-l])==null?void 0:w[7])===-1&&(i[a-1-l][7]=0),(($=i[7])==null?void 0:$[a-1-l])===-1&&(i[7][a-1-l]=0),((M=i[a-8])==null?void 0:M[l])===-1&&(i[a-8][l]=0),((I=i[l])==null?void 0:I[a-8])===-1&&(i[l][a-8]=0);ct(i,a);const R=ft[n]??[];for(let l=0;l<R.length;l++)for(let f=0;f<R.length;f++){const _=R[l],k=R[f];i[_][k]===-1&&ut(i,_,k)}i[a-8][8]=1,T(i,o,0,a);let b=0,v=-1,C=a-1;for(let l=a-1;l>=1;l-=2){l===6&&(l=5);for(let f=0;f<a;f++){const _=v===-1?C-f:f;[l,l-1].forEach(k=>{var O;((O=i[_])==null?void 0:O[k])===-1&&(i[_][k]=u[b++]??0)})}v=-v,C=v===-1?a-1:0}return ht(i,0,a),T(i,o,0,a),i.map(l=>l.map(f=>f===1))}const x=z({name:"QRCode",props:{value:{type:String,required:!0},type:{type:String,default:"canvas"},size:{type:Number,default:160},color:{type:String,default:"#000000"},bgColor:{type:String,default:"transparent"},errorLevel:{type:String,default:"M"},status:{type:String,default:"active"},icon:String,iconSize:{type:[Number,Object],default:40},bordered:{type:Boolean,default:!0},statusRender:Function,marginSize:Number,onRefresh:Function},setup(t,{attrs:o}){const d=V("qrcode"),n=U(),e=N(()=>t.value?gt(t.value,t.errorLevel):null),s=N(()=>typeof t.iconSize=="number"?{width:t.iconSize,height:t.iconSize}:t.iconSize),r=()=>{const h=n.value;if(!h||!e.value)return;const u=h.getContext("2d");if(!u)return;const a=e.value,i=t.size,R=i/a.length;if(u.clearRect(0,0,i,i),u.fillStyle=t.bgColor,u.fillRect(0,0,i,i),u.fillStyle=t.color,a.forEach((b,v)=>b.forEach((C,g)=>{C&&u.fillRect(g*R,v*R,R,R)})),t.icon){const b=new Image;b.crossOrigin="anonymous",b.src=t.icon,b.onload=()=>{const v=s.value,C=(i-v.width)/2,g=(i-v.height)/2;u.fillStyle=t.bgColor,u.fillRect(C-2,g-2,v.width+4,v.height+4),u.drawImage(b,C,g,v.width,v.height)}}};D(()=>{t.type==="canvas"&&r()}),W([()=>t.value,()=>t.size,()=>t.color,()=>t.bgColor,()=>t.errorLevel,()=>t.icon,()=>t.iconSize],()=>{t.type==="canvas"&&r()});const Q=()=>{const h=e.value;if(!h)return null;const u=t.marginSize??0,a=1,i=h.length,R=i+2*u,b=[];h.forEach((g,w)=>{g.forEach(($,M)=>{$&&b.push(`M${M+u},${w+u}h${a}v${a}h-${a}z`)})});const v={viewBox:`0 0 ${R} ${R}`,width:t.size,height:t.size,style:{display:"block"}};Object.keys(o).forEach(g=>{(g.startsWith("aria-")||g.startsWith("data-"))&&(v[g]=o[g])});const C=[S("rect",{x:0,y:0,width:R,height:R,fill:t.bgColor}),S("path",{d:b.join(""),fill:t.color})];if(t.icon){const g=s.value,w=(i-g.width/t.size*i)/2+u,$=(i-g.height/t.size*i)/2+u,M=g.width/t.size*i,I=g.height/t.size*i;C.push(S("rect",{x:w-.1,y:$-.1,width:M+.2,height:I+.2,fill:t.bgColor}),S("image",{href:t.icon,x:w,y:$,width:M,height:I,crossOrigin:"anonymous"}))}return S("svg",v,C)},y=h=>h.status==="loading"?c(tt,null,null):h.status==="expired"?c(X,null,[c("p",{class:`${d}-expired`},[B("二维码过期")]),h.onRefresh&&c("button",{type:"button",class:`${d}-refresh`,onClick:h.onRefresh},[c(et,{component:G,style:{marginRight:"4px"}},null),B("点击刷新")])]):h.status==="scanned"?c("p",{class:`${d}-scanned`},[B("已扫描")]):null;return()=>{if(!t.value)return null;const h=Z(d,{[`${d}-borderless`]:!t.bordered}),u={width:t.size,height:t.size,style:{display:"block"}};return Object.keys(o).forEach(a=>{(a.startsWith("aria-")||a.startsWith("data-"))&&(u[a]=o[a])}),c("div",{class:h,style:{width:`${t.size}px`,height:`${t.size}px`,backgroundColor:t.bgColor}},[t.type==="canvas"?c("canvas",K({ref:n},u),null):Q(),t.status!=="active"&&c("div",{class:`${d}-cover`},[(t.statusRender??y)({status:t.status,onRefresh:t.onRefresh})])])}}}),pt=z({__name:"QRCodeBasic",setup(t){return(o,d)=>(A(),q(p(x),{value:"https://ant.design"}))}}),mt=`<template>
...
<\/script>
`,St="https://gw.alipayobjects.com/zos/rmsportal/KDpgvguMpGfqaHPjicRK.svg",_t=z({__name:"QRCodeIcon",setup(t){return(o,d)=>(A(),q(p(x),{value:"https://ant.design",icon:St,"icon-size":50,"error-level":"H"}))}}),Qt=`<template>
  <QRCode
    value="https://ant.design"
    :icon="iconUrl"
    :icon-size="50"
