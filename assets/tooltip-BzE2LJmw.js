import{B as p}from"./Button-D9PdcFa1.js";import{T as d}from"./Tooltip-f6ptDiSe.js";import{o as g,A as c,k as u,h as n,m as l,n as o,K as s,R as a,_ as y,i as k,J as x,E as v,f as T,v as h,F as w,G as B,H as C,l as _}from"./index-B9Ix0zQ8.js";import"./cls-S9IiI6wd.js";import"./Icon-D0ODznex.js";import"./LoadingOutlined-aeZz6k73.js";import"./Trigger-C7LIrQfF.js";const q={class:"demo-arrow-center"},S={class:"demo-row"},N={class:"demo-item"},R={class:"demo-item"},L={class:"demo-row",style:{"margin-top":"80px"}},A={class:"demo-item"},z={class:"demo-item"},E=g({__name:"TooltipArrowCenter",setup(m){return(i,t)=>(c(),u("div",q,[t[6]||(t[6]=n("p",null,[l("设置 "),n("code",null,"arrow.pointAtCenter"),l(" 可以让箭头始终指向触发元素的中心。")],-1)),n("div",S,[n("div",N,[t[1]||(t[1]=n("h4",null,"默认箭头位置",-1)),o(s(d),{title:"默认箭头跟随浮层边缘",placement:"topLeft"},{default:a(()=>[o(s(p),{style:{width:"200px"}},{default:a(()=>[...t[0]||(t[0]=[l("长按钮 - 默认箭头",-1)])]),_:1})]),_:1})]),n("div",R,[t[3]||(t[3]=n("h4",null,"箭头居中",-1)),o(s(d),{title:"箭头指向按钮中心",placement:"topLeft",arrow:{pointAtCenter:!0}},{default:a(()=>[o(s(p),{style:{width:"200px"}},{default:a(()=>[...t[2]||(t[2]=[l("长按钮 - 箭头居中",-1)])]),_:1})]),_:1})])]),n("div",L,[n("div",A,[o(s(d),{title:"bottomRight 默认",placement:"bottomRight"},{default:a(()=>[o(s(p),{style:{width:"200px"}},{default:a(()=>[...t[4]||(t[4]=[l("bottomRight - 默认",-1)])]),_:1})]),_:1})]),n("div",z,[o(s(d),{title:"bottomRight 居中",placement:"bottomRight",arrow:{pointAtCenter:!0}},{default:a(()=>[o(s(p),{style:{width:"200px"}},{default:a(()=>[...t[5]||(t[5]=[l("bottomRight - 居中",-1)])]),_:1})]),_:1})])])]))}}),$=y(E,[["__scopeId","data-v-fee5784d"]]),D=`<template>
...
import { Tooltip, Button } from 'ant-design-hmfw'
<\/script>
`,G={class:"demo-dynamic-content"},J={style:{display:"flex",gap:"20px","margin-top":"20px"}},K=g({__name:"TooltipDynamicContent",setup(m){const i=v(!1),t=v(!1),b=T(()=>t.value?"这是一段很长的提示文字，用于演示当内容动态变化时，浮层位置会自动重新计算，确保不会溢出视口边界，提供更好的用户体验。":"短提示"),e=()=>{t.value=!t.value};return(r,f)=>(c(),u("div",G,[f[1]||(f[1]=n("p",null,"当浮层内容动态变化时，Tooltip 会通过 ResizeObserver 自动重新计算位置，确保浮层不会溢出视口。",-1)),n("div",J,[o(s(d),{title:b.value,placement:"top",open:i.value},{default:a(()=>[o(s(p),{onClick:f[0]||(f[0]=at=>i.value=!i.value)},{default:a(()=>[l(x(i.value?"关闭":"打开")+"提示",1)]),_:1})]),_:1},8,["title","open"]),o(s(p),{onClick:e},{default:a(()=>[l(x(t.value?"切换为短内容":"切换为长内容"),1)]),_:1})]),f[2]||(f[2]=n("p",{style:{"margin-top":"20px",color:"#666","font-size":"12px"}},"提示：打开浮层后切换内容长度，浮层位置会自动调整",-1))]))}}),Q=y(K,[["__scopeId","data-v-22696618"]]),U=`<template>
