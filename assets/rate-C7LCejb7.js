...
const value2 = ref(2)
<\/script>
`,En={style:{display:"flex","flex-direction":"column",gap:"16px"}},Hn=w({__name:"RateSize",setup(a){const l=k(3);return(u,i)=>(R(),q("div",En,[t("div",null,[i[3]||(i[3]=t("p",{style:{"margin-bottom":"4px"}},"Large:",-1)),o(d(m),{value:l.value,"onUpdate:value":i[0]||(i[0]=n=>l.value=n),size:"large"},null,8,["value"])]),t("div",null,[i[4]||(i[4]=t("p",{style:{"margin-bottom":"4px"}},"Middle (default):",-1)),o(d(m),{value:l.value,"onUpdate:value":i[1]||(i[1]=n=>l.value=n)},null,8,["value"])]),t("div",null,[i[5]||(i[5]=t("p",{style:{"margin-bottom":"4px"}},"Small:",-1)),o(d(m),{value:l.value,"onUpdate:value":i[2]||(i[2]=n=>l.value=n),size:"small"},null,8,["value"])])]))}}),An=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px">
    <div>
...
const value = ref(3)
<\/script>
`,Tn={style:{"margin-top":"8px"}},Dn=w({__name:"RateTooltip",setup(a){const l=k(0),u=["极差","差","一般","好","极好"],i=n=>{console.log("悬停：",u[n-1])};return(n,s)=>(R(),q("div",null,[o(d(m),{value:l.value,"onUpdate:value":s[0]||(s[0]=g=>l.value=g),tooltips:u,onHoverChange:i},null,8,["value"]),t("p",Tn,"当前："+E(u[l.value-1]||"未评分"),1)]))}}),jn=`<template>
  <div>
