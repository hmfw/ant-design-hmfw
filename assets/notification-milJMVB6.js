import{B as c}from"./Button-Cw7qEaQa.js";import{n as r}from"./notification-SY4uqsWI.js";import{o as x,A as f,k as m,n,K as d,R as s,m as o,p as b,H as C,l as k,h as l}from"./index-C7r7ERgN.js";import{a as B,C as w}from"./CloseCircleFilled-D8GUAtQ3.js";import{I as y}from"./Icon-Bn-1ylNX.js";import"./cls-S9IiI6wd.js";import"./LoadingOutlined-CFTLq47r.js";import"./CloseOutlined-BOy0Oguu.js";import"./ExclamationCircleFilled-BDZvHzJ_.js";import"./InfoCircleFilled-y_F_mdmS.js";const h={style:{display:"flex",gap:"8px","flex-wrap":"wrap"}},v=x({__name:"NotificationBasic",setup(g){function a(){r.success({message:"操作成功",description:"您的操作已成功完成，请查看详情。"})}function p(){r.error({message:"操作失败",description:"操作过程中发生错误，请稍后重试。"})}function e(){r.warning({message:"警告",description:"此操作存在风险，请谨慎操作。"})}function t(){r.info({message:"提示信息",description:"这是一条普通的提示信息。"})}return(i,u)=>(f(),m("div",h,[n(d(c),{onClick:a},{default:s(()=>[...u[0]||(u[0]=[o(" 成功 ",-1)])]),_:1}),n(d(c),{onClick:p},{default:s(()=>[...u[1]||(u[1]=[o(" 错误 ",-1)])]),_:1}),n(d(c),{onClick:e},{default:s(()=>[...u[2]||(u[2]=[o(" 警告 ",-1)])]),_:1}),n(d(c),{onClick:t},{default:s(()=>[...u[3]||(u[3]=[o(" 信息 ",-1)])]),_:1})]))}}),N=`<template>
