...
`,ft={style:{display:"flex","flex-direction":"column",gap:"32px"}},vt={class:"ant-upload-drag-icon"},yt={style:{display:"flex","flex-direction":"column","align-items":"center"}},ht={class:"ant-upload-drag-icon"},bt=R({__name:"UploadClassNames",setup(n){const o=U([]),u=U([]),a=U([]),e=[{uid:"-1",name:"document.pdf",status:"done",url:"https://example.com/document.pdf"},{uid:"-2",name:"readme.txt",status:"done",url:"https://example.com/readme.txt"}],l=[{uid:"-1",name:"image1.png",status:"done",url:"https://zos.alipayobjects.com/rmsportal/jkjgkEfvpUPVyRjUImniVslZfWPnJuuZ.png",thumbUrl:"https://zos.alipayobjects.com/rmsportal/jkjgkEfvpUPVyRjUImniVslZfWPnJuuZ.png"},{uid:"-2",name:"image2.png",status:"done",url:"https://zos.alipayobjects.com/rmsportal/jkjgkEfvpUPVyRjUImniVslZfWPnJuuZ.png",thumbUrl:"https://zos.alipayobjects.com/rmsportal/jkjgkEfvpUPVyRjUImniVslZfWPnJuuZ.png"}];return(y,p)=>(N(),T("div",ft,[c("div",null,[p[4]||(p[4]=c("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义选择按钮样式：",-1)),s(k(I),{action:"/api/upload","file-list":o.value,"class-names":{select:"custom-select",selectIcon:"custom-select-icon",selectText:"custom-select-text"},"onUpdate:fileList":p[0]||(p[0]=m=>o.value=m)},{default:h(()=>[s(k(z),null,{default:h(()=>[s(k(Fn)),p[3]||(p[3]=d(" 上传文件 ",-1))]),_:1})]),_:1},8,["file-list"])]),c("div",null,[p[6]||(p[6]=c("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义拖拽区样式：",-1)),s(k(I),{action:"/api/upload",type:"drag","file-list":u.value,"class-names":{drag:"custom-drag",dragContainer:"custom-drag-container"},"onUpdate:fileList":p[1]||(p[1]=m=>u.value=m)},{default:h(()=>[c("p",vt,[s(k(Dn),{style:{"font-size":"48px",color:"#1890ff"}})]),p[5]||(p[5]=c("p",{class:"ant-upload-text"},"点击或拖拽文件到此区域上传",-1))]),_:1},8,["file-list"])]),c("div",null,[p[8]||(p[8]=c("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义文件列表项样式：",-1)),s(k(I),{action:"/api/upload","default-file-list":e,"class-names":{list:"custom-list",listItem:"custom-list-item",itemIcon:"custom-item-icon",itemName:"custom-item-name"}},{default:h(()=>[s(k(z),null,{default:h(()=>[s(k(Fn)),p[7]||(p[7]=d(" 上传文件 ",-1))]),_:1})]),_:1})]),c("div",null,[p[10]||(p[10]=c("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义图片卡片样式：",-1)),s(k(I),{action:"/api/upload","list-type":"picture-card","default-file-list":l,"class-names":{itemCard:"custom-card",thumbnail:"custom-thumbnail",cardActions:"custom-actions"}},{default:h(()=>[c("div",yt,[s(k(nt),{style:{"font-size":"24px","margin-bottom":"8px"}}),p[9]||(p[9]=c("div",null,"上传图片",-1))])]),_:1})]),c("div",null,[p[12]||(p[12]=c("div",{style:{"margin-bottom":"8px",color:"#666"}},"使用内联样式控制：",-1)),s(k(I),{action:"/api/upload",type:"drag","file-list":a.value,styles:{drag:{borderColor:"#722ed1",borderWidth:"2px"},dragContainer:{padding:"32px"},progress:{backgroundColor:"rgba(114, 46, 209, 0.1)"},progressBar:{backgroundColor:"#722ed1"}},"onUpdate:fileList":p[2]||(p[2]=m=>a.value=m)},{default:h(()=>[c("p",ht,[s(k(Dn),{style:{"font-size":"48px",color:"#722ed1"}})]),p[11]||(p[11]=c("p",{class:"ant-upload-text",style:{color:"#722ed1"}},"紫色主题拖拽上传",-1))]),_:1},8,["file-list"])])]))}}),xt=Rn(bt,[["__scopeId","data-v-abb70545"]]),qt=`<template>
...
`,St={key:0},$t=R({__name:"UploadPictureCard",setup(n){const o=U([{uid:"-1",name:"image.png",status:"done",url:"https://zos.alipayobjects.com/rmsportal/jkjgkEfvpUPVyRjUImniVslZfWPnJuuZ.png"}]),u=a=>{o.value=a.fileList};return(a,e)=>(N(),O(k(I),{"file-list":o.value,"onUpdate:fileList":e[0]||(e[0]=l=>o.value=l),action:"https://run.mocky.io/v3/435e224c-44fb-4773-9faf-380c5e6a2188","list-type":"picture-card","max-count":8,onChange:u},{default:h(()=>[o.value.length<8?(N(),T("div",St,[...e[1]||(e[1]=[c("div",null,"+ 上传",-1)])])):jn("",!0)]),_:1},8,["file-list"]))}}),Pt=`<template>
  <Upload
    v-model:file-list="fileList"
    action="https://run.mocky.io/v3/435e224c-44fb-4773-9faf-380c5e6a2188"
    list-type="picture-card"
