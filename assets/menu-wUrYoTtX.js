import{B as g}from"./Button-BxE2sJbo.js";import{M as y}from"./Menu-pY4Zw3T2.js";import{n as m,z as a,j as b,m as l,J as o,Q as c,l as f,I as v,g as t,u as x,D as p,o as k,h as M,R as _,N as S,G as w,k as K}from"./index-i0jnWELi.js";import"./icons-DkTSuFEr.js";import"./cls-S9IiI6wd.js";import"./Icon-D9pw0Su_.js";const I=m({__name:"MenuCollapsed",setup(u){const n=p(!1),s=p(["1"]),i=[{key:"1",label:"导航一",icon:"home"},{key:"2",label:"导航二",icon:"user"},{key:"3",label:"导航三",icon:"setting"}],e=({key:d})=>{s.value=[d]};return(d,r)=>(a(),b("div",null,[l(o(g),{type:"primary",style:{"margin-bottom":"16px"},onClick:r[0]||(r[0]=h=>n.value=!n.value)},{default:c(()=>[f(v(n.value?"展开":"折叠"),1)]),_:1}),t("div",{style:x({width:n.value?"80px":"256px",borderRight:"1px solid #f0f0f0",transition:"width 0.2s"})},[l(o(y),{mode:"inline",items:i,"selected-keys":s.value,"inline-collapsed":n.value,onSelect:e},null,8,["selected-keys","inline-collapsed"])],4)]))}}),T=`<template>
  <div>
    <Button
      type="primary"
...
<\/script>
`,$={style:{width:"256px"}},N=m({__name:"MenuDanger",setup(u){const n=[{key:"1",label:"普通选项"},{key:"2",label:"编辑",icon:"✏️"},{type:"divider"},{key:"3",label:"删除",danger:!0,icon:"🗑️"}];return(s,i)=>(a(),b("div",$,[l(o(y),{mode:"inline",items:n})]))}}),V=`<template>
...
<\/script>
`,D={style:{width:"256px"}},A=m({__name:"MenuGroup",setup(u){const n=[{type:"group",label:"用户管理",children:[{key:"1",label:"用户列表"},{key:"2",label:"添加用户"}]},{type:"group",label:"系统设置",children:[{key:"3",label:"基本设置"},{key:"4",label:"高级设置"}]}];return(s,i)=>(a(),b("div",D,[l(o(y),{mode:"inline",items:n})]))}}),G=`<template>
  <div style="width: 256px;">
    <Menu mode="inline" :items="items" />
  </div>
</template>
...
<\/script>
`,j={style:{width:"256px","border-right":"1px solid #f0f0f0"}},J=m({__name:"MenuInline",setup(u){const n=p(["1"]),s=[{key:"sub1",label:"导航一",icon:"home",children:[{key:"1",label:"选项一"},{key:"2",label:"选项二"},{key:"3",label:"选项三"}]},{key:"sub2",label:"导航二",icon:"setting",children:[{key:"5",label:"选项五"},{key:"6",label:"选项六"}]},{key:"9",label:"导航三",icon:"user"}],i=({key:e})=>{n.value=[e]};return(e,d)=>(a(),b("div",j,[l(o(y),{mode:"inline",items:s,"selected-keys":n.value,"default-open-keys":["sub1"],onSelect:i},null,8,["selected-keys"])]))}}),Q=`<template>
...
<\/script>
`,U={style:{width:"256px"}},q=m({__name:"MenuMultiple",setup(u){const n=[{key:"1",label:"选项一"},{key:"2",label:"选项二"},{key:"3",label:"选项三"},{key:"4",label:"选项四"}];return(s,i)=>(a(),b("div",U,[l(o(y),{mode:"inline",items:n,multiple:"","default-selected-keys":["1","2"]})]))}}),F=`<template>
  <div style="width: 256px;">
