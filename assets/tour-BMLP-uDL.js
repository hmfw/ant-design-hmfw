import{B as I}from"./Button-8pevJcSq.js";import{S as H}from"./Space-DM35qXYa.js";import{d as K}from"./icons-B7DG7jjo.js";import{m as E,L as Q,B as w,O as z,v as Z,u as _,n as l,T as R,d as x,r as tt,p as et,y as D,i as F,l as v,I as y,P as T,k as S,E as dt,f as c,j as ot}from"./index-B2-fWtt3.js";import{c as U}from"./cls-S9IiI6wd.js";import{I as nt}from"./Icon-BgwCb1-e.js";function A(t){return t?typeof t=="function"?t():document.querySelector(t):null}function rt(t){if(!t)return null;const n=t.getBoundingClientRect();return{top:n.top+window.scrollY,left:n.left+window.scrollX,width:n.width,height:n.height}}function lt(t,n,d="bottom",p=12){if(!t||!n)return{top:100,left:100};const e=n.offsetWidth||300,a=n.offsetHeight||200,b=t.left+t.width/2,m=t.top+t.height/2;if(d.startsWith("bottom")){const i=t.top+t.height+p,s=d==="bottom"?b-e/2:d==="bottomLeft"?t.left:t.left+t.width-e;return{top:i,left:s}}if(d.startsWith("top")){const i=t.top-a-p,s=d==="top"?b-e/2:d==="topLeft"?t.left:t.left+t.width-e;return{top:i,left:s}}if(d.startsWith("right")){const i=t.left+t.width+p;return{top:d==="right"?m-a/2:d==="rightTop"?t.top:t.top+t.height-a,left:i}}if(d.startsWith("left")){const i=t.left-e-p;return{top:d==="left"?m-a/2:d==="leftTop"?t.top:t.top+t.height-a,left:i}}return{top:t.top+t.height+p,left:b-e/2}}function L(t){return t==null?null:typeof t=="function"?t():et(t)?t:String(t)}const j=E({name:"Tour",props:{open:{type:Boolean,default:void 0},defaultOpen:{type:Boolean,default:!1},current:{type:Number,default:void 0},defaultCurrent:{type:Number,default:0},steps:{type:Array,default:()=>[]},arrow:{type:[Boolean,Object],default:!0},placement:{type:String,default:void 0},mask:{type:[Boolean,Object],default:!0},type:{type:String,default:"default"},scrollIntoViewOptions:{type:[Boolean,Object],default:!0},zIndex:{type:Number,default:1001},gap:{type:Object,default:void 0},indicatorsRender:{type:Function,default:void 0},closeIcon:{type:[Object,Function,Boolean],default:void 0}},emits:["update:open","update:current","change","close","finish"],setup(t,{emit:n}){const d=Q("tour"),p=w(t.defaultOpen),e=w(t.defaultCurrent),a=w(null),b=w({top:100,left:100}),m=w(null),i=x(()=>t.open!==void 0?t.open:p.value),s=x(()=>t.current!==void 0?t.current:e.value),r=x(()=>t.steps[s.value]??null),$=x(()=>t.steps.length),B=x(()=>{var h;const o=(h=r.value)==null?void 0:h.mask;return o!==void 0?o:t.mask}),q=x(()=>{var o;return((o=r.value)==null?void 0:o.type)??t.type});z(()=>t.open,o=>{o!==void 0&&(p.value=o)}),z(()=>t.current,o=>{o!==void 0&&(e.value=o)});async function X(){var g;const o=r.value?A(r.value.target):null;if(!o)return;const h=((g=r.value)==null?void 0:g.scrollIntoViewOptions)??t.scrollIntoViewOptions??!0;if(h){const O=typeof h=="boolean"?{block:"center",behavior:"smooth"}:h;o.scrollIntoView(O)}}async function C(){var h,g;await tt();const o=r.value?A(r.value.target):null;if(m.value=rt(o),a.value){const O=((h=r.value)==null?void 0:h.placement)??t.placement??"bottom",k=((g=t.gap)==null?void 0:g.offset)??12,V=typeof k=="number"?k:k[0];b.value=lt(m.value,a.value,O,V)}}z([i,s],async([o])=>{o&&(await X(),await C())},{immediate:!0}),Z(()=>{window.addEventListener("resize",C),window.addEventListener("scroll",C,!0)}),_(()=>{window.removeEventListener("resize",C),window.removeEventListener("scroll",C,!0)});function M(){p.value=!1,n("update:open",!1),n("close")}function N(o){e.value=o,n("update:current",o),n("change",o)}function Y(){s.value>0&&N(s.value-1)}function G(){s.value<$.value-1?N(s.value+1):(M(),n("finish"))}const J=()=>t.closeIcon===!1?null:t.closeIcon===void 0?l(nt,{component:K}):typeof t.closeIcon=="function"?t.closeIcon():t.closeIcon;return()=>{var W;if(!i.value||!r.value)return null;const o=q.value==="primary",h=s.value===$.value-1,g=B.value!==!1,O=typeof B.value=="object"?B.value.style:void 0,k=typeof B.value=="object"?B.value.color:"rgba(0,0,0,0.45)",V=J();return l(R,{to:"body"},[l("div",{class:`${d}-root`,style:{zIndex:t.zIndex}},[g&&l("div",{class:`${d}-mask`,style:O},[m.value?l("svg",{class:`${d}-mask-svg`,width:"100%",height:"100%"},[l("defs",[l("mask",{id:"tour-mask"},[l("rect",{width:"100%",height:"100%",fill:"white"}),l("rect",{x:m.value.left-4,y:m.value.top-4,width:m.value.width+8,height:m.value.height+8,rx:((W=t.gap)==null?void 0:W.radius)??4,fill:"black"})])]),l("rect",{width:"100%",height:"100%",fill:k,mask:"url(#tour-mask)"})]):l("div",{class:`${d}-mask-fill`,style:{background:k}})]),l("div",{ref:a,class:U(`${d}-popover`,{[`${d}-popover-primary`]:o},r.value.className),style:{position:"absolute",top:`${b.value.top}px`,left:`${b.value.left}px`,zIndex:t.zIndex+1,...r.value.style}},[l("div",{class:`${d}-popover-inner`},[V!==null&&l("button",{type:"button",class:`${d}-close`,onClick:M,"aria-label":"Close"},[V]),r.value.cover&&l("div",{class:`${d}-cover`},[typeof r.value.cover=="string"?l("img",{src:r.value.cover,alt:""}):L(r.value.cover)]),r.value.title&&l("div",{class:`${d}-title`},[L(r.value.title)]),r.value.description&&l("div",{class:`${d}-description`},[L(r.value.description)]),l("div",{class:`${d}-footer`},[$.value>1&&l("div",{class:`${d}-indicators`},[t.indicatorsRender?t.indicatorsRender(s.value,$.value):t.steps.map((f,u)=>l("span",{key:u,class:U(`${d}-indicator`,{[`${d}-indicator-active`]:u===s.value}),onClick:()=>N(u)}))]),l("div",{class:`${d}-buttons`},[s.value>0&&l(I,{size:"small",type:"default",ghost:o,class:`${d}-prev-btn`,onClick:()=>{var f,u,P;(P=(u=(f=r.value)==null?void 0:f.prevButtonProps)==null?void 0:u.onClick)==null||P.call(u),Y()},...r.value.prevButtonProps},{default:()=>{var f,u;return((u=(f=r.value)==null?void 0:f.prevButtonProps)==null?void 0:u.children)??"上一步"}}),l(I,{size:"small",type:o?"default":"primary",ghost:o,class:`${d}-next-btn`,onClick:()=>{var f,u,P;(P=(u=(f=r.value)==null?void 0:f.nextButtonProps)==null?void 0:u.onClick)==null||P.call(u),G()},...r.value.nextButtonProps},{default:()=>{var f,u;return((u=(f=r.value)==null?void 0:f.nextButtonProps)==null?void 0:u.children)??(h?"完成":"下一步")}})])])])])])])}}}),it=E({__name:"TourBasic",setup(t){const n=w(!1),d=[{title:"第一步",description:"这是漫游引导的第一步，介绍页面的主要功能。"},{title:"第二步",description:"这是第二步，继续介绍其他功能。"},{title:"完成",description:"引导完成！现在你已经了解了所有功能。"}];return(p,e)=>(D(),F("div",null,[v(y(H),null,{default:T(()=>[v(y(I),{ref:"btnRef",type:"primary",onClick:e[0]||(e[0]=a=>n.value=!0)},{default:T(()=>[...e[3]||(e[3]=[S("开始引导",-1)])]),_:1},512)]),_:1}),v(y(j),{open:n.value,"onUpdate:open":e[1]||(e[1]=a=>n.value=a),steps:d,onFinish:e[2]||(e[2]=a=>n.value=!1)},null,8,["open"])]))}}),st=`<template>
  <div>
    <Space>
...
<\/script>
`,ut=E({__name:"TourType",setup(t){const n=w(!1),d=w(!1),p=[{title:"默认样式",description:"这是默认样式的引导，白色背景。"},{title:"第二步",description:"继续介绍功能..."}],e=[{title:"主题样式",description:"这是主题样式的引导，蓝色背景。"},{title:"第二步",description:"继续介绍功能..."}];function a(){n.value=!0}function b(){d.value=!0}return(m,i)=>(D(),F("div",null,[v(y(H),null,{default:T(()=>[v(y(I),{type:"primary",onClick:a},{default:T(()=>[...i[4]||(i[4]=[S("默认样式",-1)])]),_:1}),v(y(I),{type:"primary",onClick:b},{default:T(()=>[...i[5]||(i[5]=[S("主题样式",-1)])]),_:1})]),_:1}),v(y(j),{open:n.value,"onUpdate:open":i[0]||(i[0]=s=>n.value=s),steps:p,onFinish:i[1]||(i[1]=s=>n.value=!1)},null,8,["open"]),v(y(j),{open:d.value,"onUpdate:open":i[2]||(i[2]=s=>d.value=s),type:"primary",steps:e,onFinish:i[3]||(i[3]=s=>d.value=!1)},null,8,["open"])]))}}),at=`<template>
  <div>
    <Space>
