import{B as l}from"./Button-Bf04Y6dy.js";import{S as c}from"./Space-a2HJigIW.js";import{d as k,o as u,q as m,w as a,c as t,e as p,g as e,b as f,f as s,_ as b,F as x,z as y,A as S,h as v,i as B}from"./index-DpCWj_RH.js";import{D as w}from"./Divider-Bq9aG0nx.js";import"./cls-S9IiI6wd.js";import"./LoadingOutlined-BZTKujXV.js";const q=k({__name:"SpaceBasic",setup(r){return(i,n)=>(u(),m(p(c),null,{default:a(()=>[t(p(l),{type:"primary"},{default:a(()=>[...n[0]||(n[0]=[e(" 按钮一 ",-1)])]),_:1}),t(p(l),null,{default:a(()=>[...n[1]||(n[1]=[e("按钮二",-1)])]),_:1}),t(p(l),{type:"dashed"},{default:a(()=>[...n[2]||(n[2]=[e(" 按钮三 ",-1)])]),_:1})]),_:1}))}}),N=`<template>
  <Space>
