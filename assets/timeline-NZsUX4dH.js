import{o as m,N as H,n as a,C as K,F as X,A as u,i as k,K as l,k as T,h as e,_ as Y,H as G,R as g,m as f,l as J}from"./index-B9Ix0zQ8.js";import{c as b}from"./cls-S9IiI6wd.js";import{I as Q}from"./Icon-D0ODznex.js";import{L as U}from"./LoadingOutlined-aeZz6k73.js";function Z(t){return t==="left"?"start":t==="right"?"end":t==="start"||t==="end"||t==="alternate"?t:"start"}function tt(t,s,o){return t.placement?t.placement:t.position==="left"?"start":t.position==="right"?"end":o==="alternate"?s%2===0?"start":"end":o}function F(t){if(!t)return[];const s=[];for(const o of t)if(o&&o.type!==K){if(o.type===X&&Array.isArray(o.children)){s.push(...F(o.children));continue}o.props&&s.push(o.props)}return s}const nt=m({name:"TimelineItem",props:{title:[String,Object],content:[String,Object],icon:[String,Object],placement:String,loading:Boolean,label:[String,Object],children:null,dot:[String,Object],position:String,color:String,className:String,style:Object},setup(t,{slots:s}){return()=>{var o;return(o=s.default)==null?void 0:o.call(s)}}}),et=m({name:"Timeline",props:{items:Array,mode:{type:String,default:"left"},orientation:{type:String,default:"vertical"},variant:{type:String,default:"outlined"},reverse:Boolean,titleSpan:[Number,String],pending:[Boolean,String,Object],pendingDot:[String,Object],classNames:Object,styles:Object},setup(t,{slots:s}){const o=H("timeline");return()=>{var N,q;const i=Z(t.mode);let n=[];if(t.items)n=[...t.items];else if(s.default){const d=s.default();n=F(d)}if(t.pending){const d=typeof t.pending=="string"?t.pending:t.pending===!0?void 0:t.pending;n.push({content:d,icon:t.pendingDot,loading:!t.pendingDot,color:"gray"})}const p=t.reverse?[...n].reverse():n,S=b(o,{[`${o}-${t.orientation}`]:t.orientation==="horizontal",[`${o}-${i}`]:i!=="start",[`${o}-${t.variant}`]:t.variant!=="outlined",[`${o}-pending`]:!!t.pending,[`${o}-reverse`]:t.reverse},(N=t.classNames)==null?void 0:N.root),c={...(q=t.styles)==null?void 0:q.root};return t.titleSpan!==void 0&&i!=="alternate"&&(typeof t.titleSpan=="number"?c["--hmfw-timeline-title-span"]=`${t.titleSpan}px`:c["--hmfw-timeline-title-span"]=t.titleSpan),a("ul",{class:S,style:c},[p.map((d,y)=>{var $,I,z,P,B,O,V,A,D,E;const j=y===p.length-1,C=tt(d,y,i),_=d.title??d.label,L=d.content??d.children;let h=d.icon??d.dot;d.loading&&!h&&(h=a(Q,{component:U,spin:!0},null));const x=d.color??"blue",v=["blue","red","green","gray"].includes(x),W=!!h||d.loading,R=b(`${o}-item`,{[`${o}-item-last`]:j,[`${o}-item-${C}`]:C==="end",[`${o}-item-loading`]:d.loading},d.className,($=t.classNames)==null?void 0:$.item),M=b(`${o}-item-head`,{[`${o}-item-head-${x}`]:v,[`${o}-item-head-custom`]:W||!v},(I=t.classNames)==null?void 0:I.dot),w={...d.style,...(z=t.styles)==null?void 0:z.dot};return v||(w.borderColor=x,w.color=x),a("li",{key:d.key??y,class:R,style:(P=t.styles)==null?void 0:P.item},[_&&a("div",{class:b(`${o}-item-label`,(B=t.classNames)==null?void 0:B.label),style:(O=t.styles)==null?void 0:O.label},[_]),a("div",{class:b(`${o}-item-tail`,(V=t.classNames)==null?void 0:V.tail),style:(A=t.styles)==null?void 0:A.tail},null),a("div",{class:M,style:w},[h]),a("div",{class:b(`${o}-item-content`,(D=t.classNames)==null?void 0:D.content),style:(E=t.styles)==null?void 0:E.content},[L])])})])}}}),r=et;r.Item=nt;const ot=m({__name:"TimelineAlternate",setup(t){const s=[{content:"创建服务现场 2015-09-01"},{content:"初步排除网络异常 2015-09-01"},{content:"技术测试异常 2015-09-01"},{content:"网络异常正在修复 2015-09-01"}];return(o,i)=>(u(),k(l(r),{mode:"alternate",items:s}))}}),st=`<template>
...
<\/script>
`,at=m({__name:"TimelineBasic",setup(t){const s=[{content:"创建服务现场 2015-09-01"},{content:"初步排除网络异常 2015-09-01"},{content:"技术测试异常 2015-09-01"},{content:"网络异常正在修复 2015-09-01"}];return(o,i)=>(u(),k(l(r),{items:s}))}}),lt=`<template>
...
`,pt=m({__name:"TimelineCustomColor",setup(t){const s=[{content:"成功事件",color:"green"},{content:"失败事件",color:"red"},{content:"警告事件",color:"gray"},{content:"自定义颜色",color:"#00CCFF"}];return(o,i)=>(u(),k(l(r),{items:s}))}}),mt=`<template>
  <Timeline :items="items" />
</template>
...
<\/script>
`,ut=m({__name:"TimelineHorizontal",setup(t){const s=[{title:"2015-09",content:"创建服务"},{title:"2015-10",content:"排除异常"},{title:"2015-11",content:"技术测试"},{title:"2015-12",content:"修复完成"}];return(o,i)=>(u(),k(l(r),{orientation:"horizontal",items:s}))}}),gt=`<template>
...
<\/script>
`,ft=m({__name:"TimelineLoading",setup(t){const s=[{content:"创建服务现场",loading:!0},{content:"初步排除网络异常",color:"green"},{content:"技术测试异常",color:"red"}];return(o,i)=>(u(),k(l(r),{items:s}))}}),bt=`<template>
  <Timeline :items="items" />
</template>
...
<\/script>
`,kt=m({__name:"TimelinePending",setup(t){const s=[{content:"创建服务现场 2015-09-01"},{content:"初步排除网络异常 2015-09-01"},{content:"技术测试异常 2015-09-01"}];return(o,i)=>(u(),k(l(r),{items:s,pending:"记录中..."}))}}),ht=`<template>
...
<\/script>
`,xt={style:{display:"flex",gap:"32px"}},yt=m({__name:"TimelineVariant",setup(t){const s=[{content:"成功事件",color:"green"},{content:"进行中",color:"blue"},{content:"失败事件",color:"red"}];return(o,i)=>(u(),T("div",xt,[e("div",null,[i[0]||(i[0]=e("h4",null,"Outlined (默认)",-1)),a(l(r),{items:s})]),e("div",null,[i[1]||(i[1]=e("h4",null,"Filled",-1)),a(l(r),{items:s,variant:"filled"})])]))}}),vt=`<template>
