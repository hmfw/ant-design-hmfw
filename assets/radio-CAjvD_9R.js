import{R as y,b as v,a as z}from"./index-hlPdYwTv.js";import{o as k,A as x,k as R,n as l,K as i,R as u,m as b,h as t,J as g,E as p,H as h,l as B}from"./index-C7r7ERgN.js";import"./cls-S9IiI6wd.js";const G={style:{display:"flex","flex-direction":"column",gap:"8px"}},U=k({__name:"RadioBasic",setup(c){const a=p(!1),s=p(!1),r=p(!0);return(d,o)=>(x(),R("div",G,[l(i(y),{checked:a.value,"onUpdate:checked":o[0]||(o[0]=e=>a.value=e)},{default:u(()=>[...o[3]||(o[3]=[b(" 单选框 ",-1)])]),_:1},8,["checked"]),l(i(y),{checked:s.value,"onUpdate:checked":o[1]||(o[1]=e=>s.value=e),disabled:""},{default:u(()=>[...o[4]||(o[4]=[b(" 禁用单选框 ",-1)])]),_:1},8,["checked"]),l(i(y),{checked:r.value,"onUpdate:checked":o[2]||(o[2]=e=>r.value=e),disabled:""},{default:u(()=>[...o[5]||(o[5]=[b(" 禁用选中 ",-1)])]),_:1},8,["checked"]),t("p",null,"checked: "+g(a.value),1)]))}}),O=`<template>
...
<\/script>
`,S={style:{display:"flex","flex-direction":"column",gap:"16px"}},C=k({__name:"RadioButton",setup(c){const a=p("middle"),s=p("middle"),r=p("large"),d=p("small"),o=p("middle"),e=[{label:"大",value:"large"},{label:"中",value:"middle"},{label:"小",value:"small"}];return(f,n)=>(x(),R("div",S,[t("div",null,[n[5]||(n[5]=t("p",{style:{"margin-bottom":"8px"}},"outline 样式（默认）：",-1)),l(i(v),{value:a.value,"onUpdate:value":n[0]||(n[0]=m=>a.value=m),options:e,"option-type":"button","button-style":"outline"},null,8,["value"])]),t("div",null,[n[6]||(n[6]=t("p",{style:{"margin-bottom":"8px"}},"solid 样式：",-1)),l(i(v),{value:s.value,"onUpdate:value":n[1]||(n[1]=m=>s.value=m),options:e,"option-type":"button","button-style":"solid"},null,8,["value"])]),t("div",null,[n[7]||(n[7]=t("p",{style:{"margin-bottom":"8px"}},"大尺寸：",-1)),l(i(v),{value:r.value,"onUpdate:value":n[2]||(n[2]=m=>r.value=m),options:e,"option-type":"button",size:"large"},null,8,["value"])]),t("div",null,[n[8]||(n[8]=t("p",{style:{"margin-bottom":"8px"}},"小尺寸：",-1)),l(i(v),{value:d.value,"onUpdate:value":n[3]||(n[3]=m=>d.value=m),options:e,"option-type":"button",size:"small"},null,8,["value"])]),t("div",null,[n[9]||(n[9]=t("p",{style:{"margin-bottom":"8px"}},"禁用状态：",-1)),l(i(v),{value:o.value,"onUpdate:value":n[4]||(n[4]=m=>o.value=m),options:e,"option-type":"button",disabled:""},null,8,["value"])]),t("p",null,"选中："+g(a.value),1)]))}}),$=`<template>
...
<\/script>
`,A={style:{display:"flex","flex-direction":"column",gap:"16px"}},w=k({__name:"RadioGroup",setup(c){const a=p("a"),s=p("b"),r=[{label:"选项 A",value:"a"},{label:"选项 B",value:"b"},{label:"选项 C",value:"c"},{label:"禁用选项",value:"d",disabled:!0}];return(d,o)=>(x(),R("div",A,[t("div",null,[o[2]||(o[2]=t("p",{style:{"margin-bottom":"8px"}},"水平排列：",-1)),l(i(v),{value:a.value,"onUpdate:value":o[0]||(o[0]=e=>a.value=e),options:r},null,8,["value"])]),t("div",null,[o[3]||(o[3]=t("p",{style:{"margin-bottom":"8px"}},"垂直排列：",-1)),l(i(v),{value:s.value,"onUpdate:value":o[1]||(o[1]=e=>s.value=e),options:r,direction:"vertical"},null,8,["value"])]),t("p",null,"value1: "+g(a.value)+"，value2: "+g(s.value),1)]))}}),E=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px">
    <div>
...
<\/script>
`,M={style:{display:"flex","flex-direction":"column",gap:"16px"}},V={style:{display:"flex",gap:"16px","align-items":"center"}},N=k({__name:"RadioIdBinding",setup(c){const a=p("a"),s=p(!1),r=p("middle"),d=p("light");return(o,e)=>(x(),R("div",M,[t("div",null,[e[7]||(e[7]=t("p",{style:{"margin-bottom":"8px"}},"id 属性自动绑定到原生 input：",-1)),l(i(v),{value:a.value,"onUpdate:value":e[0]||(e[0]=f=>a.value=f)},{default:u(()=>[l(i(y),{id:"radio-a",value:"a"},{default:u(()=>[...e[4]||(e[4]=[b(' 选项 A（id="radio-a"） ',-1)])]),_:1}),l(i(y),{id:"radio-b",value:"b"},{default:u(()=>[...e[5]||(e[5]=[b(' 选项 B（id="radio-b"） ',-1)])]),_:1}),l(i(y),{id:"radio-c",value:"c"},{default:u(()=>[...e[6]||(e[6]=[b(' 选项 C（id="radio-c"） ',-1)])]),_:1})]),_:1},8,["value"])]),t("div",null,[e[9]||(e[9]=t("p",{style:{"margin-bottom":"8px"}},"通过 label[for] 配合使用：",-1)),t("div",V,[l(i(y),{id:"payment-alipay",checked:s.value,"onUpdate:checked":e[1]||(e[1]=f=>s.value=f),value:"alipay"},null,8,["checked"]),e[8]||(e[8]=t("label",{for:"payment-alipay",style:{cursor:"pointer","user-select":"none"}}," 支付宝支付 ",-1))])]),t("div",null,[e[10]||(e[10]=t("p",{style:{"margin-bottom":"8px"}},"RadioGroup 中的 id：",-1)),l(i(v),{value:r.value,"onUpdate:value":e[2]||(e[2]=f=>r.value=f),options:[{label:"大",value:"large",id:"size-large"},{label:"中",value:"middle",id:"size-middle"},{label:"小",value:"small",id:"size-small"}]},null,8,["value"])]),t("div",null,[e[14]||(e[14]=t("p",{style:{"margin-bottom":"8px"}},"RadioButton 中的 id：",-1)),l(i(v),{value:d.value,"onUpdate:value":e[3]||(e[3]=f=>d.value=f),"option-type":"button"},{default:u(()=>[l(i(z),{id:"theme-light",value:"light"},{default:u(()=>[...e[11]||(e[11]=[b(" 浅色 ",-1)])]),_:1}),l(i(z),{id:"theme-dark",value:"dark"},{default:u(()=>[...e[12]||(e[12]=[b(" 深色 ",-1)])]),_:1}),l(i(z),{id:"theme-auto",value:"auto"},{default:u(()=>[...e[13]||(e[13]=[b(" 自动 ",-1)])]),_:1})]),_:1},8,["value"])]),t("div",null,[t("p",null,"状态："+g({selectedOption:a.value,paymentMethod:s.value,size:r.value,theme:d.value}),1)]),e[15]||(e[15]=t("div",null,[t("p",{style:{"margin-bottom":"8px"}},"用例说明："),t("ul",{style:{margin:"0","padding-left":"20px"}},[t("li",null,'id 属性自动绑定到原生 <input type="radio"> 元素'),t("li",null,'可以配合 <label for="..."> 实现点击文本选中单选框'),t("li",null,"在 RadioGroup 的 options 中也可以指定 id"),t("li",null,"RadioButton 同样支持 id 属性")])],-1))]))}}),D=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px">
    <div>
