...
<\/script>
`,In={style:{width:"300px"}},Rn={style:{"margin-top":"8px"}},Vn=B({__name:"DatePickerShowTime",setup(a){const o=f(""),n=r=>{console.log("选中日期时间：",r)};return(r,e)=>(E(),_("div",In,[s(g(q),{value:o.value,"onUpdate:value":e[0]||(e[0]=k=>o.value=k),"show-time":!0,placeholder:"选择日期和时间",onChange:n},null,8,["value"]),c("p",Rn,"选中："+J(o.value),1)]))}}),Un=`<template>
