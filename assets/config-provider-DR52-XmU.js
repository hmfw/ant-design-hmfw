...
<\/script>
`,R={style:{display:"flex",gap:"12px","margin-bottom":"16px"}},D={style:{display:"flex","flex-direction":"column",gap:"12px"}},M=u({__name:"ConfigProviderSize",setup(a){const o=y("middle"),s={small:"24px",middle:"32px",large:"40px"},d=v(()=>({height:s[o.value],padding:"0 8px",border:"1px solid #d9d9d9",borderRadius:"6px"})),e=v(()=>({height:s[o.value],padding:"0 16px",border:"1px solid #d9d9d9",borderRadius:"6px",cursor:"pointer"}));return(c,l)=>(p(),m(b,null,[t("div",R,[t("button",{onClick:l[0]||(l[0]=f=>o.value="small")},"小"),t("button",{onClick:l[1]||(l[1]=f=>o.value="middle")},"中"),t("button",{onClick:l[2]||(l[2]=f=>o.value="large")},"大")]),n(r(g),{"component-size":o.value},{default:i(()=>[t("div",D,[t("input",{style:x(d.value),placeholder:"输入框"},null,4),t("button",{style:x(e.value)},"按钮",4)])]),_:1},8,["component-size"])],64))}}),F=`<template>
  <div style="display: flex; gap: 12px; margin-bottom: 16px;">
...
<\/script>
`,U=u({__name:"ConfigProviderTheme",setup(a){const o={token:{colorPrimary:"#00b96b",borderRadius:2}};return(s,d)=>(p(),S(r(g),{theme:o},{default:i(()=>[...d[0]||(d[0]=[t("div",{style:{display:"flex","flex-direction":"column",gap:"12px"}},[t("button",{style:{background:"var(--hmfw-color-primary)",color:"white",border:"none",padding:"8px 16px","border-radius":"6px",cursor:"pointer"}}," 主色按钮 "),t("p",{style:{color:"var(--hmfw-color-primary)"}},"主色文字")],-1)])]),_:1}))}}),_=`<template>
