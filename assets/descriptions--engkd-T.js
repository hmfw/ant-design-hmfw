import{o as S,N as I,L as O,n as d,F as C,f as $,x as G,y as M,E as P,A as D,i as v,K as u,k as z,h as r,H as L,R as k,m as B,l as R}from"./index-DJdGgqDu.js";import{c as w}from"./cls-S9IiI6wd.js";function T(l,t){let n=null;return function(...a){n!==null&&clearTimeout(n),n=setTimeout(()=>{l.apply(this,a),n=null},t)}}const A={xxl:3,xl:3,lg:3,md:3,sm:2,xs:1};function E(){const l=P(typeof window<"u"?window.innerWidth:0),n=T(()=>{typeof window<"u"&&(l.value=window.innerWidth)},100);return G(()=>{typeof window<"u"&&window.addEventListener("resize",n)}),M(()=>{typeof window<"u"&&window.removeEventListener("resize",n)}),$(()=>({xs:l.value>=0,sm:l.value>=576,md:l.value>=768,lg:l.value>=992,xl:l.value>=1200,xxl:l.value>=1600}))}function _(l,t){if(!t)return;const n=["xxl","xl","lg","md","sm","xs"];for(const a of n)if(l[a]&&t[a]!==void 0)return t[a]}const F=S({name:"Descriptions",props:{title:[String,Object],extra:[String,Object],bordered:Boolean,column:{type:[Number,Object],default:3},size:{type:String,default:"default"},layout:{type:String,default:"horizontal"},colon:{type:Boolean,default:!0},items:Array,labelStyle:Object,contentStyle:Object},setup(l,{slots:t}){const n=I("descriptions"),a=O(),e=E(),g=$(()=>{const p=e.value;return typeof l.column=="number"?l.column:_(p,l.column)??_(p,A)??3}),q=$(()=>{var y;return l.items?l.items.map((s,o)=>({...s,key:o})):(((y=t.default)==null?void 0:y.call(t))||[]).filter(s=>s.type&&typeof s.type=="object").map((s,o)=>({...s.props||{},children:s.children,key:s.key??o}))}),N=$(()=>{const p=e.value;return q.value.map(y=>{const{span:s,...o}=y;if(s==="filled")return{...o,filled:!0,computedSpan:1};const m=typeof s=="number"?s:_(p,s)??1;return{...o,computedSpan:m}})}),V=$(()=>{const p=g.value,y=N.value,s=[];let o=[],m=0;for(const h of y){if(h.filled){const i=p-m;o.push({...h,computedSpan:i}),s.push(o),o=[],m=0;continue}const c=h.computedSpan??1,b=p-m;m+c>p&&o.length>0&&(s.push(o),o=[],m=0),m+c>p?(o.push({...h,computedSpan:b}),m=p):(o.push(h),m+=c),m>=p&&(s.push(o),o=[],m=0)}return o.length>0&&s.push(o),s.map(h=>{const c=h.reduce((b,i)=>b+(i.computedSpan??1),0);if(c<p&&h.length>0){const b=h[h.length-1],i=b.computedSpan??1;b.computedSpan=p-(c-i)}return h})}),j=$(()=>l.size==="medium"?"middle":l.size);return()=>{var m,h;const p=a.value.direction,y=j.value,s=c=>{const b={...l.labelStyle,...c.labelStyle};return d("span",{style:b},[c.label])},o=c=>{const b={...l.contentStyle,...c.contentStyle};return d("span",{style:b},[c.children])};return d("div",{class:w(n,{[`${n}-${y}`]:y!=="default",[`${n}-bordered`]:l.bordered,[`${n}-rtl`]:p==="rtl"})},[(l.title||l.extra||t.title||t.extra)&&d("div",{class:`${n}-header`},[(l.title||t.title)&&d("div",{class:`${n}-title`},[((m=t.title)==null?void 0:m.call(t))??l.title]),(l.extra||t.extra)&&d("div",{class:`${n}-extra`},[((h=t.extra)==null?void 0:h.call(t))??l.extra])]),d("div",{class:`${n}-view`},[d("table",null,[d("tbody",null,[V.value.map((c,b)=>l.layout==="vertical"?d(C,null,[d("tr",{key:`label-${b}`,class:`${n}-row`},[c.map((i,x)=>d("th",{key:`label-${i.key??x}`,class:`${n}-item-label`,colspan:i.computedSpan??1},[s(i)]))]),d("tr",{key:`content-${b}`,class:`${n}-row`},[c.map((i,x)=>d("td",{key:`content-${i.key??x}`,class:`${n}-item-content`,colspan:i.computedSpan??1},[o(i)]))])]):l.bordered?d("tr",{key:b,class:`${n}-row`},[c.map((i,x)=>[d("th",{key:`label-${i.key??x}`,class:`${n}-item-label`},[s(i)]),d("td",{key:`content-${i.key??x}`,class:`${n}-item-content`,colspan:(i.computedSpan??1)*2-1},[o(i)])])]):d("tr",{key:b,class:`${n}-row`},[c.map((i,x)=>d("td",{key:`item-${i.key??x}`,class:`${n}-item`,colspan:i.computedSpan??1},[d("div",{class:`${n}-item-container`},[i.label&&d("span",{class:w(`${n}-item-label`,{[`${n}-item-no-colon`]:!l.colon})},[s(i)]),d("span",{class:`${n}-item-content`},[o(i)])])]))]))])])])])}}}),U=S({name:"DescriptionsItem",props:{label:String,span:[Number,String,Object],labelStyle:Object,contentStyle:Object},setup(l,{slots:t}){return()=>{var n;return(n=t.default)==null?void 0:n.call(t)}}}),f=F;f.Item=U;const W=S({__name:"DescriptionsBasic",setup(l){const t=[{label:"用户名",children:"Zhou Maomao"},{label:"手机号",children:"1810000000"},{label:"居住地",children:"杭州市"},{label:"备注",children:"学校"},{label:"联系地址",children:"浙江省杭州市西湖区古翠路",span:2}];return(n,a)=>(D(),v(u(f),{title:"用户信息",items:t}))}}),Z=`<template>
...
<\/script>
`,J=S({__name:"DescriptionsFilled",setup(l){const t=[{label:"产品",children:"Cloud Database",span:2},{label:"计费",children:"预付费"},{label:"时间",children:"18:00:00"},{label:"金额",children:"$80.00",span:"filled"},{label:"折扣",children:"$20.00",span:"filled"},{label:"实付",children:"$60.00"}];return(n,a)=>(D(),v(u(f),{title:"Span 填充示例",column:3,items:t}))}}),Q=`<template>
