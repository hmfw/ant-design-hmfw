import{S as p}from"./Select-DesA3IGj.js";import{o as b,A as c,k as v,n as o,K as a,h as e,J as h,E as u,m as r,_ as f,H as y,R as g,l as S}from"./index-C7r7ERgN.js";import"./cls-S9IiI6wd.js";import"./VirtualList-B6mwTjGn.js";const w={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"300px"}},_=b({__name:"SelectBasic",setup(m){const d=u(""),s=u(""),i=[{label:"Vue",value:"vue"},{label:"React",value:"react"},{label:"Angular",value:"angular"},{label:"Svelte（禁用）",value:"svelte",disabled:!0}];return(t,l)=>(c(),v("div",w,[o(a(p),{value:d.value,"onUpdate:value":l[0]||(l[0]=n=>d.value=n),options:i,placeholder:"请选择",style:{width:"100%"}},null,8,["value"]),o(a(p),{value:s.value,"onUpdate:value":l[1]||(l[1]=n=>s.value=n),options:i,placeholder:"禁用状态",disabled:"",style:{width:"100%"}},null,8,["value"]),e("p",null,"选中："+h(d.value),1)]))}}),V=`<template>
...
<\/script>
`,T={style:{"max-width":"300px"}},j=b({__name:"SelectSearch",setup(m){const d=u(""),s=[{label:"北京",value:"beijing"},{label:"上海",value:"shanghai"},{label:"广州",value:"guangzhou"},{label:"深圳",value:"shenzhen"},{label:"杭州",value:"hangzhou"},{label:"成都",value:"chengdu"}],i=u(s),t=l=>{i.value=s.filter(n=>n.label.includes(l))};return(l,n)=>(c(),v("div",T,[o(a(p),{value:d.value,"onUpdate:value":n[0]||(n[0]=x=>d.value=x),options:i.value,"show-search":!0,placeholder:"请搜索并选择",style:{width:"100%"},onSearch:t},null,8,["value","options"])]))}}),I=`<template>
...
<\/script>
`,H={class:"select-virtual-demo"},J={style:{display:"flex",gap:"16px","margin-bottom":"24px"}},P={style:{flex:"1"}},F={style:{"margin-top":"8px","font-size":"12px",color:"#8c8c8c"}},K={style:{flex:"1"}},W=b({__name:"SelectVirtual",setup(m){const d=u(),s=u(),i=Array.from({length:1e4},(l,n)=>({label:`选项 ${n+1} - ${Math.random().toString(36).substring(7)}`,value:`option-${n+1}`})),t=i.slice(0,100);return(l,n)=>(c(),v("div",H,[n[5]||(n[5]=e("h4",null,"虚拟滚动（10,000 个选项）",-1)),n[6]||(n[6]=e("p",{style:{"margin-bottom":"16px",color:"#666"}},"使用虚拟滚动技术，即使有 10,000 个选项也能流畅交互",-1)),e("div",J,[e("div",P,[n[2]||(n[2]=e("h5",{style:{"margin-bottom":"8px"}},"启用虚拟滚动 ✅",-1)),o(a(p),{value:d.value,"onUpdate:value":n[0]||(n[0]=x=>d.value=x),options:a(i),placeholder:"选择一个选项","show-search":"",style:{width:"100%"},virtual:"","list-height":256,"list-item-height":32},null,8,["value","options"]),e("div",F,"已选择："+h(d.value||"未选择"),1)]),e("div",K,[n[3]||(n[3]=e("h5",{style:{"margin-bottom":"8px"}},"普通模式（对比）",-1)),o(a(p),{value:s.value,"onUpdate:value":n[1]||(n[1]=x=>s.value=x),options:a(t),placeholder:"选择一个选项","show-search":"",style:{width:"100%"}},null,8,["value","options"]),n[4]||(n[4]=e("div",{style:{"margin-top":"8px","font-size":"12px",color:"#8c8c8c"}},"仅 100 个选项用于对比",-1))])]),n[7]||(n[7]=e("div",{style:{padding:"12px",background:"#f5f5f5","border-radius":"4px"}},[e("strong",null,"性能对比："),e("ul",{style:{margin:"8px 0","padding-left":"20px"}},[e("li",null,[e("strong",null,"虚拟滚动模式："),r("10,000 个选项，只渲染可见的 8-10 项，流畅无卡顿")]),e("li",null,[e("strong",null,"普通模式："),r("超过 1,000 个选项会明显卡顿，10,000 个会导致浏览器卡死")])]),e("div",{style:{"margin-top":"8px",color:"#1890ff"}},[r("💡 建议：当选项超过 100 个时启用 "),e("code",null,"virtual"),r(" 属性")])],-1))]))}}),q=f(W,[["__scopeId","data-v-d7f10b23"]]),Q=`<template>
