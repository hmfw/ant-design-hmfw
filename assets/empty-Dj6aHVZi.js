import{B as g}from"./Button-B7cCICCq.js";import{E as i,P as k}from"./Empty-Db-xY0xO.js";import{o as u,A as l,i as f,Q as r,n as e,L as s,m as o,k as y,h as t,_ as x,K as h,v as b,E,H as v,l as w}from"./index-Bxt2WIDN.js";import"./cls-S9IiI6wd.js";import"./LoadingOutlined-T50wZmIy.js";const S=u({__name:"EmptyAction",setup(c){function p(){console.log("创建")}return(a,d)=>(l(),f(s(i),{description:"暂无数据"},{default:r(()=>[e(s(g),{onClick:p},{default:r(()=>[...d[0]||(d[0]=[o("立即创建",-1)])]),_:1})]),_:1}))}}),_=`<template>
