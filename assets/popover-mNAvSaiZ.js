...
`,M={style:{display:"flex",gap:"8px","flex-wrap":"wrap"}},G=P({__name:"PopoverPlacement",setup(n){const l=["topLeft","top","topRight","leftTop","left","leftBottom","rightTop","right","rightBottom","bottomLeft","bottom","bottomRight"];return(p,u)=>(x(),h("div",M,[(x(),h(I,null,F(l,t=>e(s(c),{key:t,placement:t,title:"标题",content:"内容"},{default:a(()=>[e(s(v),null,{default:a(()=>[i(E(t),1)]),_:2},1024)]),_:2},1032,["placement"])),64))]))}}),J=`<template>
...
<\/script>
`,K={style:{display:"flex",gap:"24px","flex-wrap":"wrap"}},Q=P({__name:"PopoverPurePanel",setup(n){return(l,p)=>(x(),h("div",K,[e(s(c)._InternalPanelDoNotUseOrYouWillBeFired,{title:"标题",content:"这是直接内联渲染的气泡卡片面板"}),e(s(c)._InternalPanelDoNotUseOrYouWillBeFired,{title:"仅标题",placement:"bottom"}),e(s(c)._InternalPanelDoNotUseOrYouWillBeFired,{content:"无箭头 + 自定义背景色",arrow:!1,color:"#1677ff",styles:{content:{color:"#fff"}}})]))}}),X=`<template>
