...
`,P={style:{display:"flex","flex-direction":"column",gap:"16px"}},$=g({__name:"BadgeStatus",setup(i){return(p,n)=>(r(),l("div",P,[a(e(o),{status:"success",text:"成功"}),a(e(o),{status:"error",text:"错误"}),a(e(o),{status:"default",text:"默认"}),a(e(o),{status:"processing",text:"进行中"}),a(e(o),{status:"warning",text:"警告"})]))}}),A=`<template>
