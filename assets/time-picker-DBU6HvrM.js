import{o as O,O as An,E as i,P as tn,n as l,f as T,m as h,t as yn,A as B,k as M,L as m,h as e,K as Un,_ as Vn,H as Dn,Q as E,l as Fn}from"./index-CEDKhEzr.js";import{c as g}from"./cls-S9IiI6wd.js";import{C as Rn}from"./CloseCircleFilled-JEI3_UNE.js";import{C as In}from"./ClockCircleOutlined-BdjxwfVv.js";import{T as zn}from"./Trigger-C6BCQff1.js";function A(n){return String(n).padStart(2,"0")}function W(n){if(!n)return{h:0,m:0,s:0};const d=n.toLowerCase(),c=d.includes("pm"),p=d.includes("am"),t=n.replace(/[^\d:]/g,"").split(":").map(w=>Number(w));let a=t[0]||0;const o=t[1]||0,k=t[2]||0;return c&&a<12&&(a+=12),p&&a===12&&(a=0),{h:a,m:o,s:k}}function en(n,d,c,p){const t=n>=12,a=n%12===0?12:n%12;return p.replace(/HH|H|hh|h|mm|m|ss|s|A|a/g,o=>{switch(o){case"HH":return A(n);case"H":return String(n);case"hh":return A(a);case"h":return String(a);case"mm":return A(d);case"m":return String(d);case"ss":return A(c);case"s":return String(c);case"A":return t?"PM":"AM";case"a":return t?"pm":"am";default:return o}})}function Ln(n){return/s/.test(n)}const b=O({name:"TimePicker",props:{value:String,defaultValue:String,format:{type:String,default:"HH:mm:ss"},disabled:Boolean,size:{type:String,default:"middle"},placeholder:{type:String,default:"请选择时间"},allowClear:{type:Boolean,default:!0},hourStep:{type:Number,default:1},minuteStep:{type:Number,default:1},secondStep:{type:Number,default:1},disabledTime:Function,hideDisabledOptions:Boolean,showNow:{type:Boolean,default:!0},use12Hours:Boolean,status:{type:String,default:""},open:{type:Boolean,default:void 0},needConfirm:{type:Boolean,default:!0},changeOnScroll:Boolean,renderExtraFooter:Function,variant:{type:String,default:"outlined"},placement:{type:String,default:"bottomLeft"},classNames:Object,styles:Object},emits:["update:value","change","openChange","focus","blur"],setup(n,{emit:d,expose:c}){const p=An("time-picker"),t=W(n.defaultValue??n.value),a=i(t.h),o=i(t.m),k=i(t.s),w=i(t.h),N=i(t.m),q=i(t.s),j=i(!1),wn=i(),Q=i(),V=i(!!n.defaultValue||!!n.value),X=i(),Y=i(),G=i(),J=i(),z=T(()=>n.open!==void 0?n.open:j.value),an=T(()=>{if(n.value!==void 0){if(!n.value)return"";const s=W(n.value);return en(s.h,s.m,s.s,n.format)}return V.value?en(a.value,o.value,k.value,n.format):""}),y=T(()=>{if(n.value!==void 0){const s=W(n.value);return{h:s.h,m:s.m,s:s.s}}return n.needConfirm?{h:w.value,m:N.value,s:q.value}:{h:a.value,m:o.value,s:k.value}});tn(()=>n.value,s=>{if(s!==void 0)if(!s)a.value=0,o.value=0,k.value=0,w.value=0,N.value=0,q.value=0,V.value=!1;else{const r=W(s);a.value=r.h,o.value=r.m,k.value=r.s,w.value=r.h,N.value=r.m,q.value=r.s,V.value=!0}});const Cn=()=>{n.disabled||(n.needConfirm&&(w.value=a.value,N.value=o.value,q.value=k.value),j.value=!0,d("openChange",!0))},sn=()=>{n.needConfirm&&(w.value=a.value,N.value=o.value,q.value=k.value),j.value=!1,d("openChange",!1)},U=()=>{n.needConfirm&&(a.value=w.value,o.value=N.value,k.value=q.value);const s=en(a.value,o.value,k.value,n.format);V.value=!0,d("update:value",s),d("change",s,s),sn()},Sn=()=>{const s=new Date;n.needConfirm?(w.value=s.getHours(),N.value=s.getMinutes(),q.value=s.getSeconds()):(a.value=s.getHours(),o.value=s.getMinutes(),k.value=s.getSeconds()),n.needConfirm||U()},Pn=s=>{s.stopPropagation(),a.value=0,o.value=0,k.value=0,w.value=0,N.value=0,q.value=0,V.value=!1,d("update:value",void 0),d("change",void 0,"")},K=T(()=>{var s;return((s=n.disabledTime)==null?void 0:s.call(n))??{}}),Tn=T(()=>{var x,u;const s=((u=(x=K.value).disabledHours)==null?void 0:u.call(x))??[],r=n.use12Hours?12:24,v=[];for(let C=0;C<r;C+=n.hourStep)(!n.hideDisabledOptions||!s.includes(C))&&v.push(C);return v.map(C=>({value:C,disabled:s.includes(C)}))}),Nn=T(()=>{var v,x;const s=((x=(v=K.value).disabledMinutes)==null?void 0:x.call(v,y.value.h))??[],r=[];for(let u=0;u<60;u+=n.minuteStep)(!n.hideDisabledOptions||!s.includes(u))&&r.push(u);return r.map(u=>({value:u,disabled:s.includes(u)}))}),qn=T(()=>{var v,x;const s=((x=(v=K.value).disabledSeconds)==null?void 0:x.call(v,y.value.h,y.value.m))??[],r=[];for(let u=0;u<60;u+=n.secondStep)(!n.hideDisabledOptions||!s.includes(u))&&r.push(u);return r.map(u=>({value:u,disabled:s.includes(u)}))}),$n=T(()=>[{value:"AM",disabled:!1},{value:"PM",disabled:!1}]),L=T(()=>y.value.h>=12?"PM":"AM"),Z=T(()=>Ln(n.format));let _=0;const nn=i({}),$=(s,r,v)=>{s&&nn.value[v]!==r&&(nn.value[v]=r,_&&cancelAnimationFrame(_),_=requestAnimationFrame(()=>{const x=s.querySelector(`[data-value="${r}"]`);x&&typeof x.scrollIntoView=="function"&&x.scrollIntoView({block:"nearest",behavior:"smooth"})}))};tn(z,s=>{s?yn(()=>{const r=n.use12Hours?y.value.h%12||12:y.value.h;$(X.value,r,"h"),$(Y.value,y.value.m,"m"),Z.value&&$(G.value,y.value.s,"s"),n.use12Hours&&$(J.value,L.value,"p")}):nn.value={}}),tn(()=>[y.value.h,y.value.m,y.value.s,L.value],()=>{z.value&&yn(()=>{const s=n.use12Hours?y.value.h%12||12:y.value.h;$(X.value,s,"h"),$(Y.value,y.value.m,"m"),Z.value&&$(G.value,y.value.s,"s"),n.use12Hours&&$(J.value,L.value,"p")})});const Hn=(s,r)=>{r||(n.needConfirm?w.value=s:(a.value=s,n.changeOnScroll&&U()))},On=(s,r)=>{r||(n.needConfirm?N.value=s:(o.value=s,n.changeOnScroll&&U()))},Bn=(s,r)=>{r||(n.needConfirm?q.value=s:(k.value=s,n.changeOnScroll&&U()))},Mn=s=>{const r=s==="PM",v=n.needConfirm?w.value:a.value,x=v>=12;if(r!==x){const u=r?v+12:v-12;n.needConfirm?w.value=u:(a.value=u,n.changeOnScroll&&U())}};c({focus:()=>{var s;return(s=Q.value)==null?void 0:s.focus()},blur:()=>{var s;return(s=Q.value)==null?void 0:s.blur()}});const En=()=>{var s,r,v,x,u,C,D,F,R,I,on,ln,pn,dn,cn,rn,un,mn,kn,fn,vn,gn,bn,xn,hn;return l("div",{ref:wn,class:g(`${p}-popup`,(s=n.classNames)==null?void 0:s.popup),style:(r=n.styles)==null?void 0:r.popup},[l("div",{class:g(`${p}-panel`,(v=n.classNames)==null?void 0:v.panel),style:(x=n.styles)==null?void 0:x.panel},[l("div",{class:g(`${p}-panel-inner`,(u=n.classNames)==null?void 0:u.panelInner),style:(C=n.styles)==null?void 0:C.panelInner},[l("ul",{class:g(`${p}-panel-column`,(D=n.classNames)==null?void 0:D.column),style:(F=n.styles)==null?void 0:F.column,ref:X},[Tn.value.map(({value:f,disabled:S})=>{var P,H;return l("li",{key:f,"data-value":f,class:g(`${p}-panel-cell`,{[`${p}-panel-cell-selected`]:n.use12Hours?(y.value.h%12||12)===f:y.value.h===f,[`${p}-panel-cell-disabled`]:S},(P=n.classNames)==null?void 0:P.cell),style:(H=n.styles)==null?void 0:H.cell,onClick:()=>Hn(f,S)},[A(f)])})]),l("ul",{class:g(`${p}-panel-column`,(R=n.classNames)==null?void 0:R.column),style:(I=n.styles)==null?void 0:I.column,ref:Y},[Nn.value.map(({value:f,disabled:S})=>{var P,H;return l("li",{key:f,"data-value":f,class:g(`${p}-panel-cell`,{[`${p}-panel-cell-selected`]:y.value.m===f,[`${p}-panel-cell-disabled`]:S},(P=n.classNames)==null?void 0:P.cell),style:(H=n.styles)==null?void 0:H.cell,onClick:()=>On(f,S)},[A(f)])})]),Z.value&&l("ul",{class:g(`${p}-panel-column`,(on=n.classNames)==null?void 0:on.column),style:(ln=n.styles)==null?void 0:ln.column,ref:G},[qn.value.map(({value:f,disabled:S})=>{var P,H;return l("li",{key:f,"data-value":f,class:g(`${p}-panel-cell`,{[`${p}-panel-cell-selected`]:y.value.s===f,[`${p}-panel-cell-disabled`]:S},(P=n.classNames)==null?void 0:P.cell),style:(H=n.styles)==null?void 0:H.cell,onClick:()=>Bn(f,S)},[A(f)])})]),n.use12Hours&&l("ul",{class:g(`${p}-panel-column`,(pn=n.classNames)==null?void 0:pn.column),style:(dn=n.styles)==null?void 0:dn.column,ref:J},[$n.value.map(({value:f})=>{var S,P;return l("li",{key:f,"data-value":f,class:g(`${p}-panel-cell`,{[`${p}-panel-cell-selected`]:L.value===f},(S=n.classNames)==null?void 0:S.cell),style:(P=n.styles)==null?void 0:P.cell,onClick:()=>Mn(f)},[f])})])]),l("div",{class:g(`${p}-panel-footer`,(cn=n.classNames)==null?void 0:cn.footer),style:(rn=n.styles)==null?void 0:rn.footer},[l("div",{class:g(`${p}-panel-footer-extra`,(un=n.classNames)==null?void 0:un.footerExtra),style:(mn=n.styles)==null?void 0:mn.footerExtra},[(kn=n.renderExtraFooter)==null?void 0:kn.call(n)]),l("div",{class:g(`${p}-panel-footer-actions`,(fn=n.classNames)==null?void 0:fn.footerActions),style:(vn=n.styles)==null?void 0:vn.footerActions},[n.showNow&&l("button",{class:g(`${p}-panel-footer-btn`,(gn=n.classNames)==null?void 0:gn.now),style:(bn=n.styles)==null?void 0:bn.now,onClick:Sn},[h("此刻")]),n.needConfirm&&l("button",{class:g(`${p}-panel-footer-btn`,`${p}-panel-footer-ok`,(xn=n.classNames)==null?void 0:xn.ok),style:(hn=n.styles)==null?void 0:hn.ok,onClick:U},[h("确定")])])])])])};return()=>{var s,r,v,x;return l(zn,{open:z.value,trigger:"click",placement:n.placement,disabled:n.disabled,destroyOnHidden:!0,triggerClass:g(p,`${p}-${n.size}`,`${p}-${n.variant}`,{[`${p}-open`]:z.value,[`${p}-disabled`]:n.disabled,[`${p}-status-error`]:n.status==="error",[`${p}-status-warning`]:n.status==="warning"},(s=n.classNames)==null?void 0:s.root),triggerStyle:(r=n.styles)==null?void 0:r.root,popupClass:g(`${p}-popup`,(v=n.classNames)==null?void 0:v.popup),popupStyle:(x=n.styles)==null?void 0:x.popup,onOpenChange:u=>{u?Cn():sn()}},{default:()=>{var u,C,D,F,R,I;return l("span",{class:g(`${p}-input`,(u=n.classNames)==null?void 0:u.input),style:(C=n.styles)==null?void 0:C.input},[l("input",{ref:Q,readonly:!0,placeholder:n.placeholder,value:an.value,disabled:n.disabled,class:`${p}-input-inner`,onFocus:()=>d("focus"),onBlur:()=>d("blur")},null),n.allowClear&&an.value&&!n.disabled&&l("span",{class:g(`${p}-clear`,(D=n.classNames)==null?void 0:D.clear),style:(F=n.styles)==null?void 0:F.clear,onClick:Pn},[l(Rn,null,null)]),l("span",{class:g(`${p}-suffix`,(R=n.classNames)==null?void 0:R.suffix),style:(I=n.styles)==null?void 0:I.suffix},[l(In,null,null)])])},popup:({placement:u})=>En()})}}}),Wn={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"300px"}},jn=O({__name:"TimePickerBasic",setup(n){const d=i(""),c=i("10:30:00"),p=t=>{console.log("选中时间：",t)};return(t,a)=>(B(),M("div",Wn,[l(m(b),{value:d.value,"onUpdate:value":a[0]||(a[0]=o=>d.value=o),placeholder:"请选择时间",onChange:p},null,8,["value"]),l(m(b),{value:c.value,"onUpdate:value":a[1]||(a[1]=o=>c.value=o),placeholder:"禁用状态",disabled:""},null,8,["value"]),e("p",null,"选中时间："+Un(d.value),1)]))}}),Qn=`<template>
...
<\/script>
`,Xn={style:{display:"flex","flex-direction":"column",gap:"24px"}},Yn=O({__name:"TimePickerClassNames",setup(n){return(d,c)=>(B(),M("div",Xn,[e("div",null,[c[0]||(c[0]=e("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义触发器与输入区域：",-1)),l(m(b),{placeholder:"选择时间","class-names":{root:"custom-trigger",input:"custom-input",suffix:"custom-suffix"}})]),e("div",null,[c[1]||(c[1]=e("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义弹层与时间列：",-1)),l(m(b),{placeholder:"选择时间","class-names":{popup:"custom-popup",panel:"custom-panel",column:"custom-column",cell:"custom-cell"}})]),e("div",null,[c[2]||(c[2]=e("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义底部按钮样式：",-1)),l(m(b),{placeholder:"选择时间","need-confirm":!0,"class-names":{footer:"custom-footer",now:"custom-now-btn",ok:"custom-ok-btn"}})]),e("div",null,[c[3]||(c[3]=e("div",{style:{"margin-bottom":"8px",color:"#666"}},"使用内联样式对象：",-1)),l(m(b),{placeholder:"选择时间",styles:{root:{borderRadius:"20px",borderColor:"#722ed1"},input:{color:"#722ed1",fontWeight:500},suffix:{color:"#722ed1",fontSize:"18px"}}})]),e("div",null,[c[4]||(c[4]=e("div",{style:{"margin-bottom":"8px",color:"#666"}},"组合 classNames 与 styles：",-1)),l(m(b),{placeholder:"选择时间","need-confirm":!0,"class-names":{root:"gradient-trigger",popup:"gradient-popup",ok:"gradient-ok"},styles:{panel:{borderRadius:"12px"},cell:{fontWeight:500}}})])]))}}),Gn=Vn(Yn,[["__scopeId","data-v-8e2f9a88"]]),Jn=`<template>
...
`,Kn={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"300px"}},Zn=O({__name:"TimePickerConfirm",setup(n){const d=i(""),c=i("");return(p,t)=>(B(),M("div",Kn,[e("div",null,[t[2]||(t[2]=e("p",{style:{"margin-bottom":"4px"}},"需要确认（needConfirm）：",-1)),l(m(b),{value:d.value,"onUpdate:value":t[0]||(t[0]=a=>d.value=a),"need-confirm":!0,placeholder:"点击确定按钮生效"},null,8,["value"])]),e("div",null,[t[3]||(t[3]=e("p",{style:{"margin-bottom":"4px"}},"滚动即改变（changeOnScroll）：",-1)),l(m(b),{value:c.value,"onUpdate:value":t[1]||(t[1]=a=>c.value=a),"change-on-scroll":!0,"need-confirm":!1,placeholder:"选择即生效"},null,8,["value"])])]))}}),_n=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; max-width: 300px">
    <div>
...
const time2 = ref('')
<\/script>
`,nt={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"300px"}},tt=O({__name:"TimePickerDisabled",setup(n){const d=i(""),c=i(""),p=()=>({disabledHours:()=>[0,1,2,3,4,5]}),t=()=>({disabledHours:()=>[0,1,2,3,4,5]});return(a,o)=>(B(),M("div",nt,[e("div",null,[o[2]||(o[2]=e("p",{style:{"margin-bottom":"4px"}},"禁用部分小时：",-1)),l(m(b),{value:d.value,"onUpdate:value":o[0]||(o[0]=k=>d.value=k),"disabled-time":p,placeholder:"禁用 0-5 时"},null,8,["value"])]),e("div",null,[o[3]||(o[3]=e("p",{style:{"margin-bottom":"4px"}},"隐藏禁用选项：",-1)),l(m(b),{value:c.value,"onUpdate:value":o[1]||(o[1]=k=>c.value=k),"disabled-time":t,"hide-disabled-options":!0,placeholder:"隐藏 0-5 时"},null,8,["value"])])]))}}),et=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; max-width: 300px">
    <div>
...
<\/script>
`,at={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"300px"}},st=O({__name:"TimePickerFormat",setup(n){const d=i(""),c=i(""),p=i("");return(t,a)=>(B(),M("div",at,[e("div",null,[a[3]||(a[3]=e("p",{style:{"margin-bottom":"4px"}},"只显示时分（HH:mm）：",-1)),l(m(b),{value:d.value,"onUpdate:value":a[0]||(a[0]=o=>d.value=o),format:"HH:mm",placeholder:"选择时分"},null,8,["value"])]),e("div",null,[a[4]||(a[4]=e("p",{style:{"margin-bottom":"4px"}},"12 小时制：",-1)),l(m(b),{value:c.value,"onUpdate:value":a[1]||(a[1]=o=>c.value=o),"use12-hours":!0,format:"h:mm a",placeholder:"12 小时制"},null,8,["value"])]),e("div",null,[a[5]||(a[5]=e("p",{style:{"margin-bottom":"4px"}},"不显示秒：",-1)),l(m(b),{value:p.value,"onUpdate:value":a[2]||(a[2]=o=>p.value=o),format:"HH:mm","show-now":!1,placeholder:"不显示秒"},null,8,["value"])])]))}}),ot=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; max-width: 300px">
    <div>
...
const time3 = ref('')
<\/script>
`,lt={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"300px"}},pt=O({__name:"TimePickerStep",setup(n){const d=i(""),c=i(""),p=i("");return(t,a)=>(B(),M("div",lt,[e("div",null,[a[3]||(a[3]=e("p",{style:{"margin-bottom":"4px"}},"小时步长 2：",-1)),l(m(b),{value:d.value,"onUpdate:value":a[0]||(a[0]=o=>d.value=o),"hour-step":2,placeholder:"小时步长 2"},null,8,["value"])]),e("div",null,[a[4]||(a[4]=e("p",{style:{"margin-bottom":"4px"}},"分钟步长 15：",-1)),l(m(b),{value:c.value,"onUpdate:value":a[1]||(a[1]=o=>c.value=o),"minute-step":15,placeholder:"分钟步长 15"},null,8,["value"])]),e("div",null,[a[5]||(a[5]=e("p",{style:{"margin-bottom":"4px"}},"秒步长 30：",-1)),l(m(b),{value:p.value,"onUpdate:value":a[2]||(a[2]=o=>p.value=o),"second-step":30,placeholder:"秒步长 30"},null,8,["value"])])]))}}),dt=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; max-width: 300px">
    <div>
...
const time3 = ref('')
<\/script>
`,ct={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"300px"}},rt=O({__name:"TimePickerVariant",setup(n){const d=i(""),c=i(""),p=i(""),t=i("");return(a,o)=>(B(),M("div",ct,[e("div",null,[o[4]||(o[4]=e("p",{style:{"margin-bottom":"4px"}},"Outlined（默认）：",-1)),l(m(b),{value:d.value,"onUpdate:value":o[0]||(o[0]=k=>d.value=k),variant:"outlined",placeholder:"Outlined"},null,8,["value"])]),e("div",null,[o[5]||(o[5]=e("p",{style:{"margin-bottom":"4px"}},"Filled：",-1)),l(m(b),{value:c.value,"onUpdate:value":o[1]||(o[1]=k=>c.value=k),variant:"filled",placeholder:"Filled"},null,8,["value"])]),e("div",null,[o[6]||(o[6]=e("p",{style:{"margin-bottom":"4px"}},"Borderless：",-1)),l(m(b),{value:p.value,"onUpdate:value":o[2]||(o[2]=k=>p.value=k),variant:"borderless",placeholder:"Borderless"},null,8,["value"])]),e("div",null,[o[7]||(o[7]=e("p",{style:{"margin-bottom":"4px"}},"Underlined：",-1)),l(m(b),{value:t.value,"onUpdate:value":o[3]||(o[3]=k=>t.value=k),variant:"underlined",placeholder:"Underlined"},null,8,["value"])])]))}}),it=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; max-width: 300px">
    <div>
