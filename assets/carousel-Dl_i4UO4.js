import{B as pt}from"./Button-Bkc4rV1H.js";import{o as S,N as yt,E as P,x as xt,w as wt,Q as O,n as e,F as V,f as u,t as St,A as w,i as _,R as i,h as t,K as r,k as E,G as ut,J as gt,_ as Ct,H as Nt,m as f,l as qt}from"./index-DVYL9B-3.js";import{c as k}from"./cls-S9IiI6wd.js";import{L as At}from"./LeftOutlined-BzP5WWCG.js";import{R as $t}from"./RightOutlined-IpyCKwtb.js";import"./Icon-DOBD7t4S.js";import"./LoadingOutlined-Cfvvdn-g.js";const v=S({name:"Carousel",props:{autoplay:{type:[Boolean,Object],default:!1},autoplaySpeed:{type:Number,default:3e3},dots:{type:[Boolean,Object],default:!0},dotPosition:String,dotPlacement:String,effect:{type:String,default:"scrollx"},fade:Boolean,infinite:{type:Boolean,default:!0},speed:{type:Number,default:500},easing:{type:String,default:"ease"},initialSlide:{type:Number,default:0},arrows:{type:Boolean,default:!1},prevArrow:Object,nextArrow:Object,waitForAnimate:{type:Boolean,default:!1},adaptiveHeight:{type:Boolean,default:!1},rootClassName:String,classNames:Object,styles:Object},emits:["beforeChange","afterChange"],setup(n,{slots:g,emit:s,expose:h}){const a=yt("carousel"),l=P(n.initialSlide),b=P(!1),mt=P(),B=P(),R=P(void 0);let D=null,y=null;const L=u(()=>{var m;return(((m=g.default)==null?void 0:m.call(g))??[]).flatMap(d=>Array.isArray(d.children)?d.children:[d])}),c=u(()=>L.value.length),H=u(()=>{const o=n.dotPlacement??n.dotPosition??"bottom";return o==="left"?"start":o==="right"?"end":o}),j=u(()=>{const o=H.value;return o==="start"||o==="end"}),ft=u(()=>n.fade?"fade":n.effect),F=u(()=>ft.value==="fade"),kt=u(()=>!!n.dots),vt=u(()=>typeof n.dots=="object"&&n.dots.className?n.dots.className:""),ht=u(()=>!!n.autoplay),z=u(()=>!!(typeof n.autoplay=="object"&&n.autoplay.dotDuration));function T(){if(!n.adaptiveHeight||j.value||!B.value){R.value=void 0;return}St(()=>{if(!B.value)return;const m=B.value.querySelectorAll(`.${a}-slide`)[l.value];m&&(R.value=m.offsetHeight)})}function C(o,m=!1){if(c.value===0||!m&&n.waitForAnimate&&b.value)return;let d=o;n.infinite?d=(o%c.value+c.value)%c.value:d=Math.max(0,Math.min(o,c.value-1)),d!==l.value&&(s("beforeChange",l.value,d),m?(l.value=d,s("afterChange",d)):(y&&(clearTimeout(y),y=null),b.value=!0,l.value=d,y=setTimeout(()=>{b.value=!1,s("afterChange",d),y=null},n.speed)))}const M=()=>C(l.value-1),I=()=>C(l.value+1);function G(){!ht.value||c.value<=1||(D=setInterval(()=>C(l.value+1),n.autoplaySpeed))}function Y(){D&&(clearInterval(D),D=null),y&&(clearTimeout(y),y=null)}xt(()=>{if(c.value>0&&n.initialSlide>0){const o=n.infinite?n.initialSlide%c.value:Math.min(n.initialSlide,c.value-1);l.value=o}T(),G()}),wt(Y),O(()=>n.autoplay,o=>{o?G():Y()}),O(l,()=>{T()}),O(()=>n.adaptiveHeight,()=>{T()}),h({goTo:C,next:I,prev:M});const bt=u(()=>{const o=H.value;return o==="start"?"left":o==="end"?"right":o});return()=>{var d,J,K,Q,U,X,W,Z,tt,nt,at,st,et,ot,lt,dt,it,rt;if(c.value===0)return e("div",{class:k(a,n.rootClassName,(d=n.classNames)==null?void 0:d.root),style:(J=n.styles)==null?void 0:J.root},null);const o=`${n.speed/1e3}s`,m=z.value?{"--carousel-dot-duration":`${n.autoplaySpeed}ms`}:{};return e("div",{class:k(a,n.rootClassName,(K=n.classNames)==null?void 0:K.root,{[`${a}-vertical`]:j.value,[`${a}-fade`]:F.value}),style:{...m,...(Q=n.styles)==null?void 0:Q.root},role:"region","aria-roledescription":"carousel","aria-label":"Carousel"},[e("div",{ref:mt,class:k(`${a}-list`,(U=n.classNames)==null?void 0:U.list),style:{...n.adaptiveHeight&&R.value!==void 0?{height:`${R.value}px`,transition:b.value?`height ${o} ${n.easing}`:"none"}:{},...(X=n.styles)==null?void 0:X.list}},[e("div",{ref:B,class:k(`${a}-track`,(W=n.classNames)==null?void 0:W.track),style:{...F.value?{}:{transform:j.value?`translateY(-${l.value*100}%)`:`translateX(-${l.value*100}%)`,transition:b.value?`transform ${o} ${n.easing}`:"none"},...(Z=n.styles)==null?void 0:Z.track}},[L.value.map((ct,x)=>{var N,q,A,$;const p=x===l.value;return e("div",{key:x,class:k(`${a}-slide`,(N=n.classNames)==null?void 0:N.slide,{[`${a}-slide-active`]:p},p&&((q=n.classNames)==null?void 0:q.slideActive)),style:{...F.value?{opacity:p?1:0,transform:"translate3d(0, 0, 0)",transition:`opacity ${o} ${n.easing}`,position:p?"relative":"absolute",inset:p?"auto":"0",contentVisibility:"auto"}:{contentVisibility:"auto"},...(A=n.styles)==null?void 0:A.slide,...p&&(($=n.styles)==null?void 0:$.slideActive)},role:"group","aria-roledescription":"slide","aria-label":`${x+1} / ${c.value}`,"aria-hidden":!p},[ct])})])]),n.arrows&&c.value>1&&e(V,null,[n.prevArrow??e(pt,{class:k(`${a}-arrow`,`${a}-arrow-left`,(tt=n.classNames)==null?void 0:tt.arrow,(nt=n.classNames)==null?void 0:nt.arrowLeft),style:{...(at=n.styles)==null?void 0:at.arrow,...(st=n.styles)==null?void 0:st.arrowLeft},type:"text",icon:At,onClick:M,disabled:n.waitForAnimate&&b.value,"aria-label":"Previous slide"},null),n.nextArrow??e(pt,{class:k(`${a}-arrow`,`${a}-arrow-right`,(et=n.classNames)==null?void 0:et.arrow,(ot=n.classNames)==null?void 0:ot.arrowRight),style:{...(lt=n.styles)==null?void 0:lt.arrow,...(dt=n.styles)==null?void 0:dt.arrowRight},type:"text",icon:$t,onClick:I,disabled:n.waitForAnimate&&b.value,"aria-label":"Next slide"},null)]),kt.value&&c.value>1&&e("ul",{class:k(`${a}-dots`,`${a}-dots-${bt.value}`,vt.value,(it=n.classNames)==null?void 0:it.dots,{[`${a}-dots-progress`]:z.value,[`${a}-dots-disabled`]:n.waitForAnimate&&b.value}),style:(rt=n.styles)==null?void 0:rt.dots},[L.value.map((ct,x)=>{var N,q,A,$;const p=x===l.value;return e("li",{key:x,class:k((N=n.classNames)==null?void 0:N.dot,{[`${a}-dot-active`]:p},p&&((q=n.classNames)==null?void 0:q.dotActive)),style:{...(A=n.styles)==null?void 0:A.dot,...p&&(($=n.styles)==null?void 0:$.dotActive)},onClick:()=>C(x)},[e("button",{"aria-label":`Go to slide ${x+1}`},null)])})])])}}}),Pt=S({__name:"CarouselArrows",setup(n){return(g,s)=>(w(),_(r(v),{arrows:""},{default:i(()=>[...s[0]||(s[0]=[t("div",{class:"carousel-item",style:{background:"#364d79",color:"#fff",height:"160px","line-height":"160px","text-align":"center"}}," Slide 1 ",-1),t("div",{class:"carousel-item",style:{background:"#7dbcea",color:"#fff",height:"160px","line-height":"160px","text-align":"center"}}," Slide 2 ",-1),t("div",{class:"carousel-item",style:{background:"#00a0e9",color:"#fff",height:"160px","line-height":"160px","text-align":"center"}}," Slide 3 ",-1),t("div",{class:"carousel-item",style:{background:"#1890ff",color:"#fff",height:"160px","line-height":"160px","text-align":"center"}}," Slide 4 ",-1)])]),_:1}))}}),Bt=`<template>
  <Carousel arrows>
    <div
      class="carousel-item"
...
<\/script>
`,Rt=S({__name:"CarouselBasic",setup(n){return(g,s)=>(w(),_(r(v),{style:{height:"160px",background:"#364d79","border-radius":"4px",overflow:"hidden"}},{default:i(()=>[(w(),E(V,null,ut(4,h=>t("div",{key:h,style:{height:"160px",display:"flex","align-items":"center","justify-content":"center",color:"#fff","font-size":"24px"}},gt(h),1)),64))]),_:1}))}}),Dt=`<template>
