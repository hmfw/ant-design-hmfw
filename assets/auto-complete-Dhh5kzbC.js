import{o as S,N as G,E as u,Q as M,n as a,f as A,F as nt,A as q,k as O,K as m,h as i,R as C,_ as at,H as ot,l as K,m as $}from"./index-Y1x_vdlx.js";import{c as w}from"./cls-S9IiI6wd.js";import{T as st}from"./Trigger-CjdG1XR4.js";import{S as H}from"./SearchOutlined-WwwAUpHr.js";const lt=t=>t==="large"?"lg":t==="small"?"sm":"",h=S({name:"AutoComplete",inheritAttrs:!1,props:{value:String,defaultValue:{type:String,default:""},options:{type:Array,default:()=>[]},disabled:Boolean,placeholder:String,allowClear:{type:[Boolean,Object],default:!1},size:{type:String,default:"middle"},status:{type:String,default:""},filterOption:{type:[Boolean,Function],default:!0},backfill:Boolean,defaultActiveFirstOption:{type:Boolean,default:!0},notFoundContent:String,defaultOpen:Boolean,open:{type:Boolean,default:void 0},classNames:{type:Object},styles:{type:Object}},emits:["update:value","change","select","search","focus","blur","clear","openChange"],setup(t,{slots:r,emit:p,attrs:f,expose:n}){const l=G("auto-complete"),o=G("input"),g=u(t.value??t.defaultValue??""),y=u(t.defaultOpen??!1),v=u(-1),x=u(),b=A(()=>t.value!==void 0),s=A(()=>b.value?t.value:g.value),k=A(()=>t.open!==void 0?t.open:y.value);M(()=>t.value,e=>{e!==void 0&&(g.value=e)});const V=A(()=>{const e=s.value;return!e||t.filterOption===!1?t.options:typeof t.filterOption=="function"?t.options.filter(d=>t.filterOption(e,d)):t.options.filter(d=>d.value.toLowerCase().includes(e.toLowerCase())||(d.label??d.value).toLowerCase().includes(e.toLowerCase()))}),F=A(()=>V.value.length>0||!!t.notFoundContent),U=A(()=>V.value.findIndex(e=>!e.disabled)),X=()=>{v.value=t.defaultActiveFirstOption?U.value:-1};M(()=>V.value,e=>{k.value&&(v.value>=e.length&&(v.value=e.length-1),v.value<0&&t.defaultActiveFirstOption&&(v.value=U.value))});const N=e=>{y.value!==e&&(y.value=e,p("openChange",e))},B=e=>{g.value=e,p("update:value",e),p("change",e)},D=e=>{e.disabled||(B(e.value),p("select",e.value,e),N(!1))},Y=e=>{const d=e.target.value;B(d),p("search",d),!k.value&&F.value&&N(!0)},Q=e=>{var d;e.stopPropagation(),B(""),p("clear"),(d=x.value)==null||d.focus()},Z=e=>{if(!k.value){(e.key==="ArrowDown"||e.key==="ArrowUp")&&(e.preventDefault(),F.value&&N(!0));return}const d=V.value;if(e.key==="ArrowDown"){e.preventDefault();let c=v.value+1;for(;c<d.length&&d[c].disabled;)c++;c<d.length&&(v.value=c,t.backfill&&B(d[c].value))}else if(e.key==="ArrowUp"){e.preventDefault();let c=v.value-1;for(;c>=0&&d[c].disabled;)c--;c>=0&&(v.value=c,t.backfill&&B(d[c].value))}else e.key==="Enter"?(e.preventDefault(),v.value>=0&&v.value<d.length&&D(d[v.value])):e.key==="Escape"&&N(!1)};n({focus:()=>{var e;return(e=x.value)==null?void 0:e.focus()},blur:()=>{var e;return(e=x.value)==null?void 0:e.blur()}});const tt=()=>typeof t.allowClear=="object"&&t.allowClear.clearIcon?t.allowClear.clearIcon:"✕",L=A(()=>lt(t.size)),et=()=>{var e,d;return a(nt,null,[V.value.length>0?V.value.map((c,R)=>{var z,E;return a("div",{key:c.value,class:w(`${l}-dropdown-item`,{[`${l}-dropdown-item-active`]:v.value===R,[`${l}-dropdown-item-disabled`]:c.disabled,[`${l}-dropdown-item-selected`]:c.value===s.value},(z=t.classNames)==null?void 0:z.option),style:(E=t.styles)==null?void 0:E.option,onMouseenter:()=>{c.disabled||(v.value=R)},onMousedown:_=>{_.preventDefault(),D(c)}},[c.label??c.value])}):a("div",{class:w(`${l}-dropdown-empty`,(e=t.classNames)==null?void 0:e.empty),style:(d=t.styles)==null?void 0:d.empty},[t.notFoundContent])])};return()=>{var e,d;return a(st,{open:k.value&&F.value,trigger:"click",placement:"bottomLeft",disabled:t.disabled,destroyOnHidden:!0,matchWidth:!0,popupClass:w(`${l}-dropdown`,(e=t.classNames)==null?void 0:e.dropdown),popupStyle:(d=t.styles)==null?void 0:d.dropdown,closeOnOutsideClick:!1,closeOnEscape:!1,onOpenChange:c=>N(c)},{default:()=>{var c,R,z,E,_,T,I,J,W,j;return a("div",{class:w(l,`${o}-affix-wrapper`,L.value&&`${o}-affix-wrapper-${L.value}`,{[`${o}-affix-wrapper-disabled`]:t.disabled,[`${o}-affix-wrapper-status-error`]:t.status==="error",[`${o}-affix-wrapper-status-warning`]:t.status==="warning",[`${o}-affix-wrapper-focused`]:k.value},(c=t.classNames)==null?void 0:c.root),style:{...f.style,...(R=t.styles)==null?void 0:R.root}},[r.prefix&&a("span",{class:w(`${o}-prefix`,(z=t.classNames)==null?void 0:z.prefix),style:(E=t.styles)==null?void 0:E.prefix},[r.prefix()]),a("input",{ref:x,class:w(o,L.value&&`${o}-${L.value}`,(_=t.classNames)==null?void 0:_.input),style:(T=t.styles)==null?void 0:T.input,value:s.value,disabled:t.disabled,placeholder:t.placeholder,onInput:Y,onFocus:P=>{F.value&&N(!0),X(),p("focus",P)},onBlur:P=>p("blur",P),onKeydown:Z,autocomplete:"off"},null),!!t.allowClear&&s.value&&!t.disabled&&a("span",{class:w(`${o}-clear-icon`,(I=t.classNames)==null?void 0:I.clear),style:(J=t.styles)==null?void 0:J.clear,onMousedown:Q},[tt()]),r.suffix&&a("span",{class:w(`${o}-suffix`,(W=t.classNames)==null?void 0:W.suffix),style:(j=t.styles)==null?void 0:j.suffix},[r.suffix()])])},popup:et})}}}),pt={style:{display:"flex","flex-direction":"column",gap:"16px",width:"300px"}},ut=S({__name:"AutoCompleteAdvanced",setup(t){const r=u(""),p=u(""),f=u("Vue"),n=u(""),l=u([{value:"Vue"},{value:"React"},{value:"Angular"}]),o=u([{value:"TypeScript"},{value:"JavaScript"},{value:"Python"}]),g=u([{value:"Vue"},{value:"React"},{value:"Angular"}]),y=u([{value:"Vue"},{value:"React"},{value:"Angular"}]),v=x=>{const b=["Vue","React","Angular"];y.value=b.filter(s=>s.toLowerCase().includes(x.toLowerCase())).map(s=>({value:s}))};return(x,b)=>(q(),O("div",pt,[a(m(h),{value:r.value,"onUpdate:value":b[0]||(b[0]=s=>r.value=s),options:l.value,placeholder:"默认高亮第一项","default-active-first-option":!0},null,8,["value","options"]),a(m(h),{value:p.value,"onUpdate:value":b[1]||(b[1]=s=>p.value=s),options:o.value,placeholder:"不高亮第一项","default-active-first-option":!1},null,8,["value","options"]),a(m(h),{value:f.value,"onUpdate:value":b[2]||(b[2]=s=>f.value=s),options:g.value,placeholder:"自定义清除图标","allow-clear":{clearIcon:"🗑️"}},null,8,["value","options"]),a(m(h),{value:n.value,"onUpdate:value":b[3]||(b[3]=s=>n.value=s),options:y.value,placeholder:"无匹配时显示提示","not-found-content":"无匹配结果",onSearch:v},null,8,["value","options"])]))}}),dt=`<template>
...
<\/script>
`,mt={style:{display:"flex","flex-direction":"column",gap:"24px"}},vt=S({__name:"AutoCompleteClassNames",setup(t){const r=u(""),p=u(""),f=u(""),n=u(""),l=u(""),o=[{value:"Vue 3"},{value:"React"},{value:"Angular"},{value:"Svelte"}],g=[{value:"Beijing"},{value:"Shanghai"},{value:"Guangzhou"},{value:"Shenzhen"}],y=[{value:"🍎 Apple",label:"🍎 Apple"},{value:"🍌 Banana",label:"🍌 Banana"},{value:"🍊 Orange",label:"🍊 Orange"},{value:"🍇 Grape",label:"🍇 Grape"}],v=[{value:"Option 1"},{value:"Option 2"},{value:"Option 3"}],x=[{value:"Design System"},{value:"Component Library"},{value:"UI Framework"}];return(b,s)=>(q(),O("div",mt,[i("div",null,[s[5]||(s[5]=i("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义输入框容器样式：",-1)),a(m(h),{modelValue:r.value,"onUpdate:modelValue":s[0]||(s[0]=k=>r.value=k),options:o,placeholder:"输入内容搜索...","class-names":{root:"custom-root"}},null,8,["modelValue"])]),i("div",null,[s[6]||(s[6]=i("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义前后缀与清除按钮：",-1)),a(m(h),{modelValue:p.value,"onUpdate:modelValue":s[1]||(s[1]=k=>p.value=k),options:g,placeholder:"搜索...","allow-clear":"","class-names":{prefix:"custom-prefix",suffix:"custom-suffix",clear:"custom-clear"}},{prefix:C(()=>[a(m(H))]),_:1},8,["modelValue"])]),i("div",null,[s[7]||(s[7]=i("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义下拉面板与选项：",-1)),a(m(h),{modelValue:f.value,"onUpdate:modelValue":s[2]||(s[2]=k=>f.value=k),options:y,placeholder:"选择水果...","class-names":{dropdown:"custom-dropdown",option:"custom-option"}},null,8,["modelValue"])]),i("div",null,[s[8]||(s[8]=i("div",{style:{"margin-bottom":"8px",color:"#666"}},"使用内联样式：",-1)),a(m(h),{modelValue:n.value,"onUpdate:modelValue":s[3]||(s[3]=k=>n.value=k),options:v,placeholder:"动态样式...","allow-clear":"",styles:{root:{borderRadius:"20px",borderColor:"#722ed1"},input:{color:"#722ed1",fontWeight:"bold"},clear:{color:"#eb2f96"}}},null,8,["modelValue"])]),i("div",null,[s[9]||(s[9]=i("div",{style:{"margin-bottom":"8px",color:"#666"}},"组合使用 classNames 和 styles：",-1)),a(m(h),{modelValue:l.value,"onUpdate:modelValue":s[4]||(s[4]=k=>l.value=k),options:x,placeholder:"组合样式定制...","allow-clear":"","class-names":{root:"custom-combined-root",dropdown:"custom-combined-dropdown"},styles:{input:{fontSize:"16px"}}},{prefix:C(()=>[a(m(H))]),_:1},8,["modelValue"])])]))}}),ft=at(vt,[["__scopeId","data-v-f83b4bae"]]),gt=`<template>
