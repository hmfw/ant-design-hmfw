...
<\/script>
`,Mt=S({__name:"ImageToolbarRender",setup(t){function a(l,o){return e("div",{style:"display:flex;flex-direction:column;align-items:center;gap:8px"},[l,e("div",{style:"display:flex;gap:12px;color:#fff;font-size:13px;align-items:center"},[e("span",null,[F("缩放 "),Math.round(o.transform.scale*100),F("%")]),e(Tt,{onClick:o.actions.onReset,style:"padding:2px 10px;border:none;border-radius:4px;background:rgba(255,255,255,.2);color:#fff;cursor:pointer"},{default:()=>[F("重置")]})])])}function r(l,o){return e("div",{style:"padding:8px;border-radius:8px;background:rgba(255,255,255,.08)"},[l])}return(l,o)=>(U(),W(p(w),{src:"https://gw.alipayobjects.com/zos/antfincdn/LlvErxo8H9/photo-1503185912284-5271ff81b9a8.webp",width:"200",preview:{toolbarRender:a,imageRender:r}},null,8,["preview"]))}}),Yt=`<template>
  <Image
    src="https://gw.alipayobjects.com/zos/antfincdn/LlvErxo8H9/photo-1503185912284-5271ff81b9a8.webp"
    width="200"
