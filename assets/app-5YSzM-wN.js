import{B as c}from"./Button-D7tvIoj2.js";import{S as w}from"./Space-ChZCQvS5.js";import{n as f}from"./notification-_IHHwkCZ.js";import{m as h}from"./message-QUOQIXhk.js";import{j as M,d as r,c as d,s as _,F as y,t as C,p as E,o as A,q as B,w as g,e as l,v as i,h as x,b as P,i as m}from"./index-cgVI-orz.js";import{M as N}from"./index-B1rk1DaO.js";import"./cls-S9IiI6wd.js";import"./LoadingOutlined-BnULcwLn.js";import"./CloseOutlined-H_Tga8k8.js";import"./CheckCircleFilled-Cy0cWKQ1.js";import"./CloseCircleFilled-D94YfbHC.js";import"./ExclamationCircleFilled-C4rqH2Gp.js";import"./InfoCircleFilled-DaeLJ-gY.js";import"./index-BWIXzF4x.js";const p=()=>{},S={confirm:p,info:p,success:p,warning:p,error:p},k=Symbol("App"),v={message:h,notification:f,modal:S};function I(){return M(k,v)}const T=r({name:"App",setup(u,{slots:e}){const o=C({open:!1,type:"info",props:{}});function n(t,s){o.type=t,o.props=s,o.open=!0}return E(k,{message:h,notification:f,modal:{confirm:t=>n("confirm",t),info:t=>n("info",t),success:t=>n("success",t),warning:t=>n("warning",t),error:t=>n("error",t)}}),()=>{var t;return d(y,null,[(t=e.default)==null?void 0:t.call(e),d(N,_({open:o.open},o.props,{"onUpdate:open":s=>{o.open=s},onCancel:()=>{o.open=!1}}),null)])}}}),F=r({__name:"AppBasic",setup(u){const e=r({setup(){const{message:o,notification:n,modal:a}=I();function t(){o.success("操作成功！")}function s(){n.info({message:"系统通知",description:"这是通过 useApp() 触发的通知。"})}function b(){a.info({title:"提示",content:"这是通过 useApp() 触发的对话框。"})}return()=>i(w,null,{default:()=>[i(c,{type:"primary",onClick:t},{default:()=>"Message"}),i(c,{onClick:s},{default:()=>"Notification"}),i(c,{onClick:b},{default:()=>"Modal"})]})}});return(o,n)=>(A(),B(l(T),null,{default:g(()=>[d(l(e))]),_:1}))}}),j=`<template>
  <App>
    <AppActions />
  </App>
</template>
