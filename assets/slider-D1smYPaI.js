import{d as M,u as ft,m as bt,c as d,r as b,a as it,o as E,b as V,f as e,A as w,e as p,_ as xt,h as ht,i as ut,w as P,g as h}from"./index-DZWA4HiS.js";import{c as $}from"./cls-S9IiI6wd.js";import{K as B}from"./event-CMqgYmge.js";const v=M({name:"Slider",props:{value:[Number,Array],defaultValue:[Number,Array],min:{type:Number,default:0},max:{type:Number,default:100},step:{type:Number,default:1},disabled:Boolean,range:Boolean,vertical:Boolean,reverse:Boolean,marks:Object,tooltip:{type:Object},included:{type:Boolean,default:!0},dots:Boolean,keyboard:{type:Boolean,default:!0},classNames:Object,styles:Object},emits:["update:value","change","afterChange"],setup(t,{emit:i}){const a=ft("slider"),g=b(null),n=b(null),o=b(null),x=s=>Math.min(t.max,Math.max(t.min,s)),U=s=>{if(t.range){const l=Array.isArray(s)?s:[t.min,t.min],[r,c]=l,m=x(r),k=x(c);return[Math.min(m,k),Math.max(m,k)]}return x(typeof s=="number"?s:t.min)},ct=U(t.defaultValue??t.value??(t.range?[0,0]:0)),O=b(ct),pt=it(()=>t.value!==void 0),q=it(()=>{const s=pt.value?t.value:O.value;return U(s)});bt(()=>t.value,s=>{s!==void 0&&(O.value=U(s))});const mt=()=>t.marks?Object.keys(t.marks).map(Number).sort((s,l)=>s-l):[],L=s=>{if(t.step===null){const r=mt();return[t.min,...r,t.max].reduce((k,y)=>Math.abs(y-s)<Math.abs(k-s)?y:k)}const l=Math.round((s-t.min)/t.step);return x(t.min+l*t.step)},D=s=>(s-t.min)/(t.max-t.min)*100,W=s=>{if(!g.value)return 0;const l=g.value.getBoundingClientRect(),r="touches"in s?s.touches[0].clientX:s.clientX,c="touches"in s?s.touches[0].clientY:s.clientY;let m;return t.vertical?m=t.reverse?(c-l.top)/l.height:1-(c-l.top)/l.height:m=t.reverse?1-(r-l.left)/l.width:(r-l.left)/l.width,m=Math.max(0,Math.min(1,m)),L(t.min+m*(t.max-t.min))},S=s=>{const l=U(s);O.value=l,i("update:value",l),i("change",l)},vt=s=>{if(t.disabled)return;const l=W(s);if(t.range){const[r,c]=q.value,m=Math.abs(l-r),k=Math.abs(l-c);m<=k?S([l,c]):S([r,l])}else S(l)},A=s=>l=>{if(t.disabled)return;l.preventDefault(),n.value=s,o.value=s;const r=m=>{const k=W(m);if(t.range){const[y,T]=q.value;S(s==="start"?[Math.min(k,T),T]:[y,Math.max(k,y)])}else S(k)},c=()=>{n.value=null,o.value=null,i("afterChange",q.value),document.removeEventListener("mousemove",r),document.removeEventListener("mouseup",c),document.removeEventListener("touchmove",r),document.removeEventListener("touchend",c)};document.addEventListener("mousemove",r),document.addEventListener("mouseup",c),document.addEventListener("touchmove",r),document.addEventListener("touchend",c)},R=s=>{var l,r;return((l=t.tooltip)==null?void 0:l.formatter)===null?null:(r=t.tooltip)!=null&&r.formatter?t.tooltip.formatter(s):String(s)},j=s=>{var l;return((l=t.tooltip)==null?void 0:l.open)!==void 0?t.tooltip.open:o.value===s},z=s=>l=>{if(t.disabled||!t.keyboard)return;const r=t.range?s==="start"?q.value[0]:q.value[1]:q.value;let c=0;const m=t.step===null?1:t.step;switch(l.key){case B.ARROW_RIGHT:case B.ARROW_UP:c=m;break;case B.ARROW_LEFT:case B.ARROW_DOWN:c=-m;break;case B.HOME:c=t.min-r;break;case B.END:c=t.max-r;break;default:return}l.preventDefault();const k=L(r+c);if(t.range){const[y,T]=q.value;S(s==="start"?[Math.min(k,T),T]:[y,Math.max(k,y)])}else S(k)};return()=>{var F,K,Y,H,I,X,G,J,Q,Z,tt,nt,et,at,st,lt;const s=q.value,l=t.range?s[0]:s,r=t.range?s[1]:s,c=D(l),m=D(r),k=t.vertical?t.included?{bottom:`${t.range?c:0}%`,height:`${t.range?m-c:m}%`}:{}:t.included?{left:`${t.range?c:0}%`,width:`${t.range?m-c:m}%`}:{},y=t.marks?Object.entries(t.marks).map(([u,f])=>({value:Number(u),label:typeof f=="string"?f:f.label,style:typeof f=="object"&&f.style?f.style:void 0})):[],T=[];if(t.dots&&t.step!==null&&t.step>0)for(let u=t.min;u<=t.max;u+=t.step)T.push(u);const gt=u=>{if(!t.disabled)if(t.range){const[f,N]=q.value,C=Math.abs(u-f),_=Math.abs(u-N);C<=_?S([u,N]):S([f,u])}else S(u)};return d("div",{class:$(a,{[`${a}-disabled`]:t.disabled,[`${a}-vertical`]:t.vertical,[`${a}-with-marks`]:y.length>0},(F=t.classNames)==null?void 0:F.root),style:(K=t.styles)==null?void 0:K.root},[d("div",{ref:g,class:$(`${a}-rail`,(Y=t.classNames)==null?void 0:Y.rail),style:(H=t.styles)==null?void 0:H.rail,onClick:vt},[d("div",{class:$(`${a}-track`,(I=t.classNames)==null?void 0:I.track),style:{...k,...(X=t.styles)==null?void 0:X.track}},null),y.map(({value:u})=>{var C,_;const f=D(u),N=t.vertical?{bottom:`${f}%`}:{left:`${f}%`};return d("span",{key:u,class:$(`${a}-dot`,{[`${a}-dot-active`]:t.range?u>=l&&u<=r:u<=r},(C=t.classNames)==null?void 0:C.dot),style:{...N,...(_=t.styles)==null?void 0:_.dot}},null)}),T.map(u=>{var C,_;const f=D(u),N=t.vertical?{bottom:`${f}%`}:{left:`${f}%`};return d("span",{key:u,class:$(`${a}-dot`,{[`${a}-dot-active`]:t.range?u>=l&&u<=r:u<=r},(C=t.classNames)==null?void 0:C.dot),style:{...N,...(_=t.styles)==null?void 0:_.dot}},null)}),t.range&&d("div",{class:$(`${a}-handle`,`${a}-handle-1`,{[`${a}-handle-dragging`]:n.value==="start"},(G=t.classNames)==null?void 0:G.handle),style:{...t.vertical?{bottom:`${c}%`}:{left:`${c}%`},...(J=t.styles)==null?void 0:J.handle},role:"slider","aria-label":"最小值","aria-orientation":t.vertical?"vertical":"horizontal","aria-valuemin":t.min,"aria-valuemax":r,"aria-valuenow":l,"aria-disabled":t.disabled,tabindex:t.disabled?-1:0,onMousedown:A("start"),onTouchstart:A("start"),onMouseenter:()=>{o.value="start"},onMouseleave:()=>{n.value!=="start"&&(o.value=null)},onKeydown:z("start")},[j("start")&&R(l)!==null&&d("div",{class:$(`${a}-tooltip`,(Q=t.classNames)==null?void 0:Q.tooltip),style:(Z=t.styles)==null?void 0:Z.tooltip},[R(l)])]),d("div",{class:$(`${a}-handle`,t.range?`${a}-handle-2`:"",{[`${a}-handle-dragging`]:n.value==="end"||!t.range&&n.value!==null},(tt=t.classNames)==null?void 0:tt.handle),style:{...t.vertical?{bottom:`${m}%`}:{left:`${m}%`},...(nt=t.styles)==null?void 0:nt.handle},role:"slider","aria-label":t.range?"最大值":"滑块","aria-orientation":t.vertical?"vertical":"horizontal","aria-valuemin":t.range?l:t.min,"aria-valuemax":t.max,"aria-valuenow":r,"aria-disabled":t.disabled,tabindex:t.disabled?-1:0,onMousedown:A((t.range,"end")),onTouchstart:A((t.range,"end")),onMouseenter:()=>{o.value="end"},onMouseleave:()=>{n.value!=="end"&&(o.value=null)},onKeydown:z(t.range?"end":"start")},[j("end")&&R(r)!==null&&d("div",{class:$(`${a}-tooltip`,(et=t.classNames)==null?void 0:et.tooltip),style:(at=t.styles)==null?void 0:at.tooltip},[R(r)])])]),y.length>0&&d("div",{class:$(`${a}-mark`,(st=t.classNames)==null?void 0:st.mark),style:(lt=t.styles)==null?void 0:lt.mark},[y.map(({value:u,label:f,style:N})=>{var dt,rt;const C=D(u),_=t.vertical?{bottom:`${C}%`}:{left:`${C}%`},ot=N?{..._,...N}:_,kt=(dt=t.styles)!=null&&dt.markText?{...ot,...t.styles.markText}:ot;return d("span",{key:u,class:$(`${a}-mark-text`,{[`${a}-mark-text-active`]:t.range?u>=l&&u<=r:u<=r},(rt=t.classNames)==null?void 0:rt.markText),style:kt,onClick:()=>gt(u)},[f])})])])}}}),yt={style:{display:"flex","flex-direction":"column",gap:"24px",padding:"0 16px"}},St={style:{"margin-bottom":"8px"}},wt=M({__name:"SliderBasic",setup(t){const i=b(30),a=b(50);return(g,n)=>(E(),V("div",yt,[e("div",null,[e("p",St,"基础滑块："+w(i.value),1),d(p(v),{value:i.value,"onUpdate:value":n[0]||(n[0]=o=>i.value=o)},null,8,["value"])]),e("div",null,[n[2]||(n[2]=e("p",{style:{"margin-bottom":"8px"}},"禁用状态：",-1)),d(p(v),{value:a.value,"onUpdate:value":n[1]||(n[1]=o=>a.value=o),disabled:""},null,8,["value"])])]))}}),$t=`<template>
...
`,Tt={style:{display:"flex","flex-direction":"column",gap:"24px",padding:"0 16px"}},Mt={style:{"margin-bottom":"8px"}},Et={style:{"margin-bottom":"8px"}},Vt=M({__name:"SliderDots",setup(t){const i=b(30),a=b([20,60]);return(g,n)=>(E(),V("div",Tt,[e("div",null,[e("p",Mt,"带刻度点："+w(i.value),1),d(p(v),{value:i.value,"onUpdate:value":n[0]||(n[0]=o=>i.value=o),dots:!0,step:10},null,8,["value"])]),e("div",null,[e("p",Et,"范围选择 + 刻度点："+w(a.value),1),d(p(v),{value:a.value,"onUpdate:value":n[1]||(n[1]=o=>a.value=o),range:"",dots:!0,step:20},null,8,["value"])])]))}}),Pt=`<template>
  <div style="display: flex; flex-direction: column; gap: 24px; padding: 0 16px">
    <div>
...
<\/script>
`,Bt={style:{display:"flex","flex-direction":"column",gap:"40px",padding:"0 16px"}},Dt={style:{"margin-bottom":"8px"}},Ut={style:{"margin-bottom":"8px"}},At=M({__name:"SliderMarks",setup(t){const i=b(37),a=b(0),g={0:"0°C",26:"26°C",37:"37°C",100:{label:"100°C",style:{color:"#f50"}}};return(n,o)=>(E(),V("div",Bt,[e("div",null,[e("p",Dt,"带刻度标记："+w(i.value),1),d(p(v),{value:i.value,"onUpdate:value":o[0]||(o[0]=x=>i.value=x),marks:g},null,8,["value"])]),e("div",null,[e("p",Ut,"只能选择刻度点："+w(a.value),1),d(p(v),{value:a.value,"onUpdate:value":o[1]||(o[1]=x=>a.value=x),marks:g,step:null},null,8,["value"])])]))}}),Rt=`<template>
...
<\/script>
`,Ot={style:{display:"flex","flex-direction":"column",gap:"24px",padding:"0 16px"}},Lt={style:{"margin-bottom":"8px"}},Wt={style:{"margin-bottom":"8px"}},jt=M({__name:"SliderRange",setup(t){const i=b([20,70]),a=b([20,60]);return(g,n)=>(E(),V("div",Ot,[e("div",null,[e("p",Lt,"范围选择："+w(i.value),1),d(p(v),{value:i.value,"onUpdate:value":n[0]||(n[0]=o=>i.value=o),range:""},null,8,["value"])]),e("div",null,[e("p",Wt,"带步长的范围选择："+w(a.value),1),d(p(v),{value:a.value,"onUpdate:value":n[1]||(n[1]=o=>a.value=o),range:"",step:10},null,8,["value"])])]))}}),zt=`<template>
  <div style="display: flex; flex-direction: column; gap: 24px; padding: 0 16px">
    <div>
...
<\/script>
`,Ft={style:{display:"flex","flex-direction":"column",gap:"24px",padding:"0 16px"}},Kt={style:{"margin-bottom":"8px"}},Yt={style:{"margin-bottom":"8px"}},Ht={style:{"margin-bottom":"8px"}},It=M({__name:"SliderTooltip",setup(t){const i=b(30),a=b(50),g=b(70);return(n,o)=>(E(),V("div",Ft,[e("div",null,[e("p",Kt,"自定义 Tooltip 格式："+w(i.value),1),d(p(v),{value:i.value,"onUpdate:value":o[0]||(o[0]=x=>i.value=x),tooltip:{formatter:x=>`${x}%`}},null,8,["value","tooltip"])]),e("div",null,[e("p",Yt,"隐藏 Tooltip："+w(a.value),1),d(p(v),{value:a.value,"onUpdate:value":o[1]||(o[1]=x=>a.value=x),tooltip:{formatter:null}},null,8,["value"])]),e("div",null,[e("p",Ht,"始终显示 Tooltip："+w(g.value),1),d(p(v),{value:g.value,"onUpdate:value":o[2]||(o[2]=x=>g.value=x),tooltip:{open:!0}},null,8,["value"])])]))}}),Xt=`<template>
  <div style="display: flex; flex-direction: column; gap: 24px; padding: 0 16px">
    <div>
...
const value3 = ref(70)
<\/script>
`,Gt={style:{display:"flex",gap:"48px",padding:"0 16px"}},Jt={style:{height:"300px"}},Qt={style:{"margin-bottom":"8px"}},Zt={style:{height:"300px"}},tn={style:{"margin-bottom":"8px"}},nn=M({__name:"SliderVertical",setup(t){const i=b(30),a=b([20,50]);return(g,n)=>(E(),V("div",Gt,[e("div",Jt,[e("p",Qt,"垂直滑块："+w(i.value),1),d(p(v),{value:i.value,"onUpdate:value":n[0]||(n[0]=o=>i.value=o),vertical:""},null,8,["value"])]),e("div",Zt,[e("p",tn,"垂直范围选择："+w(a.value),1),d(p(v),{value:a.value,"onUpdate:value":n[1]||(n[1]=o=>a.value=o),vertical:"",range:"",step:10},null,8,["value"])])]))}}),en=`<template>
