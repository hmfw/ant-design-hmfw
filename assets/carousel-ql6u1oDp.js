...
<\/script>
`,rt=k({__name:"CarouselBasic",setup(e){return(f,s)=>(b(),A(p(_),{style:{height:"160px",background:"#364d79","border-radius":"4px",overflow:"hidden"}},{default:m(()=>[(b(),T(j,null,I(4,v=>d("div",{key:v,style:{height:"160px",display:"flex","align-items":"center","justify-content":"center",color:"#fff","font-size":"24px"}},L(v),1)),64))]),_:1}))}}),it=`<template>
...
<\/script>
`,st=k({__name:"CarouselFade",setup(e){return(f,s)=>(b(),A(p(_),{effect:"fade",style:{height:"160px",background:"#364d79","border-radius":"4px",overflow:"hidden"}},{default:m(()=>[(b(),T(j,null,I(4,v=>d("div",{key:v,style:{height:"160px",display:"flex","align-items":"center","justify-content":"center",color:"#fff","font-size":"24px"}},L(v),1)),64))]),_:1}))}}),ut=`<template>
