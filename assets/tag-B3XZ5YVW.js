...
<\/script>
`,j={style:{display:"flex",gap:"8px"}},F=T({__name:"TagCheckable",setup(n){const g=["Movies","Books","Music","Sports"],e=C(["Books"]);function r(t,c){c?e.value=[...e.value,t]:e.value=e.value.filter(u=>u!==t)}return(t,c)=>(b(),p("div",j,[(b(),p(I,null,S(g,u=>l(d(M),{key:u,checked:e.value.includes(u),onChange:k=>r(u,k)},{default:o(()=>[a(P(u),1)]),_:2},1032,["checked","onChange"])),64))]))}}),K=`<template>
...
<\/script>
`,R={style:{display:"flex",gap:"8px","flex-wrap":"wrap"}},z=T({__name:"TagCustomColor",setup(n){return(g,e)=>(b(),p("div",R,[l(d(s),{color:"#f50"},{default:o(()=>[...e[0]||(e[0]=[a("#f50",-1)])]),_:1}),l(d(s),{color:"#2db7f5"},{default:o(()=>[...e[1]||(e[1]=[a("#2db7f5",-1)])]),_:1}),l(d(s),{color:"#87d068"},{default:o(()=>[...e[2]||(e[2]=[a("#87d068",-1)])]),_:1}),l(d(s),{color:"#108ee9"},{default:o(()=>[...e[3]||(e[3]=[a("#108ee9",-1)])]),_:1})]))}}),A=`<template>
  <div style="display: flex; gap: 8px; flex-wrap: wrap;">
...
import { Tag } from 'ant-design-hmfw'
<\/script>
`,G={style:{display:"flex",gap:"8px","align-items":"center","flex-wrap":"wrap"}},J=T({__name:"TagLinkDisabled",setup(n){return(g,e)=>(b(),p("div",G,[l(d(s),{href:"https://ant.design",target:"_blank"},{default:o(()=>[...e[0]||(e[0]=[a("链接标签",-1)])]),_:1}),l(d(s),{disabled:""},{default:o(()=>[...e[1]||(e[1]=[a("禁用标签",-1)])]),_:1}),l(d(s),{disabled:"",closable:""},{default:o(()=>[...e[2]||(e[2]=[a("禁用且不可关闭",-1)])]),_:1})]))}}),Q=`<template>
