import{S as u}from"./Select-R6SRsb9F.js";import{d as h,o as v,b as g,c as o,e as p,f as n,A as x,r as i,_ as S,g as c,h as q,w as b,i as N}from"./index-DCNtHlH3.js";import"./cls-S9IiI6wd.js";import"./LoadingOutlined-DsitE8co.js";import"./DownOutlined-NqsBDvU3.js";import"./Trigger-Dn9I4W9t.js";import"./VirtualList-DtZ_n2r7.js";const C={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"300px"}},V=h({__name:"SelectBasic",setup(k){const e=i(""),d=i(""),r=[{label:"Vue",value:"vue"},{label:"React",value:"react"},{label:"Angular",value:"angular"},{label:"Svelte（禁用）",value:"svelte",disabled:!0}];return(t,a)=>(v(),g("div",C,[o(p(u),{value:e.value,"onUpdate:value":a[0]||(a[0]=s=>e.value=s),options:r,placeholder:"请选择",style:{width:"100%"}},null,8,["value"]),o(p(u),{value:d.value,"onUpdate:value":a[1]||(a[1]=s=>d.value=s),options:r,placeholder:"禁用状态",disabled:"",style:{width:"100%"}},null,8,["value"]),n("p",null,"选中："+x(e.value),1)]))}}),_=`<template>
