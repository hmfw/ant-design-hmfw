import{o as N,N as vt,L as bt,n as s,s as xt,f as P,r as ht,A,k as B,K as o,h as e,R as b,m as w,E as pt,_ as Pt,F as wt,H as $t,l as St}from"./index-B9Ix0zQ8.js";import{c as q}from"./cls-S9IiI6wd.js";import{T as Ct}from"./Tooltip-f6ptDiSe.js";import{a as qt,C as Nt}from"./CloseCircleFilled-BM35gEFb.js";import{I as H}from"./Icon-D0ODznex.js";import{C as At}from"./CloseOutlined-wdRsSn_L.js";import{C as Bt}from"./CheckOutlined-CGwXmDRE.js";import{B as V}from"./Button-D9PdcFa1.js";import"./Trigger-C7LIrQfF.js";import"./LoadingOutlined-aeZz6k73.js";function D(t){return!t||t<0?0:t>100?100:t}function K({success:t}){if(t&&"percent"in t)return t.percent}function Z(t,c,n){let p=-1,a=-1;if(c==="step"){const d=n.steps,l=n.strokeWidth;typeof t=="string"||typeof t>"u"?(p=t==="small"?2:14,a=l??8):typeof t=="number"?[p,a]=[t,t]:Array.isArray(t)?(p=t[0]??14,a=t[1]??8):(p=t.width??14,a=t.height??8),p*=d}else if(c==="line"){const d=n==null?void 0:n.strokeWidth;typeof t=="string"||typeof t>"u"?a=d||(t==="small"?6:8):typeof t=="number"?[p,a]=[t,t]:Array.isArray(t)?(p=t[0]??-1,a=t[1]??8):(p=t.width??-1,a=t.height??8)}else if(typeof t=="string"||typeof t>"u")[p,a]=t==="small"?[60,60]:[120,120];else if(typeof t=="number")[p,a]=[t,t];else if(Array.isArray(t)){const d=t[0]??t[1]??120;[p,a]=[d,d]}else{const d=t.width??t.height??120;[p,a]=[d,d]}return[p,a]}function zt(t,c=!1){const{from:n,to:p,direction:a=c?"to left":"to right",...d}=t,l=Object.entries(d).filter(([,u])=>typeof u=="string");if(l.length>0){const u=l.map(([m,I])=>({key:parseFloat(String(m).replace(/%/g,"")),value:I})).filter(m=>!isNaN(m.key)).sort((m,I)=>m.key-I.key).map(({key:m,value:I})=>`${I} ${m}%`).join(", ");return`linear-gradient(${a}, ${u})`}return`linear-gradient(${a}, ${n||"#1677ff"}, ${p||"#1677ff"})`}function Lt(t){if(!t)return!1;let c=0,n=0,p=0;const a=t.trim();if(a.startsWith("#")){let l=a.slice(1);if(l.length===3&&(l=l.split("").map(u=>u+u).join("")),l.length>=6)c=parseInt(l.slice(0,2),16),n=parseInt(l.slice(2,4),16),p=parseInt(l.slice(4,6),16);else return!1}else{const l=a.match(/rgba?\(([^)]+)\)/i);if(!l)return!1;const u=l[1].split(",").map(m=>parseFloat(m.trim()));if(u.length<3||u.some(m=>isNaN(m)))return!1;[c,n,p]=u}return(c*299+n*587+p*114)/1e3>=178}function It(t){if(!t)return;if(typeof t=="string")return t;if(Array.isArray(t))return t[0];if("from"in t&&typeof t.from=="string")return t.from;const c=Object.entries(t).filter(([n,p])=>n!=="direction"&&typeof p=="string");if(c.length>0)return c[0][1]}function Ot(t){const{from:c,to:n,direction:p,...a}=t,d=Object.entries(a).filter(([,l])=>typeof l=="string");return d.length>0?d.map(([l,u])=>({offsetNum:parseFloat(String(l).replace(/%/g,"")),color:u})).filter(l=>!isNaN(l.offsetNum)).sort((l,u)=>l.offsetNum-u.offsetNum).map(({offsetNum:l,color:u})=>({offset:`${l}%`,color:u})):[{offset:"0%",color:c||"#1677ff"},{offset:"100%",color:n||"#1677ff"}]}const Mt="#52c41a";function Wt(t){return(t==null?void 0:t.strokeColor)||Mt}let Dt=0;function Gt(t){return typeof t=="function"||Object.prototype.toString.call(t)==="[object Object]"&&!ht(t)}const Tt=["normal","exception","active","success"],i=N({name:"Progress",inheritAttrs:!1,props:{prefixCls:String,rootClassName:String,classNames:Object,styles:Object,percent:{type:Number,default:0},type:{type:String,default:"line"},status:String,showInfo:{type:Boolean,default:!0},strokeWidth:Number,strokeColor:[String,Array,Object],trailColor:String,railColor:String,width:Number,size:{type:[String,Number,Object,Array],default:"medium"},format:Function,strokeLinecap:{type:String,default:"round"},success:Object,steps:[Number,Object],gapDegree:Number,gapPlacement:String,gapPosition:String,percentPosition:{type:Object,default:()=>({})},rounding:Function},setup(t,{attrs:c}){const n=vt("progress"),p=bt(),a=P(()=>p.value.direction==="rtl"),d=Dt++,l=P(()=>t.railColor??t.trailColor),u=P(()=>{var r;return((r=t.percentPosition)==null?void 0:r.align)??"end"}),m=P(()=>{var r;return((r=t.percentPosition)==null?void 0:r.type)??"outer"}),I=P(()=>Array.isArray(t.strokeColor)?t.strokeColor[0]:t.strokeColor),ut=P(()=>{const r=It(t.strokeColor);return Lt(r)}),J=P(()=>{const r=K(t),k=r!==void 0?r:t.percent;return Number.parseInt(String(k??0),10)}),j=P(()=>!Tt.includes(t.status)&&J.value>=100?"success":t.status||"normal"),Q=P(()=>t.size==="medium"?"default":t.size),_=P(()=>t.type==="line"),R=P(()=>_.value&&!t.steps),X=()=>{var y,v;if(!t.showInfo)return null;const r=K(t),k=_.value&&ut.value&&m.value==="inner";let g=null;m.value==="inner"||t.format||j.value!=="exception"&&j.value!=="success"?g=(t.format??(x=>`${x}%`))(D(t.percent),D(r)):j.value==="exception"?g=_.value?s(H,{component:qt},null):s(H,{component:At},null):j.value==="success"&&(g=_.value?s(H,{component:Nt},null):s(H,{component:Bt},null));const S=q(`${n}-indicator`,{[`${n}-indicator-bright`]:k,[`${n}-indicator-${u.value}`]:R.value,[`${n}-indicator-${m.value}`]:R.value},(y=t.classNames)==null?void 0:y.indicator),$=typeof g=="string"||typeof g=="number"?String(g):void 0;return s("span",{class:S,style:(v=t.styles)==null?void 0:v.indicator,title:$},[g])},mt=()=>{var O,W,z,M,L,G,F,T,E;const[r,k]=Z(Q.value,"line",{strokeWidth:t.strokeWidth}),g=t.strokeLinecap==="square"||t.strokeLinecap==="butt"?0:void 0,S={backgroundColor:l.value||void 0,borderRadius:g!==void 0?`${g}px`:void 0,height:`${k}px`,...(O=t.styles)==null?void 0:O.rail},$=K(t),v={width:`${D(t.percent)}%`,height:`${k}px`,borderRadius:g!==void 0?`${g}px`:void 0},f=I.value;f&&typeof f!="string"?v.background=zt(f,a.value):typeof f=="string"&&(v.background=f),Object.assign(v,((W=t.styles)==null?void 0:W.track)||{});const x=$!==void 0?{width:`${D($)}%`,height:`${k}px`,borderRadius:g!==void 0?`${g}px`:void 0,backgroundColor:(z=t.success)==null?void 0:z.strokeColor,...(M=t.styles)==null?void 0:M.track}:null,h=X(),C=`${n}-track`;return s("div",{class:q(`${n}-body`,(L=t.classNames)==null?void 0:L.body,{[`${n}-body-layout-bottom`]:u.value==="center"&&m.value==="outer"}),style:{width:r>0?`${r}px`:"100%",...(G=t.styles)==null?void 0:G.body}},[s("div",{class:q(`${n}-rail`,(F=t.classNames)==null?void 0:F.rail),style:S},[s("div",{class:q(C,(T=t.classNames)==null?void 0:T.track),style:v},[m.value==="inner"&&h]),x&&s("div",{class:q(C,`${C}-success`,(E=t.classNames)==null?void 0:E.track),style:x},null)]),m.value==="outer"&&h])},Y=P(()=>t.steps?typeof t.steps=="number"?t.steps:t.steps.count:0),tt=P(()=>{if(!(!t.steps||typeof t.steps=="number"))return t.steps.gap}),gt=()=>{var h,C,O,W;const r=Y.value;if(!r)return null;const k=t.strokeWidth??8,[g,S]=Z(Q.value,"step",{steps:r,strokeWidth:k}),$=g/r,v=(t.rounding??Math.round)(r*(D(t.percent)/100)),f=[];for(let z=0;z<r;z++){const M=z<=v-1,L=Array.isArray(t.strokeColor)?t.strokeColor[z]:typeof t.strokeColor=="string"?t.strokeColor:void 0;f.push(s("div",{key:z,class:q(`${n}-steps-item`,{[`${n}-steps-item-active`]:M},(h=t.classNames)==null?void 0:h.track),style:{backgroundColor:M?L:l.value,width:`${$}px`,height:`${S}px`,...(C=t.styles)==null?void 0:C.track}},null))}const x={...(O=t.styles)==null?void 0:O.body};return tt.value!==void 0&&(x.gap=`${tt.value}px`),s("div",{class:q(`${n}-steps-body`,(W=t.classNames)==null?void 0:W.body),style:x},[f,X()])},nt=P(()=>{const r=t.size==="medium"&&t.width!==void 0?t.width:Q.value,[k]=Z(r,t.type==="dashboard"?"dashboard":"circle");return k}),ft=()=>{var st,at,ot,rt,lt,it,ct;const r=nt.value,k=Math.max(3/r*100,6),g=Math.min(k,Math.max(r/2-1,1)),S=t.strokeWidth??g,$=Math.max((r-S)/2,.5),y=2*Math.PI*$,v=t.type==="dashboard",f=t.gapDegree!==void 0?t.gapDegree:v?75:0,x=t.gapPlacement??t.gapPosition??(v?"bottom":void 0);let h=-90;x==="bottom"?h=90+f/2:x==="top"?h=-90+f/2:x==="start"||x==="left"?h=180+f/2-(a.value?180:0):(x==="end"||x==="right")&&(h=(a.value?180:0)+f/2);const C=y-f/360*y,O=K(t),W=D(t.percent),z=C*(1-W/100),M=O!==void 0?C*(1-D(O)/100):null,L=I.value,G=!!(L&&typeof L!="string"),F=`${n}-gradient-${d}-${r}`;let T;G?T=`url(#${F})`:typeof L=="string"&&(T=L);const E=t.showInfo&&X(),et=r<=20,yt=q(`${n}-body`,{[`${n}-circle-gradient`]:G},(st=t.classNames)==null?void 0:st.body),U=s("div",{class:yt,style:{width:`${r}px`,height:`${r}px`,fontSize:`${r*.15+6}px`,...(at=t.styles)==null?void 0:at.body}},[s("svg",{viewBox:`0 0 ${r} ${r}`,width:r,height:r},[G&&s("defs",null,[s("linearGradient",{id:F,gradientUnits:"userSpaceOnUse",x1:a.value?r:0,y1:r/2,x2:a.value?0:r,y2:r/2,gradientTransform:`rotate(${-h} ${r/2} ${r/2})`},[Ot(L).map(({offset:dt,color:kt})=>s("stop",{key:dt,offset:dt,"stop-color":kt},null))])]),s("circle",{class:q(`${n}-circle-rail`,(ot=t.classNames)==null?void 0:ot.rail),cx:r/2,cy:r/2,r:$,stroke:l.value??"#f5f5f5","stroke-width":S,fill:"none","stroke-dasharray":`${C}px ${y}px`,transform:`rotate(${h} ${r/2} ${r/2})`,style:(rt=t.styles)==null?void 0:rt.rail},null),s("circle",{class:q(`${n}-circle-path`,(lt=t.classNames)==null?void 0:lt.track),cx:r/2,cy:r/2,r:$,stroke:T,"stroke-width":S,fill:"none","stroke-dasharray":`${C}px ${y}px`,"stroke-dashoffset":`${z}px`,"stroke-linecap":t.strokeLinecap,transform:`rotate(${h} ${r/2} ${r/2})`,style:(it=t.styles)==null?void 0:it.track},null),M!==null&&s("circle",{class:q(`${n}-circle-path`,`${n}-circle-path-success`,(ct=t.classNames)==null?void 0:ct.track),cx:r/2,cy:r/2,r:$,stroke:Wt(t.success),"stroke-width":S,fill:"none","stroke-dasharray":`${C}px ${y}px`,"stroke-dashoffset":`${M}px`,"stroke-linecap":t.strokeLinecap,transform:`rotate(${h} ${r/2} ${r/2})`},null)]),!et&&E]);return et&&E?s(Ct,{title:E},Gt(U)?U:{default:()=>[U]}):U};return()=>{var v,f;const r=t.type==="circle"&&nt.value<=20,k=q(n,`${n}-status-${j.value}`,{[`${n}-${t.type==="dashboard"?"circle":t.type}`]:t.type!=="line",[`${n}-inline-circle`]:r,[`${n}-line`]:R.value,[`${n}-line-align-${u.value}`]:R.value,[`${n}-line-position-${m.value}`]:R.value,[`${n}-steps`]:!!Y.value,[`${n}-show-info`]:t.showInfo,[`${n}-small`]:t.size==="small",[`${n}-rtl`]:a.value},t.rootClassName,(v=t.classNames)==null?void 0:v.root,c.class),S=c["aria-label"]??`${J.value}%`,$=c["aria-labelledby"],y={...c};return delete y["aria-label"],delete y["aria-labelledby"],delete y.class,delete y.style,s("div",xt(y,{class:k,style:{...((f=t.styles)==null?void 0:f.root)||{},...c.style||{}},role:"progressbar","aria-valuenow":J.value,"aria-valuemin":0,"aria-valuemax":100,"aria-label":S,"aria-labelledby":$}),[Y.value?gt():_.value?mt():ft()])}}}),Et={style:{display:"flex","flex-direction":"column",gap:"12px"}},jt=N({__name:"ProgressBasic",setup(t){return(c,n)=>(A(),B("div",Et,[s(o(i),{percent:30}),s(o(i),{percent:50,status:"active"}),s(o(i),{percent:70,status:"exception"}),s(o(i),{percent:100}),s(o(i),{percent:50,"show-info":!1})]))}}),_t=`<template>
...
import { Progress } from 'ant-design-hmfw'
<\/script>
`,Ut={style:{display:"flex","flex-direction":"column",gap:"24px"}},Ht={style:{display:"flex",gap:"32px","align-items":"center"}},Kt={style:{"margin-top":"12px",display:"flex",gap:"8px"}},Jt=N({__name:"ProgressClassNames",setup(t){const c=pt(50),n=()=>{c.value=Math.min(100,c.value+10)},p=()=>{c.value=Math.max(0,c.value-10)},a=()=>{c.value=50};return(d,l)=>(A(),B("div",Ut,[e("div",null,[l[0]||(l[0]=e("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义轨道和进度条：",-1)),s(o(i),{percent:60,"class-names":{rail:"custom-rail",track:"custom-track"}})]),e("div",null,[l[1]||(l[1]=e("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义百分比指示器：",-1)),s(o(i),{percent:75,"class-names":{indicator:"custom-indicator"}})]),e("div",null,[l[2]||(l[2]=e("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义容器样式：",-1)),s(o(i),{percent:80,"class-names":{root:"custom-root",body:"custom-body"}})]),e("div",null,[l[3]||(l[3]=e("div",{style:{"margin-bottom":"8px",color:"#666"}},"完整自定义（组合使用）：",-1)),s(o(i),{percent:90,"class-names":{root:"complete-root",rail:"complete-rail",track:"complete-track",indicator:"complete-indicator"}})]),e("div",null,[l[4]||(l[4]=e("div",{style:{"margin-bottom":"8px",color:"#666"}},"使用内联样式（styles）：",-1)),s(o(i),{percent:65,styles:{rail:{background:"#f0f0f0",height:"12px",borderRadius:"6px"},track:{background:"linear-gradient(to right, #1890ff, #52c41a)",height:"12px"},indicator:{fontSize:"16px",fontWeight:"bold",color:"#722ed1"}}})]),e("div",null,[l[5]||(l[5]=e("div",{style:{"margin-bottom":"8px",color:"#666"}},"圆形进度条自定义：",-1)),e("div",Ht,[s(o(i),{type:"circle",percent:70,"class-names":{body:"circle-body",indicator:"circle-indicator"}}),s(o(i),{type:"circle",percent:85,styles:{body:{filter:"drop-shadow(0 4px 12px rgba(24, 144, 255, 0.4))"},indicator:{fontSize:"24px",fontWeight:"600",color:"#1890ff"}}})])]),e("div",null,[l[6]||(l[6]=e("div",{style:{"margin-bottom":"8px",color:"#666"}},"仪表盘进度条：",-1)),s(o(i),{type:"dashboard",percent:80,"class-names":{body:"dashboard-body",indicator:"dashboard-indicator"}})]),e("div",null,[l[10]||(l[10]=e("div",{style:{"margin-bottom":"8px",color:"#666"}},"动态进度（点击按钮改变）：",-1)),s(o(i),{percent:c.value,"class-names":{track:"dynamic-track",indicator:"dynamic-indicator"}},null,8,["percent"]),e("div",Kt,[s(o(V),{size:"small",onClick:p},{default:b(()=>[...l[7]||(l[7]=[w("-10%",-1)])]),_:1}),s(o(V),{size:"small",onClick:n},{default:b(()=>[...l[8]||(l[8]=[w("+10%",-1)])]),_:1}),s(o(V),{size:"small",onClick:a},{default:b(()=>[...l[9]||(l[9]=[w("重置",-1)])]),_:1})])])]))}}),Qt=Pt(Jt,[["__scopeId","data-v-41b33edb"]]),Xt=`<template>
...
import { Progress } from 'ant-design-hmfw'
<\/script>
`,an={style:{display:"flex",gap:"8px","margin-top":"12px"}},on=N({__name:"ProgressDynamic",setup(t){const c=pt(0);function n(){c.value=Math.min(c.value+10,100)}function p(){c.value=Math.max(c.value-10,0)}return(a,d)=>(A(),B(wt,null,[s(o(i),{percent:c.value},null,8,["percent"]),e("div",an,[s(o(V),{onClick:p},{default:b(()=>[...d[0]||(d[0]=[w("-",-1)])]),_:1}),s(o(V),{onClick:n},{default:b(()=>[...d[1]||(d[1]=[w("+",-1)])]),_:1})])],64))}}),rn=`<template>
...
<\/script>
`,ln={style:{display:"flex","flex-direction":"column",gap:"16px"}},cn=N({__name:"ProgressGapPlacement",setup(t){return(c,n)=>(A(),B("div",ln,[e("div",null,[n[0]||(n[0]=e("span",{style:{display:"inline-block",width:"180px"}},"默认（gapPlacement=bottom）",-1)),s(o(i),{type:"dashboard",percent:75,width:80})]),e("div",null,[n[1]||(n[1]=e("span",{style:{display:"inline-block",width:"180px"}},"gapPlacement=top",-1)),s(o(i),{type:"dashboard",percent:75,width:80,"gap-placement":"top"})]),e("div",null,[n[2]||(n[2]=e("span",{style:{display:"inline-block",width:"180px"}},"gapPlacement=start",-1)),s(o(i),{type:"dashboard",percent:75,width:80,"gap-placement":"start"})]),e("div",null,[n[3]||(n[3]=e("span",{style:{display:"inline-block",width:"180px"}},"gapPlacement=end",-1)),s(o(i),{type:"dashboard",percent:75,width:80,"gap-placement":"end"})])]))}}),dn=`<script setup lang="ts">
import { Progress } from 'ant-design-hmfw'
<\/script>
...
`,pn={style:{display:"flex","flex-direction":"column",gap:"16px"}},un={style:{display:"flex",gap:"24px"}},mn=N({__name:"ProgressGradient",setup(t){return(c,n)=>(A(),B("div",pn,[e("div",null,[n[0]||(n[0]=e("div",{style:{"margin-bottom":"8px"}},"线形渐变（from-to）",-1)),s(o(i),{percent:60,"stroke-color":{from:"#108ee9",to:"#87d068"}})]),e("div",null,[n[1]||(n[1]=e("div",{style:{"margin-bottom":"8px"}},"线形渐变（多色 stop）",-1)),s(o(i),{percent:80,"stroke-color":{"0%":"#108ee9","50%":"#87d068","100%":"#ffcb00"}})]),e("div",null,[n[2]||(n[2]=e("div",{style:{"margin-bottom":"8px"}},"成功分段 success.percent",-1)),s(o(i),{percent:60,success:{percent:30,strokeColor:"#52c41a"}})]),e("div",null,[n[3]||(n[3]=e("div",{style:{"margin-bottom":"8px"}},"圆形 / 仪表盘渐变",-1)),e("div",un,[s(o(i),{type:"circle",percent:70,"stroke-color":{"0%":"#108ee9","100%":"#87d068"}}),s(o(i),{type:"dashboard",percent:70,"stroke-color":{"0%":"#108ee9","100%":"#87d068"}}),s(o(i),{type:"circle",percent:90,"stroke-color":{from:"#1677ff",to:"#ff4d4f"}})])])]))}}),gn=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px">
    <div>
