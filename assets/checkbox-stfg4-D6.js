import{C as u,a as f}from"./Checkbox-qjmFKUru.js";import{d as v,o as h,b as x,c as a,e as d,w as c,g as l,f as t,s as b,r as k,_ as y,E as w,h as G,i as N}from"./index-dV6GQSVR.js";import"./cls-S9IiI6wd.js";const S={style:{display:"flex","flex-direction":"column",gap:"8px"}},q=v({__name:"CheckboxBasic",setup(g){const p=k(!1),e=k(!1),r=k(!0);return(n,o)=>(h(),x("div",S,[a(d(u),{checked:p.value,"onUpdate:checked":o[0]||(o[0]=s=>p.value=s)},{default:c(()=>[...o[3]||(o[3]=[l(" 普通复选框 ",-1)])]),_:1},8,["checked"]),a(d(u),{checked:e.value,"onUpdate:checked":o[1]||(o[1]=s=>e.value=s),disabled:""},{default:c(()=>[...o[4]||(o[4]=[l(" 禁用复选框 ",-1)])]),_:1},8,["checked"]),a(d(u),{checked:r.value,"onUpdate:checked":o[2]||(o[2]=s=>r.value=s),disabled:""},{default:c(()=>[...o[5]||(o[5]=[l(" 禁用选中 ",-1)])]),_:1},8,["checked"]),t("p",null,"checked1: "+b(p.value)+", checked2: "+b(e.value)+", checked3: "+b(r.value),1)]))}}),A=`<template>
...
<\/script>
`,B={style:{"border-bottom":"1px solid #e8e8e8","padding-bottom":"8px","margin-bottom":"8px"}},E={style:{"margin-top":"8px"}},D=v({__name:"CheckboxCheckAll",setup(g){const p=[{label:"选项 A",value:"A"},{label:"选项 B",value:"B"},{label:"选项 C",value:"C"},{label:"选项 D",value:"D"}],e=k(["A","B"]),r=k(!1),n=k(!0),o=i=>{e.value=i.target.checked?p.map(m=>m.value):[],n.value=!1},s=i=>{n.value=!!i.length&&i.length<p.length,r.value=i.length===p.length};return(i,m)=>(h(),x("div",null,[t("div",B,[a(d(u),{checked:r.value,"onUpdate:checked":m[0]||(m[0]=C=>r.value=C),indeterminate:n.value,onChange:o},{default:c(()=>[...m[2]||(m[2]=[l(" 全选 ",-1)])]),_:1},8,["checked","indeterminate"])]),a(d(f),{value:e.value,"onUpdate:value":m[1]||(m[1]=C=>e.value=C),options:p,onChange:s},null,8,["value"]),t("p",E,"已选："+b(e.value),1)]))}}),V=`<template>
  <div>
