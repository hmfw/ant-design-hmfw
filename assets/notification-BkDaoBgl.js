import{B as d}from"./Button-D7tvIoj2.js";import{n as p}from"./notification-_IHHwkCZ.js";import{d as y,o as m,b as g,c as s,e as o,w as a,g as t,f as c,v as b,_ as v,h as N,i as x}from"./index-cgVI-orz.js";import{C as w}from"./CloseCircleFilled-D94YfbHC.js";import{C}from"./CheckCircleFilled-Cy0cWKQ1.js";import"./cls-S9IiI6wd.js";import"./LoadingOutlined-BnULcwLn.js";import"./CloseOutlined-H_Tga8k8.js";import"./ExclamationCircleFilled-C4rqH2Gp.js";import"./InfoCircleFilled-DaeLJ-gY.js";const h={style:{display:"flex",gap:"8px","flex-wrap":"wrap"}},B=y({__name:"NotificationBasic",setup(k){function l(){p.success({message:"操作成功",description:"您的操作已成功完成，请查看详情。"})}function u(){p.error({message:"操作失败",description:"操作过程中发生错误，请稍后重试。"})}function e(){p.warning({message:"警告",description:"此操作存在风险，请谨慎操作。"})}function n(){p.info({message:"提示信息",description:"这是一条普通的提示信息。"})}return(i,f)=>(m(),g("div",h,[s(o(d),{onClick:l},{default:a(()=>[...f[0]||(f[0]=[t(" 成功 ",-1)])]),_:1}),s(o(d),{onClick:u},{default:a(()=>[...f[1]||(f[1]=[t(" 错误 ",-1)])]),_:1}),s(o(d),{onClick:e},{default:a(()=>[...f[2]||(f[2]=[t(" 警告 ",-1)])]),_:1}),s(o(d),{onClick:n},{default:a(()=>[...f[3]||(f[3]=[t(" 信息 ",-1)])]),_:1})]))}}),S=`<template>
...
`,L={style:{display:"flex",gap:"8px","flex-wrap":"wrap"}},q=y({__name:"NotificationCloseIcon",setup(k){function l(){p.info({message:"自定义关闭图标",description:"此通知使用了自定义的关闭图标（实心圆形关闭图标）。",closeIcon:()=>b(w,{class:"hmfw-icon"}),duration:0})}function u(){p.config({closeIcon:()=>b(C,{class:"hmfw-icon"})}),p.success({message:"全局关闭图标已设置",description:"所有新通知都将使用对勾图标作为关闭按钮，除非单独指定。",duration:3})}function e(){p.config({closeIcon:void 0}),p.info({message:"已重置为默认图标",description:"关闭图标已恢复为默认样式。",duration:3})}return(n,i)=>(m(),g("div",L,[s(o(d),{type:"primary",onClick:l},{default:a(()=>[...i[0]||(i[0]=[t(" 自定义关闭图标 ",-1)])]),_:1}),s(o(d),{onClick:u},{default:a(()=>[...i[1]||(i[1]=[t(" 设置全局关闭图标 ",-1)])]),_:1}),s(o(d),{onClick:e},{default:a(()=>[...i[2]||(i[2]=[t(" 重置全局配置 ",-1)])]),_:1})]))}}),T=`<template>
  <div style="display: flex; gap: 8px; flex-wrap: wrap">
