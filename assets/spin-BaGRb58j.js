import{S as l}from"./Spin-CjZT4T2Q.js";import{o as m,A as r,i as f,K as a,k as g,h as t,n as s,R as i,_ as y,E as k,m as c,x as b,y as x,J as S,H as h,l as q}from"./index-DVYL9B-3.js";import{B as v}from"./Button-Bkc4rV1H.js";import"./cls-S9IiI6wd.js";import"./Icon-DOBD7t4S.js";import"./LoadingOutlined-Cfvvdn-g.js";const w=m({__name:"SpinBasic",setup(u){return(o,e)=>(r(),f(a(l)))}}),N=`<template>
  <Spin />
</template>
...
const loading = ref(true)
<\/script>
`,D={style:{display:"flex",gap:"32px","align-items":"center"}},I=m({__name:"SpinPercent",setup(u){const o=k(0),e=k(!0);let p;b(()=>{p=setInterval(()=>{o.value=o.value>=100?0:o.value+10},500)}),x(()=>{p&&clearInterval(p)});function n(){e.value=!e.value}return(d,W)=>(r(),g("div",D,[s(a(l),{percent:o.value},null,8,["percent"]),s(a(l),{percent:o.value,size:"large"},null,8,["percent"]),s(a(l),{percent:"auto",spinning:e.value},null,8,["spinning"]),s(a(v),{onClick:n},{default:i(()=>[c(S(e.value?"停止 auto":"开始 auto"),1)]),_:1})]))}}),R=`<template>
...
<\/script>
`,T={style:{display:"flex",gap:"24px","align-items":"center"}},M=m({__name:"SpinSize",setup(u){return(o,e)=>(r(),g("div",T,[s(a(l),{size:"small"}),s(a(l)),s(a(l),{size:"large"})]))}}),V=`<template>
