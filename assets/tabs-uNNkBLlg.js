...
<\/script>
`,ct=v({__name:"TabsIcon",setup(t){const d=[{key:"1",label:"Tab 1",icon:S(A,{component:F}),children:"Content of Tab 1"},{key:"2",label:"Tab 2",icon:S(A,{component:H}),children:"Content of Tab 2"}];return(i,n)=>(k(),w(u(p),{items:d}))}}),ut=`<template>
  <Tabs :items="items" />
</template>
