...
<\/script>
`,Tt={style:{display:"flex","flex-direction":"column",gap:"32px"}},Vt=S({__name:"ListClassNames",setup(t){const e=["Vue 3 组件库开发实战","TypeScript 类型体操进阶","Vite 构建工具深度解析"],o=[{title:"用户体验设计",description:"提升产品的整体用户体验"},{title:"性能优化",description:"前端性能优化最佳实践"},{title:"代码规范",description:"团队协作的代码规范建议"}],s=["完成需求文档评审","实现用户反馈功能","修复已知 Bug"],n=["条目 1","条目 2","条目 3","条目 4","条目 5","条目 6","条目 7"],l=u=>m(p.Item,null,()=>u),g=u=>m(p.Item,{actions:[m("a",{style:"color: #1677ff"},"编辑"),m("a",{style:"color: #1677ff"},"删除")],classNames:{item:"custom-item",action:"custom-action"}},()=>m(p.Item.Meta,{avatar:m(X,{style:{backgroundColor:"#1677ff"}},()=>u.title[0]),title:u.title,description:u.description,classNames:{title:"custom-title",description:"custom-description"}})),C=u=>m(p.Item,null,()=>u);return(u,c)=>(w(),V("div",Tt,[i("div",null,[c[0]||(c[0]=i("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义头部和底部：",-1)),a(r(p),{"data-source":e,"render-item":l,header:"精选文章",footer:"查看更多 →",bordered:"","class-names":{header:"custom-header",footer:"custom-footer"}})]),i("div",null,[c[1]||(c[1]=i("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义列表项和操作样式：",-1)),a(r(p),{"data-source":o,"render-item":g,bordered:""})]),i("div",null,[c[2]||(c[2]=i("div",{style:{"margin-bottom":"8px",color:"#666"}},"使用内联样式：",-1)),a(r(p),{"data-source":s,"render-item":C,header:"任务列表",bordered:"",styles:{root:{borderRadius:"12px",overflow:"hidden"},header:{background:"linear-gradient(135deg, #667eea 0%, #764ba2 100%)",color:"white",fontWeight:600},items:{background:"#fafafa"}}})]),i("div",null,[c[3]||(c[3]=i("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义分页器：",-1)),a(r(p),{"data-source":n,"render-item":l,pagination:{pageSize:3},"class-names":{pagination:"custom-pagination"}})]),i("div",null,[c[4]||(c[4]=i("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义空状态：",-1)),a(r(p),{"data-source":[],bordered:"","class-names":{empty:"custom-empty"}})])]))}}),Ot=ft(Vt,[["__scopeId","data-v-646b5aec"]]),Ht=`<template>
...
const renderItem = (item: string) => h(List.Item, null, () => item)
<\/script>
`,Jt={class:"list-responsive-grid-demo"},Yt=S({__name:"ListResponsiveGrid",setup(t){const e=Array.from({length:12},(s,n)=>({id:n+1,title:`项目 ${n+1}`,content:`这是第 ${n+1} 个项目的内容`})),o=s=>m(p.Item,null,()=>m(yt,{title:s.title,hoverable:!0},()=>s.content));return(s,n)=>(w(),V("div",Jt,[n[0]||(n[0]=i("h4",null,"响应式网格布局",-1)),n[1]||(n[1]=i("p",{style:{"margin-bottom":"16px",color:"#666"}},[k(" 调整浏览器窗口大小查看响应式效果： "),i("br"),k(" • 超小屏 (xs < 576px): 1 列 "),i("br"),k(" • 小屏 (sm ≥ 576px): 2 列 "),i("br"),k(" • 中屏 (md ≥ 768px): 3 列 "),i("br"),k(" • 大屏 (lg ≥ 992px): 4 列 "),i("br"),k(" • 超大屏 (xl ≥ 1200px): 6 列 ")],-1)),a(r(p),{"data-source":r(e),"render-item":o,grid:{gutter:16,xs:1,sm:2,md:3,lg:4,xl:6}},null,8,["data-source"])]))}}),tn=ft(Yt,[["__scopeId","data-v-51c1bcca"]]),nn=`<template>
