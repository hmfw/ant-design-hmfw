...
<\/script>
`,zt=S({__name:"ListBasic",setup(t){const a=["Racing car sprays burning fuel into crowd.","Japanese princess to wed commoner.","Australian walks 100km after outback crash.","Man charged over missing wedding girl."],o=e=>u(d.Item,null,()=>e);return(e,n)=>(w(),O(i(d),{"data-source":a,"render-item":o,bordered:""}))}}),Bt=`<template>
  <List :data-source="data" :render-item="renderItem" bordered />
</template>
