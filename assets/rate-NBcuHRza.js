import{d as y,u as X,x as Y,r as c,m as Z,k as _,c as l,a as q,B as tt,o as x,b as h,e as u,f as n,A as F,_ as nt,h as at,w,g as k,i as et}from"./index-DZWA4HiS.js";import{c as U}from"./cls-S9IiI6wd.js";import{T as K}from"./Tooltip-Dpun1Uyv.js";import"./Trigger-B9GAuuS8.js";function L(a){return typeof a=="function"||Object.prototype.toString.call(a)==="[object Object]"&&!tt(a)}const m=y({name:"Rate",props:{value:Number,defaultValue:{type:Number,default:0},count:{type:Number,default:5},allowHalf:Boolean,allowClear:{type:Boolean,default:!0},disabled:Boolean,character:{type:[String,Function],default:"★"},tooltips:Array,size:String,keyboard:{type:Boolean,default:!0},autoFocus:Boolean,classNames:Object,styles:Object},emits:["update:value","change","hoverChange","focus","blur","keydown"],setup(a,{slots:o,emit:r,expose:p}){const t=X("rate"),e=Y(),f=c(),d=c(a.defaultValue??a.value??0),g=c(null),A=c(!1),O=q(()=>a.value!==void 0),N=q(()=>O.value?a.value:d.value),B=q(()=>a.size??e.value.componentSize),$=q(()=>e.value.direction==="rtl");Z(()=>a.value,s=>{s!==void 0&&(d.value=s)}),_(()=>{var s;a.autoFocus&&((s=f.value)==null||s.focus())}),p({focus:()=>{var s;return(s=f.value)==null?void 0:s.focus()},blur:()=>{var s;return(s=f.value)==null?void 0:s.blur()}});const C=s=>{if(a.disabled)return;let i=s;a.allowClear&&s===N.value&&(i=0),d.value=i,r("update:value",i),r("change",i)},E=(s,i)=>i?s+.5:s+1,V=(s,i)=>{C(E(s,i))},H=(s,i)=>{const v=E(s,i);g.value!==v&&(g.value=v,r("hoverChange",v))},I=()=>{g.value=null,r("hoverChange",void 0)},G=q(()=>g.value??N.value),J=s=>{const i=G.value,v=s+1,b=s+.5;return i>=v?"full":a.allowHalf&&i>=b?"half":"zero"},Q=s=>{if(!a.keyboard||a.disabled)return;r("keydown",s);const{key:i}=s,v=N.value,b=a.allowHalf?.5:1,S=$.value?["ArrowLeft","ArrowUp"]:["ArrowRight","ArrowUp"],z=$.value?["ArrowRight","ArrowDown"]:["ArrowLeft","ArrowDown"];if(S.includes(i)){s.preventDefault();const R=Math.min(v+b,a.count);R!==v&&C(R)}else if(z.includes(i)){s.preventDefault();const R=Math.max(v-b,0);R!==v&&C(R)}else i==="Home"?(s.preventDefault(),v!==0&&C(0)):i==="End"&&(s.preventDefault(),v!==a.count&&C(a.count))},D=(s,i)=>{const v={index:s,value:N.value,isHalf:i};return typeof a.character=="function"?a.character(v):o.character?o.character(v):a.character},W=s=>{var S,z,R,M,j,P,T;const i=J(s),v=(S=a.tooltips)==null?void 0:S[s],b=l("li",{key:s,class:U(`${t}-star`,{[`${t}-star-full`]:i==="full",[`${t}-star-half`]:i==="half",[`${t}-star-zero`]:i==="zero"},(z=a.classNames)==null?void 0:z.star),style:(R=a.styles)==null?void 0:R.star,role:"radio","aria-checked":i!=="zero","aria-posinset":s+1,"aria-setsize":a.count},[a.allowHalf&&l("div",{class:U(`${t}-star-first`,(M=a.classNames)==null?void 0:M.starFirst),style:(j=a.styles)==null?void 0:j.starFirst,onClick:()=>!a.disabled&&V(s,!0),onMousemove:()=>!a.disabled&&H(s,!0)},[D(s,!0)]),l("div",{class:U(`${t}-star-second`,(P=a.classNames)==null?void 0:P.starSecond),style:(T=a.styles)==null?void 0:T.starSecond,onClick:()=>!a.disabled&&V(s,!1),onMousemove:()=>!a.disabled&&H(s,!1)},[D(s,!1)])]);return v?typeof v=="string"?l(K,{title:v},L(b)?b:{default:()=>[b]}):l(K,v,L(b)?b:{default:()=>[b]}):b};return()=>{var i,v;const s=Array.from({length:a.count},(b,S)=>S);return l("ul",{ref:f,class:U(t,{[`${t}-disabled`]:a.disabled,[`${t}-small`]:B.value==="small",[`${t}-large`]:B.value==="large",[`${t}-rtl`]:$.value},(i=a.classNames)==null?void 0:i.root),style:(v=a.styles)==null?void 0:v.root,onMouseleave:I,onFocus:()=>{A.value=!0,r("focus")},onBlur:()=>{A.value=!1,r("blur")},onKeydown:Q,tabindex:a.disabled?-1:0,role:"radiogroup",dir:$.value?"rtl":void 0,"aria-disabled":a.disabled||void 0},[s.map(W)])}}}),st={style:{display:"flex","flex-direction":"column",gap:"16px"}},lt=y({__name:"RateBasic",setup(a){const o=c(3),r=c(2.5);return(p,t)=>(x(),h("div",st,[l(u(m),{value:o.value,"onUpdate:value":t[0]||(t[0]=e=>o.value=e)},null,8,["value"]),l(u(m),{value:r.value,"onUpdate:value":t[1]||(t[1]=e=>r.value=e),disabled:""},null,8,["value"]),n("p",null,"评分："+F(o.value),1)]))}}),ot=`<template>
