import{o as g,O as st,E as q,R as Y,x as ot,n as e,f as Z,F as lt,t as ct,A as y,i as N,L as c,k as R,h as s,_ as dt,p as V,U as it,P as pt,H as rt,l as tt,S as v,m as D}from"./index-7wnt1Cyk.js";import{c as C}from"./cls-S9IiI6wd.js";import{C as bt}from"./CloseOutlined-C4ZHTMg1.js";import{P as ut}from"./PlusOutlined-_DZZNOJ9.js";import{a as mt,A as kt}from"./AppleOutlined-mr92mEwl.js";const m=g({name:"Tabs",props:{activeKey:String,defaultActiveKey:String,type:{type:String,default:"line"},size:String,tabPosition:{type:String,default:"top"},centered:Boolean,items:Array,animated:{type:[Boolean,Object],default:!0},tabBarExtraContent:[Object,Function],tabBarGutter:Number,tabBarStyle:Object,hideAdd:Boolean,addIcon:Object,removeIcon:Object,destroyInactiveTabPane:Boolean,classNames:Object,styles:Object},emits:["update:activeKey","change","tabClick","edit"],setup(t,{slots:o,emit:d}){var M,G;const n=st("tabs"),a=q(t.defaultActiveKey??((G=(M=t.items)==null?void 0:M[0])==null?void 0:G.key)??""),p=q(null),u=q(null);Y(()=>t.activeKey,i=>{i!==void 0&&(a.value=i)});const k=Z(()=>t.activeKey!==void 0?t.activeKey:a.value),x=Z(()=>typeof t.animated=="boolean"?{inkBar:t.animated,tabPane:t.animated}:{inkBar:!0,tabPane:!1,...t.animated}),T=()=>{if(!p.value||!u.value||t.type!=="line")return;const i=p.value.querySelector(`.${n}-tab-active`);if(!i)return;t.tabPosition==="left"||t.tabPosition==="right"?(u.value.style.top=`${i.offsetTop}px`,u.value.style.height=`${i.offsetHeight}px`,u.value.style.width="2px",u.value.style.left=t.tabPosition==="left"?"auto":"0",u.value.style.right=t.tabPosition==="left"?"0":"auto"):(u.value.style.left=`${i.offsetLeft}px`,u.value.style.width=`${i.offsetWidth}px`,u.value.style.height="2px",u.value.style.top="auto",u.value.style.bottom="0")};Y(k,()=>{ct(T)}),ot(()=>{T()});const j=(i,r)=>{a.value=i,d("update:activeKey",i),d("change",i),d("tabClick",i,r)},nt=i=>{d("edit",i,"add")},at=(i,r)=>{r.stopPropagation(),d("edit",i,"remove")},et=(i,r,_)=>{var O,$,A;const f=t.items??[];let b=_;if(r.key==="ArrowLeft"||r.key==="ArrowUp")r.preventDefault(),b=_-1,b<0&&(b=f.length-1);else if(r.key==="ArrowRight"||r.key==="ArrowDown")r.preventDefault(),b=_+1,b>=f.length&&(b=0);else if(r.key==="Enter"||r.key===" "){r.preventDefault(),f[_].disabled||j(i,r);return}else return;let K=0;for(;(O=f[b])!=null&&O.disabled&&K<f.length;)b=r.key==="ArrowLeft"||r.key==="ArrowUp"?b-1:b+1,b<0&&(b=f.length-1),b>=f.length&&(b=0),K++;if(!(($=f[b])!=null&&$.disabled)){const P=(A=p.value)==null?void 0:A.querySelectorAll(`.${n}-tab`)[b];P==null||P.focus()}};return()=>{var $,A,P,F,L,U,H,W;const i=t.items??[],r=t.type==="editable-card",_=t.size?`${n}-${t.size}`:"",f=t.tabPosition!=="top"?`${n}-${t.tabPosition}`:"",b=t.tabPosition==="left"||t.tabPosition==="right",K=t.tabBarGutter!==void 0?b?{marginBottom:`${t.tabBarGutter}px`}:{marginRight:`${t.tabBarGutter}px`}:{},O=()=>{if(!t.tabBarExtraContent)return null;if(typeof t.tabBarExtraContent=="object"&&"left"in t.tabBarExtraContent){const l=t.tabBarExtraContent;return e(lt,null,[l.left&&e("div",{class:`${n}-extra-content-left`},[l.left]),l.right&&e("div",{class:`${n}-extra-content-right`},[l.right])])}return e("div",{class:`${n}-extra-content`},[t.tabBarExtraContent])};return e("div",{class:C(n,`${n}-${t.type}`,_,f,{[`${n}-centered`]:t.centered},($=t.classNames)==null?void 0:$.root),style:(A=t.styles)==null?void 0:A.root},[e("div",{class:C(`${n}-nav`,(P=t.classNames)==null?void 0:P.nav),style:{...t.tabBarStyle,...(F=t.styles)==null?void 0:F.nav}},[O(),e("div",{class:`${n}-nav-wrap`},[e("div",{ref:p,class:`${n}-nav-list`,role:"tablist","aria-orientation":b?"vertical":"horizontal"},[i.map((l,h)=>{var B,S,I,J,Q,X;const w=l.key===k.value,z=r&&l.closable!==!1;return e("div",{key:l.key,id:`tab-${l.key}`,class:C(`${n}-tab`,{[`${n}-tab-active`]:w,[`${n}-tab-disabled`]:l.disabled},(B=t.classNames)==null?void 0:B.tab,w&&((S=t.classNames)==null?void 0:S.tabActive)),style:{...h<i.length-1?K:void 0,...(I=t.styles)==null?void 0:I.tab,...w?(J=t.styles)==null?void 0:J.tabActive:void 0},role:"tab","aria-selected":w,"aria-controls":`tabpanel-${l.key}`,"aria-disabled":l.disabled||void 0,tabindex:l.disabled?-1:w?0:-1,onClick:E=>!l.disabled&&j(l.key,E),onKeydown:E=>et(l.key,E,h)},[e("div",{class:`${n}-tab-btn`},[l.icon&&e("span",{class:C(`${n}-tab-icon`,(Q=t.classNames)==null?void 0:Q.tabIcon),style:(X=t.styles)==null?void 0:X.tabIcon},[l.icon]),l.label,z&&e("button",{type:"button",class:`${n}-tab-remove`,"aria-label":"remove",tabindex:-1,onClick:E=>at(l.key,E)},[l.closeIcon||t.removeIcon||e(bt,{class:"hmfw-icon"},null)])])])}),r&&!t.hideAdd&&e("button",{type:"button",class:`${n}-nav-add`,"aria-label":"add",onClick:nt},[t.addIcon||e(ut,{class:"hmfw-icon"},null)])]),t.type==="line"&&e("div",{ref:u,class:C(`${n}-ink-bar`,{[`${n}-ink-bar-animated`]:x.value.inkBar},(L=t.classNames)==null?void 0:L.inkBar),style:(U=t.styles)==null?void 0:U.inkBar},null)])]),e("div",{class:`${n}-content-holder`},[e("div",{class:C(`${n}-content`,{[`${n}-content-animated`]:x.value.tabPane},(H=t.classNames)==null?void 0:H.content),style:(W=t.styles)==null?void 0:W.content},[i.map(l=>{var B,S,I;const h=l.key===k.value,w=h||l.forceRender||!t.destroyInactiveTabPane,z=t.destroyInactiveTabPane&&!h&&!l.forceRender;return e("div",{key:l.key,id:`tabpanel-${l.key}`,class:C(`${n}-tabpane`,{[`${n}-tabpane-active`]:h,[`${n}-tabpane-hidden`]:!h},(B=t.classNames)==null?void 0:B.tabpane),style:(S=t.styles)==null?void 0:S.tabpane,role:"tabpanel","aria-labelledby":`tab-${l.key}`,tabindex:h?0:-1,hidden:!h||void 0},[w&&!z&&(l.children??((I=o[l.key])==null?void 0:I.call(o)))])})])])])}}}),ft=g({__name:"TabsBasic",setup(t){const o=[{key:"1",label:"Tab 1",children:"Content of Tab Pane 1"},{key:"2",label:"Tab 2",children:"Content of Tab Pane 2"},{key:"3",label:"Tab 3",children:"Content of Tab Pane 3"}],d=n=>{console.log("Active tab:",n)};return(n,a)=>(y(),N(c(m),{items:o,onChange:d}))}}),gt=`<template>
...
<\/script>
`,yt=g({__name:"TabsCard",setup(t){const o=[{key:"1",label:"Tab 1",children:"Content of Tab Pane 1"},{key:"2",label:"Tab 2",children:"Content of Tab Pane 2"},{key:"3",label:"Tab 3",children:"Content of Tab Pane 3"}];return(d,n)=>(y(),N(c(m),{type:"card",items:o}))}}),ht=`<template>
...
<\/script>
`,vt=g({__name:"TabsCentered",setup(t){const o=[{key:"1",label:"Tab 1",children:"Content of Tab 1"},{key:"2",label:"Tab 2",children:"Content of Tab 2"},{key:"3",label:"Tab 3",children:"Content of Tab 3"}];return(d,n)=>(y(),N(c(m),{items:o,centered:""}))}}),Tt=`<template>
...
<\/script>
`,xt={class:"demo-tabs-classnames"},wt={class:"demo-section"},Ct={class:"demo-section"},_t={class:"demo-section"},Pt={class:"demo-section"},qt={class:"demo-section"},Nt={class:"demo-section"},$t={class:"demo-section"},At=g({__name:"TabsClassNames",setup(t){const o=[{key:"1",label:"标签一",children:"这是标签一的内容面板"},{key:"2",label:"标签二",children:"这是标签二的内容面板"},{key:"3",label:"标签三",children:"这是标签三的内容面板"}];return(d,n)=>(y(),R("div",xt,[s("section",wt,[n[0]||(n[0]=s("h3",null,"1. 自定义根节点样式",-1)),e(c(m),{items:o,"class-names":{root:"custom-root"}})]),s("section",Ct,[n[1]||(n[1]=s("h3",null,"2. 自定义标签栏样式",-1)),e(c(m),{items:o,"class-names":{nav:"custom-nav"}})]),s("section",_t,[n[2]||(n[2]=s("h3",null,"3. 自定义标签项与激活态",-1)),e(c(m),{items:o,"class-names":{tab:"custom-tab",tabActive:"custom-tab-active"}})]),s("section",Pt,[n[3]||(n[3]=s("h3",null,"4. 自定义墨条样式",-1)),e(c(m),{items:o,"class-names":{inkBar:"custom-inkbar"}})]),s("section",qt,[n[4]||(n[4]=s("h3",null,"5. 自定义内容区域样式",-1)),e(c(m),{items:o,"class-names":{content:"custom-content",tabpane:"custom-tabpane"}})]),s("section",Nt,[n[5]||(n[5]=s("h3",null,"6. 组合使用多个 classNames",-1)),e(c(m),{items:o,"class-names":{root:"combined-root",nav:"combined-nav",tab:"combined-tab",tabActive:"combined-tab-active",inkBar:"combined-inkbar",content:"combined-content"}})]),s("section",$t,[n[6]||(n[6]=s("h3",null,"7. 使用 styles 动态样式",-1)),e(c(m),{items:o,styles:{root:{border:"2px solid #1890ff",borderRadius:"12px",padding:"12px"},nav:{background:"linear-gradient(135deg, #667eea 0%, #764ba2 100%)",borderRadius:"8px"},content:{padding:"16px",background:"#f0f2f5",borderRadius:"8px",marginTop:"12px"}}})])]))}}),Bt=dt(At,[["__scopeId","data-v-5c7ab74c"]]),St=`<template>
...
<\/script>
`,Kt=g({__name:"TabsExtra",setup(t){const o=[{key:"1",label:"Tab 1",children:"Content of Tab 1"},{key:"2",label:"Tab 2",children:"Content of Tab 2"},{key:"3",label:"Tab 3",children:"Content of Tab 3"}],d=V("button",{style:"margin-left: 16px"},"Extra Action");return(n,a)=>(y(),N(c(m),{items:o,"tab-bar-extra-content":c(d)},null,8,["tab-bar-extra-content"]))}}),Ot=`<template>
...
<\/script>
`,Rt=g({__name:"TabsIcon",setup(t){const o=[{key:"1",label:"Tab 1",icon:V(mt,{class:"hmfw-icon"}),children:"Content of Tab 1"},{key:"2",label:"Tab 2",icon:V(kt,{class:"hmfw-icon"}),children:"Content of Tab 2"}];return(d,n)=>(y(),N(c(m),{items:o}))}}),zt=`<template>
  <Tabs :items="items" />
</template>
...
<\/script>
`,Dt={style:{"margin-bottom":"16px"}},Vt=g({__name:"TabsPosition",setup(t){const o=q("top"),d=[{key:"1",label:"Tab 1",children:"Content of Tab 1"},{key:"2",label:"Tab 2",children:"Content of Tab 2"},{key:"3",label:"Tab 3",children:"Content of Tab 3"}];return(n,a)=>(y(),R("div",null,[s("div",Dt,[a[2]||(a[2]=s("span",null,"Tab Position: ",-1)),it(s("select",{"onUpdate:modelValue":a[0]||(a[0]=p=>o.value=p)},[...a[1]||(a[1]=[s("option",{value:"top"},"top",-1),s("option",{value:"bottom"},"bottom",-1),s("option",{value:"left"},"left",-1),s("option",{value:"right"},"right",-1)])],512),[[pt,o.value]])]),e(c(m),{items:d,"tab-position":o.value},null,8,["tab-position"])]))}}),jt=`<template>
  <div>
...
<\/script>
`,Mt=g({__name:"TabsSize",setup(t){const o=[{key:"1",label:"Tab 1",children:"Content of Tab 1"},{key:"2",label:"Tab 2",children:"Content of Tab 2"},{key:"3",label:"Tab 3",children:"Content of Tab 3"}];return(d,n)=>(y(),R("div",null,[e(c(m),{items:o,size:"small",style:{"margin-bottom":"16px"}}),e(c(m),{items:o,style:{"margin-bottom":"16px"}}),e(c(m),{items:o,size:"large"})]))}}),Gt=`<template>
  <div>
