import{B as g}from"./Button-dLk1ExkL.js";import{M as y}from"./Menu-DmbPpS6q.js";import{n as m,z as a,j as b,m as l,J as o,Q as c,l as f,I as v,g as t,u as x,D as p,o as k,h as M,R as _,N as S,G as w,k as K}from"./index-DBrYVvYd.js";import"./icons-CTzpiRs0.js";import"./cls-S9IiI6wd.js";import"./Icon-CiCvy_Uq.js";const I=m({__name:"MenuCollapsed",setup(u){const n=p(!1),s=p(["1"]),i=[{key:"1",label:"导航一",icon:"home"},{key:"2",label:"导航二",icon:"user"},{key:"3",label:"导航三",icon:"setting"}],e=({key:d})=>{s.value=[d]};return(d,r)=>(a(),b("div",null,[l(o(g),{type:"primary",style:{"margin-bottom":"16px"},onClick:r[0]||(r[0]=h=>n.value=!n.value)},{default:c(()=>[f(v(n.value?"展开":"折叠"),1)]),_:1}),t("div",{style:x({width:n.value?"80px":"256px",borderRight:"1px solid #f0f0f0",transition:"width 0.2s"})},[l(o(y),{mode:"inline",items:i,"selected-keys":s.value,"inline-collapsed":n.value,onSelect:e},null,8,["selected-keys","inline-collapsed"])],4)]))}}),T=`<template>
  <div>
