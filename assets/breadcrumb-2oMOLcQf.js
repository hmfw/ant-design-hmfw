...
<\/script>
`,yt=k({__name:"BreadcrumbIcon",setup(n){const e=[{title:O(V,{component:st}),href:"/"},{title:O("span",{},[O(V,{component:et}),O("span",{style:{marginLeft:"4px"}},"用户列表")]),href:"/users"},{title:"用户详情"}];return(a,r)=>(g(),B(l(i),{items:e}))}}),xt=`<template>
  <Breadcrumb :items="items" />
</template>
