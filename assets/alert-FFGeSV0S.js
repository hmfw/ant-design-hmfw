import{d as k,u as Y,c as n,r as W,a as v,o as f,b as y,e as o,f as e,w as m,g as u,_ as Z,h as tt,i as nt}from"./index-DZWA4HiS.js";import{C as st}from"./CloseCircleFilled-DiZVqLZC.js";import{C as et}from"./CheckCircleFilled-I8UqTjtq.js";import{C as at}from"./CloseOutlined-Kr3orOYj.js";import{E as ot}from"./ExclamationCircleFilled-C-dhOcMX.js";import{I as lt}from"./InfoCircleFilled-BWvrjuRC.js";import{c as g}from"./cls-S9IiI6wd.js";import{B as ct}from"./Button-BJ4qjE3i.js";import"./LoadingOutlined-_M72e6LV.js";const rt={success:et,info:lt,warning:ot,error:st};function h(t){return Object.prototype.toString.call(t)==="[object Object]"}const c=k({name:"Alert",props:{type:{type:String,default:void 0},variant:{type:String,default:"outlined"},title:String,message:String,description:String,showIcon:{type:Boolean,default:void 0},closable:{type:[Boolean,Object],default:void 0},closeText:[String,Object,Array,Function],closeIcon:[String,Object,Array,Function],icon:[String,Object,Array,Function],banner:Boolean,action:[String,Object,Array,Function],role:{type:String,default:"alert"},classNames:Object,styles:Object},emits:["close","afterClose"],setup(t,{slots:a,emit:l}){const i=Y("alert"),s=W(!1),p=W(!1),L=v(()=>t.type!==void 0?t.type:t.banner?"warning":"info"),w=v(()=>t.banner&&t.showIcon===void 0?!0:!!t.showIcon),G=v(()=>t.title??t.message),H=v(()=>{const{closable:r,closeText:d,closeIcon:b}=t;return h(r)||d!=null&&d!==""?!0:typeof r=="boolean"?r:b!=null}),J=v(()=>{const{closable:r,closeText:d,closeIcon:b}=t;if(h(r)&&r.closeIcon!=null)return r.closeIcon;if(d!=null&&d!=="")return d;if(b!=null)return b;if(a.closeIcon)return a.closeIcon()}),K=v(()=>{const{closable:r}=t;return h(r)&&typeof r["aria-label"]=="string"?r["aria-label"]:"关闭"}),Q=r=>{p.value=!0,l("close",r),setTimeout(()=>{s.value=!0,l("afterClose")},300)};return()=>{var N,C,S,I,_,q,$,B,F,E,T,O,P,j,D,V,z,M,R;if(s.value)return null;const r=L.value,d=!!(t.description||a.description),b=rt[r],U=t.icon??((N=a.icon)==null?void 0:N.call(a))??n(b,null,null),X=J.value??n(at,null,null),x=((C=a.message)==null?void 0:C.call(a))??((S=a.title)==null?void 0:S.call(a))??G.value,A=t.action??((I=a.action)==null?void 0:I.call(a));return n("div",{role:t.role,"aria-live":r==="error"||r==="warning"?"assertive":"polite","data-show":!s.value,class:g(i,`${i}-${r}`,`${i}-${t.variant}`,{[`${i}-with-description`]:d,[`${i}-banner`]:t.banner,[`${i}-closing`]:p.value,[`${i}-no-icon`]:!w.value},(_=t.classNames)==null?void 0:_.root),style:(q=t.styles)==null?void 0:q.root},[w.value&&n("span",{class:g(`${i}-icon`,($=t.classNames)==null?void 0:$.icon),style:(B=t.styles)==null?void 0:B.icon},[U]),n("div",{class:g(`${i}-section`,(F=t.classNames)==null?void 0:F.section),style:(E=t.styles)==null?void 0:E.section},[x!=null&&x!==""&&n("div",{class:g(`${i}-title`,(T=t.classNames)==null?void 0:T.title),style:(O=t.styles)==null?void 0:O.title},[x]),d&&n("div",{class:g(`${i}-description`,(P=t.classNames)==null?void 0:P.description),style:(j=t.styles)==null?void 0:j.description},[((D=a.description)==null?void 0:D.call(a))??t.description])]),A!=null&&n("div",{class:g(`${i}-actions`,(V=t.classNames)==null?void 0:V.actions),style:(z=t.styles)==null?void 0:z.actions},[A]),H.value&&n("button",{type:"button",tabindex:0,class:g(`${i}-close-icon`,(M=t.classNames)==null?void 0:M.closeIcon),style:(R=t.styles)==null?void 0:R.closeIcon,"aria-label":K.value,onClick:Q},[X])])}}}),it={style:{display:"flex","flex-direction":"column",gap:"12px"}},pt=k({__name:"AlertBanner",setup(t){return(a,l)=>(f(),y("div",it,[n(o(c),{banner:"",message:"顶部公告：banner 模式默认显示图标，类型默认为 warning。"}),n(o(c),{banner:"",type:"error",message:"错误公告"})]))}}),dt=`<template>
