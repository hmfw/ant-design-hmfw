import{o as E,q as me,O as pe,n as t,c as ie,f as y,E as H,P as ye,F as fe,e as ke,B as he,A as $,i as F,Q as c,L as d,h as o,k as M,_ as ge,p as ve,H as be,m as _,l as xe}from"./index-CEDKhEzr.js";import{c as p}from"./cls-S9IiI6wd.js";import{R as Q}from"./RightOutlined-n7eN4wji.js";import{D as Ce}from"./DownOutlined-BVXNUlD5.js";const C={onBeforeEnter(e){const s=e;s.style.height="0",s.style.opacity="0"},onEnter(e){const s=e,l=s.scrollHeight;s.offsetHeight,s.style.height=`${l}px`,s.style.opacity="1"},onAfterEnter(e){const s=e;s.style.height="",s.style.opacity=""},onBeforeLeave(e){const s=e;s.style.height=`${s.offsetHeight}px`,s.style.opacity="1"},onLeave(e){const s=e;s.offsetHeight,s.style.height="0",s.style.opacity="0"},onAfterLeave(e){const s=e;s.style.height="",s.style.opacity=""}},ue=Symbol("collapse-context"),we=E({name:"Collapse",props:{activeKey:[String,Array],defaultActiveKey:[String,Array],accordion:Boolean,bordered:{type:Boolean,default:!0},ghost:Boolean,size:{type:String,default:"middle"},expandIconPosition:{type:String,default:"start"},items:Array,destroyInactivePanel:Boolean,collapsible:String,expandIcon:Function,classNames:Object,styles:Object},emits:["update:activeKey","change"],setup(e,{slots:s,emit:l}){const n=pe("collapse"),a=u=>u?Array.isArray(u)?u:[u]:[],i=H(a(e.defaultActiveKey??e.activeKey)),f=y(()=>e.activeKey!==void 0),g=y(()=>f.value?a(e.activeKey):i.value);ye(()=>e.activeKey,u=>{u!==void 0&&(i.value=a(u))});const v=u=>{const b=g.value;let P;e.accordion?P=b.includes(u)?[]:[u]:P=b.includes(u)?b.filter(I=>I!==u):[...b,u],i.value=P,l("update:activeKey",P),l("change",P)};he(ue,{activeKeys:g,toggle:v,prefixCls:n,expandIconPosition:y(()=>e.expandIconPosition),collapsible:y(()=>e.collapsible),destroyInactivePanel:y(()=>e.destroyInactivePanel),expandIcon:y(()=>e.expandIcon),classNames:y(()=>e.classNames),styles:y(()=>e.styles)});const A=(u,b)=>e.expandIcon?e.expandIcon({isActive:u,panelKey:b}):t(Q,{class:"hmfw-icon",style:{transform:u?"rotate(90deg)":"rotate(0deg)"}},null);return()=>{var m,N,z;const u=e.items??[],b=(r,q)=>{const B=r.key!=null?String(r.key):String(q);return ke(r,{panelKey:B})},P=((m=s.default)==null?void 0:m.call(s))??[];let I=0;const U=P.flatMap(r=>r.type===fe&&Array.isArray(r.children)?r.children.map(q=>b(q,I++)):[b(r,I++)]),X=(r,q,B,w={})=>{var D,L,W,Y,G,J,Z,ee,te,ne,ae,se,oe,le;const x=g.value.includes(r),T=x||!e.destroyInactivePanel||w.forceRender,S=w.collapsible??e.collapsible,K=w.disabled||S==="disabled",R=!K&&S!=="icon",O=!K&&(S==="icon"||S==="header"||S===void 0),j=!w.forceRender;return t("div",{key:r,class:p(`${n}-item`,(D=e.classNames)==null?void 0:D.item,{[`${n}-item-active`]:x,[`${n}-item-disabled`]:K}),style:{...w.style,...(L=e.styles)==null?void 0:L.item}},[t("div",{class:p(`${n}-header`,(W=e.classNames)==null?void 0:W.header),onClick:()=>R&&v(r),role:"button","aria-expanded":x,"aria-disabled":K,style:{cursor:R?"pointer":"default",...(Y=e.styles)==null?void 0:Y.header}},[w.showArrow!==!1&&t("span",{class:p(`${n}-expand-icon`,(G=e.classNames)==null?void 0:G.icon,{[`${n}-expand-icon-active`]:x}),onClick:V=>{S==="icon"&&O&&(V.stopPropagation(),v(r))},style:{cursor:O&&S==="icon"?"pointer":"inherit",...(J=e.styles)==null?void 0:J.icon}},[A(x,r)]),t("span",{class:p(`${n}-header-text`,(Z=e.classNames)==null?void 0:Z.headerText),style:(ee=e.styles)==null?void 0:ee.headerText},[q]),w.extra&&t("span",{class:p(`${n}-extra`,(te=e.classNames)==null?void 0:te.extra),style:(ne=e.styles)==null?void 0:ne.extra},[w.extra])]),j?t(ie,{name:`${n}-motion`,onBeforeEnter:C.onBeforeEnter,onEnter:C.onEnter,onAfterEnter:C.onAfterEnter,onBeforeLeave:C.onBeforeLeave,onLeave:C.onLeave,onAfterLeave:C.onAfterLeave},{default:()=>{var V,de,ce,re;return[T&&x&&t("div",{class:p(`${n}-content`,(V=e.classNames)==null?void 0:V.content),role:"region",style:(de=e.styles)==null?void 0:de.content},[t("div",{class:p(`${n}-content-box`,(ce=e.classNames)==null?void 0:ce.body),style:(re=e.styles)==null?void 0:re.body},[B])])]}}):T&&t("div",{class:p(`${n}-content`,(ae=e.classNames)==null?void 0:ae.content,{[`${n}-content-hidden`]:!x}),role:"region",style:{height:x?void 0:"0",opacity:x?void 0:"0",...(se=e.styles)==null?void 0:se.content}},[t("div",{class:p(`${n}-content-box`,(oe=e.classNames)==null?void 0:oe.body),style:(le=e.styles)==null?void 0:le.body},[B])])])};return t("div",{class:p(n,(N=e.classNames)==null?void 0:N.root,{[`${n}-borderless`]:!e.bordered,[`${n}-ghost`]:e.ghost,[`${n}-${e.size}`]:e.size!=="middle",[`${n}-icon-position-end`]:e.expandIconPosition==="end"}),style:(z=e.styles)==null?void 0:z.root},[u.map(r=>X(r.key,r.label,r.children,{disabled:r.disabled,showArrow:r.showArrow,extra:r.extra,collapsible:r.collapsible,style:r.style,forceRender:r.forceRender})),U])}}}),h=E({name:"CollapsePanel",props:{header:String,disabled:Boolean,showArrow:{type:Boolean,default:!0},extra:[String,Object],forceRender:Boolean,collapsible:String,panelKey:String,classNames:Object,styles:Object},setup(e,{slots:s,attrs:l}){const n=me(ue,null);if(!n){const m=pe("collapse");return()=>{var N,z,r,q,B,w,x,T,S,K,R,O,j,D,L;return t("div",{class:p(`${m}-item`,(N=e.classNames)==null?void 0:N.item),style:(z=e.styles)==null?void 0:z.item},[t("div",{class:p(`${m}-header`,(r=e.classNames)==null?void 0:r.header),style:(q=e.styles)==null?void 0:q.header},[e.showArrow&&t("span",{class:p(`${m}-expand-icon`,(B=e.classNames)==null?void 0:B.icon),style:(w=e.styles)==null?void 0:w.icon},[t(Q,{class:"hmfw-icon"},null)]),t("span",{class:p(`${m}-header-text`,(x=e.classNames)==null?void 0:x.headerText),style:(T=e.styles)==null?void 0:T.headerText},[e.header]),e.extra&&t("span",{class:p(`${m}-extra`,(S=e.classNames)==null?void 0:S.extra),style:(K=e.styles)==null?void 0:K.extra},[e.extra])]),t("div",{class:p(`${m}-content ${m}-content-active`,(R=e.classNames)==null?void 0:R.content),style:(O=e.styles)==null?void 0:O.content},[t("div",{class:p(`${m}-content-box`,(j=e.classNames)==null?void 0:j.body),style:(D=e.styles)==null?void 0:D.body},[(L=s.default)==null?void 0:L.call(s)])])])}}const a=y(()=>e.panelKey??l.key??""),i=y(()=>n.activeKeys.value.includes(a.value)),f=n.prefixCls,g=y(()=>{var m;return{...(m=n.classNames)==null?void 0:m.value,...e.classNames}}),v=y(()=>{var m;return{...(m=n.styles)==null?void 0:m.value,...e.styles}}),A=y(()=>e.collapsible??n.collapsible.value),u=y(()=>e.disabled||A.value==="disabled"),b=y(()=>!u.value&&A.value!=="icon"),P=y(()=>!u.value&&A.value!=="disabled"),I=y(()=>i.value||!n.destroyInactivePanel.value||e.forceRender),U=y(()=>!e.forceRender),X=()=>n.expandIcon.value?n.expandIcon.value({isActive:i.value,panelKey:a.value}):t(Q,{class:"hmfw-icon",style:{transform:i.value?"rotate(90deg)":"rotate(0deg)"}},null);return()=>{var m;return t("div",{class:p(`${f}-item`,g.value.item,{[`${f}-item-active`]:i.value,[`${f}-item-disabled`]:u.value}),style:v.value.item},[t("div",{class:p(`${f}-header`,g.value.header),onClick:()=>b.value&&n.toggle(a.value),role:"button","aria-expanded":i.value,"aria-disabled":u.value,style:{cursor:b.value?"pointer":"default",...v.value.header}},[e.showArrow&&t("span",{class:p(`${f}-expand-icon`,g.value.icon,{[`${f}-expand-icon-active`]:i.value}),onClick:N=>{A.value==="icon"&&P.value&&(N.stopPropagation(),n.toggle(a.value))},style:{cursor:P.value&&A.value==="icon"?"pointer":"inherit",...v.value.icon}},[X()]),t("span",{class:p(`${f}-header-text`,g.value.headerText),style:v.value.headerText},[e.header]),e.extra&&t("span",{class:p(`${f}-extra`,g.value.extra),style:v.value.extra},[e.extra])]),U.value?t(ie,{name:`${f}-motion`,onBeforeEnter:C.onBeforeEnter,onEnter:C.onEnter,onAfterEnter:C.onAfterEnter,onBeforeLeave:C.onBeforeLeave,onLeave:C.onLeave,onAfterLeave:C.onAfterLeave},{default:()=>{var N;return[I.value&&i.value&&t("div",{class:p(`${f}-content`,g.value.content),role:"region",style:v.value.content},[t("div",{class:p(`${f}-content-box`,g.value.body),style:v.value.body},[(N=s.default)==null?void 0:N.call(s)])])]}}):I.value&&t("div",{class:p(`${f}-content`,g.value.content,{[`${f}-content-hidden`]:!i.value}),role:"region",style:{height:i.value?void 0:"0",opacity:i.value?void 0:"0",...v.value.content}},[t("div",{class:p(`${f}-content-box`,g.value.body),style:v.value.body},[(m=s.default)==null?void 0:m.call(s)])])])}}}),k=Object.assign(we,{Panel:h}),Pe=E({__name:"CollapseAccordion",setup(e){const s=H(["1"]);return(l,n)=>($(),F(d(k),{"active-key":s.value,"onUpdate:activeKey":n[0]||(n[0]=a=>s.value=a),accordion:""},{default:c(()=>[t(d(h),{key:"1",header:"面板标题 1"},{default:c(()=>[...n[1]||(n[1]=[o("p",null,"面板内容 1",-1)])]),_:1}),t(d(h),{key:"2",header:"面板标题 2"},{default:c(()=>[...n[2]||(n[2]=[o("p",null,"面板内容 2",-1)])]),_:1}),t(d(h),{key:"3",header:"面板标题 3"},{default:c(()=>[...n[3]||(n[3]=[o("p",null,"面板内容 3",-1)])]),_:1})]),_:1},8,["active-key"]))}}),Ne=`<template>
...
const activeKey = ref(['1'])
<\/script>
`,$e=E({__name:"CollapseBorderless",setup(e){const s=H(["1"]);return(l,n)=>($(),F(d(k),{"active-key":s.value,"onUpdate:activeKey":n[0]||(n[0]=a=>s.value=a),bordered:!1},{default:c(()=>[t(d(h),{key:"1",header:"面板标题 1"},{default:c(()=>[...n[1]||(n[1]=[o("p",null,"面板内容 1",-1)])]),_:1}),t(d(h),{key:"2",header:"面板标题 2"},{default:c(()=>[...n[2]||(n[2]=[o("p",null,"面板内容 2",-1)])]),_:1})]),_:1},8,["active-key"]))}}),qe=`<template>
...
`,_e={style:{display:"flex","flex-direction":"column",gap:"16px"}},ze="这个面板可以通过点击文本或图标来折叠",Te=E({__name:"CollapseCollapsible",setup(e){const s=[{key:"1",label:"点击文本或图标可折叠",children:ze}],l=[{key:"1",label:"只能点击图标折叠",children:"这个面板只能通过点击图标来折叠"}],n=[{key:"1",label:"无法折叠",children:"这个面板无法被折叠"}];return(a,i)=>($(),M("div",_e,[t(d(k),{collapsible:"header","default-active-key":["1"],items:s}),t(d(k),{collapsible:"icon","default-active-key":["1"],items:l}),t(d(k),{collapsible:"disabled",items:n})]))}}),Re=`<template>
...
<\/script>
`,Le=E({__name:"CollapseExtra",setup(e){const s=[{key:"1",label:"面板标题 1",children:"这是面板内容 1",extra:"额外内容"},{key:"2",label:"面板标题 2",children:"这是面板内容 2",extra:"更多"},{key:"3",label:"面板标题 3",children:"这是面板内容 3",showArrow:!1}];return(l,n)=>($(),F(d(k),{"default-active-key":["1"],items:s}))}}),Fe=`<template>
...
<\/script>
`,je={style:{display:"flex","flex-direction":"column",gap:"16px"}},Ve=E({__name:"CollapseSize",setup(e){const s=[{key:"1",label:"面板标题",children:"这是面板内容"}];return(l,n)=>($(),M("div",je,[t(d(k),{items:s,size:"small"}),t(d(k),{items:s,size:"middle"}),t(d(k),{items:s,size:"large"})]))}}),He=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px">
