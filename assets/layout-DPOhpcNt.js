...
<\/script>
`,fe={style:{"margin-bottom":"16px"}},ge=y({__name:"LayoutTheme",setup(d){const o=m("dark"),l=()=>{o.value=o.value==="dark"?"light":"dark"};return(s,e)=>(h(),D("div",null,[t("div",fe,[t("button",{style:{padding:"8px 16px",cursor:"pointer",border:"1px solid #d9d9d9","border-radius":"4px",background:"#fff"},onClick:l}," 切换主题 (当前: "+b(o.value==="dark"?"暗色":"亮色")+") ",1)]),n(r(c),{style:{"min-height":"400px"}},{default:a(()=>[n(r(H),{theme:o.value,collapsible:""},{default:a(()=>[...e[0]||(e[0]=[t("div",{style:{padding:"16px",color:"inherit"}},[t("div",{style:{"margin-bottom":"12px"}},"菜单项 1"),t("div",{style:{"margin-bottom":"12px"}},"菜单项 2"),t("div",{style:{"margin-bottom":"12px"}},"菜单项 3"),t("div",{style:{"margin-bottom":"12px"}},"菜单项 4")],-1)])]),_:1},8,["theme"]),n(r(c),null,{default:a(()=>[n(r(S),{style:{background:"#fff",padding:"0 24px","line-height":"64px","box-shadow":"0 1px 4px rgba(0, 21, 41, 0.08)"}},{default:a(()=>[...e[1]||(e[1]=[t("h2",{style:{margin:"0",color:"#000"}},"主题切换演示",-1)])]),_:1}),n(r(L),{style:{margin:"24px 16px",padding:"24px",background:"#fff"}},{default:a(()=>[...e[2]||(e[2]=[t("p",null,"侧边栏支持 light 和 dark 两种主题。",-1),t("p",null,"主题切换时，背景色、文字颜色和边框颜色会平滑过渡（0.3s），提供流畅的视觉体验。",-1),t("p",null,"宽度变化保持快速响应（0.2s），确保交互的即时反馈。",-1)])]),_:1})]),_:1})]),_:1})]))}}),ce=`<template>
  <div>
