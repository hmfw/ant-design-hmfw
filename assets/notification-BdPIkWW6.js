import{B as c}from"./Button-mNkoEchB.js";import{n as r}from"./notification-CSCsY4O6.js";import{o as x,A as f,k as m,n,K as d,R as s,m as o,p as b,H as C,l as k,h as l}from"./index-B09KCCs0.js";import{o as B,l as w}from"./icons-n88SZ_u-.js";import{I as y}from"./Icon-BGDem5mI.js";import"./cls-S9IiI6wd.js";const h={style:{display:"flex",gap:"8px","flex-wrap":"wrap"}},v=x({__name:"NotificationBasic",setup(g){function a(){r.success({message:"操作成功",description:"您的操作已成功完成，请查看详情。"})}function p(){r.error({message:"操作失败",description:"操作过程中发生错误，请稍后重试。"})}function e(){r.warning({message:"警告",description:"此操作存在风险，请谨慎操作。"})}function t(){r.info({message:"提示信息",description:"这是一条普通的提示信息。"})}return(i,u)=>(f(),m("div",h,[n(d(c),{onClick:a},{default:s(()=>[...u[0]||(u[0]=[o(" 成功 ",-1)])]),_:1}),n(d(c),{onClick:p},{default:s(()=>[...u[1]||(u[1]=[o(" 错误 ",-1)])]),_:1}),n(d(c),{onClick:e},{default:s(()=>[...u[2]||(u[2]=[o(" 警告 ",-1)])]),_:1}),n(d(c),{onClick:t},{default:s(()=>[...u[3]||(u[3]=[o(" 信息 ",-1)])]),_:1})]))}}),N=`<template>
