import{o as B,O as An,E as i,P as tn,n as l,m as v,f as T,t as yn,A as O,k as M,L as m,h as e,K as Dn,_ as Un,H as Vn,Q as E,l as Fn}from"./index-aeAUYztw.js";import{c as b}from"./cls-S9IiI6wd.js";import{T as Rn}from"./Trigger-DUHNd6y-.js";function A(n){return String(n).padStart(2,"0")}function W(n){if(!n)return{h:0,m:0,s:0};const d=n.toLowerCase(),c=d.includes("pm"),p=d.includes("am"),t=n.replace(/[^\d:]/g,"").split(":").map(w=>Number(w));let a=t[0]||0;const o=t[1]||0,k=t[2]||0;return c&&a<12&&(a+=12),p&&a===12&&(a=0),{h:a,m:o,s:k}}function en(n,d,c,p){const t=n>=12,a=n%12===0?12:n%12;return p.replace(/HH|H|hh|h|mm|m|ss|s|A|a/g,o=>{switch(o){case"HH":return A(n);case"H":return String(n);case"hh":return A(a);case"h":return String(a);case"mm":return A(d);case"m":return String(d);case"ss":return A(c);case"s":return String(c);case"A":return t?"PM":"AM";case"a":return t?"pm":"am";default:return o}})}function In(n){return/s/.test(n)}const x=B({name:"TimePicker",props:{value:String,defaultValue:String,format:{type:String,default:"HH:mm:ss"},disabled:Boolean,size:{type:String,default:"middle"},placeholder:{type:String,default:"请选择时间"},allowClear:{type:Boolean,default:!0},hourStep:{type:Number,default:1},minuteStep:{type:Number,default:1},secondStep:{type:Number,default:1},disabledTime:Function,hideDisabledOptions:Boolean,showNow:{type:Boolean,default:!0},use12Hours:Boolean,status:{type:String,default:""},open:{type:Boolean,default:void 0},needConfirm:{type:Boolean,default:!0},changeOnScroll:Boolean,renderExtraFooter:Function,variant:{type:String,default:"outlined"},placement:{type:String,default:"bottomLeft"},classNames:Object,styles:Object},emits:["update:value","change","openChange","focus","blur"],setup(n,{emit:d,expose:c}){const p=An("time-picker"),t=W(n.defaultValue??n.value),a=i(t.h),o=i(t.m),k=i(t.s),w=i(t.h),N=i(t.m),q=i(t.s),j=i(!1),wn=i(),Q=i(),U=i(!!n.defaultValue||!!n.value),X=i(),Y=i(),G=i(),J=i(),z=T(()=>n.open!==void 0?n.open:j.value),an=T(()=>{if(n.value!==void 0){if(!n.value)return"";const s=W(n.value);return en(s.h,s.m,s.s,n.format)}return U.value?en(a.value,o.value,k.value,n.format):""}),y=T(()=>{if(n.value!==void 0){const s=W(n.value);return{h:s.h,m:s.m,s:s.s}}return n.needConfirm?{h:w.value,m:N.value,s:q.value}:{h:a.value,m:o.value,s:k.value}});tn(()=>n.value,s=>{if(s!==void 0)if(!s)a.value=0,o.value=0,k.value=0,w.value=0,N.value=0,q.value=0,U.value=!1;else{const r=W(s);a.value=r.h,o.value=r.m,k.value=r.s,w.value=r.h,N.value=r.m,q.value=r.s,U.value=!0}});const Sn=()=>{n.disabled||(n.needConfirm&&(w.value=a.value,N.value=o.value,q.value=k.value),j.value=!0,d("openChange",!0))},sn=()=>{n.needConfirm&&(w.value=a.value,N.value=o.value,q.value=k.value),j.value=!1,d("openChange",!1)},D=()=>{n.needConfirm&&(a.value=w.value,o.value=N.value,k.value=q.value);const s=en(a.value,o.value,k.value,n.format);U.value=!0,d("update:value",s),d("change",s,s),sn()},Pn=()=>{const s=new Date;n.needConfirm?(w.value=s.getHours(),N.value=s.getMinutes(),q.value=s.getSeconds()):(a.value=s.getHours(),o.value=s.getMinutes(),k.value=s.getSeconds()),n.needConfirm||D()},Cn=s=>{s.stopPropagation(),a.value=0,o.value=0,k.value=0,w.value=0,N.value=0,q.value=0,U.value=!1,d("update:value",void 0),d("change",void 0,"")},K=T(()=>{var s;return((s=n.disabledTime)==null?void 0:s.call(n))??{}}),Tn=T(()=>{var h,u;const s=((u=(h=K.value).disabledHours)==null?void 0:u.call(h))??[],r=n.use12Hours?12:24,g=[];for(let S=0;S<r;S+=n.hourStep)(!n.hideDisabledOptions||!s.includes(S))&&g.push(S);return g.map(S=>({value:S,disabled:s.includes(S)}))}),Nn=T(()=>{var g,h;const s=((h=(g=K.value).disabledMinutes)==null?void 0:h.call(g,y.value.h))??[],r=[];for(let u=0;u<60;u+=n.minuteStep)(!n.hideDisabledOptions||!s.includes(u))&&r.push(u);return r.map(u=>({value:u,disabled:s.includes(u)}))}),qn=T(()=>{var g,h;const s=((h=(g=K.value).disabledSeconds)==null?void 0:h.call(g,y.value.h,y.value.m))??[],r=[];for(let u=0;u<60;u+=n.secondStep)(!n.hideDisabledOptions||!s.includes(u))&&r.push(u);return r.map(u=>({value:u,disabled:s.includes(u)}))}),$n=T(()=>[{value:"AM",disabled:!1},{value:"PM",disabled:!1}]),L=T(()=>y.value.h>=12?"PM":"AM"),Z=T(()=>In(n.format));let _=0;const nn=i({}),$=(s,r,g)=>{s&&nn.value[g]!==r&&(nn.value[g]=r,_&&cancelAnimationFrame(_),_=requestAnimationFrame(()=>{const h=s.querySelector(`[data-value="${r}"]`);h&&typeof h.scrollIntoView=="function"&&h.scrollIntoView({block:"nearest",behavior:"smooth"})}))};tn(z,s=>{s?yn(()=>{const r=n.use12Hours?y.value.h%12||12:y.value.h;$(X.value,r,"h"),$(Y.value,y.value.m,"m"),Z.value&&$(G.value,y.value.s,"s"),n.use12Hours&&$(J.value,L.value,"p")}):nn.value={}}),tn(()=>[y.value.h,y.value.m,y.value.s,L.value],()=>{z.value&&yn(()=>{const s=n.use12Hours?y.value.h%12||12:y.value.h;$(X.value,s,"h"),$(Y.value,y.value.m,"m"),Z.value&&$(G.value,y.value.s,"s"),n.use12Hours&&$(J.value,L.value,"p")})});const Hn=(s,r)=>{r||(n.needConfirm?w.value=s:(a.value=s,n.changeOnScroll&&D()))},Bn=(s,r)=>{r||(n.needConfirm?N.value=s:(o.value=s,n.changeOnScroll&&D()))},On=(s,r)=>{r||(n.needConfirm?q.value=s:(k.value=s,n.changeOnScroll&&D()))},Mn=s=>{const r=s==="PM",g=n.needConfirm?w.value:a.value,h=g>=12;if(r!==h){const u=r?g+12:g-12;n.needConfirm?w.value=u:(a.value=u,n.changeOnScroll&&D())}};c({focus:()=>{var s;return(s=Q.value)==null?void 0:s.focus()},blur:()=>{var s;return(s=Q.value)==null?void 0:s.blur()}});const En=()=>{var s,r,g,h,u,S,V,F,R,I,on,ln,pn,dn,cn,rn,un,mn,kn,fn,vn,gn,bn,xn,hn;return l("div",{ref:wn,class:b(`${p}-popup`,(s=n.classNames)==null?void 0:s.popup),style:(r=n.styles)==null?void 0:r.popup},[l("div",{class:b(`${p}-panel`,(g=n.classNames)==null?void 0:g.panel),style:(h=n.styles)==null?void 0:h.panel},[l("div",{class:b(`${p}-panel-inner`,(u=n.classNames)==null?void 0:u.panelInner),style:(S=n.styles)==null?void 0:S.panelInner},[l("ul",{class:b(`${p}-panel-column`,(V=n.classNames)==null?void 0:V.column),style:(F=n.styles)==null?void 0:F.column,ref:X},[Tn.value.map(({value:f,disabled:P})=>{var C,H;return l("li",{key:f,"data-value":f,class:b(`${p}-panel-cell`,{[`${p}-panel-cell-selected`]:n.use12Hours?(y.value.h%12||12)===f:y.value.h===f,[`${p}-panel-cell-disabled`]:P},(C=n.classNames)==null?void 0:C.cell),style:(H=n.styles)==null?void 0:H.cell,onClick:()=>Hn(f,P)},[A(f)])})]),l("ul",{class:b(`${p}-panel-column`,(R=n.classNames)==null?void 0:R.column),style:(I=n.styles)==null?void 0:I.column,ref:Y},[Nn.value.map(({value:f,disabled:P})=>{var C,H;return l("li",{key:f,"data-value":f,class:b(`${p}-panel-cell`,{[`${p}-panel-cell-selected`]:y.value.m===f,[`${p}-panel-cell-disabled`]:P},(C=n.classNames)==null?void 0:C.cell),style:(H=n.styles)==null?void 0:H.cell,onClick:()=>Bn(f,P)},[A(f)])})]),Z.value&&l("ul",{class:b(`${p}-panel-column`,(on=n.classNames)==null?void 0:on.column),style:(ln=n.styles)==null?void 0:ln.column,ref:G},[qn.value.map(({value:f,disabled:P})=>{var C,H;return l("li",{key:f,"data-value":f,class:b(`${p}-panel-cell`,{[`${p}-panel-cell-selected`]:y.value.s===f,[`${p}-panel-cell-disabled`]:P},(C=n.classNames)==null?void 0:C.cell),style:(H=n.styles)==null?void 0:H.cell,onClick:()=>On(f,P)},[A(f)])})]),n.use12Hours&&l("ul",{class:b(`${p}-panel-column`,(pn=n.classNames)==null?void 0:pn.column),style:(dn=n.styles)==null?void 0:dn.column,ref:J},[$n.value.map(({value:f})=>{var P,C;return l("li",{key:f,"data-value":f,class:b(`${p}-panel-cell`,{[`${p}-panel-cell-selected`]:L.value===f},(P=n.classNames)==null?void 0:P.cell),style:(C=n.styles)==null?void 0:C.cell,onClick:()=>Mn(f)},[f])})])]),l("div",{class:b(`${p}-panel-footer`,(cn=n.classNames)==null?void 0:cn.footer),style:(rn=n.styles)==null?void 0:rn.footer},[l("div",{class:b(`${p}-panel-footer-extra`,(un=n.classNames)==null?void 0:un.footerExtra),style:(mn=n.styles)==null?void 0:mn.footerExtra},[(kn=n.renderExtraFooter)==null?void 0:kn.call(n)]),l("div",{class:b(`${p}-panel-footer-actions`,(fn=n.classNames)==null?void 0:fn.footerActions),style:(vn=n.styles)==null?void 0:vn.footerActions},[n.showNow&&l("button",{class:b(`${p}-panel-footer-btn`,(gn=n.classNames)==null?void 0:gn.now),style:(bn=n.styles)==null?void 0:bn.now,onClick:Pn},[v("此刻")]),n.needConfirm&&l("button",{class:b(`${p}-panel-footer-btn`,`${p}-panel-footer-ok`,(xn=n.classNames)==null?void 0:xn.ok),style:(hn=n.styles)==null?void 0:hn.ok,onClick:D},[v("确定")])])])])])};return()=>{var s,r,g,h;return l(Rn,{open:z.value,trigger:"click",placement:n.placement,disabled:n.disabled,destroyOnHidden:!0,triggerClass:b(p,`${p}-${n.size}`,`${p}-${n.variant}`,{[`${p}-open`]:z.value,[`${p}-disabled`]:n.disabled,[`${p}-status-error`]:n.status==="error",[`${p}-status-warning`]:n.status==="warning"},(s=n.classNames)==null?void 0:s.root),triggerStyle:(r=n.styles)==null?void 0:r.root,popupClass:b(`${p}-popup`,(g=n.classNames)==null?void 0:g.popup),popupStyle:(h=n.styles)==null?void 0:h.popup,onOpenChange:u=>{u?Sn():sn()}},{default:()=>{var u,S,V,F,R,I;return l("span",{class:b(`${p}-input`,(u=n.classNames)==null?void 0:u.input),style:(S=n.styles)==null?void 0:S.input},[l("input",{ref:Q,readonly:!0,placeholder:n.placeholder,value:an.value,disabled:n.disabled,class:`${p}-input-inner`,onFocus:()=>d("focus"),onBlur:()=>d("blur")},null),n.allowClear&&an.value&&!n.disabled&&l("span",{class:b(`${p}-clear`,(V=n.classNames)==null?void 0:V.clear),style:(F=n.styles)==null?void 0:F.clear,onClick:Cn},[v("✕")]),l("span",{class:b(`${p}-suffix`,(R=n.classNames)==null?void 0:R.suffix),style:(I=n.styles)==null?void 0:I.suffix},[v("🕐")])])},popup:({placement:u})=>En()})}}}),zn={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"300px"}},Ln=B({__name:"TimePickerBasic",setup(n){const d=i(""),c=i("10:30:00"),p=t=>{console.log("选中时间：",t)};return(t,a)=>(O(),M("div",zn,[l(m(x),{value:d.value,"onUpdate:value":a[0]||(a[0]=o=>d.value=o),placeholder:"请选择时间",onChange:p},null,8,["value"]),l(m(x),{value:c.value,"onUpdate:value":a[1]||(a[1]=o=>c.value=o),placeholder:"禁用状态",disabled:""},null,8,["value"]),e("p",null,"选中时间："+Dn(d.value),1)]))}}),Wn=`<template>
