...
<\/script>
`,W=g({__name:"FlexWrap",setup(t){return(p,e)=>(x(),u(l(r),{wrap:"",gap:"small",style:{"max-width":"400px"}},{default:f(()=>[(x(),k(w,null,S(12,s=>d("div",{key:s,style:{background:"#1677ff",color:"#fff",padding:"8px 16px","border-radius":"4px"}}," item "+_(s),1)),64))]),_:1}))}}),A=`<template>
...
import { Flex } from 'ant-design-hmfw'
<\/script>
`,D={class:"markdown-body"},T={__name:"flex",setup(t,{expose:p}){return p({frontmatter:{}}),(s,i)=>{const a=j("DemoBlock");return x(),k("div",D,[i[0]||(i[0]=v('<h1 id="flex-" tabindex="-1">Flex 弹性布局</h1><p>弹性布局。</p><h2 id="" tabindex="-1">何时使用</h2><ul><li>需要在水平或垂直方向上排列元素时</li><li>需要控制元素间距、对齐方式时</li><li>替代传统的 float 布局</li></ul><h2 id="-1" tabindex="-1">代码演示</h2><h3 id="-2" tabindex="-1">基础水平排列</h3><p>默认水平排列，通过 <code>justify</code> 和 <code>align</code> 控制对齐。</p>',7)),n(a,{title:"基础水平排列",source:l($)},{default:f(()=>[n(C)]),_:1},8,["source"]),i[1]||(i[1]=d("h3",{id:"-3",tabindex:"-1"},"垂直排列",-1)),i[2]||(i[2]=d("p",null,[o("通过 "),d("code",null,"vertical"),o(" 属性设置垂直方向排列。")],-1)),n(a,{title:"垂直排列",source:l(P)},{default:f(()=>[n(G)]),_:1},8,["source"]),i[3]||(i[3]=d("h3",{id:"-4",tabindex:"-1"},"间距设置",-1)),i[4]||(i[4]=d("p",null,[o("通过 "),d("code",null,"gap"),o(" 属性设置元素间距，支持预设值和数字。")],-1)),n(a,{title:"间距设置",source:l(V)},{default:f(()=>[n(N)]),_:1},8,["source"]),i[5]||(i[5]=d("h3",{id:"-5",tabindex:"-1"},"自动换行",-1)),i[6]||(i[6]=d("p",null,[o("通过 "),d("code",null,"wrap"),o(" 属性允许子元素换行。")],-1)),n(a,{title:"自动换行",source:l(A)},{default:f(()=>[n(W)]),_:1},8,["source"]),i[7]||(i[7]=v('<h2 id="api" tabindex="-1">API</h2><h3 id="flex-props" tabindex="-1">Flex Props</h3><table><thead><tr><th>参数</th><th>说明</th><th>类型</th><th>默认值</th></tr></thead><tbody><tr><td>vertical</td><td>是否垂直方向排列</td><td><code>boolean</code></td><td><code>false</code></td></tr><tr><td>wrap</td><td>是否自动换行</td><td><code>boolean | string</code></td><td><code>false</code></td></tr><tr><td>justify</td><td>主轴对齐方式</td><td><code>&#39;flex-start&#39; | &#39;center&#39; | &#39;flex-end&#39; | &#39;space-between&#39; | &#39;space-around&#39; | &#39;space-evenly&#39;</code></td><td><code>&#39;flex-start&#39;</code></td></tr><tr><td>align</td><td>交叉轴对齐方式</td><td><code>&#39;flex-start&#39; | &#39;center&#39; | &#39;flex-end&#39; | &#39;stretch&#39;</code></td><td><code>&#39;stretch&#39;</code></td></tr><tr><td>gap</td><td>子元素间距</td><td><code>&#39;small&#39; | &#39;middle&#39; | &#39;large&#39; | number</code></td><td>-</td></tr><tr><td>flex</td><td>flex CSS 简写属性</td><td><code>string | number</code></td><td>-</td></tr><tr><td>component</td><td>自定义元素类型</td><td><code>string</code></td><td><code>&#39;div&#39;</code></td></tr></tbody></table><h3 id="flex-slots" tabindex="-1">Flex Slots</h3><table><thead><tr><th>名称</th><th>说明</th></tr></thead><tbody><tr><td>default</td><td>子元素内容</td></tr></tbody></table>',5))])}}};export{T as default};
