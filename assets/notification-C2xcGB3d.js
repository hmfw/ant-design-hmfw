import{B as d}from"./Button-DUKwImBM.js";import{n as p}from"./notification-Dxu6iNY2.js";import{o as y,A as m,k as g,n as s,K as o,R as a,m as t,h as c,p as b,_ as N,H as C,l as x}from"./index-Dewmb7_Q.js";import{a as w,C as h}from"./CloseCircleFilled-BpmBEuxR.js";import{I as v}from"./Icon-Dgvr5Blx.js";import"./cls-S9IiI6wd.js";import"./LoadingOutlined-BZSBBEZE.js";import"./CloseOutlined-z6AYgBVy.js";import"./ExclamationCircleFilled-CD9d1U_k.js";import"./InfoCircleFilled-B9ruxdz4.js";const B={style:{display:"flex",gap:"8px","flex-wrap":"wrap"}},S=y({__name:"NotificationBasic",setup(k){function l(){p.success({message:"操作成功",description:"您的操作已成功完成，请查看详情。"})}function u(){p.error({message:"操作失败",description:"操作过程中发生错误，请稍后重试。"})}function e(){p.warning({message:"警告",description:"此操作存在风险，请谨慎操作。"})}function n(){p.info({message:"提示信息",description:"这是一条普通的提示信息。"})}return(i,f)=>(m(),g("div",B,[s(o(d),{onClick:l},{default:a(()=>[...f[0]||(f[0]=[t(" 成功 ",-1)])]),_:1}),s(o(d),{onClick:u},{default:a(()=>[...f[1]||(f[1]=[t(" 错误 ",-1)])]),_:1}),s(o(d),{onClick:e},{default:a(()=>[...f[2]||(f[2]=[t(" 警告 ",-1)])]),_:1}),s(o(d),{onClick:n},{default:a(()=>[...f[3]||(f[3]=[t(" 信息 ",-1)])]),_:1})]))}}),I=`<template>
...
`,q={style:{display:"flex",gap:"8px","flex-wrap":"wrap"}},T=y({__name:"NotificationCloseIcon",setup(k){function l(){p.info({message:"自定义关闭图标",description:"此通知使用了自定义的关闭图标（实心圆形关闭图标）。",closeIcon:()=>b(v,{component:w}),duration:0})}function u(){p.config({closeIcon:()=>b(v,{component:h})}),p.success({message:"全局关闭图标已设置",description:"所有新通知都将使用对勾图标作为关闭按钮，除非单独指定。",duration:3})}function e(){p.config({closeIcon:void 0}),p.info({message:"已重置为默认图标",description:"关闭图标已恢复为默认样式。",duration:3})}return(n,i)=>(m(),g("div",q,[s(o(d),{type:"primary",onClick:l},{default:a(()=>[...i[0]||(i[0]=[t(" 自定义关闭图标 ",-1)])]),_:1}),s(o(d),{onClick:u},{default:a(()=>[...i[1]||(i[1]=[t(" 设置全局关闭图标 ",-1)])]),_:1}),s(o(d),{onClick:e},{default:a(()=>[...i[2]||(i[2]=[t(" 重置全局配置 ",-1)])]),_:1})]))}}),W=`<template>
  <div style="display: flex; gap: 8px; flex-wrap: wrap">
...
<script setup lang="ts">
import { h } from 'vue'
import { notification, Button, Icon, CloseCircleFilled, CheckCircleFilled } from 'ant-design-hmfw'
...
<\/script>
`,_={style:{display:"flex",gap:"8px","flex-wrap":"wrap"}},V=y({__name:"NotificationConfig",setup(k){function l(){p.open({key:"updatable",message:"正在加载...",description:"请稍候，正在处理您的请求。",duration:0}),setTimeout(()=>{p.success({key:"updatable",message:"加载完成",description:"您的请求已处理完成！",duration:3})},2e3)}function u(){p.config({maxCount:3,top:100,duration:2}),p.info({message:"全局配置生效",description:"已设置：maxCount=3, top=100px, duration=2s"}),p.info({message:"通知 2",description:"这是第二条通知"}),p.info({message:"通知 3",description:"这是第三条通知"}),p.info({message:"通知 4",description:"这是第四条通知（第一条将被移除）"}),setTimeout(()=>{p.config({maxCount:void 0,top:24,duration:4.5})},3e3)}return(e,n)=>(m(),g("div",_,[s(o(d),{onClick:l},{default:a(()=>[...n[0]||(n[0]=[t(" 打开并更新 ",-1)])]),_:1}),s(o(d),{onClick:u},{default:a(()=>[...n[1]||(n[1]=[t(" 全局配置 ",-1)])]),_:1})]))}}),E=`<template>
  <div style="display: flex; gap: 8px; flex-wrap: wrap">
...
<\/script>
`,O={style:{display:"flex",gap:"8px","flex-wrap":"wrap"}},U=y({__name:"NotificationRtl",setup(k){function l(){p.config({rtl:!0}),p.success({message:"RTL 模式已启用",description:"通知现在将以从右到左的布局显示，适用于阿拉伯语等语言。图标和关闭按钮位置已自动调整。",duration:3})}function u(){p.config({rtl:!1}),p.info({message:"RTL 模式已禁用",description:"通知已恢复为默认的从左到右布局。",duration:3})}function e(){p.open({message:"测试通知",description:"这是一条测试通知，用于查看当前布局方向的效果。",duration:3})}return(n,i)=>(m(),g("div",O,[s(o(d),{type:"primary",onClick:l},{default:a(()=>[...i[0]||(i[0]=[t(" 启用 RTL 模式 ",-1)])]),_:1}),s(o(d),{onClick:u},{default:a(()=>[...i[1]||(i[1]=[t(" 禁用 RTL 模式 ",-1)])]),_:1}),s(o(d),{onClick:e},{default:a(()=>[...i[2]||(i[2]=[t(" 打开通知 ",-1)])]),_:1})]))}}),M=`<template>
  <div style="display: flex; gap: 8px; flex-wrap: wrap">
...
<\/script>
`,j={style:{display:"flex",gap:"8px","flex-wrap":"wrap"}},K=y({__name:"NotificationShowProgress",setup(k){function l(){p.success({message:"带进度条的通知",description:"此通知会在 5 秒后自动关闭，底部显示倒计时进度条。",duration:5,showProgress:!0})}function u(){p.info({message:"不带进度条的通知",description:"此通知 5 秒后关闭，但不显示进度条。",duration:5,showProgress:!1})}return(e,n)=>(m(),g("div",j,[s(o(d),{type:"primary",onClick:l},{default:a(()=>[...n[0]||(n[0]=[t(" 显示进度条 ",-1)])]),_:1}),s(o(d),{onClick:u},{default:a(()=>[...n[1]||(n[1]=[t(" 不显示进度条 ",-1)])]),_:1})]))}}),J=`<template>
  <div style="display: flex; gap: 8px; flex-wrap: wrap">
