import{m as E,L as z,O as F,l as o,B as v,d as j,y as N,i as L,f as i,H as _,I as g,E as I,j as D,P as T,k}from"./index-CsoOETlJ.js";import{c as S}from"./cls-S9IiI6wd.js";const p=E({name:"Slider",props:{value:[Number,Array],defaultValue:[Number,Array],min:{type:Number,default:0},max:{type:Number,default:100},step:{type:Number,default:1},disabled:Boolean,range:Boolean,vertical:Boolean,reverse:Boolean,marks:Object,tooltip:{type:Object},included:{type:Boolean,default:!0}},emits:["update:value","change","afterChange"],setup(e,{emit:u}){const l=z("slider"),b=v(null),t=v(null),d=v(null),$=e.defaultValue??e.value??(e.range?[0,0]:0),P=v($),R=j(()=>e.value!==void 0),V=j(()=>R.value?e.value:P.value);F(()=>e.value,n=>{n!==void 0&&(P.value=n)});const O=n=>Math.min(e.max,Math.max(e.min,n)),A=n=>{const a=Math.round((n-e.min)/e.step);return O(e.min+a*e.step)},C=n=>(n-e.min)/(e.max-e.min)*100,U=n=>{if(!b.value)return 0;const a=b.value.getBoundingClientRect(),r="touches"in n?n.touches[0].clientX:n.clientX,s="touches"in n?n.touches[0].clientY:n.clientY;let m;return e.vertical?m=e.reverse?(s-a.top)/a.height:1-(s-a.top)/a.height:m=e.reverse?1-(r-a.left)/a.width:(r-a.left)/a.width,m=Math.max(0,Math.min(1,m)),A(e.min+m*(e.max-e.min))},f=n=>{P.value=n,u("update:value",n),u("change",n)},X=n=>{if(e.disabled)return;const a=U(n);if(e.range){const[r,s]=V.value,m=Math.abs(a-r),x=Math.abs(a-s);m<=x?f([a,s]):f([r,a])}else f(a)},M=n=>a=>{if(e.disabled)return;a.preventDefault(),t.value=n,d.value=n;const r=m=>{const x=U(m);if(e.range){const[h,c]=V.value;f(n==="start"?[Math.min(x,c),c]:[h,Math.max(x,h)])}else f(x)},s=()=>{t.value=null,d.value=null,u("afterChange",V.value),document.removeEventListener("mousemove",r),document.removeEventListener("mouseup",s),document.removeEventListener("touchmove",r),document.removeEventListener("touchend",s)};document.addEventListener("mousemove",r),document.addEventListener("mouseup",s),document.addEventListener("touchmove",r),document.addEventListener("touchend",s)},w=n=>{var a,r;return((a=e.tooltip)==null?void 0:a.formatter)===null?null:(r=e.tooltip)!=null&&r.formatter?e.tooltip.formatter(n):String(n)};return()=>{const n=V.value,a=e.range?n[0]:n,r=e.range?n[1]:n,s=C(a),m=C(r),x=e.vertical?e.included?{bottom:`${e.range?s:0}%`,height:`${e.range?m-s:m}%`}:{}:e.included?{left:`${e.range?s:0}%`,width:`${e.range?m-s:m}%`}:{},h=e.marks?Object.entries(e.marks).map(([c,y])=>({value:Number(c),label:y})):[];return o("div",{class:S(l,{[`${l}-disabled`]:e.disabled,[`${l}-vertical`]:e.vertical,[`${l}-with-marks`]:h.length>0})},[o("div",{ref:b,class:`${l}-rail`,onClick:X},[o("div",{class:`${l}-track`,style:x},null),h.map(({value:c})=>{const y=C(c),B=e.vertical?{bottom:`${y}%`}:{left:`${y}%`};return o("span",{key:c,class:S(`${l}-dot`,{[`${l}-dot-active`]:e.range?c>=a&&c<=r:c<=r}),style:B},null)}),e.range&&o("div",{class:S(`${l}-handle`,`${l}-handle-1`,{[`${l}-handle-dragging`]:t.value==="start"}),style:e.vertical?{bottom:`${s}%`}:{left:`${s}%`},role:"slider","aria-label":"最小值","aria-orientation":e.vertical?"vertical":"horizontal","aria-valuemin":e.min,"aria-valuemax":r,"aria-valuenow":a,"aria-disabled":e.disabled,tabindex:e.disabled?-1:0,onMousedown:M("start"),onTouchstart:M("start"),onMouseenter:()=>{d.value="start"},onMouseleave:()=>{t.value!=="start"&&(d.value=null)}},[d.value==="start"&&w(a)!==null&&o("div",{class:`${l}-tooltip`},[w(a)])]),o("div",{class:S(`${l}-handle`,e.range?`${l}-handle-2`:"",{[`${l}-handle-dragging`]:t.value==="end"||!e.range&&t.value!==null}),style:e.vertical?{bottom:`${m}%`}:{left:`${m}%`},role:"slider","aria-label":e.range?"最大值":"滑块","aria-orientation":e.vertical?"vertical":"horizontal","aria-valuemin":e.range?a:e.min,"aria-valuemax":e.max,"aria-valuenow":r,"aria-disabled":e.disabled,tabindex:e.disabled?-1:0,onMousedown:M((e.range,"end")),onTouchstart:M((e.range,"end")),onMouseenter:()=>{d.value="end"},onMouseleave:()=>{t.value!=="end"&&(d.value=null)}},[d.value==="end"&&w(r)!==null&&o("div",{class:`${l}-tooltip`},[w(r)])])]),h.length>0&&o("div",{class:`${l}-mark`},[h.map(({value:c,label:y})=>{const B=C(c),Y=e.vertical?{bottom:`${B}%`}:{left:`${B}%`};return o("span",{key:c,class:S(`${l}-mark-text`,{[`${l}-mark-text-active`]:e.range?c>=a&&c<=r:c<=r}),style:Y,onClick:()=>!e.disabled&&f(c)},[y])})])])}}}),H={style:{display:"flex","flex-direction":"column",gap:"24px",padding:"0 16px"}},q={style:{"margin-bottom":"8px"}},G=E({__name:"SliderBasic",setup(e){const u=v(30),l=v(50);return(b,t)=>(N(),L("div",H,[i("div",null,[i("p",q,"基础滑块："+_(u.value),1),o(g(p),{value:u.value,"onUpdate:value":t[0]||(t[0]=d=>u.value=d)},null,8,["value"])]),i("div",null,[t[2]||(t[2]=i("p",{style:{"margin-bottom":"8px"}},"禁用状态：",-1)),o(g(p),{value:l.value,"onUpdate:value":t[1]||(t[1]=d=>l.value=d),disabled:""},null,8,["value"])])]))}}),J=`<template>
