...
import { Tooltip } from 'ant-design-hmfw'
<\/script>
`,P={class:"demo-dynamic-content"},M={style:{display:"flex",gap:"20px","margin-top":"20px"}},j=f({__name:"TooltipDynamicContent",setup(m){const i=g(!1),e=g(!1),b=T(()=>e.value?"这是一段很长的提示文字，用于演示当内容动态变化时，浮层位置会自动重新计算，确保不会溢出视口边界，提供更好的用户体验。":"短提示"),o=()=>{e.value=!e.value};return(r,u)=>(s(),a("div",P,[u[1]||(u[1]=t("p",null,"当浮层内容动态变化时，Tooltip 会通过 ResizeObserver 自动重新计算位置，确保浮层不会溢出视口。",-1)),t("div",M,[n(d(p),{title:b.value,placement:"top",open:i.value},{default:l(()=>[t("button",{onClick:u[0]||(u[0]=ot=>i.value=!i.value)},v(i.value?"关闭":"打开")+"提示",1)]),_:1},8,["title","open"]),t("button",{onClick:o},v(e.value?"切换为短内容":"切换为长内容"),1)]),u[2]||(u[2]=t("p",{style:{"margin-top":"20px",color:"#666","font-size":"12px"}}," 提示：打开浮层后切换内容长度，浮层位置会自动调整 ",-1))]))}}),G=x(j,[["__scopeId","data-v-11bf5039"]]),J=`<template>
