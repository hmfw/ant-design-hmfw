import{I as i,a as y,b,T as w}from"./Input-RQuQYnri.js";import{k as g,w as c,g as h,j as e,G as l,z as u,d as o,E as I,B as S,M as x,h as k}from"./index-DvxRruME.js";import"./cls-S9IiI6wd.js";const U={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"400px"}},A=g({__name:"InputAddon",setup(m){const d=u(""),s=u(""),a=u(""),t=u("");return(n,r)=>(c(),h("div",U,[e(l(i),{value:d.value,"onUpdate:value":r[0]||(r[0]=p=>d.value=p),placeholder:"请输入用户名",prefix:"👤"},null,8,["value"]),e(l(i),{value:s.value,"onUpdate:value":r[1]||(r[1]=p=>s.value=p),placeholder:"请输入金额",prefix:"¥",suffix:"元"},null,8,["value"]),e(l(i),{value:a.value,"onUpdate:value":r[2]||(r[2]=p=>a.value=p),placeholder:"带前置/后置标签","addon-before":"http://","addon-after":".com"},null,8,["value"]),e(l(i),{value:t.value,"onUpdate:value":r[3]||(r[3]=p=>t.value=p),placeholder:"支持清除","allow-clear":""},null,8,["value"])]))}}),P=`<template>
