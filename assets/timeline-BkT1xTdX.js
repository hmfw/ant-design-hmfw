import{d as m,u as H,c as a,O as X,F as Y,o as u,q as k,e as l,b as T,f as e,_ as G,h as J,w as g,g as f,i as K}from"./index-DZWA4HiS.js";import{c as b}from"./cls-S9IiI6wd.js";import{L as Q}from"./LoadingOutlined-_M72e6LV.js";function U(t){return t==="left"?"start":t==="right"?"end":t==="start"||t==="end"||t==="alternate"?t:"start"}function Z(t,s,o){return t.placement?t.placement:t.position==="left"?"start":t.position==="right"?"end":o==="alternate"?s%2===0?"start":"end":o}function j(t){if(!t)return[];const s=[];for(const o of t)if(o&&o.type!==X){if(o.type===Y&&Array.isArray(o.children)){s.push(...j(o.children));continue}o.props&&s.push(o.props)}return s}const tt=m({name:"TimelineItem",props:{title:[String,Object],content:[String,Object],icon:[String,Object],placement:String,loading:Boolean,label:[String,Object],children:null,dot:[String,Object],position:String,color:String,className:String,style:Object},setup(t,{slots:s}){return()=>{var o;return(o=s.default)==null?void 0:o.call(s)}}}),nt=m({name:"Timeline",props:{items:Array,mode:{type:String,default:"left"},orientation:{type:String,default:"vertical"},variant:{type:String,default:"outlined"},reverse:Boolean,titleSpan:[Number,String],pending:[Boolean,String,Object],pendingDot:[String,Object],classNames:Object,styles:Object},setup(t,{slots:s}){const o=H("timeline");return()=>{var q,N;const i=U(t.mode);let n=[];if(t.items)n=[...t.items];else if(s.default){const d=s.default();n=j(d)}if(t.pending){const d=typeof t.pending=="string"?t.pending:t.pending===!0?void 0:t.pending;n.push({content:d,icon:t.pendingDot,loading:!t.pendingDot,color:"gray"})}const p=t.reverse?[...n].reverse():n,S=b(o,{[`${o}-${t.orientation}`]:t.orientation==="horizontal",[`${o}-${i}`]:i!=="start",[`${o}-${t.variant}`]:t.variant!=="outlined",[`${o}-pending`]:!!t.pending,[`${o}-reverse`]:t.reverse},(q=t.classNames)==null?void 0:q.root),c={...(N=t.styles)==null?void 0:N.root};return t.titleSpan!==void 0&&i!=="alternate"&&(typeof t.titleSpan=="number"?c["--hmfw-timeline-title-span"]=`${t.titleSpan}px`:c["--hmfw-timeline-title-span"]=t.titleSpan),a("ul",{class:S,style:c},[p.map((d,y)=>{var $,z,I,P,O,B,V,D,E,F;const A=y===p.length-1,C=Z(d,y,i),_=d.title??d.label,L=d.content??d.children;let h=d.icon??d.dot;d.loading&&!h&&(h=a(Q,{class:"hmfw-icon hmfw-icon-spin"},null));const x=d.color??"blue",v=["blue","red","green","gray"].includes(x),W=!!h||d.loading,M=b(`${o}-item`,{[`${o}-item-last`]:A,[`${o}-item-${C}`]:C==="end",[`${o}-item-loading`]:d.loading},d.className,($=t.classNames)==null?void 0:$.item),R=b(`${o}-item-head`,{[`${o}-item-head-${x}`]:v,[`${o}-item-head-custom`]:W||!v},(z=t.classNames)==null?void 0:z.dot),w={...d.style,...(I=t.styles)==null?void 0:I.dot};return v||(w.borderColor=x,w.color=x),a("li",{key:d.key??y,class:M,style:(P=t.styles)==null?void 0:P.item},[_&&a("div",{class:b(`${o}-item-label`,(O=t.classNames)==null?void 0:O.label),style:(B=t.styles)==null?void 0:B.label},[_]),a("div",{class:b(`${o}-item-tail`,(V=t.classNames)==null?void 0:V.tail),style:(D=t.styles)==null?void 0:D.tail},null),a("div",{class:R,style:w},[h]),a("div",{class:b(`${o}-item-content`,(E=t.classNames)==null?void 0:E.content),style:(F=t.styles)==null?void 0:F.content},[L])])})])}}}),r=nt;r.Item=tt;const et=m({__name:"TimelineAlternate",setup(t){const s=[{content:"创建服务现场 2015-09-01"},{content:"初步排除网络异常 2015-09-01"},{content:"技术测试异常 2015-09-01"},{content:"网络异常正在修复 2015-09-01"}];return(o,i)=>(u(),k(l(r),{mode:"alternate",items:s}))}}),ot=`<template>
