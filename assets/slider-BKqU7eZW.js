...
<\/script>
`,Dn={style:{display:"flex","flex-direction":"column",gap:"40px",padding:"0 16px"}},Un={style:{"margin-bottom":"8px"}},Rn={style:{"margin-bottom":"8px"}},An=M({__name:"SliderMarks",setup(n){const u=b(37),s=b(0),v={0:"0°C",26:"26°C",37:"37°C",100:{label:"100°C",style:{color:"#f50"}}};return(a,o)=>(E(),V("div",Dn,[t("div",null,[t("p",Un,"带刻度标记："+q(u.value),1),p(r(k),{value:u.value,"onUpdate:value":o[0]||(o[0]=x=>u.value=x),marks:v},null,8,["value"])]),t("div",null,[t("p",Rn,"只能选择刻度点："+q(s.value),1),p(r(k),{value:s.value,"onUpdate:value":o[1]||(o[1]=x=>s.value=x),marks:v,step:null},null,8,["value"])])]))}}),On=`<template>
