import{S as Cs}from"./Space-3bEPr88J.js";import{o as H,O as ws,E as m,P as is,x as Ss,w as qs,n as l,m as B,f as U,A as T,i as ds,Q as L,L as b,h as i,K as Ns,k as ks,_ as Ps,H as Bs,l as $s}from"./index-Bxt2WIDN.js";import{c as k}from"./cls-S9IiI6wd.js";import{T as Es}from"./Trigger-Am0ZUlli.js";function Ms(s){const p=s.replace("#",""),a=p.length===3?p.split("").map(n=>n+n).join(""):p,d=parseInt(a,16);return{r:d>>16&255,g:d>>8&255,b:d&255}}function Ls({r:s,g:p,b:a}){return"#"+[s,p,a].map(d=>d.toString(16).padStart(2,"0")).join("")}function Hs({r:s,g:p,b:a}){const d=s/255,n=p/255,t=a/255,r=Math.max(d,n,t),g=Math.min(d,n,t),e=r-g;let c=0;e!==0&&(r===d?c=(n-t)/e%6:r===n?c=(t-d)/e+2:c=(d-n)/e+4,c=Math.round(c*60),c<0&&(c+=360));const v=r===0?0:Math.round(e/r*100),$=Math.round(r*100);return{h:c,s:v,b:$}}function Ts({h:s,s:p,b:a}){const d=p/100,n=a/100,t=n*d,r=t*(1-Math.abs(s/60%2-1)),g=n-t;let e=0,c=0,v=0;return s<60?(e=t,c=r):s<120?(e=r,c=t):s<180?(c=t,v=r):s<240?(c=r,v=t):s<300?(e=r,v=t):(e=t,v=r),{r:Math.round((e+g)*255),g:Math.round((c+g)*255),b:Math.round((v+g)*255)}}function Rs(s){return Ls(Ts(s))}function E(s){return Hs(Ms(s))}function M(s){return/^#([0-9a-fA-F]{3}|[0-9a-fA-F]{6})$/.test(s)}const X="#1677ff",w=H({name:"ColorPicker",props:{value:String,defaultValue:{type:String,default:X},format:{type:String,default:"hex"},disabled:Boolean,size:{type:String,default:"middle"},showText:Boolean,allowClear:Boolean,presets:{type:Array,default:()=>[]},classNames:Object,styles:Object},emits:["update:value","change","clear","openChange"],setup(s,{emit:p}){const a=ws("color-picker"),d=m(null),n=m(!1),t=m(s.value??s.defaultValue??X);is(()=>s.value,o=>{o!==void 0&&(t.value=o)});const r=m(E(M(t.value)?t.value:X)),g=m(t.value);is(t,o=>{M(o)&&(r.value=E(o),g.value=o)});function e(o){r.value=o;const u=Rs(o);t.value=u,g.value=u,p("update:value",u),p("change",u)}const c=m(null),v=m(!1);function $(o){if(!c.value)return;const u=c.value.getBoundingClientRect(),h="touches"in o?o.touches[0].clientX:o.clientX,y="touches"in o?o.touches[0].clientY:o.clientY,f=Math.max(0,Math.min(100,(h-u.left)/u.width*100)),C=Math.max(0,Math.min(100,(1-(y-u.top)/u.height)*100));e({...r.value,s:Math.round(f),b:Math.round(C)})}function ms(o){v.value=!0,$(o)}function D(o){v.value&&$(o)}function V(){v.value=!1}const R=m(null),I=m(!1);function O(o){if(!R.value)return;const u=R.value.getBoundingClientRect(),h=Math.max(0,Math.min(360,(o.clientX-u.left)/u.width*360));e({...r.value,h:Math.round(h)})}function gs(o){I.value=!0,O(o)}function F(o){I.value&&O(o)}function G(){I.value=!1}Ss(()=>{document.addEventListener("mousemove",D),document.addEventListener("mouseup",V),document.addEventListener("mousemove",F),document.addEventListener("mouseup",G)}),qs(()=>{document.removeEventListener("mousemove",D),document.removeEventListener("mouseup",V),document.removeEventListener("mousemove",F),document.removeEventListener("mouseup",G)});const vs=U(()=>({left:`${r.value.s}%`,top:`${100-r.value.b}%`})),fs=U(()=>({left:`${r.value.h/360*100}%`})),bs=U(()=>({background:`hsl(${r.value.h}, 100%, 50%)`}));function hs(o){const u=o.target.value;g.value=u,M(u)&&(t.value=u,r.value=E(u),p("update:value",u),p("change",u))}function xs(){t.value="",g.value="",p("update:value",void 0),p("clear")}const ys=()=>{var o,u,h,y,f,C,S,q,N,P,Y,j,z,W,K,Q,J,Z,_,ss,ns,as;return l("div",{ref:d,class:k(`${a}-panel`,(o=s.classNames)==null?void 0:o.panel),style:(u=s.styles)==null?void 0:u.panel},[l("div",{ref:c,class:k(`${a}-sb`,(h=s.classNames)==null?void 0:h.saturation),style:{...bs.value,...(y=s.styles)==null?void 0:y.saturation},onMousedown:ms},[l("div",{class:`${a}-sb-white`},null),l("div",{class:`${a}-sb-black`},null),l("div",{class:k(`${a}-sb-cursor`,(f=s.classNames)==null?void 0:f.saturationCursor),style:{...vs.value,...(C=s.styles)==null?void 0:C.saturationCursor}},null)]),l("div",{class:`${a}-sliders`},[l("div",{ref:R,class:k(`${a}-hue`,(S=s.classNames)==null?void 0:S.hueSlider),style:(q=s.styles)==null?void 0:q.hueSlider,onMousedown:gs},[l("div",{class:k(`${a}-hue-cursor`,(N=s.classNames)==null?void 0:N.hueCursor),style:{...fs.value,...(P=s.styles)==null?void 0:P.hueCursor}},null)])]),l("div",{class:k(`${a}-input-container`,(Y=s.classNames)==null?void 0:Y.inputContainer),style:(j=s.styles)==null?void 0:j.inputContainer},[l("div",{class:k(`${a}-preview`,(z=s.classNames)==null?void 0:z.preview),style:{background:t.value,...(W=s.styles)==null?void 0:W.preview}},null),l("input",{class:k(`${a}-hex-input`,(K=s.classNames)==null?void 0:K.hexInput),style:(Q=s.styles)==null?void 0:Q.hexInput,value:g.value,onInput:hs,maxlength:7,spellcheck:!1},null),l("span",{class:k(`${a}-format-label`,(J=s.classNames)==null?void 0:J.formatLabel),style:(Z=s.styles)==null?void 0:Z.formatLabel},[B("HEX")])]),s.presets.length>0&&l("div",{class:k(`${a}-presets`,(_=s.classNames)==null?void 0:_.presets),style:(ss=s.styles)==null?void 0:ss.presets},[s.presets.map(A=>{var ts,es,os,ls,ps,cs;return l("div",{key:A.label,class:k(`${a}-preset-group`,(ts=s.classNames)==null?void 0:ts.presetGroup),style:(es=s.styles)==null?void 0:es.presetGroup},[l("div",{class:k(`${a}-preset-label`,(os=s.classNames)==null?void 0:os.presetLabel),style:(ls=s.styles)==null?void 0:ls.presetLabel},[A.label]),l("div",{class:k(`${a}-preset-colors`,(ps=s.classNames)==null?void 0:ps.presetColors),style:(cs=s.styles)==null?void 0:cs.presetColors},[A.colors.map(x=>{var rs,us;return l("div",{key:x,class:k(`${a}-preset-color`,{[`${a}-preset-color-active`]:x===t.value},(rs=s.classNames)==null?void 0:rs.presetColor),style:{background:x,...(us=s.styles)==null?void 0:us.presetColor},onClick:()=>{t.value=x,g.value=x,M(x)&&(r.value=E(x)),p("update:value",x),p("change",x)}},null)})])])})]),s.allowClear&&l("div",{class:k(`${a}-clear-btn`,(ns=s.classNames)==null?void 0:ns.clearBtn),style:(as=s.styles)==null?void 0:as.clearBtn,onClick:xs},[B("清除")])])};return()=>{var o,u,h,y;return l(Es,{open:n.value,trigger:"click",placement:"bottomLeft",disabled:s.disabled,destroyOnHidden:!0,triggerClass:k(a,`${a}-${s.size}`,{[`${a}-disabled`]:s.disabled},(o=s.classNames)==null?void 0:o.root),triggerStyle:(u=s.styles)==null?void 0:u.root,popupClass:k(`${a}-panel`,(h=s.classNames)==null?void 0:h.panel),popupStyle:(y=s.styles)==null?void 0:y.panel,onOpenChange:f=>{n.value=f,p("openChange",f)}},{default:()=>{var f,C,S,q,N,P;return l("div",{class:k(`${a}-trigger`,{[`${a}-trigger-open`]:n.value},(f=s.classNames)==null?void 0:f.trigger),style:(C=s.styles)==null?void 0:C.trigger,role:"button","aria-haspopup":"true","aria-expanded":n.value},[l("div",{class:k(`${a}-color-block`,(S=s.classNames)==null?void 0:S.colorBlock),style:{background:t.value||"transparent",...(q=s.styles)==null?void 0:q.colorBlock}},null),s.showText&&l("span",{class:k(`${a}-text`,(N=s.classNames)==null?void 0:N.text),style:(P=s.styles)==null?void 0:P.text},[t.value||"—"])])},popup:({placement:f})=>ys()})}}}),Is=H({__name:"ColorPickerBasic",setup(s){const p=m("#1677ff");return(a,d)=>(T(),ds(b(Cs),{wrap:"",align:"center"},{default:L(()=>[l(b(w),{value:p.value,"onUpdate:value":d[0]||(d[0]=n=>p.value=n),"show-text":""},null,8,["value"]),i("span",null,"当前颜色："+Ns(p.value),1)]),_:1}))}}),As=`<template>
...
<\/script>
`,Us={style:{display:"flex","flex-direction":"column",gap:"24px"}},Xs=H({__name:"ColorPickerClassNames",setup(s){const p=m("#1677ff"),a=m("#52c41a"),d=m("#722ed1"),n=m("#fa8c16"),t=m("#eb2f96"),r=[{label:"推荐色",colors:["#1677ff","#52c41a","#faad14","#f5222d","#722ed1"]},{label:"最近使用",colors:["#fa8c16","#13c2c2","#eb2f96","#2f54eb","#a0d911"]}];return(g,e)=>(T(),ks("div",Us,[i("div",null,[e[5]||(e[5]=i("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义触发器：",-1)),l(b(w),{value:p.value,"onUpdate:value":e[0]||(e[0]=c=>p.value=c),"show-text":"","class-names":{trigger:"custom-trigger",colorBlock:"custom-color-block",text:"custom-text"}},null,8,["value"])]),i("div",null,[e[6]||(e[6]=i("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义面板：",-1)),l(b(w),{value:a.value,"onUpdate:value":e[1]||(e[1]=c=>a.value=c),"class-names":{panel:"custom-panel",saturation:"custom-saturation",hueSlider:"custom-hue-slider"}},null,8,["value"])]),i("div",null,[e[7]||(e[7]=i("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义预设颜色：",-1)),l(b(w),{value:d.value,"onUpdate:value":e[2]||(e[2]=c=>d.value=c),presets:r,"class-names":{presetLabel:"custom-preset-label",presetColor:"custom-preset-color"}},null,8,["value"])]),i("div",null,[e[8]||(e[8]=i("div",{style:{"margin-bottom":"8px",color:"#666"}},"使用内联样式：",-1)),l(b(w),{value:n.value,"onUpdate:value":e[3]||(e[3]=c=>n.value=c),"show-text":"",styles:{trigger:{borderRadius:"12px",padding:"6px 12px",border:"2px solid #722ed1"},colorBlock:{borderRadius:"8px",width:"32px",height:"32px"},text:{color:"#722ed1",fontWeight:"500",marginLeft:"8px"}}},null,8,["value"])]),i("div",null,[e[9]||(e[9]=i("div",{style:{"margin-bottom":"8px",color:"#666"}},"组合使用：",-1)),l(b(w),{value:t.value,"onUpdate:value":e[4]||(e[4]=c=>t.value=c),"allow-clear":"",presets:r,"class-names":{panel:"combined-panel",clearBtn:"combined-clear-btn"},styles:{saturationCursor:{width:"24px",height:"24px",border:"3px solid white"},hueCursor:{width:"20px",height:"20px"}}},null,8,["value"])])]))}}),Ds=Ps(Xs,[["__scopeId","data-v-c08002d0"]]),Vs=`<template>
...
`,Os=H({__name:"ColorPickerPresets",setup(s){const p=m("#1677ff"),a=[{label:"推荐",colors:["#1677ff","#52c41a","#faad14","#ff4d4f","#722ed1","#13c2c2"]}];return(d,n)=>(T(),ds(b(w),{value:p.value,"onUpdate:value":n[0]||(n[0]=t=>p.value=t),"show-text":"",presets:a},null,8,["value"]))}}),Fs=`<template>
