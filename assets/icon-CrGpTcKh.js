...
<\/script>
`,ln={class:"icon-browser"},rn={class:"controls"},dn={class:"search-box"},pn={class:"category-filter"},un=["value"],mn={class:"stats"},fn={key:0,class:"search-term"},gn={class:"icon-grid"},yn=["onClick"],xn={class:"icon-display"},kn={class:"icon-name"},vn={class:"icon-category"},hn={class:"icon-keywords"},wn={key:0,class:"copied-indicator"},On={key:0,class:"empty-state"},In=O({__name:"IconBrowser",setup(p){const a=U(""),r=U("all"),d=U(""),t=E(()=>["all",...on()]),c=E(()=>{let m=[];return a.value.trim()?m=tn(a.value):r.value!=="all"?m=en(r.value):m=sn(),m}),f=m=>{const l=m.split("-").map(k=>k.charAt(0).toUpperCase()+k.slice(1)).join("")+"Outlined",i=`import { ${l} } from 'ant-design-hmfw'

<Icon :component="${l}" />`;navigator.clipboard.writeText(i).then(()=>{d.value=m,setTimeout(()=>{d.value=""},2e3)})};return(m,l)=>(u(),g("div",ln,[o("div",rn,[o("div",dn,[q(o("input",{"onUpdate:modelValue":l[0]||(l[0]=i=>a.value=i),type:"text",placeholder:"搜索图标... (如: home, search, arrow)",class:"search-input"},null,512),[[Y,a.value]]),l[2]||(l[2]=o("span",{class:"search-icon"},"🔍",-1))]),o("div",pn,[l[3]||(l[3]=o("label",null,"分类：",-1)),q(o("select",{"onUpdate:modelValue":l[1]||(l[1]=i=>r.value=i),class:"category-select"},[(u(!0),g(z,null,_(t.value,i=>(u(),g("option",{key:i,value:i},v(i==="all"?"全部":i),9,un))),128))],512),[[J,r.value]])])]),o("div",mn,[l[4]||(l[4]=y(" 找到 ",-1)),o("strong",null,v(c.value.length),1),l[5]||(l[5]=y(" 个图标 ",-1)),a.value?(u(),g("span",fn,' 搜索: "'+v(a.value)+'" ',1)):S("",!0)]),o("div",gn,[(u(!0),g(z,null,_(c.value,i=>(u(),g("div",{key:i.name,class:K(["icon-card",{copied:d.value===i.name}]),onClick:k=>f(i.name)},[o("div",xn,[e(n(s),{component:i.component,style:{fontSize:"32px"}},null,8,["component"])]),o("div",kn,v(i.name),1),o("div",vn,v(i.category),1),o("div",hn,[(u(!0),g(z,null,_(i.keywords.slice(0,3),k=>(u(),g("span",{key:k,class:"keyword-tag"},v(k),1))),128))]),d.value===i.name?(u(),g("div",wn," ✓ 已复制 ")):S("",!0)],10,yn))),128))]),c.value.length===0?(u(),g("div",On,[...l[6]||(l[6]=[o("div",{class:"empty-icon"},"🔍",-1),o("div",{class:"empty-text"},"未找到匹配的图标",-1),o("div",{class:"empty-hint"},"尝试其他关键词或选择不同的分类",-1)])])):S("",!0)]))}}),bn=X(In,[["__scopeId","data-v-8035b003"]]),Cn=`<script setup lang="ts">
