import{S as l,a as k,b as h,c as v,d as f}from"./index-COHq9QCp.js";import{d as u,o as c,q as b,e as s,b as m,c as a,f as t,_ as y,w as p,g,r as S,h as x,i as w}from"./index-DZWA4HiS.js";import{B as N}from"./Button-BJ4qjE3i.js";import"./cls-S9IiI6wd.js";import"./LoadingOutlined-_M72e6LV.js";const q=u({__name:"SkeletonActive",setup(d){return(o,e)=>(c(),b(s(l),{active:""}))}}),C=`<template>
  <Skeleton active />
</template>
...
`,W={style:{display:"flex",gap:"16px"}},M=u({__name:"SkeletonImageNode",setup(d){return(o,e)=>(c(),m("div",W,[a(s(l).Image,{active:""}),a(s(l).Node,{active:""},{default:p(()=>[...e[0]||(e[0]=[t("div",{style:{width:"96px",height:"96px",display:"flex","align-items":"center","justify-content":"center",color:"#bfbfbf"}}," Node ",-1)])]),_:1})]))}}),O=`<template>
...
import { Skeleton } from '@hmfw/ant-design'
<\/script>
`,Y=u({__name:"SkeletonWithChildren",setup(d){const o=S(!0);return(e,r)=>(c(),m("div",null,[a(s(N),{onClick:r[0]||(r[0]=n=>o.value=!o.value)},{default:p(()=>[...r[1]||(r[1]=[g("切换加载状态",-1)])]),_:1}),a(s(l),{loading:o.value,active:"",avatar:""},{default:p(()=>[...r[2]||(r[2]=[t("div",{style:{display:"flex",gap:"12px","margin-top":"16px"}},[t("img",{src:"https://api.dicebear.com/7.x/miniavs/svg?seed=1",style:{width:"40px",height:"40px","border-radius":"50%"}}),t("div",null,[t("p",{style:{"font-weight":"bold"}},"用户名称"),t("p",null,"这是一段描述信息，用于展示骨架屏效果。")])],-1)])]),_:1},8,["loading"])]))}}),H=`<template>
  <div>
