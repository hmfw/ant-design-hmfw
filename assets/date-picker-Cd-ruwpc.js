...
<\/script>
`,We={style:{display:"flex","flex-direction":"column",gap:"16px",width:"300px"}},Xe=Y({__name:"DatePickerDisabledDate",setup(t){const l=m(""),a=m(""),u=c=>new Date(c)<new Date(new Date().toDateString()),d=c=>new Date(c)>new Date(new Date().toDateString());return(c,h)=>(T(),F("div",We,[n(D(y),{value:l.value,"onUpdate:value":h[0]||(h[0]=r=>l.value=r),"disabled-date":u,placeholder:"不可选择过去日期"},null,8,["value"]),n(D(y),{value:a.value,"onUpdate:value":h[1]||(h[1]=r=>a.value=r),"disabled-date":d,placeholder:"不可选择未来日期"},null,8,["value"])]))}}),Ze=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; width: 300px">
...
<\/script>
`,et={style:{display:"flex","flex-direction":"column",gap:"16px",width:"300px"}},tt=Y({__name:"DatePickerMinMax",setup(t){const l=m(""),a=f(()=>{const d=new Date;return d.setDate(1),d.toISOString().split("T")[0]}),u=f(()=>{const d=new Date;return d.setMonth(d.getMonth()+1,0),d.toISOString().split("T")[0]});return(d,c)=>(T(),F("div",et,[n(D(y),{value:l.value,"onUpdate:value":c[0]||(c[0]=h=>l.value=h),"min-date":a.value,"max-date":u.value,placeholder:"只能选择本月"},null,8,["value","min-date","max-date"]),v("p",null,"选中日期："+V(l.value),1)]))}}),at=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; width: 300px">
...
<\/script>
`,nt={style:{display:"flex","flex-direction":"column",gap:"16px",width:"300px"}},lt=Y({__name:"DatePickerPicker",setup(t){const l=m(""),a=m(""),u=m(""),d=m("");return(c,h)=>(T(),F("div",nt,[n(D(y),{value:l.value,"onUpdate:value":h[0]||(h[0]=r=>l.value=r),picker:"date",placeholder:"选择日期"},null,8,["value"]),n(D(y),{value:a.value,"onUpdate:value":h[1]||(h[1]=r=>a.value=r),picker:"month",placeholder:"选择月份"},null,8,["value"]),n(D(y),{value:u.value,"onUpdate:value":h[2]||(h[2]=r=>u.value=r),picker:"quarter",placeholder:"选择季度"},null,8,["value"]),n(D(y),{value:d.value,"onUpdate:value":h[3]||(h[3]=r=>d.value=r),picker:"year",placeholder:"选择年份"},null,8,["value"])]))}}),dt=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; width: 300px">
...
const year = ref('')
<\/script>
`,ot={style:{display:"flex","flex-direction":"column",gap:"16px",width:"300px"}},rt=Y({__name:"DatePickerPresets",setup(t){const l=m(""),a=[{label:"昨天",value:()=>{const u=new Date;return u.setDate(u.getDate()-1),u.toISOString().split("T")[0]}},{label:"今天",value:()=>new Date().toISOString().split("T")[0]},{label:"明天",value:()=>{const u=new Date;return u.setDate(u.getDate()+1),u.toISOString().split("T")[0]}},{label:"一周后",value:()=>{const u=new Date;return u.setDate(u.getDate()+7),u.toISOString().split("T")[0]}}];return(u,d)=>(T(),F("div",ot,[n(D(y),{value:l.value,"onUpdate:value":d[0]||(d[0]=c=>l.value=c),presets:a,placeholder:"选择日期"},null,8,["value"]),v("p",null,"选中日期："+V(l.value),1)]))}}),st=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; width: 300px">
...
<\/script>
`,ut={style:{width:"300px"}},it={style:{"margin-top":"8px"}},ct=Y({__name:"DatePickerShowTime",setup(t){const l=m(""),a=u=>{console.log("选中日期时间：",u)};return(u,d)=>(T(),F("div",ut,[n(D(y),{value:l.value,"onUpdate:value":d[0]||(d[0]=c=>l.value=c),"show-time":!0,placeholder:"选择日期和时间",onChange:a},null,8,["value"]),v("p",it,"选中："+V(l.value),1)]))}}),vt=`<template>
