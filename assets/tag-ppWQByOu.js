...
<\/script>
`,R={style:{display:"flex",gap:"8px"}},q=m({__name:"TagCheckable",setup(t){const i=["Movies","Books","Music","Sports"],e=_(["Books"]);function r(d,u){u?e.value=[...e.value,d]:e.value=e.value.filter(f=>f!==d)}return(d,u)=>(b(),p("div",R,[(b(),p(N,null,E(i,f=>o(n(V),{key:f,checked:e.value.includes(f),onChange:y=>r(f,y)},{default:l(()=>[a(L(f),1)]),_:2},1032,["checked","onChange"])),64))]))}}),z=`<template>
...
<\/script>
`,W={style:{display:"flex",gap:"8px","flex-wrap":"wrap"}},G=m({__name:"TagCustomColor",setup(t){return(i,e)=>(b(),p("div",W,[o(n(s),{color:"#f50"},{default:l(()=>[...e[0]||(e[0]=[a(" #f50 ",-1)])]),_:1}),o(n(s),{color:"#2db7f5"},{default:l(()=>[...e[1]||(e[1]=[a(" #2db7f5 ",-1)])]),_:1}),o(n(s),{color:"#87d068"},{default:l(()=>[...e[2]||(e[2]=[a(" #87d068 ",-1)])]),_:1}),o(n(s),{color:"#108ee9"},{default:l(()=>[...e[3]||(e[3]=[a(" #108ee9 ",-1)])]),_:1})]))}}),H=`<template>
  <div style="display: flex; gap: 8px; flex-wrap: wrap">
