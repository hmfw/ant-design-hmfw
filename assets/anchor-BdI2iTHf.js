import{q as ct,B as st,o as b,N as K,x as Y,y as j,n as d,f as k,Q as B,E as w,t as W,A as C,i as ht,K as s,k as I,h as t,R as m,H as ft,m as g,l as pt}from"./index-DJdGgqDu.js";import{c as _}from"./cls-S9IiI6wd.js";const Q=Symbol("AnchorContext");function ut(n){st(Q,n)}function gt(){return ct(Q,null)}const U=b({name:"AnchorLink",props:{href:{type:String,required:!0},title:{type:String,required:!0},target:String,replace:Boolean,targetOffset:Number},setup(n,{slots:a}){const h=K("anchor"),e=gt();Y(()=>{e==null||e.registerLink(n.href,n.targetOffset)}),j(()=>{e==null||e.unregisterLink(n.href)});const r=f=>{var E;if((E=e==null?void 0:e.onClick)==null||E.call(e,f,{title:n.title,href:n.href}),e==null||e.scrollTo(n.href,n.targetOffset),f.defaultPrevented)return;if(n.href.startsWith("http://")||n.href.startsWith("https://")){(n.replace??(e==null?void 0:e.replace))&&(f.preventDefault(),window.location.replace(n.href));return}f.preventDefault();const A=n.replace??(e==null?void 0:e.replace)?"replaceState":"pushState";window.history[A](null,"",n.href)},l=k(()=>(e==null?void 0:e.activeLink)===n.href),T=k(()=>_(`${h}-link`,{[`${h}-link-active`]:l.value})),S=k(()=>_(`${h}-link-title`,{[`${h}-link-title-active`]:l.value}));return()=>{var f;return d("div",{class:T.value},[d("a",{class:S.value,href:n.href,title:n.title,target:n.target,onClick:r},[n.title]),(e==null?void 0:e.direction)!=="horizontal"?(f=a.default)==null?void 0:f.call(a):null])}}}),mt=b({name:"Anchor",props:{items:{type:Array,default:()=>[]},affix:{type:Boolean,default:!0},offsetTop:{type:Number,default:0},bounds:{type:Number,default:5},targetOffset:Number,direction:{type:String,default:"vertical"},replace:Boolean,getCurrentAnchor:Function,getContainer:Function},emits:["change","click"],setup(n,{emit:a,slots:h}){const e=K("anchor"),r=w(null),l=w([]),T=w({}),S=w(),f=w(),$=w(!1);let O=null;const A=()=>n.getContainer?n.getContainer():window,E=o=>o===window?window.scrollY:o.scrollTop,D=(o,i)=>{if(!o.getClientRects().length)return 0;const c=o.getBoundingClientRect();return c.width||c.height?i===window?c.top-o.ownerDocument.documentElement.clientTop:c.top-i.getBoundingClientRect().top:c.top},G=(o,i)=>{l.value.includes(o)||(l.value=[...l.value,o]),i!==void 0&&(T.value[o]=i)},J=o=>{l.value=l.value.filter(i=>i!==o),delete T.value[o]},q=()=>{if(!S.value||!f.value)return;const o=S.value.querySelector(`.${e}-link-title-active`);if(o){const{style:i}=f.value,c=n.direction==="horizontal";i.top=c?"":`${o.offsetTop+o.clientHeight/2}px`,i.height=c?"":`${o.clientHeight}px`,i.left=c?`${o.offsetLeft}px`:"",i.width=c?`${o.clientWidth}px`:"",c&&o.scrollIntoView({behavior:"smooth",block:"nearest",inline:"nearest"})}},X=(o,i,c)=>{const y=[],z=A();return o.forEach(p=>{const u=/#([\S ]+)$/.exec(p);if(!u)return;const v=document.getElementById(u[1]);if(v){const N=T.value[p]??i,R=D(v,z);R<=N+c&&y.push({link:p,top:R})}}),y.length?y.reduce((u,v)=>v.top>u.top?v:u).link:""},H=o=>{if(r.value===o)return;const i=n.getCurrentAnchor?n.getCurrentAnchor(o):o;r.value=i,a("change",o)},P=()=>{if($.value)return;const o=X(l.value,n.targetOffset??n.offsetTop??0,n.bounds);H(o)},Z=(o,i)=>{const c=r.value;H(o);const y=/#([\S ]+)$/.exec(o);if(!y)return;const z=document.getElementById(y[1]);if(!z||$.value&&c===o)return;const p=A(),u=E(p),v=D(z,p);let N=u+v;const R=i??n.targetOffset??n.offsetTop??0;N-=R,$.value=!0;const it=Date.now(),dt=450,V=()=>{const at=Date.now()-it,L=Math.min(at/dt,1),lt=L<.5?2*L*L:-1+(4-2*L)*L,F=u+(N-u)*lt;p===window?window.scrollTo(0,F):p.scrollTop=F,L<1?O=requestAnimationFrame(V):$.value=!1};V()},tt=(o,i)=>{a("click",o,i)};ut({registerLink:G,unregisterLink:J,activeLink:r.value,scrollTo:Z,onClick:tt,direction:n.direction,replace:n.replace}),Y(()=>{A().addEventListener("scroll",P),P()}),j(()=>{A().removeEventListener("scroll",P),O!==null&&cancelAnimationFrame(O)}),B(()=>n.items,()=>{P()},{deep:!0}),B(()=>l.value,()=>{P()}),B(()=>r.value,()=>{W(()=>{q()})}),B(()=>n.getCurrentAnchor,()=>{n.getCurrentAnchor&&r.value&&H(n.getCurrentAnchor(r.value))}),B(()=>n.direction,()=>{W(()=>{q()})});const M=o=>o.map(i=>d(U,{key:i.key??i.href,href:i.href,title:i.title,target:i.target,targetOffset:i.targetOffset},{default:()=>{var c;return[n.direction==="vertical"&&((c=i.children)!=null&&c.length)?M(i.children):null]}})),et=k(()=>_(`${e}-wrapper`,{[`${e}-wrapper-horizontal`]:n.direction==="horizontal"})),nt=k(()=>_(e,{[`${e}-fixed`]:!n.affix})),rt=k(()=>_(`${e}-ink`,{[`${e}-ink-visible`]:!!r.value})),ot=k(()=>({maxHeight:n.offsetTop?`calc(100vh - ${n.offsetTop}px)`:"100vh"}));return()=>{var o,i;return d("div",{ref:S,class:et.value,style:ot.value},[d("div",{class:nt.value},[d("span",{class:rt.value,ref:f},null),(o=n.items)!=null&&o.length?M(n.items):(i=h.default)==null?void 0:i.call(h)])])}}}),x=mt;x.Link=U;const xt=b({__name:"AnchorAffix",setup(n){const a=[{href:"#section-a",title:"章节 A"},{href:"#section-b",title:"章节 B"},{href:"#section-c",title:"章节 C"}],h=r=>{console.log("当前锚点:",r)},e=(r,l)=>{console.log("点击锚点:",l)};return(r,l)=>(C(),ht(s(x),{affix:"","offset-top":80,items:a,onChange:h,onClick:e}))}}),vt=`<template>
