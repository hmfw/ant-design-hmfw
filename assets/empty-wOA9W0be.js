import{E as l}from"./Empty-B_kfsdTQ.js";import{k as a,w as s,e as u,M as r,d as e,G as o,B as y,g as f,j as n,h as b}from"./index-DvxRruME.js";import"./cls-S9IiI6wd.js";const E=a({__name:"EmptyAction",setup(i){function d(){console.log("创建")}return(p,c)=>(s(),u(o(l),{description:"暂无数据"},{default:r(()=>[e("button",{onClick:d},"立即创建")]),_:1}))}}),x=`<template>
