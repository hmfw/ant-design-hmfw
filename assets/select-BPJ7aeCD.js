import{S as u}from"./Select-wwWmb0sJ.js";import{o as k,A as v,k as g,n as o,K as d,h as t,J as x,E as i,_ as S,m as c,H as N,R as h,l as q}from"./index-0wAKNcUB.js";import"./cls-S9IiI6wd.js";import"./Icon-BHSpInk3.js";import"./Trigger-DXOrN7Pd.js";import"./VirtualList-CNbvmt6M.js";import"./LoadingOutlined-8a6xi408.js";import"./DownOutlined-Bsf8QJFP.js";const C={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"300px"}},V=k({__name:"SelectBasic",setup(b){const e=i(""),p=i(""),r=[{label:"Vue",value:"vue"},{label:"React",value:"react"},{label:"Angular",value:"angular"},{label:"Svelte（禁用）",value:"svelte",disabled:!0}];return(n,a)=>(v(),g("div",C,[o(d(u),{value:e.value,"onUpdate:value":a[0]||(a[0]=s=>e.value=s),options:r,placeholder:"请选择",style:{width:"100%"}},null,8,["value"]),o(d(u),{value:p.value,"onUpdate:value":a[1]||(a[1]=s=>p.value=s),options:r,placeholder:"禁用状态",disabled:"",style:{width:"100%"}},null,8,["value"]),t("p",null,"选中："+x(e.value),1)]))}}),_=`<template>
...
<\/script>
`,$={class:"demo-select-classnames"},O={class:"demo-section"},R={class:"demo-section"},z={class:"demo-section"},U={class:"demo-section"},A={class:"demo-section"},L={class:"demo-section"},P={class:"demo-section"},E={class:"demo-section"},T=k({__name:"SelectClassNames",setup(b){const e=[{label:"苹果 🍎",value:"apple"},{label:"香蕉 🍌",value:"banana"},{label:"橙子 🍊",value:"orange"},{label:"草莓 🍓",value:"strawberry"},{label:"葡萄 🍇",value:"grape"}],p=i(void 0),r=i(void 0),n=i(void 0),a=i(void 0),s=i(void 0),f=i([]),y=i(void 0),w=i(void 0);return(vt,l)=>(v(),g("div",$,[t("section",O,[l[8]||(l[8]=t("h3",null,"1. 自定义根节点样式",-1)),o(d(u),{value:p.value,"onUpdate:value":l[0]||(l[0]=m=>p.value=m),options:e,"class-names":{root:"custom-root"},placeholder:"请选择",style:{width:"240px"}},null,8,["value"])]),t("section",R,[l[9]||(l[9]=t("h3",null,"2. 自定义选择器样式",-1)),o(d(u),{value:r.value,"onUpdate:value":l[1]||(l[1]=m=>r.value=m),options:e,"class-names":{selector:"custom-selector"},placeholder:"请选择",style:{width:"240px"}},null,8,["value"])]),t("section",z,[l[10]||(l[10]=t("h3",null,"3. 自定义占位符样式",-1)),o(d(u),{value:n.value,"onUpdate:value":l[2]||(l[2]=m=>n.value=m),options:e,"class-names":{placeholder:"custom-placeholder"},placeholder:"自定义占位符样式",style:{width:"240px"}},null,8,["value"])]),t("section",U,[l[11]||(l[11]=t("h3",null,"4. 自定义下拉面板样式",-1)),o(d(u),{value:a.value,"onUpdate:value":l[3]||(l[3]=m=>a.value=m),options:e,"class-names":{dropdown:"custom-dropdown"},placeholder:"点击查看下拉面板",style:{width:"240px"}},null,8,["value"])]),t("section",A,[l[12]||(l[12]=t("h3",null,"5. 自定义选项样式",-1)),o(d(u),{value:s.value,"onUpdate:value":l[4]||(l[4]=m=>s.value=m),options:e,"class-names":{option:"custom-option",optionLabel:"custom-option-label"},placeholder:"点击查看选项",style:{width:"240px"}},null,8,["value"])]),t("section",L,[l[13]||(l[13]=t("h3",null,"6. 多选模式自定义标签样式",-1)),o(d(u),{value:f.value,"onUpdate:value":l[5]||(l[5]=m=>f.value=m),options:e,mode:"multiple","class-names":{item:"custom-item"},placeholder:"多选",style:{width:"320px"}},null,8,["value"])]),t("section",P,[l[14]||(l[14]=t("h3",null,"7. 组合使用多个 classNames",-1)),o(d(u),{value:y.value,"onUpdate:value":l[6]||(l[6]=m=>y.value=m),options:e,"class-names":{root:"combined-root",selector:"combined-selector",arrow:"combined-arrow",dropdown:"combined-dropdown",option:"combined-option"},placeholder:"综合样式",style:{width:"280px"}},null,8,["value"])]),t("section",E,[l[15]||(l[15]=t("h3",null,"8. 使用 styles 动态样式",-1)),o(d(u),{value:w.value,"onUpdate:value":l[7]||(l[7]=m=>w.value=m),options:e,styles:{root:{borderRadius:"20px",overflow:"hidden"},selector:{background:"linear-gradient(135deg, #667eea 0%, #764ba2 100%)",color:"white",border:"none"},dropdown:{borderRadius:"12px",boxShadow:"0 8px 24px rgba(102, 126, 234, 0.3)"}},placeholder:"动态样式",style:{width:"280px"}},null,8,["value"])])]))}}),B=S(T,[["__scopeId","data-v-20eb88b8"]]),M=`<template>
...
`,I={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"400px"}},j=k({__name:"SelectLabelInValue",setup(b){const e=i(null),p=[{label:"Vue",value:"vue"},{label:"React",value:"react"},{label:"Angular",value:"angular"}],r=(n,a)=>{console.log("change:",n,a)};return(n,a)=>(v(),g("div",I,[o(d(u),{value:e.value,"onUpdate:value":a[0]||(a[0]=s=>e.value=s),options:p,"label-in-value":"",placeholder:"选择一个选项",style:{width:"100%"},onChange:r},null,8,["value"]),t("p",null,"选中值："+x(JSON.stringify(e.value)),1)]))}}),D=`<template>
...
<\/script>
`,G={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"400px"}},F=k({__name:"SelectMaxCount",setup(b){const e=i([]),p=[{label:"Vue",value:"vue"},{label:"React",value:"react"},{label:"Angular",value:"angular"},{label:"Svelte",value:"svelte"},{label:"Solid",value:"solid"}];return(r,n)=>(v(),g("div",G,[o(d(u),{value:e.value,"onUpdate:value":n[0]||(n[0]=a=>e.value=a),options:p,mode:"multiple","max-count":3,placeholder:"最多选择 3 个",style:{width:"100%"}},null,8,["value"]),t("p",null,"已选："+x(e.value),1)]))}}),H=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; max-width: 400px">
    <Select
      v-model:value="value"
      :options="options"
...
<\/script>
`,J={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"400px"}},K=k({__name:"SelectMultiple",setup(b){const e=i([]),p=i([]),r=[{label:"Vue",value:"vue"},{label:"React",value:"react"},{label:"Angular",value:"angular"},{label:"Svelte",value:"svelte"},{label:"Solid",value:"solid"}];return(n,a)=>(v(),g("div",J,[o(d(u),{value:e.value,"onUpdate:value":a[0]||(a[0]=s=>e.value=s),options:r,mode:"multiple",placeholder:"请选择多个选项",style:{width:"100%"}},null,8,["value"]),o(d(u),{value:p.value,"onUpdate:value":a[1]||(a[1]=s=>p.value=s),options:r,mode:"multiple","max-tag-count":2,placeholder:"最多显示 2 个标签",style:{width:"100%"}},null,8,["value"]),t("p",null,"已选："+x(e.value),1)]))}}),W=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; max-width: 400px">
    <Select
...
<\/script>
`,X={style:{"max-width":"400px"}},Q=k({__name:"SelectOptGroup",setup(b){const e=i(""),p=[{label:"浙江",options:[{label:"杭州",value:"hangzhou"},{label:"宁波",value:"ningbo"},{label:"温州",value:"wenzhou"}]},{label:"江苏",options:[{label:"南京",value:"nanjing"},{label:"苏州",value:"suzhou"},{label:"镇江",value:"zhenjiang"}]}];return(r,n)=>(v(),g("div",X,[o(d(u),{value:e.value,"onUpdate:value":n[0]||(n[0]=a=>e.value=a),options:p,placeholder:"选择城市",style:{width:"100%"}},null,8,["value"])]))}}),Y=`<template>
...
<\/script>
`,Z={style:{"max-width":"300px"}},tt=k({__name:"SelectSearch",setup(b){const e=i(""),p=[{label:"北京",value:"beijing"},{label:"上海",value:"shanghai"},{label:"广州",value:"guangzhou"},{label:"深圳",value:"shenzhen"},{label:"杭州",value:"hangzhou"},{label:"成都",value:"chengdu"}],r=i(p),n=a=>{r.value=p.filter(s=>s.label.includes(a))};return(a,s)=>(v(),g("div",Z,[o(d(u),{value:e.value,"onUpdate:value":s[0]||(s[0]=f=>e.value=f),options:r.value,"show-search":!0,placeholder:"请搜索并选择",style:{width:"100%"},onSearch:n},null,8,["value","options"])]))}}),nt=`<template>
...
<\/script>
`,et={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"400px"}},at=k({__name:"SelectTags",setup(b){const e=i([]),p=[{label:"Vue",value:"vue"},{label:"React",value:"react"},{label:"Angular",value:"angular"}];return(r,n)=>(v(),g("div",et,[o(d(u),{value:e.value,"onUpdate:value":n[0]||(n[0]=a=>e.value=a),options:p,mode:"tags","token-separators":[","],placeholder:"输入标签，用逗号分隔",style:{width:"100%"}},null,8,["value"]),t("p",null,"已选："+x(e.value),1)]))}}),st=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; max-width: 400px">
    <Select
      v-model:value="value"
      :options="options"
...
<\/script>
`,ot={class:"select-virtual-demo"},lt={style:{display:"flex",gap:"16px","margin-bottom":"24px"}},dt={style:{flex:"1"}},pt={style:{"margin-top":"8px","font-size":"12px",color:"#8c8c8c"}},ct={style:{flex:"1"}},rt=k({__name:"SelectVirtual",setup(b){const e=i(),p=i(),r=Array.from({length:1e4},(a,s)=>({label:`选项 ${s+1} - ${Math.random().toString(36).substring(7)}`,value:`option-${s+1}`})),n=r.slice(0,100);return(a,s)=>(v(),g("div",ot,[s[5]||(s[5]=t("h4",null,"虚拟滚动（10,000 个选项）",-1)),s[6]||(s[6]=t("p",{style:{"margin-bottom":"16px",color:"#666"}},"使用虚拟滚动技术，即使有 10,000 个选项也能流畅交互",-1)),t("div",lt,[t("div",dt,[s[2]||(s[2]=t("h5",{style:{"margin-bottom":"8px"}},"启用虚拟滚动 ✅",-1)),o(d(u),{value:e.value,"onUpdate:value":s[0]||(s[0]=f=>e.value=f),options:d(r),placeholder:"选择一个选项","show-search":"",style:{width:"100%"},virtual:"","list-height":256,"list-item-height":32},null,8,["value","options"]),t("div",pt,"已选择："+x(e.value||"未选择"),1)]),t("div",ct,[s[3]||(s[3]=t("h5",{style:{"margin-bottom":"8px"}},"普通模式（对比）",-1)),o(d(u),{value:p.value,"onUpdate:value":s[1]||(s[1]=f=>p.value=f),options:d(n),placeholder:"选择一个选项","show-search":"",style:{width:"100%"}},null,8,["value","options"]),s[4]||(s[4]=t("div",{style:{"margin-top":"8px","font-size":"12px",color:"#8c8c8c"}},"仅 100 个选项用于对比",-1))])]),s[7]||(s[7]=t("div",{style:{padding:"12px",background:"#f5f5f5","border-radius":"4px"}},[t("strong",null,"性能对比："),t("ul",{style:{margin:"8px 0","padding-left":"20px"}},[t("li",null,[t("strong",null,"虚拟滚动模式："),c("10,000 个选项，只渲染可见的 8-10 项，流畅无卡顿")]),t("li",null,[t("strong",null,"普通模式："),c("超过 1,000 个选项会明显卡顿，10,000 个会导致浏览器卡死")])]),t("div",{style:{"margin-top":"8px",color:"#1890ff"}},[c("💡 建议：当选项超过 100 个时启用 "),t("code",null,"virtual"),c(" 属性")])],-1))]))}}),it=S(rt,[["__scopeId","data-v-5bdfd819"]]),ut=`<template>
