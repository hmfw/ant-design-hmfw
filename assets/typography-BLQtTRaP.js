...
<\/script>
`,At=v({__name:"TypographyLink",setup(n){return(a,t)=>(w(),D("div",null,[s(l(M),{href:"https://ant.design",target:"_blank"},{default:p(()=>[...t[0]||(t[0]=[o(" Ant Design 链接 ",-1)])]),_:1}),t[2]||(t[2]=r("br",null,null,-1)),s(l(M),{href:"https://ant.design",disabled:""},{default:p(()=>[...t[1]||(t[1]=[o(" 禁用链接 ",-1)])]),_:1})]))}}),_t=`<template>
  <div>
