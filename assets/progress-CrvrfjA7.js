...
import { Progress } from 'ant-design-hmfw'
<\/script>
`,Et={style:{display:"flex",gap:"16px"}},Jt=A({__name:"ProgressDashboard",setup(t){return(l,e)=>(_(),I("div",Et,[r(i(d),{type:"dashboard",percent:75}),r(i(d),{type:"dashboard",percent:75,"gap-degree":30})]))}}),Kt=`<template>
  <div style="display: flex; gap: 16px;">
...
import { Progress } from 'ant-design-hmfw'
<\/script>
`,Qt=A({__name:"ProgressDynamic",setup(t){const l=St(0);function e(){l.value=Math.min(l.value+10,100)}function c(){l.value=Math.max(l.value-10,0)}return(s,a)=>(_(),I(wt,null,[r(i(d),{percent:l.value},null,8,["percent"]),n("div",{style:{display:"flex",gap:"8px","margin-top":"12px"}},[n("button",{onClick:c},"-"),n("button",{onClick:e},"+")])],64))}}),Ut=`<template>
