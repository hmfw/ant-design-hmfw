import{B as r}from"./Button-CnMq9a0G.js";import{M as i}from"./index-C4rJ485P.js";import{d as b,o as m,b as y,F as q,c as t,e,w as o,g as l,f as p,r as f,_ as C,q as x,A as B,v as M,h as S,i as h}from"./index-Dhlw_h7w.js";import{S as w}from"./Space-CKjJe6BD.js";import"./cls-S9IiI6wd.js";import"./LoadingOutlined-BpH-uTyr.js";import"./index-CsB0XnK0.js";import"./CloseOutlined-N_iBbuHV.js";import"./ExclamationCircleFilled-BYoDTTJJ.js";import"./CheckCircleFilled-LEf_dyYG.js";import"./CloseCircleFilled-CH10Ua8m.js";import"./InfoCircleFilled-CJnSTIEn.js";const N=b({__name:"ModalBasic",setup(g){const a=f(!1);function u(){console.log("确认"),a.value=!1}function c(){console.log("取消"),a.value=!1}return(n,s)=>(m(),y(q,null,[t(e(r),{onClick:s[0]||(s[0]=d=>a.value=!0)},{default:o(()=>[...s[2]||(s[2]=[l("打开对话框",-1)])]),_:1}),t(e(i),{open:a.value,"onUpdate:open":s[1]||(s[1]=d=>a.value=d),title:"基础对话框",onOk:u,onCancel:c},{default:o(()=>[...s[3]||(s[3]=[p("p",null,"对话框内容",-1),p("p",null,"对话框内容",-1),p("p",null,"对话框内容",-1)])]),_:1},8,["open"])],64))}}),O=`<template>
...
<\/script>
`,_=b({__name:"ModalCustomFooter",setup(g){const a=f(!1),u=f(!1),c=f("内容将在两秒后更新");function n(){c.value="正在提交...",u.value=!0,setTimeout(()=>{a.value=!1,u.value=!1},2e3)}return(s,d)=>(m(),y(q,null,[t(e(r),{onClick:d[0]||(d[0]=v=>a.value=!0)},{default:o(()=>[...d[3]||(d[3]=[l("打开对话框",-1)])]),_:1}),t(e(i),{open:a.value,"onUpdate:open":d[2]||(d[2]=v=>a.value=v),title:"自定义页脚","confirm-loading":u.value,onOk:n},{footer:o(()=>[t(e(r),{onClick:d[1]||(d[1]=v=>a.value=!1)},{default:o(()=>[...d[4]||(d[4]=[l("取消",-1)])]),_:1}),t(e(r),{onClick:n},{default:o(()=>[...d[5]||(d[5]=[l("确认",-1)])]),_:1})]),default:o(()=>[p("p",null,B(c.value),1)]),_:1},8,["open","confirm-loading"])],64))}}),A=`<template>
  <Button @click="open = true">打开对话框</Button>
...
<\/script>
`,F=b({__name:"ModalCustomIcon",setup(g){function a(){i.info({title:"自定义图标",content:"这个对话框使用了自定义的 VNode 作为图标。",icon:M("span",{style:{fontSize:"24px",color:"#1890ff"}},"🎨")})}function u(){i.confirm({title:"无图标确认",content:"通过设置 icon 为 null 可以隐藏图标。",icon:null})}return(c,n)=>(m(),x(e(w),null,{default:o(()=>[t(e(r),{onClick:a},{default:o(()=>[...n[0]||(n[0]=[l(" 使用自定义 VNode 图标 ",-1)])]),_:1}),t(e(r),{onClick:u},{default:o(()=>[...n[1]||(n[1]=[l(" 隐藏图标 ",-1)])]),_:1})]),_:1}))}}),z=`<template>
  <Space>
