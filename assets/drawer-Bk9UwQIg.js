import{B as k}from"./Button-BJ4qjE3i.js";import{d as D,u as et,r as y,m as W,y as at,c as s,T as st,s as ot,I as lt,a as B,o as $,b as N,F as L,e as d,w as o,g as p,f as a,_ as rt,A as dt,h as pt,i as it}from"./index-DZWA4HiS.js";import{S as ut}from"./index-COHq9QCp.js";import{c as h}from"./cls-S9IiI6wd.js";import{C as ct}from"./CloseOutlined-Kr3orOYj.js";import"./LoadingOutlined-_M72e6LV.js";class ft{constructor(){this.drawers=new Map,this.uidCounter=0}register(){const l=++this.uidCounter,m=this.drawers.size;return this.drawers.set(l,m),l}unregister(l){this.drawers.delete(l)}getZIndex(l,c){const m=this.drawers.get(l)??0;return c+m*2}get size(){return this.drawers.size}}const F=new ft,mt='a[href],button:not([disabled]),input:not([disabled]),select:not([disabled]),textarea:not([disabled]),[tabindex]:not([tabindex="-1"])';function kt(e,l){var u;const c=document.activeElement,m=()=>Array.from(e.querySelectorAll(mt));(u=m()[0])==null||u.focus();const n=b=>{if(b.key!=="Tab")return;const i=m();if(!i.length)return;const g=i[0],v=i[i.length-1];b.shiftKey?document.activeElement===g&&(b.preventDefault(),v.focus()):document.activeElement===v&&(b.preventDefault(),g.focus())};return e.addEventListener("keydown",n),()=>{e.removeEventListener("keydown",n),l&&(c==null||c.focus())}}let A=0,K="";function gt(){typeof document>"u"||(A===0&&(K=document.body.style.overflow,document.body.style.overflow="hidden"),A+=1)}function V(){typeof document>"u"||(A=Math.max(0,A-1),A===0&&(document.body.style.overflow=K))}let bt=0;const M=378,yt=736;function Z(e,l){if(l){const c=l();if(c&&c.length)return c}if(!(e==null||e===""))return typeof e=="function"?e():e}function wt(e){return typeof e=="number"?`${e}px`:e}const x=D({name:"Drawer",inheritAttrs:!1,props:{open:{type:Boolean,default:void 0},defaultOpen:Boolean,title:{type:[String,Number,Object,Function],default:void 0},placement:{type:String,default:"right"},size:{type:[String,Number],default:void 0},width:{type:[Number,String],default:M},height:{type:[Number,String],default:M},closable:{type:Boolean,default:!0},closeIcon:{type:Function,default:void 0},maskClosable:{type:Boolean,default:!0},mask:{type:Boolean,default:!0},keyboard:{type:Boolean,default:!0},loading:Boolean,zIndex:{type:Number,default:1e3},destroyOnClose:Boolean,destroyOnHidden:{type:Boolean,default:void 0},forceRender:Boolean,focusTriggerAfterClose:{type:Boolean,default:!0},getContainer:{type:[String,Object,Function,Boolean],default:void 0},rootClassName:{type:String,default:void 0},rootStyle:{type:Object,default:void 0},bodyStyle:{type:Object,default:void 0},headerStyle:{type:Object,default:void 0},footerStyle:{type:Object,default:void 0},maskStyle:{type:Object,default:void 0},contentWrapperStyle:{type:Object,default:void 0},classNames:{type:Object,default:void 0},styles:{type:Object,default:void 0}},emits:["update:open","close","afterOpenChange"],setup(e,{slots:l,emit:c,attrs:m}){const n=et("drawer"),u=`${n}-title-${bt+=1}`,b=y(e.defaultOpen??!1),i=y(null);let g=null,v=!1;const t=F.register(),f=B(()=>F.getZIndex(t,e.zIndex));W(()=>e.open,r=>{r!==void 0&&(b.value=r)});const q=B(()=>e.open!==void 0?e.open:b.value);W(q,async r=>{r?(e.mask&&(gt(),v=!0),await Promise.resolve(),i.value&&(g=kt(i.value,e.focusTriggerAfterClose))):(g==null||g(),g=null,v&&(V(),v=!1)),setTimeout(()=>c("afterOpenChange",r),0)},{flush:"post"}),at(()=>{g==null||g(),g=null,v&&(V(),v=!1),F.unregister(t)});const U=r=>{e.open===void 0&&(b.value=!1),c("update:open",!1),c("close",r)},G=r=>{e.mask&&e.maskClosable&&U(r)},Y=r=>{r.key==="Escape"&&e.keyboard&&q.value&&U(r)},j=B(()=>e.placement==="left"||e.placement==="right"),H=B(()=>{const{size:r}=e;return r==="large"?`${yt}px`:r==="default"?`${M}px`:typeof r=="number"?`${r}px`:typeof r=="string"?/^\d+(\.\d+)?$/.test(r)?`${r}px`:r:wt(j.value?e.width:e.height)}),J=B(()=>j.value?{width:H.value}:{height:H.value}),Q=B(()=>{const r=e.getContainer;return r===!1?"body":typeof r=="function"?r():typeof r=="string"||r instanceof HTMLElement?r:"body"}),X=()=>{if(!e.closable)return null;const r=e.closeIcon??ct;return s("button",{type:"button",class:`${n}-close`,onClick:w=>U(w),"aria-label":"Close"},[s(r,{class:"hmfw-icon"},null)])},_=()=>{var S,z,E,O,P,T,I;const r=Z(e.title,l.title),w=(S=l.extra)==null?void 0:S.call(l),C=r!=null&&r!=="";return!C&&!e.closable&&!w?null:s("div",{class:h(`${n}-header`,{[`${n}-header-close-only`]:e.closable&&!C&&!w},(z=e.classNames)==null?void 0:z.header),style:{...e.headerStyle,...(E=e.styles)==null?void 0:E.header}},[s("div",{class:`${n}-header-title`},[X(),C&&s("div",{id:u,class:h(`${n}-title`,(O=e.classNames)==null?void 0:O.title),style:(P=e.styles)==null?void 0:P.title},[r])]),w&&s("div",{class:h(`${n}-extra`,(T=e.classNames)==null?void 0:T.extra),style:(I=e.styles)==null?void 0:I.extra},[w])])},tt=()=>{var w,C,S;const r=(w=l.footer)==null?void 0:w.call(l);return!r||Array.isArray(r)&&!r.length?null:s("div",{class:h(`${n}-footer`,(C=e.classNames)==null?void 0:C.footer),style:{...e.footerStyle,...(S=e.styles)==null?void 0:S.footer}},[r])},nt=()=>{var w;return e.loading?s(ut,{active:!0,title:!1,paragraph:{rows:5},class:`${n}-body-skeleton`},null):(e.destroyOnHidden??e.destroyOnClose)&&!q.value?null:(w=l.default)==null?void 0:w.call(l)};return()=>{const r=Z(e.title,l.title)!=null,w={zIndex:f.value,...e.rootStyle},C=e.getContainer===!1;return s(lt,{to:Q.value,disabled:C},{default:()=>[s(st,{name:`hmfw-drawer-${e.placement}`,appear:!0},{default:()=>{var S,z,E,O,P,T,I,R;return[(q.value||e.forceRender)&&s("div",{class:h(`${n}-root`,e.rootClassName,{[`${n}-no-mask`]:!e.mask}),style:{...w,display:q.value?"":"none"},onKeydown:Y},[e.mask&&s("div",{class:h(`${n}-mask`,(S=e.classNames)==null?void 0:S.mask),style:{...e.maskStyle,...(z=e.styles)==null?void 0:z.mask},onClick:G},null),s("div",ot({ref:i,class:h(`${n}-content-wrapper`,`${n}-${e.placement}`,(E=e.classNames)==null?void 0:E.wrapper),style:{...J.value,...e.contentWrapperStyle,...(O=e.styles)==null?void 0:O.wrapper},role:"dialog","aria-modal":"true","aria-labelledby":r?u:void 0},m),[s("div",{class:h(`${n}-content`,(P=e.classNames)==null?void 0:P.content),style:(T=e.styles)==null?void 0:T.content},[_(),s("div",{class:h(`${n}-body`,(I=e.classNames)==null?void 0:I.body),style:{...e.bodyStyle,...(R=e.styles)==null?void 0:R.body}},[nt()]),tt()])])])]}})]})}}}),xt=D({__name:"DrawerBasic",setup(e){const l=y(!1);return(c,m)=>($(),N(L,null,[s(d(k),{type:"primary",onClick:m[0]||(m[0]=n=>l.value=!0)},{default:o(()=>[...m[2]||(m[2]=[p(" 打开抽屉 ",-1)])]),_:1}),s(d(x),{open:l.value,"onUpdate:open":m[1]||(m[1]=n=>l.value=n),title:"基础抽屉"},{default:o(()=>[...m[3]||(m[3]=[a("p",null,"抽屉内容",-1),a("p",null,"抽屉内容",-1),a("p",null,"抽屉内容",-1)])]),_:1},8,["open"])],64))}}),vt=`<template>
...
`,Tt={style:{display:"flex",gap:"8px"}},It={style:{"text-align":"right"}},At=D({__name:"DrawerExtraFooter",setup(e){const l=y(!1),c=y("default");return(m,n)=>($(),N(L,null,[a("div",Tt,[s(d(k),{onClick:n[0]||(n[0]=()=>{l.value=!0,c.value="default"})},{default:o(()=>[...n[6]||(n[6]=[p(" 默认 378px ",-1)])]),_:1}),s(d(k),{onClick:n[1]||(n[1]=()=>{l.value=!0,c.value="large"})},{default:o(()=>[...n[7]||(n[7]=[p(" 大号 736px ",-1)])]),_:1})]),s(d(x),{open:l.value,"onUpdate:open":n[5]||(n[5]=u=>l.value=u),size:c.value,title:"尺寸"},{extra:o(()=>[s(d(k),{type:"primary",onClick:n[2]||(n[2]=u=>l.value=!1)},{default:o(()=>[...n[8]||(n[8]=[p(" 确定 ",-1)])]),_:1})]),footer:o(()=>[a("div",It,[s(d(k),{style:{"margin-right":"8px"},onClick:n[3]||(n[3]=u=>l.value=!1)},{default:o(()=>[...n[9]||(n[9]=[p(" 取消 ",-1)])]),_:1}),s(d(k),{type:"primary",onClick:n[4]||(n[4]=u=>l.value=!1)},{default:o(()=>[...n[10]||(n[10]=[p(" 提交 ",-1)])]),_:1})])]),default:o(()=>[a("p",null,"当前尺寸："+dt(c.value),1)]),_:1},8,["open","size"])],64))}}),Lt=`<template>
