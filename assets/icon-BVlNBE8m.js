import{S as b}from"./Space-DxoCbPXb.js";import{W as V,g as E,s as $,a as P,b as N}from"./utils-B3fT4TBQ.js";import{C as G}from"./CheckOutlined-_g32GbF7.js";import{C as W}from"./CloseOutlined-Kr3orOYj.js";import{D as T}from"./DeleteOutlined-Blf6klq2.js";import{D as j}from"./DownOutlined-7PX7T7iC.js";import{E as Q}from"./EditOutlined-BKMrgpSa.js";import{E as Z,I as K}from"./Input-fgyoHGwZ.js";import{H as O}from"./HomeOutlined-DF6dHnnz.js";import{I as J}from"./RocketOutlined-B71HA_ff.js";import{L as X}from"./LeftOutlined-D1RAhMdi.js";import{L as A}from"./LoadingOutlined-_M72e6LV.js";import{M as Y}from"./MinusOutlined-CPZPETbH.js";import{P as nn}from"./PlusOutlined-DKbxQxtW.js";import{R as tn}from"./RightOutlined-DxQZ7HNk.js";import{S as sn}from"./SearchOutlined-ChywRtum.js";import{S as R}from"./SettingOutlined-CyWR3vWt.js";import{U as an}from"./UpOutlined-DvPWHlLA.js";import{U as h}from"./UserOutlined-DNkh_kwG.js";import{d as y,o as l,q as v,w as m,c as n,e as t,b as p,f as a,F as C,z as _,M as I,A as x,K as F,N as en,g as r,r as S,a as L,_ as on,h as ln,i as cn}from"./index-DZWA4HiS.js";import"./cls-S9IiI6wd.js";import"./AppleOutlined-1GBjdR5E.js";import"./TeamOutlined-Nzhe0z3F.js";import"./PictureOutlined-DkSZzSFv.js";import"./CalendarOutlined-Bop964ys.js";import"./CaretRightFilled-4nkEOFHH.js";import"./CheckCircleFilled-I8UqTjtq.js";import"./ClockCircleOutlined-C10tdH7d.js";import"./CloseCircleFilled-DiZVqLZC.js";import"./CloseCircleOutlined-D59UmevV.js";import"./CopyOutlined-C6tYUyyh.js";import"./DownloadOutlined-JuDicSTA.js";import"./ExclamationCircleFilled-C-dhOcMX.js";import"./UploadOutlined-BuhbJPp2.js";import"./InfoCircleFilled-BWvrjuRC.js";import"./ZoomOutOutlined-Ck-tO838.js";import"./WarningFilled-C_y0yCcw.js";const pn=y({__name:"IconBasic",setup(w){return(u,d)=>(l(),v(t(b),{size:16,wrap:""},{default:m(()=>[n(t(sn),{class:"hmfw-icon"}),n(t(W),{class:"hmfw-icon"}),n(t(G),{class:"hmfw-icon"}),n(t(V),{class:"hmfw-icon"}),n(t(J),{class:"hmfw-icon"}),n(t(A),{class:"hmfw-icon"}),n(t(an),{class:"hmfw-icon"}),n(t(j),{class:"hmfw-icon"}),n(t(X),{class:"hmfw-icon"}),n(t(tn),{class:"hmfw-icon"}),n(t(nn),{class:"hmfw-icon"}),n(t(Y),{class:"hmfw-icon"}),n(t(Q),{class:"hmfw-icon"}),n(t(T),{class:"hmfw-icon"}),n(t(Z),{class:"hmfw-icon"}),n(t(O),{class:"hmfw-icon"}),n(t(h),{class:"hmfw-icon"}),n(t(R),{class:"hmfw-icon"})]),_:1}))}}),un=`<template>
  <Space :size="16" wrap>
...
<\/script>
`,dn={class:"icon-browser"},rn={class:"search-wrapper"},mn={class:"category-tabs"},fn=["onClick"],kn={key:0,class:"icon-stats"},On={class:"stats-text"},hn={class:"style-switch"},wn=["onClick"],gn={key:1,class:"icon-groups"},xn={class:"group-title"},yn={class:"icon-list"},vn=["onClick"],Cn={class:"icon-label"},_n={key:0,class:"copied-badge"},Sn={key:2,class:"empty-state"},bn=y({__name:"IconBrowser",setup(w){const u=S(""),d=S("all"),g=S(""),s=S("all"),k=[{value:"all",label:"全部"},{value:"outlined",label:"线形"},{value:"filled",label:"实底"}],H=L(()=>["all",...E()]),D=i=>s.value==="filled"?i.filter(e=>e.name.endsWith("-filled")):s.value==="outlined"?i.filter(e=>!e.name.endsWith("-filled")):i,U=L(()=>{const i={};let e=[];if(u.value.trim())return{"Search Results":D($(u.value))};d.value!=="all"?e=P(d.value):e=N(),e=D(e),e.forEach(c=>{i[c.category]||(i[c.category]=[]),i[c.category].push(c)});const o={};return E().forEach(c=>{i[c]&&(o[c]=i[c])}),o}),z=L(()=>Object.values(U.value).reduce((i,e)=>i+e.length,0)),M=i=>{const o=i.name.split("-").map(B=>B.charAt(0).toUpperCase()+B.slice(1)).join(""),c=i.name.includes("filled")?"Filled":"Outlined",q=`<${o.replace(/filled$/i,"")+c} class="hmfw-icon" />`;navigator.clipboard.writeText(q).then(()=>{g.value=i.name,setTimeout(()=>{g.value=""},2e3)})};return(i,e)=>(l(),p("div",dn,[a("div",rn,[n(t(K),{value:u.value,"onUpdate:value":e[0]||(e[0]=o=>u.value=o),placeholder:"在此搜索图标，点击图标可复制代码",class:"search-input"},null,8,["value"])]),a("div",mn,[(l(!0),p(C,null,_(H.value,o=>(l(),p("button",{key:o,class:I(["category-tab",{active:d.value===o}]),onClick:c=>d.value=o},x(o==="all"?"全部图标":o),11,fn))),128))]),z.value>0?(l(),p("div",kn,[a("span",On,"共 "+x(z.value)+" 个图标",1),a("div",hn,[(l(),p(C,null,_(k,o=>a("button",{key:o.value,class:I(["style-switch__item",{active:s.value===o.value}]),onClick:c=>s.value=o.value},x(o.label),11,wn)),64))])])):F("",!0),z.value>0?(l(),p("div",gn,[(l(!0),p(C,null,_(U.value,(o,c)=>(l(),p("div",{key:c,class:"icon-group"},[a("h4",xn,x(c),1),a("ul",yn,[(l(!0),p(C,null,_(o,f=>(l(),p("li",{key:f.name,class:I(["icon-item",{copied:g.value===f.name}]),onClick:q=>M(f)},[(l(),v(en(f.component),{class:"hmfw-icon icon-svg"})),a("span",Cn,x(f.name),1),g.value===f.name?(l(),p("span",_n,[...e[1]||(e[1]=[a("svg",{viewBox:"64 64 896 896",width:"1em",height:"1em",fill:"currentColor"},[a("path",{d:"M912 190h-69.9c-9.8 0-19.1 4.5-25.1 12.2L404.7 724.5 207 474a32 32 0 00-25.1-12.2H112c-6.7 0-10.4 7.7-6.3 12.9l273.9 347c12.8 16.2 37.4 16.2 50.3 0l488.4-618.9c4.1-5.1.4-12.8-6.3-12.8z"})],-1),r(" Copied! ",-1)])])):F("",!0)],10,vn))),128))])]))),128))])):(l(),p("div",Sn,[...e[2]||(e[2]=[a("svg",{viewBox:"64 64 896 896",width:"64",height:"64",fill:"currentColor",opacity:"0.3"},[a("path",{d:"M893.6 693.2L730.4 530c-9.4-9.4-24.6-9.4-33.9 0l-63.7 63.7-96.6-96.6L762.9 270.4c1.8-1.9 3.3-4 4.5-6.2l86.8-158.8c2.8-5.1.9-11.5-4.2-14.3-5.1-2.8-11.5-.9-14.3 4.2L749 253.9c-1.2 2.2-2.7 4.3-4.5 6.2L518.2 486.4 282 250.2c-9.4-9.4-24.6-9.4-33.9 0L64.4 433.9c-9.4 9.4-9.4 24.6 0 33.9l464.6 464.6c9.4 9.4 24.6 9.4 33.9 0l330.7-330.8c9.4-9.4 9.4-24.6 0-33.9z"})],-1),a("p",{class:"empty-text"},"未找到相关图标",-1)])]))]))}}),zn=on(bn,[["__scopeId","data-v-a13fb4a9"]]),In=y({__name:"IconColor",setup(w){return(u,d)=>(l(),v(t(b),{size:16},{default:m(()=>[n(t(h),{class:"hmfw-icon",style:{"font-size":"24px",color:"#1677ff"}}),n(t(h),{class:"hmfw-icon",style:{"font-size":"24px",color:"#52c41a"}}),n(t(h),{class:"hmfw-icon",style:{"font-size":"24px",color:"#faad14"}}),n(t(h),{class:"hmfw-icon",style:{"font-size":"24px",color:"#ff4d4f"}}),n(t(h),{class:"hmfw-icon",style:{"font-size":"24px",color:"#722ed1"}})]),_:1}))}}),Ln=`<template>
  <Space :size="16">
...
<\/script>
`,qn=y({__name:"IconSpin",setup(w){return(u,d)=>(l(),v(t(b),{size:16},{default:m(()=>[n(t(A),{class:"hmfw-icon-spin",style:{"font-size":"24px"}}),n(t(R),{class:"hmfw-icon-spin",style:{"font-size":"24px"}})]),_:1}))}}),Bn=`<template>
  <Space :size="16">
