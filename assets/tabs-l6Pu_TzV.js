import{d as y,u as et,r as B,m as Y,k as ot,l as lt,c as a,a as Z,B as ct,n as pt,o as h,q as P,e as c,b as z,f as o,_ as it,v as D,h as dt,i as tt,w as T,g as V}from"./index-cgVI-orz.js";import{c as q}from"./cls-S9IiI6wd.js";import{C as rt}from"./CloseOutlined-H_Tga8k8.js";import{P as ut}from"./PlusOutlined-BhKQqLRS.js";import{B as bt}from"./Button-D7tvIoj2.js";import{a as mt,A as kt}from"./AppleOutlined-L9byCgKS.js";import{S as ft}from"./Select-DDreAcsa.js";import"./LoadingOutlined-BnULcwLn.js";import"./DownOutlined-Lt7RJDf6.js";import"./Trigger-WY8NmOER.js";import"./VirtualList-L6q9UIex.js";const m=y({name:"Tabs",props:{activeKey:String,defaultActiveKey:String,type:{type:String,default:"line"},size:String,tabPosition:{type:String,default:"top"},centered:Boolean,items:Array,animated:{type:[Boolean,Object],default:!0},tabBarExtraContent:[Object,Function],tabBarGutter:Number,tabBarStyle:Object,hideAdd:Boolean,addIcon:Object,removeIcon:Object,destroyInactiveTabPane:Boolean,classNames:Object,styles:Object},emits:["update:activeKey","change","tabClick","edit"],setup(t,{slots:e,emit:i}){var L,M;const n=et("tabs"),s=B(t.defaultActiveKey??((M=(L=t.items)==null?void 0:L[0])==null?void 0:M.key)??""),p=B(null),u=B(null);Y(()=>t.activeKey,d=>{d!==void 0&&(s.value=d)});const k=Z(()=>t.activeKey!==void 0?t.activeKey:s.value),w=Z(()=>typeof t.animated=="boolean"?{inkBar:t.animated,tabPane:t.animated}:{inkBar:!0,tabPane:!1,...t.animated}),f=()=>{if(!p.value||!u.value||t.type!=="line")return;const d=p.value.querySelector(`.${n}-tab-active`);if(!d)return;if(t.tabPosition==="left"||t.tabPosition==="right")u.value.style.top=`${d.offsetTop}px`,u.value.style.height=`${d.offsetHeight}px`,u.value.style.width="2px",u.value.style.left=t.tabPosition==="left"?"auto":"0",u.value.style.right=t.tabPosition==="left"?"0":"auto";else{const x=p.value.offsetLeft;u.value.style.left=`${x+d.offsetLeft}px`,u.value.style.width=`${d.offsetWidth}px`,u.value.style.height="2px",u.value.style.top="auto",u.value.style.bottom="0"}};Y(k,()=>{pt(f)}),ot(()=>{f(),window.addEventListener("resize",f)}),lt(()=>{window.removeEventListener("resize",f)});const j=(d,r)=>{s.value=d,i("update:activeKey",d),i("change",d),i("tabClick",d,r)},nt=d=>{i("edit",d,"add")},at=(d,r)=>{r.stopPropagation(),i("edit",d,"remove")},st=(d,r,x)=>{var N,$,A;const g=t.items??[];let b=x;if(r.key==="ArrowLeft"||r.key==="ArrowUp")r.preventDefault(),b=x-1,b<0&&(b=g.length-1);else if(r.key==="ArrowRight"||r.key==="ArrowDown")r.preventDefault(),b=x+1,b>=g.length&&(b=0);else if(r.key==="Enter"||r.key===" "){r.preventDefault(),g[x].disabled||j(d,r);return}else return;let O=0;for(;(N=g[b])!=null&&N.disabled&&O<g.length;)b=r.key==="ArrowLeft"||r.key==="ArrowUp"?b-1:b+1,b<0&&(b=g.length-1),b>=g.length&&(b=0),O++;if(!(($=g[b])!=null&&$.disabled)){const _=(A=p.value)==null?void 0:A.querySelectorAll(`.${n}-tab`)[b];_==null||_.focus()}};return()=>{var $,A,_,G,U,F,H,W;const d=t.items??[],r=t.type==="editable-card",x=t.size?`${n}-${t.size}`:"",g=t.tabPosition!=="top"?`${n}-${t.tabPosition}`:"",b=t.tabPosition==="left"||t.tabPosition==="right",O=t.tabBarGutter!==void 0?b?{marginBottom:`${t.tabBarGutter}px`}:{marginRight:`${t.tabBarGutter}px`}:{},N=()=>{if(!t.tabBarExtraContent)return{left:null,right:null};if(!ct(t.tabBarExtraContent)&&typeof t.tabBarExtraContent=="object"&&("left"in t.tabBarExtraContent||"right"in t.tabBarExtraContent)){const l=t.tabBarExtraContent;return{left:l.left?a("div",{class:`${n}-extra-content-left`},[l.left]):null,right:l.right?a("div",{class:`${n}-extra-content-right`},[l.right]):null}}return{left:null,right:a("div",{class:`${n}-extra-content`},[t.tabBarExtraContent])}};return a("div",{class:q(n,`${n}-${t.type}`,x,g,{[`${n}-centered`]:t.centered},($=t.classNames)==null?void 0:$.root),style:(A=t.styles)==null?void 0:A.root},[a("div",{class:q(`${n}-nav`,(_=t.classNames)==null?void 0:_.nav),style:{...t.tabBarStyle,...(G=t.styles)==null?void 0:G.nav}},[N().left,a("div",{class:`${n}-nav-wrap`},[a("div",{ref:p,class:`${n}-nav-list`,role:"tablist","aria-orientation":b?"vertical":"horizontal"},[d.map((l,v)=>{var S,I,E,J,Q,X;const C=l.key===k.value,R=r&&l.closable!==!1;return a("div",{key:l.key,id:`tab-${l.key}`,class:q(`${n}-tab`,{[`${n}-tab-active`]:C,[`${n}-tab-disabled`]:l.disabled},(S=t.classNames)==null?void 0:S.tab,C&&((I=t.classNames)==null?void 0:I.tabActive)),style:{...v<d.length-1?O:void 0,...(E=t.styles)==null?void 0:E.tab,...C?(J=t.styles)==null?void 0:J.tabActive:void 0},role:"tab","aria-selected":C,"aria-controls":`tabpanel-${l.key}`,"aria-disabled":l.disabled||void 0,tabindex:l.disabled?-1:C?0:-1,onClick:K=>!l.disabled&&j(l.key,K),onKeydown:K=>st(l.key,K,v)},[a("div",{class:`${n}-tab-btn`},[l.icon&&a("span",{class:q(`${n}-tab-icon`,(Q=t.classNames)==null?void 0:Q.tabIcon),style:(X=t.styles)==null?void 0:X.tabIcon},[l.icon]),l.label,R&&a("button",{type:"button",class:`${n}-tab-remove`,"aria-label":"remove",tabindex:-1,onClick:K=>at(l.key,K)},[l.closeIcon||t.removeIcon||a(rt,{class:"hmfw-icon"},null)])])])}),r&&!t.hideAdd&&a("button",{type:"button",class:`${n}-nav-add`,"aria-label":"add",onClick:nt},[t.addIcon||a(ut,{class:"hmfw-icon"},null)])]),t.type==="line"&&a("div",{ref:u,class:q(`${n}-ink-bar`,{[`${n}-ink-bar-animated`]:w.value.inkBar},(U=t.classNames)==null?void 0:U.inkBar),style:(F=t.styles)==null?void 0:F.inkBar},null)]),N().right]),a("div",{class:`${n}-content-holder`},[a("div",{class:q(`${n}-content`,{[`${n}-content-animated`]:w.value.tabPane},(H=t.classNames)==null?void 0:H.content),style:(W=t.styles)==null?void 0:W.content},[d.map(l=>{var S,I,E;const v=l.key===k.value,C=v||l.forceRender||!t.destroyInactiveTabPane,R=t.destroyInactiveTabPane&&!v&&!l.forceRender;return a("div",{key:l.key,id:`tabpanel-${l.key}`,class:q(`${n}-tabpane`,{[`${n}-tabpane-active`]:v,[`${n}-tabpane-hidden`]:!v},(S=t.classNames)==null?void 0:S.tabpane),style:(I=t.styles)==null?void 0:I.tabpane,role:"tabpanel","aria-labelledby":`tab-${l.key}`,tabindex:v?0:-1,hidden:!v||void 0},[C&&!R&&(l.children??((E=e[l.key])==null?void 0:E.call(e)))])})])])])}}}),gt=y({__name:"TabsBasic",setup(t){const e=[{key:"1",label:"Tab 1",children:"Content of Tab Pane 1"},{key:"2",label:"Tab 2",children:"Content of Tab Pane 2"},{key:"3",label:"Tab 3",children:"Content of Tab Pane 3"}],i=n=>{console.log("Active tab:",n)};return(n,s)=>(h(),P(c(m),{items:e,onChange:i}))}}),yt=`<template>
...
<\/script>
`,ht=y({__name:"TabsCard",setup(t){const e=[{key:"1",label:"Tab 1",children:"Content of Tab Pane 1"},{key:"2",label:"Tab 2",children:"Content of Tab Pane 2"},{key:"3",label:"Tab 3",children:"Content of Tab Pane 3"}];return(i,n)=>(h(),P(c(m),{type:"card",items:e}))}}),vt=`<template>
...
<\/script>
`,Tt=y({__name:"TabsCentered",setup(t){const e=[{key:"1",label:"Tab 1",children:"Content of Tab 1"},{key:"2",label:"Tab 2",children:"Content of Tab 2"},{key:"3",label:"Tab 3",children:"Content of Tab 3"}];return(i,n)=>(h(),P(c(m),{items:e,centered:""}))}}),xt=`<template>
...
<\/script>
`,wt={class:"demo-tabs-classnames"},Ct={class:"demo-section"},qt={class:"demo-section"},_t={class:"demo-section"},Bt={class:"demo-section"},Pt={class:"demo-section"},Nt={class:"demo-section"},$t={class:"demo-section"},At=y({__name:"TabsClassNames",setup(t){const e=[{key:"1",label:"标签一",children:"这是标签一的内容面板"},{key:"2",label:"标签二",children:"这是标签二的内容面板"},{key:"3",label:"标签三",children:"这是标签三的内容面板"}];return(i,n)=>(h(),z("div",wt,[o("section",Ct,[n[0]||(n[0]=o("h3",null,"1. 自定义根节点样式",-1)),a(c(m),{items:e,"class-names":{root:"custom-root"}})]),o("section",qt,[n[1]||(n[1]=o("h3",null,"2. 自定义标签栏样式",-1)),a(c(m),{items:e,"class-names":{nav:"custom-nav"}})]),o("section",_t,[n[2]||(n[2]=o("h3",null,"3. 自定义标签项与激活态",-1)),a(c(m),{items:e,"class-names":{tab:"custom-tab",tabActive:"custom-tab-active"}})]),o("section",Bt,[n[3]||(n[3]=o("h3",null,"4. 自定义墨条样式",-1)),a(c(m),{items:e,"class-names":{inkBar:"custom-inkbar"}})]),o("section",Pt,[n[4]||(n[4]=o("h3",null,"5. 自定义内容区域样式",-1)),a(c(m),{items:e,"class-names":{content:"custom-content",tabpane:"custom-tabpane"}})]),o("section",Nt,[n[5]||(n[5]=o("h3",null,"6. 组合使用多个 classNames",-1)),a(c(m),{items:e,"class-names":{root:"combined-root",nav:"combined-nav",tab:"combined-tab",tabActive:"combined-tab-active",inkBar:"combined-inkbar",content:"combined-content"}})]),o("section",$t,[n[6]||(n[6]=o("h3",null,"7. 使用 styles 动态样式",-1)),a(c(m),{items:e,styles:{root:{border:"2px solid #1890ff",borderRadius:"12px",padding:"12px"},nav:{background:"linear-gradient(135deg, #667eea 0%, #764ba2 100%)",borderRadius:"8px"},content:{padding:"16px",background:"#f0f2f5",borderRadius:"8px",marginTop:"12px"}}})])]))}}),St=it(At,[["__scopeId","data-v-5c7ab74c"]]),It=`<template>
...
`,Et=y({__name:"TabsEditable",setup(t){const e=B("1"),i=B([{key:"1",label:"Tab 1",children:"Content of Tab 1"},{key:"2",label:"Tab 2",children:"Content of Tab 2"},{key:"3",label:"Tab 3",children:"Content of Tab 3",closable:!1}]);let n=0;const s=(p,u)=>{if(u==="add"){const k=`newTab${n++}`;i.value.push({key:k,label:"New Tab",children:"Content of new Tab"}),e.value=k}else{const k=i.value.findIndex(f=>f.key===p),w=i.value.filter(f=>f.key!==p);if(w.length&&p===e.value){const f=w[k===w.length?k-1:k].key;e.value=f}i.value=w}};return(p,u)=>(h(),P(c(m),{"active-key":e.value,"onUpdate:activeKey":u[0]||(u[0]=k=>e.value=k),type:"editable-card",items:i.value,onEdit:s},null,8,["active-key","items"]))}}),Kt=`<template>
...
<\/script>
`,Ot=y({__name:"TabsExtra",setup(t){const e=[{key:"1",label:"Tab 1",children:"Content of Tab 1"},{key:"2",label:"Tab 2",children:"Content of Tab 2"},{key:"3",label:"Tab 3",children:"Content of Tab 3"}],i=D(bt,{style:"margin-left: 16px"},()=>"Extra Action");return(n,s)=>(h(),P(c(m),{items:e,"tab-bar-extra-content":c(i)},null,8,["tab-bar-extra-content"]))}}),zt=`<template>
...
<\/script>
`,Rt=y({__name:"TabsIcon",setup(t){const e=[{key:"1",label:"Tab 1",icon:D(mt,{class:"hmfw-icon"}),children:"Content of Tab 1"},{key:"2",label:"Tab 2",icon:D(kt,{class:"hmfw-icon"}),children:"Content of Tab 2"}];return(i,n)=>(h(),P(c(m),{items:e}))}}),Vt=`<template>
  <Tabs :items="items" />
</template>
...
<\/script>
`,Dt={style:{"margin-bottom":"16px"}},jt=y({__name:"TabsPosition",setup(t){const e=B("top"),i=[{value:"top",label:"top"},{value:"bottom",label:"bottom"},{value:"left",label:"left"},{value:"right",label:"right"}],n=[{key:"1",label:"Tab 1",children:"Content of Tab 1"},{key:"2",label:"Tab 2",children:"Content of Tab 2"},{key:"3",label:"Tab 3",children:"Content of Tab 3"}];return(s,p)=>(h(),z("div",null,[o("div",Dt,[p[1]||(p[1]=o("span",{style:{"margin-right":"8px"}},"Tab Position: ",-1)),a(c(ft),{value:e.value,"onUpdate:value":p[0]||(p[0]=u=>e.value=u),options:i,style:{width:"120px"}},null,8,["value"])]),a(c(m),{items:n,"tab-position":e.value},null,8,["tab-position"])]))}}),Lt=`<template>
  <div>
...
<\/script>
`,Mt=y({__name:"TabsSize",setup(t){const e=[{key:"1",label:"Tab 1",children:"Content of Tab 1"},{key:"2",label:"Tab 2",children:"Content of Tab 2"},{key:"3",label:"Tab 3",children:"Content of Tab 3"}];return(i,n)=>(h(),z("div",null,[a(c(m),{items:e,size:"small",style:{"margin-bottom":"16px"}}),a(c(m),{items:e,style:{"margin-bottom":"16px"}}),a(c(m),{items:e,size:"large"})]))}}),Gt=`<template>
  <div>
...
<span class="token selector">:deep(.my-tabs-root)</span> <span class="token punctuation">{</span>
...
<span class="token selector">:deep(.my-tabs-nav)</span> <span class="token punctuation">{</span>
...
<span class="token selector">:deep(.my-tabs-tab-active)</span> <span class="token punctuation">{</span>
