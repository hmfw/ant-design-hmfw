import{k as a,l as s,A as o}from"./index-CEDKhEzr.js";const e={class:"markdown-body"},i={__name:"i18n",setup(p,{expose:t}){return t({frontmatter:{}}),(c,n)=>(o(),a("div",e,[...n[0]||(n[0]=[s(`<h1 id="国际化" tabindex="-1">国际化</h1><p>ant-design-hmfw 内置中文（<code>zhCN</code>）和英文（<code>enUS</code>）两种语言包，通过 <code>ConfigProvider</code> 的 <code>locale</code> 属性切换。</p><h2 id="使用语言包" tabindex="-1">使用语言包</h2><pre class="language-vue"><code class="language-vue">&lt;template&gt;
