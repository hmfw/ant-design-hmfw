import{n as d}from"./notification-Ccrbr-sZ.js";import{k as f,w as p,g as a,d as n,B as m,j as r,M as l,G as u,h as b}from"./index-DvxRruME.js";import"./cls-S9IiI6wd.js";const g={style:{display:"flex",gap:"8px","flex-wrap":"wrap"}},x=f({__name:"NotificationBasic",setup(c){function i(){d.success({message:"操作成功",description:"您的操作已成功完成，请查看详情。"})}function e(){d.error({message:"操作失败",description:"操作过程中发生错误，请稍后重试。"})}function o(){d.warning({message:"警告",description:"此操作存在风险，请谨慎操作。"})}function t(){d.info({message:"提示信息",description:"这是一条普通的提示信息。"})}return(s,C)=>(p(),a("div",g,[n("button",{onClick:i},"成功"),n("button",{onClick:e},"错误"),n("button",{onClick:o},"警告"),n("button",{onClick:t},"信息")]))}}),k=`<template>
...
<\/script>
`,h={style:{display:"flex",gap:"8px","flex-wrap":"wrap"}},w=f({__name:"NotificationPlacement",setup(c){function i(e){d.info({message:`通知 (${e})`,description:`这是一条来自${e}的通知消息。`,placement:e})}return(e,o)=>(p(),a("div",h,[n("button",{onClick:o[0]||(o[0]=t=>i("topLeft"))},"左上角"),n("button",{onClick:o[1]||(o[1]=t=>i("topRight"))},"右上角"),n("button",{onClick:o[2]||(o[2]=t=>i("bottomLeft"))},"左下角"),n("button",{onClick:o[3]||(o[3]=t=>i("bottomRight"))},"右下角")]))}}),y=`<template>
  <div style="display: flex; gap: 8px; flex-wrap: wrap;">
