import{o as m,N as E,n as t,E as F,f,A as g,k as y,K as r,H as P,h as d,R as b,m as x,l as M}from"./index-B09KCCs0.js";import{o as H,x as K,Q as L,l as Q,p as R}from"./icons-n88SZ_u-.js";import{c as q}from"./cls-S9IiI6wd.js";const z={success:Q,info:L,warning:K,error:H};function h(n){return Object.prototype.toString.call(n)==="[object Object]"}const s=m({name:"Alert",props:{type:{type:String,default:void 0},variant:{type:String,default:"outlined"},title:String,message:String,description:String,showIcon:{type:Boolean,default:void 0},closable:{type:[Boolean,Object],default:void 0},closeText:[String,Object,Array,Function],closeIcon:[String,Object,Array,Function],icon:[String,Object,Array,Function],banner:Boolean,action:[String,Object,Array,Function],role:{type:String,default:"alert"}},emits:["close","afterClose"],setup(n,{slots:o,emit:c}){const i=E("alert"),e=F(!1),u=F(!1),N=f(()=>n.type!==void 0?n.type:n.banner?"warning":"info"),w=f(()=>n.banner&&n.showIcon===void 0?!0:!!n.showIcon),B=f(()=>n.title??n.message),T=f(()=>{const{closable:l,closeText:a,closeIcon:p}=n;return h(l)||a!=null&&a!==""?!0:typeof l=="boolean"?l:p!=null}),j=f(()=>{const{closable:l,closeText:a,closeIcon:p}=n;if(h(l)&&l.closeIcon!=null)return l.closeIcon;if(a!=null&&a!=="")return a;if(p!=null)return p;if(o.closeIcon)return o.closeIcon()}),O=f(()=>{const{closable:l}=n;return h(l)&&typeof l["aria-label"]=="string"?l["aria-label"]:"关闭"}),V=l=>{u.value=!0,c("close",l),setTimeout(()=>{e.value=!0,c("afterClose")},300)};return()=>{var _,C,$,I,S;if(e.value)return null;const l=N.value,a=!!(n.description||o.description),p=z[l],k=n.icon??((_=o.icon)==null?void 0:_.call(o))??t(p,null,null),D=j.value??t(R,null,null),v=((C=o.message)==null?void 0:C.call(o))??(($=o.title)==null?void 0:$.call(o))??B.value,A=n.action??((I=o.action)==null?void 0:I.call(o));return t("div",{role:n.role,"aria-live":l==="error"||l==="warning"?"assertive":"polite","data-show":!e.value,class:q(i,`${i}-${l}`,`${i}-${n.variant}`,{[`${i}-with-description`]:a,[`${i}-banner`]:n.banner,[`${i}-closing`]:u.value,[`${i}-no-icon`]:!w.value})},[w.value&&t("span",{class:`${i}-icon`},[k]),t("div",{class:`${i}-section`},[v!=null&&v!==""&&t("div",{class:`${i}-title`},[v]),a&&t("div",{class:`${i}-description`},[((S=o.description)==null?void 0:S.call(o))??n.description])]),A!=null&&t("div",{class:`${i}-actions`},[A]),T.value&&t("button",{type:"button",tabindex:0,class:`${i}-close-icon`,"aria-label":O.value,onClick:V},[D])])}}}),G={style:{display:"flex","flex-direction":"column",gap:"12px"}},J=m({__name:"AlertBanner",setup(n){return(o,c)=>(g(),y("div",G,[t(r(s),{banner:"",message:"顶部公告：banner 模式默认显示图标，类型默认为 warning。"}),t(r(s),{banner:"",type:"error",message:"错误公告"})]))}}),U=`<template>
