...
`,Ft=j({__name:"TourType",setup(t){const o=b(!1),s=b(!1),k=[{title:"默认样式",description:"这是默认样式的引导，白色背景。"},{title:"第二步",description:"继续介绍功能..."}],n=[{title:"主题样式",description:"这是主题样式的引导，蓝色背景。"},{title:"第二步",description:"继续介绍功能..."}];function u(){o.value=!0}function w(){s.value=!0}return(h,r)=>(D(),L("div",null,[d(m(yt),null,{default:x(()=>[d(m(B),{type:"primary",onClick:u},{default:x(()=>[...r[4]||(r[4]=[y(" 默认样式 ",-1)])]),_:1}),d(m(B),{type:"primary",onClick:w},{default:x(()=>[...r[5]||(r[5]=[y(" 主题样式 ",-1)])]),_:1})]),_:1}),d(m(T),{open:o.value,"onUpdate:open":r[0]||(r[0]=c=>o.value=c),steps:k,onFinish:r[1]||(r[1]=c=>o.value=!1)},null,8,["open"]),d(m(T),{open:s.value,"onUpdate:open":r[2]||(r[2]=c=>s.value=c),type:"primary",steps:n,onFinish:r[3]||(r[3]=c=>s.value=!1)},null,8,["open"])]))}}),Mt=`<template>
  <div>
    <Space>
