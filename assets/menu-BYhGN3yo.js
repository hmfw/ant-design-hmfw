import{B as g}from"./Button-Dov5fw3V.js";import{M as y}from"./Menu-DdyLSuo9.js";import{o as m,A as a,k as b,n as l,K as o,R as c,m as f,J as v,h as t,v as x,E as p,p as k,i as M,S as _,O as S,H as w,l as K}from"./index-C69_RY61.js";import"./cls-S9IiI6wd.js";import"./Icon-Bvf6WoCy.js";import"./LoadingOutlined-De7mgAt0.js";const T=m({__name:"MenuCollapsed",setup(u){const n=p(!1),s=p(["1"]),i=[{key:"1",label:"导航一",icon:"home"},{key:"2",label:"导航二",icon:"user"},{key:"3",label:"导航三",icon:"setting"}],e=({key:d})=>{s.value=[d]};return(d,r)=>(a(),b("div",null,[l(o(g),{type:"primary",style:{"margin-bottom":"16px"},onClick:r[0]||(r[0]=h=>n.value=!n.value)},{default:c(()=>[f(v(n.value?"展开":"折叠"),1)]),_:1}),t("div",{style:x({width:n.value?"80px":"256px",borderRight:"1px solid #f0f0f0",transition:"width 0.2s"})},[l(o(y),{mode:"inline",items:i,"selected-keys":s.value,"inline-collapsed":n.value,onSelect:e},null,8,["selected-keys","inline-collapsed"])],4)]))}}),I=`<template>
  <div>
