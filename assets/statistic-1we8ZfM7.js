...
`,ut={class:"statistic-demo"},pt=y({__name:"StatisticCountdown",setup(t){const a=q(Date.now()+72e5),s=q(Date.now()+1e3*60*60*24*2+1e3*30*30),d=q(Date.now()+1e3*10),e=()=>{Z.success("倒计时结束！")};return(l,u)=>(h(),w("div",ut,[n(i(V),{direction:"vertical",size:16},{default:m(()=>[n(i(R),{title:"倒计时",value:a.value,format:"HH:mm:ss"},null,8,["value"]),n(i(R),{title:"天数倒计时",value:s.value,format:"DD 天 HH 时 mm 分 ss 秒"},null,8,["value"]),n(i(R),{title:"毫秒倒计时",value:d.value,format:"HH:mm:ss:SSS",onFinish:e},null,8,["value"])]),_:1})]))}}),mt=N(pt,[["__scopeId","data-v-b242e756"]]),ft=`<template>
  <div class="statistic-demo">
...
`,St={class:"statistic-demo"},bt={style:{"margin-top":"16px"}},yt=y({__name:"StatisticLoading",setup(t){const a=q(!0),s=q(112893),d=()=>{a.value=!a.value};return(e,l)=>(h(),w("div",St,[n(i(V),{size:32},{default:m(()=>[n(i(r),{title:"用户数",value:s.value,loading:a.value},null,8,["value","loading"]),n(i(r),{title:"活跃用户",value:93,suffix:"/ 100",loading:a.value},null,8,["loading"]),n(i(R),{title:"倒计时",value:Date.now()+6e4,loading:a.value},null,8,["value","loading"])]),_:1}),o("div",bt,[n(i(tt),{onClick:d},{default:m(()=>[b(J(a.value?"显示内容":"显示加载"),1)]),_:1})])]))}}),ht=N(yt,[["__scopeId","data-v-6eca9204"]]),wt=`<template>
  <div class="statistic-demo">
    <Space :size="32">
