...
<\/script>
`,O={style:{display:"flex",gap:"8px"}},H=k({__name:"MessageDuration",setup(m){function u(){e.success("这条消息将显示 10 秒",10)}function r(){const n=e.warning("点我手动关闭",0);setTimeout(n,5e3)}function d(){e.info("关闭后将触发回调",2).then(()=>{e.success("消息已关闭！")})}return(n,l)=>(g(),f("div",O,[t(p(i),{onClick:u},{default:c(()=>[...l[0]||(l[0]=[a(" 显示 10 秒 ",-1)])]),_:1}),t(p(i),{onClick:r},{default:c(()=>[...l[1]||(l[1]=[a(" 不自动关闭 ",-1)])]),_:1}),t(p(i),{onClick:d},{default:c(()=>[...l[2]||(l[2]=[a(" 关闭后回调 ",-1)])]),_:1})]))}}),$=`<template>
