import{M as u}from"./index-BHWbAPoW.js";import{n as v,z as m,j as g,F as C,g as e,m as n,J as a,Q as l,D as k,l as s,_ as h,I as B,o as x,G as w,k as M}from"./index-bv5A37HL.js";import{B as f}from"./Button-DaEKIrtr.js";import"./icons-DrnBibzR.js";import"./index-BX7ajAlU.js";import"./cls-S9IiI6wd.js";import"./Icon-K3gH4Ffy.js";const N=v({__name:"ModalBasic",setup(b){const o=k(!1);function c(){console.log("确认"),o.value=!1}function r(){console.log("取消"),o.value=!1}return(t,d)=>(m(),g(C,null,[e("button",{onClick:d[0]||(d[0]=i=>o.value=!0)},"打开对话框"),n(a(u),{open:o.value,"onUpdate:open":d[1]||(d[1]=i=>o.value=i),title:"基础对话框",onOk:c,onCancel:r},{default:l(()=>[...d[2]||(d[2]=[e("p",null,"对话框内容",-1),e("p",null,"对话框内容",-1),e("p",null,"对话框内容",-1)])]),_:1},8,["open"])],64))}}),O=`<template>
...
const open = ref(false)
<\/script>
`,V=v({__name:"ModalClassNames",setup(b){const o=k(!1);function c(){console.log("确认"),o.value=!1}return(r,t)=>(m(),g(C,null,[n(a(f),{onClick:t[0]||(t[0]=d=>o.value=!0)},{default:l(()=>[...t[2]||(t[2]=[s(" 打开自定义样式对话框 ",-1)])]),_:1}),n(a(u),{open:o.value,"onUpdate:open":t[1]||(t[1]=d=>o.value=d),title:"细粒度样式控制","class-names":{header:"custom-header",body:"custom-body",footer:"custom-footer"},styles:{header:{background:"#f0f5ff",borderRadius:"8px 8px 0 0"},body:{padding:"32px"},footer:{background:"#fafafa"}},onOk:c},{default:l(()=>[...t[3]||(t[3]=[e("p",null,"通过 classNames 和 styles 可以细粒度控制对话框各部分的样式。",-1),e("p",null,"这个例子演示了如何自定义 header、body 和 footer 的样式。",-1)])]),_:1},8,["open"])],64))}}),T=h(V,[["__scopeId","data-v-125c4de0"]]),I=`<template>
