...
<\/script>
`,q=m({__name:"TimelineBasic",setup(e){const o=[{content:"创建服务现场 2015-09-01"},{content:"初步排除网络异常 2015-09-01"},{content:"技术测试异常 2015-09-01"},{content:"网络异常正在修复 2015-09-01"}];return(n,l)=>(u(),g(s(a),{items:o}))}}),G=`<template>
...
<\/script>
`,J=m({__name:"TimelineCustomColor",setup(e){const o=[{content:"成功事件",color:"green"},{content:"失败事件",color:"red"},{content:"警告事件",color:"gray"},{content:"自定义颜色",color:"#00CCFF"}];return(n,l)=>(u(),g(s(a),{items:o}))}}),Q=`<template>
  <Timeline :items="items" />
</template>
