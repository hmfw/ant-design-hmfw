import{I as i,a as y,b,T as w}from"./Input-_jKyeH4e.js";import{m as g,y as c,i as h,l as e,I as l,B as u,f as o,H as I,E as S,P as x,j as U}from"./index-CsoOETlJ.js";import"./cls-S9IiI6wd.js";const k={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"400px"}},P=g({__name:"InputAddon",setup(m){const d=u(""),s=u(""),a=u(""),t=u("");return(n,r)=>(c(),h("div",k,[e(l(i),{value:d.value,"onUpdate:value":r[0]||(r[0]=p=>d.value=p),placeholder:"请输入用户名",prefix:"👤"},null,8,["value"]),e(l(i),{value:s.value,"onUpdate:value":r[1]||(r[1]=p=>s.value=p),placeholder:"请输入金额",prefix:"¥",suffix:"元"},null,8,["value"]),e(l(i),{value:a.value,"onUpdate:value":r[2]||(r[2]=p=>a.value=p),placeholder:"带前置/后置标签","addon-before":"http://","addon-after":".com"},null,8,["value"]),e(l(i),{value:t.value,"onUpdate:value":r[3]||(r[3]=p=>t.value=p),placeholder:"支持清除","allow-clear":""},null,8,["value"])]))}}),A=`<template>
...
const password2 = ref('')
<\/script>
`,R={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"400px"}},C=g({__name:"InputSearch",setup(m){const d=u(""),s=u(""),a=u(""),t=u(!1),n=p=>{console.log("搜索：",p)},r=p=>{t.value=!0,setTimeout(()=>{t.value=!1,console.log("搜索完成：",p)},1500)};return(p,v)=>(c(),h("div",R,[e(l(b),{value:d.value,"onUpdate:value":v[0]||(v[0]=f=>d.value=f),placeholder:"请输入搜索内容",onSearch:n},null,8,["value"]),e(l(b),{value:s.value,"onUpdate:value":v[1]||(v[1]=f=>s.value=f),placeholder:"带按钮的搜索框","enter-button":"",onSearch:n},null,8,["value"]),e(l(b),{value:a.value,"onUpdate:value":v[2]||(v[2]=f=>a.value=f),placeholder:"加载中","enter-button":"",loading:t.value,onSearch:r},null,8,["value","loading"])]))}}),_=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; max-width: 400px;">
    <InputSearch
...
<\/script>
`,z={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"400px"}},D=g({__name:"InputTextArea",setup(m){const d=u(""),s=u(""),a=u("");return(t,n)=>(c(),h("div",z,[e(l(w),{value:d.value,"onUpdate:value":n[0]||(n[0]=r=>d.value=r),placeholder:"固定行数",rows:4},null,8,["value"]),e(l(w),{value:s.value,"onUpdate:value":n[1]||(n[1]=r=>s.value=r),placeholder:"自适应高度","auto-size":{minRows:2,maxRows:6}},null,8,["value"]),e(l(w),{value:a.value,"onUpdate:value":n[2]||(n[2]=r=>a.value=r),placeholder:"显示字数",maxlength:100,"show-count":!0},null,8,["value"])]))}}),L=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; max-width: 400px;">
    <TextArea
      v-model:value="text1"
      placeholder="固定行数"
