import{B as Q}from"./Button-B7cCICCq.js";import{S as X}from"./Space-3bEPr88J.js";import{o as b,O as tt,n as a,f as x,p as N,A as y,i as w,Q as g,L as i,m as l,h as s,K as nt,E as st,k as C,_ as et,H as at,l as ot}from"./index-Bxt2WIDN.js";import{c as m}from"./cls-S9IiI6wd.js";import{C as it}from"./CloseOutlined-U1-bOQkR.js";import{C as ct}from"./CheckOutlined-DqOME6Da.js";import"./LoadingOutlined-T50wZmIy.js";const v=b({name:"Steps",props:{current:{type:Number,default:0},initial:{type:Number,default:0},items:{type:Array,default:()=>[]},direction:{type:String},orientation:{type:String},size:{type:String,default:"default"},status:{type:String,default:"process"},type:{type:String,default:"default"},labelPlacement:{type:String},titlePlacement:{type:String},progressDot:{type:[Boolean,Function]},variant:{type:String,default:"filled"},responsive:{type:Boolean,default:!0},ellipsis:Boolean,offset:{type:Number,default:0},iconRender:Function,classNames:Object,styles:Object},emits:["change"],setup(n,{emit:o}){const e=tt("steps"),k=x(()=>n.type&&n.type!=="default"?n.type:n.progressDot?"dot":n.type),t=x(()=>k.value==="dot"||k.value==="inline"),f=x(()=>k.value==="inline"),q=x(()=>(n.orientation||n.direction)==="vertical"?"vertical":"horizontal"),$=x(()=>t.value||q.value==="vertical"?q.value==="vertical"?"horizontal":"vertical":n.titlePlacement||n.labelPlacement||"horizontal"),G=(p,d)=>{if(d.status)return d.status;const r=p+n.initial;return r<n.current?"finish":r===n.current?n.status:"wait"},J=(p,d,r)=>{const c=`${e}-item-icon`;let u=null;if(t.value||r.icon)u=r.icon||N("span",{class:`${e}-icon-dot`});else switch(d){case"finish":u=N(ct,{class:m("hmfw-icon",`${c}-finish`)});break;case"error":u=N(it,{class:m("hmfw-icon",`${c}-error`)});break;default:u=N("span",{class:`${c}-number`},p+n.initial+1)}let h=u;if(n.iconRender){const S={index:p,active:p+n.initial===n.current,item:{...r,status:d}};h=n.iconRender(h,S)}else if(typeof n.progressDot=="function"){const S={index:p,active:p+n.initial===n.current,item:{...r,status:d}};h=n.progressDot(h,S)}return h},U=(p,d,r)=>{if(d.disabled)return;d.onClick&&d.onClick(r);const c=p+n.initial;c!==n.current&&o("change",c)};return()=>{var d,r;const p=n.items??[];return a("div",{class:m(e,`${e}-${q.value}`,`${e}-${n.variant}`,{[`${e}-${n.size}`]:n.size!=="default",[`${e}-label-${$.value}`]:$.value!=="horizontal",[`${e}-dot`]:t.value,[`${e}-inline`]:f.value,[`${e}-ellipsis`]:n.ellipsis},(d=n.classNames)==null?void 0:d.root),style:(r=n.styles)==null?void 0:r.root,role:"list","aria-label":"步骤条"},[p.map((c,u)=>{var z,B,P,D,E,I,V,T,A,O,F,R,W,j,M,H,K,L;const h=G(u,c),S=J(u,h,c),Y=!c.disabled,_=c.content||c.description;return a("div",{key:u,class:m(`${e}-item`,`${e}-item-${h}`,{[`${e}-item-disabled`]:c.disabled,[`${e}-item-active`]:u+n.initial===n.current},(z=n.classNames)==null?void 0:z.item),style:(B=n.styles)==null?void 0:B.item,role:"listitem","aria-current":u+n.initial===n.current?"step":void 0,"aria-disabled":c.disabled||void 0,onClick:Z=>Y&&U(u,c,Z)},[a("div",{class:m(`${e}-item-header`,(P=n.classNames)==null?void 0:P.header),style:(D=n.styles)==null?void 0:D.header},[a("div",{class:m(`${e}-item-icon`,(E=n.classNames)==null?void 0:E.icon),style:(I=n.styles)==null?void 0:I.icon},[S]),a("div",{class:m(`${e}-item-title`,(V=n.classNames)==null?void 0:V.title),style:(T=n.styles)==null?void 0:T.title},[c.title,c.subTitle&&a("span",{class:m(`${e}-item-subtitle`,(A=n.classNames)==null?void 0:A.subtitle),style:(O=n.styles)==null?void 0:O.subtitle},[c.subTitle])]),a("div",{class:m(`${e}-item-tail`,(F=n.classNames)==null?void 0:F.tail),style:(R=n.styles)==null?void 0:R.tail},null)]),a("div",{class:m(`${e}-item-content`,(W=n.classNames)==null?void 0:W.content),style:(j=n.styles)==null?void 0:j.content},[a("div",{class:m(`${e}-item-icon`,`${e}-item-icon-placeholder`,(M=n.classNames)==null?void 0:M.icon),style:(H=n.styles)==null?void 0:H.icon},null),_&&a("div",{class:m(`${e}-item-description`,(K=n.classNames)==null?void 0:K.description),style:(L=n.styles)==null?void 0:L.description},[_])])])})])}}}),lt=b({__name:"StepsBasic",setup(n){const o=st(0),e=[{title:"第一步",description:"填写基本信息"},{title:"第二步",description:"确认订单信息"},{title:"第三步",description:"完成支付"}];return(k,t)=>(y(),w(i(X),{direction:"vertical",style:{width:"100%"}},{default:g(()=>[a(i(v),{current:o.value,items:e},null,8,["current"]),a(i(X),null,{default:g(()=>[a(i(Q),{disabled:o.value===0,onClick:t[0]||(t[0]=f=>o.value--)},{default:g(()=>[...t[2]||(t[2]=[l(" 上一步 ",-1)])]),_:1},8,["disabled"]),a(i(Q),{type:"primary",disabled:o.value===e.length-1,onClick:t[1]||(t[1]=f=>o.value++)},{default:g(()=>[...t[3]||(t[3]=[l(" 下一步 ",-1)])]),_:1},8,["disabled"])]),_:1}),s("p",null,"当前步骤："+nt(o.value+1),1)]),_:1}))}}),dt=`<template>
...
<\/script>
`,pt={style:{display:"flex","flex-direction":"column",gap:"32px"}},rt=b({__name:"StepsClassNames",setup(n){const o=[{title:"已完成",content:"这是第一步的描述"},{title:"进行中",content:"这是第二步的描述"},{title:"待处理",content:"这是第三步的描述"}],e=[{title:"注册账号",content:"填写基本信息并验证邮箱"},{title:"完善资料",content:"上传头像并填写个人详情"},{title:"开始使用",content:"探索产品功能"}];return(k,t)=>(y(),C("div",pt,[s("div",null,[t[0]||(t[0]=s("div",{style:{"margin-bottom":"12px",color:"#666"}},"自定义根容器背景：",-1)),a(i(v),{current:1,items:o,"class-names":{root:"custom-root"}})]),s("div",null,[t[1]||(t[1]=s("div",{style:{"margin-bottom":"12px",color:"#666"}},"自定义图标与标题：",-1)),a(i(v),{current:1,items:o,"class-names":{icon:"custom-icon",title:"custom-title"}})]),s("div",null,[t[2]||(t[2]=s("div",{style:{"margin-bottom":"12px",color:"#666"}},"自定义连接线：",-1)),a(i(v),{current:1,items:e,"class-names":{tail:"custom-tail",description:"custom-description"}})]),s("div",null,[t[3]||(t[3]=s("div",{style:{"margin-bottom":"12px",color:"#666"}},"使用内联样式：",-1)),a(i(v),{current:2,items:o,styles:{root:{padding:"20px",backgroundColor:"#fafafa",borderRadius:"8px"},icon:{fontSize:"20px"},title:{fontWeight:600,color:"#1677ff"}}})]),s("div",null,[t[4]||(t[4]=s("div",{style:{"margin-bottom":"12px",color:"#666"}},"垂直步骤条组合定制：",-1)),a(i(v),{orientation:"vertical",current:1,items:e,"class-names":{item:"custom-vertical-item",container:"custom-container",content:"custom-content"}})])]))}}),ut=et(rt,[["__scopeId","data-v-473a969e"]]),mt=`<template>
...
`,kt=b({__name:"StepsDot",setup(n){const o=[{title:"已完成",description:"2024-01-01"},{title:"进行中",description:"2024-01-02"},{title:"待处理",description:"2024-01-03"},{title:"待处理",description:"2024-01-04"}];return(e,k)=>(y(),w(i(v),{"progress-dot":"",current:1,items:o}))}}),ft=`<template>
...
<\/script>
`,gt=b({__name:"StepsError",setup(n){const o=[{title:"已完成",description:"操作成功"},{title:"处理中",description:"操作失败",status:"error"},{title:"待处理",description:"等待处理"}];return(e,k)=>(y(),w(i(v),{current:1,status:"error",items:o}))}}),vt=`<template>
...
<\/script>
`,ht={style:{padding:"20px"}},bt=b({__name:"StepsInline",setup(n){const o=[{title:"Step 1",content:"First step"},{title:"Step 2",content:"Second step"},{title:"Step 3",content:"Third step"},{title:"Step 4",content:"Fourth step"}];return(e,k)=>(y(),C("div",ht,[a(i(v),{items:o,type:"inline",current:1})]))}}),yt=`<template>
...
<\/script>
`,St=b({__name:"StepsSmall",setup(n){const o=[{title:"第一步"},{title:"第二步"},{title:"第三步"}];return(e,k)=>(y(),w(i(v),{size:"small",current:1,items:o}))}}),xt=`<template>
...
<\/script>
`,wt=b({__name:"StepsVertical",setup(n){const o=[{title:"已完成",description:"这是一段描述文字。"},{title:"进行中",description:"这是一段描述文字。"},{title:"待处理",description:"这是一段描述文字。"}];return(e,k)=>(y(),w(i(v),{direction:"vertical",current:1,items:o}))}}),Nt=`<template>
