import{n as g,M as G,K as J,D as p,P as Q,w as W,m as o,e as $,q as X,z as y,j as R,J as i,g as e,I as V,G as Y,Q as w,l as c,k as Z}from"./index-BIkAb7lZ.js";import{c as j}from"./cls-S9IiI6wd.js";import{T as K}from"./Tooltip-B_1Hxmej.js";function E(a){return typeof a=="function"||Object.prototype.toString.call(a)==="[object Object]"&&!X(a)}const f=g({name:"Rate",props:{value:Number,defaultValue:{type:Number,default:0},count:{type:Number,default:5},allowHalf:Boolean,allowClear:{type:Boolean,default:!0},disabled:Boolean,character:{type:[String,Function],default:"★"},tooltips:Array,size:String,keyboard:{type:Boolean,default:!0},autoFocus:Boolean},emits:["update:value","change","hoverChange","focus","blur","keydown"],setup(a,{slots:d,emit:r,expose:u}){const t=G("rate"),n=J(),m=p(),x=p(a.defaultValue??a.value??0),h=p(null),A=p(!1),F=$(()=>a.value!==void 0),k=$(()=>F.value?a.value:x.value),B=$(()=>a.size??n.value.componentSize),z=$(()=>n.value.direction==="rtl");Q(()=>a.value,l=>{l!==void 0&&(x.value=l)}),W(()=>{var l;a.autoFocus&&((l=m.value)==null||l.focus())}),u({focus:()=>{var l;return(l=m.value)==null?void 0:l.focus()},blur:()=>{var l;return(l=m.value)==null?void 0:l.blur()}});const C=l=>{if(a.disabled)return;let s=l;a.allowClear&&l===k.value&&(s=0),x.value=s,r("update:value",s),r("change",s)},M=(l,s)=>s?l+.5:l+1,H=(l,s)=>{C(M(l,s))},N=(l,s)=>{const v=M(l,s);h.value!==v&&(h.value=v,r("hoverChange",v))},T=()=>{h.value=null,r("hoverChange",void 0)},L=$(()=>h.value??k.value),P=l=>{const s=L.value,v=l+1,b=l+.5;return s>=v?"full":a.allowHalf&&s>=b?"half":"zero"},I=l=>{if(!a.keyboard||a.disabled)return;r("keydown",l);const{key:s}=l,v=k.value,b=a.allowHalf?.5:1,U=z.value?["ArrowLeft","ArrowUp"]:["ArrowRight","ArrowUp"],q=z.value?["ArrowRight","ArrowDown"]:["ArrowLeft","ArrowDown"];if(U.includes(s)){l.preventDefault();const S=Math.min(v+b,a.count);S!==v&&C(S)}else if(q.includes(s)){l.preventDefault();const S=Math.max(v-b,0);S!==v&&C(S)}else s==="Home"?(l.preventDefault(),v!==0&&C(0)):s==="End"&&(l.preventDefault(),v!==a.count&&C(a.count))},D=(l,s)=>{const v={index:l,value:k.value,isHalf:s};return typeof a.character=="function"?a.character(v):d.character?d.character(v):a.character},O=l=>{var U;const s=P(l),v=(U=a.tooltips)==null?void 0:U[l],b=o("li",{key:l,class:j(`${t}-star`,{[`${t}-star-full`]:s==="full",[`${t}-star-half`]:s==="half",[`${t}-star-zero`]:s==="zero"}),role:"radio","aria-checked":s!=="zero","aria-posinset":l+1,"aria-setsize":a.count},[a.allowHalf&&o("div",{class:`${t}-star-first`,onClick:()=>!a.disabled&&H(l,!0),onMousemove:()=>!a.disabled&&N(l,!0)},[D(l,!0)]),o("div",{class:`${t}-star-second`,onClick:()=>!a.disabled&&H(l,!1),onMousemove:()=>!a.disabled&&N(l,!1)},[D(l,!1)])]);return v?typeof v=="string"?o(K,{title:v},E(b)?b:{default:()=>[b]}):o(K,v,E(b)?b:{default:()=>[b]}):b};return()=>{const l=Array.from({length:a.count},(s,v)=>v);return o("ul",{ref:m,class:j(t,{[`${t}-disabled`]:a.disabled,[`${t}-small`]:B.value==="small",[`${t}-large`]:B.value==="large",[`${t}-rtl`]:z.value}),onMouseleave:T,onFocus:()=>{A.value=!0,r("focus")},onBlur:()=>{A.value=!1,r("blur")},onKeydown:I,tabindex:a.disabled?-1:0,role:"radiogroup",dir:z.value?"rtl":void 0,"aria-disabled":a.disabled||void 0},[l.map(O)])}}}),_={style:{display:"flex","flex-direction":"column",gap:"16px"}},tt=g({__name:"RateBasic",setup(a){const d=p(3),r=p(2.5);return(u,t)=>(y(),R("div",_,[o(i(f),{value:d.value,"onUpdate:value":t[0]||(t[0]=n=>d.value=n)},null,8,["value"]),o(i(f),{value:r.value,"onUpdate:value":t[1]||(t[1]=n=>r.value=n),disabled:""},null,8,["value"]),e("p",null,"评分："+V(d.value),1)]))}}),et=`<template>
