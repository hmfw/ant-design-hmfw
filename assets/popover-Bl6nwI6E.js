import{m as _,L as X,B as k,O as I,v as Y,u as z,l as n,T as H,F as N,d as $,r as U,y as w,g as q,P as m,f as l,I as g,i as C,D as G,H as J,E as K,j as Q}from"./index-BZUMvgWw.js";import{c as Z}from"./cls-S9IiI6wd.js";const P=_({name:"Popover",props:{title:String,content:String,placement:{type:String,default:"top"},trigger:{type:[String,Array],default:"hover"},open:{type:Boolean,default:void 0},defaultOpen:Boolean,arrow:{type:Boolean,default:!0},mouseEnterDelay:{type:Number,default:.1},mouseLeaveDelay:{type:Number,default:.1},disabled:Boolean,overlayStyle:Object,overlayInnerStyle:Object},emits:["update:open","openChange"],setup(o,{slots:r,emit:a}){const u=X("popover"),e=k(null),v=k(null),L=k(o.defaultOpen??!1),S=k({top:0,left:0});let h=null,b=null;const A=$(()=>o.open!==void 0),B=$(()=>A.value?o.open:L.value);I(()=>o.open,t=>{t!==void 0&&(L.value=t)});const y=$(()=>{const t=o.trigger;return Array.isArray(t)?t:[t]}),x=t=>{o.disabled||(L.value=t,a("update:open",t),a("openChange",t))},F=()=>{if(!e.value||!v.value)return;const t=e.value.getBoundingClientRect(),i=v.value.getBoundingClientRect(),s=window.scrollX,p=window.scrollY,d=o.placement;let c=0,f=0;const T=8,O=t.left+t.width/2+s,M=t.top+t.height/2+p;d.startsWith("top")?(c=t.top+p-i.height-T,d==="top"?f=O-i.width/2:d==="topLeft"?f=t.left+s:f=t.right+s-i.width):d.startsWith("bottom")?(c=t.bottom+p+T,d==="bottom"?f=O-i.width/2:d==="bottomLeft"?f=t.left+s:f=t.right+s-i.width):d.startsWith("left")?(f=t.left+s-i.width-T,d==="left"?c=M-i.height/2:d==="leftTop"?c=t.top+p:c=t.bottom+p-i.height):d.startsWith("right")&&(f=t.right+s+T,d==="right"?c=M-i.height/2:d==="rightTop"?c=t.top+p:c=t.bottom+p-i.height),S.value={top:c,left:f}};I(B,async t=>{t&&(await U(),F())});const R=()=>{y.value.includes("hover")&&(b&&(clearTimeout(b),b=null),h=setTimeout(()=>x(!0),o.mouseEnterDelay*1e3))},D=()=>{y.value.includes("hover")&&(h&&(clearTimeout(h),h=null),b=setTimeout(()=>x(!1),o.mouseLeaveDelay*1e3))},W=()=>{y.value.includes("click")&&x(!B.value)},j=()=>{y.value.includes("focus")&&x(!0)},V=()=>{y.value.includes("focus")&&x(!1)},E=t=>{var i,s;B.value&&((i=e.value)!=null&&i.contains(t.target)||(s=v.value)!=null&&s.contains(t.target)||y.value.includes("click")&&x(!1))};return Y(()=>document.addEventListener("click",E)),z(()=>{document.removeEventListener("click",E),h&&clearTimeout(h),b&&clearTimeout(b)}),()=>{var s;const t=(s=r.default)==null?void 0:s.call(r)[0];if(!t)return null;const i={position:"absolute",top:`${S.value.top}px`,left:`${S.value.left}px`,zIndex:"1070",...o.overlayStyle};return n(N,null,[n("div",{ref:e,style:{display:"inline-block"},onMouseenter:R,onMouseleave:D,onClick:W,onFocus:j,onBlur:V},[t]),n(H,{to:"body"},{default:()=>{var p,d;return[n("div",{ref:v,class:Z(u,`${u}-placement-${o.placement}`,{[`${u}-hidden`]:!B.value}),style:i,onMouseenter:R,onMouseleave:D},[n("div",{class:`${u}-content`},[o.arrow&&n("div",{class:`${u}-arrow`},null),n("div",{class:`${u}-inner`,style:o.overlayInnerStyle},[(o.title||r.title)&&n("div",{class:`${u}-title`},[((p=r.title)==null?void 0:p.call(r))??o.title]),n("div",{class:`${u}-inner-content`},[((d=r.content)==null?void 0:d.call(r))??o.content])])])])]}})])}}}),tt=_({__name:"PopoverBasic",setup(o){return(r,a)=>(w(),q(g(P),{title:"标题",content:"这是气泡卡片的内容"},{default:m(()=>[...a[0]||(a[0]=[l("button",null,"鼠标移入",-1)])]),_:1}))}}),et=`<template>
