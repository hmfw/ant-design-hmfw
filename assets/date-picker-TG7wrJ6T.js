...
<\/script>
`,ye={style:{display:"flex","flex-direction":"column",gap:"16px",width:"300px"}},$e=P({__name:"DatePickerDisabledDate",setup(e){const l=h(""),t=h(""),s=u=>new Date(u)<new Date(new Date().toDateString()),d=u=>new Date(u)>new Date(new Date().toDateString());return(u,v)=>(C(),Y("div",ye,[a(m(b),{value:l.value,"onUpdate:value":v[0]||(v[0]=o=>l.value=o),"disabled-date":s,placeholder:"不可选择过去日期"},null,8,["value"]),a(m(b),{value:t.value,"onUpdate:value":v[1]||(v[1]=o=>t.value=o),"disabled-date":d,placeholder:"不可选择未来日期"},null,8,["value"])]))}}),we=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; width: 300px;">
    <DatePicker
      v-model:value="date"
...
<\/script>
`,xe={style:{display:"flex","flex-direction":"column",gap:"16px",width:"300px"}},Pe=P({__name:"DatePickerPicker",setup(e){const l=h(""),t=h(""),s=h(""),d=h("");return(u,v)=>(C(),Y("div",xe,[a(m(b),{value:l.value,"onUpdate:value":v[0]||(v[0]=o=>l.value=o),picker:"date",placeholder:"选择日期"},null,8,["value"]),a(m(b),{value:t.value,"onUpdate:value":v[1]||(v[1]=o=>t.value=o),picker:"month",placeholder:"选择月份"},null,8,["value"]),a(m(b),{value:s.value,"onUpdate:value":v[2]||(v[2]=o=>s.value=o),picker:"quarter",placeholder:"选择季度"},null,8,["value"]),a(m(b),{value:d.value,"onUpdate:value":v[3]||(v[3]=o=>d.value=o),picker:"year",placeholder:"选择年份"},null,8,["value"])]))}}),Ce=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; width: 300px;">
    <DatePicker
      v-model:value="date"
      picker="date"
...
const year = ref('')
<\/script>
`,Ye={style:{width:"300px"}},Me={style:{"margin-top":"8px"}},Se=P({__name:"DatePickerShowTime",setup(e){const l=h(""),t=s=>{console.log("选中日期时间：",s)};return(s,d)=>(C(),Y("div",Ye,[a(m(b),{value:l.value,"onUpdate:value":d[0]||(d[0]=u=>l.value=u),"show-time":!0,placeholder:"选择日期和时间",onChange:t},null,8,["value"]),c("p",Me,"选中："+j(l.value),1)]))}}),Be=`<template>
