...
<\/script>
`,R={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"300px"}},T=y({__name:"InputNumberMode",setup(b){const n=p(3),u=p(3);return(o,t)=>(f(),x("div",R,[e("div",null,[t[2]||(t[2]=e("p",{style:{"margin-bottom":"4px"}},"Input 模式（默认）：",-1)),l(r(i),{value:n.value,"onUpdate:value":t[0]||(t[0]=d=>n.value=d),min:1,max:10,style:{width:"100%"}},null,8,["value"])]),e("div",null,[t[3]||(t[3]=e("p",{style:{"margin-bottom":"4px"}},"Spinner 模式：",-1)),l(r(i),{value:u.value,"onUpdate:value":t[1]||(t[1]=d=>u.value=d),mode:"spinner",min:1,max:10,style:{width:"100%"}},null,8,["value"])])]))}}),K=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; max-width: 300px">
    <div>
...
<\/script>
`,P={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"300px"}},z=y({__name:"InputNumberSuffix",setup(b){const n=p(100),u=p(200),o=p(300);return(t,d)=>(f(),x("div",P,[e("div",null,[d[3]||(d[3]=e("p",{style:{"margin-bottom":"4px"}},"带前缀：",-1)),l(r(i),{value:n.value,"onUpdate:value":d[0]||(d[0]=s=>n.value=s),prefix:"¥",style:{width:"100%"}},null,8,["value"])]),e("div",null,[d[4]||(d[4]=e("p",{style:{"margin-bottom":"4px"}},"带后缀：",-1)),l(r(i),{value:u.value,"onUpdate:value":d[1]||(d[1]=s=>u.value=s),suffix:"RMB",style:{width:"100%"}},null,8,["value"])]),e("div",null,[d[5]||(d[5]=e("p",{style:{"margin-bottom":"4px"}},"前缀 + 后缀：",-1)),l(r(i),{value:o.value,"onUpdate:value":d[2]||(d[2]=s=>o.value=s),prefix:"¥",suffix:"元",style:{width:"100%"}},null,8,["value"])])]))}}),H=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; max-width: 300px">
    <div>
...
<\/script>
`,J={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"300px"}},W=y({__name:"InputNumberVariant",setup(b){const n=p(100);return(u,o)=>(f(),x("div",J,[l(r(i),{value:n.value,"onUpdate:value":o[0]||(o[0]=t=>n.value=t),placeholder:"Outlined (默认)",style:{width:"100%"}},null,8,["value"]),l(r(i),{value:n.value,"onUpdate:value":o[1]||(o[1]=t=>n.value=t),variant:"filled",placeholder:"Filled",style:{width:"100%"}},null,8,["value"]),l(r(i),{value:n.value,"onUpdate:value":o[2]||(o[2]=t=>n.value=t),variant:"borderless",placeholder:"Borderless",style:{width:"100%"}},null,8,["value"]),l(r(i),{value:n.value,"onUpdate:value":o[3]||(o[3]=t=>n.value=t),variant:"underlined",placeholder:"Underlined",style:{width:"100%"}},null,8,["value"])]))}}),j=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; max-width: 300px">
