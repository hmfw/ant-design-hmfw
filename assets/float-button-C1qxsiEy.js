...
`,qt={class:"float-btn-demo"},St=b({__name:"FloatButtonBasic",setup(t){const s={position:"absolute",insetInlineEnd:"24px",insetBlockEnd:"24px"};function c(){console.log("点击悬浮按钮")}return(l,n)=>(x(),B("div",qt,[o(e(d),{tooltip:"点击",style:s,onClick:c})]))}}),Ct=w(St,[["__scopeId","data-v-726185db"]]),Ot=`<template>
...
`,_t={style:{display:"flex","flex-direction":"column",gap:"24px"}},Tt=b({__name:"FloatButtonClassNames",setup(t){return(s,c)=>(x(),B("div",_t,[a("div",null,[c[0]||(c[0]=a("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义根节点（渐变背景）：",-1)),o(e(d),{icon:e(dt),"class-names":{root:"custom-root"},tooltip:"帮助"},null,8,["icon"])]),a("div",null,[c[1]||(c[1]=a("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义图标容器（放大图标）：",-1)),o(e(d),{type:"primary",icon:e(lt),"class-names":{icon:"custom-icon"},tooltip:"客服"},null,8,["icon"])]),a("div",null,[c[2]||(c[2]=a("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义内容区域（square 形状）：",-1)),o(e(d),{shape:"square",icon:e(it),content:"反馈","class-names":{body:"custom-body",content:"custom-content"}},null,8,["icon"])]),a("div",null,[c[3]||(c[3]=a("div",{style:{"margin-bottom":"8px",color:"#666"}},"组合自定义（多个 key）：",-1)),o(e(d),{shape:"square",icon:e(N),content:"编辑","class-names":{root:"custom-combined-root",body:"custom-combined-body",icon:"custom-combined-icon",content:"custom-combined-content"}},null,8,["icon"])]),a("div",null,[c[4]||(c[4]=a("div",{style:{"margin-bottom":"8px",color:"#666"}},"使用内联样式：",-1)),o(e(d),{type:"primary",shape:"square",icon:e(pt),content:"启动",styles:{root:{borderRadius:"12px",boxShadow:"0 4px 16px rgba(22, 119, 255, 0.3)"},body:{padding:"8px"},icon:{fontSize:"20px"},content:{fontWeight:"bold"}}},null,8,["icon"])])]))}}),Et=w(Tt,[["__scopeId","data-v-1935b508"]]),Nt=`<template>
...
`,zt={class:"float-btn-demo"},Gt=b({__name:"FloatButtonMenu",setup(t){const s={position:"absolute",insetInlineEnd:"120px",insetBlockEnd:"24px"},c={position:"absolute",insetInlineEnd:"24px",insetBlockEnd:"24px"};return(l,n)=>(x(),B("div",zt,[o(e(I),{trigger:"click",type:"primary",icon:e(_),style:s},{default:k(()=>[o(e(d),{icon:e(N),tooltip:"编辑"},null,8,["icon"]),o(e(d),{icon:e(W),tooltip:"搜索"},null,8,["icon"])]),_:1},8,["icon"]),o(e(I),{trigger:"hover",style:c},{default:k(()=>[o(e(d),{icon:e(N),tooltip:"编辑"},null,8,["icon"]),o(e(d),{icon:e(Q),tooltip:"删除"},null,8,["icon"])]),_:1})]))}}),Mt=w(Gt,[["__scopeId","data-v-022b3d62"]]),Rt=`<template>
  <div class="float-btn-demo">
...
`,Ht={class:"float-btn-showcase"},Vt=b({__name:"FloatButtonTypes",setup(t){const s={position:"static"};return(c,l)=>(x(),B("div",Ht,[o(e(d),{icon:e(_),style:s},null,8,["icon"]),o(e(d),{type:"primary",icon:e(_),style:s},null,8,["icon"]),o(e(d),{shape:"square",icon:e(_),style:s},null,8,["icon"]),o(e(d),{type:"primary",shape:"square",icon:e(_),style:s},null,8,["icon"]),o(e(d),{type:"primary",shape:"square",description:"文档",style:s})]))}}),At=w(Vt,[["__scopeId","data-v-ad453991"]]),jt=`<template>
  <div class="float-btn-showcase">
...
`,Lt={class:"markdown-body"},sn={__name:"float-button",setup(t,{expose:s}){return s({frontmatter:{}}),(l,n)=>{const i=tt("DemoBlock");return x(),B("div",Lt,[n[0]||(n[0]=a("h1",{id:"floatbutton-悬浮按钮",tabindex:"-1"},"FloatButton 悬浮按钮",-1)),n[1]||(n[1]=a("p",null,"悬浮于页面上方的按钮。",-1)),n[2]||(n[2]=a("h2",{id:"何时使用",tabindex:"-1"},"何时使用",-1)),n[3]||(n[3]=a("ul",null,[a("li",null,"用于网站上的全局功能"),a("li",null,"无论浏览到页面的哪个位置，都可以看见的按钮")],-1)),n[4]||(n[4]=a("h2",{id:"代码演示",tabindex:"-1"},"代码演示",-1)),n[5]||(n[5]=a("h3",{id:"基础用法",tabindex:"-1"},"基础用法",-1)),n[6]||(n[6]=a("p",null,"最简单的用法。",-1)),o(i,{title:"基础用法",source:e(Ot)},{default:k(()=>[o(Ct)]),_:1},8,["source"]),n[7]||(n[7]=a("h3",{id:"不同类型",tabindex:"-1"},"不同类型",-1)),n[8]||(n[8]=a("p",null,[r("提供 "),a("code",null,"default"),r(" 和 "),a("code",null,"primary"),r(" 两种类型，以及 "),a("code",null,"circle"),r(" 和 "),a("code",null,"square"),r(" 两种形状。")],-1)),o(i,{title:"不同类型",source:e(jt)},{default:k(()=>[o(At)]),_:1},8,["source"]),n[9]||(n[9]=a("h3",{id:"徽标数字",tabindex:"-1"},"徽标数字",-1)),n[10]||(n[10]=a("p",null,"带徽标的悬浮按钮，徽标基于 Badge 组件实现。",-1)),o(i,{title:"徽标数字",source:e(wt)},{default:k(()=>[o(Ft)]),_:1},8,["source"]),n[11]||(n[11]=a("h3",{id:"浮动按钮组",tabindex:"-1"},"浮动按钮组",-1)),n[12]||(n[12]=a("p",null,[r("使用 "),a("code",null,"FloatButtonGroup"),r(" 可以将多个悬浮按钮组合在一起。设置 "),a("code",null,"trigger"),r(" 后会折叠为可展开的菜单。")],-1)),o(i,{title:"浮动按钮组",source:e(Pt)},{default:k(()=>[o(Dt)]),_:1},8,["source"]),n[13]||(n[13]=a("h3",{id:"菜单模式",tabindex:"-1"},"菜单模式",-1)),n[14]||(n[14]=a("p",null,[r("设置 "),a("code",null,"trigger"),r(" 为 "),a("code",null,"hover"),r(" 或 "),a("code",null,"click"),r("，鼠标悬停或点击展开菜单。")],-1)),o(i,{title:"菜单模式",source:e(Rt)},{default:k(()=>[o(Mt)]),_:1},8,["source"]),n[15]||(n[15]=a("h3",{id:"回到顶部",tabindex:"-1"},"回到顶部",-1)),n[16]||(n[16]=a("p",null,[a("code",null,"FloatButton.BackTop"),r(" 返回页面顶部的操作按钮。")],-1)),o(i,{title:"回到顶部",source:e(vt)},{default:k(()=>[o(ht)]),_:1},8,["source"]),n[17]||(n[17]=a("h3",{id:"细粒度样式控制",tabindex:"-1"},"细粒度样式控制",-1)),n[18]||(n[18]=a("p",null,[r("通过 "),a("code",null,"classNames"),r(" / "),a("code",null,"styles"),r(" 对各子元素做细粒度样式控制。")],-1)),o(i,{title:"语义化 className 与 style",source:e(Nt)},{default:k(()=>[o(Et)]),_:1},8,["source"]),n[19]||(n[19]=nt(`<h2 id="api" tabindex="-1">API</h2><p>组件提供了三种使用方式：</p><pre class="language-ts"><code class="language-ts"><span class="token keyword">import</span> <span class="token punctuation">{</span> FloatButton <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&#39;@hmfw/ant-design&#39;</span>
