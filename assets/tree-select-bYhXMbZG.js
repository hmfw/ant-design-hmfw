import{S as ae}from"./Space-BXsqDMEi.js";import{d as V,u as _e,r as x,m as pe,c as l,F as re,g as Q,a as N,o as L,q as se,w as M,e as y,f as m,A as le,b as xe,_ as Be,h as Oe,i as Ve}from"./index-BOp1Gurx.js";import{c as w}from"./cls-S9IiI6wd.js";import{D as Le}from"./DownOutlined-P5RWco7A.js";import{C as Ke,a as Ie}from"./CaretRightFilled-CAi4bZ1C.js";import{T as Fe}from"./Trigger-BSBv38Hy.js";const P=V({name:"TreeSelect",props:{value:[String,Number,Array],defaultValue:[String,Number,Array],treeData:{type:Array,default:()=>[]},multiple:Boolean,treeCheckable:Boolean,treeCheckStrictly:Boolean,showCheckedStrategy:{type:String,default:"SHOW_CHILD"},showSearch:Boolean,autoClearSearchValue:{type:Boolean,default:!0},allowClear:Boolean,placeholder:{type:String,default:"请选择"},disabled:Boolean,size:{type:String,default:"middle"},status:{type:String,default:""},maxCount:Number,notFoundContent:{type:String,default:"暂无数据"},treeDefaultExpandAll:Boolean,treeDefaultExpandedKeys:{type:Array,default:()=>[]},open:{type:Boolean,default:void 0},defaultOpen:Boolean,fieldNames:Object,virtual:{type:Boolean,default:!0},listHeight:{type:Number,default:256},itemHeight:{type:Number,default:28},treeIcon:[Boolean,Object,String,Function],maxTagCount:[Number,String],maxTagPlaceholder:[String,Function],maxTagTextLength:Number,classNames:Object,styles:Object},emits:["update:value","update:open","change","search","select","treeExpand","dropdownVisibleChange","openChange","clear"],setup(e,{emit:c}){const a=_e("tree-select"),E=x(null),p=x(null),f=x(!!e.defaultOpen),b=x(""),Z=x(0),g=N(()=>{var t;return((t=e.fieldNames)==null?void 0:t.label)??"label"}),q=N(()=>{var t;return((t=e.fieldNames)==null?void 0:t.value)??"value"}),Se=N(()=>{var t;return((t=e.fieldNames)==null?void 0:t.children)??"children"}),K=t=>t[g.value],H=t=>t[q.value],O=t=>t[Se.value],ee=N(()=>e.multiple||e.treeCheckable),te=N(()=>e.open!==void 0?e.open:f.value),A=x((t=>t??(ee.value?[]:void 0))(e.defaultValue??e.value));pe(()=>e.value,t=>{t!==void 0&&(A.value=t)});const Ce=N(()=>e.value!==void 0?e.value:A.value),C=N(()=>{const t=Ce.value;return t==null?[]:Array.isArray(t)?t:[t]}),D=N(()=>{const t=new Map,n=new Map,s=new Map,d=new Map,o=(u,r)=>{for(const h of u){const k=H(h);t.set(k,h),n.set(k,r),d.set(k,K(h));const i=O(h);i!=null&&i.length&&(s.set(k,i.map(H)),o(i,k))}};return o(e.treeData,void 0),{nodeMap:t,parentMap:n,childKeysMap:s,labelMap:d,rootKeys:e.treeData.map(H)}}),de=t=>{const n=D.value.childKeysMap.get(t);return n!=null&&n.length?n.flatMap(s=>de(s)):[t]},ue=t=>{const{childKeysMap:n,rootKeys:s}=D.value,d=new Set(t),o=new Set,u=r=>{const h=n.get(r);if(!(h!=null&&h.length))return d.has(r)?"checked":"none";let k=!0,i=!1;for(const v of h){const S=u(v);S==="checked"?i=!0:(S==="half"&&(i=!0),k=!1)}return k?(d.add(r),"checked"):(d.delete(r),i?(o.add(r),"half"):"none")};return s.forEach(u),{checked:d,half:o}},ie=t=>t.flatMap(n=>[H(n),...ie(O(n)??[])]),ke=N(()=>e.treeDefaultExpandAll?ie(e.treeData):e.treeDefaultExpandedKeys),$=x([...ke.value]);pe(ke,t=>{$.value=[...t]});function me(t,n=0,s=!1){return t.flatMap(d=>{const o=O(d),u=H(d),r=[{node:d,level:n,hasChildren:!!(o!=null&&o.length),valueKey:u,label:K(d),forceExpand:s}];return o!=null&&o.length&&(s||$.value.includes(u))&&r.push(...me(o,n+1,s)),r})}const _=N(()=>{if(!b.value)return me(e.treeData);const t=b.value.toLowerCase(),n=new Set,s=new Set,d=u=>{for(const r of u){const h=H(r);if(K(r).toLowerCase().includes(t)){n.add(h);let v=D.value.parentMap.get(h);for(;v!==void 0;)s.add(v),v=D.value.parentMap.get(v)}const i=O(r);i&&d(i)}};d(e.treeData);const o=(u,r=0)=>u.flatMap(h=>{const k=H(h),i=n.has(k),v=s.has(k);if(!i&&!v)return[];const S=O(h),B=[{node:h,level:r,hasChildren:!!(S!=null&&S.length),valueKey:k,label:K(h),forceExpand:v}];return S&&v&&B.push(...o(S,r+1)),B});return o(e.treeData)}),he=N(()=>C.value.map(t=>D.value.labelMap.get(t)??String(t))),ne=N(()=>e.virtual&&e.itemHeight>0&&_.value.length*e.itemHeight>e.listHeight),oe=N(()=>{if(!ne.value)return{start:0,end:_.value.length,offset:0};const t=_.value.length,n=5,s=Math.max(0,Math.floor(Z.value/e.itemHeight)-n),d=Math.ceil(e.listHeight/e.itemHeight)+n*2,o=Math.min(t,s+d);return{start:s,end:o,offset:s*e.itemHeight}}),Ne=t=>{Z.value=t.target.scrollTop};pe([b,()=>e.treeData,$],()=>{Z.value=0,p.value&&(p.value.scrollTop=0)});const Te=t=>{const n=e.maxTagTextLength;return n&&n>0&&t.length>n?`${t.slice(0,n)}...`:t},qe=t=>{const n=e.maxTagPlaceholder;return typeof n=="function"?n(t):typeof n=="string"?n:`+ ${t.length} ...`},ce=N(()=>{const t=C.value.length,n=e.maxTagCount;if(n===void 0||n==="responsive")return t;const s=Number(n);return!Number.isFinite(s)||s<0?t:Math.min(s,t)}),De=t=>{if(t.icon!==void 0&&t.icon!==null)return typeof t.icon=="function"?t.icon(t):t.icon;const n=e.treeIcon;if(n==null||n===!1)return null;if(n===!0){const s=O(t);return s!=null&&s.length?"📁":"📄"}return typeof n=="function"?n(t):n};function $e(){e.disabled||(f.value=!0,c("update:open",!0),c("dropdownVisibleChange",!0),c("openChange",!0))}function ve(){f.value=!1,b.value="",c("update:open",!1),c("dropdownVisibleChange",!1),c("openChange",!1)}function Ee(t){$.value.includes(t)?$.value=$.value.filter(n=>n!==t):$.value=[...$.value,t],c("treeExpand",$.value)}function ge(t){if(!(t.selectable!==!1)||t.disabled||e.disabled)return;const s=H(t),d=K(t);if(e.treeCheckable){if(t.disableCheckbox)return;let o;if(e.treeCheckStrictly){const u=[...C.value],r=u.indexOf(s);r>=0?u.splice(r,1):u.push(s),o=u}else{const u=de(s),r=new Set(C.value);u.every(i=>r.has(i))?u.forEach(i=>r.delete(i)):u.forEach(i=>r.add(i));const{checked:k}=ue(r);e.showCheckedStrategy==="SHOW_ALL"?o=Array.from(k):e.showCheckedStrategy==="SHOW_PARENT"?o=Array.from(k).filter(i=>{const v=D.value.childKeysMap.get(i);return v!=null&&v.length?v.every(S=>k.has(S)):!0}):o=Array.from(k).filter(i=>{var v;return!((v=D.value.childKeysMap.get(i))!=null&&v.length)})}if(e.maxCount!==void 0&&o.length>e.maxCount)return;A.value=o,c("update:value",o),c("change",o,o.map(u=>D.value.labelMap.get(u)??String(u))),c("select",s,t),e.autoClearSearchValue&&(b.value="")}else if(ee.value){const o=[...C.value],u=o.indexOf(s);if(u>=0)o.splice(u,1);else{if(e.maxCount!==void 0&&o.length>=e.maxCount)return;o.push(s)}A.value=o,c("update:value",o),c("change",o,o.map(r=>D.value.labelMap.get(r)??String(r))),c("select",s,t),e.autoClearSearchValue&&(b.value="")}else A.value=s,c("update:value",s),c("change",s,d),c("select",s,t),ve()}function Me(t,n){n.stopPropagation();const s=C.value.filter(d=>d!==t);A.value=s,c("update:value",s),c("change",s,s.map(d=>D.value.labelMap.get(d)??String(d)))}function Pe(t){t.stopPropagation();const n=ee.value?[]:void 0;A.value=n,c("update:value",n),c("change",n,[]),c("clear")}const fe=(t,n,s)=>{var F,R,W,U,z,j,X,Y,G,J;const{node:d,level:o,hasChildren:u,valueKey:r,label:h,forceExpand:k}=t,i=C.value.includes(r),v=k||$.value.includes(r),S=n.has(r),B=s.has(r),I=De(d);return l("div",{key:r,class:w(`${a}-tree-node`,(F=e.classNames)==null?void 0:F.treeNode,{[`${a}-tree-node-selected`]:i,[`${a}-tree-node-disabled`]:d.disabled}),style:{paddingLeft:`${o*20+8}px`,height:ne.value?`${e.itemHeight}px`:void 0,minHeight:ne.value?`${e.itemHeight}px`:void 0,...(R=e.styles)==null?void 0:R.treeNode}},[l("span",{class:w(`${a}-tree-switcher`,(W=e.classNames)==null?void 0:W.treeSwitcher,{[`${a}-tree-switcher-noop`]:!u}),style:(U=e.styles)==null?void 0:U.treeSwitcher,onClick:T=>{T.stopPropagation(),u&&!k&&Ee(r)}},[u&&!k?v?l(Ke,null,null):l(Ie,null,null):null]),e.treeCheckable&&l("span",{class:w(`${a}-tree-checkbox`,(z=e.classNames)==null?void 0:z.treeCheckbox,{[`${a}-tree-checkbox-checked`]:S,[`${a}-tree-checkbox-indeterminate`]:B,[`${a}-tree-checkbox-disabled`]:d.disabled||d.disableCheckbox}),style:(j=e.styles)==null?void 0:j.treeCheckbox,onClick:T=>{T.stopPropagation(),ge(d)}},[l("span",{class:`${a}-tree-checkbox-inner`},null)]),I!==null&&l("span",{class:w(`${a}-tree-icon`,(X=e.classNames)==null?void 0:X.treeIcon),style:(Y=e.styles)==null?void 0:Y.treeIcon},[I]),l("span",{class:w(`${a}-tree-node-content`,(G=e.classNames)==null?void 0:G.treeNodeContent),style:(J=e.styles)==null?void 0:J.treeNodeContent,onClick:()=>ge(d)},[h])])},He=(t,n)=>{var s,d;return _.value.length===0?l("div",{class:w(`${a}-dropdown-empty`,(s=e.classNames)==null?void 0:s.dropdownEmpty),style:(d=e.styles)==null?void 0:d.dropdownEmpty},[e.notFoundContent]):l("div",{ref:p,class:`${a}-dropdown-list`,style:{maxHeight:`${e.listHeight}px`,overflowY:"auto",position:"relative"},onScroll:Ne},[ne.value?l("div",{class:`${a}-dropdown-list-holder`,style:{height:`${_.value.length*e.itemHeight}px`,position:"relative"}},[l("div",{class:`${a}-dropdown-list-inner`,style:{transform:`translateY(${oe.value.offset}px)`,position:"absolute",top:0,left:0,right:0}},[_.value.slice(oe.value.start,oe.value.end).map(o=>fe(o,t,n))])]):_.value.map(o=>fe(o,t,n))])};return()=>{var o,u,r,h;const t=C.value.length>0,n=e.allowClear&&t&&!e.disabled;let s=new Set,d=new Set;if(e.treeCheckable&&!e.treeCheckStrictly){const k=new Set(C.value),i=ue(k);s=i.checked,d=i.half}else e.treeCheckable&&(s=new Set(C.value));return l(Fe,{open:te.value,trigger:"click",placement:"bottomLeft",disabled:e.disabled,destroyOnHidden:!0,matchWidth:!0,triggerClass:w(a,`${a}-${e.size}`,(o=e.classNames)==null?void 0:o.root,{[`${a}-open`]:te.value,[`${a}-disabled`]:e.disabled,[`${a}-status-error`]:e.status==="error",[`${a}-status-warning`]:e.status==="warning"}),triggerStyle:(u=e.styles)==null?void 0:u.root,popupClass:w(`${a}-dropdown`,(r=e.classNames)==null?void 0:r.dropdown),popupStyle:(h=e.styles)==null?void 0:h.dropdown,onOpenChange:k=>{k?$e():ve()}},{default:()=>{var k,i,v,S,B,I,F,R,W,U,z,j,X,Y,G,J;return l(re,null,[l("div",{ref:E,class:w(`${a}-selector`,(k=e.classNames)==null?void 0:k.selector),style:(i=e.styles)==null?void 0:i.selector},[ee.value?l(re,null,[he.value.slice(0,ce.value).map((T,be)=>{var we,ye;return l("span",{key:C.value[be],class:w(`${a}-selection-item`,(we=e.classNames)==null?void 0:we.item),style:(ye=e.styles)==null?void 0:ye.item},[l("span",{class:`${a}-selection-item-content`},[Te(T)]),l("span",{class:`${a}-selection-item-remove`,onClick:Ae=>Me(C.value[be],Ae)},[Q("×")])])}),C.value.length>ce.value&&l("span",{class:w(`${a}-selection-item`,`${a}-selection-overflow`)},[l("span",{class:`${a}-selection-item-content`},[qe(C.value.slice(ce.value))])]),e.showSearch&&l("input",{class:w(`${a}-selection-search`,(v=e.classNames)==null?void 0:v.search),style:(S=e.styles)==null?void 0:S.search,value:b.value,onInput:T=>{b.value=T.target.value,c("search",b.value)},onClick:T=>T.stopPropagation()},null),!t&&!b.value&&l("span",{class:w(`${a}-selection-placeholder`,(B=e.classNames)==null?void 0:B.placeholder),style:(I=e.styles)==null?void 0:I.placeholder},[e.placeholder])]):l(re,null,[t?l("span",{class:w(`${a}-selection-item`,(F=e.classNames)==null?void 0:F.item),style:(R=e.styles)==null?void 0:R.item},[he.value[0]]):l("span",{class:w(`${a}-selection-placeholder`,(W=e.classNames)==null?void 0:W.placeholder),style:(U=e.styles)==null?void 0:U.placeholder},[e.placeholder]),e.showSearch&&te.value&&l("input",{class:w(`${a}-selection-search`,(z=e.classNames)==null?void 0:z.search),style:(j=e.styles)==null?void 0:j.search,value:b.value,onInput:T=>{b.value=T.target.value,c("search",b.value)},onClick:T=>T.stopPropagation()},null)])]),l("div",{class:w(`${a}-arrow`,(X=e.classNames)==null?void 0:X.arrow),style:(Y=e.styles)==null?void 0:Y.arrow},[l(Le,{class:w(`${a}-arrow-icon`,{[`${a}-arrow-icon-open`]:te.value})},null)]),n&&l("span",{class:w(`${a}-clear`,(G=e.classNames)==null?void 0:G.clear),style:(J=e.styles)==null?void 0:J.clear,onClick:Pe},[Q("×")])])},popup:({placement:k})=>He(s,d)})}}}),Re=V({__name:"TreeSelectBasic",setup(e){const c=x(),a=[{value:"parent1",label:"父节点 1",children:[{value:"child1-1",label:"子节点 1-1"},{value:"child1-2",label:"子节点 1-2"}]},{value:"parent2",label:"父节点 2",children:[{value:"child2-1",label:"子节点 2-1"}]}];return(E,p)=>(L(),se(y(ae),{direction:"vertical",style:{width:"300px"}},{default:M(()=>[l(y(P),{value:c.value,"onUpdate:value":p[0]||(p[0]=f=>c.value=f),"tree-data":a,placeholder:"请选择",style:{width:"100%"}},null,8,["value"]),m("span",null,"选中："+le(c.value),1)]),_:1}))}}),We=`<template>
...
<\/script>
`,Ue=V({__name:"TreeSelectCheckable",setup(e){const c=x([]),a=[{value:"parent1",label:"父节点 1",children:[{value:"child1-1",label:"子节点 1-1"},{value:"child1-2",label:"子节点 1-2"}]},{value:"parent2",label:"父节点 2",children:[{value:"child2-1",label:"子节点 2-1"}]}];return(E,p)=>(L(),se(y(ae),{direction:"vertical",style:{width:"300px"}},{default:M(()=>[l(y(P),{value:c.value,"onUpdate:value":p[0]||(p[0]=f=>c.value=f),"tree-data":a,"tree-checkable":"",placeholder:"请选择",style:{width:"100%"}},null,8,["value"]),m("span",null,"选中："+le(c.value),1)]),_:1}))}}),ze=`<template>
  <Space direction="vertical" style="width: 300px">
...
<\/script>
`,je={style:{display:"flex","flex-direction":"column",gap:"24px"}},Xe=V({__name:"TreeSelectClassNames",setup(e){const c=x(),a=x(),E=x([]),p=x([]),f=x(),b=[{value:"engineering",label:"工程部",children:[{value:"frontend",label:"前端团队"},{value:"backend",label:"后端团队"},{value:"mobile",label:"移动端团队"}]},{value:"product",label:"产品部",children:[{value:"pm",label:"产品经理"},{value:"design",label:"设计师"}]},{value:"marketing",label:"市场部",children:[{value:"sales",label:"销售团队"},{value:"promotion",label:"推广团队"}]}];return(Z,g)=>(L(),xe("div",je,[m("div",null,[g[5]||(g[5]=m("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义选择器容器（渐变背景）：",-1)),l(y(P),{value:c.value,"onUpdate:value":g[0]||(g[0]=q=>c.value=q),"tree-data":b,placeholder:"请选择部门","allow-clear":"","class-names":{root:"custom-selector-root",selector:"custom-selector",arrow:"custom-arrow"},style:{width:"280px"}},null,8,["value"])]),m("div",null,[g[6]||(g[6]=m("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义下拉面板与树节点样式：",-1)),l(y(P),{value:a.value,"onUpdate:value":g[1]||(g[1]=q=>a.value=q),"tree-data":b,placeholder:"选择分类","tree-default-expand-all":"","class-names":{dropdown:"custom-dropdown",treeNode:"custom-tree-node",treeNodeContent:"custom-tree-node-content"},style:{width:"280px"}},null,8,["value"])]),m("div",null,[g[7]||(g[7]=m("div",{style:{"margin-bottom":"8px",color:"#666"}},"多选模式自定义标签：",-1)),l(y(P),{value:E.value,"onUpdate:value":g[2]||(g[2]=q=>E.value=q),"tree-data":b,multiple:"",placeholder:"选择多个部门","allow-clear":"","class-names":{selector:"custom-multi-selector",item:"custom-multi-item"},style:{width:"320px"}},null,8,["value"])]),m("div",null,[g[8]||(g[8]=m("div",{style:{"margin-bottom":"8px",color:"#666"}},"可勾选模式自定义复选框：",-1)),l(y(P),{value:p.value,"onUpdate:value":g[3]||(g[3]=q=>p.value=q),"tree-data":b,"tree-checkable":"",placeholder:"勾选节点","show-checked-strategy":"SHOW_PARENT","class-names":{treeCheckbox:"custom-checkbox",treeSwitcher:"custom-switcher"},style:{width:"280px"}},null,8,["value"])]),m("div",null,[g[9]||(g[9]=m("div",{style:{"margin-bottom":"8px",color:"#666"}},"使用 styles 内联样式：",-1)),l(y(P),{value:f.value,"onUpdate:value":g[4]||(g[4]=q=>f.value=q),"tree-data":b,placeholder:"内联样式示例","allow-clear":"",styles:{root:{borderRadius:"12px",borderColor:"#52c41a"},selector:{background:"linear-gradient(to right, #f0f9ff, #e0f2fe)"},dropdown:{borderRadius:"12px",boxShadow:"0 6px 20px rgba(82, 196, 26, 0.2)"},treeNode:{padding:"6px 8px"}},style:{width:"280px"}},null,8,["value"])])]))}}),Ye=Be(Xe,[["__scopeId","data-v-9bce694f"]]),Ge=`<template>
...
`,Je=V({__name:"TreeSelectMultiple",setup(e){const c=x([]),a=[{value:"parent1",label:"父节点 1",children:[{value:"child1-1",label:"子节点 1-1"},{value:"child1-2",label:"子节点 1-2"}]},{value:"parent2",label:"父节点 2",children:[{value:"child2-1",label:"子节点 2-1"}]}];return(E,p)=>(L(),se(y(ae),{direction:"vertical",style:{width:"300px"}},{default:M(()=>[l(y(P),{value:c.value,"onUpdate:value":p[0]||(p[0]=f=>c.value=f),"tree-data":a,multiple:"",placeholder:"请选择",style:{width:"100%"}},null,8,["value"]),m("span",null,"选中："+le(c.value),1)]),_:1}))}}),Qe=`<template>
  <Space direction="vertical" style="width: 300px">
...
<\/script>
`,Ze=V({__name:"TreeSelectSearch",setup(e){const c=x(),a=[{value:"parent1",label:"父节点 1",children:[{value:"child1-1",label:"子节点 1-1"},{value:"child1-2",label:"子节点 1-2"}]},{value:"parent2",label:"父节点 2",children:[{value:"child2-1",label:"子节点 2-1"},{value:"child2-2",label:"子节点 2-2"}]}];return(E,p)=>(L(),se(y(ae),{direction:"vertical",style:{width:"300px"}},{default:M(()=>[l(y(P),{value:c.value,"onUpdate:value":p[0]||(p[0]=f=>c.value=f),"tree-data":a,"show-search":"",placeholder:"搜索节点",style:{width:"100%"}},null,8,["value"]),m("span",null,"选中："+le(c.value),1)]),_:1}))}}),et=`<template>
  <Space direction="vertical" style="width: 300px">
...
<span class="token comment">/* dropdown 通过 Teleport 渲染到 body，必须使用 :global() */</span>
...
<span class="token selector">:global(.my-tree-node:hover)</span> <span class="token punctuation">{</span>
  <span class="token property">background</span><span class="token punctuation">:</span> <span class="token function">linear-gradient</span><span class="token punctuation">(</span>90deg<span class="token punctuation">,</span> #e6f4ff 0%<span class="token punctuation">,</span> #bae0ff 100%<span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<span class="token selector">:deep(.my-tree-select-root)</span> <span class="token punctuation">{</span>
