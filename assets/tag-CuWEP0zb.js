import{d as m,u as B,c as o,r as I,a as k,o as b,b as p,e as n,w as l,g as a,f as c,F as N,B as E,s as L,h as O,i as M}from"./index-dV6GQSVR.js";import{c as x}from"./cls-S9IiI6wd.js";const j=["magenta","red","volcano","orange","gold","lime","green","cyan","blue","geekblue","purple","success","processing","error","warning","default"],s=m({name:"Tag",props:{color:String,closable:Boolean,closeIcon:{type:[Object,Boolean,Function],default:void 0},bordered:{type:Boolean,default:!0},icon:Object,href:String,target:String,disabled:Boolean,classNames:Object,styles:Object},emits:["close"],setup(t,{slots:i,emit:e}){const r=B("tag"),d=I(!0),u=k(()=>t.color?j.includes(t.color):!1),f=k(()=>{var g;return x(r,{[`${r}-${t.color}`]:u.value||void 0,[`${r}-has-color`]:t.color&&!u.value||void 0,[`${r}-borderless`]:!t.bordered||void 0,[`${r}-hidden`]:!d.value||void 0,[`${r}-disabled`]:t.disabled||void 0},(g=t.classNames)==null?void 0:g.root)}),y=k(()=>{var T;const g={};return t.color&&!u.value&&!t.disabled&&(g.backgroundColor=t.color),{...g,...(T=t.styles)==null?void 0:T.root}}),_=g=>{t.disabled||(g.stopPropagation(),e("close",g),!g.defaultPrevented&&(d.value=!1))},P=g=>{(g.key==="Enter"||g.key===" ")&&(g.preventDefault(),g.currentTarget.click())},D=()=>{var h;const g=(h=i.closeIcon)==null?void 0:h.call(i);if(g)return g;if(t.closeIcon===void 0||t.closeIcon===!0)return"×";if(t.closeIcon===!1)return null;if(typeof t.closeIcon=="function")return t.closeIcon();const T=t.closeIcon;return o(T,null,null)};return()=>{if(!d.value)return null;const g=t.icon,T=t.href?"a":"span",h=t.closable&&t.closeIcon!==!1;return o(T,{class:f.value,style:y.value,href:t.href&&!t.disabled?t.href:void 0,target:t.href?t.target:void 0,"aria-disabled":t.disabled||void 0},{default:()=>{var v,C,w,$,S;return[t.icon&&o(g,{class:x(`${r}-icon`,(v=t.classNames)==null?void 0:v.icon),style:(C=t.styles)==null?void 0:C.icon},null),(w=i.default)==null?void 0:w.call(i),h&&o("span",{class:x(`${r}-close-icon`,($=t.classNames)==null?void 0:$.closeIcon),style:(S=t.styles)==null?void 0:S.closeIcon,onClick:_,onKeydown:P,role:"button",tabindex:t.disabled?-1:0,"aria-label":"close","aria-disabled":t.disabled||void 0},[D()])]}})}}}),V=m({name:"CheckableTag",props:{checked:Boolean},emits:["change","update:checked"],setup(t,{slots:i,emit:e}){const r=B("tag"),d=k(()=>x(r,`${r}-checkable`,{[`${r}-checkable-checked`]:t.checked})),u=()=>{const f=!t.checked;e("update:checked",f),e("change",f)};return()=>{var f;return o("span",{class:d.value,onClick:u},[(f=i.default)==null?void 0:f.call(i)])}}}),F={style:{display:"flex",gap:"8px","flex-wrap":"wrap"}},K=m({__name:"TagBasic",setup(t){function i(){console.log("关闭标签")}return(e,r)=>(b(),p("div",F,[o(n(s),null,{default:l(()=>[...r[0]||(r[0]=[a("Tag 1",-1)])]),_:1}),o(n(s),null,{default:l(()=>[...r[1]||(r[1]=[c("a",{href:"https://github.com/ant-design/ant-design"},"Link",-1)])]),_:1}),o(n(s),{closable:"",onClose:i},{default:l(()=>[...r[2]||(r[2]=[a(" Tag 2 ",-1)])]),_:1}),o(n(s),{closable:"",bordered:!1},{default:l(()=>[...r[3]||(r[3]=[a(" Tag 3 ",-1)])]),_:1})]))}}),R=`<template>
...
<\/script>
`,q={style:{display:"flex",gap:"8px"}},A=m({__name:"TagCheckable",setup(t){const i=["Movies","Books","Music","Sports"],e=I(["Books"]);function r(d,u){u?e.value=[...e.value,d]:e.value=e.value.filter(f=>f!==d)}return(d,u)=>(b(),p("div",q,[(b(),p(N,null,E(i,f=>o(n(V),{key:f,checked:e.value.includes(f),onChange:y=>r(f,y)},{default:l(()=>[a(L(f),1)]),_:2},1032,["checked","onChange"])),64))]))}}),W=`<template>
...
<\/script>
`,z={style:{display:"flex",gap:"8px","flex-wrap":"wrap"}},G=m({__name:"TagCustomColor",setup(t){return(i,e)=>(b(),p("div",z,[o(n(s),{color:"#f50"},{default:l(()=>[...e[0]||(e[0]=[a(" #f50 ",-1)])]),_:1}),o(n(s),{color:"#2db7f5"},{default:l(()=>[...e[1]||(e[1]=[a(" #2db7f5 ",-1)])]),_:1}),o(n(s),{color:"#87d068"},{default:l(()=>[...e[2]||(e[2]=[a(" #87d068 ",-1)])]),_:1}),o(n(s),{color:"#108ee9"},{default:l(()=>[...e[3]||(e[3]=[a(" #108ee9 ",-1)])]),_:1})]))}}),H=`<template>
  <div style="display: flex; gap: 8px; flex-wrap: wrap">
...
import { Tag } from '@hmfw/ant-design'
<\/script>
`,J={style:{display:"flex",gap:"8px","align-items":"center","flex-wrap":"wrap"}},Q=m({__name:"TagLinkDisabled",setup(t){return(i,e)=>(b(),p("div",J,[o(n(s),{href:"https://ant.design",target:"_blank"},{default:l(()=>[...e[0]||(e[0]=[a(" 链接标签 ",-1)])]),_:1}),o(n(s),{disabled:""},{default:l(()=>[...e[1]||(e[1]=[a(" 禁用标签 ",-1)])]),_:1}),o(n(s),{disabled:"",closable:""},{default:l(()=>[...e[2]||(e[2]=[a(" 禁用且不可关闭 ",-1)])]),_:1})]))}}),U=`<template>
