import{M as d}from"./index-VN3c37xN.js";import{M as v,A as x,T as I,F as M,a as O}from"./TeamOutlined-dvr6zDce.js";import{S as b}from"./SettingOutlined-0h7DWPmT.js";import{U as h}from"./UserOutlined-nHnAGjJt.js";import{o as k,p as a,A as u,k as g,h as t,n as e,L as o,_ as N,S as r,m as f,K as q,v as _,E as y,i as T,U as K,P as z,H as A,l as P}from"./index-7wnt1Cyk.js";import{B as C}from"./Button-CLD9HWRg.js";import{H as w}from"./HomeOutlined-CwE40qVY.js";import{E as D}from"./EditOutlined-C4WGgSkR.js";import{D as G}from"./DeleteOutlined-CzPtcckK.js";import{C as $}from"./CopyOutlined-CCBEdQ-i.js";import"./Layout-B6Y0drE-.js";import"./MinusOutlined-BcCjvfit.js";import"./LeftOutlined-DTpp0vYo.js";import"./RightOutlined-CbK0u0Ck.js";import"./cls-S9IiI6wd.js";import"./event-CMqgYmge.js";import"./Trigger-CiLr3mxg.js";import"./Tooltip-UMwxxvHk.js";import"./LoadingOutlined-VcPrAqG4.js";const B={style:{display:"flex","flex-direction":"column",gap:"32px"}},E=k({__name:"MenuClassNames",setup(m){const s=[{key:"1",label:"导航一",icon:a(v)},{key:"2",label:"导航二",icon:a(x)},{key:"3",label:"导航三",icon:a(b)}],p=[{key:"1",label:"选项 1",icon:a(v)},{key:"sub1",label:"子菜单",icon:a(x),children:[{key:"2",label:"选项 2"},{key:"3",label:"选项 3"}]},{key:"4",label:"选项 4",icon:a(b)}],c=[{type:"group",label:"分组 1",children:[{key:"1",label:"选项 1",icon:a(h)},{key:"2",label:"选项 2",icon:a(I)}]},{type:"divider"},{type:"group",label:"分组 2",children:[{key:"3",label:"选项 3",icon:a(M)},{key:"4",label:"选项 4",icon:a(b)}]}],n=[{key:"mail",label:"邮件",icon:a(v)},{key:"app",label:"应用",icon:a(x)},{key:"setting",label:"设置",icon:a(b)}];return(l,i)=>(u(),g("div",B,[t("div",null,[i[0]||(i[0]=t("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义菜单项样式：",-1)),e(o(d),{mode:"inline","default-selected-keys":["1"],items:s,"class-names":{item:"custom-item",itemSelected:"custom-item-selected",itemIcon:"custom-icon"},style:{width:"256px"}})]),t("div",null,[i[1]||(i[1]=t("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义子菜单样式：",-1)),e(o(d),{mode:"inline","default-open-keys":["sub1"],"default-selected-keys":["1"],items:p,"class-names":{submenu:"custom-submenu",submenuTitle:"custom-submenu-title",submenuArrow:"custom-arrow"},style:{width:"256px"}})]),t("div",null,[i[2]||(i[2]=t("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义分组和分割线：",-1)),e(o(d),{mode:"inline","default-selected-keys":["1"],items:c,"class-names":{itemGroup:"custom-group",itemGroupTitle:"custom-group-title",divider:"custom-divider"},style:{width:"256px"}})]),t("div",null,[i[3]||(i[3]=t("div",{style:{"margin-bottom":"8px",color:"#666"}},"使用内联样式：",-1)),e(o(d),{mode:"inline","default-selected-keys":["2"],items:s,styles:{root:{border:"2px solid #722ed1",borderRadius:"12px"},item:{margin:"8px 12px"},itemSelected:{background:"linear-gradient(135deg, #667eea 0%, #764ba2 100%)",color:"#fff",fontWeight:"bold"},itemIcon:{fontSize:"16px"}},style:{width:"256px"}})]),t("div",null,[i[4]||(i[4]=t("div",{style:{"margin-bottom":"8px",color:"#666"}},"水平菜单自定义：",-1)),e(o(d),{mode:"horizontal","default-selected-keys":["mail"],items:n,"class-names":{root:"custom-horizontal",item:"custom-horizontal-item",itemSelected:"custom-horizontal-selected"}})])]))}}),V=N(E,[["__scopeId","data-v-e873dbdc"]]),U=`<template>
...
`,F=k({__name:"MenuCollapsed",setup(m){const s=y(!1),p=y(["1"]),c=[{key:"1",label:"导航一",icon:a(w)},{key:"2",label:"导航二",icon:a(h)},{key:"3",label:"导航三",icon:a(b)}],n=({key:l})=>{p.value=[l]};return(l,i)=>(u(),g("div",null,[e(o(C),{type:"primary",style:{"margin-bottom":"16px"},onClick:i[0]||(i[0]=S=>s.value=!s.value)},{default:r(()=>[f(q(s.value?"展开":"折叠"),1)]),_:1}),t("div",{style:_({width:s.value?"80px":"256px",borderRight:"1px solid #f0f0f0",transition:"width 0.2s"})},[e(o(d),{mode:"inline",items:c,"selected-keys":p.value,"inline-collapsed":s.value,onSelect:n},null,8,["selected-keys","inline-collapsed"])],4)]))}}),H=`<template>
  <div>
...
<\/script>
`,R={style:{width:"256px"}},L=k({__name:"MenuDanger",setup(m){const s=[{key:"1",label:"普通选项"},{key:"2",label:"编辑",icon:a(D)},{type:"divider"},{key:"3",label:"删除",danger:!0,icon:a(G)}];return(p,c)=>(u(),g("div",R,[e(o(d),{mode:"inline",items:s})]))}}),W=`<template>
...
<\/script>
`,Q={style:{width:"256px"}},Y=k({__name:"MenuGroup",setup(m){const s=[{type:"group",label:"用户管理",children:[{key:"1",label:"用户列表"},{key:"2",label:"添加用户"}]},{type:"group",label:"系统设置",children:[{key:"3",label:"基本设置"},{key:"4",label:"高级设置"}]}];return(p,c)=>(u(),g("div",Q,[e(o(d),{mode:"inline",items:s})]))}}),Z=`<template>
  <div style="width: 256px">
    <Menu mode="inline" :items="items" />
  </div>
</template>
...
<\/script>
`,on={style:{width:"256px","border-right":"1px solid #f0f0f0"}},ln=k({__name:"MenuInline",setup(m){const s=y(["1"]),p=[{key:"sub1",label:"导航一",icon:a(v),children:[{key:"1",label:"选项一"},{key:"2",label:"选项二"},{key:"3",label:"选项三"}]},{key:"sub2",label:"导航二",icon:a(b),children:[{key:"5",label:"选项五"},{key:"6",label:"选项六"}]},{key:"9",label:"导航三",icon:a(h)}],c=({key:n})=>{s.value=[n]};return(n,l)=>(u(),g("div",on,[e(o(d),{mode:"inline",items:p,"selected-keys":s.value,"default-open-keys":["sub1"],onSelect:c},null,8,["selected-keys"])]))}}),pn=`<template>
...
<\/script>
`,cn={style:{width:"256px"}},dn=k({__name:"MenuMultiple",setup(m){const s=[{key:"1",label:"选项一"},{key:"2",label:"选项二"},{key:"3",label:"选项三"},{key:"4",label:"选项四"}];return(p,c)=>(u(),g("div",cn,[e(o(d),{mode:"inline",items:s,multiple:"","default-selected-keys":["1","2"]})]))}}),rn=`<template>
  <div style="width: 256px">
...
<\/script>
`,un=k({__name:"MenuTooltip",setup(m){const s=y(!1),p=y(["1"]),c=[{key:"1",label:"导航一",icon:a(w),title:"这是导航一的提示"},{key:"2",label:"导航二",icon:a(h),title:"这是导航二的提示"},{key:"3",label:"导航三",icon:a(b)},{key:"sub",label:"子菜单",icon:a(O),children:[{key:"sub-1",label:"子项 1"},{key:"sub-2",label:"子项 2"}]}],n=({key:l})=>{p.value=[l]};return(l,i)=>(u(),g("div",null,[e(o(C),{type:"primary",style:{"margin-bottom":"16px"},onClick:i[0]||(i[0]=S=>s.value=!s.value)},{default:r(()=>[f(q(s.value?"展开":"折叠"),1)]),_:1}),t("div",{style:_({width:s.value?"80px":"256px",borderRight:"1px solid #f0f0f0",transition:"width 0.2s"})},[e(o(d),{mode:"inline",items:c,"selected-keys":p.value,"inline-collapsed":s.value,onSelect:n},null,8,["selected-keys","inline-collapsed"])],4)]))}}),mn=`<template>
  <div>
    <Button type="primary" style="margin-bottom: 16px" @click="collapsed = !collapsed">
      {{ collapsed ? '展开' : '折叠' }}
    </Button>
...
<\/script>
`,kn={style:{"margin-bottom":"16px"}},gn=k({__name:"MenuTrigger",setup(m){const s=y(["1"]),p=y("hover"),c=[{key:"1",label:"导航一",icon:a(x)},{key:"2",label:"导航二",icon:a(b)},{key:"sub",label:"子菜单",children:[{key:"sub-1",label:"子项 1"},{key:"sub-2",label:"子项 2"},{key:"sub-3",label:"子项 3"}]},{key:"4",label:"导航四"}],n=({key:l})=>{s.value=[l]};return(l,i)=>(u(),g("div",null,[t("div",kn,[i[2]||(i[2]=t("label",{style:{"margin-right":"8px"}},"触发方式:",-1)),K(t("select",{"onUpdate:modelValue":i[0]||(i[0]=S=>p.value=S),style:{padding:"4px 8px"}},[...i[1]||(i[1]=[t("option",{value:"hover"},"hover",-1),t("option",{value:"click"},"click",-1)])],512),[[z,p.value]])]),e(o(d),{mode:"horizontal",items:c,"selected-keys":s.value,"trigger-sub-menu-action":p.value,onSelect:n},null,8,["selected-keys","trigger-sub-menu-action"])]))}}),bn=`<template>
  <div>
