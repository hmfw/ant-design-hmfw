import{I as Re}from"./Icon-DOjVoSFw.js";import{A as je,a as Me,b as Ue,c as ze,d as He,e as Je,B as Ge,f as Qe,g as We,C as Ze,h as qe,i as Xe,j as Ye,k as et,l as tt,m as nt,n as dt,o as lt,p as at,q as ot,r as rt,D as it,s as st,t as ct,u as ut,v as ft,E as ht,w as yt,x as pt,y as kt,z as gt,F as ge,G as mt,H as me,I as be,J as bt,K as vt,L as xt,M as Dt,N as Nt,O as Ct,Q as wt,R as Tt,S as Kt,T as Ot,U as St,V as At,W as Et,X as It,Y as $t,Z as Lt,_ as Bt,$ as _t,a0 as Ft,a1 as Pt,a2 as Vt,a3 as Rt,a4 as jt,a5 as Mt,a6 as Ut,a7 as zt,a8 as Ht,a9 as Jt,aa as Gt,ab as Qt,ac as Wt,ad as Zt,ae as qt,af as Xt,ag as Yt,ah as en,ai as tn,aj as nn,ak as dn,al as ln,am as an,an as on,ao as rn,ap as sn}from"./icons-DLCoPw-s.js";import{g as cn,a as un,b as fn,i as hn,s as yn}from"./utils-Dp1z1BsR.js";import{n as A,M as pn,D as C,P as pe,m as h,e as K,l as x,s as kn,r as gn,z as E,h as te,J as g,j as _,g as c,_ as ne,F as ve,I as ee,R as mn,O as bn,G as vn,Q as $,k as xn}from"./index-BIkAb7lZ.js";import{V as Dn}from"./VirtualList-6vtixCj9.js";import{c as J}from"./cls-S9IiI6wd.js";import{C as Nn}from"./Checkbox-DuAA3Out.js";const Cn=Object.freeze(Object.defineProperty({__proto__:null,AndroidOutlined:je,AppleOutlined:Me,ArrowDownOutlined:Ue,ArrowLeftOutlined:ze,ArrowRightOutlined:He,ArrowUpOutlined:Je,BarsOutlined:Ge,BellFilled:Qe,BellOutlined:We,CalendarOutlined:Ze,CaretDownOutlined:qe,CaretLeftOutlined:Xe,CaretRightOutlined:Ye,CaretUpOutlined:et,CheckCircleFilled:tt,CheckOutlined:nt,ClockCircleOutlined:dt,CloseCircleFilled:lt,CloseOutlined:at,CloudOutlined:ot,CopyOutlined:rt,DeleteOutlined:it,DoubleLeftOutlined:st,DoubleRightOutlined:ct,DownOutlined:ut,DownloadOutlined:ft,EditOutlined:ht,EllipsisOutlined:yt,ExclamationCircleFilled:pt,ExclamationCircleOutlined:kt,EyeOutlined:gt,FileOutlined:ge,FilterOutlined:mt,FolderOpenOutlined:me,FolderOutlined:be,FullscreenExitOutlined:bt,FullscreenOutlined:vt,GlobalOutlined:xt,HeartFilled:Dt,HeartOutlined:Nt,HomeOutlined:Ct,Icon:Re,InfoCircleFilled:wt,InfoCircleOutlined:Tt,LeftOutlined:Kt,LinkOutlined:Ot,LoadingOutlined:St,LockOutlined:At,LoginOutlined:Et,LogoutOutlined:It,MailOutlined:$t,MenuOutlined:Lt,MessageOutlined:Bt,MinusCircleOutlined:_t,MinusOutlined:Ft,PhoneOutlined:Pt,PictureOutlined:Vt,PlusCircleOutlined:Rt,PlusOutlined:jt,QuestionCircleOutlined:Mt,ReloadOutlined:Ut,RightOutlined:zt,RotateLeftOutlined:Ht,RotateRightOutlined:Jt,SaveOutlined:Gt,SearchOutlined:Qt,SettingOutlined:Wt,ShareAltOutlined:Zt,StarFilled:qt,StarOutlined:Xt,SwapOutlined:Yt,SyncOutlined:en,UnlockOutlined:tn,UpOutlined:nn,UserOutlined:dn,VideoCameraOutlined:ln,WarningFilled:an,WarningOutlined:on,ZoomInOutlined:rn,ZoomOutOutlined:sn,getAllCategories:cn,getAllIcons:un,getIconsByCategory:fn,iconMetadata:hn,searchIcons:yn},Symbol.toStringTag,{value:"Module"}));function ke(t,i,o){if(!t)return null;if(typeof t=="function")return t(i,o);const y=Cn[t];return y?y({}):t}const xe=A({name:"Tree",props:{treeData:{type:Array,default:()=>[]},expandedKeys:Array,defaultExpandedKeys:{type:Array,default:()=>[]},defaultExpandAll:Boolean,defaultExpandParent:{type:Boolean,default:!0},autoExpandParent:Boolean,selectedKeys:Array,defaultSelectedKeys:{type:Array,default:()=>[]},checkedKeys:[Array,Object],defaultCheckedKeys:{type:Array,default:()=>[]},checkable:Boolean,checkStrictly:Boolean,multiple:Boolean,selectable:{type:Boolean,default:!0},disabled:Boolean,draggable:[Boolean,Function,Object],allowDrop:Function,showLine:[Boolean,Object],showIcon:Boolean,blockNode:Boolean,indent:{type:Number,default:24},filterTreeNode:Function,icon:[String,Function],switcherIcon:[String,Function],titleRender:Function,fieldNames:Object,virtual:Boolean,height:[Number,String],itemHeight:{type:Number,default:28},rootClassName:String,classNames:Object,styles:Object,expandAction:{type:[Boolean,String],default:void 0}},emits:["update:expandedKeys","update:selectedKeys","update:checkedKeys","expand","select","check","dblclick","rightClick","dragstart","dragenter","dragover","dragleave","dragend","drop"],setup(t,{emit:i}){const o=pn("tree"),y=K(()=>{var e;return((e=t.fieldNames)==null?void 0:e.key)??"key"}),l=K(()=>{var e;return((e=t.fieldNames)==null?void 0:e.title)??"title"}),r=K(()=>{var e;return((e=t.fieldNames)==null?void 0:e.children)??"children"}),u=e=>e[y.value],b=e=>e[l.value],D=e=>e[r.value],p=K(()=>{const e=new Map,n=(d,s,a,f)=>{d.forEach((m,k)=>{const N=u(m),w=`${f}-${k}`,S=D(m)??[];e.set(N,{node:m,parentKey:s,level:a,pos:w,index:k,childrenKeys:S.map(I=>u(I))}),S.length&&n(S,N,a+1,w)})};return n(t.treeData,null,0,"0"),e}),F=()=>Array.from(p.value.keys()),L=e=>{const n=p.value.get(e);return n?n.childrenKeys.flatMap(d=>[d,...L(d)]):[]},X=e=>{var s,a;const n=[];let d=((s=p.value.get(e))==null?void 0:s.parentKey)??null;for(;d!==null;)n.push(d),d=((a=p.value.get(d))==null?void 0:a.parentKey)??null;return n},de=e=>{const n=new Set(e);return e.forEach(d=>X(d).forEach(s=>n.add(s))),Array.from(n)},G=C((()=>{if(t.defaultExpandAll)return F();const e=t.expandedKeys??t.defaultExpandedKeys;return t.defaultExpandParent?de(e):[...e]})()),le=C([...t.defaultSelectedKeys]),De=e=>e?Array.isArray(e)?e:e.checked??[]:[],ae=C([...t.defaultCheckedKeys]),B=K(()=>t.expandedKeys??G.value),V=K(()=>t.selectedKeys??le.value),P=K(()=>t.checkedKeys!==void 0?De(t.checkedKeys):ae.value);pe(()=>t.treeData,()=>{t.defaultExpandAll&&(G.value=F())}),pe(()=>t.expandedKeys,e=>{e&&t.autoExpandParent&&(G.value=de(e))});const Ne=K(()=>{const e=new Set;if(t.checkStrictly)return e;const n=new Set(P.value);for(const[d]of p.value){if(n.has(d))continue;const s=L(d);s.length&&s.some(a=>n.has(a))&&e.add(d)}return e}),oe=(e,n=0,d="0")=>e.flatMap((s,a)=>{const f=u(s),m=D(s),k=`${d}-${a}`,N=!!(m!=null&&m.length),w=[{node:s,level:n,hasChildren:N,pos:k}];return N&&B.value.includes(f)&&w.push(...oe(m,n+1,k)),w}),Q=K(()=>oe(t.treeData)),re=e=>e.map(n=>{var d;return(d=p.value.get(n))==null?void 0:d.node}).filter(Boolean),Ce=e=>{G.value=e,i("update:expandedKeys",e)},R=(e,n,d)=>{const s=!B.value.includes(e),a=s?[...B.value,e]:B.value.filter(f=>f!==e);Ce(a),i("expand",a,{expanded:s,node:n,nativeEvent:d})},ie=(e,n,d)=>{if(t.disabled||n.disabled||n.selectable===!1||!t.selectable)return;const s=!V.value.includes(e);let a;t.multiple?a=s?[...V.value,e]:V.value.filter(f=>f!==e):a=V.value[0]===e?[]:[e],le.value=a,i("update:selectedKeys",a),i("select",a,{event:"select",selected:a.includes(e),node:n,selectedNodes:re(a),nativeEvent:d})},se=(e,n,d)=>{if(t.disabled||n.disabled||n.disableCheckbox||n.checkable===!1)return;const s=P.value.includes(e);let a;if(t.checkStrictly)a=s?P.value.filter(m=>m!==e):[...P.value,e];else{const m=L(e).filter(N=>{var S;const w=(S=p.value.get(N))==null?void 0:S.node;return w&&!w.disabled&&!w.disableCheckbox}),k=new Set(P.value);s?(k.delete(e),m.forEach(N=>k.delete(N)),X(e).forEach(N=>k.delete(N))):(k.add(e),m.forEach(N=>k.add(N)),X(e).forEach(N=>{var S;const w=(((S=p.value.get(N))==null?void 0:S.childrenKeys)??[]).filter(I=>{var H;const z=(H=p.value.get(I))==null?void 0:H.node;return z&&!z.disabled&&!z.disableCheckbox});w.length&&w.every(I=>k.has(I))&&k.add(N)})),a=Array.from(k)}ae.value=a;const f=Array.from(we(a));i("update:checkedKeys",t.checkStrictly?{checked:a,halfChecked:f}:a),i("check",a,{event:"check",checked:!s,node:n,checkedNodes:re(a),halfCheckedKeys:f,nativeEvent:d})},we=e=>{const n=new Set;if(t.checkStrictly)return n;const d=new Set(e);for(const[s]of p.value){if(d.has(s))continue;const a=L(s);a.length&&a.some(f=>d.has(f))&&n.add(s)}return n},W=C(null),Z=e=>{W.value=e,e!==null&&kn(()=>{var d;const n=(d=ce.value)==null?void 0:d.querySelector(`[data-key="${String(e)}"]`);n==null||n.focus()})},Te=(e,n,d,s)=>{var m;const a=Q.value,f=a.findIndex(k=>u(k.node)===n);switch(e.key){case"ArrowDown":e.preventDefault(),f<a.length-1&&Z(u(a[f+1].node));break;case"ArrowUp":e.preventDefault(),f>0&&Z(u(a[f-1].node));break;case"ArrowRight":e.preventDefault(),s&&!B.value.includes(n)?R(n,d,e):s&&f<a.length-1&&Z(u(a[f+1].node));break;case"ArrowLeft":if(e.preventDefault(),s&&B.value.includes(n))R(n,d,e);else{const k=(m=p.value.get(n))==null?void 0:m.parentKey;k!=null&&Z(k)}break;case"Enter":case" ":e.preventDefault(),t.checkable?se(n,d,e):ie(n,d,e);break}},Ke=(e,n,d,s)=>{ie(e,n,s),t.expandAction==="click"&&d&&R(e,n,s)},Oe=(e,n,d,s)=>{i("dblclick",s,n),t.expandAction==="doubleClick"&&d&&R(e,n,s)},Se=(e,n,d)=>{i("rightClick",{event:d,node:n})},T=C(null),j=C(null),Ae=e=>t.draggable?t.draggable===!0?!0:typeof t.draggable=="function"?t.draggable(e):typeof t.draggable=="object"&&t.draggable.nodeDraggable?t.draggable.nodeDraggable(e):!0:!1,Y=e=>{var d,s;if(T.value==null||T.value===e||L(T.value).includes(e))return!1;if(t.allowDrop){const a=(d=p.value.get(T.value))==null?void 0:d.node,f=(s=p.value.get(e))==null?void 0:s.node;if(a&&f)return t.allowDrop({dragNode:a,dropNode:f,dropPosition:0})}return!0},Ee=(e,n,d)=>{T.value=n,i("dragstart",{event:e,node:d})},Ie=(e,n,d)=>{j.value=Y(n)?n:null,i("dragenter",{event:e,node:d,expandedKeys:B.value})},$e=(e,n,d)=>{Y(n)&&e.preventDefault(),i("dragover",{event:e,node:d})},Le=(e,n)=>{i("dragleave",{event:e,node:n})},Be=(e,n)=>{T.value=null,j.value=null,i("dragend",{event:e,node:n})},_e=(e,n,d)=>{var f;if(e.preventDefault(),!Y(n)){T.value=null,j.value=null;return}const s=T.value!=null?(f=p.value.get(T.value))==null?void 0:f.node:void 0,a=p.value.get(n);i("drop",{node:d,dragNode:s,dragNodesKeys:T.value!=null?[T.value,...L(T.value)]:[],dropPosition:(a==null?void 0:a.index)??0,dropToGap:!1,nativeEvent:e}),T.value=null,j.value=null},ce=C(null),Fe=K(()=>typeof t.showLine=="object"?t.showLine.showLeafIcon!==!1:!!t.showLine),ue=K(()=>!!t.showLine),Pe=K(()=>!(typeof t.draggable=="object"&&t.draggable.icon===!1)),M=e=>{var n;return(n=t.classNames)==null?void 0:n[e]},U=e=>{var n;return(n=t.styles)==null?void 0:n[e]},Ve=(e,n,d)=>{if(t.switcherIcon){const s=typeof t.switcherIcon=="function"?t.switcherIcon({expanded:d,isLeaf:!n}):ke(t.switcherIcon,e);if(s)return s}return n?d?"▾":"▸":null},fe=(e,n)=>{var he,ye;const{node:d,level:s,hasChildren:a}=e,f=u(d),m=B.value.includes(f),k=V.value.includes(f),N=P.value.includes(f),w=Ne.value.has(f),S=W.value===f,I=!!(d.disabled||t.disabled),z=(he=t.filterTreeNode)==null?void 0:he.call(t,d),H=d.icon??t.icon,q=Ae(d);return h("div",{key:f,"data-key":String(f),class:J(`${o}-treenode`,M("item"),{[`${o}-treenode-selected`]:k,[`${o}-treenode-disabled`]:I,[`${o}-treenode-leaf`]:!a,[`${o}-treenode-active`]:S,[`${o}-treenode-draggable`]:q,[`${o}-treenode-drag-over`]:j.value===f}),role:"treeitem",tabindex:S||W.value===null&&s===0&&((ye=Q.value[0])==null?void 0:ye.node)===d?0:-1,"aria-level":s+1,"aria-expanded":a?m:void 0,"aria-selected":t.selectable?k:void 0,"aria-checked":t.checkable?N:void 0,"aria-disabled":I||void 0,style:{paddingLeft:`${s*t.indent}px`,...U("item")},draggable:q||void 0,onFocus:()=>{W.value=f},onKeydown:v=>Te(v,f,d,a),onContextmenu:v=>Se(f,d,v),onDragstart:q?v=>Ee(v,f,d):void 0,onDragenter:t.draggable?v=>Ie(v,f,d):void 0,onDragover:t.draggable?v=>$e(v,f,d):void 0,onDragleave:t.draggable?v=>Le(v,d):void 0,onDragend:t.draggable?v=>Be(v,d):void 0,onDrop:t.draggable?v=>_e(v,f,d):void 0},[q&&Pe.value&&h("span",{class:`${o}-draggable-icon`},[x("⋮⋮")]),h("span",{class:J(`${o}-switcher`,M("itemSwitcher"),{[`${o}-switcher_open`]:a&&m,[`${o}-switcher_close`]:a&&!m,[`${o}-switcher-noop`]:!a}),style:U("itemSwitcher"),onClick:()=>a&&R(f,d)},[Ve(d,a,m)]),t.checkable&&h("span",{class:`${o}-checkbox-cell`,onClick:v=>v.stopPropagation()},[h(Nn,{checked:N,indeterminate:w,disabled:I||!!d.disableCheckbox,onChange:()=>se(f,d)},null)]),t.showIcon&&(H||ue.value&&Fe.value)&&h("span",{class:J(`${o}-iconEle`,M("itemIcon")),style:U("itemIcon")},[ke(H,d,{expanded:m,isLeaf:!a})]),h("span",{class:J(`${o}-node-content-wrapper`,M("itemTitle"),{[`${o}-node-content-wrapper-normal`]:!a,[`${o}-node-selected`]:k,[`${o}-node-content-wrapper-matched`]:z}),style:U("itemTitle"),onClick:v=>Ke(f,d,a,v),onDblclick:v=>Oe(f,d,a,v)},[h("span",{class:`${o}-title`},[t.titleRender?t.titleRender(d):b(d)])])])};return()=>{const e=t.virtual&&t.height?h(Dn,{data:Q.value,height:t.height,itemHeight:t.itemHeight,renderItem:(n,d)=>fe(n),itemKey:n=>u(n.node)},null):Q.value.map((n,d)=>fe(n));return h("div",{ref:ce,class:J(o,t.rootClassName,M("root"),{[`${o}-show-line`]:ue.value,[`${o}-block-node`]:t.blockNode,[`${o}-disabled`]:t.disabled,[`${o}-icon-hide`]:!t.showIcon,[`${o}-unselectable`]:!t.selectable}),style:U("root"),role:"tree","aria-multiselectable":t.multiple||void 0},[e])}}}),wn=A({name:"DirectoryTree",props:{expandAction:{type:[Boolean,String],default:"click"},showIcon:{type:Boolean,default:!0}},setup(t,{attrs:i,slots:o}){const y=(l,r)=>l.icon?typeof l.icon=="function"?l.icon(l):l.icon:r!=null&&r.isLeaf?h(ge,null,null):r!=null&&r.expanded?h(me,null,null):h(be,null,null);return()=>h(xe,gn(i,{class:"hmfw-tree-directory",blockNode:!0,showIcon:t.showIcon,expandAction:t.expandAction,icon:y}),{default:()=>{var l;return[(l=o.default)==null?void 0:l.call(o)]}})}}),O=xe;O.DirectoryTree=wn;const Tn=A({__name:"TreeBasic",setup(t){const i=C(["0-0","0-0-0"]),o=C([]),y=[{title:"父节点 1",key:"0-0",children:[{title:"父节点 1-0",key:"0-0-0",children:[{title:"叶子节点",key:"0-0-0-0"},{title:"叶子节点",key:"0-0-0-1"}]},{title:"父节点 1-1",key:"0-0-1",children:[{title:"叶子节点",key:"0-0-1-0"}]}]}];return(l,r)=>(E(),te(g(O),{"tree-data":y,"expanded-keys":i.value,"onUpdate:expandedKeys":r[0]||(r[0]=u=>i.value=u),"selected-keys":o.value,"onUpdate:selectedKeys":r[1]||(r[1]=u=>o.value=u)},null,8,["expanded-keys","selected-keys"]))}}),Kn=`<template>
  <Tree
    :tree-data="treeData"
...
`,En=A({__name:"TreeCheckable",setup(t){const i=C(["0-0"]),o=C([]),y=[{title:"父节点 1",key:"0-0",children:[{title:"子节点 1-1",key:"0-0-0"},{title:"子节点 1-2",key:"0-0-1"}]},{title:"父节点 2",key:"0-1",children:[{title:"子节点 2-1",key:"0-1-0"}]}];return(l,r)=>(E(),_(ve,null,[h(g(O),{checkable:"","tree-data":y,"checked-keys":o.value,"onUpdate:checkedKeys":r[0]||(r[0]=u=>o.value=u),"expanded-keys":i.value,"onUpdate:expandedKeys":r[1]||(r[1]=u=>i.value=u)},null,8,["checked-keys","expanded-keys"]),c("p",null,"已勾选："+ee(o.value.join(", ")),1)],64))}}),In=`<template>
  <Tree
    checkable
    :tree-data="treeData"
...
<\/script>
`,$n=A({__name:"TreeDirectory",setup(t){const i=C(["0-0"]),o=C([]),y=[{title:"src",key:"0-0",children:[{title:"components",key:"0-0-0",children:[{title:"Button.tsx",key:"0-0-0-0",isLeaf:!0},{title:"Tree.tsx",key:"0-0-0-1",isLeaf:!0}]},{title:"utils",key:"0-0-1",children:[{title:"index.ts",key:"0-0-1-0",isLeaf:!0}]}]}];return(l,r)=>(E(),te(g(O).DirectoryTree,{multiple:"","tree-data":y,"expanded-keys":i.value,"onUpdate:expandedKeys":r[0]||(r[0]=u=>i.value=u),"selected-keys":o.value,"onUpdate:selectedKeys":r[1]||(r[1]=u=>o.value=u)},null,8,["expanded-keys","selected-keys"]))}}),Ln=`<template>
  <Tree.DirectoryTree
    multiple
    :tree-data="treeData"
    v-model:expanded-keys="expandedKeys"
...
<\/script>
`,Bn=A({__name:"TreeDraggable",setup(t){const i=C([{title:"父节点 1",key:"0-0",children:[{title:"子节点 1-1",key:"0-0-0"},{title:"子节点 1-2",key:"0-0-1"}]},{title:"父节点 2",key:"0-1",children:[{title:"子节点 2-1",key:"0-1-0"}]}]),o=({dropNode:u})=>Array.isArray(u.children)&&u.children.length>0,y=(u,b)=>{for(let D=0;D<u.length;D++){if(u[D].key===b)return u.splice(D,1)[0];if(u[D].children){const p=y(u[D].children,b);if(p)return p}}return null},l=(u,b,D)=>{for(const p of u){if(p.key===b)return p.children||(p.children=[]),p.children.push(D),!0;if(p.children&&l(p.children,b,D))return!0}return!1},r=u=>{const b=JSON.parse(JSON.stringify(i.value)),D=y(b,u.dragNode.key);D&&(l(b,u.node.key,D),i.value=b)};return(u,b)=>(E(),_("div",null,[b[0]||(b[0]=c("p",{style:{"margin-bottom":"12px",color:"#666"}}," 拖动节点可重新排列。已内置边界检查：节点不能拖到自身或自己的后代上（防止循环引用）。 ",-1)),h(g(O),{draggable:"","block-node":"","tree-data":i.value,"default-expand-all":!0,"allow-drop":o,onDrop:r},null,8,["tree-data"]),b[1]||(b[1]=c("p",{style:{"margin-top":"12px",color:"#999","font-size":"12px"}}," 本示例通过 allowDrop 额外限制：叶子节点不能作为放置目标。 ",-1))]))}}),_n=`<template>
  <div>
...
<\/script>
`,zn={style:{"margin-top":"16px",color:"#666"}},Hn=A({__name:"TreeVirtual",setup(t){const i=(r,u,b)=>r>3?[]:Array.from({length:b},(D,p)=>{const F=`${u}-${p}`,L=r<3;return{key:F,title:`Node ${F}`,children:L?i(r+1,F,Math.min(10,b)):void 0}}),o=i(0,"0",100),y=C(["0-0","0-1","0-0-0","0-0-1"]),l=K(()=>{const r=u=>u.reduce((b,D)=>b+1+(D.children?r(D.children):0),0);return r(o)});return(r,u)=>(E(),_("div",null,[u[0]||(u[0]=c("h3",null,"虚拟滚动 - 10,000 个节点",-1)),h(g(O),{"tree-data":g(o),"default-expanded-keys":y.value,virtual:"",height:400,"item-height":28,"show-line":""},null,8,["tree-data","default-expanded-keys"]),c("div",zn," 总节点数: "+ee(g(o).length)+" 个根节点，约 "+ee(l.value)+" 个节点 ",1)]))}}),Jn=ne(Hn,[["__scopeId","data-v-46efa699"]]),Gn=`<template>
  <div>
