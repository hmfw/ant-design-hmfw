import{B as c}from"./Button-CgFQ9v8N.js";import{n as r}from"./notification-BXzR5T6I.js";import{o as x,A as f,k as m,n,K as d,R as s,m as o,p as b,H as C,l as k,h as l}from"./index-DJdGgqDu.js";import{a as w,C as B}from"./CloseCircleFilled-DwuEqd_1.js";import{I as y}from"./Icon-B3Sy0DYw.js";import"./cls-S9IiI6wd.js";import"./LoadingOutlined-D4bpgc9j.js";import"./CloseOutlined-IFElrYRj.js";import"./ExclamationCircleFilled-BHpRoHQB.js";import"./InfoCircleFilled-Ca97aSXN.js";const h={style:{display:"flex",gap:"8px","flex-wrap":"wrap"}},v=x({__name:"NotificationBasic",setup(g){function a(){r.success({message:"操作成功",description:"您的操作已成功完成，请查看详情。"})}function p(){r.error({message:"操作失败",description:"操作过程中发生错误，请稍后重试。"})}function e(){r.warning({message:"警告",description:"此操作存在风险，请谨慎操作。"})}function t(){r.info({message:"提示信息",description:"这是一条普通的提示信息。"})}return(i,u)=>(f(),m("div",h,[n(d(c),{onClick:a},{default:s(()=>[...u[0]||(u[0]=[o(" 成功 ",-1)])]),_:1}),n(d(c),{onClick:p},{default:s(()=>[...u[1]||(u[1]=[o(" 错误 ",-1)])]),_:1}),n(d(c),{onClick:e},{default:s(()=>[...u[2]||(u[2]=[o(" 警告 ",-1)])]),_:1}),n(d(c),{onClick:t},{default:s(()=>[...u[3]||(u[3]=[o(" 信息 ",-1)])]),_:1})]))}}),N=`<template>
...
<\/script>
`,G={style:{display:"flex",gap:"8px","flex-wrap":"wrap"}},E=x({__name:"NotificationRtl",setup(g){function a(){r.config({rtl:!0}),r.success({message:"RTL 模式已启用",description:"通知现在将以从右到左的布局显示，适用于阿拉伯语等语言。图标和关闭按钮位置已自动调整。",duration:3})}function p(){r.config({rtl:!1}),r.info({message:"RTL 模式已禁用",description:"通知已恢复为默认的从左到右布局。",duration:3})}function e(){r.open({message:"测试通知",description:"这是一条测试通知，用于查看当前布局方向的效果。",duration:3})}return(t,i)=>(f(),m("div",G,[n(d(c),{type:"primary",onClick:a},{default:s(()=>[...i[0]||(i[0]=[o(" 启用 RTL 模式 ",-1)])]),_:1}),n(d(c),{onClick:p},{default:s(()=>[...i[1]||(i[1]=[o(" 禁用 RTL 模式 ",-1)])]),_:1}),n(d(c),{onClick:e},{default:s(()=>[...i[2]||(i[2]=[o(" 打开通知 ",-1)])]),_:1})]))}}),H=`<template>
  <div style="display: flex; gap: 8px; flex-wrap: wrap">
