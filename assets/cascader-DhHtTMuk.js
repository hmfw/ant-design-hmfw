import{n as P,M as ve,D as v,P as ge,w as pe,x as me,m as d,F as Y,l as C,T as be,e as S,z as N,j as J,g as s,J as m,I as M,o as fe,_ as xe,h as Z,G as ye,Q as L,k as Ce}from"./index-i0jnWELi.js";import{c as U}from"./cls-S9IiI6wd.js";const $=P({name:"Cascader",inheritAttrs:!1,props:{value:[Array,Object],defaultValue:{type:[Array,Object],default:()=>[]},options:{type:Array,default:()=>[]},disabled:Boolean,placeholder:{type:String,default:"请选择"},allowClear:{type:Boolean,default:!0},size:{type:String,default:"middle"},status:{type:String,default:""},expandTrigger:{type:String,default:"click"},multiple:Boolean,showSearch:Boolean,changeOnSelect:Boolean,displayRender:Function,fieldNames:Object,open:{type:Boolean,default:void 0},defaultOpen:Boolean,notFoundContent:{type:String,default:"无匹配结果"},loadData:Function,showCheckedStrategy:{type:String,default:"SHOW_PARENT"},maxTagCount:Number,maxTagPlaceholder:[String,Function],maxTagTextLength:Number},emits:["update:value","update:open","change","search","focus","blur","clear"],setup(t,{emit:i,attrs:g,expose:b}){const n=ve("cascader"),c=S(()=>{var e;return((e=t.fieldNames)==null?void 0:e.label)??"label"}),z=S(()=>{var e;return((e=t.fieldNames)==null?void 0:e.value)??"value"}),D=S(()=>{var e;return((e=t.fieldNames)==null?void 0:e.children)??"children"}),h=e=>e[c.value],f=e=>e[z.value],H=e=>e[D.value],I=e=>e?t.multiple?Array.isArray(e)&&e.length>0&&Array.isArray(e[0])?e:[]:Array.isArray(e)&&e.length>0&&!Array.isArray(e[0])?[e]:[]:[],T=v(I(t.defaultValue??t.value)),q=v(t.defaultOpen??!1),k=v([]),w=v(""),B=v(),ee=v(),K=v({top:0,left:0,width:0}),E=v(),le=S(()=>t.value!==void 0),p=S(()=>le.value?I(t.value):T.value),V=S(()=>t.open!==void 0?t.open:q.value);ge(()=>t.value,e=>{e!==void 0&&(T.value=I(e))});const _=(e,l)=>{const a=[];let o=l;for(const u of e){const r=o.find(x=>f(x)===u);if(!r)break;a.push(r),o=H(r)??[]}return a},G=(e,l)=>_(e,l).map(h),R=S(()=>{if(!t.multiple)return p.value;const e=p.value;return!t.showCheckedStrategy||e.length===0?e:t.showCheckedStrategy==="SHOW_CHILD"?e.filter(l=>!e.some(o=>o.length>l.length&&l.every((u,r)=>u===o[r]))):t.showCheckedStrategy==="SHOW_PARENT"?e.filter(l=>!e.some(o=>o.length<l.length&&o.every((u,r)=>u===l[r]))):e}),ne=(e,l)=>{if(!l)return[e];const a=e.toLowerCase(),o=l.toLowerCase(),u=a.indexOf(o);if(u===-1)return[e];const r=e.slice(0,u),x=e.slice(u,u+l.length),j=e.slice(u+l.length),y=[];return r&&y.push(r),y.push(d("span",{class:`${n}-menu-item-highlight`},[x])),j&&y.push(...ne(j,l)),y},W=S(()=>{if(t.multiple){const e=R.value;if(e.length===0)return"";const l=G(e[0],t.options),a=_(e[0],t.options);return t.displayRender?t.displayRender(l,a):l.join(" / ")}else{if(p.value.length===0)return"";const e=G(p.value[0],t.options),l=_(p.value[0],t.options);return t.displayRender?t.displayRender(e,l):e.join(" / ")}}),ae=S(()=>{const e=[t.options];let l=t.options;for(const a of k.value){const o=l.find(r=>f(r)===a);if(!o)break;const u=H(o);if(u!=null&&u.length)e.push(u),l=u;else break}return e}),de=S(()=>{const e=[],l=(a,o,u,r)=>{for(const x of a){const j=[...o,h(x)],y=[...u,f(x)],O=[...r,x],F=H(x);F!=null&&F.length&&!x.isLeaf?l(F,j,y,O):e.push({labels:j,values:y,options:O})}};return l(t.options,[],[],[]),e}),Q=S(()=>{if(!w.value)return null;const e=w.value.toLowerCase();return de.value.filter(l=>l.labels.some(a=>a.toLowerCase().includes(e)))}),oe=()=>{if(!B.value)return;const e=B.value.getBoundingClientRect();K.value={top:e.bottom+window.scrollY+4,left:e.left+window.scrollX,width:e.width}},se=()=>{t.disabled||(oe(),!t.multiple&&p.value.length>0&&(k.value=[...p.value[0]]),q.value=!0,i("update:open",!0))},X=()=>{q.value=!1,w.value="",i("update:open",!1)},te=e=>{var l,a;!((l=B.value)!=null&&l.contains(e.target))&&!((a=ee.value)!=null&&a.contains(e.target))&&X()};pe(()=>document.addEventListener("mousedown",te)),me(()=>document.removeEventListener("mousedown",te));const A=e=>{const l=t.multiple?e:e[0]??[],a=t.multiple?e.map(o=>_(o,t.options)):_(e[0]??[],t.options);i("update:value",l),i("change",l,a)},ue=(e,l)=>{if(e.disabled)return;const a=[...k.value.slice(0,l),f(e)];k.value=a;const o=H(e),u=!(o!=null&&o.length)||e.isLeaf;if(t.loadData&&!u&&!(o!=null&&o.length)){const r=_(a,t.options);t.loadData(r);return}if(t.multiple){if(u||t.changeOnSelect){const r=[...p.value],x=r.findIndex(j=>j.length===a.length&&j.every((y,O)=>y===a[O]));x>=0?r.splice(x,1):r.push(a),T.value=r,A(r)}}else(u||t.changeOnSelect)&&(T.value=[a],A([a]),u&&X())},ie=(e,l)=>{if(t.expandTrigger!=="hover"||e.disabled)return;const a=[...k.value.slice(0,l),f(e)];k.value=a},re=(e,l)=>{if(t.multiple){const a=[...p.value,e];T.value=a,A(a)}else T.value=[e],A([e]),X()},ce=e=>{e.stopPropagation(),T.value=[],A([]),i("clear")},he=(e,l)=>{l.stopPropagation();const a=p.value.filter(o=>!(o.length===e.length&&o.every((u,r)=>u===e[r])));T.value=a,A(a)};return b({focus:()=>{var e;return(e=E.value)==null?void 0:e.focus()},blur:()=>{var e;return(e=E.value)==null?void 0:e.blur()}}),()=>d(Y,null,[d("div",{ref:B,class:U(n,`${n}-${t.size}`,{[`${n}-open`]:V.value,[`${n}-disabled`]:t.disabled,[`${n}-multiple`]:t.multiple,[`${n}-status-error`]:t.status==="error",[`${n}-status-warning`]:t.status==="warning"},g.class),style:g.style,onClick:se},[d("span",{class:`${n}-selector`},[t.multiple?d(Y,null,[R.value.slice(0,t.maxTagCount??R.value.length).map(e=>{const l=G(e,t.options),a=_(e,t.options);let o;return t.displayRender?o=t.displayRender(l,a):o=l.join(" / "),typeof o=="string"&&t.maxTagTextLength&&o.length>t.maxTagTextLength&&(o=o.slice(0,t.maxTagTextLength)+"..."),d("span",{key:e.join("-"),class:`${n}-selection-item`},[d("span",{class:`${n}-selection-item-content`},[o]),!t.disabled&&d("span",{class:`${n}-selection-item-remove`,onClick:u=>he(e,u)},[C("×")])])}),t.maxTagCount&&R.value.length>t.maxTagCount&&d("span",{class:`${n}-selection-item`},[typeof t.maxTagPlaceholder=="function"?t.maxTagPlaceholder(R.value.slice(t.maxTagCount)):t.maxTagPlaceholder??`+${R.value.length-t.maxTagCount}`]),t.showSearch&&V.value&&d("input",{ref:E,class:`${n}-search-input`,value:w.value,placeholder:p.value.length===0?t.placeholder:"",onInput:e=>{w.value=e.target.value,i("search",w.value)},onClick:e=>e.stopPropagation(),autofocus:!0},null),p.value.length===0&&!w.value&&d("span",{class:`${n}-selection-placeholder`},[t.placeholder])]):d(Y,null,[t.showSearch&&V.value?d("input",{ref:E,class:`${n}-search-input`,value:w.value,placeholder:typeof W.value=="string"&&W.value||t.placeholder,onInput:e=>{w.value=e.target.value,i("search",w.value)},onClick:e=>e.stopPropagation(),autofocus:!0},null):d("span",{class:U(`${n}-selection-item`,{[`${n}-selection-placeholder`]:!W.value})},[W.value||t.placeholder])])]),d("span",{class:`${n}-suffix`},[t.allowClear&&p.value.length>0&&!t.disabled?d("span",{class:`${n}-clear`,onMousedown:ce,onClick:e=>e.stopPropagation()},[C("✕")]):d("span",{class:U(`${n}-arrow`,{[`${n}-arrow-open`]:V.value})},[C("▾")])])]),V.value&&d(be,{to:"body"},{default:()=>[d("div",{ref:ee,class:`${n}-dropdown`,style:{position:"absolute",top:`${K.value.top}px`,left:`${K.value.left}px`,zIndex:1050}},[Q.value?d("div",{class:`${n}-menu ${n}-menu-search`},[Q.value.length===0?d("div",{class:`${n}-menu-item-empty`},[t.notFoundContent]):Q.value.map((e,l)=>d("div",{key:l,class:`${n}-menu-item`,onMousedown:a=>{a.preventDefault(),re(e.values,e.options)}},[ne(e.labels.join(" / "),w.value)]))]):d("div",{class:`${n}-menus`},[ae.value.map((e,l)=>d("ul",{key:l,class:`${n}-menu`},[e.map(a=>{var y;const o=f(a),u=H(a),r=!!(u!=null&&u.length)&&!a.isLeaf,x=k.value[l]===o,j=t.multiple?p.value.some(O=>O[l]===o&&O.length>l):((y=p.value[0])==null?void 0:y[l])===o;return d("li",{key:o,class:U(`${n}-menu-item`,{[`${n}-menu-item-active`]:x,[`${n}-menu-item-selected`]:j,[`${n}-menu-item-disabled`]:a.disabled,[`${n}-menu-item-expand`]:r}),onClick:()=>ue(a,l),onMouseenter:()=>ie(a,l)},[t.multiple&&d("span",{class:`${n}-menu-item-checkbox`},[p.value.some(O=>O.length===l+1&&O[l]===o)&&"✓"]),d("span",{class:`${n}-menu-item-content`},[h(a)]),r&&d("span",{class:`${n}-menu-item-expand-icon`},[C("›")])])})]))])])]})])}}),we={class:"demo-cascader"},Se={style:{"margin-top":"8px",color:"#666"}},je={style:{"margin-top":"8px",color:"#666"}},Oe=P({__name:"CascaderAdvanced",setup(t){const i=[{value:"zhejiang",label:"浙江",children:[{value:"hangzhou",label:"杭州",children:[{value:"xihu",label:"西湖"},{value:"binjiang",label:"滨江"}]},{value:"ningbo",label:"宁波"}]},{value:"jiangsu",label:"江苏",children:[{value:"nanjing",label:"南京"},{value:"suzhou",label:"苏州"}]}],g=v([]),b=v([["zhejiang"],["zhejiang","hangzhou"],["zhejiang","hangzhou","xihu"],["jiangsu","nanjing"]]),n=v([["zhejiang"],["zhejiang","hangzhou"],["zhejiang","hangzhou","xihu"],["jiangsu","nanjing"]]),c=v(["zhejiang","hangzhou","xihu"]),z=D=>fe("span",{style:"color: #1677ff; font-weight: 600;"},D.join(" → "));return(D,h)=>(N(),J("div",we,[h[4]||(h[4]=s("h3",null,"搜索高亮",-1)),d(m($),{value:g.value,"onUpdate:value":h[0]||(h[0]=f=>g.value=f),options:i,"show-search":"",placeholder:"搜索城市（高亮显示匹配结果）",style:{width:"300px"}},null,8,["value"]),h[5]||(h[5]=s("h3",{style:{"margin-top":"24px"}},"showCheckedStrategy - SHOW_PARENT",-1)),d(m($),{value:b.value,"onUpdate:value":h[1]||(h[1]=f=>b.value=f),options:i,multiple:"","show-checked-strategy":"SHOW_PARENT",placeholder:"只显示父节点",style:{width:"400px"}},null,8,["value"]),s("div",Se," 当前选择: "+M(JSON.stringify(b.value)),1),h[6]||(h[6]=s("h3",{style:{"margin-top":"24px"}},"showCheckedStrategy - SHOW_CHILD",-1)),d(m($),{value:n.value,"onUpdate:value":h[2]||(h[2]=f=>n.value=f),options:i,multiple:"","show-checked-strategy":"SHOW_CHILD",placeholder:"只显示子节点",style:{width:"400px"}},null,8,["value"]),s("div",je," 当前选择: "+M(JSON.stringify(n.value)),1),h[7]||(h[7]=s("h3",{style:{"margin-top":"24px"}},"自定义 displayRender (VNode)",-1)),d(m($),{value:c.value,"onUpdate:value":h[3]||(h[3]=f=>c.value=f),options:i,"display-render":z,placeholder:"自定义渲染",style:{width:"300px"}},null,8,["value"])]))}}),ze=xe(Oe,[["__scopeId","data-v-75aae63f"]]),$e=`<template>
...
<\/script>
`,Le={style:{"margin-top":"8px"}},He=P({__name:"CascaderMultiple",setup(t){const i=v([]),g=[{value:"zhejiang",label:"浙江",children:[{value:"hangzhou",label:"杭州",children:[{value:"xihu",label:"西湖区"},{value:"yuhang",label:"余杭区"}]},{value:"ningbo",label:"宁波",children:[{value:"haishu",label:"海曙区"}]}]},{value:"jiangsu",label:"江苏",children:[{value:"nanjing",label:"南京",children:[{value:"xuanwu",label:"玄武区"}]}]}],b=(n,c)=>{console.log("选中值：",n,c)};return(n,c)=>(N(),J("div",null,[d(m($),{value:i.value,"onUpdate:value":c[0]||(c[0]=z=>i.value=z),options:g,multiple:!0,placeholder:"支持多选",style:{width:"300px"},onChange:b},null,8,["value"]),s("p",Le,"当前值："+M(i.value),1)]))}}),Ve=`<template>
  <div>
    <Cascader
      v-model:value="value"
      :options="options"
...
<\/script>
`,De=P({__name:"CascaderSearch",setup(t){const i=v([]),g=[{value:"zhejiang",label:"浙江",children:[{value:"hangzhou",label:"杭州",children:[{value:"xihu",label:"西湖区"},{value:"yuhang",label:"余杭区"}]}]},{value:"jiangsu",label:"江苏",children:[{value:"nanjing",label:"南京",children:[{value:"xuanwu",label:"玄武区"}]}]}],b=n=>{console.log("搜索：",n)};return(n,c)=>(N(),Z(m($),{value:i.value,"onUpdate:value":c[0]||(c[0]=z=>i.value=z),options:g,"show-search":!0,placeholder:"请搜索并选择",style:{width:"300px"},onSearch:b},null,8,["value"]))}}),Be=`<template>
  <Cascader
    v-model:value="value"
    :options="options"
    :show-search="true"
