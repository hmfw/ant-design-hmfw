import{S as p}from"./Select-BZuMXyo3.js";import{o as b,A as c,k as v,n as o,K as a,h as e,J as h,E as u,m as r,_ as f,H as y,R as g,l as S}from"./index-B09KCCs0.js";import"./cls-S9IiI6wd.js";import"./VirtualList-DoIsak3W.js";const w={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"300px"}},_=b({__name:"SelectBasic",setup(m){const d=u(""),s=u(""),i=[{label:"Vue",value:"vue"},{label:"React",value:"react"},{label:"Angular",value:"angular"},{label:"Svelte（禁用）",value:"svelte",disabled:!0}];return(t,l)=>(c(),v("div",w,[o(a(p),{value:d.value,"onUpdate:value":l[0]||(l[0]=n=>d.value=n),options:i,placeholder:"请选择",style:{width:"100%"}},null,8,["value"]),o(a(p),{value:s.value,"onUpdate:value":l[1]||(l[1]=n=>s.value=n),options:i,placeholder:"禁用状态",disabled:"",style:{width:"100%"}},null,8,["value"]),e("p",null,"选中："+h(d.value),1)]))}}),V=`<template>
