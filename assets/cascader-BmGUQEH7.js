import{o as R,N as Rn,E as S,Q as En,n as t,F as un,m as N,f as z,A as E,k as G,h as s,K as v,J as ln,p as Hn,_ as xn,i as mn,H as _n,R as A,l as An}from"./index-Y1x_vdlx.js";import{c as m}from"./cls-S9IiI6wd.js";import{D as Ln}from"./DownOutlined-ClBf0RtQ.js";import{T as Dn}from"./Trigger-CjdG1XR4.js";const j=R({name:"Cascader",inheritAttrs:!1,props:{value:[Array,Object],defaultValue:{type:[Array,Object],default:()=>[]},options:{type:Array,default:()=>[]},disabled:Boolean,placeholder:{type:String,default:"请选择"},allowClear:{type:Boolean,default:!0},size:{type:String,default:"middle"},status:{type:String,default:""},expandTrigger:{type:String,default:"click"},multiple:Boolean,showSearch:Boolean,changeOnSelect:Boolean,displayRender:Function,fieldNames:Object,open:{type:Boolean,default:void 0},defaultOpen:Boolean,notFoundContent:{type:String,default:"无匹配结果"},loadData:Function,showCheckedStrategy:{type:String,default:"SHOW_PARENT"},maxTagCount:Number,maxTagPlaceholder:[String,Function],maxTagTextLength:Number,classNames:Object,styles:Object},emits:["update:value","update:open","change","search","focus","blur","clear"],setup(n,{emit:c,attrs:y,expose:i}){const e=Rn("cascader"),u=z(()=>{var a;return((a=n.fieldNames)==null?void 0:a.label)??"label"}),P=z(()=>{var a;return((a=n.fieldNames)==null?void 0:a.value)??"value"}),Z=z(()=>{var a;return((a=n.fieldNames)==null?void 0:a.children)??"children"}),k=a=>a[u.value],I=a=>a[P.value],B=a=>a[Z.value],on=a=>a?n.multiple?Array.isArray(a)&&a.length>0&&Array.isArray(a[0])?a:[]:Array.isArray(a)&&a.length>0&&!Array.isArray(a[0])?[a]:[]:[],T=S(on(n.defaultValue??n.value)),cn=S(n.defaultOpen??!1),H=S([]),q=S(""),Cn=S(),nn=S(),wn=z(()=>n.value!==void 0),C=z(()=>wn.value?on(n.value):T.value),W=z(()=>n.open!==void 0?n.open:cn.value);En(()=>n.value,a=>{a!==void 0&&(T.value=on(a))});const _=(a,l)=>{const o=[];let d=l;for(const p of a){const r=d.find(h=>I(h)===p);if(!r)break;o.push(r),d=B(r)??[]}return o},dn=(a,l)=>_(a,l).map(k),L=z(()=>{if(!n.multiple)return C.value;const a=C.value;return!n.showCheckedStrategy||a.length===0?a:n.showCheckedStrategy==="SHOW_CHILD"?a.filter(l=>!a.some(d=>d.length>l.length&&l.every((p,r)=>p===d[r]))):n.showCheckedStrategy==="SHOW_PARENT"?a.filter(l=>!a.some(d=>d.length<l.length&&d.every((p,r)=>p===l[r]))):a}),gn=(a,l)=>{var w,b;if(!l)return[a];const o=a.toLowerCase(),d=l.toLowerCase(),p=o.indexOf(d);if(p===-1)return[a];const r=a.slice(0,p),h=a.slice(p,p+l.length),g=a.slice(p+l.length),f=[];return r&&f.push(r),f.push(t("span",{class:m(`${e}-menu-item-highlight`,(w=n.classNames)==null?void 0:w.menuItemHighlight),style:(b=n.styles)==null?void 0:b.menuItemHighlight},[h])),g&&f.push(...gn(g,l)),f},en=z(()=>{if(n.multiple){const a=L.value;if(a.length===0)return"";const l=dn(a[0],n.options),o=_(a[0],n.options);return n.displayRender?n.displayRender(l,o):l.join(" / ")}else{if(C.value.length===0)return"";const a=dn(C.value[0],n.options),l=_(C.value[0],n.options);return n.displayRender?n.displayRender(a,l):a.join(" / ")}}),Sn=z(()=>{const a=[n.options];let l=n.options;for(const o of H.value){const d=l.find(r=>I(r)===o);if(!d)break;const p=B(d);if(p!=null&&p.length)a.push(p),l=p;else break}return a}),In=z(()=>{const a=[],l=(o,d,p,r)=>{for(const h of o){const g=[...d,k(h)],f=[...p,I(h)],w=[...r,h],b=B(h);b!=null&&b.length&&!h.isLeaf?l(b,g,f,w):a.push({labels:g,values:f,options:w})}};return l(n.options,[],[],[]),a}),pn=z(()=>{if(!q.value)return null;const a=q.value.toLowerCase();return In.value.filter(l=>l.labels.some(o=>o.toLowerCase().includes(a)))}),Nn=()=>{n.disabled||(!n.multiple&&C.value.length>0&&(H.value=[...C.value[0]]),cn.value=!0,c("update:open",!0))},rn=()=>{cn.value=!1,q.value="",c("update:open",!1)},D=a=>{const l=n.multiple?a:a[0]??[],o=n.multiple?a.map(d=>_(d,n.options)):_(a[0]??[],n.options);c("update:value",l),c("change",l,o)},jn=(a,l)=>{if(a.disabled)return;const o=[...H.value.slice(0,l),I(a)];H.value=o;const d=B(a),p=!(d!=null&&d.length)||a.isLeaf;if(n.loadData&&!p&&!(d!=null&&d.length)){const r=_(o,n.options);n.loadData(r);return}if(n.multiple){if(p||n.changeOnSelect){const r=[...C.value],h=r.findIndex(g=>g.length===o.length&&g.every((f,w)=>f===o[w]));h>=0?r.splice(h,1):r.push(o),T.value=r,D(r)}}else(p||n.changeOnSelect)&&(T.value=[o],D([o]),p&&rn())},On=(a,l)=>{if(n.expandTrigger!=="hover"||a.disabled)return;const o=[...H.value.slice(0,l),I(a)];H.value=o},qn=(a,l)=>{if(n.multiple){const o=[...C.value,a];T.value=o,D(o)}else T.value=[a],D([a]),rn()},zn=a=>{a.stopPropagation(),T.value=[],D([]),c("clear")},Pn=(a,l)=>{l.stopPropagation();const o=C.value.filter(d=>!(d.length===a.length&&d.every((p,r)=>p===a[r])));T.value=o,D(o)};i({focus:()=>{var a;return(a=nn.value)==null?void 0:a.focus()},blur:()=>{var a;return(a=nn.value)==null?void 0:a.blur()}});const Tn=()=>{var a,l,o,d,p,r;return t(un,null,[pn.value?t("div",{class:m(`${e}-menu`,`${e}-menu-search`,(a=n.classNames)==null?void 0:a.menu),style:(l=n.styles)==null?void 0:l.menu},[pn.value.length===0?t("div",{class:m(`${e}-menu-item-empty`,(o=n.classNames)==null?void 0:o.menuItemEmpty),style:(d=n.styles)==null?void 0:d.menuItemEmpty},[n.notFoundContent]):pn.value.map((h,g)=>{var f,w;return t("div",{key:g,class:m(`${e}-menu-item`,(f=n.classNames)==null?void 0:f.menuItem),style:(w=n.styles)==null?void 0:w.menuItem,onMousedown:b=>{b.preventDefault(),qn(h.values,h.options)}},[gn(h.labels.join(" / "),q.value)])})]):t("div",{class:m(`${e}-menus`,(p=n.classNames)==null?void 0:p.menus),style:(r=n.styles)==null?void 0:r.menus},[Sn.value.map((h,g)=>{var f,w;return t("ul",{key:g,class:m(`${e}-menu`,(f=n.classNames)==null?void 0:f.menu),style:(w=n.styles)==null?void 0:w.menu},[h.map(b=>{var U,J,M,K,Q,X,x,Y,sn;const $=I(b),V=B(b),F=!!(V!=null&&V.length)&&!b.isLeaf,an=H.value[g]===$,tn=n.multiple?C.value.some(O=>O[g]===$&&O.length>g):((U=C.value[0])==null?void 0:U[g])===$;return t("li",{key:$,class:m(`${e}-menu-item`,{[`${e}-menu-item-active`]:an,[`${e}-menu-item-selected`]:tn,[`${e}-menu-item-disabled`]:b.disabled,[`${e}-menu-item-expand`]:F},(J=n.classNames)==null?void 0:J.menuItem),style:(M=n.styles)==null?void 0:M.menuItem,onClick:()=>jn(b,g),onMouseenter:()=>On(b,g)},[n.multiple&&t("span",{class:m(`${e}-menu-item-checkbox`,(K=n.classNames)==null?void 0:K.menuItemCheckbox),style:(Q=n.styles)==null?void 0:Q.menuItemCheckbox},[C.value.some(O=>O.length===g+1&&O[g]===$)&&"✓"]),t("span",{class:m(`${e}-menu-item-content`,(X=n.classNames)==null?void 0:X.menuItemContent),style:(x=n.styles)==null?void 0:x.menuItemContent},[k(b)]),F&&t("span",{class:m(`${e}-menu-item-expand-icon`,(Y=n.classNames)==null?void 0:Y.menuItemExpandIcon),style:(sn=n.styles)==null?void 0:sn.menuItemExpandIcon},[N("›")])])})])})])])};return()=>{var a,l;return t(Dn,{open:W.value,trigger:"click",placement:"bottomLeft",disabled:n.disabled,destroyOnHidden:!0,popupClass:m(`${e}-dropdown`,(a=n.classNames)==null?void 0:a.dropdown),popupStyle:(l=n.styles)==null?void 0:l.dropdown,onOpenChange:o=>{o?Nn():rn()}},{default:()=>{var o,d,p,r,h,g,f,w,b,$,V,F,an,tn,U,J,M,K,Q,X;return t("div",{ref:Cn,class:m(e,`${e}-${n.size}`,{[`${e}-open`]:W.value,[`${e}-disabled`]:n.disabled,[`${e}-multiple`]:n.multiple,[`${e}-status-error`]:n.status==="error",[`${e}-status-warning`]:n.status==="warning"},(o=n.classNames)==null?void 0:o.root,y.class),style:{...(d=n.styles)==null?void 0:d.root,...y.style}},[t("span",{class:m(`${e}-selector`,(p=n.classNames)==null?void 0:p.selector),style:(r=n.styles)==null?void 0:r.selector},[n.multiple?t(un,null,[L.value.slice(0,n.maxTagCount??L.value.length).map(x=>{var hn,vn,kn,bn,fn,yn;const Y=dn(x,n.options),sn=_(x,n.options);let O;return n.displayRender?O=n.displayRender(Y,sn):O=Y.join(" / "),typeof O=="string"&&n.maxTagTextLength&&O.length>n.maxTagTextLength&&(O=O.slice(0,n.maxTagTextLength)+"..."),t("span",{key:x.join("-"),class:m(`${e}-selection-item`,(hn=n.classNames)==null?void 0:hn.selectionItem),style:(vn=n.styles)==null?void 0:vn.selectionItem},[t("span",{class:m(`${e}-selection-item-content`,(kn=n.classNames)==null?void 0:kn.selectionItemContent),style:(bn=n.styles)==null?void 0:bn.selectionItemContent},[O]),!n.disabled&&t("span",{class:m(`${e}-selection-item-remove`,(fn=n.classNames)==null?void 0:fn.selectionItemRemove),style:(yn=n.styles)==null?void 0:yn.selectionItemRemove,onClick:$n=>Pn(x,$n)},[N("×")])])}),n.maxTagCount&&L.value.length>n.maxTagCount&&t("span",{class:m(`${e}-selection-item`,(h=n.classNames)==null?void 0:h.selectionItem),style:(g=n.styles)==null?void 0:g.selectionItem},[typeof n.maxTagPlaceholder=="function"?n.maxTagPlaceholder(L.value.slice(n.maxTagCount)):n.maxTagPlaceholder??`+${L.value.length-n.maxTagCount}`]),n.showSearch&&W.value&&t("input",{ref:nn,class:m(`${e}-search-input`,(f=n.classNames)==null?void 0:f.searchInput),style:(w=n.styles)==null?void 0:w.searchInput,value:q.value,placeholder:C.value.length===0?n.placeholder:"",onInput:x=>{q.value=x.target.value,c("search",q.value)},onClick:x=>x.stopPropagation(),autofocus:!0},null),C.value.length===0&&!q.value&&t("span",{class:m(`${e}-selection-placeholder`,(b=n.classNames)==null?void 0:b.selectionPlaceholder),style:($=n.styles)==null?void 0:$.selectionPlaceholder},[n.placeholder])]):t(un,null,[n.showSearch&&W.value?t("input",{ref:nn,class:m(`${e}-search-input`,(V=n.classNames)==null?void 0:V.searchInput),style:(F=n.styles)==null?void 0:F.searchInput,value:q.value,placeholder:typeof en.value=="string"&&en.value||n.placeholder,onInput:x=>{q.value=x.target.value,c("search",q.value)},onClick:x=>x.stopPropagation(),autofocus:!0},null):t("span",{class:m(`${e}-selection-item`,{[`${e}-selection-placeholder`]:!en.value},(an=n.classNames)==null?void 0:an.selectionItem),style:(tn=n.styles)==null?void 0:tn.selectionItem},[en.value||n.placeholder])])]),t("span",{class:m(`${e}-suffix`,(U=n.classNames)==null?void 0:U.suffix),style:(J=n.styles)==null?void 0:J.suffix},[n.allowClear&&C.value.length>0&&!n.disabled?t("span",{class:m(`${e}-clear`,(M=n.classNames)==null?void 0:M.clear),style:(K=n.styles)==null?void 0:K.clear,onMousedown:zn,onClick:x=>x.stopPropagation()},[N("✕")]):t(Ln,{class:m(`${e}-arrow`,{[`${e}-arrow-open`]:W.value},(Q=n.classNames)==null?void 0:Q.arrow),style:(X=n.styles)==null?void 0:X.arrow},null)])])},popup:({placement:o})=>Tn()})}}}),Vn={class:"demo-cascader"},Bn={style:{"margin-top":"8px",color:"#666"}},Wn={style:{"margin-top":"8px",color:"#666"}},Fn=R({__name:"CascaderAdvanced",setup(n){const c=[{value:"zhejiang",label:"浙江",children:[{value:"hangzhou",label:"杭州",children:[{value:"xihu",label:"西湖"},{value:"binjiang",label:"滨江"}]},{value:"ningbo",label:"宁波"}]},{value:"jiangsu",label:"江苏",children:[{value:"nanjing",label:"南京"},{value:"suzhou",label:"苏州"}]}],y=S([]),i=S([["zhejiang"],["zhejiang","hangzhou"],["zhejiang","hangzhou","xihu"],["jiangsu","nanjing"]]),e=S([["zhejiang"],["zhejiang","hangzhou"],["zhejiang","hangzhou","xihu"],["jiangsu","nanjing"]]),u=S(["zhejiang","hangzhou","xihu"]),P=Z=>Hn("span",{style:"color: #1677ff; font-weight: 600;"},Z.join(" → "));return(Z,k)=>(E(),G("div",Vn,[k[4]||(k[4]=s("h3",null,"搜索高亮",-1)),t(v(j),{value:y.value,"onUpdate:value":k[0]||(k[0]=I=>y.value=I),options:c,"show-search":"",placeholder:"搜索城市（高亮显示匹配结果）",style:{width:"300px"}},null,8,["value"]),k[5]||(k[5]=s("h3",{style:{"margin-top":"24px"}},"showCheckedStrategy - SHOW_PARENT",-1)),t(v(j),{value:i.value,"onUpdate:value":k[1]||(k[1]=I=>i.value=I),options:c,multiple:"","show-checked-strategy":"SHOW_PARENT",placeholder:"只显示父节点",style:{width:"400px"}},null,8,["value"]),s("div",Bn,"当前选择: "+ln(JSON.stringify(i.value)),1),k[6]||(k[6]=s("h3",{style:{"margin-top":"24px"}},"showCheckedStrategy - SHOW_CHILD",-1)),t(v(j),{value:e.value,"onUpdate:value":k[2]||(k[2]=I=>e.value=I),options:c,multiple:"","show-checked-strategy":"SHOW_CHILD",placeholder:"只显示子节点",style:{width:"400px"}},null,8,["value"]),s("div",Wn,"当前选择: "+ln(JSON.stringify(e.value)),1),k[7]||(k[7]=s("h3",{style:{"margin-top":"24px"}},"自定义 displayRender (VNode)",-1)),t(v(j),{value:u.value,"onUpdate:value":k[3]||(k[3]=I=>u.value=I),options:c,"display-render":P,placeholder:"自定义渲染",style:{width:"300px"}},null,8,["value"])]))}}),Un=xn(Fn,[["__scopeId","data-v-ad0255c4"]]),Jn=`<template>
...
`,Mn=R({__name:"CascaderBasic",setup(n){const c=S([]),y=[{value:"zhejiang",label:"浙江",children:[{value:"hangzhou",label:"杭州",children:[{value:"xihu",label:"西湖区"},{value:"yuhang",label:"余杭区"}]},{value:"ningbo",label:"宁波",children:[{value:"haishu",label:"海曙区"},{value:"jiangbei",label:"江北区"}]}]},{value:"jiangsu",label:"江苏",children:[{value:"nanjing",label:"南京",children:[{value:"xuanwu",label:"玄武区"},{value:"qinhuai",label:"秦淮区"}]}]}];return(i,e)=>(E(),mn(v(j),{value:c.value,"onUpdate:value":e[0]||(e[0]=u=>c.value=u),options:y,placeholder:"请选择省市区",style:{width:"300px"}},null,8,["value"]))}}),Kn=`<template>
...
<\/script>
`,Qn={style:{"margin-top":"8px"}},Xn=R({__name:"CascaderChangeOnSelect",setup(n){const c=S([]),y=[{value:"zhejiang",label:"浙江",children:[{value:"hangzhou",label:"杭州",children:[{value:"xihu",label:"西湖区"}]}]}],i=e=>{console.log("选中值：",e)};return(e,u)=>(E(),G("div",null,[t(v(j),{value:c.value,"onUpdate:value":u[0]||(u[0]=P=>c.value=P),options:y,"change-on-select":!0,placeholder:"选择即改变",style:{width:"300px"},onChange:i},null,8,["value"]),s("p",Qn,"当前值："+ln(c.value),1)]))}}),Yn=`<template>
  <div>
    <Cascader
      v-model:value="value"
      :options="options"
...
<\/script>
`,Gn={style:{display:"flex","flex-direction":"column",gap:"32px"}},Zn=R({__name:"CascaderClassNames",setup(n){const c=[{value:"zhejiang",label:"浙江",children:[{value:"hangzhou",label:"杭州"},{value:"ningbo",label:"宁波"}]},{value:"jiangsu",label:"江苏",children:[{value:"nanjing",label:"南京"},{value:"suzhou",label:"苏州"}]},{value:"guangdong",label:"广东",children:[{value:"guangzhou",label:"广州"},{value:"shenzhen",label:"深圳"}]}];return(y,i)=>(E(),G("div",Gn,[s("div",null,[i[0]||(i[0]=s("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义选择器样式：",-1)),t(v(j),{options:c,placeholder:"请选择城市","class-names":{root:"custom-cascader-root",selector:"custom-selector",arrow:"custom-arrow"}})]),s("div",null,[i[1]||(i[1]=s("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义下拉面板与菜单项：",-1)),t(v(j),{options:c,placeholder:"请选择城市","class-names":{dropdown:"custom-dropdown",menu:"custom-menu",menuItem:"custom-menu-item",menuItemContent:"custom-menu-item-content"}})]),s("div",null,[i[2]||(i[2]=s("div",{style:{"margin-bottom":"8px",color:"#666"}},"多选模式自定义标签：",-1)),t(v(j),{multiple:"",options:c,placeholder:"请选择多个城市","default-value":[["zhejiang","hangzhou"],["jiangsu","nanjing"]],"class-names":{selectionItem:"custom-tag",selectionItemContent:"custom-tag-content",selectionItemRemove:"custom-tag-remove"}})]),s("div",null,[i[3]||(i[3]=s("div",{style:{"margin-bottom":"8px",color:"#666"}},"搜索高亮自定义：",-1)),t(v(j),{"show-search":"",options:c,placeholder:"搜索城市","class-names":{searchInput:"custom-search-input",menuItemHighlight:"custom-highlight"}})]),s("div",null,[i[4]||(i[4]=s("div",{style:{"margin-bottom":"8px",color:"#666"}},"使用内联样式：",-1)),t(v(j),{options:c,placeholder:"请选择城市",styles:{root:{borderRadius:"20px",borderColor:"#722ed1"},selector:{padding:"8px 16px"},dropdown:{borderRadius:"12px",boxShadow:"0 6px 16px rgba(0, 0, 0, 0.12)"},menuItem:{padding:"10px 16px"}}})])]))}}),ne=xn(Zn,[["__scopeId","data-v-ef69c369"]]),ee=`<template>
...
`,ae=R({__name:"CascaderHover",setup(n){const c=S([]),y=[{value:"frontend",label:"前端",children:[{value:"framework",label:"框架",children:[{value:"vue",label:"Vue"},{value:"react",label:"React"}]},{value:"language",label:"语言",children:[{value:"ts",label:"TypeScript"},{value:"js",label:"JavaScript"}]}]},{value:"backend",label:"后端",children:[{value:"node",label:"Node.js",children:[{value:"express",label:"Express"},{value:"koa",label:"Koa"}]}]}];return(i,e)=>(E(),mn(v(j),{value:c.value,"onUpdate:value":e[0]||(e[0]=u=>c.value=u),options:y,"expand-trigger":"hover",placeholder:"鼠标悬停展开",style:{width:"300px"}},null,8,["value"]))}}),te=`<template>
  <Cascader
    v-model:value="value"
    :options="options"
...
<\/script>
`,se={style:{"margin-top":"8px"}},le=R({__name:"CascaderMultiple",setup(n){const c=S([]),y=[{value:"zhejiang",label:"浙江",children:[{value:"hangzhou",label:"杭州",children:[{value:"xihu",label:"西湖区"},{value:"yuhang",label:"余杭区"}]},{value:"ningbo",label:"宁波",children:[{value:"haishu",label:"海曙区"}]}]},{value:"jiangsu",label:"江苏",children:[{value:"nanjing",label:"南京",children:[{value:"xuanwu",label:"玄武区"}]}]}],i=(e,u)=>{console.log("选中值：",e,u)};return(e,u)=>(E(),G("div",null,[t(v(j),{value:c.value,"onUpdate:value":u[0]||(u[0]=P=>c.value=P),options:y,multiple:!0,placeholder:"支持多选",style:{width:"300px"},onChange:i},null,8,["value"]),s("p",se,"当前值："+ln(c.value),1)]))}}),oe=`<template>
  <div>
    <Cascader
      v-model:value="value"
      :options="options"
...
<\/script>
`,ce=R({__name:"CascaderSearch",setup(n){const c=S([]),y=[{value:"zhejiang",label:"浙江",children:[{value:"hangzhou",label:"杭州",children:[{value:"xihu",label:"西湖区"},{value:"yuhang",label:"余杭区"}]}]},{value:"jiangsu",label:"江苏",children:[{value:"nanjing",label:"南京",children:[{value:"xuanwu",label:"玄武区"}]}]}],i=e=>{console.log("搜索：",e)};return(e,u)=>(E(),mn(v(j),{value:c.value,"onUpdate:value":u[0]||(u[0]=P=>c.value=P),options:y,"show-search":!0,placeholder:"请搜索并选择",style:{width:"300px"},onSearch:i},null,8,["value"]))}}),de=`<template>
  <Cascader
    v-model:value="value"
    :options="options"
    :show-search="true"
