import{I as u}from"./InputNumber-DVpB7l8u.js";import{d as x,o as v,b as f,c as s,e as l,f as t,A as h,r as c,_ as N,h as I,w as g,g as r,i as q}from"./index-DZWA4HiS.js";import"./cls-S9IiI6wd.js";const S={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"300px"}},$=x({__name:"InputNumberBasic",setup(b){const o=c(null);return(d,i)=>(v(),f("div",S,[s(l(u),{value:o.value,"onUpdate:value":i[0]||(i[0]=n=>o.value=n),placeholder:"请输入数字",style:{width:"100%"}},null,8,["value"]),s(l(u),{value:o.value,"onUpdate:value":i[1]||(i[1]=n=>o.value=n),disabled:"",placeholder:"禁用状态",style:{width:"100%"}},null,8,["value"]),t("p",null,"当前值："+h(o.value),1)]))}}),C=`<template>
...
`,E={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"300px"}},M=x({__name:"InputNumberFormatter",setup(b){const o=c(1e3),d=c(50),i=(a,p)=>{const[k,y]=`${a}`.split(".")||[],w=`${k}`.replace(/\B(?=(\d{3})+(?!\d))/g,",");return`$ ${y?`${w}.${y}`:`${w}`}`},n=a=>parseFloat(a.replace(/\$\s?|(,*)/g,"")),e=a=>`${a}%`,m=a=>parseFloat(a.replace("%",""));return(a,p)=>(v(),f("div",E,[t("div",null,[p[2]||(p[2]=t("p",{style:{"margin-bottom":"4px"}},"千分位格式化：",-1)),s(l(u),{value:o.value,"onUpdate:value":p[0]||(p[0]=k=>o.value=k),formatter:i,parser:n,style:{width:"100%"}},null,8,["value"])]),t("div",null,[p[3]||(p[3]=t("p",{style:{"margin-bottom":"4px"}},"百分比：",-1)),s(l(u),{value:d.value,"onUpdate:value":p[1]||(p[1]=k=>d.value=k),min:0,max:100,formatter:e,parser:m,style:{width:"100%"}},null,8,["value"])])]))}}),P=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; max-width: 300px">
    <div>
...
<\/script>
`,R={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"300px"}},K=x({__name:"InputNumberSuffix",setup(b){const o=c(100),d=c(200),i=c(300);return(n,e)=>(v(),f("div",R,[t("div",null,[e[3]||(e[3]=t("p",{style:{"margin-bottom":"4px"}},"带前缀：",-1)),s(l(u),{value:o.value,"onUpdate:value":e[0]||(e[0]=m=>o.value=m),prefix:"¥",style:{width:"100%"}},null,8,["value"])]),t("div",null,[e[4]||(e[4]=t("p",{style:{"margin-bottom":"4px"}},"带后缀：",-1)),s(l(u),{value:d.value,"onUpdate:value":e[1]||(e[1]=m=>d.value=m),suffix:"RMB",style:{width:"100%"}},null,8,["value"])]),t("div",null,[e[5]||(e[5]=t("p",{style:{"margin-bottom":"4px"}},"前缀 + 后缀：",-1)),s(l(u),{value:i.value,"onUpdate:value":e[2]||(e[2]=m=>i.value=m),prefix:"¥",suffix:"元",style:{width:"100%"}},null,8,["value"])])]))}}),Y=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; max-width: 300px">
    <div>
