import{S as l,a as k,b as h,c as v,d as b}from"./index-CsCQ1gtv.js";import{d as i,o as c,q as f,e as s,b as m,c as a,f as n,_ as y,w as p,g,r as S,h as x,i as w}from"./index-DpCWj_RH.js";import{B as q}from"./Button-Bf04Y6dy.js";import"./cls-S9IiI6wd.js";import"./LoadingOutlined-BZTKujXV.js";const N=i({__name:"SkeletonActive",setup(r){return(o,e)=>(c(),f(s(l),{active:""}))}}),C=`<template>
  <Skeleton active />
</template>
...
<\/script>
`,B={style:{display:"flex","flex-direction":"column",gap:"16px"}},E=i({__name:"SkeletonAvatar",setup(r){return(o,e)=>(c(),m("div",B,[a(s(l).Avatar,{active:""}),a(s(l).Avatar,{active:"",size:"large"}),a(s(l).Avatar,{active:"",shape:"square"})]))}}),A=`<template>
...
import { Skeleton } from '@hmfw/ant-design'
<\/script>
`,I=i({__name:"SkeletonBasic",setup(r){return(o,e)=>(c(),f(s(l)))}}),_=`<template>
  <Skeleton />
</template>
...
import { Skeleton } from '@hmfw/ant-design'
<\/script>
`,P={style:{display:"flex","flex-direction":"column",gap:"16px"}},z=i({__name:"SkeletonButtonInput",setup(r){return(o,e)=>(c(),m("div",P,[a(s(k),{active:""}),a(s(k),{active:"",size:"small"}),a(s(k),{active:"",shape:"round"}),a(s(h),{active:""}),a(s(h),{active:"",size:"small"})]))}}),D=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px">
...
<\/script>
`,F={style:{display:"flex","flex-direction":"column",gap:"32px"}},R={style:{display:"flex",gap:"12px","align-items":"center"}},$={style:{display:"flex","flex-direction":"column",gap:"12px"}},T={style:{display:"flex",gap:"16px","align-items":"center"}},V=i({__name:"SkeletonClassNames",setup(r){return(o,e)=>(c(),m("div",F,[n("div",null,[e[0]||(e[0]=n("div",{style:{"margin-bottom":"12px",color:"#666","font-weight":"500"}},"主组件：自定义头部与段落样式",-1)),a(s(l),{avatar:"",paragraph:{rows:3},active:"","class-names":{root:"custom-skeleton-root",header:"custom-header",avatar:"custom-avatar",section:"custom-section",title:"custom-title",paragraph:"custom-paragraph",row:"custom-row"}})]),n("div",null,[e[1]||(e[1]=n("div",{style:{"margin-bottom":"12px",color:"#666","font-weight":"500"}},"主组件：使用内联样式",-1)),a(s(l),{avatar:"",paragraph:{rows:2},active:"",styles:{root:{padding:"16px",backgroundColor:"#fafafa",borderRadius:"8px"},avatar:{borderRadius:"12px"},title:{height:"20px",backgroundColor:"#1890ff20"},row:{height:"14px",backgroundColor:"#52c41a20"}}})]),n("div",null,[e[2]||(e[2]=n("div",{style:{"margin-bottom":"12px",color:"#666","font-weight":"500"}},"SkeletonButton：自定义按钮骨架",-1)),n("div",R,[a(s(k),{active:"",size:"large","class-names":{root:"custom-button-root",button:"custom-button"}}),a(s(k),{active:"",shape:"round",styles:{button:{background:"linear-gradient(135deg, #667eea 0%, #764ba2 100%)"}}}),a(s(k),{active:"",shape:"circle","class-names":{button:"custom-button-circle"}})])]),n("div",null,[e[3]||(e[3]=n("div",{style:{"margin-bottom":"12px",color:"#666","font-weight":"500"}},"SkeletonInput：自定义输入框骨架",-1)),n("div",$,[a(s(h),{active:"",size:"large",block:"","class-names":{input:"custom-input"}}),a(s(h),{active:"",styles:{input:{backgroundColor:"#ff4d4f20",borderRadius:"6px"}}})])]),n("div",null,[e[4]||(e[4]=n("div",{style:{"margin-bottom":"12px",color:"#666","font-weight":"500"}},"SkeletonAvatar 与 SkeletonImage：组合样式",-1)),n("div",T,[a(s(v),{active:"",size:64,"class-names":{avatar:"custom-large-avatar"}}),a(s(b),{active:"","class-names":{image:"custom-image",svg:"custom-svg",path:"custom-path"}}),a(s(v),{active:"",shape:"square",size:"large",styles:{avatar:{borderRadius:"16px",background:"linear-gradient(135deg, #ffd89b 0%, #19547b 100%)"}}})])])]))}}),j=y(V,[["__scopeId","data-v-ff37a614"]]),G=`<template>
...
`,W={style:{display:"flex",gap:"16px"}},M=i({__name:"SkeletonImageNode",setup(r){return(o,e)=>(c(),m("div",W,[a(s(l).Image,{active:""}),a(s(l).Node,{active:""},{default:p(()=>[...e[0]||(e[0]=[n("div",{style:{width:"96px",height:"96px",display:"flex","align-items":"center","justify-content":"center",color:"#bfbfbf"}}," Node ",-1)])]),_:1})]))}}),O=`<template>
...
import { Skeleton } from '@hmfw/ant-design'
<\/script>
`,Y=i({__name:"SkeletonWithChildren",setup(r){const o=S(!0);return(e,d)=>(c(),m("div",null,[a(s(q),{onClick:d[0]||(d[0]=t=>o.value=!o.value)},{default:p(()=>[...d[1]||(d[1]=[g("切换加载状态",-1)])]),_:1}),a(s(l),{loading:o.value,active:"",avatar:""},{default:p(()=>[...d[2]||(d[2]=[n("div",{style:{display:"flex",gap:"12px","margin-top":"16px"}},[n("img",{src:"https://api.dicebear.com/7.x/miniavs/svg?seed=1",style:{width:"40px",height:"40px","border-radius":"50%"}}),n("div",null,[n("p",{style:{"font-weight":"bold"}},"用户名称"),n("p",null,"这是一段描述信息，用于展示骨架屏效果。")])],-1)])]),_:1},8,["loading"])]))}}),H=`<template>
  <div>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">&gt;</span></span>
  ...
  <span class="token comment">&lt;!-- Skeleton 主组件 --&gt;</span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>Skeleton</span>
    <span class="token attr-name">avatar</span>
    <span class="token attr-name">:paragraph</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>{ rows: 3 }<span class="token punctuation">&quot;</span></span>
  ...
  <span class="token comment">&lt;!-- SkeletonButton --&gt;</span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>SkeletonButton</span>
  ...
  <span class="token comment">&lt;!-- SkeletonImage --&gt;</span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>SkeletonImage</span>
    <span class="token attr-name">active</span>
    <span class="token attr-name">:class-names</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>{
      image: &#39;my-image&#39;,
      path: &#39;my-path&#39;,
...
<span class="token selector">:deep(.my-skeleton)</span> <span class="token punctuation">{</span>
  <span class="token property">padding</span><span class="token punctuation">:</span> 16px<span class="token punctuation">;</span>
  <span class="token property">background</span><span class="token punctuation">:</span> <span class="token function">linear-gradient</span><span class="token punctuation">(</span>135deg<span class="token punctuation">,</span> #667eea15 0%<span class="token punctuation">,</span> #764ba215 100%<span class="token punctuation">)</span><span class="token punctuation">;</span>
  <span class="token property">border-radius</span><span class="token punctuation">:</span> 8px<span class="token punctuation">;</span>
<span class="token punctuation">}</span>

<span class="token selector">:deep(.my-avatar)</span> <span class="token punctuation">{</span>
...
<span class="token selector">:deep(.my-row)</span> <span class="token punctuation">{</span>
  <span class="token property">background</span><span class="token punctuation">:</span> <span class="token function">linear-gradient</span><span class="token punctuation">(</span>90deg<span class="token punctuation">,</span> #52c41a 0%<span class="token punctuation">,</span> #389e0d 100%<span class="token punctuation">)</span><span class="token punctuation">;</span>
  <span class="token property">opacity</span><span class="token punctuation">:</span> 0.25<span class="token punctuation">;</span>
<span class="token punctuation">}</span>

<span class="token selector">:deep(.my-button)</span> <span class="token punctuation">{</span>
...
<span class="token selector">:deep(.my-image)</span> <span class="token punctuation">{</span>
  <span class="token property">background</span><span class="token punctuation">:</span> <span class="token function">linear-gradient</span><span class="token punctuation">(</span>135deg<span class="token punctuation">,</span> #faad14 0%<span class="token punctuation">,</span> #d48806 100%<span class="token punctuation">)</span><span class="token punctuation">;</span>
  <span class="token property">border-radius</span><span class="token punctuation">:</span> 12px<span class="token punctuation">;</span>
<span class="token punctuation">}</span>

<span class="token selector">:deep(.my-path)</span> <span class="token punctuation">{</span>
  <span class="token property">fill</span><span class="token punctuation">:</span> #ffffff<span class="token punctuation">;</span>
<span class="token punctuation">}</span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>style</span><span class="token punctuation">&gt;</span></span>
  ...
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>Skeleton</span>
    <span class="token attr-name">avatar</span>
    <span class="token attr-name">:paragraph</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>{ rows: 2 }<span class="token punctuation">&quot;</span></span>
  ...
  <span class="token comment">&lt;!-- SkeletonInput --&gt;</span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>SkeletonInput</span>
  ...
  <span class="token comment">&lt;!-- SkeletonAvatar --&gt;</span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>SkeletonAvatar</span>
