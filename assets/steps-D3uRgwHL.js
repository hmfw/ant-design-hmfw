import{B as z}from"./Button-D1WJzeS3.js";import{S as I}from"./Space-Rctnr-lV.js";import{b as E,C as R}from"./icons-BOELVDCf.js";import{m as f,l as i,k as l,L as O,d as _,n as x,y as v,g as w,P as m,I as c,f as r,H as j,B as k,i as C,E as q,j as L}from"./index-CsoOETlJ.js";import{c as N}from"./cls-S9IiI6wd.js";import{I as T}from"./Icon-Bu-seQlV.js";const M=f({name:"ProgressIcon",props:{prefixCls:{type:String,required:!0},percent:{type:Number,required:!0}},setup(e,{slots:d}){return()=>{var $;const n=`${e.prefixCls}-item-progress-icon`,s=`${n}-circle`,t=14,a=`${2*Math.PI*t*e.percent/100} 9999`;return i("span",{class:n},[i("svg",{class:`${n}-svg`,viewBox:"0 0 100 100",width:"100%",height:"100%",xmlns:"http://www.w3.org/2000/svg","aria-valuemax":100,"aria-valuemin":0,"aria-valuenow":e.percent},[i("title",null,[l("Progress")]),i("circle",{class:`${s} ${s}-rail`,cx:"50",cy:"50",r:t},null),i("circle",{class:`${s} ${s}-ptg`,cx:"50",cy:"50",r:t,"stroke-dasharray":a,transform:"rotate(-90 50 50)"},null)]),($=d.default)==null?void 0:$.call(d)])}}}),W=f({name:"PanelArrow",props:{prefixCls:{type:String,required:!0}},setup(e){return()=>i("svg",{class:`${e.prefixCls}-panel-arrow`,viewBox:"0 0 100 100",xmlns:"http://www.w3.org/2000/svg",preserveAspectRatio:"none"},[i("title",null,[l("Arrow")]),i("path",{d:"M 0 0 L 100 50 L 0 100"},null)])}}),h=f({name:"Steps",props:{current:{type:Number,default:0},initial:{type:Number,default:0},items:{type:Array,default:()=>[]},direction:{type:String},orientation:{type:String},size:{type:String,default:"default"},status:{type:String,default:"process"},type:{type:String,default:"default"},labelPlacement:{type:String},titlePlacement:{type:String},progressDot:{type:[Boolean,Function]},variant:{type:String,default:"filled"},percent:Number,responsive:{type:Boolean,default:!0},ellipsis:Boolean,offset:{type:Number,default:0},iconRender:Function},emits:["change"],setup(e,{emit:d}){const n=O("steps"),s=_(()=>e.type&&e.type!=="default"?e.type:e.progressDot?"dot":e.type),t=_(()=>s.value==="dot"||s.value==="inline"),a=_(()=>s.value==="inline"),$=_(()=>{const p=e.orientation||e.direction;return s.value==="panel"?"horizontal":p==="vertical"?"vertical":"horizontal"}),B=_(()=>t.value||$.value==="vertical"?$.value==="vertical"?"horizontal":"vertical":e.type==="navigation"?"horizontal":e.titlePlacement||e.labelPlacement||"horizontal"),P=_(()=>a.value?void 0:e.percent),F=(p,o)=>{if(o.status)return o.status;const u=p+e.initial;return u<e.current?"finish":u===e.current?e.status:"wait"},V=(p,o,u)=>{const S=`${n}-item-icon`;let b=null;if(t.value||u.icon)b=u.icon||x("span",{class:`${n}-icon-dot`});else switch(o){case"finish":b=x(T,{component:R,class:`${S}-finish`});break;case"error":b=x(T,{component:E,class:`${S}-error`});break;default:{const g=x("span",{class:`${S}-number`},p+e.initial+1);o==="process"&&P.value!==void 0?b=x(M,{prefixCls:n,percent:P.value},{default:()=>g}):b=g}}let y=b;if(e.iconRender){const g={index:p,active:p+e.initial===e.current,item:{...u,status:o}};y=e.iconRender(y,g)}else if(typeof e.progressDot=="function"){const g={index:p,active:p+e.initial===e.current,item:{...u,status:o}};y=e.progressDot(y,g)}return y},D=(p,o,u)=>{if(o.disabled)return;o.onClick&&o.onClick(u);const S=p+e.initial;S!==e.current&&d("change",S)};return()=>{const p=e.items??[];return i("div",{class:N(n,`${n}-${$.value}`,`${n}-${e.variant}`,{[`${n}-${e.size}`]:e.size!=="default",[`${n}-label-${B.value}`]:B.value!=="horizontal",[`${n}-dot`]:t.value,[`${n}-navigation`]:e.type==="navigation",[`${n}-inline`]:a.value,[`${n}-panel`]:s.value==="panel",[`${n}-with-progress`]:P.value!==void 0,[`${n}-ellipsis`]:e.ellipsis}),role:"list","aria-label":"步骤条"},[p.map((o,u)=>{const S=F(u,o),b=V(u,S,o),y=!o.disabled,g=o.content||o.description;return i("div",{key:u,class:N(`${n}-item`,`${n}-item-${S}`,{[`${n}-item-disabled`]:o.disabled,[`${n}-item-active`]:u+e.initial===e.current}),role:"listitem","aria-current":u+e.initial===e.current?"step":void 0,"aria-disabled":o.disabled||void 0,onClick:A=>y&&D(u,o,A)},[i("div",{class:`${n}-item-container`},[i("div",{class:`${n}-item-tail`},null),i("div",{class:`${n}-item-icon`},[b]),i("div",{class:`${n}-item-content`},[i("div",{class:`${n}-item-title`},[o.title,o.subTitle&&i("span",{class:`${n}-item-subtitle`},[o.subTitle])]),g&&i("div",{class:`${n}-item-description`},[g])])]),s.value==="panel"&&i(W,{prefixCls:n},null)])})])}}}),H=f({__name:"StepsBasic",setup(e){const d=k(0),n=[{title:"第一步",description:"填写基本信息"},{title:"第二步",description:"确认订单信息"},{title:"第三步",description:"完成支付"}];return(s,t)=>(v(),w(c(I),{direction:"vertical",style:{width:"100%"}},{default:m(()=>[i(c(h),{current:d.value,items:n},null,8,["current"]),i(c(I),null,{default:m(()=>[i(c(z),{disabled:d.value===0,onClick:t[0]||(t[0]=a=>d.value--)},{default:m(()=>[...t[2]||(t[2]=[l("上一步",-1)])]),_:1},8,["disabled"]),i(c(z),{type:"primary",disabled:d.value===n.length-1,onClick:t[1]||(t[1]=a=>d.value++)},{default:m(()=>[...t[3]||(t[3]=[l("下一步",-1)])]),_:1},8,["disabled"])]),_:1}),r("p",null,"当前步骤："+j(d.value+1),1)]),_:1}))}}),G=`<template>
...
<\/script>
`,J=f({__name:"StepsDot",setup(e){const d=[{title:"已完成",description:"2024-01-01"},{title:"进行中",description:"2024-01-02"},{title:"待处理",description:"2024-01-03"},{title:"待处理",description:"2024-01-04"}];return(n,s)=>(v(),w(c(h),{"progress-dot":"",current:1,items:d}))}}),K=`<template>
  <Steps
    progress-dot
    :current="1"
    :items="items"
