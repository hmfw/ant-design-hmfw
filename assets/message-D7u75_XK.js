import{m as o}from"./message-nDDQwWQa.js";import{k as m,w as a,g as c,d as n,B as p,j as i,M as l,G as g,h as b}from"./index-BNHhPN23.js";import"./cls-S9IiI6wd.js";const h={style:{display:"flex",gap:"8px","flex-wrap":"wrap"}},f=m({__name:"MessageBasic",setup(u){function e(){o.success("操作成功！")}function s(){o.error("操作失败，请重试。")}function r(){o.warning("请注意此操作的风险。")}function t(){o.info("这是一条普通提示信息。")}function d(){o.loading("正在加载中...")}return(_,y)=>(a(),c("div",h,[n("button",{onClick:e},"成功"),n("button",{onClick:s},"错误"),n("button",{onClick:r},"警告"),n("button",{onClick:t},"信息"),n("button",{onClick:d},"加载中")]))}}),w=`<template>
