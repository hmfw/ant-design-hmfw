import{E as l,P as f}from"./Empty-C4KqP8r5.js";import{m as a,y as s,g as u,P as r,f as e,I as n,E as _,i as y,l as o,k as c,j as b}from"./index-CsoOETlJ.js";import"./cls-S9IiI6wd.js";const S=a({__name:"EmptyAction",setup(i){function d(){console.log("创建")}return(p,E)=>(s(),u(n(l),{description:"暂无数据"},{default:r(()=>[e("button",{onClick:d},"立即创建")]),_:1}))}}),g=`<template>
