import{B as d}from"./Button-CnMq9a0G.js";import{n as p}from"./notification-DQ3wcZn9.js";import{d as y,o as m,b as g,c as s,e as o,w as a,g as t,f as c,v as b,_ as v,h as N,i as x}from"./index-Dhlw_h7w.js";import{C as w}from"./CloseCircleFilled-CH10Ua8m.js";import{C}from"./CheckCircleFilled-LEf_dyYG.js";import"./cls-S9IiI6wd.js";import"./LoadingOutlined-BpH-uTyr.js";import"./CloseOutlined-N_iBbuHV.js";import"./ExclamationCircleFilled-BYoDTTJJ.js";import"./InfoCircleFilled-CJnSTIEn.js";const h={style:{display:"flex",gap:"8px","flex-wrap":"wrap"}},B=y({__name:"NotificationBasic",setup(k){function l(){p.success({message:"操作成功",description:"您的操作已成功完成，请查看详情。"})}function u(){p.error({message:"操作失败",description:"操作过程中发生错误，请稍后重试。"})}function e(){p.warning({message:"警告",description:"此操作存在风险，请谨慎操作。"})}function n(){p.info({message:"提示信息",description:"这是一条普通的提示信息。"})}return(i,f)=>(m(),g("div",h,[s(o(d),{onClick:l},{default:a(()=>[...f[0]||(f[0]=[t(" 成功 ",-1)])]),_:1}),s(o(d),{onClick:u},{default:a(()=>[...f[1]||(f[1]=[t(" 错误 ",-1)])]),_:1}),s(o(d),{onClick:e},{default:a(()=>[...f[2]||(f[2]=[t(" 警告 ",-1)])]),_:1}),s(o(d),{onClick:n},{default:a(()=>[...f[3]||(f[3]=[t(" 信息 ",-1)])]),_:1})]))}}),S=`<template>
