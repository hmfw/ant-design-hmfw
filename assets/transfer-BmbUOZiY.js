import{B as ue}from"./Button-DaEKIrtr.js";import{u as he,ab as ve,D as ke,a7 as be,S as Se}from"./icons-DrnBibzR.js";import{D as Te}from"./index-XmO1DnZE.js";import{C as pe}from"./Checkbox-CpptgAwY.js";import{I as oe}from"./Icon-K3gH4Ffy.js";import{I as Ke}from"./Input-DwdPd9gM.js";import{c as I}from"./cls-S9IiI6wd.js";import{P as we}from"./Pagination-DoUAhvLa.js";import{E as xe}from"./Empty-T8wXMoWh.js";import{n as P,D as w,P as Z,m as o,r as fe,F as le,e as f,M as Ce,L as Ae,z as j,h as q,J as h,j as ye,g as m,I as Ie,G as $e,Q as V,l as ge,k as De}from"./index-bv5A37HL.js";import"./Menu-DlRzxQxp.js";import"./Select-D_N5z-mT.js";import"./VirtualList-41ffnqds.js";function Oe(t){return!!t&&typeof t=="object"&&!("__v_isVNode"in t)&&"value"in t}function Re(t,r){for(const c of[t,r.title,r.key]){if(typeof c=="string")return c;if(typeof c=="number")return String(c)}return""}function E(t){return t.filter(r=>!r.disabled).map(r=>r.key)}const me=P({name:"TransferList",props:{prefixCls:{type:String,required:!0},direction:{type:String,required:!0},titleText:{type:[String,Object],default:""},dataSource:{type:Array,default:()=>[]},checkedKeys:{type:Array,default:()=>[]},disabled:Boolean,showSearch:{type:[Boolean,Object],default:!1},showSelectAll:{type:Boolean,default:!0},showRemove:Boolean,draggable:Boolean,pagination:{type:[Boolean,Object],default:void 0},selectAllLabel:{type:[String,Object,Function],default:void 0},render:Function,filterOption:Function,footer:Function,listStyle:{type:Object,default:()=>({})},classNames:{type:Object,default:()=>({})},styles:{type:Object,default:()=>({})},searchPlaceholder:{type:String,default:"请输入搜索内容"},notFoundContent:{type:[String,Object,Array],default:void 0},itemUnit:{type:String,default:"项"},itemsUnit:{type:String,default:"项"},selectAll:{type:String,default:"全选所有"},deselectAll:{type:String,default:"取消全选"},selectCurrent:{type:String,default:"全选当页"},selectInvert:{type:String,default:"反选当页"},removeAll:{type:String,default:"删除全部"},removeCurrent:{type:String,default:"删除当页"}},emits:["itemSelect","itemSelectAll","itemRemove","reorder","filter","scroll"],setup(t,{emit:r}){const c=f(()=>`${t.prefixCls}-list`),y=f(()=>`${t.prefixCls}-section`),n=f(()=>t.showSearch&&typeof t.showSearch=="object"?{defaultValue:"",placeholder:"",...t.showSearch}:{defaultValue:"",placeholder:""}),l=w(n.value.defaultValue||"");Z(()=>n.value.defaultValue,e=>{l.value=e||""});const x=w(1),v=f(()=>t.pagination?{simple:!0,showSizeChanger:!1,showLessItems:!1,pageSize:10,...typeof t.pagination=="object"?t.pagination:{}}:null);function H(e){const a=t.render?t.render(e):null,s=Oe(a),d=s?a.label:a,g=s?a.value:Re(a,e);return{item:e,renderedEl:d??e.title??String(e.key),renderedText:g}}function W(e,a){return t.filterOption?t.filterOption(l.value,a,t.direction):e.toLowerCase().includes(l.value.toLowerCase())}const D=f(()=>{const e=[];return t.dataSource.forEach(a=>{const s=H(a);l.value&&!W(s.renderedText,a)||e.push(s)}),e}),O=f(()=>D.value.map(e=>e.item));Z([D,v],()=>{const e=v.value;if(e){const a=Math.max(1,Math.ceil(D.value.length/e.pageSize));x.value=Math.min(x.value,a)}});const R=f(()=>{const e=v.value;return e?D.value.slice((x.value-1)*e.pageSize,x.value*e.pageSize):D.value}),T=f(()=>O.value.filter(e=>t.checkedKeys.includes(e.key)&&!e.disabled)),S=f(()=>{if(T.value.length===0)return"none";const e=new Set(t.checkedKeys);return O.value.every(a=>e.has(a.key)||!!a.disabled)?"all":"part"});function z(e){l.value=e,r("filter",t.direction,e)}function G(){const e=E(O.value);r("itemSelectAll",e,S.value!=="all")}function J(e,a){const s=t.selectAllLabel;if(s)return typeof s=="function"?s({selectedCount:e,totalCount:a}):s;const d=a>1?t.itemsUnit:t.itemUnit;return`${e>0?`${e}/`:""}${a} ${d}`}const ee=f(()=>{const e=v.value;return t.showRemove?[e&&{key:"removeCurrent",label:t.removeCurrent,onClick:()=>r("itemRemove",E(R.value.map(a=>a.item)))},{key:"removeAll",label:t.removeAll,onClick:()=>r("itemRemove",E(O.value))}].filter(Boolean):[{key:"selectAll",label:S.value==="all"?t.deselectAll:t.selectAll,onClick:()=>{const a=E(O.value);r("itemSelectAll",a,a.length!==t.checkedKeys.length)}},e&&{key:"selectCurrent",label:t.selectCurrent,onClick:()=>r("itemSelectAll",E(R.value.map(a=>a.item)),!0)},{key:"selectInvert",label:t.selectInvert,onClick:()=>{const a=E(R.value.map(d=>d.item)),s=new Set(t.checkedKeys);a.forEach(d=>s.has(d)?s.delete(d):s.add(d)),r("itemSelectAll",[...s],"replace")}}].filter(Boolean)});function C(e){return t.classNames[e]}function k(e){return t.styles[e]}const _=w(null),L=w(null),B=w(!1);function te(e){return!!t.draggable&&!t.disabled&&!e.disabled}function ne(e,a){if(_.value=a,e.dataTransfer){e.dataTransfer.effectAllowed="move";try{e.dataTransfer.setData("text/plain",String(a))}catch{}}}function ae(e,a){if(_.value===null||_.value===a)return;e.preventDefault(),e.dataTransfer&&(e.dataTransfer.dropEffect="move");const d=e.currentTarget.getBoundingClientRect(),i=e.clientY-d.top>d.height/2;(L.value!==a||B.value!==i)&&(L.value=a,B.value=i)}function se(e,a){L.value===a&&(L.value=null)}function Q(e,a){e.preventDefault();const s=_.value,d=B.value;_.value=null,L.value=null,!(s===null||s===a)&&r("reorder",s,a,d)}function Y(){_.value=null,L.value=null}return()=>{const e=c.value,a=t.dataSource.some(b=>!b.disabled),s=o(pe,{class:`${e}-checkbox`,disabled:!a||t.disabled,checked:S.value==="all",indeterminate:S.value==="part",onChange:G},null),d=o(Te,{class:`${e}-header-dropdown`,disabled:t.disabled,menu:{items:ee.value}},{default:()=>[o("span",{class:`${e}-header-dropdown-trigger`},[o(oe,{component:he},null)])]}),g=t.showSearch?o("div",{class:`${e}-body-search-wrapper`},[o(Ke,{class:`${e}-search`,value:l.value,placeholder:n.value.placeholder||t.searchPlaceholder,disabled:t.disabled,allowClear:!0,prefix:o(oe,{component:ve},null),onInput:b=>z(b.target.value),onClear:()=>z("")},null)]):null,i=R.value.map(({item:b,renderedEl:F})=>{const K=b.key,A=t.disabled||b.disabled,U=t.checkedKeys.includes(K),X=_.value===K,re=L.value===K,de=te(b)?{draggable:!0,onDragstart:N=>ne(N,K),onDragover:N=>ae(N,K),onDragleave:N=>se(N,K),onDrop:N=>Q(N,K),onDragend:()=>Y()}:{},ce={[`${e}-content-item-draggable`]:!!t.draggable&&!A,[`${e}-content-item-dragging`]:X,[`${e}-content-item-drag-over`]:re&&!X,[`${e}-content-item-drag-over-after`]:re&&!X&&B.value,[`${e}-content-item-drag-over-before`]:re&&!X&&!B.value},ie=o("span",{class:I(`${e}-content-item-text`,C("itemContent")),style:k("itemContent")},[F]);return t.showRemove?o("li",fe({key:K,class:I(`${e}-content-item`,C("item"),ce,{[`${e}-content-item-disabled`]:A}),style:k("item")},de),[ie,o("button",{type:"button",disabled:A,class:`${e}-content-item-remove`,"aria-label":t.removeCurrent,onClick:()=>!A&&r("itemRemove",[K])},[o(oe,{component:ke},null)])]):o("li",fe({key:K,class:I(`${e}-content-item`,C("item"),ce,{[`${e}-content-item-disabled`]:A,[`${e}-content-item-checked`]:U&&!A}),style:k("item")},de,{onClick:N=>!A&&r("itemSelect",K,!U,N)}),[o(pe,{class:I(`${e}-checkbox`,C("itemIcon")),style:k("itemIcon"),checked:U,disabled:A},null),ie])}),u=Array.isArray(t.notFoundContent)?t.notFoundContent[t.direction==="left"?0:1]:t.notFoundContent,p=R.value.length?o(le,null,[o("ul",{class:I(`${e}-content`,C("list"),{[`${e}-content-show-remove`]:t.showRemove}),style:k("list"),onScroll:b=>r("scroll",t.direction,b)},[i]),v.value&&o(we,{size:"small",disabled:t.disabled,simple:v.value.simple,pageSize:v.value.pageSize,showSizeChanger:v.value.showSizeChanger,class:`${e}-pagination`,total:D.value.length,current:x.value,onChange:b=>{x.value=b}},null)]):o("div",{class:`${e}-body-not-found`},[u??o(xe,{description:!1},null)]),$=t.footer?t.footer({direction:t.direction,filteredItems:O.value,selectedKeys:t.checkedKeys,disabled:t.disabled}):null;return o("div",{class:I(y.value,C("section"),{[`${y.value}-with-pagination`]:!!v.value,[`${y.value}-with-footer`]:!!$}),style:{...t.listStyle,...k("section")}},[o("div",{class:I(`${e}-header`,C("header")),style:k("header")},[t.showSelectAll?o(le,null,[!t.showRemove&&!v.value&&s,d]):null,o("span",{class:`${e}-header-selected`},[J(T.value.length,O.value.length)]),o("span",{class:I(`${e}-header-title`,C("title")),style:k("title")},[t.titleText])]),o("div",{class:I(`${e}-body`,C("body"),{[`${e}-body-with-search`]:!!t.showSearch}),style:k("body")},[g,p]),$&&o("div",{class:I(`${e}-footer`,C("footer")),style:k("footer")},[$])])}}}),M=P({name:"Transfer",props:{dataSource:{type:Array,default:()=>[]},targetKeys:Array,defaultTargetKeys:{type:Array,default:()=>[]},selectedKeys:Array,defaultSelectedKeys:{type:Array,default:()=>[]},titles:{type:Array,default:()=>["",""]},operations:{type:Array,default:()=>[]},render:Function,rowKey:Function,showSearch:{type:[Boolean,Object],default:!1},filterOption:Function,footer:Function,listStyle:{type:[Object,Function],default:()=>({})},disabled:Boolean,showSelectAll:{type:Boolean,default:!0},selectAllLabels:{type:Array,default:()=>[]},oneWay:Boolean,draggable:Boolean,pagination:{type:[Boolean,Object],default:void 0},status:String,locale:{type:Object,default:()=>({})},rootClassName:String,classNames:{type:Object,default:()=>({})},styles:{type:Object,default:()=>({})}},emits:["update:targetKeys","change","update:selectedKeys","selectChange","search","scroll","reorder"],setup(t,{emit:r}){const c=Ce("transfer"),y=Ae(),n=f(()=>({...y.value.Transfer,...t.locale})),l=w([...t.defaultTargetKeys]),x=w([...t.defaultSelectedKeys]);Z(()=>t.targetKeys,e=>{e&&(l.value=[...e])}),Z(()=>t.selectedKeys,e=>{e&&(x.value=[...e])});const v=f(()=>t.targetKeys??l.value),H=f(()=>t.selectedKeys??x.value),W=f(()=>t.dataSource.map(e=>({...e,key:t.rowKey?t.rowKey(e):e.key}))),D=f(()=>W.value.filter(e=>!v.value.includes(e.key))),O=f(()=>new Map(W.value.map(e=>[e.key,e]))),R=f(()=>v.value.map(e=>O.value.get(e)).filter(Boolean)),T=f(()=>H.value.filter(e=>D.value.some(a=>a.key===e))),S=f(()=>H.value.filter(e=>R.value.some(a=>a.key===e)));function z(e){x.value=e,r("update:selectedKeys",e)}function G(e,a){const s=e==="left"?S.value:T.value,d=e==="left"?[...a,...s]:[...s,...a];z(d),e==="left"?r("selectChange",a,S.value):r("selectChange",T.value,a)}function J(e){const a=e==="right"?T.value:S.value,s=new Set(W.value.filter(p=>p.disabled).map(p=>p.key)),d=a.filter(p=>!s.has(p)),g=new Set(d),i=e==="right"?[...d,...v.value]:v.value.filter(p=>!g.has(p));l.value=i,r("update:targetKeys",i);const u=e==="right"?S.value:T.value;z(u),e==="right"?r("selectChange",[],S.value):r("selectChange",T.value,[]),r("change",i,e,d)}const ee=()=>J("right"),C=()=>J("left"),k={left:null,right:null};function _(e,a,s,d){var b;const g=e==="left",i=g?T.value:S.value,u=(g?D.value:R.value).filter(F=>!F.disabled),p=u.findIndex(F=>F.key===a),$=new Set(i);if(d&&k[e]!==null){const F=Math.min(k[e],p),K=Math.max(k[e],p);for(let A=F;A<=K;A++){const U=(b=u[A])==null?void 0:b.key;U!==void 0&&$.add(U)}}else $.has(a)&&$.delete(a),s&&$.add(a),k[e]=s?p:null;G(e,[...$])}function L(e,a,s){const d=e==="left"?T.value:S.value;let g;if(s==="replace")g=a;else if(s)g=[...new Set([...d,...a])];else{const i=new Set(a);g=d.filter(u=>!i.has(u))}k[e]=null,G(e,g)}function B(e){const a=new Set(e),s=v.value.filter(d=>!a.has(d));l.value=s,r("update:targetKeys",s),z(T.value),r("change",s,"left",[...e])}function te(e,a,s){if(e===a)return;const d=[...v.value],g=d.indexOf(e),i=d.indexOf(a);if(g<0||i<0)return;const u=d.slice();u.splice(g,1);const p=u.indexOf(a),$=s?p+1:p;u.splice($,0,e),l.value=u,r("update:targetKeys",u);const b={direction:"right",oldTargetKeys:d,newTargetKeys:u,activeKey:e,fromIndex:g,toIndex:u.indexOf(e)};r("reorder",b)}function ne(e){return typeof t.listStyle=="function"?t.listStyle({direction:e}):t.listStyle}const ae=f(()=>T.value.length>0),se=f(()=>S.value.length>0),Q=f(()=>t.operations||[]);function Y(e){var d,g;const a=e==="left",s=n.value;return{prefixCls:c,direction:e,titleText:((d=t.titles)==null?void 0:d[a?0:1])??"",dataSource:a?D.value:R.value,checkedKeys:a?T.value:S.value,disabled:t.disabled,showSearch:t.showSearch,showSelectAll:t.showSelectAll,showRemove:t.oneWay&&!a,draggable:!!t.draggable&&!a,pagination:t.pagination,selectAllLabel:(g=t.selectAllLabels)==null?void 0:g[a?0:1],render:t.render,filterOption:t.filterOption,footer:t.footer,listStyle:ne(e),classNames:t.classNames,styles:t.styles,searchPlaceholder:s.searchPlaceholder,notFoundContent:t.locale.notFoundContent??s.notFoundContent,itemUnit:s.itemUnit,itemsUnit:s.itemsUnit,selectAll:s.selectAll,deselectAll:s.deselectAll,selectCurrent:s.selectCurrent,selectInvert:s.selectInvert,removeAll:s.removeAll,removeCurrent:s.removeCurrent,onItemSelect:(i,u,p)=>_(e,i,u,p==null?void 0:p.shiftKey),onItemSelectAll:(i,u)=>L(e,i,u),onItemRemove:i=>B(i),onReorder:(i,u,p)=>te(i,u,p),onFilter:(i,u)=>r("search",i,u),onScroll:(i,u)=>r("scroll",i,u)}}return()=>o("div",{class:I(c,t.rootClassName,t.classNames.root,{[`${c}-disabled`]:t.disabled,[`${c}-status-error`]:t.status==="error",[`${c}-status-warning`]:t.status==="warning"}),style:t.styles.root},[o(me,Y("left"),null),o("div",{class:I(`${c}-actions`,t.classNames.actions),style:t.styles.actions},[o(ue,{type:"primary",size:"small",icon:be,disabled:!ae.value||t.disabled,onClick:ee},{default:()=>[Q.value[0]]}),!t.oneWay&&o(ue,{type:"primary",size:"small",icon:Se,disabled:!se.value||t.disabled,onClick:C},{default:()=>[Q.value[1]]})]),o(me,Y("right"),null)])}}),_e=P({__name:"TransferBasic",setup(t){const r=Array.from({length:10},(y,n)=>({key:String(n),title:`选项 ${n+1}`,description:`描述 ${n+1}`,disabled:n===3})),c=w(["1","3","5"]);return(y,n)=>(j(),q(h(M),{"target-keys":c.value,"onUpdate:targetKeys":n[0]||(n[0]=l=>c.value=l),"data-source":h(r),titles:["待选","已选"],"show-search":""},null,8,["target-keys","data-source"]))}}),Le=`<template>
...
<\/script>
`,Ne=P({__name:"TransferCustom",setup(t){const r=Array.from({length:10},(y,n)=>({key:String(n),title:`选项 ${n+1}`})),c=w(["1","3"]);return(y,n)=>(j(),q(h(M),{"target-keys":c.value,"onUpdate:targetKeys":n[0]||(n[0]=l=>c.value=l),"data-source":h(r),titles:["待选","已选"],render:l=>`[${l.title}]`},null,8,["target-keys","data-source","render"]))}}),Pe=`<template>
  <Transfer
...
<\/script>
`,Be={style:{"margin-top":"12px",color:"rgba(0, 0, 0, 0.45)","font-size":"12px"}},Fe=P({__name:"TransferDraggable",setup(t){const r=Array.from({length:8},(n,l)=>({key:String(l),title:`Item ${l+1}`})),c=w(["0","1","2","3"]);function y(n){console.log("reorder",n)}return(n,l)=>(j(),ye(le,null,[o(h(M),{"target-keys":c.value,"onUpdate:targetKeys":l[0]||(l[0]=x=>c.value=x),"data-source":h(r),titles:["源","目标（可拖拽排序）"],draggable:"",onReorder:y},null,8,["target-keys","data-source"]),m("p",Be," 当前顺序："+Ie(c.value.join(", ")||"（空）"),1)],64))}}),je=`<template>
  <Transfer
    v-model:target-keys="targetKeys"
    :data-source="dataSource"
    :titles="['源', '目标（可拖拽排序）']"
...
<\/script>
`,ze=P({__name:"TransferOneWay",setup(t){const r=Array.from({length:10},(y,n)=>({key:String(n),title:`Item ${n+1}`})),c=w(["1","3"]);return(y,n)=>(j(),q(h(M),{"target-keys":c.value,"onUpdate:targetKeys":n[0]||(n[0]=l=>c.value=l),"data-source":h(r),titles:["源","目标"],"one-way":""},null,8,["target-keys","data-source"]))}}),Ue=`<template>
...
const targetKeys = ref<string[]>(['1', '3'])
<\/script>
`,Ve=P({__name:"TransferPagination",setup(t){const r=Array.from({length:20},(y,n)=>({key:String(n),title:`选项 ${n+1}`})),c=w(["2","5","8"]);return(y,n)=>(j(),q(h(M),{"target-keys":c.value,"onUpdate:targetKeys":n[0]||(n[0]=l=>c.value=l),"data-source":h(r),titles:["源","目标"],pagination:{pageSize:5}},null,8,["target-keys","data-source"]))}}),Ee=`<template>
  <Transfer
    v-model:target-keys="targetKeys"
    :data-source="dataSource"
    :titles="['源', '目标']"
...
<\/script>
`,Me=P({__name:"TransferSearch",setup(t){const r=Array.from({length:20},(y,n)=>({key:String(n),title:`选项 ${n+1}`,description:`描述 ${n+1}`,disabled:n%8===3})),c=w(["1","3","5"]);return(y,n)=>(j(),q(h(M),{"target-keys":c.value,"onUpdate:targetKeys":n[0]||(n[0]=l=>c.value=l),"data-source":h(r),titles:["待选","已选"],"show-search":""},null,8,["target-keys","data-source"]))}}),We=`<template>
  <Transfer v-model:target-keys="targetKeys" :data-source="dataSource" :titles="['待选', '已选']" show-search />
</template>
