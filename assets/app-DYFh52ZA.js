import{B as i}from"./Button-dLk1ExkL.js";import{S as b}from"./Space-Dz5A7DSP.js";import{n as f}from"./notification-CVN_C2ed.js";import{m as h}from"./message-CX2vPvK8.js";import{p as _,n as r,m as d,r as y,F as C,H as M,A as x,z as A,h as B,Q as g,J as l,o as c,G as P,j as S,k as m}from"./index-DBrYVvYd.js";import{M as N}from"./index-IiPbcZAK.js";import"./icons-CTzpiRs0.js";import"./cls-S9IiI6wd.js";import"./Icon-CiCvy_Uq.js";import"./index-DLUhhIBQ.js";const p=()=>{},v={confirm:p,info:p,success:p,warning:p,error:p},k=Symbol("App"),I={message:h,notification:f,modal:v};function j(){return _(k,I)}const D=r({name:"App",setup(u,{slots:e}){const o=M({open:!1,type:"info",props:{}});function n(t,a){o.type=t,o.props=a,o.open=!0}return x(k,{message:h,notification:f,modal:{confirm:t=>n("confirm",t),info:t=>n("info",t),success:t=>n("success",t),warning:t=>n("warning",t),error:t=>n("error",t)}}),()=>{var t;return d(C,null,[(t=e.default)==null?void 0:t.call(e),d(N,y({open:o.open},o.props,{"onUpdate:open":a=>{o.open=a},onCancel:()=>{o.open=!1}}),null)])}}}),E=r({__name:"AppBasic",setup(u){const e=r({setup(){const{message:o,notification:n,modal:s}=j();function t(){o.success("操作成功！")}function a(){n.info({message:"系统通知",description:"这是通过 useApp() 触发的通知。"})}function w(){s.info({title:"提示",content:"这是通过 useApp() 触发的对话框。"})}return()=>c(b,null,{default:()=>[c(i,{type:"primary",onClick:t},{default:()=>"Message"}),c(i,{onClick:a},{default:()=>"Notification"}),c(i,{onClick:w},{default:()=>"Modal"})]})}});return(o,n)=>(A(),B(l(D),null,{default:g(()=>[d(l(e))]),_:1}))}}),F=`<template>
  <App>
    <AppActions />
  </App>
</template>
