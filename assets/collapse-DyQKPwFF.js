...
<\/script>
`,De=E({__name:"CollapseCustomIcon",setup(e){const s=[{key:"1",label:"自定义展开图标 1",children:"这是面板内容 1"},{key:"2",label:"自定义展开图标 2",children:"这是面板内容 2"},{key:"3",label:"自定义展开图标 3",children:"这是面板内容 3"}],l=({isActive:n})=>ve(Ce,{class:"hmfw-icon",style:{transform:n?"rotate(0deg)":"rotate(-90deg)",transition:"transform 0.3s"}});return(n,a)=>($(),j(d(k),{"default-active-key":["1"],"expand-icon":l,items:s}))}}),Oe=`<template>
...
<\/script>
`,Le=E({__name:"CollapseExtra",setup(e){const s=[{key:"1",label:"面板标题 1",children:"这是面板内容 1",extra:"额外内容"},{key:"2",label:"面板标题 2",children:"这是面板内容 2",extra:"更多"},{key:"3",label:"面板标题 3",children:"这是面板内容 3",showArrow:!1}];return(l,n)=>($(),j(d(k),{"default-active-key":["1"],items:s}))}}),je=`<template>
...
<\/script>
`,Fe={style:{display:"flex","flex-direction":"column",gap:"16px"}},Ve=E({__name:"CollapseSize",setup(e){const s=[{key:"1",label:"面板标题",children:"这是面板内容"}];return(l,n)=>($(),M("div",Fe,[t(d(k),{items:s,size:"small"}),t(d(k),{items:s,size:"middle"}),t(d(k),{items:s,size:"large"})]))}}),He=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px">
