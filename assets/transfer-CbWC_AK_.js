...
<\/script>
`,Ne=P({__name:"TransferCustom",setup(t){const r=Array.from({length:10},(y,n)=>({key:String(n),title:`选项 ${n+1}`})),c=w(["1","3"]);return(y,n)=>(j(),q(h(M),{"data-source":h(r),"target-keys":c.value,"onUpdate:targetKeys":n[0]||(n[0]=l=>c.value=l),titles:["待选","已选"],render:l=>`[${l.title}]`},null,8,["data-source","target-keys","render"]))}}),Pe=`<template>
  <Transfer
    :data-source="dataSource"
    v-model:target-keys="targetKeys"
    :titles="['待选', '已选']"
...
<\/script>
`,ze=P({__name:"TransferOneWay",setup(t){const r=Array.from({length:10},(y,n)=>({key:String(n),title:`Item ${n+1}`})),c=w(["1","3"]);return(y,n)=>(j(),q(h(M),{"data-source":h(r),"target-keys":c.value,"onUpdate:targetKeys":n[0]||(n[0]=l=>c.value=l),titles:["源","目标"],"one-way":""},null,8,["data-source","target-keys"]))}}),Ue=`<template>
  <Transfer
    :data-source="dataSource"
    v-model:target-keys="targetKeys"
    :titles="['源', '目标']"
...
const targetKeys = ref<string[]>(['1', '3'])
<\/script>
`,Ve=P({__name:"TransferPagination",setup(t){const r=Array.from({length:20},(y,n)=>({key:String(n),title:`选项 ${n+1}`})),c=w(["2","5","8"]);return(y,n)=>(j(),q(h(M),{"data-source":h(r),"target-keys":c.value,"onUpdate:targetKeys":n[0]||(n[0]=l=>c.value=l),titles:["源","目标"],pagination:{pageSize:5}},null,8,["data-source","target-keys"]))}}),Ee=`<template>
  <Transfer
    :data-source="dataSource"
    v-model:target-keys="targetKeys"
    :titles="['源', '目标']"
...
<\/script>
`,Me=P({__name:"TransferSearch",setup(t){const r=Array.from({length:20},(y,n)=>({key:String(n),title:`选项 ${n+1}`,description:`描述 ${n+1}`,disabled:n%8===3})),c=w(["1","3","5"]);return(y,n)=>(j(),q(h(M),{"data-source":h(r),"target-keys":c.value,"onUpdate:targetKeys":n[0]||(n[0]=l=>c.value=l),titles:["待选","已选"],"show-search":""},null,8,["data-source","target-keys"]))}}),We=`<template>
  <Transfer
    :data-source="dataSource"
    v-model:target-keys="targetKeys"
    :titles="['待选', '已选']"
