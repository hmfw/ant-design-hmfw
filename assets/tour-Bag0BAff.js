import{B}from"./Button-Dr1TfEzc.js";import{S as bt}from"./Space-BxpGTspH.js";import{o as j,N as wt,E as b,Q as A,x as St,w as qt,p as i,T as Bt,f as $,t as Nt,r as Tt,A as D,k as L,n as d,K as m,R as x,m as y,h as e,_ as Ct,H as Pt,l as It}from"./index-Dxep-jrR.js";import{c as v}from"./cls-S9IiI6wd.js";import{C as Ot}from"./CloseOutlined-Cg7mwYr0.js";import{I as $t}from"./Icon-DATzad6v.js";import"./LoadingOutlined-CKq07YS5.js";function vt(t){return t?typeof t=="function"?t():document.querySelector(t):null}function Vt(t){if(!t)return null;const o=t.getBoundingClientRect();return{top:o.top+window.scrollY,left:o.left+window.scrollX,width:o.width,height:o.height}}function zt(t,o,s="bottom",f=12){if(!t||!o)return{top:100,left:100};const n=o.offsetWidth||300,u=o.offsetHeight||200,w=t.left+t.width/2,h=t.top+t.height/2;if(s.startsWith("bottom")){const r=t.top+t.height+f,c=s==="bottom"?w-n/2:s==="bottomLeft"?t.left:t.left+t.width-n;return{top:r,left:c}}if(s.startsWith("top")){const r=t.top-u-f,c=s==="top"?w-n/2:s==="topLeft"?t.left:t.left+t.width-n;return{top:r,left:c}}if(s.startsWith("right")){const r=t.left+t.width+f;return{top:s==="right"?h-u/2:s==="rightTop"?t.top:t.top+t.height-u,left:r}}if(s.startsWith("left")){const r=t.left-n-f;return{top:s==="left"?h-u/2:s==="leftTop"?t.top:t.top+t.height-u,left:r}}return{top:t.top+t.height+f,left:w-n/2}}function F(t){return t==null?null:typeof t=="function"?t():Tt(t)?t:String(t)}const T=j({name:"Tour",props:{open:{type:Boolean,default:void 0},defaultOpen:{type:Boolean,default:!1},current:{type:Number,default:void 0},defaultCurrent:{type:Number,default:0},steps:{type:Array,default:()=>[]},arrow:{type:[Boolean,Object],default:!0},placement:{type:String,default:void 0},mask:{type:[Boolean,Object],default:!0},type:{type:String,default:"default"},scrollIntoViewOptions:{type:[Boolean,Object],default:!0},zIndex:{type:Number,default:1001},gap:{type:Object,default:void 0},indicatorsRender:{type:Function,default:void 0},closeIcon:{type:[Object,Function,Boolean],default:void 0},classNames:{type:Object,default:void 0},styles:{type:Object,default:void 0}},emits:["update:open","update:current","change","close","finish"],setup(t,{emit:o}){const s=wt("tour"),f=b(t.defaultOpen),n=b(t.defaultCurrent),u=b(null),w=b({top:100,left:100}),h=b(null),r=$(()=>t.open!==void 0?t.open:f.value),c=$(()=>t.current!==void 0?t.current:n.value),l=$(()=>t.steps[c.value]??null),P=$(()=>t.steps.length),I=$(()=>{var q;const p=(q=l.value)==null?void 0:q.mask;return p!==void 0?p:t.mask}),a=$(()=>{var p;return((p=l.value)==null?void 0:p.type)??t.type});A(()=>t.open,p=>{p!==void 0&&(f.value=p)}),A(()=>t.current,p=>{p!==void 0&&(n.value=p)});async function g(){var C;const p=l.value?vt(l.value.target):null;if(!p)return;const q=((C=l.value)==null?void 0:C.scrollIntoViewOptions)??t.scrollIntoViewOptions??!0;if(q){const z=typeof q=="boolean"?{block:"center",behavior:"smooth"}:q;p.scrollIntoView(z)}}async function V(){var q,C;await Nt();const p=l.value?vt(l.value.target):null;if(h.value=Vt(p),u.value){const z=((q=l.value)==null?void 0:q.placement)??t.placement??"bottom",O=((C=t.gap)==null?void 0:C.offset)??12,E=typeof O=="number"?O:O[0];w.value=zt(h.value,u.value,z,E)}}A([r,c],async([p])=>{p&&(await g(),await V())},{immediate:!0}),St(()=>{window.addEventListener("resize",V),window.addEventListener("scroll",V,!0)}),qt(()=>{window.removeEventListener("resize",V),window.removeEventListener("scroll",V,!0)});function M(){f.value=!1,o("update:open",!1),o("close")}function U(p){n.value=p,o("update:current",p),o("change",p)}function yt(){c.value>0&&U(c.value-1)}function ht(){c.value<P.value-1?U(c.value+1):(M(),o("finish"))}const xt=()=>t.closeIcon===!1?null:t.closeIcon===void 0?i($t,{component:Ot}):typeof t.closeIcon=="function"?t.closeIcon():t.closeIcon;return()=>{var W,H,X,K,Q,Y,G,J,Z,R,_,tt,nt,st,at,ot,et,pt,lt,rt,ct,it,dt,ut,mt,kt,ft;if(!r.value||!l.value)return null;const p=a.value==="primary",q=c.value===P.value-1,C=I.value!==!1,z=typeof I.value=="object"?I.value.style:void 0,O=typeof I.value=="object"?I.value.color:"rgba(0,0,0,0.45)",E=xt();return i(Bt,{to:"body"},[i("div",{class:v(`${s}-root`,(W=t.classNames)==null?void 0:W.root),style:{zIndex:t.zIndex,...(H=t.styles)==null?void 0:H.root}},[C&&i("div",{class:v(`${s}-mask`,(X=t.classNames)==null?void 0:X.mask),style:{...z,...(K=t.styles)==null?void 0:K.mask}},[h.value?i("svg",{class:`${s}-mask-svg`,width:"100%",height:"100%"},[i("defs",[i("mask",{id:"tour-mask"},[i("rect",{width:"100%",height:"100%",fill:"white"}),i("rect",{x:h.value.left-4,y:h.value.top-4,width:h.value.width+8,height:h.value.height+8,rx:((Q=t.gap)==null?void 0:Q.radius)??4,fill:"black"})])]),i("rect",{width:"100%",height:"100%",fill:O,mask:"url(#tour-mask)"})]):i("div",{class:`${s}-mask-fill`,style:{background:O}})]),i("div",{ref:u,class:v(`${s}-popover`,{[`${s}-popover-primary`]:p},l.value.className,(Y=t.classNames)==null?void 0:Y.popover),style:{position:"absolute",top:`${w.value.top}px`,left:`${w.value.left}px`,zIndex:t.zIndex+1,...l.value.style,...(G=t.styles)==null?void 0:G.popover}},[i("div",{class:v(`${s}-popover-inner`,(J=t.classNames)==null?void 0:J.popoverInner),style:(Z=t.styles)==null?void 0:Z.popoverInner},[E!==null&&i("button",{type:"button",class:v(`${s}-close`,(R=t.classNames)==null?void 0:R.close),style:(_=t.styles)==null?void 0:_.close,onClick:M,"aria-label":"Close"},[E]),l.value.cover&&i("div",{class:v(`${s}-cover`,(tt=t.classNames)==null?void 0:tt.cover),style:(nt=t.styles)==null?void 0:nt.cover},[typeof l.value.cover=="string"?i("img",{src:l.value.cover,alt:""}):F(l.value.cover)]),l.value.title&&i("div",{class:v(`${s}-title`,(st=t.classNames)==null?void 0:st.title),style:(at=t.styles)==null?void 0:at.title},[F(l.value.title)]),l.value.description&&i("div",{class:v(`${s}-description`,(ot=t.classNames)==null?void 0:ot.description),style:(et=t.styles)==null?void 0:et.description},[F(l.value.description)]),i("div",{class:v(`${s}-footer`,(pt=t.classNames)==null?void 0:pt.footer),style:(lt=t.styles)==null?void 0:lt.footer},[P.value>1&&i("div",{class:v(`${s}-indicators`,(rt=t.classNames)==null?void 0:rt.indicators),style:(ct=t.styles)==null?void 0:ct.indicators},[t.indicatorsRender?t.indicatorsRender(c.value,P.value):t.steps.map((S,k)=>{var N,gt;return i("span",{key:k,class:v(`${s}-indicator`,{[`${s}-indicator-active`]:k===c.value},(N=t.classNames)==null?void 0:N.indicator),style:(gt=t.styles)==null?void 0:gt.indicator,onClick:()=>U(k)})})]),i("div",{class:v(`${s}-buttons`,(it=t.classNames)==null?void 0:it.buttons),style:(dt=t.styles)==null?void 0:dt.buttons},[c.value>0&&i(B,{size:"small",type:"default",ghost:p,class:v(`${s}-prev-btn`,(ut=t.classNames)==null?void 0:ut.prevBtn),style:(mt=t.styles)==null?void 0:mt.prevBtn,onClick:()=>{var S,k,N;(N=(k=(S=l.value)==null?void 0:S.prevButtonProps)==null?void 0:k.onClick)==null||N.call(k),yt()},...l.value.prevButtonProps},{default:()=>{var S,k;return((k=(S=l.value)==null?void 0:S.prevButtonProps)==null?void 0:k.children)??"上一步"}}),i(B,{size:"small",type:p?"default":"primary",ghost:p,class:v(`${s}-next-btn`,(kt=t.classNames)==null?void 0:kt.nextBtn),style:(ft=t.styles)==null?void 0:ft.nextBtn,onClick:()=>{var S,k,N;(N=(k=(S=l.value)==null?void 0:S.nextButtonProps)==null?void 0:k.onClick)==null||N.call(k),ht()},...l.value.nextButtonProps},{default:()=>{var S,k;return((k=(S=l.value)==null?void 0:S.nextButtonProps)==null?void 0:k.children)??(q?"完成":"下一步")}})])])])])])])}}}),Et=j({__name:"TourBasic",setup(t){const o=b(!1),s=[{title:"第一步",description:"这是漫游引导的第一步，介绍页面的主要功能。"},{title:"第二步",description:"这是第二步，继续介绍其他功能。"},{title:"完成",description:"引导完成！现在你已经了解了所有功能。"}];return(f,n)=>(D(),L("div",null,[d(m(bt),null,{default:x(()=>[d(m(B),{ref:"btnRef",type:"primary",onClick:n[0]||(n[0]=u=>o.value=!0)},{default:x(()=>[...n[3]||(n[3]=[y(" 开始引导 ",-1)])]),_:1},512)]),_:1}),d(m(T),{open:o.value,"onUpdate:open":n[1]||(n[1]=u=>o.value=u),steps:s,onFinish:n[2]||(n[2]=u=>o.value=!1)},null,8,["open"])]))}}),jt=`<template>
  <div>
    <Space>
...
<\/script>
`,Dt={style:{display:"flex","flex-direction":"column",gap:"24px"}},Lt=j({__name:"TourClassNames",setup(t){const o=b(!1),s=b(!1),f=b(!1),n=b(!1),u=b(!1),w=b(),h=[{title:"渐变卡片",description:"通过 classNames 自定义卡片背景和遮罩颜色"}],r=[{title:"自定义文字",description:"可以对标题、描述、关闭按钮分别应用不同样式",target:()=>w.value||null}],c=[{title:"第一步",description:"这是多步骤引导的第一步"},{title:"第二步",description:"这是多步骤引导的第二步"},{title:"第三步",description:"这是多步骤引导的第三步"}],l=[{title:"内联样式",description:"通过 styles 属性应用内联样式，优先级更高"}],P=[{title:"组合样式",description:"classNames 和 styles 可以同时使用，实现更灵活的样式控制"},{title:"完成",description:"所有样式都生效了"}];return(I,a)=>(D(),L("div",Dt,[e("div",null,[a[11]||(a[11]=e("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义遮罩与卡片样式：",-1)),d(m(B),{type:"primary",onClick:a[0]||(a[0]=g=>o.value=!0)},{default:x(()=>[...a[10]||(a[10]=[y("打开渐变卡片引导",-1)])]),_:1}),d(m(T),{open:o.value,"onUpdate:open":a[1]||(a[1]=g=>o.value=g),steps:h,"class-names":{mask:"custom-mask",popover:"custom-popover",popoverInner:"custom-popover-inner"}},null,8,["open"])]),e("div",null,[a[13]||(a[13]=e("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义标题与描述样式：",-1)),d(m(B),{type:"primary",onClick:a[2]||(a[2]=g=>s.value=!0)},{default:x(()=>[...a[12]||(a[12]=[y("打开自定义文字引导",-1)])]),_:1}),e("div",{ref_key:"target2",ref:w,style:{"margin-top":"8px",padding:"16px",border:"1px dashed #d9d9d9","border-radius":"8px"}}," 目标元素 ",512),d(m(T),{open:s.value,"onUpdate:open":a[3]||(a[3]=g=>s.value=g),steps:r,"class-names":{title:"custom-title",description:"custom-description",close:"custom-close"}},null,8,["open"])]),e("div",null,[a[15]||(a[15]=e("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义指示器与按钮样式：",-1)),d(m(B),{type:"primary",onClick:a[4]||(a[4]=g=>f.value=!0)},{default:x(()=>[...a[14]||(a[14]=[y("打开多步骤引导",-1)])]),_:1}),d(m(T),{open:f.value,"onUpdate:open":a[5]||(a[5]=g=>f.value=g),steps:c,"class-names":{indicators:"custom-indicators",indicator:"custom-indicator",buttons:"custom-buttons",prevBtn:"custom-prev-btn",nextBtn:"custom-next-btn"}},null,8,["open"])]),e("div",null,[a[17]||(a[17]=e("div",{style:{"margin-bottom":"8px",color:"#666"}},"使用内联样式：",-1)),d(m(B),{type:"primary",onClick:a[6]||(a[6]=g=>n.value=!0)},{default:x(()=>[...a[16]||(a[16]=[y("打开内联样式引导",-1)])]),_:1}),d(m(T),{open:n.value,"onUpdate:open":a[7]||(a[7]=g=>n.value=g),steps:l,styles:{popoverInner:{borderRadius:"16px",padding:"24px"},title:{color:"#722ed1",fontSize:"18px"},description:{color:"#52c41a",fontSize:"15px"},footer:{marginTop:"20px"}}},null,8,["open"])]),e("div",null,[a[19]||(a[19]=e("div",{style:{"margin-bottom":"8px",color:"#666"}},"组合使用 classNames 与 styles：",-1)),d(m(B),{type:"primary",onClick:a[8]||(a[8]=g=>u.value=!0)},{default:x(()=>[...a[18]||(a[18]=[y("打开组合样式引导",-1)])]),_:1}),d(m(T),{open:u.value,"onUpdate:open":a[9]||(a[9]=g=>u.value=g),steps:P,"class-names":{popoverInner:"gradient-card",indicator:"gradient-indicator"},styles:{title:{fontWeight:"bold"},buttons:{gap:"12px"}}},null,8,["open"])])]))}}),Ut=Ct(Lt,[["__scopeId","data-v-8c5e3721"]]),At=`<template>
...
`,Ft=j({__name:"TourType",setup(t){const o=b(!1),s=b(!1),f=[{title:"默认样式",description:"这是默认样式的引导，白色背景。"},{title:"第二步",description:"继续介绍功能..."}],n=[{title:"主题样式",description:"这是主题样式的引导，蓝色背景。"},{title:"第二步",description:"继续介绍功能..."}];function u(){o.value=!0}function w(){s.value=!0}return(h,r)=>(D(),L("div",null,[d(m(bt),null,{default:x(()=>[d(m(B),{type:"primary",onClick:u},{default:x(()=>[...r[4]||(r[4]=[y(" 默认样式 ",-1)])]),_:1}),d(m(B),{type:"primary",onClick:w},{default:x(()=>[...r[5]||(r[5]=[y(" 主题样式 ",-1)])]),_:1})]),_:1}),d(m(T),{open:o.value,"onUpdate:open":r[0]||(r[0]=c=>o.value=c),steps:f,onFinish:r[1]||(r[1]=c=>o.value=!1)},null,8,["open"]),d(m(T),{open:s.value,"onUpdate:open":r[2]||(r[2]=c=>s.value=c),type:"primary",steps:n,onFinish:r[3]||(r[3]=c=>s.value=!1)},null,8,["open"])]))}}),Mt=`<template>
  <div>
    <Space>
