import{B as s}from"./Button-DijKNe_E.js";import{n as m,z as p,j as u,m as n,J as e,Q as l,l as o,_ as b,g as i,D as x,I as _,G as v,k as g}from"./index-BIkAb7lZ.js";import{ab as f,m as k,p as D,v as B}from"./icons-DLCoPw-s.js";import"./cls-S9IiI6wd.js";import"./Icon-DOjVoSFw.js";const h={style:{display:"flex",gap:"8px","flex-wrap":"wrap"}},w=m({__name:"ButtonBasic",setup(y){return(a,t)=>(p(),u("div",h,[n(e(s),{type:"primary"},{default:l(()=>[...t[0]||(t[0]=[o("Primary Button",-1)])]),_:1}),n(e(s),null,{default:l(()=>[...t[1]||(t[1]=[o("Default Button",-1)])]),_:1}),n(e(s),{type:"dashed"},{default:l(()=>[...t[2]||(t[2]=[o("Dashed Button",-1)])]),_:1}),n(e(s),{type:"text"},{default:l(()=>[...t[3]||(t[3]=[o("Text Button",-1)])]),_:1}),n(e(s),{type:"link"},{default:l(()=>[...t[4]||(t[4]=[o("Link Button",-1)])]),_:1})]))}}),S=`<template>
...
<\/script>
`,C={style:{display:"flex","flex-direction":"column",gap:"8px"}},$=m({__name:"ButtonBlock",setup(y){return(a,t)=>(p(),u("div",C,[n(e(s),{type:"primary",block:""},{default:l(()=>[...t[0]||(t[0]=[o("Primary Block",-1)])]),_:1}),n(e(s),{block:""},{default:l(()=>[...t[1]||(t[1]=[o("Default Block",-1)])]),_:1}),n(e(s),{type:"dashed",block:""},{default:l(()=>[...t[2]||(t[2]=[o("Dashed Block",-1)])]),_:1})]))}}),L=`<template>
...
import { Button } from 'ant-design-hmfw'
<\/script>
`,O={style:{display:"flex",gap:"12px","flex-wrap":"wrap"}},P=m({__name:"ButtonClassNames",setup(y){return(a,t)=>(p(),u("div",O,[n(e(s),{type:"primary",icon:e(f),"class-names":{icon:"demo-tinted-icon"},styles:{icon:{color:"#fadb14"}}},{default:l(()=>[...t[0]||(t[0]=[o(" 自定义图标颜色 ",-1)])]),_:1},8,["icon"]),n(e(s),{icon:e(f),"icon-position":"end",styles:{root:{borderColor:"#722ed1",color:"#722ed1"}}},{default:l(()=>[...t[1]||(t[1]=[o(" 尾部图标 + 自定义边框 ",-1)])]),_:1},8,["icon"]),n(e(s),{loading:"","class-names":{loading:"demo-loading-emphasis"}},{default:l(()=>[...t[2]||(t[2]=[o(" 加载中 ",-1)])]),_:1})]))}}),z=b(P,[["__scopeId","data-v-1929d2bc"]]),G=`<template>
...
`,N={style:{display:"flex",gap:"8px","flex-wrap":"wrap"}},T=m({__name:"ButtonDanger",setup(y){return(a,t)=>(p(),u("div",N,[n(e(s),{type:"primary",danger:""},{default:l(()=>[...t[0]||(t[0]=[o("Primary Danger",-1)])]),_:1}),n(e(s),{danger:""},{default:l(()=>[...t[1]||(t[1]=[o("Default Danger",-1)])]),_:1}),n(e(s),{type:"text",danger:""},{default:l(()=>[...t[2]||(t[2]=[o("Text Danger",-1)])]),_:1}),n(e(s),{type:"link",danger:""},{default:l(()=>[...t[3]||(t[3]=[o("Link Danger",-1)])]),_:1})]))}}),I=`<template>
  <div style="display: flex; gap: 8px; flex-wrap: wrap;">
...
import { Button } from 'ant-design-hmfw'
<\/script>
`,V={style:{display:"flex",gap:"8px","flex-wrap":"wrap"}},A=m({__name:"ButtonDisabled",setup(y){return(a,t)=>(p(),u("div",V,[n(e(s),{type:"primary",disabled:""},{default:l(()=>[...t[0]||(t[0]=[o("Primary Disabled",-1)])]),_:1}),n(e(s),{disabled:""},{default:l(()=>[...t[1]||(t[1]=[o("Default Disabled",-1)])]),_:1}),n(e(s),{type:"dashed",disabled:""},{default:l(()=>[...t[2]||(t[2]=[o("Dashed Disabled",-1)])]),_:1}),n(e(s),{type:"text",disabled:""},{default:l(()=>[...t[3]||(t[3]=[o("Text Disabled",-1)])]),_:1}),n(e(s),{type:"link",disabled:""},{default:l(()=>[...t[4]||(t[4]=[o("Link Disabled",-1)])]),_:1})]))}}),E=`<template>
  <div style="display: flex; gap: 8px; flex-wrap: wrap;">
...
import { Button } from 'ant-design-hmfw'
<\/script>
`,M={style:{padding:"16px",background:"#1677ff"}},H={style:{display:"flex",gap:"8px","flex-wrap":"wrap"}},R=m({__name:"ButtonGhost",setup(y){return(a,t)=>(p(),u("div",M,[i("div",H,[n(e(s),{type:"primary",ghost:""},{default:l(()=>[...t[0]||(t[0]=[o("Primary Ghost",-1)])]),_:1}),n(e(s),{ghost:""},{default:l(()=>[...t[1]||(t[1]=[o("Default Ghost",-1)])]),_:1}),n(e(s),{type:"dashed",ghost:""},{default:l(()=>[...t[2]||(t[2]=[o("Dashed Ghost",-1)])]),_:1})])]))}}),j=`<template>
...
import { Button } from 'ant-design-hmfw'
<\/script>
`,J={style:{display:"flex","flex-direction":"column",gap:"16px"}},Q={style:{display:"flex",gap:"8px"}},q={style:{display:"flex",gap:"8px"}},F=m({__name:"ButtonHref",setup(y){return(a,t)=>(p(),u("div",J,[i("div",Q,[n(e(s),{type:"primary",href:"https://ant.design",target:"_blank"},{default:l(()=>[...t[0]||(t[0]=[o("Link Button",-1)])]),_:1}),n(e(s),{type:"link",href:"https://ant.design",target:"_blank"},{default:l(()=>[...t[1]||(t[1]=[o("Link Type",-1)])]),_:1})]),i("div",q,[n(e(s),{type:"primary",href:"https://ant.design",disabled:""},{default:l(()=>[...t[2]||(t[2]=[o("Disabled Link",-1)])]),_:1})])]))}}),K=`<template>
...
<\/script>
`,U={style:{display:"flex",gap:"8px","flex-wrap":"wrap"}},W=m({__name:"ButtonIcon",setup(y){return(a,t)=>(p(),u("div",U,[n(e(s),{type:"primary",icon:e(f)},{default:l(()=>[...t[0]||(t[0]=[o("Search",-1)])]),_:1},8,["icon"]),n(e(s),{type:"primary",icon:e(f)},null,8,["icon"]),n(e(s),{type:"primary",icon:e(k)},{default:l(()=>[...t[1]||(t[1]=[o("Confirm",-1)])]),_:1},8,["icon"]),n(e(s),{type:"dashed",icon:e(D)},{default:l(()=>[...t[2]||(t[2]=[o("Cancel",-1)])]),_:1},8,["icon"])]))}}),X=`<template>
  <div style="display: flex; gap: 8px; flex-wrap: wrap;">
...
<\/script>
`,Y={style:{display:"flex","flex-direction":"column",gap:"16px"}},Z={style:{display:"flex",gap:"8px"}},tt={style:{display:"flex",gap:"8px"}},nt=m({__name:"ButtonIconPosition",setup(y){return(a,t)=>(p(),u("div",Y,[i("div",Z,[n(e(s),{type:"primary",icon:e(f)},{default:l(()=>[...t[0]||(t[0]=[o("Search",-1)])]),_:1},8,["icon"]),n(e(s),{type:"primary",icon:e(f),"icon-position":"end"},{default:l(()=>[...t[1]||(t[1]=[o("Search",-1)])]),_:1},8,["icon"])]),i("div",tt,[n(e(s),{type:"default",icon:e(B)},{default:l(()=>[...t[2]||(t[2]=[o("Download",-1)])]),_:1},8,["icon"]),n(e(s),{type:"default",icon:e(B),"icon-position":"end"},{default:l(()=>[...t[3]||(t[3]=[o("Download",-1)])]),_:1},8,["icon"])])]))}}),et=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px;">
    <div style="display: flex; gap: 8px;">
      <Button type="primary" :icon="SearchOutlined">Search</Button>
...
<\/script>
`,it={style:{display:"flex","flex-direction":"column",gap:"16px"}},st={style:{display:"flex",gap:"8px"}},at=m({__name:"ButtonLoadingDelay",setup(y){const a=x(!1),t=()=>{console.log("Button clicked")},c=()=>{a.value=!a.value};return(d,r)=>(p(),u("div",it,[i("div",st,[n(e(s),{type:"primary",loading:{delay:500},onClick:t},{default:l(()=>[...r[0]||(r[0]=[o(" Click me (500ms delay) ",-1)])]),_:1}),n(e(s),{type:"primary",loading:a.value,onClick:c},{default:l(()=>[o(_(a.value?"Loading...":"Click to load"),1)]),_:1},8,["loading"])])]))}}),rt=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px;">
    <div style="display: flex; gap: 8px;">
...
<\/script>
`,pt={style:{display:"flex",gap:"8px","align-items":"center"}},ut=m({__name:"ButtonShape",setup(y){return(a,t)=>(p(),u("div",pt,[n(e(s),{type:"primary",shape:"circle",icon:e(f)},null,8,["icon"]),n(e(s),{type:"primary",shape:"circle"},{default:l(()=>[...t[0]||(t[0]=[o("A",-1)])]),_:1}),n(e(s),{type:"primary",shape:"round"},{default:l(()=>[...t[1]||(t[1]=[o("Round",-1)])]),_:1}),n(e(s),{type:"primary"},{default:l(()=>[...t[2]||(t[2]=[o("Default",-1)])]),_:1})]))}}),yt=`<template>
...
<\/script>
`,mt={style:{display:"flex",gap:"8px","align-items":"center"}},ft=m({__name:"ButtonSize",setup(y){return(a,t)=>(p(),u("div",mt,[n(e(s),{type:"primary",size:"large"},{default:l(()=>[...t[0]||(t[0]=[o("Large",-1)])]),_:1}),n(e(s),{type:"primary"},{default:l(()=>[...t[1]||(t[1]=[o("Middle",-1)])]),_:1}),n(e(s),{type:"primary",size:"small"},{default:l(()=>[...t[2]||(t[2]=[o("Small",-1)])]),_:1})]))}}),ct=`<template>
  <div style="display: flex; gap: 8px; align-items: center;">
