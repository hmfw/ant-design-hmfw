import{m,L as E,l as t,B as F,d as f,y as g,i as y,I as r,E as P,f as d,P as b,k as x,j as L}from"./index-BQisgCTe.js";import{c as M,g as q,k as z,C as G,d as H}from"./icons-Buy98oKP.js";import{c as J}from"./cls-S9IiI6wd.js";const K={success:G,info:z,warning:q,error:M};function h(n){return Object.prototype.toString.call(n)==="[object Object]"}const s=m({name:"Alert",props:{type:{type:String,default:void 0},variant:{type:String,default:"outlined"},title:String,message:String,description:String,showIcon:{type:Boolean,default:void 0},closable:{type:[Boolean,Object],default:void 0},closeText:[String,Object,Array,Function],closeIcon:[String,Object,Array,Function],icon:[String,Object,Array,Function],banner:Boolean,action:[String,Object,Array,Function],role:{type:String,default:"alert"}},emits:["close","afterClose"],setup(n,{slots:o,emit:c}){const i=E("alert"),e=F(!1),u=F(!1),B=f(()=>n.type!==void 0?n.type:n.banner?"warning":"info"),w=f(()=>n.banner&&n.showIcon===void 0?!0:!!n.showIcon),N=f(()=>n.title??n.message),j=f(()=>{const{closable:l,closeText:a,closeIcon:p}=n;return h(l)||a!=null&&a!==""?!0:typeof l=="boolean"?l:p!=null}),T=f(()=>{const{closable:l,closeText:a,closeIcon:p}=n;if(h(l)&&l.closeIcon!=null)return l.closeIcon;if(a!=null&&a!=="")return a;if(p!=null)return p;if(o.closeIcon)return o.closeIcon()}),k=f(()=>{const{closable:l}=n;return h(l)&&typeof l["aria-label"]=="string"?l["aria-label"]:"关闭"}),O=l=>{u.value=!0,c("close",l),setTimeout(()=>{e.value=!0,c("afterClose")},300)};return()=>{var _,C,$,I,S;if(e.value)return null;const l=B.value,a=!!(n.description||o.description),p=K[l],V=n.icon??((_=o.icon)==null?void 0:_.call(o))??t(p,null,null),D=T.value??t(H,null,null),v=((C=o.message)==null?void 0:C.call(o))??(($=o.title)==null?void 0:$.call(o))??N.value,A=n.action??((I=o.action)==null?void 0:I.call(o));return t("div",{role:n.role,"aria-live":l==="error"||l==="warning"?"assertive":"polite","data-show":!e.value,class:J(i,`${i}-${l}`,`${i}-${n.variant}`,{[`${i}-with-description`]:a,[`${i}-banner`]:n.banner,[`${i}-closing`]:u.value,[`${i}-no-icon`]:!w.value})},[w.value&&t("span",{class:`${i}-icon`},[V]),t("div",{class:`${i}-section`},[v!=null&&v!==""&&t("div",{class:`${i}-title`},[v]),a&&t("div",{class:`${i}-description`},[((S=o.description)==null?void 0:S.call(o))??n.description])]),A!=null&&t("div",{class:`${i}-actions`},[A]),j.value&&t("button",{type:"button",tabindex:0,class:`${i}-close-icon`,"aria-label":k.value,onClick:O},[D])])}}}),Q={style:{display:"flex","flex-direction":"column",gap:"12px"}},R=m({__name:"AlertBanner",setup(n){return(o,c)=>(g(),y("div",Q,[t(r(s),{banner:"",message:"顶部公告：banner 模式默认显示图标，类型默认为 warning。"}),t(r(s),{banner:"",type:"error",message:"错误公告"})]))}}),U=`<template>
