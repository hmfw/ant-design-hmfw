import{k as a,l as t,A as p}from"./index-0wAKNcUB.js";const e={class:"markdown-body"},r={__name:"getting-started",setup(o,{expose:s}){return s({frontmatter:{}}),(l,n)=>(p(),a("div",e,[...n[0]||(n[0]=[t(`<h1 id="快速上手" tabindex="-1">快速上手</h1><h2 id="安装" tabindex="-1">安装</h2><pre class="language-bash"><code class="language-bash"><span class="token function">npm</span> <span class="token function">install</span> ant-design-hmfw
