import{d as y,x as H,u as R,r as T,k as M,y as $,c as l,T as L,a as D,o as u,b as m,f as c,F as N,z as C,A as _,e as p,_ as O,w as h,h as z,i as F,g as w}from"./index-DZWA4HiS.js";import{c as B}from"./cls-S9IiI6wd.js";import{U as P}from"./UpOutlined-DvPWHlLA.js";function j(t){let e=null;const a=function(...s){e===null&&(e=requestAnimationFrame(()=>{t.apply(this,s),e=null}))};return a.cancel=()=>{e!==null&&(cancelAnimationFrame(e),e=null)},a}function A(t){return typeof window>"u"||!t?0:t===window||t.window===t?t.pageYOffset:t instanceof Document?t.documentElement.scrollTop:t instanceof HTMLElement?t.scrollTop:0}function I(t,e,a,s){const n=a-e;return t/=s/2,t<1?n/2*t*t*t+e:(t-=2,n/2*(t*t*t+2)+e)}function V(t,e={}){const{getContainer:a=()=>window,duration:s=450,callback:n}=e,i=a(),x=A(i),f=Date.now();let r;const v=()=>{const k=Date.now()-f,b=I(k>s?s:k,x,t,s);i===window||i.window===i?i.scrollTo(window.pageXOffset,b):i instanceof Document?i.documentElement.scrollTop=b:i instanceof HTMLElement&&(i.scrollTop=b),k<s?r=requestAnimationFrame(v):n&&n()};return r=requestAnimationFrame(v),()=>{cancelAnimationFrame(r)}}const g=y({name:"BackTop",props:{visibilityHeight:{type:Number,default:400},target:Function,duration:{type:Number,default:450},className:String,rootClassName:String,style:[String,Object],prefixCls:String,classNames:Object,styles:Object},emits:["click"],setup(t,{slots:e,emit:a}){const s=H(),n=t.prefixCls||R("back-top"),i=T(t.visibilityHeight===0),x=T(),f=()=>{var o;return((o=x.value)==null?void 0:o.ownerDocument)||window},r=j(o=>{const d=A(o.target);i.value=d>=t.visibilityHeight}),v=o=>{const d=t.target||f;V(0,{getContainer:d,duration:t.duration}),a("click",o)};M(()=>{const d=(t.target||f)();r({target:d}),d==null||d.addEventListener("scroll",r)}),$(()=>{const d=(t.target||f)();r.cancel(),d==null||d.removeEventListener("scroll",r)});const S=D(()=>{var o;return B(n,{[`${n}-rtl`]:s.value.direction==="rtl"},t.className,t.rootClassName,(o=t.classNames)==null?void 0:o.root)}),k=D(()=>{var d;const o=(d=t.styles)==null?void 0:d.root;return o?typeof t.style=="string"?o:{...t.style,...o}:t.style}),b=()=>{var o,d,E,q;return l("div",{class:B(`${n}-content`,(o=t.classNames)==null?void 0:o.content),style:(d=t.styles)==null?void 0:d.content},[l("div",{class:B(`${n}-icon`,(E=t.classNames)==null?void 0:E.icon),style:(q=t.styles)==null?void 0:q.icon},[l(P,{class:"hmfw-icon"},null)])])};return()=>l("div",{ref:x,class:S.value,style:k.value,onClick:v},[l(L,{name:"hmfw-fade"},{default:()=>{var o;return[i.value&&(((o=e.default)==null?void 0:o.call(e))||b())]}})])}}),U={style:{height:"1500px",padding:"20px",background:"linear-gradient(to bottom, #fff, #f0f0f0)"}},Y=y({__name:"BackTopBasic",setup(t){return(e,a)=>(u(),m("div",U,[a[0]||(a[0]=c("p",{style:{"margin-bottom":"20px"}},"向下滚动页面，右下角会出现回到顶部按钮。",-1)),a[1]||(a[1]=c("p",{style:{"margin-bottom":"20px"}},"默认当页面滚动超过 400px 时显示。",-1)),(u(),m(N,null,C(50,s=>c("div",{key:s,style:{"margin-bottom":"10px"}},"内容行 "+_(s),1)),64)),l(p(g))]))}}),W=`<template>
...
<\/script>
`,X={style:{position:"relative",height:"220px",overflow:"auto",border:"1px solid #f0f0f0","border-radius":"8px",padding:"16px"}},G={style:{height:"800px",padding:"8px"}},J=y({__name:"BackTopClassNames",setup(t){const e=T(),a=()=>e.value||document.body;return(s,n)=>(u(),m("div",X,[c("div",G,[n[0]||(n[0]=c("p",{style:{color:"#666"}},"在此容器内向下滚动，即可看到经过语义化定制的回到顶部按钮。",-1)),n[1]||(n[1]=c("p",{style:{color:"#999","margin-top":"8px"}}," 下面通过 classNames / styles 对 root、content、icon 三个子节点做细粒度样式控制。 ",-1)),l(p(g),{target:a,"visibility-height":0,"class-names":{root:"demo-bt-root"}}),l(p(g),{target:a,"visibility-height":0,"class-names":{content:"demo-bt-content",icon:"demo-bt-icon"},style:{right:"100px"}}),l(p(g),{target:a,"visibility-height":0,styles:{content:{borderRadius:"12px",background:"linear-gradient(135deg, #1890ff 0%, #096dd9 100%)"},icon:{color:"#fff"}},style:{right:"180px"}})])]))}}),K=O(J,[["__scopeId","data-v-4014528c"]]),Q=`<template>
  <div
    style="
      position: relative;
      height: 220px;
