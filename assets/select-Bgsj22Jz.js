import{S as u}from"./Select-D_YE9VWW.js";import{o as k,A as v,k as g,n as o,K as d,h as t,J as x,E as i,_ as S,m as c,H as N,R as h,l as q}from"./index-X2tFbSxS.js";import"./cls-S9IiI6wd.js";import"./VirtualList-DQe-YVNG.js";const C={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"300px"}},V=k({__name:"SelectBasic",setup(b){const e=i(""),p=i(""),r=[{label:"Vue",value:"vue"},{label:"React",value:"react"},{label:"Angular",value:"angular"},{label:"Svelte（禁用）",value:"svelte",disabled:!0}];return(n,a)=>(v(),g("div",C,[o(d(u),{value:e.value,"onUpdate:value":a[0]||(a[0]=s=>e.value=s),options:r,placeholder:"请选择",style:{width:"100%"}},null,8,["value"]),o(d(u),{value:p.value,"onUpdate:value":a[1]||(a[1]=s=>p.value=s),options:r,placeholder:"禁用状态",disabled:"",style:{width:"100%"}},null,8,["value"]),t("p",null,"选中："+x(e.value),1)]))}}),_=`<template>
