import{o as Q,N as V,x as K,Q as W,n as c,s as U,E as F,p as C,m as z,F as Y,f as T,A as q,i as D,K as g,k as A,h as u,_ as X,H as J,R as E,l as Z}from"./index-B9Ix0zQ8.js";import{c as H}from"./cls-S9IiI6wd.js";import{S as tt}from"./Spin-p0FRUquz.js";import{I as nt}from"./Icon-D0ODznex.js";import{L as et}from"./LoadingOutlined-aeZz6k73.js";const P=new Array(512),j=new Array(256);(()=>{let n=1;for(let e=0;e<255;e++)P[e]=n,j[n]=e,n<<=1,n&256&&(n^=285);for(let e=255;e<512;e++)P[e]=P[e-255]})();function G(n,e){return n===0||e===0?0:P[(j[n]+j[e])%255]}function st(n){let e=[1];for(let d=0;d<n.length;d++){const s=[1,P[d]],t=new Array(e.length+1).fill(0);for(let o=0;o<e.length;o++)for(let a=0;a<s.length;a++)t[o+a]^=G(e[o],s[a]);e=t}return e}function ot(n,e){const d=st(Array.from({length:e},(t,o)=>o)),s=[...n,...new Array(e).fill(0)];for(let t=0;t<n.length;t++){const o=s[t];if(o!==0)for(let a=1;a<d.length;a++)s[t+a]^=G(d[a],o)}return s.slice(n.length)}const at={1:{L:[19,7],M:[16,10],Q:[13,13],H:[9,17]},2:{L:[34,10],M:[28,16],Q:[22,22],H:[16,28]},3:{L:[55,15],M:[44,26],Q:[34,18],H:[26,22]},4:{L:[80,20],M:[64,18],Q:[48,26],H:[36,16]},5:{L:[108,26],M:[86,24],Q:[62,18],H:[46,22]},6:{L:[136,18],M:[108,16],Q:[76,24],H:[60,28]},7:{L:[156,20],M:[124,18],Q:[88,18],H:[66,26]}},dt={L:1,M:0,Q:3,H:2},rt=21522;function lt(n){const e=new TextEncoder().encode(n),d=[],s=(t,o)=>{for(let a=o-1;a>=0;a--)d.push(t>>a&1)};return s(4,4),s(e.length,8),e.forEach(t=>s(t,8)),s(0,4),d}function ct(n,e){return[...n,...e]}function it(n){return Array.from({length:n},()=>new Array(n).fill(-1))}function B(n,e,d){for(let s=0;s<7;s++)for(let t=0;t<7;t++){const o=s===0||s===6||t===0||t===6||s>=2&&s<=4&&t>=2&&t<=4?1:0;n[e+s][d+t]=o}}function ut(n,e){for(let d=8;d<e-8;d++)n[6][d]=n[d][6]=d%2===0?1:0}function pt(n,e,d){for(let s=-2;s<=2;s++)for(let t=-2;t<=2;t++)n[e+s][d+t]=s===-2||s===2||t===-2||t===2||s===0&&t===0?1:0}const gt={1:[],2:[6,18],3:[6,22],4:[6,26],5:[6,30],6:[6,34],7:[6,22,38]};function ft(n,e,d){const t=[(o,a)=>(o+a)%2===0,o=>o%2===0,(o,a)=>a%3===0,(o,a)=>(o+a)%3===0,(o,a)=>(Math.floor(o/2)+Math.floor(a/3))%2===0,(o,a)=>o*a%2+o*a%3===0,(o,a)=>(o*a%2+o*a%3)%2===0,(o,a)=>((o+a)%2+o*a%3)%2===0][e];for(let o=0;o<d;o++)for(let a=0;a<d;a++)n[o][a]!==-1&&t(o,a)&&(n[o][a]^=1)}function O(n,e,d,s){let o=dt[e]<<3|d,a=o;for(let p=0;p<10;p++)a=a<<1^(a>>9&1?1335:0);o=(o<<10|a)^rt;const w=Array.from({length:15},(p,l)=>o>>14-l&1),R=[[8,0],[8,1],[8,2],[8,3],[8,4],[8,5],[8,7],[8,8],[7,8],[5,8],[4,8],[3,8],[2,8],[1,8],[0,8]],h=[[s-1,8],[s-2,8],[s-3,8],[s-4,8],[s-5,8],[s-6,8],[s-7,8],[s-8,8],[8,s-8],[8,s-7],[8,s-6],[8,s-5],[8,s-4],[8,s-3],[8,s-2]];w.forEach((p,l)=>{n[R[l][0]][R[l][1]]=p,n[h[l][0]][h[l][1]]=p})}function mt(n,e="M"){var v,_,N,$,M;const d=lt(n);let s=1,t=0,o=0;for(;s<=7;s++){const i=(v=at[s])==null?void 0:v[e];if(!i)return null;if(t=i[0],o=i[1],d.length<=t*8)break}if(s>7)return null;const a=t*8,w=[...d];for(;w.length<a;)w.push(0);const R=[];for(let i=0;i<w.length;i+=8){let f=0;for(let S=0;S<8;S++)f=f<<1|(w[i+S]??0);R.push(f)}for(;R.length<t;)R.push(R.length%2===0?236:17);const h=ot(R,o),p=[];ct(R,h).forEach(i=>{for(let f=7;f>=0;f--)p.push(i>>f&1)});const l=s*4+17,r=it(l);B(r,0,0),B(r,0,l-7),B(r,l-7,0);for(let i=0;i<8;i++)[0,l-8].forEach(f=>{r[i][f]===-1&&(r[i][f]=0)}),[0,l-8].forEach(f=>{r[f][i]===-1&&(r[f][i]=0)}),((_=r[l-1-i])==null?void 0:_[7])===-1&&(r[l-1-i][7]=0),((N=r[7])==null?void 0:N[l-1-i])===-1&&(r[7][l-1-i]=0),(($=r[l-8])==null?void 0:$[i])===-1&&(r[l-8][i]=0),((M=r[i])==null?void 0:M[l-8])===-1&&(r[i][l-8]=0);ut(r,l);const x=gt[s]??[];for(let i=0;i<x.length;i++)for(let f=0;f<x.length;f++){const S=x[i],I=x[f];r[S][I]===-1&&pt(r,S,I)}r[l-8][8]=1,O(r,e,0,l);let y=0,m=-1,k=l-1;for(let i=l-1;i>=1;i-=2){i===6&&(i=5);for(let f=0;f<l;f++){const S=m===-1?k-f:f;[i,i-1].forEach(I=>{var L;((L=r[S])==null?void 0:L[I])===-1&&(r[S][I]=p[y++]??0)})}m=-m,k=m===-1?l-1:0}return ft(r,0,l),O(r,e,0,l),r.map(i=>i.map(f=>f===1))}const b=Q({name:"QRCode",props:{value:{type:String,required:!0},type:{type:String,default:"canvas"},size:{type:Number,default:160},color:{type:String,default:"#000000"},bgColor:{type:String,default:"transparent"},errorLevel:{type:String,default:"M"},status:{type:String,default:"active"},icon:String,iconSize:{type:[Number,Object],default:40},bordered:{type:Boolean,default:!0},statusRender:Function,marginSize:Number,onRefresh:Function,classNames:Object,styles:Object},setup(n,{attrs:e}){const d=V("qrcode"),s=F(),t=T(()=>n.value?mt(n.value,n.errorLevel):null),o=T(()=>typeof n.iconSize=="number"?{width:n.iconSize,height:n.iconSize}:n.iconSize),a=()=>{const h=s.value;if(!h||!t.value)return;const p=h.getContext("2d");if(!p)return;const l=t.value,r=n.size,x=r/l.length;if(p.clearRect(0,0,r,r),p.fillStyle=n.bgColor,p.fillRect(0,0,r,r),p.fillStyle=n.color,l.forEach((y,m)=>y.forEach((k,v)=>{k&&p.fillRect(v*x,m*x,x,x)})),n.icon){const y=new Image;y.crossOrigin="anonymous",y.src=n.icon,y.onload=()=>{const m=o.value,k=(r-m.width)/2,v=(r-m.height)/2;p.fillStyle=n.bgColor,p.fillRect(k-2,v-2,m.width+4,m.height+4),p.drawImage(y,k,v,m.width,m.height)}}};K(()=>{n.type==="canvas"&&a()}),W([()=>n.value,()=>n.size,()=>n.color,()=>n.bgColor,()=>n.errorLevel,()=>n.icon,()=>n.iconSize],()=>{n.type==="canvas"&&a()});const w=()=>{const h=t.value;if(!h)return null;const p=n.marginSize??0,l=1,r=h.length,x=r+2*p,y=[];h.forEach((v,_)=>{v.forEach((N,$)=>{N&&y.push(`M${$+p},${_+p}h${l}v${l}h-${l}z`)})});const m={viewBox:`0 0 ${x} ${x}`,width:n.size,height:n.size,style:{display:"block"}};Object.keys(e).forEach(v=>{(v.startsWith("aria-")||v.startsWith("data-"))&&(m[v]=e[v])});const k=[C("rect",{x:0,y:0,width:x,height:x,fill:n.bgColor}),C("path",{d:y.join(""),fill:n.color})];if(n.icon){const v=o.value,_=(r-v.width/n.size*r)/2+p,N=(r-v.height/n.size*r)/2+p,$=v.width/n.size*r,M=v.height/n.size*r;k.push(C("rect",{x:_-.1,y:N-.1,width:$+.2,height:M+.2,fill:n.bgColor}),C("image",{href:n.icon,x:_,y:N,width:$,height:M,crossOrigin:"anonymous"}))}return C("svg",m,k)},R=h=>h.status==="loading"?c(tt,null,null):h.status==="expired"?c(Y,null,[c("p",{class:`${d}-expired`},[z("二维码过期")]),h.onRefresh&&c("button",{type:"button",class:`${d}-refresh`,onClick:h.onRefresh},[c(nt,{component:et,style:{marginRight:"4px"}},null),z("点击刷新")])]):h.status==="scanned"?c("p",{class:`${d}-scanned`},[z("已扫描")]):null;return()=>{var l,r,x,y;if(!n.value)return null;const h=H(d,{[`${d}-borderless`]:!n.bordered},(l=n.classNames)==null?void 0:l.root),p={width:n.size,height:n.size,style:{display:"block"}};return Object.keys(e).forEach(m=>{(m.startsWith("aria-")||m.startsWith("data-"))&&(p[m]=e[m])}),c("div",{class:h,style:{width:`${n.size}px`,height:`${n.size}px`,backgroundColor:n.bgColor,...(r=n.styles)==null?void 0:r.root}},[n.type==="canvas"?c("canvas",U({ref:s},p),null):w(),n.status!=="active"&&c("div",{class:H(`${d}-cover`,(x=n.classNames)==null?void 0:x.cover),style:(y=n.styles)==null?void 0:y.cover},[(n.statusRender??R)({status:n.status,onRefresh:n.onRefresh})])])}}}),ht=Q({__name:"QRCodeBasic",setup(n){return(e,d)=>(q(),D(g(b),{value:"https://ant.design"}))}}),vt=`<template>
...
<\/script>
`,bt={style:{display:"flex","flex-direction":"column",gap:"24px"}},xt={style:{"margin-top":"8px"}},yt=Q({__name:"QRCodeClassNames",setup(n){const e=F("expired"),d=()=>{e.value="loading",setTimeout(()=>{e.value="active"},1500)};return(s,t)=>(q(),A("div",bt,[u("div",null,[t[4]||(t[4]=u("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义根容器（圆角边框）：",-1)),c(g(b),{value:"https://ant.design","class-names":{root:"custom-root"}})]),u("div",null,[t[5]||(t[5]=u("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义状态遮罩样式：",-1)),c(g(b),{value:"https://ant.design",status:"expired","class-names":{cover:"custom-cover"},"on-refresh":()=>{}})]),u("div",null,[t[6]||(t[6]=u("div",{style:{"margin-bottom":"8px",color:"#666"}},"组合自定义（根容器 + 遮罩）：",-1)),c(g(b),{value:"https://ant.design",status:"loading","class-names":{root:"custom-root-combo",cover:"custom-cover-combo"}})]),u("div",null,[t[7]||(t[7]=u("div",{style:{"margin-bottom":"8px",color:"#666"}},"使用内联样式：",-1)),c(g(b),{value:"https://ant.design",styles:{root:{borderRadius:"16px",boxShadow:"0 4px 12px rgba(22, 119, 255, 0.3)"}}})]),u("div",null,[t[8]||(t[8]=u("div",{style:{"margin-bottom":"8px",color:"#666"}},"动态样式（状态切换）：",-1)),c(g(b),{value:"https://ant.design",status:e.value,"class-names":{root:"custom-dynamic",cover:"custom-dynamic-cover"},"on-refresh":d},null,8,["status"]),u("div",xt,[u("button",{style:{"margin-right":"8px"},onClick:t[0]||(t[0]=o=>e.value="active")},"激活"),u("button",{style:{"margin-right":"8px"},onClick:t[1]||(t[1]=o=>e.value="expired")},"过期"),u("button",{style:{"margin-right":"8px"},onClick:t[2]||(t[2]=o=>e.value="loading")},"加载中"),u("button",{onClick:t[3]||(t[3]=o=>e.value="scanned")},"已扫描")])])]))}}),Rt=X(yt,[["__scopeId","data-v-a094c1ce"]]),kt=`<template>
...
`,Ct={style:{display:"flex",gap:"16px"}},St=Q({__name:"QRCodeCustomColor",setup(n){return(e,d)=>(q(),A("div",Ct,[c(g(b),{value:"https://ant.design",color:"#1677ff"}),c(g(b),{value:"https://ant.design",color:"#52c41a","bg-color":"#f0f0f0"})]))}}),wt=`<template>
...
import { QRCode } from 'ant-design-hmfw'
<\/script>
`,Qt={style:{display:"flex",gap:"16px"}},qt=Q({__name:"QRCodeCustomStatusRender",setup(n){const e=s=>s.status==="expired"?C("div",{style:{color:"#ff4d4f"}},[C("div","❌ 已过期"),s.onRefresh&&C("button",{onClick:s.onRefresh,style:{marginTop:"8px",padding:"4px 12px",border:"1px solid #ff4d4f",borderRadius:"4px",background:"transparent",color:"#ff4d4f",cursor:"pointer"}},"重新生成")]):s.status==="loading"?C("div",{style:{color:"#1677ff"}},"⏳ 加载中..."):s.status==="scanned"?C("div",{style:{color:"#52c41a"}},"✅ 扫描成功"):null,d=()=>{console.log("刷新二维码")};return(s,t)=>(q(),A("div",Qt,[c(g(b),{value:"https://ant.design",status:"expired","status-render":e,"on-refresh":d}),c(g(b),{value:"https://ant.design",status:"loading","status-render":e}),c(g(b),{value:"https://ant.design",status:"scanned","status-render":e})]))}}),_t=`<template>
  <div style="display: flex; gap: 16px">
    <QRCode
      value="https://ant.design"
      status="expired"
...
<\/script>
`,Nt="https://gw.alipayobjects.com/zos/rmsportal/KDpgvguMpGfqaHPjicRK.svg",$t=Q({__name:"QRCodeIcon",setup(n){return(e,d)=>(q(),D(g(b),{value:"https://ant.design",icon:Nt,"icon-size":50,"error-level":"H"}))}}),Et=`<template>
...
<\/script>
`,zt={style:{display:"flex",gap:"16px"}},At=Q({__name:"QRCodeStatus",setup(n){function e(){console.log("刷新二维码")}return(d,s)=>(q(),A("div",zt,[c(g(b),{value:"https://ant.design",status:"active"}),c(g(b),{value:"https://ant.design",status:"expired",onRefresh:e}),c(g(b),{value:"https://ant.design",status:"loading"}),c(g(b),{value:"https://ant.design",status:"scanned"})]))}}),Mt=`<template>
  <div style="display: flex; gap: 16px">
...
<\/script>
`,It={style:{display:"flex",gap:"16px"}},Pt=Q({__name:"QRCodeType",setup(n){return(e,d)=>(q(),A("div",It,[c(g(b),{value:"https://ant.design",type:"canvas"}),c(g(b),{value:"https://ant.design",type:"svg"})]))}}),Bt=`<template>
  <div style="display: flex; gap: 16px">
