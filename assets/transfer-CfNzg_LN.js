import{B as ut}from"./Button-C1GEWIg_.js";import{D as kt}from"./index-B--Oi3vD.js";import{C as mt}from"./Checkbox-nw2xSfDz.js";import{D as yt}from"./DownOutlined-Ct3Sxh2i.js";import{D as vt}from"./DeleteOutlined-CZoLGXFP.js";import{S as ht}from"./SearchOutlined-DXnml86D.js";import{I as bt}from"./Input-C84iRRQW.js";import{c as $}from"./cls-S9IiI6wd.js";import{P as xt}from"./Pagination-BlR9s0ng.js";import{E as St}from"./Empty-DJnW9mOQ.js";import{o as _,E as x,R as tt,n as s,s as gt,F as rt,f as k,O as wt,N as Tt,A as E,i as X,L as u,k as ct,h as p,_ as Kt,K as Ct,H as qt,S as U,m as H,l as At}from"./index-8XlzfTv5.js";import{R as It}from"./RightOutlined-DQVUS5Tj.js";import{L as $t}from"./LeftOutlined-DbjhzKe4.js";import"./LoadingOutlined-DqorBNRC.js";import"./index-BBHiyIFf.js";import"./Layout-BqMDEKIG.js";import"./MinusOutlined-C7E0X_-_.js";import"./event-CMqgYmge.js";import"./Trigger-B5otcy1E.js";import"./Tooltip-DzhyL8cd.js";import"./CloseOutlined-Cyc9QAx7.js";import"./EyeOutlined-DbpJqG0M.js";import"./Select-KQmpZrfp.js";import"./VirtualList-yH7G4j2y.js";function Dt(e){return!!e&&typeof e=="object"&&!("__v_isVNode"in e)&&"value"in e}function Nt(e,l){for(const c of[e,l.title,l.key]){if(typeof c=="string")return c;if(typeof c=="number")return String(c)}return""}function W(e){return e.filter(l=>!l.disabled).map(l=>l.key)}const ft=_({name:"TransferList",props:{prefixCls:{type:String,required:!0},direction:{type:String,required:!0},titleText:{type:[String,Object],default:""},dataSource:{type:Array,default:()=>[]},checkedKeys:{type:Array,default:()=>[]},disabled:Boolean,showSearch:{type:[Boolean,Object],default:!1},showSelectAll:{type:Boolean,default:!0},showRemove:Boolean,draggable:Boolean,pagination:{type:[Boolean,Object],default:void 0},selectAllLabel:{type:[String,Object,Function],default:void 0},render:Function,filterOption:Function,footer:Function,listStyle:{type:Object,default:()=>({})},classNames:{type:Object,default:()=>({})},styles:{type:Object,default:()=>({})},searchPlaceholder:{type:String,default:"请输入搜索内容"},notFoundContent:{type:[String,Object,Array],default:void 0},itemUnit:{type:String,default:"项"},itemsUnit:{type:String,default:"项"},selectAll:{type:String,default:"全选所有"},deselectAll:{type:String,default:"取消全选"},selectCurrent:{type:String,default:"全选当页"},selectInvert:{type:String,default:"反选当页"},removeAll:{type:String,default:"删除全部"},removeCurrent:{type:String,default:"删除当页"}},emits:["itemSelect","itemSelectAll","itemRemove","reorder","filter","scroll"],setup(e,{emit:l}){const c=k(()=>`${e.prefixCls}-list`),y=k(()=>`${e.prefixCls}-section`),n=k(()=>e.showSearch&&typeof e.showSearch=="object"?{defaultValue:"",placeholder:"",...e.showSearch}:{defaultValue:"",placeholder:""}),r=x(n.value.defaultValue||"");tt(()=>n.value.defaultValue,t=>{r.value=t||""});const T=x(1),h=k(()=>e.pagination?{simple:!0,showSizeChanger:!1,showLessItems:!1,pageSize:10,...typeof e.pagination=="object"?e.pagination:{}}:null);function F(t){const a=e.render?e.render(t):null,o=Dt(a),d=o?a.label:a,v=o?a.value:Nt(a,t);return{item:t,renderedEl:d??t.title??String(t.key),renderedText:v}}function i(t,a){return e.filterOption?e.filterOption(r.value,a,e.direction):t.toLowerCase().includes(r.value.toLowerCase())}const b=k(()=>{const t=[];return e.dataSource.forEach(a=>{const o=F(a);r.value&&!i(o.renderedText,a)||t.push(o)}),t}),R=k(()=>b.value.map(t=>t.item));tt([b,h],()=>{const t=h.value;if(t){const a=Math.max(1,Math.ceil(b.value.length/t.pageSize));T.value=Math.min(T.value,a)}});const O=k(()=>{const t=h.value;return t?b.value.slice((T.value-1)*t.pageSize,T.value*t.pageSize):b.value}),C=k(()=>R.value.filter(t=>e.checkedKeys.includes(t.key)&&!t.disabled)),K=k(()=>{if(C.value.length===0)return"none";const t=new Set(e.checkedKeys);return R.value.every(a=>t.has(a.key)||!!a.disabled)?"all":"part"});function V(t){r.value=t,l("filter",e.direction,t)}function Y(){const t=W(R.value);l("itemSelectAll",t,K.value!=="all")}function G(t,a){const o=e.selectAllLabel;if(o)return typeof o=="function"?o({selectedCount:t,totalCount:a}):o;const d=a>1?e.itemsUnit:e.itemUnit;return`${t>0?`${t}/`:""}${a} ${d}`}const et=k(()=>{const t=h.value;return e.showRemove?[t&&{key:"removeCurrent",label:e.removeCurrent,onClick:()=>l("itemRemove",W(O.value.map(a=>a.item)))},{key:"removeAll",label:e.removeAll,onClick:()=>l("itemRemove",W(R.value))}].filter(Boolean):[{key:"selectAll",label:K.value==="all"?e.deselectAll:e.selectAll,onClick:()=>{const a=W(R.value);l("itemSelectAll",a,a.length!==e.checkedKeys.length)}},t&&{key:"selectCurrent",label:e.selectCurrent,onClick:()=>l("itemSelectAll",W(O.value.map(a=>a.item)),!0)},{key:"selectInvert",label:e.selectInvert,onClick:()=>{const a=W(O.value.map(d=>d.item)),o=new Set(e.checkedKeys);a.forEach(d=>o.has(d)?o.delete(d):o.add(d)),l("itemSelectAll",[...o],"replace")}}].filter(Boolean)});function A(t){return e.classNames[t]}function S(t){return e.styles[t]}const P=x(null),L=x(null),z=x(!1);function nt(t){return!!e.draggable&&!e.disabled&&!t.disabled}function at(t,a){if(P.value=a,t.dataTransfer){t.dataTransfer.effectAllowed="move";try{t.dataTransfer.setData("text/plain",String(a))}catch{}}}function st(t,a){if(P.value===null||P.value===a)return;t.preventDefault(),t.dataTransfer&&(t.dataTransfer.dropEffect="move");const d=t.currentTarget.getBoundingClientRect(),m=t.clientY-d.top>d.height/2;(L.value!==a||z.value!==m)&&(L.value=a,z.value=m)}function ot(t,a){L.value===a&&(L.value=null)}function J(t,a){t.preventDefault();const o=P.value,d=z.value;P.value=null,L.value=null,!(o===null||o===a)&&l("reorder",o,a,d)}function Q(){P.value=null,L.value=null}return()=>{const t=c.value,a=e.dataSource.some(w=>!w.disabled),o=s(mt,{class:`${t}-checkbox`,disabled:!a||e.disabled,checked:K.value==="all",indeterminate:K.value==="part",onChange:Y},null),d=s(kt,{class:`${t}-header-dropdown`,disabled:e.disabled,menu:{items:et.value}},{default:()=>[s("span",{class:`${t}-header-dropdown-trigger`},[s(yt,{class:"hmfw-icon"},null)])]}),v=e.showSearch?s("div",{class:`${t}-body-search-wrapper`},[s(bt,{class:`${t}-search`,value:r.value,placeholder:n.value.placeholder||e.searchPlaceholder,disabled:e.disabled,allowClear:!0,prefix:s(ht,{class:"hmfw-icon"},null),onInput:w=>V(w.target.value),onClear:()=>V("")},null)]):null,m=O.value.map(({item:w,renderedEl:j})=>{const q=w.key,I=e.disabled||w.disabled,M=e.checkedKeys.includes(q),Z=P.value===q,lt=L.value===q,dt=nt(w)?{draggable:!0,onDragstart:B=>at(B,q),onDragover:B=>st(B,q),onDragleave:B=>ot(B,q),onDrop:B=>J(B,q),onDragend:()=>Q()}:{},pt={[`${t}-content-item-draggable`]:!!e.draggable&&!I,[`${t}-content-item-dragging`]:Z,[`${t}-content-item-drag-over`]:lt&&!Z,[`${t}-content-item-drag-over-after`]:lt&&!Z&&z.value,[`${t}-content-item-drag-over-before`]:lt&&!Z&&!z.value},it=s("span",{class:$(`${t}-content-item-text`,A("itemContent")),style:S("itemContent")},[j]);return e.showRemove?s("li",gt({key:q,class:$(`${t}-content-item`,A("item"),pt,{[`${t}-content-item-disabled`]:I}),style:S("item")},dt),[it,s("button",{type:"button",disabled:I,class:`${t}-content-item-remove`,"aria-label":e.removeCurrent,onClick:()=>!I&&l("itemRemove",[q])},[s(vt,{class:"hmfw-icon"},null)])]):s("li",gt({key:q,class:$(`${t}-content-item`,A("item"),pt,{[`${t}-content-item-disabled`]:I,[`${t}-content-item-checked`]:M&&!I}),style:S("item")},dt,{onClick:B=>!I&&l("itemSelect",q,!M,B)}),[s(mt,{class:$(`${t}-checkbox`,A("itemIcon")),style:S("itemIcon"),checked:M,disabled:I},null),it])}),g=Array.isArray(e.notFoundContent)?e.notFoundContent[e.direction==="left"?0:1]:e.notFoundContent,f=O.value.length?s(rt,null,[s("ul",{class:$(`${t}-content`,A("list"),{[`${t}-content-show-remove`]:e.showRemove}),style:S("list"),onScroll:w=>l("scroll",e.direction,w)},[m]),h.value&&s(xt,{size:"small",disabled:e.disabled,simple:h.value.simple,pageSize:h.value.pageSize,showSizeChanger:h.value.showSizeChanger,class:`${t}-pagination`,total:b.value.length,current:T.value,onChange:w=>{T.value=w}},null)]):s("div",{class:`${t}-body-not-found`},[g??s(St,{description:!1},null)]),D=e.footer?e.footer({direction:e.direction,filteredItems:R.value,selectedKeys:e.checkedKeys,disabled:e.disabled}):null;return s("div",{class:$(y.value,A("section"),{[`${y.value}-with-pagination`]:!!h.value,[`${y.value}-with-footer`]:!!D}),style:{...e.listStyle,...S("section")}},[s("div",{class:$(`${t}-header`,A("header")),style:S("header")},[e.showSelectAll?s(rt,null,[!e.showRemove&&!h.value&&o,d]):null,s("span",{class:`${t}-header-selected`},[G(C.value.length,R.value.length)]),s("span",{class:$(`${t}-header-title`,A("title")),style:S("title")},[e.titleText])]),s("div",{class:$(`${t}-body`,A("body"),{[`${t}-body-with-search`]:!!e.showSearch}),style:S("body")},[v,f]),D&&s("div",{class:$(`${t}-footer`,A("footer")),style:S("footer")},[D])])}}}),N=_({name:"Transfer",props:{dataSource:{type:Array,default:()=>[]},targetKeys:Array,defaultTargetKeys:{type:Array,default:()=>[]},selectedKeys:Array,defaultSelectedKeys:{type:Array,default:()=>[]},titles:{type:Array,default:()=>["",""]},operations:{type:Array,default:()=>[]},render:Function,rowKey:Function,showSearch:{type:[Boolean,Object],default:!1},filterOption:Function,footer:Function,listStyle:{type:[Object,Function],default:()=>({})},disabled:Boolean,showSelectAll:{type:Boolean,default:!0},selectAllLabels:{type:Array,default:()=>[]},oneWay:Boolean,draggable:Boolean,pagination:{type:[Boolean,Object],default:void 0},status:String,locale:{type:Object,default:()=>({})},rootClassName:String,classNames:{type:Object,default:()=>({})},styles:{type:Object,default:()=>({})}},emits:["update:targetKeys","change","update:selectedKeys","selectChange","search","scroll","reorder"],setup(e,{emit:l}){const c=wt("transfer"),y=Tt(),n=k(()=>({...y.value.Transfer,...e.locale})),r=x([...e.defaultTargetKeys]),T=x([...e.defaultSelectedKeys]);tt(()=>e.targetKeys,t=>{t&&(r.value=[...t])}),tt(()=>e.selectedKeys,t=>{t&&(T.value=[...t])});const h=k(()=>e.targetKeys??r.value),F=k(()=>e.selectedKeys??T.value),i=k(()=>e.dataSource.map(t=>({...t,key:e.rowKey?e.rowKey(t):t.key}))),b=k(()=>i.value.filter(t=>!h.value.includes(t.key))),R=k(()=>new Map(i.value.map(t=>[t.key,t]))),O=k(()=>h.value.map(t=>R.value.get(t)).filter(Boolean)),C=k(()=>F.value.filter(t=>b.value.some(a=>a.key===t))),K=k(()=>F.value.filter(t=>O.value.some(a=>a.key===t)));function V(t){T.value=t,l("update:selectedKeys",t)}function Y(t,a){const o=t==="left"?K.value:C.value,d=t==="left"?[...a,...o]:[...o,...a];V(d),t==="left"?l("selectChange",a,K.value):l("selectChange",C.value,a)}function G(t){const a=t==="right"?C.value:K.value,o=new Set(i.value.filter(f=>f.disabled).map(f=>f.key)),d=a.filter(f=>!o.has(f)),v=new Set(d),m=t==="right"?[...d,...h.value]:h.value.filter(f=>!v.has(f));r.value=m,l("update:targetKeys",m);const g=t==="right"?K.value:C.value;V(g),t==="right"?l("selectChange",[],K.value):l("selectChange",C.value,[]),l("change",m,t,d)}const et=()=>G("right"),A=()=>G("left"),S={left:null,right:null};function P(t,a,o,d){var w;const v=t==="left",m=v?C.value:K.value,g=(v?b.value:O.value).filter(j=>!j.disabled),f=g.findIndex(j=>j.key===a),D=new Set(m);if(d&&S[t]!==null){const j=Math.min(S[t],f),q=Math.max(S[t],f);for(let I=j;I<=q;I++){const M=(w=g[I])==null?void 0:w.key;M!==void 0&&D.add(M)}}else D.has(a)&&D.delete(a),o&&D.add(a),S[t]=o?f:null;Y(t,[...D])}function L(t,a,o){const d=t==="left"?C.value:K.value;let v;if(o==="replace")v=a;else if(o)v=[...new Set([...d,...a])];else{const m=new Set(a);v=d.filter(g=>!m.has(g))}S[t]=null,Y(t,v)}function z(t){const a=new Set(t),o=h.value.filter(d=>!a.has(d));r.value=o,l("update:targetKeys",o),V(C.value),l("change",o,"left",[...t])}function nt(t,a,o){if(t===a)return;const d=[...h.value],v=d.indexOf(t),m=d.indexOf(a);if(v<0||m<0)return;const g=d.slice();g.splice(v,1);const f=g.indexOf(a),D=o?f+1:f;g.splice(D,0,t),r.value=g,l("update:targetKeys",g);const w={direction:"right",oldTargetKeys:d,newTargetKeys:g,activeKey:t,fromIndex:v,toIndex:g.indexOf(t)};l("reorder",w)}function at(t){return typeof e.listStyle=="function"?e.listStyle({direction:t}):e.listStyle}const st=k(()=>C.value.length>0),ot=k(()=>K.value.length>0),J=k(()=>e.operations||[]);function Q(t){var d,v;const a=t==="left",o=n.value;return{prefixCls:c,direction:t,titleText:((d=e.titles)==null?void 0:d[a?0:1])??"",dataSource:a?b.value:O.value,checkedKeys:a?C.value:K.value,disabled:e.disabled,showSearch:e.showSearch,showSelectAll:e.showSelectAll,showRemove:e.oneWay&&!a,draggable:!!e.draggable&&!a,pagination:e.pagination,selectAllLabel:(v=e.selectAllLabels)==null?void 0:v[a?0:1],render:e.render,filterOption:e.filterOption,footer:e.footer,listStyle:at(t),classNames:e.classNames,styles:e.styles,searchPlaceholder:o.searchPlaceholder,notFoundContent:e.locale.notFoundContent??o.notFoundContent,itemUnit:o.itemUnit,itemsUnit:o.itemsUnit,selectAll:o.selectAll,deselectAll:o.deselectAll,selectCurrent:o.selectCurrent,selectInvert:o.selectInvert,removeAll:o.removeAll,removeCurrent:o.removeCurrent,onItemSelect:(m,g,f)=>P(t,m,g,f==null?void 0:f.shiftKey),onItemSelectAll:(m,g)=>L(t,m,g),onItemRemove:m=>z(m),onReorder:(m,g,f)=>nt(m,g,f),onFilter:(m,g)=>l("search",m,g),onScroll:(m,g)=>l("scroll",m,g)}}return()=>s("div",{class:$(c,e.rootClassName,e.classNames.root,{[`${c}-disabled`]:e.disabled,[`${c}-status-error`]:e.status==="error",[`${c}-status-warning`]:e.status==="warning"}),style:e.styles.root},[s(ft,Q("left"),null),s("div",{class:$(`${c}-actions`,e.classNames.actions),style:e.styles.actions},[s(ut,{type:"primary",size:"small",icon:It,disabled:!st.value||e.disabled,onClick:et},{default:()=>[J.value[0]]}),!e.oneWay&&s(ut,{type:"primary",size:"small",icon:$t,disabled:!ot.value||e.disabled,onClick:A},{default:()=>[J.value[1]]})]),s(ft,Q("right"),null)])}}),Rt=_({__name:"TransferBasic",setup(e){const l=Array.from({length:10},(y,n)=>({key:String(n),title:`选项 ${n+1}`,description:`描述 ${n+1}`,disabled:n===3})),c=x(["1","3","5"]);return(y,n)=>(E(),X(u(N),{"target-keys":c.value,"onUpdate:targetKeys":n[0]||(n[0]=r=>c.value=r),"data-source":u(l),titles:["待选","已选"],"show-search":""},null,8,["target-keys","data-source"]))}}),Ot=`<template>
