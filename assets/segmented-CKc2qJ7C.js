...
<\/script>
`,ft=w({__name:"SegmentedBlock",setup(e){const d=r("Map"),o=["Map","Transit","Satellite"];return(g,t)=>(q(),R(c(v),{value:d.value,"onUpdate:value":t[0]||(t[0]=a=>d.value=a),options:o,block:""},null,8,["value"]))}}),bt=`<template>
...
`,qt=w({__name:"SegmentedDisabled",setup(e){const d=r("Daily"),o=[{value:"Daily",label:"每日"},{value:"Weekly",label:"每周",disabled:!0},{value:"Monthly",label:"每月"}];return(g,t)=>(q(),R(c(v),{value:d.value,"onUpdate:value":t[0]||(t[0]=a=>d.value=a),options:o},null,8,["value"]))}}),Ot=`<template>
  <Segmented v-model:value="value" :options="options" />
</template>
