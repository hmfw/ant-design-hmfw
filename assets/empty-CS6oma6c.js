import{B as g}from"./Button-CLD9HWRg.js";import{E as i,P as k}from"./Empty-D5hD_CQx.js";import{o as u,A as l,i as f,S as r,n as e,L as s,m as o,k as y,h as t,_ as x,K as h,v as b,E,H as v,l as w}from"./index-7wnt1Cyk.js";import"./cls-S9IiI6wd.js";import"./LoadingOutlined-VcPrAqG4.js";const S=u({__name:"EmptyAction",setup(c){function p(){console.log("创建")}return(a,d)=>(l(),f(s(i),{description:"暂无数据"},{default:r(()=>[e(s(g),{onClick:p},{default:r(()=>[...d[0]||(d[0]=[o("立即创建",-1)])]),_:1})]),_:1}))}}),_=`<template>
