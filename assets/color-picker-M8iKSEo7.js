...
`,Fs=H({__name:"ColorPickerPresets",setup(s){const p=m("#1677ff"),a=[{label:"推荐",colors:["#1677ff","#52c41a","#faad14","#ff4d4f","#722ed1","#13c2c2"]}];return(d,n)=>(T(),ds(b(w),{value:p.value,"onUpdate:value":n[0]||(n[0]=t=>p.value=t),"show-text":"",presets:a},null,8,["value"]))}}),Os=`<template>
