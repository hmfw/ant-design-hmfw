import{C as u,a as f}from"./Checkbox-BUjLnWpJ.js";import{o as v,A as h,k as x,n as a,L as d,Q as c,m as l,h as e,K as k,E as b,_ as y,R as w,H as G,l as N}from"./index-CEDKhEzr.js";import"./cls-S9IiI6wd.js";const S={style:{display:"flex","flex-direction":"column",gap:"8px"}},A=v({__name:"CheckboxBasic",setup(g){const p=b(!1),t=b(!1),r=b(!0);return(n,s)=>(h(),x("div",S,[a(d(u),{checked:p.value,"onUpdate:checked":s[0]||(s[0]=o=>p.value=o)},{default:c(()=>[...s[3]||(s[3]=[l(" 普通复选框 ",-1)])]),_:1},8,["checked"]),a(d(u),{checked:t.value,"onUpdate:checked":s[1]||(s[1]=o=>t.value=o),disabled:""},{default:c(()=>[...s[4]||(s[4]=[l(" 禁用复选框 ",-1)])]),_:1},8,["checked"]),a(d(u),{checked:r.value,"onUpdate:checked":s[2]||(s[2]=o=>r.value=o),disabled:""},{default:c(()=>[...s[5]||(s[5]=[l(" 禁用选中 ",-1)])]),_:1},8,["checked"]),e("p",null,"checked1: "+k(p.value)+", checked2: "+k(t.value)+", checked3: "+k(r.value),1)]))}}),q=`<template>
...
<\/script>
`,B={style:{"border-bottom":"1px solid #e8e8e8","padding-bottom":"8px","margin-bottom":"8px"}},E={style:{"margin-top":"8px"}},D=v({__name:"CheckboxCheckAll",setup(g){const p=[{label:"选项 A",value:"A"},{label:"选项 B",value:"B"},{label:"选项 C",value:"C"},{label:"选项 D",value:"D"}],t=b(["A","B"]),r=b(!1),n=b(!0),s=i=>{t.value=i.target.checked?p.map(m=>m.value):[],n.value=!1},o=i=>{n.value=!!i.length&&i.length<p.length,r.value=i.length===p.length};return(i,m)=>(h(),x("div",null,[e("div",B,[a(d(u),{checked:r.value,"onUpdate:checked":m[0]||(m[0]=C=>r.value=C),indeterminate:n.value,onChange:s},{default:c(()=>[...m[2]||(m[2]=[l(" 全选 ",-1)])]),_:1},8,["checked","indeterminate"])]),a(d(f),{value:t.value,"onUpdate:value":m[1]||(m[1]=C=>t.value=C),options:p,onChange:o},null,8,["value"]),e("p",E,"已选："+k(t.value),1)]))}}),V=`<template>
  <div>
...
<\/script>
`,$={class:"demo-checkbox-classnames"},U={class:"demo-section"},P={class:"demo-section"},T={class:"demo-section"},F={class:"demo-section"},O={class:"demo-section"},L={class:"demo-section"},I={class:"demo-section"},M=v({__name:"CheckboxClassNames",setup(g){return(p,t)=>(h(),x("div",$,[e("section",U,[t[1]||(t[1]=e("h3",null,"1. 自定义根节点样式",-1)),a(d(u),{"class-names":{root:"custom-root"}},{default:c(()=>[...t[0]||(t[0]=[l(" 自定义根节点 ",-1)])]),_:1})]),e("section",P,[t[3]||(t[3]=e("h3",null,"2. 自定义勾选框样式",-1)),a(d(u),{"class-names":{checkbox:"custom-checkbox"}},{default:c(()=>[...t[2]||(t[2]=[l(" 圆形勾选框 ",-1)])]),_:1})]),e("section",T,[t[5]||(t[5]=e("h3",null,"3. 自定义内部勾选图标",-1)),a(d(u),{"class-names":{inner:"custom-inner"}},{default:c(()=>[...t[4]||(t[4]=[l(" 星形勾选 ",-1)])]),_:1})]),e("section",F,[t[7]||(t[7]=e("h3",null,"4. 自定义文本标签样式",-1)),a(d(u),{"class-names":{label:"custom-label"}},{default:c(()=>[...t[6]||(t[6]=[l(" 渐变文字标签 ",-1)])]),_:1})]),e("section",O,[t[9]||(t[9]=e("h3",null,"5. 组合使用多个 classNames",-1)),a(d(u),{"class-names":{root:"combined-root",checkbox:"combined-checkbox",inner:"combined-inner",label:"combined-label"}},{default:c(()=>[...t[8]||(t[8]=[l(" 组合样式 ",-1)])]),_:1})]),e("section",L,[t[11]||(t[11]=e("h3",null,"6. 使用 styles 动态样式",-1)),a(d(u),{styles:{root:{padding:"8px 16px",border:"2px solid #1890ff",borderRadius:"8px"},checkbox:{transform:"scale(1.2)"},label:{fontWeight:"bold",color:"#1890ff"}}},{default:c(()=>[...t[10]||(t[10]=[l(" 动态样式 ",-1)])]),_:1})]),e("section",I,[t[13]||(t[13]=e("h3",null,"7. 半选状态自定义样式",-1)),a(d(u),{indeterminate:!0,"class-names":{checkbox:"indeterminate-custom",inner:"indeterminate-inner"}},{default:c(()=>[...t[12]||(t[12]=[l(" 自定义半选状态 ",-1)])]),_:1})])]))}}),z=y(M,[["__scopeId","data-v-bf3ed9c5"]]),K=`<template>
