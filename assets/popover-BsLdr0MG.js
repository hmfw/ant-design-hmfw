...
`,M={style:{display:"flex",gap:"8px","flex-wrap":"wrap"}},G=P({__name:"PopoverPlacement",setup(n){const l=["topLeft","top","topRight","leftTop","left","leftBottom","rightTop","right","rightBottom","bottomLeft","bottom","bottomRight"];return(p,u)=>(x(),h("div",M,[(x(),h(I,null,F(l,t=>e(s(c),{key:t,placement:t,title:"标题",content:"内容"},{default:a(()=>[e(s(v),null,{default:a(()=>[i($(t),1)]),_:2},1024)]),_:2},1032,["placement"])),64))]))}}),J=`<template>
