import{q as ct,B as pt,o as y,O as K,x as Q,y as U,n as i,f as b,P as B,E as w,t as Y,A as C,i as ut,L as d,k as q,h as n,l as X,_ as ht,Q as x,H as ft,m as g}from"./index-CEDKhEzr.js";import{c as E}from"./cls-S9IiI6wd.js";const G=Symbol("AnchorContext");function gt(e){pt(G,e)}function mt(){return ct(G,null)}const J=y({name:"AnchorLink",props:{href:{type:String,required:!0},title:{type:String,required:!0},target:String,replace:Boolean,targetOffset:Number},setup(e,{slots:r}){const p=K("anchor"),t=mt();Q(()=>{t==null||t.registerLink(e.href,e.targetOffset)}),U(()=>{t==null||t.unregisterLink(e.href)});const a=c=>{var O;if((O=t==null?void 0:t.onClick)==null||O.call(t,c,{title:e.title,href:e.href}),t==null||t.scrollTo(e.href,e.targetOffset),c.defaultPrevented)return;if(e.href.startsWith("http://")||e.href.startsWith("https://")){(e.replace??(t==null?void 0:t.replace))&&(c.preventDefault(),window.location.replace(e.href));return}c.preventDefault();const I=e.replace??(t==null?void 0:t.replace)?"replaceState":"pushState";window.history[I](null,"",e.href)},o=b(()=>(t==null?void 0:t.activeLink)===e.href),N=b(()=>{var c,h;return E(`${p}-link`,{[`${p}-link-active`]:o.value},(c=t==null?void 0:t.classNames)==null?void 0:c.link,o.value?(h=t==null?void 0:t.classNames)==null?void 0:h.linkActive:void 0)}),T=b(()=>{var c,h;return E(`${p}-link-title`,{[`${p}-link-title-active`]:o.value},(c=t==null?void 0:t.classNames)==null?void 0:c.title,o.value?(h=t==null?void 0:t.classNames)==null?void 0:h.titleActive:void 0)}),P=b(()=>{var c,h;return{...(c=t==null?void 0:t.styles)==null?void 0:c.link,...o.value?(h=t==null?void 0:t.styles)==null?void 0:h.linkActive:{}}}),L=b(()=>{var c,h;return{...(c=t==null?void 0:t.styles)==null?void 0:c.title,...o.value?(h=t==null?void 0:t.styles)==null?void 0:h.titleActive:{}}});return()=>{var c;return i("div",{class:N.value,style:P.value},[i("a",{class:T.value,style:L.value,href:e.href,title:e.title,target:e.target,onClick:a},[e.title]),(t==null?void 0:t.direction)!=="horizontal"?(c=r.default)==null?void 0:c.call(r):null])}}}),kt=y({name:"Anchor",props:{items:{type:Array,default:()=>[]},affix:{type:Boolean,default:!0},offsetTop:{type:Number,default:0},bounds:{type:Number,default:5},targetOffset:Number,direction:{type:String,default:"vertical"},replace:Boolean,getCurrentAnchor:Function,getContainer:Function,classNames:Object,styles:Object},emits:["change","click"],setup(e,{emit:r,slots:p}){const t=K("anchor"),a=w(null),o=w([]),N=w({}),T=w(),P=w(),L=w(!1);let c=null;const h=()=>e.getContainer?e.getContainer():window,H=s=>s===window?window.scrollY:s.scrollTop,I=(s,l)=>{if(!s.getClientRects().length)return 0;const u=s.getBoundingClientRect();return u.width||u.height?l===window?u.top-s.ownerDocument.documentElement.clientTop:u.top-l.getBoundingClientRect().top:u.top},O=(s,l)=>{o.value.includes(s)||(o.value=[...o.value,s]),l!==void 0&&(N.value[s]=l)},M=s=>{o.value=o.value.filter(l=>l!==s),delete N.value[s]},W=()=>{if(!T.value||!P.value)return;const s=T.value.querySelector(`.${t}-link-title-active`);if(s){const{style:l}=P.value,u=e.direction==="horizontal";l.top=u?"":`${s.offsetTop+s.clientHeight/2}px`,l.height=u?"":`${s.clientHeight}px`,l.left=u?`${s.offsetLeft}px`:"",l.width=u?`${s.clientWidth}px`:"",u&&s.scrollIntoView({behavior:"smooth",block:"nearest",inline:"nearest"})}},Z=(s,l,u)=>{const m=[],_=h();return s.forEach(k=>{const v=/#([\S ]+)$/.exec(k);if(!v)return;const A=document.getElementById(v[1]);if(A){const R=N.value[k]??l,z=I(A,_);z<=R+u&&m.push({link:k,top:z})}}),m.length?m.reduce((v,A)=>A.top>v.top?A:v).link:""},D=s=>{if(a.value===s)return;const l=e.getCurrentAnchor?e.getCurrentAnchor(s):s;a.value=l,r("change",s)},$=()=>{if(L.value)return;const s=Z(o.value,e.targetOffset??e.offsetTop??0,e.bounds);D(s)},tt=(s,l)=>{const u=a.value;D(s);const m=/#([\S ]+)$/.exec(s);if(!m)return;const _=document.getElementById(m[1]);if(!_||L.value&&u===s)return;const k=h(),v=H(k),A=I(_,k);let R=v+A;const z=l??e.targetOffset??e.offsetTop??0;R-=z,L.value=!0;const it=Date.now(),lt=450,V=()=>{const rt=Date.now()-it,S=Math.min(rt/lt,1),dt=S<.5?2*S*S:-1+(4-2*S)*S,j=v+(R-v)*dt;k===window?window.scrollTo(0,j):k.scrollTop=j,S<1?c=requestAnimationFrame(V):L.value=!1};V()},nt=(s,l)=>{r("click",s,l)};gt({registerLink:O,unregisterLink:M,activeLink:a.value,scrollTo:tt,onClick:nt,direction:e.direction,replace:e.replace,classNames:e.classNames,styles:e.styles}),Q(()=>{h().addEventListener("scroll",$),$()}),U(()=>{h().removeEventListener("scroll",$),c!==null&&cancelAnimationFrame(c)}),B(()=>e.items,()=>{$()},{deep:!0}),B(()=>o.value,()=>{$()}),B(()=>a.value,()=>{Y(()=>{W()})}),B(()=>e.getCurrentAnchor,()=>{e.getCurrentAnchor&&a.value&&D(e.getCurrentAnchor(a.value))}),B(()=>e.direction,()=>{Y(()=>{W()})});const F=s=>s.map(l=>i(J,{key:l.key??l.href,href:l.href,title:l.title,target:l.target,targetOffset:l.targetOffset},{default:()=>{var u;return[e.direction==="vertical"&&((u=l.children)!=null&&u.length)?F(l.children):null]}})),et=b(()=>{var s;return E(`${t}-wrapper`,{[`${t}-wrapper-horizontal`]:e.direction==="horizontal"},(s=e.classNames)==null?void 0:s.wrapper)}),st=b(()=>{var s;return E(t,{[`${t}-fixed`]:!e.affix},(s=e.classNames)==null?void 0:s.root)}),at=b(()=>{var s;return E(`${t}-ink`,{[`${t}-ink-visible`]:!!a.value},(s=e.classNames)==null?void 0:s.ink)}),ot=b(()=>{var s;return{maxHeight:e.offsetTop?`calc(100vh - ${e.offsetTop}px)`:"100vh",...(s=e.styles)==null?void 0:s.wrapper}});return()=>{var s,l,u,m;return i("div",{ref:T,class:et.value,style:ot.value},[i("div",{class:st.value,style:(s=e.styles)==null?void 0:s.root},[i("span",{class:at.value,ref:P,style:(l=e.styles)==null?void 0:l.ink},null),(u=e.items)!=null&&u.length?F(e.items):(m=p.default)==null?void 0:m.call(p)])])}}}),f=kt;f.Link=J;const vt=y({__name:"AnchorAffix",setup(e){const r=[{href:"#section-a",title:"章节 A"},{href:"#section-b",title:"章节 B"},{href:"#section-c",title:"章节 C"}],p=a=>{console.log("当前锚点:",a)},t=(a,o)=>{console.log("点击锚点:",o)};return(a,o)=>(C(),ut(d(f),{affix:"","offset-top":80,items:r,onChange:p,onClick:t}))}}),xt=`<template>
