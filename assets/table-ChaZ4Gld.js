...
<\/script>
`,Mt={style:{height:"600px",overflow:"auto"}},Ot=z({__name:"TableSticky",setup(e){const i=C(Array.from({length:100},(c,t)=>({key:t,name:`李明 ${t+1}`,age:20+t%50,address:`北京市朝阳区某街道 ${t+1} 号`,tags:t%2===0?["开发者","设计师"]:["产品经理"]}))),s=[{title:"姓名",dataIndex:"name",key:"name",width:150,fixed:"left"},{title:"年龄",dataIndex:"age",key:"age",width:100,sorter:(c,t)=>c.age-t.age},{title:"地址",dataIndex:"address",key:"address",width:300},{title:"标签",key:"tags",dataIndex:"tags",width:200,render:c=>c.join(", ")}];return(c,t)=>(P(),re("div",Mt,[t[0]||(t[0]=l("div",{style:{height:"300px",background:"#f0f0f0",display:"flex","align-items":"center","justify-content":"center","margin-bottom":"16px"}},[l("p",null,"向下滚动查看表头吸顶效果")],-1)),a(y($),{"data-source":i.value,columns:s,pagination:!1,scroll:{y:300},sticky:!0,bordered:""},null,8,["data-source"]),t[1]||(t[1]=l("div",{style:{height:"300px",background:"#f0f0f0",display:"flex","align-items":"center","justify-content":"center","margin-top":"16px"}},[l("p",null,"底部内容")],-1))]))}}),Ht=`<script setup lang="ts">
import { ref } from 'vue'
import { Table } from 'ant-design-hmfw'
import type { TableColumn } from 'ant-design-hmfw'
