import{o as _,O as un,N as dn,E as h,P as kn,n as s,f as v,F as mn,m as i,t as gn,A as H,k as A,L as g,h as r,K as G,_ as vn,H as yn,Q as j,l as hn}from"./index-CEDKhEzr.js";import{c}from"./cls-S9IiI6wd.js";import{C as fn}from"./CloseCircleFilled-JEI3_UNE.js";import{C as bn}from"./CalendarOutlined-CJIzbSZd.js";import{T as wn}from"./Trigger-C6BCQff1.js";function O(a){return String(a).padStart(2,"0")}function sa(a,o="YYYY-MM-DD"){return o.replace("YYYY",String(a.getFullYear())).replace("MM",O(a.getMonth()+1)).replace("DD",O(a.getDate())).replace("HH",O(a.getHours())).replace("mm",O(a.getMinutes())).replace("ss",O(a.getSeconds()))}function z(a){if(!a)return null;const o=new Date(a);return isNaN(o.getTime())?null:o}function _a(a,o){return a.getFullYear()===o.getFullYear()&&a.getMonth()===o.getMonth()&&a.getDate()===o.getDate()}function xn(a,o){return a.getFullYear()===o.getFullYear()&&a.getMonth()===o.getMonth()}function Dn(a,o){return a.getFullYear()===o.getFullYear()}function Ha(a,o){return new Date(a,o+1,0).getDate()}function Sn(a,o){return new Date(a,o,1).getDay()}function Cn(a,o){const n=[],u=Sn(a,o),e=Ha(a,o),k=Ha(a,o-1);for(let p=u-1;p>=0;p--)n.push({date:new Date(a,o-1,k-p),inCurrentMonth:!1});for(let p=1;p<=e;p++)n.push({date:new Date(a,o,p),inCurrentMonth:!0});const y=42-n.length;for(let p=1;p<=y;p++)n.push({date:new Date(a,o+1,p),inCurrentMonth:!1});return n}const S=_({name:"DatePicker",props:{value:String,defaultValue:String,format:String,disabled:Boolean,size:{type:String,default:"middle"},placeholder:String,allowClear:{type:Boolean,default:!0},picker:{type:String,default:"date"},showTime:[Boolean,Object],showToday:{type:Boolean,default:!0},showNow:Boolean,disabledDate:Function,status:{type:String,default:""},open:{type:Boolean,default:void 0},defaultOpen:Boolean,presets:Array,minDate:String,maxDate:String,renderExtraFooter:Function,cellRender:Function,classNames:Object,styles:Object},emits:["update:value","change","openChange","panelChange"],setup(a,{emit:o}){var ca,ra,ua;const n=un("date-picker"),u=dn(),e=new Date,k=v(()=>a.format?a.format:a.picker==="year"?"YYYY":a.picker==="month"?"YYYY-MM":a.picker==="quarter"?"YYYY-[Q]Q":a.showTime?"YYYY-MM-DD HH:mm:ss":"YYYY-MM-DD"),y=v(()=>{if(a.placeholder)return a.placeholder;const t=u.value.DatePicker;return a.picker==="year"?t.yearPlaceholder:a.picker==="month"?t.monthPlaceholder:t.placeholder}),p=h(z(a.defaultValue??a.value)),I=h(((ca=p.value)==null?void 0:ca.getHours())??0),R=h(((ra=p.value)==null?void 0:ra.getMinutes())??0),V=h(((ua=p.value)==null?void 0:ua.getSeconds())??0),U=v(()=>a.showTime?typeof a.showTime=="boolean"?{}:a.showTime:null),W=v(()=>!!a.showTime),b=h((p.value??e).getFullYear()),T=h((p.value??e).getMonth()),J=h(a.defaultOpen??!1),C=h(a.picker==="year"?"year":a.picker==="month"?"month":"date"),Aa=h(),ea=v(()=>a.open!==void 0?a.open:J.value),Y=v(()=>a.value?z(a.value):p.value),oa=v(()=>a.minDate?z(a.minDate):null),la=v(()=>a.maxDate?z(a.maxDate):null),pa=v(()=>{const t=Y.value;if(!t)return"";if(a.picker==="quarter"){const l=Math.floor(t.getMonth()/3)+1;return`${t.getFullYear()}-Q${l}`}return sa(t,k.value)});kn(()=>a.value,t=>{p.value=z(t)});const Ia=()=>{if(a.disabled)return;const t=Y.value??e;b.value=t.getFullYear(),T.value=t.getMonth(),C.value=a.picker==="year"?"year":a.picker==="month"?"month":"date",W.value&&t&&(I.value=t.getHours(),R.value=t.getMinutes(),V.value=t.getSeconds()),J.value=!0,o("openChange",!0)},Z=()=>{J.value=!1,o("openChange",!1)},Q=t=>{var m;if((m=a.disabledDate)!=null&&m.call(a,t)||oa.value&&t<oa.value||la.value&&t>la.value)return;if(W.value){const w=new Date(t.getFullYear(),t.getMonth(),t.getDate(),I.value,R.value,V.value);p.value=w;return}p.value=t;const l=a.picker==="quarter"?`${t.getFullYear()}-Q${Math.floor(t.getMonth()/3)+1}`:sa(t,k.value);o("update:value",l),o("change",l,t),Z()},Ra=t=>{if(I.value=t,p.value){const l=p.value;p.value=new Date(l.getFullYear(),l.getMonth(),l.getDate(),t,R.value,V.value)}},Va=t=>{if(R.value=t,p.value){const l=p.value;p.value=new Date(l.getFullYear(),l.getMonth(),l.getDate(),I.value,t,V.value)}},Ua=t=>{if(V.value=t,p.value){const l=p.value;p.value=new Date(l.getFullYear(),l.getMonth(),l.getDate(),I.value,R.value,t)}},ja=()=>{if(!p.value)return;const t=sa(p.value,k.value);o("update:value",t),o("change",t,p.value),Z()},Qa=t=>{t.stopPropagation(),p.value=null,o("update:value",void 0),o("change",void 0,null)},za=t=>{const l=typeof t.value=="function"?t.value():t.value,m=z(l);m&&Q(m)},Wa=()=>{T.value===0?(b.value--,T.value=11):T.value--,o("panelChange",null,C.value)},La=()=>{T.value===11?(b.value++,T.value=0):T.value++,o("panelChange",null,C.value)},aa=()=>{b.value--,o("panelChange",null,C.value)},na=()=>{b.value++,o("panelChange",null,C.value)},Ka=v(()=>Cn(b.value,T.value)),Xa=v(()=>{const t=U.value;return t&&typeof t=="object"&&"hourStep"in t&&t.hourStep?t.hourStep:1}),Ga=v(()=>{const t=U.value;return t&&typeof t=="object"&&"minuteStep"in t&&t.minuteStep?t.minuteStep:1}),Ja=v(()=>{const t=U.value;return t&&typeof t=="object"&&"secondStep"in t&&t.secondStep?t.secondStep:1}),Za=v(()=>{const t=[];for(let l=0;l<24;l+=Xa.value)t.push(l);return t}),an=v(()=>{const t=[];for(let l=0;l<60;l+=Ga.value)t.push(l);return t}),nn=v(()=>{const t=[];for(let l=0;l<60;l+=Ja.value)t.push(l);return t}),tn=v(()=>{if(!W.value)return!1;const t=U.value&&"format"in U.value&&U.value.format?U.value.format:k.value;return t.includes("ss")||t.includes("s")}),K=v(()=>{const t=Math.floor(b.value/10)*10;return Array.from({length:10},(l,m)=>t+m)}),ta=(t,l)=>{t&&gn(()=>{const m=t.querySelector(`[data-value="${l}"]`);m&&typeof m.scrollIntoView=="function"&&m.scrollIntoView({block:"nearest"})})},sn=()=>{var t,l,m,w,q,P,N,$,f,M,F,B,E,L,da,ia,ka,ma,ga,va,ya,ha,fa,ba,wa,xa,Da,Sa,Ca,qa,Pa,Na,$a,Ma,Ya;return s("div",{class:c(`${n}-panel`,{[`${n}-panel-has-time`]:W.value},(t=a.classNames)==null?void 0:t.panel),style:(l=a.styles)==null?void 0:l.panel},[s("div",{class:c(`${n}-panel-header`,(m=a.classNames)==null?void 0:m.panelHeader),style:(w=a.styles)==null?void 0:w.panelHeader},[s("button",{class:`${n}-panel-header-btn`,onClick:aa},[i("«")]),s("button",{class:`${n}-panel-header-btn`,onClick:Wa},[i("‹")]),s("span",{class:`${n}-panel-header-title`},[s("button",{class:`${n}-panel-header-title-btn`,onClick:()=>{C.value="year",o("panelChange",null,"year")}},[b.value,i("年")]),s("button",{class:`${n}-panel-header-title-btn`,onClick:()=>{C.value="month",o("panelChange",null,"month")}},[u.value.DatePicker.months[T.value]])]),s("button",{class:`${n}-panel-header-btn`,onClick:La},[i("›")]),s("button",{class:`${n}-panel-header-btn`,onClick:na},[i("»")])]),s("div",{class:c(`${n}-panel-body`,(q=a.classNames)==null?void 0:q.panelBody),style:(P=a.styles)==null?void 0:P.panelBody},[s("div",{class:c(`${n}-weekdays`,(N=a.classNames)==null?void 0:N.weekdays),style:($=a.styles)==null?void 0:$.weekdays},[u.value.DatePicker.weekdays.map(d=>{var D,x;return s("span",{key:d,class:c(`${n}-weekday`,(D=a.classNames)==null?void 0:D.weekday),style:(x=a.styles)==null?void 0:x.weekday},[d])})]),s("div",{class:c(`${n}-days`,(f=a.classNames)==null?void 0:f.days),style:(M=a.styles)==null?void 0:M.days},[Ka.value.map(({date:d,inCurrentMonth:D},x)=>{var Ba,Ea,Oa;const X=_a(d,e),cn=Y.value?_a(d,Y.value):!1,Ta=((Ba=a.disabledDate)==null?void 0:Ba.call(a,d))??!1,Fa=s("span",null,[d.getDate()]),rn=a.cellRender?a.cellRender(d,{originNode:Fa,today:e,type:"date"}):Fa;return s("button",{key:x,class:c(`${n}-day`,{[`${n}-day-other-month`]:!D,[`${n}-day-today`]:X,[`${n}-day-selected`]:cn,[`${n}-day-disabled`]:Ta},(Ea=a.classNames)==null?void 0:Ea.day),style:(Oa=a.styles)==null?void 0:Oa.day,disabled:Ta,onClick:()=>Q(d)},[rn])})])]),W.value&&s("div",{class:c(`${n}-time-panel`,(F=a.classNames)==null?void 0:F.timePanel),style:(B=a.styles)==null?void 0:B.timePanel},[s("div",{class:c(`${n}-time-content`,(E=a.classNames)==null?void 0:E.timeContent),style:(L=a.styles)==null?void 0:L.timeContent},[s("ul",{class:c(`${n}-time-column`,(da=a.classNames)==null?void 0:da.timeColumn),style:(ia=a.styles)==null?void 0:ia.timeColumn,ref:d=>ta(d,I.value)},[Za.value.map(d=>{var D,x;return s("li",{key:d,"data-value":d,class:c(`${n}-time-cell`,{[`${n}-time-cell-selected`]:I.value===d},(D=a.classNames)==null?void 0:D.timeCell),style:(x=a.styles)==null?void 0:x.timeCell,onClick:()=>Ra(d)},[O(d)])})]),s("ul",{class:c(`${n}-time-column`,(ka=a.classNames)==null?void 0:ka.timeColumn),style:(ma=a.styles)==null?void 0:ma.timeColumn,ref:d=>ta(d,R.value)},[an.value.map(d=>{var D,x;return s("li",{key:d,"data-value":d,class:c(`${n}-time-cell`,{[`${n}-time-cell-selected`]:R.value===d},(D=a.classNames)==null?void 0:D.timeCell),style:(x=a.styles)==null?void 0:x.timeCell,onClick:()=>Va(d)},[O(d)])})]),tn.value&&s("ul",{class:c(`${n}-time-column`,(ga=a.classNames)==null?void 0:ga.timeColumn),style:(va=a.styles)==null?void 0:va.timeColumn,ref:d=>ta(d,V.value)},[nn.value.map(d=>{var D,x;return s("li",{key:d,"data-value":d,class:c(`${n}-time-cell`,{[`${n}-time-cell-selected`]:V.value===d},(D=a.classNames)==null?void 0:D.timeCell),style:(x=a.styles)==null?void 0:x.timeCell,onClick:()=>Ua(d)},[O(d)])})])])]),(a.showToday||a.showNow||a.showTime||((ya=a.presets)==null?void 0:ya.length)||a.renderExtraFooter)&&s("div",{class:c(`${n}-panel-footer`,(ha=a.classNames)==null?void 0:ha.panelFooter),style:(fa=a.styles)==null?void 0:fa.panelFooter},[s("div",{class:c(`${n}-panel-footer-extra`,(ba=a.classNames)==null?void 0:ba.panelFooterExtra),style:(wa=a.styles)==null?void 0:wa.panelFooterExtra},[((xa=a.presets)==null?void 0:xa.length)&&s("div",{class:c(`${n}-presets`,(Da=a.classNames)==null?void 0:Da.presets),style:(Sa=a.styles)==null?void 0:Sa.presets},[a.presets.map((d,D)=>{var x,X;return s("button",{key:D,class:c(`${n}-preset-btn`,(x=a.classNames)==null?void 0:x.presetBtn),style:(X=a.styles)==null?void 0:X.presetBtn,onClick:()=>za(d)},[d.label])})]),(Ca=a.renderExtraFooter)==null?void 0:Ca.call(a)]),s("div",{class:c(`${n}-panel-footer-actions`,(qa=a.classNames)==null?void 0:qa.panelFooterActions),style:(Pa=a.styles)==null?void 0:Pa.panelFooterActions},[(a.showToday||a.showNow)&&s("button",{class:c(`${n}-panel-footer-today`,(Na=a.classNames)==null?void 0:Na.today),style:($a=a.styles)==null?void 0:$a.today,onClick:()=>Q(new Date)},[a.showNow?u.value.DatePicker.now:u.value.DatePicker.today]),a.showTime&&s("button",{class:c(`${n}-panel-footer-ok`,(Ma=a.classNames)==null?void 0:Ma.ok),style:(Ya=a.styles)==null?void 0:Ya.ok,onClick:ja},[u.value.DatePicker.ok])])])])},en=()=>{var t,l,m,w,q,P,N,$;return s("div",{class:c(`${n}-panel`,(t=a.classNames)==null?void 0:t.panel),style:(l=a.styles)==null?void 0:l.panel},[s("div",{class:c(`${n}-panel-header`,(m=a.classNames)==null?void 0:m.panelHeader),style:(w=a.styles)==null?void 0:w.panelHeader},[s("button",{class:`${n}-panel-header-btn`,onClick:aa},[i("«")]),s("span",{class:`${n}-panel-header-title`},[s("button",{class:`${n}-panel-header-title-btn`,onClick:()=>{C.value="year",o("panelChange",null,"year")}},[b.value,i("年")])]),s("button",{class:`${n}-panel-header-btn`,onClick:na},[i("»")])]),s("div",{class:c(`${n}-panel-body`,(q=a.classNames)==null?void 0:q.panelBody),style:(P=a.styles)==null?void 0:P.panelBody},[s("div",{class:c(`${n}-months`,(N=a.classNames)==null?void 0:N.months),style:($=a.styles)==null?void 0:$.months},[u.value.DatePicker.months.map((f,M)=>{var E,L;const F=new Date(b.value,M,1),B=Y.value?xn(F,Y.value):!1;return s("button",{key:M,class:c(`${n}-month`,{[`${n}-month-selected`]:B},(E=a.classNames)==null?void 0:E.month),style:(L=a.styles)==null?void 0:L.month,onClick:()=>{T.value=M,a.picker==="month"?Q(F):(C.value="date",o("panelChange",null,"date"))}},[f])})])])])},on=()=>{var t,l,m,w,q,P,N,$;return s("div",{class:c(`${n}-panel`,(t=a.classNames)==null?void 0:t.panel),style:(l=a.styles)==null?void 0:l.panel},[s("div",{class:c(`${n}-panel-header`,(m=a.classNames)==null?void 0:m.panelHeader),style:(w=a.styles)==null?void 0:w.panelHeader},[s("button",{class:`${n}-panel-header-btn`,onClick:()=>{b.value-=10}},[i("«")]),s("span",{class:`${n}-panel-header-title`},[K.value[0],i("年 - "),K.value[K.value.length-1],i("年")]),s("button",{class:`${n}-panel-header-btn`,onClick:()=>{b.value+=10}},[i("»")])]),s("div",{class:c(`${n}-panel-body`,(q=a.classNames)==null?void 0:q.panelBody),style:(P=a.styles)==null?void 0:P.panelBody},[s("div",{class:c(`${n}-years`,(N=a.classNames)==null?void 0:N.years),style:($=a.styles)==null?void 0:$.years},[K.value.map(f=>{var F,B;const M=Y.value?Dn(new Date(f,0,1),Y.value):!1;return s("button",{key:f,class:c(`${n}-year`,{[`${n}-year-selected`]:M},(F=a.classNames)==null?void 0:F.year),style:(B=a.styles)==null?void 0:B.year,onClick:()=>{b.value=f,a.picker==="year"?Q(new Date(f,0,1)):(C.value="month",o("panelChange",null,"month"))}},[f,i("年")])})])])])},ln=()=>{var t,l,m,w,q,P,N,$;return s("div",{class:c(`${n}-panel`,(t=a.classNames)==null?void 0:t.panel),style:(l=a.styles)==null?void 0:l.panel},[s("div",{class:c(`${n}-panel-header`,(m=a.classNames)==null?void 0:m.panelHeader),style:(w=a.styles)==null?void 0:w.panelHeader},[s("button",{class:`${n}-panel-header-btn`,onClick:aa},[i("«")]),s("span",{class:`${n}-panel-header-title`},[b.value,i("年")]),s("button",{class:`${n}-panel-header-btn`,onClick:na},[i("»")])]),s("div",{class:c(`${n}-panel-body`,(q=a.classNames)==null?void 0:q.panelBody),style:(P=a.styles)==null?void 0:P.panelBody},[s("div",{class:c(`${n}-quarters`,(N=a.classNames)==null?void 0:N.quarters),style:($=a.styles)==null?void 0:$.quarters},[[1,2,3,4].map(f=>{var B,E;const M=new Date(b.value,(f-1)*3,1),F=Y.value?Y.value.getFullYear()===b.value&&Math.floor(Y.value.getMonth()/3)+1===f:!1;return s("button",{key:f,class:c(`${n}-quarter`,{[`${n}-quarter-selected`]:F},(B=a.classNames)==null?void 0:B.quarter),style:(E=a.styles)==null?void 0:E.quarter,onClick:()=>Q(M)},[i("Q"),f])})])])])},pn=()=>s(mn,null,[C.value==="date"&&a.picker!=="quarter"&&sn(),C.value==="month"&&en(),C.value==="year"&&on(),a.picker==="quarter"&&C.value==="date"&&ln()]);return()=>{var t,l;return s(wn,{open:ea.value,trigger:"click",placement:"bottomLeft",disabled:a.disabled,destroyOnHidden:!0,popupClass:c(`${n}-popup`,(t=a.classNames)==null?void 0:t.popup),popupStyle:(l=a.styles)==null?void 0:l.popup,onOpenChange:m=>{m?Ia():Z()}},{default:()=>{var m,w,q,P,N,$,f,M;return s("div",{ref:Aa,class:c(n,`${n}-${a.size}`,{[`${n}-open`]:ea.value,[`${n}-disabled`]:a.disabled,[`${n}-status-error`]:a.status==="error",[`${n}-status-warning`]:a.status==="warning"},(m=a.classNames)==null?void 0:m.root),style:(w=a.styles)==null?void 0:w.root},[s("span",{class:c(`${n}-input`,(q=a.classNames)==null?void 0:q.input),style:(P=a.styles)==null?void 0:P.input},[s("input",{readonly:!0,value:pa.value,placeholder:y.value,disabled:a.disabled,class:`${n}-input-inner`},null),a.allowClear&&pa.value&&!a.disabled&&s("span",{class:c(`${n}-clear`,(N=a.classNames)==null?void 0:N.clear),style:($=a.styles)==null?void 0:$.clear,onClick:Qa},[s(fn,null,null)]),s("span",{class:c(`${n}-suffix`,(f=a.classNames)==null?void 0:f.suffix),style:(M=a.styles)==null?void 0:M.suffix},[s(bn,null,null)])])])},popup:({placement:m})=>pn()})}}}),qn={style:{display:"flex","flex-direction":"column",gap:"16px",width:"300px"}},Pn=_({__name:"DatePickerBasic",setup(a){const o=h(""),n=u=>{console.log("选中日期：",u)};return(u,e)=>(H(),A("div",qn,[s(g(S),{value:o.value,"onUpdate:value":e[0]||(e[0]=k=>o.value=k),placeholder:"请选择日期",onChange:n},null,8,["value"]),r("p",null,"选中日期："+G(o.value),1)]))}}),Nn=`<template>
...
<\/script>
`,$n={style:{display:"flex","flex-direction":"column",gap:"24px"}},Mn=_({__name:"DatePickerClassNames",setup(a){return(o,n)=>(H(),A("div",$n,[r("div",null,[n[0]||(n[0]=r("div",{style:{"margin-bottom":"8px",color:"#666"}},"渐变触发器：",-1)),s(g(S),{placeholder:"选择日期","class-names":{root:"custom-root",input:"custom-input",suffix:"custom-suffix"}})]),r("div",null,[n[1]||(n[1]=r("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义弹层面板：",-1)),s(g(S),{placeholder:"选择日期","class-names":{popup:"custom-popup",panel:"custom-panel",panelHeader:"custom-header"}})]),r("div",null,[n[2]||(n[2]=r("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义日期单元格：",-1)),s(g(S),{placeholder:"选择日期","class-names":{day:"custom-day",weekday:"custom-weekday"}})]),r("div",null,[n[3]||(n[3]=r("div",{style:{"margin-bottom":"8px",color:"#666"}},"带时间选择：",-1)),s(g(S),{placeholder:"选择日期时间","show-time":!0,"class-names":{root:"custom-datetime-root",timePanel:"custom-time-panel",timeColumn:"custom-time-column",timeCell:"custom-time-cell"}})]),r("div",null,[n[4]||(n[4]=r("div",{style:{"margin-bottom":"8px",color:"#666"}},"使用内联样式：",-1)),s(g(S),{placeholder:"选择日期",styles:{root:{borderRadius:"20px",borderColor:"#722ed1"},input:{color:"#722ed1",fontWeight:500},popup:{borderRadius:"16px"},panel:{boxShadow:"0 8px 24px rgba(114, 46, 209, 0.15)"}}})])]))}}),Yn=vn(Mn,[["__scopeId","data-v-71e3ca16"]]),Tn=`<template>
...
`,Fn={style:{display:"flex","flex-direction":"column",gap:"16px",width:"300px"}},Bn=_({__name:"DatePickerDisabledDate",setup(a){const o=h(""),n=h(""),u=k=>new Date(k)<new Date(new Date().toDateString()),e=k=>new Date(k)>new Date(new Date().toDateString());return(k,y)=>(H(),A("div",Fn,[s(g(S),{value:o.value,"onUpdate:value":y[0]||(y[0]=p=>o.value=p),"disabled-date":u,placeholder:"不可选择过去日期"},null,8,["value"]),s(g(S),{value:n.value,"onUpdate:value":y[1]||(y[1]=p=>n.value=p),"disabled-date":e,placeholder:"不可选择未来日期"},null,8,["value"])]))}}),En=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; width: 300px">
...
<\/script>
`,An={style:{display:"flex","flex-direction":"column",gap:"16px",width:"300px"}},In=_({__name:"DatePickerPicker",setup(a){const o=h(""),n=h(""),u=h(""),e=h("");return(k,y)=>(H(),A("div",An,[s(g(S),{value:o.value,"onUpdate:value":y[0]||(y[0]=p=>o.value=p),picker:"date",placeholder:"选择日期"},null,8,["value"]),s(g(S),{value:n.value,"onUpdate:value":y[1]||(y[1]=p=>n.value=p),picker:"month",placeholder:"选择月份"},null,8,["value"]),s(g(S),{value:u.value,"onUpdate:value":y[2]||(y[2]=p=>u.value=p),picker:"quarter",placeholder:"选择季度"},null,8,["value"]),s(g(S),{value:e.value,"onUpdate:value":y[3]||(y[3]=p=>e.value=p),picker:"year",placeholder:"选择年份"},null,8,["value"])]))}}),Rn=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; width: 300px">
...
const year = ref('')
<\/script>
`,Vn={style:{display:"flex","flex-direction":"column",gap:"16px",width:"300px"}},Un=_({__name:"DatePickerPresets",setup(a){const o=h(""),n=[{label:"昨天",value:()=>{const u=new Date;return u.setDate(u.getDate()-1),u.toISOString().split("T")[0]}},{label:"今天",value:()=>new Date().toISOString().split("T")[0]},{label:"明天",value:()=>{const u=new Date;return u.setDate(u.getDate()+1),u.toISOString().split("T")[0]}},{label:"一周后",value:()=>{const u=new Date;return u.setDate(u.getDate()+7),u.toISOString().split("T")[0]}}];return(u,e)=>(H(),A("div",Vn,[s(g(S),{value:o.value,"onUpdate:value":e[0]||(e[0]=k=>o.value=k),presets:n,placeholder:"选择日期"},null,8,["value"]),r("p",null,"选中日期："+G(o.value),1)]))}}),jn=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; width: 300px">
...
<\/script>
`,Qn={style:{width:"300px"}},zn={style:{"margin-top":"8px"}},Wn=_({__name:"DatePickerShowTime",setup(a){const o=h(""),n=u=>{console.log("选中日期时间：",u)};return(u,e)=>(H(),A("div",Qn,[s(g(S),{value:o.value,"onUpdate:value":e[0]||(e[0]=k=>o.value=k),"show-time":!0,placeholder:"选择日期和时间",onChange:n},null,8,["value"]),r("p",zn,"选中："+G(o.value),1)]))}}),Ln=`<template>
