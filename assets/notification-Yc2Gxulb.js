import{n as d}from"./notification--17ltc31.js";import{m as u,y as p,i as a,f as n,E as m,l as r,P as l,I as f,j as b}from"./index-BZUMvgWw.js";import"./cls-S9IiI6wd.js";const g={style:{display:"flex",gap:"8px","flex-wrap":"wrap"}},x=u({__name:"NotificationBasic",setup(c){function i(){d.success({message:"操作成功",description:"您的操作已成功完成，请查看详情。"})}function e(){d.error({message:"操作失败",description:"操作过程中发生错误，请稍后重试。"})}function o(){d.warning({message:"警告",description:"此操作存在风险，请谨慎操作。"})}function t(){d.info({message:"提示信息",description:"这是一条普通的提示信息。"})}return(s,C)=>(p(),a("div",g,[n("button",{onClick:i},"成功"),n("button",{onClick:e},"错误"),n("button",{onClick:o},"警告"),n("button",{onClick:t},"信息")]))}}),k=`<template>
