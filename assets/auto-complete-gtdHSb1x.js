...
<\/script>
`,mt={style:{display:"flex","flex-direction":"column",gap:"24px"}},vt=S({__name:"AutoCompleteClassNames",setup(t){const r=u(""),p=u(""),f=u(""),n=u(""),l=u(""),o=[{value:"Vue 3"},{value:"React"},{value:"Angular"},{value:"Svelte"}],g=[{value:"Beijing"},{value:"Shanghai"},{value:"Guangzhou"},{value:"Shenzhen"}],y=[{value:"🍎 Apple",label:"🍎 Apple"},{value:"🍌 Banana",label:"🍌 Banana"},{value:"🍊 Orange",label:"🍊 Orange"},{value:"🍇 Grape",label:"🍇 Grape"}],v=[{value:"Option 1"},{value:"Option 2"},{value:"Option 3"}],x=[{value:"Design System"},{value:"Component Library"},{value:"UI Framework"}];return(b,s)=>(q(),O("div",mt,[i("div",null,[s[5]||(s[5]=i("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义输入框容器样式：",-1)),a(m(h),{modelValue:r.value,"onUpdate:modelValue":s[0]||(s[0]=k=>r.value=k),options:o,placeholder:"输入内容搜索...","class-names":{root:"custom-root"}},null,8,["modelValue"])]),i("div",null,[s[6]||(s[6]=i("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义前后缀与清除按钮：",-1)),a(m(h),{modelValue:p.value,"onUpdate:modelValue":s[1]||(s[1]=k=>p.value=k),options:g,placeholder:"搜索...","allow-clear":"","class-names":{prefix:"custom-prefix",suffix:"custom-suffix",clear:"custom-clear"}},{prefix:C(()=>[a(m(X))]),_:1},8,["modelValue"])]),i("div",null,[s[7]||(s[7]=i("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义下拉面板与选项：",-1)),a(m(h),{modelValue:f.value,"onUpdate:modelValue":s[2]||(s[2]=k=>f.value=k),options:y,placeholder:"选择水果...","class-names":{dropdown:"custom-dropdown",option:"custom-option"}},null,8,["modelValue"])]),i("div",null,[s[8]||(s[8]=i("div",{style:{"margin-bottom":"8px",color:"#666"}},"使用内联样式：",-1)),a(m(h),{modelValue:n.value,"onUpdate:modelValue":s[3]||(s[3]=k=>n.value=k),options:v,placeholder:"动态样式...","allow-clear":"",styles:{root:{borderRadius:"20px",borderColor:"#722ed1"},input:{color:"#722ed1",fontWeight:"bold"},clear:{color:"#eb2f96"}}},null,8,["modelValue"])]),i("div",null,[s[9]||(s[9]=i("div",{style:{"margin-bottom":"8px",color:"#666"}},"组合使用 classNames 和 styles：",-1)),a(m(h),{modelValue:l.value,"onUpdate:modelValue":s[4]||(s[4]=k=>l.value=k),options:x,placeholder:"组合样式定制...","allow-clear":"","class-names":{root:"custom-combined-root",dropdown:"custom-combined-dropdown"},styles:{input:{fontSize:"16px"}}},{prefix:C(()=>[a(m(X))]),_:1},8,["modelValue"])])]))}}),ft=at(vt,[["__scopeId","data-v-a2dba500"]]),gt=`<template>
