import{S as p}from"./Select-D_N5z-mT.js";import{n as b,z as c,j as v,m as o,J as a,g as e,I as h,D as u,l as r,_ as f,G as y,Q as g,k as S}from"./index-bv5A37HL.js";import"./cls-S9IiI6wd.js";import"./VirtualList-41ffnqds.js";const w={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"300px"}},_=b({__name:"SelectBasic",setup(m){const d=u(""),s=u(""),i=[{label:"Vue",value:"vue"},{label:"React",value:"react"},{label:"Angular",value:"angular"},{label:"Svelte（禁用）",value:"svelte",disabled:!0}];return(t,l)=>(c(),v("div",w,[o(a(p),{value:d.value,"onUpdate:value":l[0]||(l[0]=n=>d.value=n),options:i,placeholder:"请选择",style:{width:"100%"}},null,8,["value"]),o(a(p),{value:s.value,"onUpdate:value":l[1]||(l[1]=n=>s.value=n),options:i,placeholder:"禁用状态",disabled:"",style:{width:"100%"}},null,8,["value"]),e("p",null,"选中："+h(d.value),1)]))}}),V=`<template>
