import{S as r,a as m,b}from"./index-DLUhhIBQ.js";import{n as u,z as s,h as f,J as o,j as h,m as d,Q as a,g as e,l as v,D as k,G as g,k as x}from"./index-DBrYVvYd.js";import{B as S}from"./Button-dLk1ExkL.js";import"./cls-S9IiI6wd.js";import"./icons-CTzpiRs0.js";import"./Icon-CiCvy_Uq.js";const y=u({__name:"SkeletonActive",setup(p){return(n,l)=>(s(),f(o(r),{active:""}))}}),_=`<template>
  <Skeleton active />
</template>
...
<\/script>
`,B={style:{display:"flex","flex-direction":"column",gap:"16px"}},w=u({__name:"SkeletonAvatar",setup(p){return(n,l)=>(s(),h("div",B,[d(o(r).Avatar,{active:""}),d(o(r).Avatar,{active:"",size:"large"}),d(o(r).Avatar,{active:"",shape:"square"})]))}}),P=`<template>
...
import { Skeleton } from 'ant-design-hmfw'
<\/script>
`,A=u({__name:"SkeletonBasic",setup(p){return(n,l)=>(s(),f(o(r)))}}),I=`<template>
  <Skeleton />
</template>
