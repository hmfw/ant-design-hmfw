import{B as v}from"./Button-vU6fU06D.js";import{m as y,L as k,o as _,l as n,d as h,B as A,z as N,y as w,g as B,P as s,I as d,k as b,A as C,E as O,i as P,f,j as z}from"./index-BZUMvgWw.js";import{c as S}from"./cls-S9IiI6wd.js";import{I as x,a as E}from"./Input-ClHj9Erp.js";import{I as V}from"./InputNumber-Bd34V6xE.js";import"./icons-ef0p77fA.js";import"./Icon-BOmCTdv5.js";const j=Symbol("form-context");async function U(e,a){for(const r of a){if(r.required&&(e==null||e===""))return r.message??"此字段为必填项";if(r.min!==void 0&&typeof e=="string"&&e.length<r.min)return r.message??`最少 ${r.min} 个字符`;if(r.max!==void 0&&typeof e=="string"&&e.length>r.max)return r.message??`最多 ${r.max} 个字符`;if(r.pattern&&!r.pattern.test(String(e??"")))return r.message??"格式不正确";if(r.type==="email"&&e&&!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(String(e)))return r.message??"请输入有效的邮箱地址";if(r.validator)try{await r.validator(r,e)}catch(o){return(o==null?void 0:o.message)??String(o)??"验证失败"}}return null}const $=y({name:"Form",props:{model:Object,rules:Object,layout:{type:String,default:"horizontal"},labelCol:Object,wrapperCol:Object,colon:{type:Boolean,default:!0},labelAlign:{type:String,default:"right"},size:{type:String,default:"middle"},disabled:Boolean,scrollToFirstError:Boolean,validateTrigger:[String,Array]},emits:["finish","finishFailed","valuesChange"],setup(e,{slots:a,emit:r}){const o=k("form"),t=A({}),m=async l=>{var F,R;const u=(F=e.rules)==null?void 0:F[l];if(!u)return!0;const c=Array.isArray(u)?u:[u],I=(R=e.model)==null?void 0:R[l],g=await U(I,c);if(g)return t.value={...t.value,[l]:g},!1;{const q={...t.value};return delete q[l],t.value=q,!0}};N(j,{get model(){return e.model??{}},get rules(){return e.rules??{}},get layout(){return e.layout},get colon(){return e.colon},get labelAlign(){return e.labelAlign},get size(){return e.size},get disabled(){return e.disabled??!1},get errors(){return t.value},setError:(l,u)=>{t.value={...t.value,[l]:u}},clearError:l=>{const u={...t.value};delete u[l],t.value=u},validateField:m});const i=async l=>{l.preventDefault();const u=Object.keys(e.rules??{});(await Promise.all(u.map(m))).every(Boolean)?r("finish",e.model):r("finishFailed",{values:e.model,errorFields:Object.entries(t.value).map(([g,F])=>({name:g,errors:[F]}))})};return()=>{var l;return n("form",{class:S(o,`${o}-${e.layout}`,{[`${o}-${e.size}`]:e.size!=="middle"}),onSubmit:i},[(l=a.default)==null?void 0:l.call(a)])}}}),p=y({name:"FormItem",props:{name:[String,Array],label:String,rules:[Object,Array],required:Boolean,colon:{type:Boolean,default:void 0},labelCol:Object,wrapperCol:Object,validateStatus:String,help:String,extra:String,hasFeedback:Boolean,noStyle:Boolean,hidden:Boolean,tooltip:String},setup(e,{slots:a}){const r=k("form"),o=_(j),t=h(()=>e.name?Array.isArray(e.name)?e.name.join("."):e.name:""),m=h(()=>e.validateStatus==="error"&&e.help?e.help:t.value?o==null?void 0:o.errors[t.value]:void 0),i=h(()=>e.validateStatus?e.validateStatus:m.value?"error":""),l=h(()=>{if(e.required)return!0;const c=e.rules??(o==null?void 0:o.rules[t.value]);return c?(Array.isArray(c)?c:[c]).some(g=>g.required):!1}),u=h(()=>e.colon!==void 0?e.colon:(o==null?void 0:o.colon)??!0);return e.noStyle?()=>{var c;return(c=a.default)==null?void 0:c.call(a)}:e.hidden?()=>{var c;return n("div",{style:{display:"none"}},[(c=a.default)==null?void 0:c.call(a)])}:()=>{var c;return n("div",{class:S(`${r}-item`,{[`${r}-item-has-error`]:i.value==="error",[`${r}-item-has-warning`]:i.value==="warning",[`${r}-item-has-success`]:i.value==="success",[`${r}-item-required`]:l.value})},[e.label!==void 0&&n("div",{class:`${r}-item-label`},[n("label",{class:S({[`${r}-item-no-colon`]:!u.value})},[e.label])]),n("div",{class:`${r}-item-control`},[n("div",{class:`${r}-item-control-input`},[(c=a.default)==null?void 0:c.call(a)]),(m.value||e.help)&&n("div",{class:S(`${r}-item-explain`,{[`${r}-item-explain-error`]:i.value==="error",[`${r}-item-explain-warning`]:i.value==="warning",[`${r}-item-explain-success`]:i.value==="success"})},[m.value??e.help]),e.extra&&n("div",{class:`${r}-item-extra`},[e.extra])])])}}}),T=y({__name:"FormBasic",setup(e){const a=C({username:"",password:""}),r=t=>{console.log("表单提交：",t)},o=()=>{a.username="",a.password=""};return(t,m)=>(w(),B(d($),{model:a,"label-col":{span:6},"wrapper-col":{span:18},style:{"max-width":"480px"},onFinish:r},{default:s(()=>[n(d(p),{label:"用户名",name:"username",rules:[{required:!0,message:"请输入用户名"}]},{default:s(()=>[n(d(x),{value:a.username,"onUpdate:value":m[0]||(m[0]=i=>a.username=i),placeholder:"请输入用户名"},null,8,["value"])]),_:1}),n(d(p),{label:"密码",name:"password",rules:[{required:!0,message:"请输入密码"}]},{default:s(()=>[n(d(E),{value:a.password,"onUpdate:value":m[1]||(m[1]=i=>a.password=i),placeholder:"请输入密码"},null,8,["value"])]),_:1}),n(d(p),{"wrapper-col":{offset:6,span:18}},{default:s(()=>[n(d(v),{type:"primary","html-type":"submit"},{default:s(()=>[...m[2]||(m[2]=[b("提交",-1)])]),_:1}),n(d(v),{style:{"margin-left":"8px"},onClick:o},{default:s(()=>[...m[3]||(m[3]=[b("重置",-1)])]),_:1})]),_:1})]),_:1},8,["model"]))}}),L=`<template>
  <Form
    :model="formState"
    :label-col="{ span: 6 }"
    :wrapper-col="{ span: 18 }"
...
<\/script>
`,D=y({__name:"FormInline",setup(e){const a=C({name:"",age:null}),r=o=>{console.log("搜索：",o)};return(o,t)=>(w(),B(d($),{model:a,layout:"inline",onFinish:r},{default:s(()=>[n(d(p),{label:"姓名",name:"name"},{default:s(()=>[n(d(x),{value:a.name,"onUpdate:value":t[0]||(t[0]=m=>a.name=m),placeholder:"请输入姓名"},null,8,["value"])]),_:1}),n(d(p),{label:"年龄",name:"age"},{default:s(()=>[n(d(V),{value:a.age,"onUpdate:value":t[1]||(t[1]=m=>a.age=m),placeholder:"年龄",style:{width:"100px"}},null,8,["value"])]),_:1}),n(d(p),null,{default:s(()=>[n(d(v),{type:"primary","html-type":"submit"},{default:s(()=>[...t[2]||(t[2]=[b("搜索",-1)])]),_:1})]),_:1})]),_:1},8,["model"]))}}),K=`<template>
  <Form
    :model="formState"
    layout="inline"
    @finish="handleSearch"
