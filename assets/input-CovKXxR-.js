import{I as p,a as y,b as g,T as w}from"./Input-BZuH9R3e.js";import{m as x,y as c,i as v,l as d,I as l,B as u,f as n,H as I,E as S,P as f,j as k}from"./index-D5ELMp0l.js";import"./icons-B2D3pXlE.js";import"./cls-S9IiI6wd.js";const U={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"400px"}},N=x({__name:"InputAddon",setup(h){const o=u(""),r=u(""),a=u("");return(t,e)=>(c(),v("div",U,[d(l(p),{value:o.value,"onUpdate:value":e[0]||(e[0]=s=>o.value=s),placeholder:"请输入用户名",prefix:"👤"},null,8,["value"]),d(l(p),{value:r.value,"onUpdate:value":e[1]||(e[1]=s=>r.value=s),placeholder:"请输入金额",prefix:"¥",suffix:"元"},null,8,["value"]),d(l(p),{value:a.value,"onUpdate:value":e[2]||(e[2]=s=>a.value=s),placeholder:"支持清除","allow-clear":""},null,8,["value"])]))}}),P=`<template>
