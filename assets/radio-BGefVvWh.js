import{R as x,a as v}from"./index-B2_rCCPR.js";import{m as h,y as c,i as f,l as n,I as a,P as m,k as g,f as t,H as b,B as u,E as R,j as k}from"./index-B2-fWtt3.js";import"./cls-S9IiI6wd.js";const z={style:{display:"flex","flex-direction":"column",gap:"8px"}},G=h({__name:"RadioBasic",setup(y){const i=u(!1),s=u(!1),r=u(!0);return(e,d)=>(c(),f("div",z,[n(a(x),{checked:i.value,"onUpdate:checked":d[0]||(d[0]=l=>i.value=l)},{default:m(()=>[...d[3]||(d[3]=[g("单选框",-1)])]),_:1},8,["checked"]),n(a(x),{checked:s.value,"onUpdate:checked":d[1]||(d[1]=l=>s.value=l),disabled:""},{default:m(()=>[...d[4]||(d[4]=[g("禁用单选框",-1)])]),_:1},8,["checked"]),n(a(x),{checked:r.value,"onUpdate:checked":d[2]||(d[2]=l=>r.value=l),disabled:""},{default:m(()=>[...d[5]||(d[5]=[g("禁用选中",-1)])]),_:1},8,["checked"]),t("p",null,"checked: "+b(i.value),1)]))}}),B=`<template>
