import{B as p}from"./Button-mNkoEchB.js";import{m as s}from"./message-CLoSA5Kq.js";import{o as m,A as g,k,n,K as d,R as i,m as e,i as w,H as x,h as o,l as b}from"./index-B09KCCs0.js";import"./icons-n88SZ_u-.js";import"./cls-S9IiI6wd.js";import"./Icon-BGDem5mI.js";const y={style:{display:"flex",gap:"8px","flex-wrap":"wrap"}},C=m({__name:"MessageBasic",setup(f){function l(){s.success("操作成功！")}function u(){s.error("操作失败，请重试。")}function c(){s.warning("请注意此操作的风险。")}function t(){s.info("这是一条普通提示信息。")}function a(){s.loading("正在加载中...")}return(W,r)=>(g(),k("div",y,[n(d(p),{onClick:l},{default:i(()=>[...r[0]||(r[0]=[e(" 成功 ",-1)])]),_:1}),n(d(p),{onClick:u},{default:i(()=>[...r[1]||(r[1]=[e(" 错误 ",-1)])]),_:1}),n(d(p),{onClick:c},{default:i(()=>[...r[2]||(r[2]=[e(" 警告 ",-1)])]),_:1}),n(d(p),{onClick:t},{default:i(()=>[...r[3]||(r[3]=[e(" 信息 ",-1)])]),_:1}),n(d(p),{onClick:a},{default:i(()=>[...r[4]||(r[4]=[e(" 加载中 ",-1)])]),_:1})]))}}),B=`<template>
...
<\/script>
`,h={style:{display:"flex",gap:"8px","flex-wrap":"wrap"}},v=m({__name:"MessageConfig",setup(f){function l(){s.config({maxCount:3,top:100}),s.info("已应用全局配置")}function u(){for(let c=1;c<=5;c++)s.info(`第 ${c} 条消息`)}return(c,t)=>(g(),k("div",h,[n(d(p),{onClick:l},{default:i(()=>[...t[0]||(t[0]=[e(" 设置 maxCount = 3 / top = 100 ",-1)])]),_:1}),n(d(p),{onClick:u},{default:i(()=>[...t[1]||(t[1]=[e(" 连续弹出 5 条 ",-1)])]),_:1})]))}}),_=`<template>
  <div style="display: flex; gap: 8px; flex-wrap: wrap">
...
<\/script>
`,M={style:{display:"flex",gap:"8px"}},S=m({__name:"MessageDuration",setup(f){function l(){s.success("这条消息将显示 10 秒",10)}function u(){const t=s.warning("点我手动关闭",0);setTimeout(t,5e3)}function c(){s.info("关闭后将触发回调",2).then(()=>{s.success("消息已关闭！")})}return(t,a)=>(g(),k("div",M,[n(d(p),{onClick:l},{default:i(()=>[...a[0]||(a[0]=[e(" 显示 10 秒 ",-1)])]),_:1}),n(d(p),{onClick:u},{default:i(()=>[...a[1]||(a[1]=[e(" 不自动关闭 ",-1)])]),_:1}),n(d(p),{onClick:c},{default:i(()=>[...a[2]||(a[2]=[e(" 关闭后回调 ",-1)])]),_:1})]))}}),H=`<template>
...
<\/script>
`,O={style:{display:"flex",gap:"8px","flex-wrap":"wrap"}},T=m({__name:"MessagePauseOnHover",setup(f){function l(){s.config({pauseOnHover:!0}),s.info("悬停时暂停计时，移开继续计时",5)}function u(){s.config({pauseOnHover:!1}),s.warning("悬停时不暂停计时，5 秒后自动关闭",5)}function c(){s.config({pauseOnHover:!0}),s.open({content:"这条消息悬停时不暂停",type:"success",duration:5,pauseOnHover:!1})}return(t,a)=>(g(),k("div",O,[n(d(p),{onClick:l},{default:i(()=>[...a[0]||(a[0]=[e(" 悬停暂停（默认） ",-1)])]),_:1}),n(d(p),{onClick:u},{default:i(()=>[...a[1]||(a[1]=[e(" 悬停不暂停 ",-1)])]),_:1}),n(d(p),{onClick:c},{default:i(()=>[...a[2]||(a[2]=[e(" 单独配置 ",-1)])]),_:1})]))}}),$=`<template>
  <div style="display: flex; gap: 8px; flex-wrap: wrap">
...
<\/script>
`,N={style:{display:"flex",gap:"8px","flex-wrap":"wrap"}},V=m({__name:"MessagePosition",setup(f){function l(){s.config({top:8}),s.info("默认顶部显示，距离 8px")}function u(){s.config({top:100}),s.success("自定义顶部距离 100px")}return(c,t)=>(g(),k("div",N,[n(d(p),{onClick:l},{default:i(()=>[...t[0]||(t[0]=[e(" 顶部显示（默认） ",-1)])]),_:1}),n(d(p),{onClick:u},{default:i(()=>[...t[1]||(t[1]=[e(" 顶部自定义距离 ",-1)])]),_:1})]))}}),E=`<template>
  <div style="display: flex; gap: 8px; flex-wrap: wrap">
...
<\/script>
`,L=m({__name:"MessageUpdate",setup(f){function l(){const u="updatable";s.loading({content:"加载中...",key:u,duration:0}),setTimeout(()=>{s.success({content:"加载完成！",key:u,duration:2})},1500)}return(u,c)=>(g(),w(d(p),{onClick:l},{default:i(()=>[...c[0]||(c[0]=[e(" 开始加载 ",-1)])]),_:1}))}}),D=`<template>
