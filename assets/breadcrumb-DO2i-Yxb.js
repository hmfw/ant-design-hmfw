...
`,ft={style:{"margin-top":"8px",color:"#666"}},gt=k({__name:"BreadcrumbClick",setup(n){const e=J("无"),a=[{title:"首页",onClick:()=>{e.value="首页"}},{title:"应用列表",onClick:()=>{e.value="应用列表"}},{title:"某应用"}];return(r,t)=>(f(),V(U,null,[o(l(i),{items:a}),s("p",ft,"点击了："+G(e.value),1)],64))}}),bt=`<template>
  <Breadcrumb :items="items" />
