import{A as a,a as c}from"./Avatar-DnJrZpg2.js";import{o as v,A as l,k as p,n as e,K as d,R as n,m as i,h as s,H as x,l as g}from"./index-C69_RY61.js";import{U as f}from"./UserOutlined-Jc0LbvEW.js";import"./cls-S9IiI6wd.js";const A={style:{display:"flex",gap:"16px","align-items":"center"}},b=v({__name:"AvatarBasic",setup(m){return(o,r)=>(l(),p("div",A,[e(d(a),{size:64,src:"https://api.dicebear.com/7.x/miniavs/svg?seed=1"}),e(d(a),{size:64},{default:n(()=>[...r[0]||(r[0]=[i(" U ",-1)])]),_:1}),e(d(a),{size:64,style:{"background-color":"#87d068"}},{default:n(()=>[...r[1]||(r[1]=[i(" USER ",-1)])]),_:1})]))}}),y=`<template>
