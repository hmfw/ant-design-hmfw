...
<\/script>
`,V={style:{display:"flex","flex-direction":"column",gap:"16px"}},W={style:{display:"flex","align-items":"center",gap:"16px"}},A={style:{display:"flex","align-items":"center",gap:"16px"}},L=m({__name:"SwitchSize",setup(h){const o=d(!0),p=d(!0);return(i,n)=>(k(),f("div",V,[t("div",W,[e(c(l),{checked:o.value,"onUpdate:checked":n[0]||(n[0]=s=>o.value=s)},null,8,["checked"]),n[3]||(n[3]=t("span",null,"默认大小",-1))]),t("div",A,[e(c(l),{checked:p.value,"onUpdate:checked":n[1]||(n[1]=s=>p.value=s),size:"small"},null,8,["checked"]),e(c(l),{checked:p.value,"onUpdate:checked":n[2]||(n[2]=s=>p.value=s),size:"small","checked-children":"on","un-checked-children":"off"},null,8,["checked"]),n[4]||(n[4]=t("span",null,"小号开关",-1))])]))}}),M=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px">
