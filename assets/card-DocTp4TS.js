import{C as o,a as y}from"./index-B4XVCKGm.js";import{n as m,z as p,h as c,Q as n,g as d,J as a,m as r,l as s,D as g,j as f,I as h,G as x,k as v}from"./index-bv5A37HL.js";import"./cls-S9IiI6wd.js";const w=m({__name:"CardBasic",setup(u){return(i,e)=>(p(),c(a(o),{title:"卡片标题",style:{width:"300px"}},{default:n(()=>[...e[0]||(e[0]=[d("p",null,"卡片内容",-1),d("p",null,"卡片内容",-1),d("p",null,"卡片内容",-1)])]),_:1}))}}),_=`<template>
...
import { Card } from 'ant-design-hmfw'
<\/script>
`,K=m({__name:"CardLoading",setup(u){const i=g(!0);return(e,b)=>(p(),c(a(o),{title:"卡片标题",loading:i.value,style:{width:"300px"}},{default:n(()=>[...b[0]||(b[0]=[d("p",null,"卡片内容",-1),d("p",null,"卡片内容",-1)])]),_:1},8,["loading"]))}}),L=`<template>
