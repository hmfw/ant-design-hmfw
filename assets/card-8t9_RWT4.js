import{C as p,a as h}from"./index-R9XgBJUq.js";import{d as u,o as c,q as m,w as s,f as t,e as o,b as g,c as e,_ as y,g as d,r as f,A as x,h as C,i as v}from"./index-BOp1Gurx.js";import"./cls-S9IiI6wd.js";const w=u({__name:"CardBasic",setup(i){return(r,n)=>(c(),m(o(p),{title:"卡片标题",style:{width:"300px"}},{default:s(()=>[...n[0]||(n[0]=[t("p",null,"卡片内容",-1),t("p",null,"卡片内容",-1),t("p",null,"卡片内容",-1)])]),_:1}))}}),q=`<template>
...
<\/script>
`,S={class:"demo-card-classnames"},N={class:"demo-section"},G={class:"demo-section"},_={class:"demo-section"},T={class:"demo-section"},E={class:"demo-section"},B={class:"demo-section"},P={class:"demo-section"},A={class:"demo-section"},M=u({__name:"CardClassNames",setup(i){return(r,n)=>(c(),g("div",S,[t("section",N,[n[1]||(n[1]=t("h3",null,"1. 自定义根节点样式",-1)),e(o(p),{title:"自定义根节点","class-names":{root:"custom-root"}},{default:s(()=>[...n[0]||(n[0]=[t("p",null,"这是一个自定义根节点样式的卡片",-1)])]),_:1})]),t("section",G,[n[3]||(n[3]=t("h3",null,"2. 自定义头部样式",-1)),e(o(p),{title:"自定义头部","class-names":{head:"custom-head"}},{default:s(()=>[...n[2]||(n[2]=[t("p",null,"这是一个自定义头部样式的卡片",-1)])]),_:1})]),t("section",_,[n[5]||(n[5]=t("h3",null,"3. 自定义标题样式",-1)),e(o(p),{title:"渐变标题","class-names":{title:"custom-title"}},{default:s(()=>[...n[4]||(n[4]=[t("p",null,"这是一个自定义标题样式的卡片",-1)])]),_:1})]),t("section",T,[n[8]||(n[8]=t("h3",null,"4. 自定义扩展区域样式",-1)),e(o(p),{title:"标题","class-names":{extra:"custom-extra"}},{extra:s(()=>[...n[6]||(n[6]=[t("a",{href:"#"},"更多",-1)])]),default:s(()=>[n[7]||(n[7]=t("p",null,"这是一个自定义扩展区域样式的卡片",-1))]),_:1})]),t("section",E,[n[10]||(n[10]=t("h3",null,"5. 自定义主体内容样式",-1)),e(o(p),{title:"主体样式","class-names":{body:"custom-body"}},{default:s(()=>[...n[9]||(n[9]=[t("p",null,"这是一个自定义主体样式的卡片",-1),t("p",null,"内容可以有多个段落",-1)])]),_:1})]),t("section",B,[n[13]||(n[13]=t("h3",null,"6. 自定义操作区域样式",-1)),e(o(p),{title:"操作样式","class-names":{actions:"custom-actions"}},{actions:s(()=>[...n[11]||(n[11]=[t("li",null,[t("a",null,"设置")],-1),t("li",null,[t("a",null,"编辑")],-1),t("li",null,[t("a",null,"删除")],-1)])]),default:s(()=>[n[12]||(n[12]=t("p",null,"这是一个自定义操作区域样式的卡片",-1))]),_:1})]),t("section",P,[n[18]||(n[18]=t("h3",null,"7. 组合使用多个 classNames",-1)),e(o(p),{title:"综合样式","class-names":{root:"combined-root",head:"combined-head",title:"combined-title",body:"combined-body",actions:"combined-actions"}},{extra:s(()=>[...n[14]||(n[14]=[t("a",{href:"#"},"操作",-1)])]),actions:s(()=>[...n[15]||(n[15]=[t("li",null,[t("a",null,"操作 1")],-1),t("li",null,[t("a",null,"操作 2")],-1)])]),default:s(()=>[n[16]||(n[16]=t("p",null,"这是一个组合多个自定义样式的卡片",-1)),n[17]||(n[17]=t("p",null,"所有部分都有自定义样式",-1))]),_:1})]),t("section",A,[n[20]||(n[20]=t("h3",null,"8. 使用 styles 动态样式",-1)),e(o(p),{title:"动态样式卡片",styles:{root:{border:"2px solid #1890ff",borderRadius:"12px"},head:{background:"linear-gradient(135deg, #667eea 0%, #764ba2 100%)",color:"white"},title:{fontWeight:"bold",fontSize:"18px"},body:{padding:"24px",background:"#f0f2f5"}}},{default:s(()=>[...n[19]||(n[19]=[t("p",null,"这是一个使用动态样式的卡片",-1)])]),_:1})])]))}}),$=y(M,[["__scopeId","data-v-5cf5e317"]]),z=`<template>
...
`,K=u({__name:"CardCover",setup(i){return(r,n)=>(c(),m(o(p),{style:{width:"300px"}},{cover:s(()=>[...n[0]||(n[0]=[t("img",{alt:"example",src:"https://gw.alipayobjects.com/zos/rmsportal/JiqGstEfoWAOHiTxclqi.png",style:{width:"100%"}},null,-1)])]),default:s(()=>[e(o(h),{title:"卡片标题",description:"这是卡片的描述信息"})]),_:1}))}}),L=`<template>
...
<\/script>
`,D=u({__name:"CardGrid",setup(i){return(r,n)=>(c(),m(o(p),{title:"网格卡片"},{default:s(()=>[e(o(p).Grid,null,{default:s(()=>[...n[0]||(n[0]=[d("内容 1",-1)])]),_:1}),e(o(p).Grid,null,{default:s(()=>[...n[1]||(n[1]=[d("内容 2",-1)])]),_:1}),e(o(p).Grid,null,{default:s(()=>[...n[2]||(n[2]=[d("内容 3",-1)])]),_:1}),e(o(p).Grid,null,{default:s(()=>[...n[3]||(n[3]=[d("内容 4",-1)])]),_:1}),e(o(p).Grid,null,{default:s(()=>[...n[4]||(n[4]=[d("内容 5",-1)])]),_:1}),e(o(p).Grid,null,{default:s(()=>[...n[5]||(n[5]=[d("内容 6",-1)])]),_:1})]),_:1}))}}),I=`<template>
  <Card title="网格卡片">
...
import { Card } from '@hmfw/ant-design'
<\/script>
`,R=u({__name:"CardInner",setup(i){return(r,n)=>(c(),m(o(p),{type:"inner",title:"内部卡片"},{default:s(()=>[...n[0]||(n[0]=[t("p",null,'type="inner" 用于卡片内部嵌套展示。',-1)])]),_:1}))}}),V=`<template>
...
import { Card } from '@hmfw/ant-design'
<\/script>
`,W=u({__name:"CardLoading",setup(i){const r=f(!0);return(n,k)=>(c(),m(o(p),{title:"卡片标题",loading:r.value,style:{width:"300px"}},{default:s(()=>[...k[0]||(k[0]=[t("p",null,"卡片内容",-1),t("p",null,"卡片内容",-1)])]),_:1},8,["loading"]))}}),O=`<template>
...
<\/script>
`,j={style:{display:"flex",gap:"16px"}},F=u({__name:"CardLoadingAvatar",setup(i){return(r,n)=>(c(),g("div",j,[e(o(p),{loading:{avatar:!0,paragraph:{rows:4}},style:{width:"300px"}},{default:s(()=>[e(o(p).Meta,{title:"Card title",description:"This is the description"},{avatar:s(()=>[...n[0]||(n[0]=[t("img",{src:"https://via.placeholder.com/48",alt:"avatar",style:{"border-radius":"50%"}},null,-1)])]),_:1})]),_:1}),e(o(p),{loading:{paragraph:{rows:3}},style:{width:"300px"}},{default:s(()=>[...n[1]||(n[1]=[t("p",null,"Card content",-1)])]),_:1})]))}}),H=`<template>
...
import { Card } from '@hmfw/ant-design'
<\/script>
`,J=u({__name:"CardTabs",setup(i){const r=[{key:"tab1",label:"选项卡一"},{key:"tab2",label:"选项卡二"},{key:"tab3",label:"选项卡三"}],n={tab1:"选项卡一的内容",tab2:"选项卡二的内容",tab3:"选项卡三的内容"},k=f("tab1"),a=l=>{k.value=l,console.log("Tab changed:",l)};return(l,b)=>(c(),m(o(p),{title:"卡片标题","tab-list":r,"active-tab-key":k.value,onTabChange:a},{tabBarExtraContent:s(()=>[...b[0]||(b[0]=[t("a",{href:"#"},"更多",-1)])]),default:s(()=>[t("p",null,x(n[k.value]),1)]),_:1},8,["active-tab-key"]))}}),Y=`<template>
...
<span class="token selector">:deep(.my-card-root)</span> <span class="token punctuation">{</span>
...
<span class="token selector">:deep(.my-card-head)</span> <span class="token punctuation">{</span>
  <span class="token property">background</span><span class="token punctuation">:</span> <span class="token function">linear-gradient</span><span class="token punctuation">(</span>to right<span class="token punctuation">,</span> #667eea<span class="token punctuation">,</span> #764ba2<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>

<span class="token selector">:deep(.my-card-title)</span> <span class="token punctuation">{</span>
  <span class="token property">color</span><span class="token punctuation">:</span> white<span class="token punctuation">;</span>
  <span class="token property">font-weight</span><span class="token punctuation">:</span> bold<span class="token punctuation">;</span>
<span class="token punctuation">}</span>

<span class="token selector">:deep(.my-card-body)</span> <span class="token punctuation">{</span>
  <span class="token property">padding</span><span class="token punctuation">:</span> 24px<span class="token punctuation">;</span>
<span class="token punctuation">}</span>

<span class="token selector">:deep(.my-card-actions)</span> <span class="token punctuation">{</span>
