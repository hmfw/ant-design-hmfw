import{B as i}from"./Button-DUAUyor1.js";import{m as e}from"./message-CpQtC2yj.js";import{d as m,o as g,b as f,c as t,e as p,w as c,g as a,f as s,_ as b,q as w,h as x,i as h}from"./index-D624MvcT.js";import"./cls-S9IiI6wd.js";import"./LoadingOutlined-YZYQjBMp.js";import"./CheckCircleFilled-1JMJDz9z.js";import"./CloseCircleFilled-BkPSf2w8.js";import"./ExclamationCircleFilled-BTPTYg5w.js";import"./InfoCircleFilled-DcG4HFtO.js";const v={style:{display:"flex",gap:"8px","flex-wrap":"wrap"}},C=m({__name:"MessageBasic",setup(k){function r(){e.success("操作成功！")}function u(){e.error("操作失败，请重试。")}function d(){e.warning("请注意此操作的风险。")}function n(){e.info("这是一条普通提示信息。")}function l(){e.loading("正在加载中...")}return(y,o)=>(g(),f("div",v,[t(p(i),{onClick:r},{default:c(()=>[...o[0]||(o[0]=[a(" 成功 ",-1)])]),_:1}),t(p(i),{onClick:u},{default:c(()=>[...o[1]||(o[1]=[a(" 错误 ",-1)])]),_:1}),t(p(i),{onClick:d},{default:c(()=>[...o[2]||(o[2]=[a(" 警告 ",-1)])]),_:1}),t(p(i),{onClick:n},{default:c(()=>[...o[3]||(o[3]=[a(" 信息 ",-1)])]),_:1}),t(p(i),{onClick:l},{default:c(()=>[...o[4]||(o[4]=[a(" 加载中 ",-1)])]),_:1})]))}}),B=`<template>
...
`,T={style:{display:"flex",gap:"8px","flex-wrap":"wrap"}},E=m({__name:"MessageConfig",setup(k){function r(){e.config({maxCount:3,top:100}),e.info("已应用全局配置")}function u(){for(let d=1;d<=5;d++)e.info(`第 ${d} 条消息`)}return(d,n)=>(g(),f("div",T,[t(p(i),{onClick:r},{default:c(()=>[...n[0]||(n[0]=[a(" 设置 maxCount = 3 / top = 100 ",-1)])]),_:1}),t(p(i),{onClick:u},{default:c(()=>[...n[1]||(n[1]=[a(" 连续弹出 5 条 ",-1)])]),_:1})]))}}),q=`<template>
  <div style="display: flex; gap: 8px; flex-wrap: wrap">
...
<\/script>
`,O={style:{display:"flex",gap:"8px"}},H=m({__name:"MessageDuration",setup(k){function r(){e.success("这条消息将显示 10 秒",10)}function u(){const n=e.warning("点我手动关闭",0);setTimeout(n,5e3)}function d(){e.info("关闭后将触发回调",2).then(()=>{e.success("消息已关闭！")})}return(n,l)=>(g(),f("div",O,[t(p(i),{onClick:r},{default:c(()=>[...l[0]||(l[0]=[a(" 显示 10 秒 ",-1)])]),_:1}),t(p(i),{onClick:u},{default:c(()=>[...l[1]||(l[1]=[a(" 不自动关闭 ",-1)])]),_:1}),t(p(i),{onClick:d},{default:c(()=>[...l[2]||(l[2]=[a(" 关闭后回调 ",-1)])]),_:1})]))}}),$=`<template>
...
<\/script>
`,D={style:{display:"flex",gap:"8px","flex-wrap":"wrap"}},P=m({__name:"MessagePauseOnHover",setup(k){function r(){e.config({pauseOnHover:!0}),e.info("悬停时暂停计时，移开继续计时",5)}function u(){e.config({pauseOnHover:!1}),e.warning("悬停时不暂停计时，5 秒后自动关闭",5)}function d(){e.config({pauseOnHover:!0}),e.open({content:"这条消息悬停时不暂停",type:"success",duration:5,pauseOnHover:!1})}return(n,l)=>(g(),f("div",D,[t(p(i),{onClick:r},{default:c(()=>[...l[0]||(l[0]=[a(" 悬停暂停（默认） ",-1)])]),_:1}),t(p(i),{onClick:u},{default:c(()=>[...l[1]||(l[1]=[a(" 悬停不暂停 ",-1)])]),_:1}),t(p(i),{onClick:d},{default:c(()=>[...l[2]||(l[2]=[a(" 单独配置 ",-1)])]),_:1})]))}}),V=`<template>
  <div style="display: flex; gap: 8px; flex-wrap: wrap">
...
<\/script>
`,W={style:{display:"flex",gap:"8px","flex-wrap":"wrap"}},I=m({__name:"MessagePosition",setup(k){function r(){e.config({top:8}),e.info("默认顶部显示，距离 8px")}function u(){e.config({top:100}),e.success("自定义顶部距离 100px")}return(d,n)=>(g(),f("div",W,[t(p(i),{onClick:r},{default:c(()=>[...n[0]||(n[0]=[a(" 顶部显示（默认） ",-1)])]),_:1}),t(p(i),{onClick:u},{default:c(()=>[...n[1]||(n[1]=[a(" 顶部自定义距离 ",-1)])]),_:1})]))}}),L=`<template>
  <div style="display: flex; gap: 8px; flex-wrap: wrap">
...
<\/script>
`,A=m({__name:"MessageUpdate",setup(k){function r(){const u="updatable";e.loading({content:"加载中...",key:u,duration:0}),setTimeout(()=>{e.success({content:"加载完成！",key:u,duration:2})},1500)}return(u,d)=>(g(),w(p(i),{onClick:r},{default:c(()=>[...d[0]||(d[0]=[a(" 开始加载 ",-1)])]),_:1}))}}),R=`<template>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">&gt;</span></span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><p>由于 Message 通过独立的 Vue 应用挂载在 <code>document.body</code> 上，位于业务组件的 DOM 树之外，在 SFC 中编写样式时需用 <code>:global()</code>（或非 scoped 样式）才能命中：</p><pre class="language-vue"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>style</span> <span class="token attr-name">scoped</span><span class="token punctuation">&gt;</span></span>
<span class="token selector">:global(.my-notice)</span> <span class="token punctuation">{</span>
...
<span class="token selector">:global(.my-icon)</span> <span class="token punctuation">{</span>
  <span class="token property">animation</span><span class="token punctuation">:</span> pulse 1s ease-in-out infinite<span class="token punctuation">;</span>
<span class="token punctuation">}</span>
