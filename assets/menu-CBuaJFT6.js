import{B as h}from"./Button-D1WJzeS3.js";import{M as u}from"./Menu-OclyQjB-.js";import{m as p,y as c,i as y,l as n,I as l,P as r,k,H as g,f as e,t as f,B as m,g as v,E as x,j as M}from"./index-CsoOETlJ.js";import"./icons-BOELVDCf.js";import"./Icon-Bu-seQlV.js";import"./cls-S9IiI6wd.js";const _=p({__name:"MenuCollapsed",setup(a){const d=m(!1),s=m(["1"]),i=[{key:"1",label:"导航一",icon:"home"},{key:"2",label:"导航二",icon:"user"},{key:"3",label:"导航三",icon:"setting"}],t=({key:o})=>{s.value=[o]};return(o,b)=>(c(),y("div",null,[n(l(h),{type:"primary",style:{"margin-bottom":"16px"},onClick:b[0]||(b[0]=A=>d.value=!d.value)},{default:r(()=>[k(g(d.value?"展开":"折叠"),1)]),_:1}),e("div",{style:f({width:d.value?"80px":"256px",borderRight:"1px solid #f0f0f0",transition:"width 0.2s"})},[n(l(u),{mode:"inline",items:i,"selected-keys":s.value,"inline-collapsed":d.value,onSelect:t},null,8,["selected-keys","inline-collapsed"])],4)]))}}),S=`<template>
  <div>
    <Button
      type="primary"
