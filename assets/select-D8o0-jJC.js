import{S as u}from"./Select-CJegQkwo.js";import{o as k,A as v,k as g,n as o,L as d,h as t,K as x,E as i,_ as S,m as c,H as N,S as h,l as q}from"./index-7wnt1Cyk.js";import"./cls-S9IiI6wd.js";import"./LoadingOutlined-VcPrAqG4.js";import"./DownOutlined-DHoKTeux.js";import"./Trigger-CiLr3mxg.js";import"./VirtualList-C42pzEzm.js";const C={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"300px"}},V=k({__name:"SelectBasic",setup(b){const e=i(""),p=i(""),r=[{label:"Vue",value:"vue"},{label:"React",value:"react"},{label:"Angular",value:"angular"},{label:"Svelte（禁用）",value:"svelte",disabled:!0}];return(n,a)=>(v(),g("div",C,[o(d(u),{value:e.value,"onUpdate:value":a[0]||(a[0]=s=>e.value=s),options:r,placeholder:"请选择",style:{width:"100%"}},null,8,["value"]),o(d(u),{value:p.value,"onUpdate:value":a[1]||(a[1]=s=>p.value=s),options:r,placeholder:"禁用状态",disabled:"",style:{width:"100%"}},null,8,["value"]),t("p",null,"选中："+x(e.value),1)]))}}),_=`<template>
