import{I as u}from"./InputNumber-30jz5pfv.js";import{o as x,A as v,k as f,n as s,L as l,h as t,K as h,E as c,_ as N,H as I,Q as g,m as r,l as q}from"./index-ON6sqzpw.js";import"./cls-S9IiI6wd.js";const S={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"300px"}},$=x({__name:"InputNumberBasic",setup(b){const o=c(null);return(d,i)=>(v(),f("div",S,[s(l(u),{value:o.value,"onUpdate:value":i[0]||(i[0]=n=>o.value=n),placeholder:"请输入数字",style:{width:"100%"}},null,8,["value"]),s(l(u),{value:o.value,"onUpdate:value":i[1]||(i[1]=n=>o.value=n),disabled:"",placeholder:"禁用状态",style:{width:"100%"}},null,8,["value"]),t("p",null,"当前值："+h(o.value),1)]))}}),C=`<template>
