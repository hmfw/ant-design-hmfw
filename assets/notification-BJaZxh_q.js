import{B as d}from"./Button-C1GEWIg_.js";import{n as p}from"./notification-B7iBz5dE.js";import{o as y,A as m,k as g,n as s,L as o,S as a,m as t,h as c,p as b,_ as v,H as N,l as x}from"./index-8XlzfTv5.js";import{a as w,C}from"./CloseCircleFilled-BGcOiTRa.js";import"./cls-S9IiI6wd.js";import"./LoadingOutlined-DqorBNRC.js";import"./CloseOutlined-Cyc9QAx7.js";import"./ExclamationCircleFilled-DDGeIVID.js";import"./InfoCircleFilled-HaNasUQq.js";const h={style:{display:"flex",gap:"8px","flex-wrap":"wrap"}},B=y({__name:"NotificationBasic",setup(k){function l(){p.success({message:"操作成功",description:"您的操作已成功完成，请查看详情。"})}function u(){p.error({message:"操作失败",description:"操作过程中发生错误，请稍后重试。"})}function e(){p.warning({message:"警告",description:"此操作存在风险，请谨慎操作。"})}function n(){p.info({message:"提示信息",description:"这是一条普通的提示信息。"})}return(i,f)=>(m(),g("div",h,[s(o(d),{onClick:l},{default:a(()=>[...f[0]||(f[0]=[t(" 成功 ",-1)])]),_:1}),s(o(d),{onClick:u},{default:a(()=>[...f[1]||(f[1]=[t(" 错误 ",-1)])]),_:1}),s(o(d),{onClick:e},{default:a(()=>[...f[2]||(f[2]=[t(" 警告 ",-1)])]),_:1}),s(o(d),{onClick:n},{default:a(()=>[...f[3]||(f[3]=[t(" 信息 ",-1)])]),_:1})]))}}),S=`<template>
