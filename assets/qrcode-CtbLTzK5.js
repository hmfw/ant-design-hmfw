...
<\/script>
`,vt={style:{display:"flex",gap:"16px"}},Rt=z({__name:"QRCodeCustomColor",setup(t){return(o,d)=>(A(),H("div",vt,[c(p(x),{value:"https://ant.design",color:"#1677ff"}),c(p(x),{value:"https://ant.design",color:"#52c41a","bg-color":"#f0f0f0"})]))}}),xt=`<template>
...
<\/script>
`,wt={style:{display:"flex",gap:"16px"}},$t=z({__name:"QRCodeStatus",setup(t){function o(){console.log("刷新二维码")}return(d,n)=>(A(),H("div",wt,[c(p(x),{value:"https://ant.design",status:"active"}),c(p(x),{value:"https://ant.design",status:"expired",onRefresh:o}),c(p(x),{value:"https://ant.design",status:"loading"}),c(p(x),{value:"https://ant.design",status:"scanned"})]))}}),Mt=`<template>
  <div style="display: flex; gap: 16px">
...
<\/script>
`,zt={style:{display:"flex",gap:"16px"}},At=z({__name:"QRCodeType",setup(t){return(o,d)=>(A(),H("div",zt,[c(p(x),{value:"https://ant.design",type:"canvas"}),c(p(x),{value:"https://ant.design",type:"svg"})]))}}),Et=`<template>
  <div style="display: flex; gap: 16px">
