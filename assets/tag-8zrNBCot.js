...
import { Tag } from 'ant-design-hmfw'
<\/script>
`,A={style:{display:"flex",gap:"8px","align-items":"center","flex-wrap":"wrap"}},G=T({__name:"TagLinkDisabled",setup(d){return(g,e)=>(p(),b("div",A,[n(l(s),{href:"https://ant.design",target:"_blank"},{default:a(()=>[...e[0]||(e[0]=[o("链接标签",-1)])]),_:1}),n(l(s),{disabled:""},{default:a(()=>[...e[1]||(e[1]=[o("禁用标签",-1)])]),_:1}),n(l(s),{disabled:"",closable:""},{default:a(()=>[...e[2]||(e[2]=[o("禁用且不可关闭",-1)])]),_:1})]))}}),J=`<template>
