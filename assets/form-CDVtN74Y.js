...
isFieldsTouched(所有字段, true): ${i}`},g=()=>{var m;(m=r.value)==null||m.resetFields(),t.username="",t.email="",t.password="",n.value="表单已重置"};return(m,i)=>(T(),R("div",le,[i[8]||(i[8]=p("h4",null,"批量查询 API 演示",-1)),o(l(q),{ref_key:"formRef",ref:r,model:t,rules:a,layout:"vertical",style:{"max-width":"600px"}},{default:s(()=>[o(l(y),{label:"用户名",name:"username"},{default:s(()=>[o(l(k),{value:t.username,"onUpdate:value":i[0]||(i[0]=w=>t.username=w),placeholder:"请输入用户名"},null,8,["value"])]),_:1}),o(l(y),{label:"邮箱",name:"email"},{default:s(()=>[o(l(k),{value:t.email,"onUpdate:value":i[1]||(i[1]=w=>t.email=w),placeholder:"请输入邮箱"},null,8,["value"])]),_:1}),o(l(y),{label:"密码",name:"password"},{default:s(()=>[o(l(k),{value:t.password,"onUpdate:value":i[2]||(i[2]=w=>t.password=w),type:"password",placeholder:"请输入密码"},null,8,["value"])]),_:1}),o(l(y),null,{default:s(()=>[o(l(L),null,{default:s(()=>[o(l(I),{type:"primary",onClick:d},{default:s(()=>[...i[3]||(i[3]=[b(" 验证表单 ",-1)])]),_:1}),o(l(I),{onClick:f},{default:s(()=>[...i[4]||(i[4]=[b(" 获取错误 ",-1)])]),_:1}),o(l(I),{onClick:v},{default:s(()=>[...i[5]||(i[5]=[b(" 检查触摸状态 ",-1)])]),_:1}),o(l(I),{onClick:g},{default:s(()=>[...i[6]||(i[6]=[b(" 重置 ",-1)])]),_:1})]),_:1})]),_:1})]),_:1},8,["model"]),n.value?(T(),R("div",de,[i[7]||(i[7]=p("h5",null,"输出结果：",-1)),p("pre",null,K(n.value),1)])):A("",!0)]))}}),ie=H(se,[["__scopeId","data-v-525d5a1b"]]),ue=`<template>
