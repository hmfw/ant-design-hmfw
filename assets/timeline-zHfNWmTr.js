import{o as m,N as P,n as d,C as F,F as j,A as u,i as g,K as s,k as C,h as i,H as z,R as p,m as f,l as A}from"./index-C69_RY61.js";import{c as x}from"./cls-S9IiI6wd.js";import{I as D}from"./Icon-Bvf6WoCy.js";import{L}from"./LoadingOutlined-De7mgAt0.js";function H(e){return e==="left"?"start":e==="right"?"end":e==="start"||e==="end"||e==="alternate"?e:"start"}function M(e,o,n){return e.placement?e.placement:e.position==="left"?"start":e.position==="right"?"end":n==="alternate"?o%2===0?"start":"end":n}function N(e){if(!e)return[];const o=[];for(const n of e)if(n&&n.type!==F){if(n.type===j&&Array.isArray(n.children)){o.push(...N(n.children));continue}n.props&&o.push(n.props)}return o}const E=m({name:"TimelineItem",props:{title:[String,Object],content:[String,Object],icon:[String,Object],placement:String,loading:Boolean,label:[String,Object],children:null,dot:[String,Object],position:String,color:String,className:String,style:Object},setup(e,{slots:o}){return()=>{var n;return(n=o.default)==null?void 0:n.call(o)}}}),K=m({name:"Timeline",props:{items:Array,mode:{type:String,default:"left"},orientation:{type:String,default:"vertical"},variant:{type:String,default:"outlined"},reverse:Boolean,titleSpan:[Number,String],pending:[Boolean,String,Object],pendingDot:[String,Object]},setup(e,{slots:o}){const n=P("timeline");return()=>{const l=H(e.mode);let t=[];if(e.items)t=[...e.items];else if(o.default){const r=o.default();t=N(r)}if(e.pending){const r=typeof e.pending=="string"?e.pending:e.pending===!0?void 0:e.pending;t.push({content:r,icon:e.pendingDot,loading:!e.pendingDot,color:"gray"})}const c=e.reverse?[...t].reverse():t,w=x(n,{[`${n}-${e.orientation}`]:e.orientation==="horizontal",[`${n}-${l}`]:l!=="start",[`${n}-${e.variant}`]:e.variant!=="outlined",[`${n}-pending`]:!!e.pending,[`${n}-reverse`]:e.reverse}),T={};return e.titleSpan!==void 0&&l!=="alternate"&&(typeof e.titleSpan=="number"?T["--hmfw-timeline-title-span"]=`${e.titleSpan}px`:T["--hmfw-timeline-title-span"]=e.titleSpan),d("ul",{class:w,style:T},[c.map((r,y)=>{const V=y===c.length-1,v=M(r,y,l),$=r.title??r.label,I=r.content??r.children;let b=r.icon??r.dot;r.loading&&!b&&(b=d(D,{component:L,spin:!0},null));const h=r.color??"blue",S=["blue","red","green","gray"].includes(h),k=!!b||r.loading,B=x(`${n}-item`,{[`${n}-item-last`]:V,[`${n}-item-${v}`]:v==="end",[`${n}-item-loading`]:r.loading},r.className),O=x(`${n}-item-head`,{[`${n}-item-head-${h}`]:S,[`${n}-item-head-custom`]:k||!S}),_={...r.style};return S||(_.borderColor=h,_.color=h),d("li",{key:r.key??y,class:B},[$&&d("div",{class:`${n}-item-label`},[$]),d("div",{class:`${n}-item-tail`},null),d("div",{class:O,style:_},[b]),d("div",{class:`${n}-item-content`},[I])])})])}}}),a=K;a.Item=E;const R=m({__name:"TimelineAlternate",setup(e){const o=[{content:"创建服务现场 2015-09-01"},{content:"初步排除网络异常 2015-09-01"},{content:"技术测试异常 2015-09-01"},{content:"网络异常正在修复 2015-09-01"}];return(n,l)=>(u(),g(s(a),{mode:"alternate",items:o}))}}),q=`<template>
...
<\/script>
`,G=m({__name:"TimelineBasic",setup(e){const o=[{content:"创建服务现场 2015-09-01"},{content:"初步排除网络异常 2015-09-01"},{content:"技术测试异常 2015-09-01"},{content:"网络异常正在修复 2015-09-01"}];return(n,l)=>(u(),g(s(a),{items:o}))}}),J=`<template>
...
<\/script>
`,Q=m({__name:"TimelineCustomColor",setup(e){const o=[{content:"成功事件",color:"green"},{content:"失败事件",color:"red"},{content:"警告事件",color:"gray"},{content:"自定义颜色",color:"#00CCFF"}];return(n,l)=>(u(),g(s(a),{items:o}))}}),U=`<template>
  <Timeline :items="items" />
</template>
