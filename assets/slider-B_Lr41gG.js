import{o as E,N as ft,Q as bt,n as d,E as b,f as it,A as M,k as V,h as e,J as $,K as p,_ as xt,H as ht,l as ut,R as P,m as h}from"./index-BIs5wmTl.js";import{c as w}from"./cls-S9IiI6wd.js";import{K as B}from"./event-CZUxRbwU.js";const v=E({name:"Slider",props:{value:[Number,Array],defaultValue:[Number,Array],min:{type:Number,default:0},max:{type:Number,default:100},step:{type:Number,default:1},disabled:Boolean,range:Boolean,vertical:Boolean,reverse:Boolean,marks:Object,tooltip:{type:Object},included:{type:Boolean,default:!0},dots:Boolean,keyboard:{type:Boolean,default:!0},classNames:Object,styles:Object},emits:["update:value","change","afterChange"],setup(t,{emit:i}){const a=ft("slider"),g=b(null),n=b(null),o=b(null),x=s=>Math.min(t.max,Math.max(t.min,s)),R=s=>{if(t.range){const l=Array.isArray(s)?s:[t.min,t.min],[r,c]=l,m=x(r),k=x(c);return[Math.min(m,k),Math.max(m,k)]}return x(typeof s=="number"?s:t.min)},ct=R(t.defaultValue??t.value??(t.range?[0,0]:0)),O=b(ct),pt=it(()=>t.value!==void 0),N=it(()=>{const s=pt.value?t.value:O.value;return R(s)});bt(()=>t.value,s=>{s!==void 0&&(O.value=R(s))});const mt=()=>t.marks?Object.keys(t.marks).map(Number).sort((s,l)=>s-l):[],L=s=>{if(t.step===null){const r=mt();return[t.min,...r,t.max].reduce((k,y)=>Math.abs(y-s)<Math.abs(k-s)?y:k)}const l=Math.round((s-t.min)/t.step);return x(t.min+l*t.step)},D=s=>(s-t.min)/(t.max-t.min)*100,W=s=>{if(!g.value)return 0;const l=g.value.getBoundingClientRect(),r="touches"in s?s.touches[0].clientX:s.clientX,c="touches"in s?s.touches[0].clientY:s.clientY;let m;return t.vertical?m=t.reverse?(c-l.top)/l.height:1-(c-l.top)/l.height:m=t.reverse?1-(r-l.left)/l.width:(r-l.left)/l.width,m=Math.max(0,Math.min(1,m)),L(t.min+m*(t.max-t.min))},S=s=>{const l=R(s);O.value=l,i("update:value",l),i("change",l)},vt=s=>{if(t.disabled)return;const l=W(s);if(t.range){const[r,c]=N.value,m=Math.abs(l-r),k=Math.abs(l-c);m<=k?S([l,c]):S([r,l])}else S(l)},U=s=>l=>{if(t.disabled)return;l.preventDefault(),n.value=s,o.value=s;const r=m=>{const k=W(m);if(t.range){const[y,T]=N.value;S(s==="start"?[Math.min(k,T),T]:[y,Math.max(k,y)])}else S(k)},c=()=>{n.value=null,o.value=null,i("afterChange",N.value),document.removeEventListener("mousemove",r),document.removeEventListener("mouseup",c),document.removeEventListener("touchmove",r),document.removeEventListener("touchend",c)};document.addEventListener("mousemove",r),document.addEventListener("mouseup",c),document.addEventListener("touchmove",r),document.addEventListener("touchend",c)},A=s=>{var l,r;return((l=t.tooltip)==null?void 0:l.formatter)===null?null:(r=t.tooltip)!=null&&r.formatter?t.tooltip.formatter(s):String(s)},j=s=>{var l;return((l=t.tooltip)==null?void 0:l.open)!==void 0?t.tooltip.open:o.value===s},z=s=>l=>{if(t.disabled||!t.keyboard)return;const r=t.range?s==="start"?N.value[0]:N.value[1]:N.value;let c=0;const m=t.step===null?1:t.step;switch(l.key){case B.ARROW_RIGHT:case B.ARROW_UP:c=m;break;case B.ARROW_LEFT:case B.ARROW_DOWN:c=-m;break;case B.HOME:c=t.min-r;break;case B.END:c=t.max-r;break;default:return}l.preventDefault();const k=L(r+c);if(t.range){const[y,T]=N.value;S(s==="start"?[Math.min(k,T),T]:[y,Math.max(k,y)])}else S(k)};return()=>{var K,F,H,Y,I,X,G,J,Q,Z,tt,nt,et,at,st,lt;const s=N.value,l=t.range?s[0]:s,r=t.range?s[1]:s,c=D(l),m=D(r),k=t.vertical?t.included?{bottom:`${t.range?c:0}%`,height:`${t.range?m-c:m}%`}:{}:t.included?{left:`${t.range?c:0}%`,width:`${t.range?m-c:m}%`}:{},y=t.marks?Object.entries(t.marks).map(([u,f])=>({value:Number(u),label:typeof f=="string"?f:f.label,style:typeof f=="object"&&f.style?f.style:void 0})):[],T=[];if(t.dots&&t.step!==null&&t.step>0)for(let u=t.min;u<=t.max;u+=t.step)T.push(u);const gt=u=>{if(!t.disabled)if(t.range){const[f,q]=N.value,C=Math.abs(u-f),_=Math.abs(u-q);C<=_?S([u,q]):S([f,u])}else S(u)};return d("div",{class:w(a,{[`${a}-disabled`]:t.disabled,[`${a}-vertical`]:t.vertical,[`${a}-with-marks`]:y.length>0},(K=t.classNames)==null?void 0:K.root),style:(F=t.styles)==null?void 0:F.root},[d("div",{ref:g,class:w(`${a}-rail`,(H=t.classNames)==null?void 0:H.rail),style:(Y=t.styles)==null?void 0:Y.rail,onClick:vt},[d("div",{class:w(`${a}-track`,(I=t.classNames)==null?void 0:I.track),style:{...k,...(X=t.styles)==null?void 0:X.track}},null),y.map(({value:u})=>{var C,_;const f=D(u),q=t.vertical?{bottom:`${f}%`}:{left:`${f}%`};return d("span",{key:u,class:w(`${a}-dot`,{[`${a}-dot-active`]:t.range?u>=l&&u<=r:u<=r},(C=t.classNames)==null?void 0:C.dot),style:{...q,...(_=t.styles)==null?void 0:_.dot}},null)}),T.map(u=>{var C,_;const f=D(u),q=t.vertical?{bottom:`${f}%`}:{left:`${f}%`};return d("span",{key:u,class:w(`${a}-dot`,{[`${a}-dot-active`]:t.range?u>=l&&u<=r:u<=r},(C=t.classNames)==null?void 0:C.dot),style:{...q,...(_=t.styles)==null?void 0:_.dot}},null)}),t.range&&d("div",{class:w(`${a}-handle`,`${a}-handle-1`,{[`${a}-handle-dragging`]:n.value==="start"},(G=t.classNames)==null?void 0:G.handle),style:{...t.vertical?{bottom:`${c}%`}:{left:`${c}%`},...(J=t.styles)==null?void 0:J.handle},role:"slider","aria-label":"最小值","aria-orientation":t.vertical?"vertical":"horizontal","aria-valuemin":t.min,"aria-valuemax":r,"aria-valuenow":l,"aria-disabled":t.disabled,tabindex:t.disabled?-1:0,onMousedown:U("start"),onTouchstart:U("start"),onMouseenter:()=>{o.value="start"},onMouseleave:()=>{n.value!=="start"&&(o.value=null)},onKeydown:z("start")},[j("start")&&A(l)!==null&&d("div",{class:w(`${a}-tooltip`,(Q=t.classNames)==null?void 0:Q.tooltip),style:(Z=t.styles)==null?void 0:Z.tooltip},[A(l)])]),d("div",{class:w(`${a}-handle`,t.range?`${a}-handle-2`:"",{[`${a}-handle-dragging`]:n.value==="end"||!t.range&&n.value!==null},(tt=t.classNames)==null?void 0:tt.handle),style:{...t.vertical?{bottom:`${m}%`}:{left:`${m}%`},...(nt=t.styles)==null?void 0:nt.handle},role:"slider","aria-label":t.range?"最大值":"滑块","aria-orientation":t.vertical?"vertical":"horizontal","aria-valuemin":t.range?l:t.min,"aria-valuemax":t.max,"aria-valuenow":r,"aria-disabled":t.disabled,tabindex:t.disabled?-1:0,onMousedown:U((t.range,"end")),onTouchstart:U((t.range,"end")),onMouseenter:()=>{o.value="end"},onMouseleave:()=>{n.value!=="end"&&(o.value=null)},onKeydown:z(t.range?"end":"start")},[j("end")&&A(r)!==null&&d("div",{class:w(`${a}-tooltip`,(et=t.classNames)==null?void 0:et.tooltip),style:(at=t.styles)==null?void 0:at.tooltip},[A(r)])])]),y.length>0&&d("div",{class:w(`${a}-mark`,(st=t.classNames)==null?void 0:st.mark),style:(lt=t.styles)==null?void 0:lt.mark},[y.map(({value:u,label:f,style:q})=>{var dt,rt;const C=D(u),_=t.vertical?{bottom:`${C}%`}:{left:`${C}%`},ot=q?{..._,...q}:_,kt=(dt=t.styles)!=null&&dt.markText?{...ot,...t.styles.markText}:ot;return d("span",{key:u,class:w(`${a}-mark-text`,{[`${a}-mark-text-active`]:t.range?u>=l&&u<=r:u<=r},(rt=t.classNames)==null?void 0:rt.markText),style:kt,onClick:()=>gt(u)},[f])})])])}}}),yt={style:{display:"flex","flex-direction":"column",gap:"24px",padding:"0 16px"}},St={style:{"margin-bottom":"8px"}},$t=E({__name:"SliderBasic",setup(t){const i=b(30),a=b(50);return(g,n)=>(M(),V("div",yt,[e("div",null,[e("p",St,"基础滑块："+$(i.value),1),d(p(v),{value:i.value,"onUpdate:value":n[0]||(n[0]=o=>i.value=o)},null,8,["value"])]),e("div",null,[n[2]||(n[2]=e("p",{style:{"margin-bottom":"8px"}},"禁用状态：",-1)),d(p(v),{value:a.value,"onUpdate:value":n[1]||(n[1]=o=>a.value=o),disabled:""},null,8,["value"])])]))}}),wt=`<template>
...
<\/script>
`,Bt={style:{display:"flex","flex-direction":"column",gap:"40px",padding:"0 16px"}},Dt={style:{"margin-bottom":"8px"}},Rt={style:{"margin-bottom":"8px"}},Ut=E({__name:"SliderMarks",setup(t){const i=b(37),a=b(0),g={0:"0°C",26:"26°C",37:"37°C",100:{label:"100°C",style:{color:"#f50"}}};return(n,o)=>(M(),V("div",Bt,[e("div",null,[e("p",Dt,"带刻度标记："+$(i.value),1),d(p(v),{value:i.value,"onUpdate:value":o[0]||(o[0]=x=>i.value=x),marks:g},null,8,["value"])]),e("div",null,[e("p",Rt,"只能选择刻度点："+$(a.value),1),d(p(v),{value:a.value,"onUpdate:value":o[1]||(o[1]=x=>a.value=x),marks:g,step:null},null,8,["value"])])]))}}),At=`<template>
...
<\/script>
`,Ot={style:{display:"flex","flex-direction":"column",gap:"24px",padding:"0 16px"}},Lt={style:{"margin-bottom":"8px"}},Wt={style:{"margin-bottom":"8px"}},jt=E({__name:"SliderRange",setup(t){const i=b([20,70]),a=b([20,60]);return(g,n)=>(M(),V("div",Ot,[e("div",null,[e("p",Lt,"范围选择："+$(i.value),1),d(p(v),{value:i.value,"onUpdate:value":n[0]||(n[0]=o=>i.value=o),range:""},null,8,["value"])]),e("div",null,[e("p",Wt,"带步长的范围选择："+$(a.value),1),d(p(v),{value:a.value,"onUpdate:value":n[1]||(n[1]=o=>a.value=o),range:"",step:10},null,8,["value"])])]))}}),zt=`<template>
  <div style="display: flex; flex-direction: column; gap: 24px; padding: 0 16px">
    <div>
...
const value3 = ref(70)
<\/script>
`,Gt={style:{display:"flex",gap:"48px",padding:"0 16px"}},Jt={style:{height:"300px"}},Qt={style:{"margin-bottom":"8px"}},Zt={style:{height:"300px"}},tn={style:{"margin-bottom":"8px"}},nn=E({__name:"SliderVertical",setup(t){const i=b(30),a=b([20,50]);return(g,n)=>(M(),V("div",Gt,[e("div",Jt,[e("p",Qt,"垂直滑块："+$(i.value),1),d(p(v),{value:i.value,"onUpdate:value":n[0]||(n[0]=o=>i.value=o),vertical:""},null,8,["value"])]),e("div",Zt,[e("p",tn,"垂直范围选择："+$(a.value),1),d(p(v),{value:a.value,"onUpdate:value":n[1]||(n[1]=o=>a.value=o),vertical:"",range:"",step:10},null,8,["value"])])]))}}),en=`<template>
