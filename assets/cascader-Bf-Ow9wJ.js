...
<\/script>
`,Xn={style:{"margin-top":"8px"}},Yn=R({__name:"CascaderChangeOnSelect",setup(n){const c=S([]),y=[{value:"zhejiang",label:"浙江",children:[{value:"hangzhou",label:"杭州",children:[{value:"xihu",label:"西湖区"}]}]}],i=e=>{console.log("选中值：",e)};return(e,u)=>(E(),Q("div",null,[t(v(j),{value:c.value,"onUpdate:value":u[0]||(u[0]=P=>c.value=P),options:y,"change-on-select":!0,placeholder:"选择即改变",style:{width:"300px"},onChange:i},null,8,["value"]),s("p",Xn,"当前值："+ln(c.value),1)]))}}),Gn=`<template>
  <div>
    <Cascader
      v-model:value="value"
      :options="options"
...
<\/script>
`,se={style:{"margin-top":"8px"}},le=R({__name:"CascaderMultiple",setup(n){const c=S([]),y=[{value:"zhejiang",label:"浙江",children:[{value:"hangzhou",label:"杭州",children:[{value:"xihu",label:"西湖区"},{value:"yuhang",label:"余杭区"}]},{value:"ningbo",label:"宁波",children:[{value:"haishu",label:"海曙区"}]}]},{value:"jiangsu",label:"江苏",children:[{value:"nanjing",label:"南京",children:[{value:"xuanwu",label:"玄武区"}]}]}],i=(e,u)=>{console.log("选中值：",e,u)};return(e,u)=>(E(),Q("div",null,[t(v(j),{value:c.value,"onUpdate:value":u[0]||(u[0]=P=>c.value=P),options:y,multiple:!0,placeholder:"支持多选",style:{width:"300px"},onChange:i},null,8,["value"]),s("p",se,"当前值："+ln(c.value),1)]))}}),oe=`<template>
  <div>
    <Cascader
      v-model:value="value"
      :options="options"
