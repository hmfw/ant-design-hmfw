...
<\/script>
`,It=O({__name:"TreeDirectory",setup(t){const c=m(["0-0"]),r=m([]),g=[{title:"src",key:"0-0",children:[{title:"components",key:"0-0-0",children:[{title:"Button.tsx",key:"0-0-0-0",isLeaf:!0},{title:"Tree.tsx",key:"0-0-0-1",isLeaf:!0}]},{title:"utils",key:"0-0-1",children:[{title:"index.ts",key:"0-0-1-0",isLeaf:!0}]}]}];return(a,s)=>(A(),z(D(I).DirectoryTree,{multiple:"","tree-data":g,"expanded-keys":c.value,"onUpdate:expandedKeys":s[0]||(s[0]=y=>c.value=y),"selected-keys":r.value,"onUpdate:selectedKeys":s[1]||(s[1]=y=>r.value=y)},null,8,["expanded-keys","selected-keys"]))}}),$t=`<template>
  <Tree.DirectoryTree
    multiple
    :tree-data="treeData"
    v-model:expanded-keys="expandedKeys"
...
<\/script>
`,Lt=O({__name:"TreeDraggable",setup(t){const c=[{title:"父节点 1",key:"0-0",children:[{title:"子节点 1-1",key:"0-0-0"},{title:"子节点 1-2",key:"0-0-1"}]},{title:"父节点 2",key:"0-1",children:[{title:"子节点 2-1",key:"0-1-0"}]}],r=g=>{var a,s;console.log("drop",(a=g.dragNode)==null?void 0:a.key,"->",(s=g.node)==null?void 0:s.key)};return(g,a)=>(A(),G(J,null,[u(D(I),{draggable:"","block-node":"","tree-data":c,"default-expand-all":!0,onDrop:r}),a[0]||(a[0]=i("p",null,"提示：拖动节点查看 drop 事件（本示例仅打印，不改变数据）。",-1))],64))}}),Bt=`<template>
  <Tree
    draggable
    block-node
    :tree-data="treeData"
...
<\/script>
`,Ft=O({__name:"TreeSearch",setup(t){const c=m(""),r=[{title:"父节点 1",key:"0-0",children:[{title:"子节点 apple",key:"0-0-0"},{title:"子节点 banana",key:"0-0-1"}]},{title:"父节点 2",key:"0-1",children:[{title:"子节点 cherry",key:"0-1-0"}]}],g=a=>c.value?String(a.title).toLowerCase().includes(c.value.toLowerCase()):!1;return(a,s)=>(A(),G(J,null,[xt(i("input",{"onUpdate:modelValue":s[0]||(s[0]=y=>c.value=y),placeholder:"输入关键字高亮匹配节点",style:{"margin-bottom":"8px",padding:"4px 8px",width:"240px"}},null,512),[[Kt,c.value]]),u(D(I),{"tree-data":r,"default-expand-all":!0,"filter-tree-node":g})],64))}}),Pt=`<template>
  <input
    v-model="searchValue"
...
<\/script>
`,_t=O({__name:"TreeShowLine",setup(t){const c=[{title:"父节点",key:"0-0",children:[{title:"子节点 1",key:"0-0-0"},{title:"子节点 2",key:"0-0-1"},{title:"子节点 3",key:"0-0-2"}]}];return(r,g)=>(A(),z(D(I),{"show-line":"","tree-data":c,"default-expand-all":!0}))}}),jt=`<template>
  <Tree
    show-line
    :tree-data="treeData"
    :default-expand-all="true"
