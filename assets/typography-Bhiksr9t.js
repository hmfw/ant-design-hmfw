...
<\/script>
`,Pt={style:{display:"flex","flex-direction":"column",gap:"12px","max-width":"240px"}},Nt={style:{"font-size":"12px",color:"#999"}},Dt=v({__name:"TypographyEllipsisTooltip",setup(n){const a=E(!1);function t(y){a.value=y}return(y,e)=>(w(),D("div",Pt,[s(l(k),{ellipsis:{tooltip:!0}},{default:p(()=>[...e[0]||(e[0]=[o(" 这是一段超出容器宽度的长文本，鼠标悬停时会通过 Tooltip 显示完整内容，方便用户查看被省略的部分。 ",-1)])]),_:1}),s(l(k),{ellipsis:{tooltip:"自定义 Tooltip 文案"}},{default:p(()=>[...e[1]||(e[1]=[o(" 显示的文字会被省略，但悬停时 Tooltip 展示的内容与之不同。 ",-1)])]),_:1}),s(l(C),{ellipsis:{rows:2,tooltip:{placement:"topLeft",color:"#1677ff"},onEllipsis:t}},{default:p(()=>[...e[2]||(e[2]=[o(" 多行省略时，可以传入完整的 Tooltip 配置（placement、color 等），并通过 onEllipsis 监听省略状态的变化，从而在文本被截断时做出相应的交互处理。 ",-1)])]),_:1},8,["ellipsis"]),r("div",Nt,"省略状态: "+lt(a.value),1)]))}}),qt=`<template>
...
import { Text, Space } from '@hmfw/ant-design'
<\/script>
`,Ot=v({__name:"TypographyTitle",setup(n){return(a,t)=>(w(),L(l($),{direction:"vertical",size:16},{default:p(()=>[s(l(P),{level:1},{default:p(()=>[...t[0]||(t[0]=[o(" h1. Ant Design ",-1)])]),_:1}),s(l(P),{level:2},{default:p(()=>[...t[1]||(t[1]=[o(" h2. Ant Design ",-1)])]),_:1}),s(l(P),{level:3},{default:p(()=>[...t[2]||(t[2]=[o(" h3. Ant Design ",-1)])]),_:1}),s(l(P),{level:4},{default:p(()=>[...t[3]||(t[3]=[o(" h4. Ant Design ",-1)])]),_:1}),s(l(P),{level:5},{default:p(()=>[...t[4]||(t[4]=[o(" h5. Ant Design ",-1)])]),_:1})]),_:1}))}}),zt=`<template>
  <Space direction="vertical" :size="16">
