import{M as u}from"./index-Rc-jE5S1.js";import{m as C,y as g,i as k,F as M,f as n,l as e,I as c,P as r,B as b,k as p,H as h,E as x,j as y}from"./index-BQisgCTe.js";import{B as m}from"./Button-CwdPD8WR.js";import"./icons-Buy98oKP.js";import"./index-nlXGR9MR.js";import"./cls-S9IiI6wd.js";import"./Icon-BfLh2ono.js";const B=C({__name:"ModalBasic",setup(v){const d=b(!1);function i(){console.log("确认"),d.value=!1}function o(){console.log("取消"),d.value=!1}return(t,l)=>(g(),k(M,null,[n("button",{onClick:l[0]||(l[0]=s=>d.value=!0)},"打开对话框"),e(c(u),{open:d.value,"onUpdate:open":l[1]||(l[1]=s=>d.value=s),title:"基础对话框",onOk:i,onCancel:o},{default:r(()=>[...l[2]||(l[2]=[n("p",null,"对话框内容",-1),n("p",null,"对话框内容",-1),n("p",null,"对话框内容",-1)])]),_:1},8,["open"])],64))}}),w=`<template>
...
<\/script>
`,O=C({__name:"ModalCentered",setup(v){const d=b(!1);return(i,o)=>(g(),k(M,null,[n("button",{onClick:o[0]||(o[0]=t=>d.value=!0)},"居中对话框"),e(c(u),{open:d.value,"onUpdate:open":o[1]||(o[1]=t=>d.value=t),title:"居中对话框",centered:"",onOk:o[2]||(o[2]=t=>d.value=!1),onCancel:o[3]||(o[3]=t=>d.value=!1)},{default:r(()=>[...o[4]||(o[4]=[n("p",null,"居中展示的对话框内容",-1)])]),_:1},8,["open"])],64))}}),P=`<template>
...
const open = ref(false)
<\/script>
`,T=C({__name:"ModalConfirm",setup(v){function d(){u.confirm({title:"确认删除？",content:"该操作不可撤销。",okType:"danger",onOk:()=>{console.log("OK")},onCancel:()=>{console.log("Cancel")}})}function i(){u.info({title:"提示",content:"这是一条信息。"})}function o(){u.success({title:"操作成功",content:"保存完成。"})}function t(){u.error({title:"操作失败",content:"请重试。"})}function l(){u.warning({title:"注意",content:"即将关闭。"})}function s(){u.confirm({title:"提交中？",content:"OK 按钮会显示 loading 直到 Promise resolve。",onOk:()=>new Promise(f=>setTimeout(f,1500))})}return(f,a)=>(g(),k(M,null,[e(c(m),{onClick:d},{default:r(()=>[...a[0]||(a[0]=[p("删除项目",-1)])]),_:1}),e(c(m),{onClick:i},{default:r(()=>[...a[1]||(a[1]=[p("提示信息",-1)])]),_:1}),e(c(m),{onClick:o},{default:r(()=>[...a[2]||(a[2]=[p("成功",-1)])]),_:1}),e(c(m),{onClick:t},{default:r(()=>[...a[3]||(a[3]=[p("错误",-1)])]),_:1}),e(c(m),{onClick:l},{default:r(()=>[...a[4]||(a[4]=[p("警告",-1)])]),_:1}),e(c(m),{onClick:s},{default:r(()=>[...a[5]||(a[5]=[p("异步确认",-1)])]),_:1})],64))}}),N=`<template>
...
<\/script>
`,S=C({__name:"ModalCustomFooter",setup(v){const d=b(!1),i=b(!1),o=b("内容将在两秒后更新");function t(){o.value="正在提交...",i.value=!0,setTimeout(()=>{d.value=!1,i.value=!1},2e3)}return(l,s)=>(g(),k(M,null,[n("button",{onClick:s[0]||(s[0]=f=>d.value=!0)},"打开对话框"),e(c(u),{open:d.value,"onUpdate:open":s[2]||(s[2]=f=>d.value=f),title:"自定义页脚","confirm-loading":i.value,onOk:t},{footer:r(()=>[n("button",{onClick:s[1]||(s[1]=f=>d.value=!1)},"取消"),n("button",{onClick:t},"确认")]),default:r(()=>[n("p",null,h(o.value),1)]),_:1},8,["open","confirm-loading"])],64))}}),V=`<template>
  <button @click="open = true">打开对话框</button>
  <Modal
    v-model:open="open"
    title="自定义页脚"
