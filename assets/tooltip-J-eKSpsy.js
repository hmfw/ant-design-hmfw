...
import { Tooltip, Button } from '@hmfw/ant-design'
<\/script>
`,K={class:"demo-dynamic-content"},G={style:{display:"flex",gap:"20px","margin-top":"20px"}},J=k({__name:"TooltipDynamicContent",setup(m){const i=b(!1),t=b(!1),f=T(()=>t.value?"这是一段很长的提示文字，用于演示当内容动态变化时，浮层位置会自动重新计算，确保不会溢出视口边界，提供更好的用户体验。":"短提示"),a=()=>{t.value=!t.value};return(d,g)=>(u(),r("div",K,[g[1]||(g[1]=n("p",null,"当浮层内容动态变化时，Tooltip 会通过 ResizeObserver 自动重新计算位置，确保浮层不会溢出视口。",-1)),n("div",G,[s(o(c),{title:f.value,placement:"top",open:i.value},{default:e(()=>[s(o(l),{onClick:g[0]||(g[0]=et=>i.value=!i.value)},{default:e(()=>[p(y(i.value?"关闭":"打开")+"提示",1)]),_:1})]),_:1},8,["title","open"]),s(o(l),{onClick:a},{default:e(()=>[p(y(t.value?"切换为短内容":"切换为长内容"),1)]),_:1})]),g[2]||(g[2]=n("p",{style:{"margin-top":"20px",color:"#666","font-size":"12px"}},"提示：打开浮层后切换内容长度，浮层位置会自动调整",-1))]))}}),Q=v(J,[["__scopeId","data-v-1da4fabc"]]),U=`<template>
