import{I as i,T as h,a as q,b}from"./Input-C84iRRQW.js";import{o as k,A as v,k as x,n as a,L as s,E as d,h as e,S as f,m as y,K as w,j as N,_ as C,H as A,l as E}from"./index-8XlzfTv5.js";import{S}from"./Space-DIK7Q-ya.js";import{C as T}from"./CloseCircleOutlined-DF8v0sUH.js";import{S as I}from"./SearchOutlined-DXnml86D.js";import{U as P}from"./UserOutlined-DdbPmEiT.js";import"./cls-S9IiI6wd.js";import"./CloseOutlined-Cyc9QAx7.js";import"./EyeOutlined-DbpJqG0M.js";import"./LoadingOutlined-DqorBNRC.js";const U={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"400px"}},W=k({__name:"InputAddon",setup(g){const l=d(""),u=d(""),r=d("");return(t,o)=>(v(),x("div",U,[a(s(i),{value:l.value,"onUpdate:value":o[0]||(o[0]=c=>l.value=c),placeholder:"请输入用户名",prefix:"👤"},null,8,["value"]),a(s(i),{value:u.value,"onUpdate:value":o[1]||(o[1]=c=>u.value=c),placeholder:"请输入金额",prefix:"¥",suffix:"元"},null,8,["value"]),a(s(i),{value:r.value,"onUpdate:value":o[2]||(o[2]=c=>r.value=c),placeholder:"支持清除","allow-clear":""},null,8,["value"])]))}}),V=`<template>
