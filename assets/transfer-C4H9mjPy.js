...
<\/script>
`,Pt={style:{display:"flex","flex-direction":"column",gap:"24px"}},Lt=_({__name:"TransferClassNames",setup(e){const c=(()=>{const F=[];for(let i=1;i<=10;i++)F.push({key:`item-${i}`,title:`选项 ${i}`,description:`这是选项 ${i} 的描述`});return F})(),y=x(["item-2","item-4"]),n=x(["item-1","item-3"]),r=x(["item-5","item-6"]),T=x(["item-7","item-8"]),b=x(["item-9","item-10"]);return(F,i)=>(E(),ct("div",Pt,[p("div",null,[i[5]||(i[5]=p("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义列表容器和项：",-1)),s(u(N),{"target-keys":y.value,"onUpdate:targetKeys":i[0]||(i[0]=h=>y.value=h),"data-source":u(c),"class-names":{list:"custom-list",item:"custom-item"},titles:["源列表","目标列表"]},null,8,["target-keys","data-source"])]),p("div",null,[i[6]||(i[6]=p("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义头部和标题：",-1)),s(u(N),{"target-keys":n.value,"onUpdate:targetKeys":i[1]||(i[1]=h=>n.value=h),"data-source":u(c),"class-names":{header:"custom-header",title:"custom-title"},titles:["可选项","已选项"]},null,8,["target-keys","data-source"])]),p("div",null,[i[7]||(i[7]=p("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义操作按钮区：",-1)),s(u(N),{"target-keys":r.value,"onUpdate:targetKeys":i[2]||(i[2]=h=>r.value=h),"data-source":u(c),"class-names":{actions:"custom-actions"},titles:["左侧","右侧"]},null,8,["target-keys","data-source"])]),p("div",null,[i[8]||(i[8]=p("div",{style:{"margin-bottom":"8px",color:"#666"}},"完整自定义（组合使用）：",-1)),s(u(N),{"target-keys":T.value,"onUpdate:targetKeys":i[3]||(i[3]=h=>T.value=h),"data-source":u(c),"class-names":{root:"complete-root",section:"complete-section",header:"complete-header",title:"complete-title",body:"complete-body",list:"complete-list",item:"complete-item",actions:"complete-actions"},titles:["待选区","已选区"]},null,8,["target-keys","data-source"])]),p("div",null,[i[9]||(i[9]=p("div",{style:{"margin-bottom":"8px",color:"#666"}},"使用内联样式（styles）：",-1)),s(u(N),{"target-keys":b.value,"onUpdate:targetKeys":i[4]||(i[4]=h=>b.value=h),"data-source":u(c),styles:{section:{border:"2px solid #1890ff",borderRadius:"8px"},header:{background:"linear-gradient(135deg, #667eea 0%, #764ba2 100%)",color:"white",padding:"12px 16px"},list:{background:"#fafafa"},item:{padding:"12px 16px",borderRadius:"4px"}},titles:["来源","目标"]},null,8,["target-keys","data-source"])])]))}}),Bt=Kt(Lt,[["__scopeId","data-v-736c8795"]]),_t=`<template>
