import{B as i}from"./Button-Cv9KoN5D.js";import{m as e}from"./message-BrlBECU3.js";import{o as k,A as g,k as f,n as t,L as p,Q as c,m as a,h as s,_ as b,i as w,H as x,l as h}from"./index-aeAUYztw.js";import"./cls-S9IiI6wd.js";import"./LoadingOutlined-DS-uT1Fx.js";import"./CloseCircleFilled-DeEvbF5c.js";import"./ExclamationCircleFilled-Ch_H6tMM.js";import"./InfoCircleFilled-8UeOs6dr.js";const v={style:{display:"flex",gap:"8px","flex-wrap":"wrap"}},C=k({__name:"MessageBasic",setup(m){function u(){e.success("操作成功！")}function r(){e.error("操作失败，请重试。")}function d(){e.warning("请注意此操作的风险。")}function n(){e.info("这是一条普通提示信息。")}function l(){e.loading("正在加载中...")}return(y,o)=>(g(),f("div",v,[t(p(i),{onClick:u},{default:c(()=>[...o[0]||(o[0]=[a(" 成功 ",-1)])]),_:1}),t(p(i),{onClick:r},{default:c(()=>[...o[1]||(o[1]=[a(" 错误 ",-1)])]),_:1}),t(p(i),{onClick:d},{default:c(()=>[...o[2]||(o[2]=[a(" 警告 ",-1)])]),_:1}),t(p(i),{onClick:n},{default:c(()=>[...o[3]||(o[3]=[a(" 信息 ",-1)])]),_:1}),t(p(i),{onClick:l},{default:c(()=>[...o[4]||(o[4]=[a(" 加载中 ",-1)])]),_:1})]))}}),B=`<template>
