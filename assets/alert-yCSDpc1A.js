import{o as k,O as Y,n,E as W,f as v,A as f,k as y,L as o,h as e,S as m,m as u,_ as Z,H as tt,l as nt}from"./index-8XlzfTv5.js";import{a as st,C as et}from"./CloseCircleFilled-BGcOiTRa.js";import{C as at}from"./CloseOutlined-Cyc9QAx7.js";import{E as ot}from"./ExclamationCircleFilled-DDGeIVID.js";import{I as lt}from"./InfoCircleFilled-HaNasUQq.js";import{c as g}from"./cls-S9IiI6wd.js";import{B as ct}from"./Button-C1GEWIg_.js";import"./LoadingOutlined-DqorBNRC.js";const rt={success:et,info:lt,warning:ot,error:st};function h(t){return Object.prototype.toString.call(t)==="[object Object]"}const c=k({name:"Alert",props:{type:{type:String,default:void 0},variant:{type:String,default:"outlined"},title:String,message:String,description:String,showIcon:{type:Boolean,default:void 0},closable:{type:[Boolean,Object],default:void 0},closeText:[String,Object,Array,Function],closeIcon:[String,Object,Array,Function],icon:[String,Object,Array,Function],banner:Boolean,action:[String,Object,Array,Function],role:{type:String,default:"alert"},classNames:Object,styles:Object},emits:["close","afterClose"],setup(t,{slots:a,emit:l}){const i=Y("alert"),s=W(!1),p=W(!1),L=v(()=>t.type!==void 0?t.type:t.banner?"warning":"info"),w=v(()=>t.banner&&t.showIcon===void 0?!0:!!t.showIcon),H=v(()=>t.title??t.message),G=v(()=>{const{closable:r,closeText:d,closeIcon:b}=t;return h(r)||d!=null&&d!==""?!0:typeof r=="boolean"?r:b!=null}),J=v(()=>{const{closable:r,closeText:d,closeIcon:b}=t;if(h(r)&&r.closeIcon!=null)return r.closeIcon;if(d!=null&&d!=="")return d;if(b!=null)return b;if(a.closeIcon)return a.closeIcon()}),K=v(()=>{const{closable:r}=t;return h(r)&&typeof r["aria-label"]=="string"?r["aria-label"]:"关闭"}),Q=r=>{p.value=!0,l("close",r),setTimeout(()=>{s.value=!0,l("afterClose")},300)};return()=>{var N,S,C,I,_,q,$,B,F,E,O,T,P,j,D,V,z,M,R;if(s.value)return null;const r=L.value,d=!!(t.description||a.description),b=rt[r],U=t.icon??((N=a.icon)==null?void 0:N.call(a))??n(b,null,null),X=J.value??n(at,null,null),x=((S=a.message)==null?void 0:S.call(a))??((C=a.title)==null?void 0:C.call(a))??H.value,A=t.action??((I=a.action)==null?void 0:I.call(a));return n("div",{role:t.role,"aria-live":r==="error"||r==="warning"?"assertive":"polite","data-show":!s.value,class:g(i,`${i}-${r}`,`${i}-${t.variant}`,{[`${i}-with-description`]:d,[`${i}-banner`]:t.banner,[`${i}-closing`]:p.value,[`${i}-no-icon`]:!w.value},(_=t.classNames)==null?void 0:_.root),style:(q=t.styles)==null?void 0:q.root},[w.value&&n("span",{class:g(`${i}-icon`,($=t.classNames)==null?void 0:$.icon),style:(B=t.styles)==null?void 0:B.icon},[U]),n("div",{class:g(`${i}-section`,(F=t.classNames)==null?void 0:F.section),style:(E=t.styles)==null?void 0:E.section},[x!=null&&x!==""&&n("div",{class:g(`${i}-title`,(O=t.classNames)==null?void 0:O.title),style:(T=t.styles)==null?void 0:T.title},[x]),d&&n("div",{class:g(`${i}-description`,(P=t.classNames)==null?void 0:P.description),style:(j=t.styles)==null?void 0:j.description},[((D=a.description)==null?void 0:D.call(a))??t.description])]),A!=null&&n("div",{class:g(`${i}-actions`,(V=t.classNames)==null?void 0:V.actions),style:(z=t.styles)==null?void 0:z.actions},[A]),G.value&&n("button",{type:"button",tabindex:0,class:g(`${i}-close-icon`,(M=t.classNames)==null?void 0:M.closeIcon),style:(R=t.styles)==null?void 0:R.closeIcon,"aria-label":K.value,onClick:Q},[X])])}}}),it={style:{display:"flex","flex-direction":"column",gap:"12px"}},pt=k({__name:"AlertBanner",setup(t){return(a,l)=>(f(),y("div",it,[n(o(c),{banner:"",message:"顶部公告：banner 模式默认显示图标，类型默认为 warning。"}),n(o(c),{banner:"",type:"error",message:"错误公告"})]))}}),dt=`<template>
...
import { Alert } from '@hmfw/ant-design'
<\/script>
`,St={style:{display:"flex","flex-direction":"column",gap:"12px"}},Ct=k({__name:"AlertVariant",setup(t){return(a,l)=>(f(),y("div",St,[n(o(c),{type:"success",variant:"filled",message:"Filled 填充样式","show-icon":""}),n(o(c),{type:"info",variant:"filled",message:"Filled 填充样式","show-icon":""}),n(o(c),{type:"warning",variant:"filled",message:"Filled 填充样式","show-icon":""}),n(o(c),{type:"error",variant:"filled",message:"Filled 填充样式","show-icon":""})]))}}),It=`<template>
  <div style="display: flex; flex-direction: column; gap: 12px">
