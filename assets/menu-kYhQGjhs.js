import{M as u}from"./index-DsyBsvbF.js";import{M as x,A as S,T as N,F as M,a as O}from"./TeamOutlined-BLfNjVL3.js";import{S as b}from"./SettingOutlined-DPHRWPDI.js";import{U as v}from"./UserOutlined-CLL1fJiS.js";import{d as k,v as a,o as r,b as g,f as t,c as s,e as o,_ as T,w as d,g as h,A as q,J as _,r as y,q as K,h as z,i as A}from"./index-DpCWj_RH.js";import{B as C}from"./Button-Bf04Y6dy.js";import{H as w}from"./HomeOutlined-Bi1YTwab.js";import{E as P}from"./EditOutlined-CCHIQR47.js";import{D}from"./DeleteOutlined-C3ChhOJJ.js";import{C as G}from"./CopyOutlined-DlI_amHL.js";import{S as $}from"./Select-BD79ShA_.js";import"./Layout-CBNy-KCH.js";import"./MinusOutlined-CS9u7csd.js";import"./LeftOutlined-Dmhui-oM.js";import"./RightOutlined-B3rpRsMI.js";import"./cls-S9IiI6wd.js";import"./event-CMqgYmge.js";import"./Trigger-BvJ5OT70.js";import"./Tooltip-CGkZ9PxR.js";import"./LoadingOutlined-BZTKujXV.js";import"./DownOutlined-BfyIF5yt.js";import"./VirtualList-DQXrAMvZ.js";const B={style:{display:"flex","flex-direction":"column",gap:"32px"}},E=k({__name:"MenuClassNames",setup(m){const e=[{key:"1",label:"导航一",icon:a(x)},{key:"2",label:"导航二",icon:a(S)},{key:"3",label:"导航三",icon:a(b)}],p=[{key:"1",label:"选项 1",icon:a(x)},{key:"sub1",label:"子菜单",icon:a(S),children:[{key:"2",label:"选项 2"},{key:"3",label:"选项 3"}]},{key:"4",label:"选项 4",icon:a(b)}],c=[{type:"group",label:"分组 1",children:[{key:"1",label:"选项 1",icon:a(v)},{key:"2",label:"选项 2",icon:a(N)}]},{type:"divider"},{type:"group",label:"分组 2",children:[{key:"3",label:"选项 3",icon:a(M)},{key:"4",label:"选项 4",icon:a(b)}]}],n=[{key:"mail",label:"邮件",icon:a(x)},{key:"app",label:"应用",icon:a(S)},{key:"setting",label:"设置",icon:a(b)}];return(l,i)=>(r(),g("div",B,[t("div",null,[i[0]||(i[0]=t("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义菜单项样式：",-1)),s(o(u),{mode:"inline","default-selected-keys":["1"],items:e,"class-names":{item:"custom-item",itemSelected:"custom-item-selected",itemIcon:"custom-icon"},style:{width:"256px"}})]),t("div",null,[i[1]||(i[1]=t("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义子菜单样式：",-1)),s(o(u),{mode:"inline","default-open-keys":["sub1"],"default-selected-keys":["1"],items:p,"class-names":{submenu:"custom-submenu",submenuTitle:"custom-submenu-title",submenuArrow:"custom-arrow"},style:{width:"256px"}})]),t("div",null,[i[2]||(i[2]=t("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义分组和分割线：",-1)),s(o(u),{mode:"inline","default-selected-keys":["1"],items:c,"class-names":{itemGroup:"custom-group",itemGroupTitle:"custom-group-title",divider:"custom-divider"},style:{width:"256px"}})]),t("div",null,[i[3]||(i[3]=t("div",{style:{"margin-bottom":"8px",color:"#666"}},"使用内联样式：",-1)),s(o(u),{mode:"inline","default-selected-keys":["2"],items:e,styles:{root:{border:"2px solid #722ed1",borderRadius:"12px"},item:{margin:"8px 12px"},itemSelected:{background:"linear-gradient(135deg, #667eea 0%, #764ba2 100%)",color:"#fff",fontWeight:"bold"},itemIcon:{fontSize:"16px"}},style:{width:"256px"}})]),t("div",null,[i[4]||(i[4]=t("div",{style:{"margin-bottom":"8px",color:"#666"}},"水平菜单自定义：",-1)),s(o(u),{mode:"horizontal","default-selected-keys":["mail"],items:n,"class-names":{root:"custom-horizontal",item:"custom-horizontal-item",itemSelected:"custom-horizontal-selected"}})])]))}}),V=T(E,[["__scopeId","data-v-e873dbdc"]]),F=`<template>
...
`,U=k({__name:"MenuCollapsed",setup(m){const e=y(!1),p=y(["1"]),c=[{key:"1",label:"导航一",icon:a(w)},{key:"2",label:"导航二",icon:a(v)},{key:"3",label:"导航三",icon:a(b)}],n=({key:l})=>{p.value=[l]};return(l,i)=>(r(),g("div",null,[s(o(C),{type:"primary",style:{"margin-bottom":"16px"},onClick:i[0]||(i[0]=f=>e.value=!e.value)},{default:d(()=>[h(q(e.value?"展开":"折叠"),1)]),_:1}),t("div",{style:_({width:e.value?"80px":"256px",borderRight:"1px solid #f0f0f0",transition:"width 0.2s"})},[s(o(u),{mode:"inline",items:c,"selected-keys":p.value,"inline-collapsed":e.value,onSelect:n},null,8,["selected-keys","inline-collapsed"])],4)]))}}),H=`<template>
  <div>
...
<\/script>
`,R={style:{width:"256px"}},L=k({__name:"MenuDanger",setup(m){const e=[{key:"1",label:"普通选项"},{key:"2",label:"编辑",icon:a(P)},{type:"divider"},{key:"3",label:"删除",danger:!0,icon:a(D)}];return(p,c)=>(r(),g("div",R,[s(o(u),{mode:"inline",items:e})]))}}),W=`<template>
...
<\/script>
`,X={style:{width:"256px"}},J=k({__name:"MenuGlobalIcon",setup(m){const e=y(["1"]),p=[{key:"1",label:"导航一",icon:a(M,{style:{color:"#1890ff"}})},{key:"2",label:"导航二",icon:a(G,{style:{color:"#52c41a"}})},{key:"3",label:"导航三",icon:a(b,{style:{color:"#fa8c16"}})},{key:"sub",label:"子菜单",icon:a(O),children:[{key:"sub-1",label:"子项 1"},{key:"sub-2",label:"子项 2"}]}],c=({key:n})=>{e.value=[n]};return(n,l)=>(r(),g("div",X,[s(o(u),{mode:"inline",items:p,"selected-keys":e.value,onSelect:c},null,8,["selected-keys"])]))}}),j=`<template>
  <div style="width: 256px">
...
<\/script>
`,Q={style:{width:"256px"}},Y=k({__name:"MenuGroup",setup(m){const e=[{type:"group",label:"用户管理",children:[{key:"1",label:"用户列表"},{key:"2",label:"添加用户"}]},{type:"group",label:"系统设置",children:[{key:"3",label:"基本设置"},{key:"4",label:"高级设置"}]}];return(p,c)=>(r(),g("div",Q,[s(o(u),{mode:"inline",items:e})]))}}),Z=`<template>
  <div style="width: 256px">
    <Menu mode="inline" :items="items" />
  </div>
</template>
...
<\/script>
`,nn=k({__name:"MenuHorizontal",setup(m){const e=y(["home"]),p=[{key:"home",label:"首页",icon:a(w)},{key:"user",label:"用户管理",icon:a(v)},{key:"setting",label:"系统设置",icon:a(b),children:[{key:"setting-1",label:"基础设置"},{key:"setting-2",label:"高级设置"}]}],c=({key:n})=>{e.value=[n]};return(n,l)=>(r(),K(o(u),{mode:"horizontal",items:p,"selected-keys":e.value,onSelect:c},null,8,["selected-keys"]))}}),tn=`<template>
...
<\/script>
`,sn={style:{width:"256px"}},en=k({__name:"MenuIndent",setup(m){const e=y(["1"]),p=[{key:"1",label:"普通项目"},{type:"group",key:"group-1",label:"分组一",children:[{key:"g1-1",label:"分组项 1"},{key:"g1-2",label:"分组项 2"},{key:"g1-sub",label:"分组子菜单",children:[{key:"g1-sub-1",label:"三级项目 1"},{key:"g1-sub-2",label:"三级项目 2"}]}]},{type:"group",key:"group-2",label:"分组二",children:[{key:"g2-1",label:"分组项 3"},{key:"g2-2",label:"分组项 4"}]}],c=({key:n})=>{e.value=[n]};return(n,l)=>(r(),g("div",sn,[s(o(u),{mode:"inline",items:p,"selected-keys":e.value,"inline-indent":40,onSelect:c},null,8,["selected-keys"])]))}}),an=`<template>
  <div style="width: 256px">
...
<\/script>
`,on={style:{width:"256px","border-right":"1px solid #f0f0f0"}},ln=k({__name:"MenuInline",setup(m){const e=y(["1"]),p=[{key:"sub1",label:"导航一",icon:a(x),children:[{key:"1",label:"选项一"},{key:"2",label:"选项二"},{key:"3",label:"选项三"}]},{key:"sub2",label:"导航二",icon:a(b),children:[{key:"5",label:"选项五"},{key:"6",label:"选项六"}]},{key:"9",label:"导航三",icon:a(v)}],c=({key:n})=>{e.value=[n]};return(n,l)=>(r(),g("div",on,[s(o(u),{mode:"inline",items:p,"selected-keys":e.value,"default-open-keys":["sub1"],onSelect:c},null,8,["selected-keys"])]))}}),pn=`<template>
...
<\/script>
`,cn={style:{width:"256px"}},un=k({__name:"MenuMultiple",setup(m){const e=[{key:"1",label:"选项一"},{key:"2",label:"选项二"},{key:"3",label:"选项三"},{key:"4",label:"选项四"}];return(p,c)=>(r(),g("div",cn,[s(o(u),{mode:"inline",items:e,multiple:"","default-selected-keys":["1","2"]})]))}}),dn=`<template>
  <div style="width: 256px">
...
<\/script>
`,rn=k({__name:"MenuTooltip",setup(m){const e=y(!1),p=y(["1"]),c=[{key:"1",label:"导航一",icon:a(w),title:"这是导航一的提示"},{key:"2",label:"导航二",icon:a(v),title:"这是导航二的提示"},{key:"3",label:"导航三",icon:a(b)},{key:"sub",label:"子菜单",icon:a(O),children:[{key:"sub-1",label:"子项 1"},{key:"sub-2",label:"子项 2"}]}],n=({key:l})=>{p.value=[l]};return(l,i)=>(r(),g("div",null,[s(o(C),{type:"primary",style:{"margin-bottom":"16px"},onClick:i[0]||(i[0]=f=>e.value=!e.value)},{default:d(()=>[h(q(e.value?"展开":"折叠"),1)]),_:1}),t("div",{style:_({width:e.value?"80px":"256px",borderRight:"1px solid #f0f0f0",transition:"width 0.2s"})},[s(o(u),{mode:"inline",items:c,"selected-keys":p.value,"inline-collapsed":e.value,onSelect:n},null,8,["selected-keys","inline-collapsed"])],4)]))}}),mn=`<template>
  <div>
    <Button type="primary" style="margin-bottom: 16px" @click="collapsed = !collapsed">
      {{ collapsed ? '展开' : '折叠' }}
    </Button>
...
<\/script>
`,kn={style:{"margin-bottom":"16px"}},gn=k({__name:"MenuTrigger",setup(m){const e=y(["1"]),p=y("hover"),c=[{value:"hover",label:"hover"},{value:"click",label:"click"}],n=[{key:"1",label:"导航一",icon:a(S)},{key:"2",label:"导航二",icon:a(b)},{key:"sub",label:"子菜单",children:[{key:"sub-1",label:"子项 1"},{key:"sub-2",label:"子项 2"},{key:"sub-3",label:"子项 3"}]},{key:"4",label:"导航四"}],l=({key:i})=>{e.value=[i]};return(i,f)=>(r(),g("div",null,[t("div",kn,[f[1]||(f[1]=t("label",{style:{"margin-right":"8px"}},"触发方式:",-1)),s(o($),{value:p.value,"onUpdate:value":f[0]||(f[0]=I=>p.value=I),options:c,style:{width:"100px"}},null,8,["value"])]),s(o(u),{mode:"horizontal",items:n,"selected-keys":e.value,"trigger-sub-menu-action":p.value,onSelect:l},null,8,["selected-keys","trigger-sub-menu-action"])]))}}),bn=`<template>
  <div>
...
<span class="token selector">:deep(.my-menu-item)</span> <span class="token punctuation">{</span>
  <span class="token property">border-left</span><span class="token punctuation">:</span> 3px solid transparent<span class="token punctuation">;</span>
  <span class="token property">transition</span><span class="token punctuation">:</span> all 0.3s<span class="token punctuation">;</span>
<span class="token punctuation">}</span>

<span class="token selector">:deep(.my-menu-item:hover)</span> <span class="token punctuation">{</span>
  <span class="token property">border-left-color</span><span class="token punctuation">:</span> #1677ff<span class="token punctuation">;</span>
...
<span class="token selector">:deep(.my-item-selected)</span> <span class="token punctuation">{</span>
  <span class="token property">background</span><span class="token punctuation">:</span> <span class="token function">linear-gradient</span><span class="token punctuation">(</span>90deg<span class="token punctuation">,</span> #e6f4ff 0%<span class="token punctuation">,</span> transparent 100%<span class="token punctuation">)</span> <span class="token important">!important</span><span class="token punctuation">;</span>
  <span class="token property">border-left-color</span><span class="token punctuation">:</span> #1677ff <span class="token important">!important</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>

<span class="token selector">:deep(.my-submenu-title)</span> <span class="token punctuation">{</span>
