import{C as u,a as f}from"./Checkbox-DWmeNri2.js";import{o as v,A as h,k as x,n as a,K as d,R as c,m as l,h as e,J as k,E as b,_ as y,U as G,H as w,l as N}from"./index-DiKIrHqq.js";import"./cls-S9IiI6wd.js";const S={style:{display:"flex","flex-direction":"column",gap:"8px"}},A=v({__name:"CheckboxBasic",setup(g){const p=b(!1),t=b(!1),r=b(!0);return(n,s)=>(h(),x("div",S,[a(d(u),{checked:p.value,"onUpdate:checked":s[0]||(s[0]=o=>p.value=o)},{default:c(()=>[...s[3]||(s[3]=[l(" 普通复选框 ",-1)])]),_:1},8,["checked"]),a(d(u),{checked:t.value,"onUpdate:checked":s[1]||(s[1]=o=>t.value=o),disabled:""},{default:c(()=>[...s[4]||(s[4]=[l(" 禁用复选框 ",-1)])]),_:1},8,["checked"]),a(d(u),{checked:r.value,"onUpdate:checked":s[2]||(s[2]=o=>r.value=o),disabled:""},{default:c(()=>[...s[5]||(s[5]=[l(" 禁用选中 ",-1)])]),_:1},8,["checked"]),e("p",null,"checked1: "+k(p.value)+", checked2: "+k(t.value)+", checked3: "+k(r.value),1)]))}}),q=`<template>
