import{a as We}from"./index-D1PPYnnM.js";import{D as an}from"./index-BdiM2Xp3.js";import{B as de}from"./Button-DUAUyor1.js";import{C as ge}from"./Checkbox-zjGwQVUI.js";import{d as z,r as C,c as a,u as sn,C as on,k as ln,l as dn,m as be,s as le,g as T,F as Ge,a as M,o as P,q as U,e as k,b as re,f as d,_ as rn,L as cn,A as Ue,h as un,w as L,i as pn}from"./index-D624MvcT.js";import{c as F}from"./cls-S9IiI6wd.js";import{E as mn}from"./Empty-CQVjz52k.js";import{P as gn}from"./Pagination-DIZBCRhD.js";import{S as kn}from"./Spin-_uLr1peZ.js";import{I as ve}from"./Input-D0wr-smq.js";import"./index-DViEnr3B.js";import"./Layout-C5sEkQPo.js";import"./MinusOutlined-BVlLTb1f.js";import"./LeftOutlined-De9bAUho.js";import"./RightOutlined-DuHGjLUj.js";import"./event-CMqgYmge.js";import"./Trigger-D8KlWo3g.js";import"./Tooltip-N_Z7Umoy.js";import"./DownOutlined-D0hknCoY.js";import"./LoadingOutlined-YZYQjBMp.js";import"./Select-CChPXbCg.js";import"./VirtualList-C7kIDEhj.js";import"./CloseOutlined-BVCBReO7.js";import"./EyeOutlined-BDMlzO8P.js";import"./SearchOutlined-Djx-C46f.js";const yn=z({name:"FilterDropdown",props:{prefixCls:{type:String,required:!0},filters:{type:Array,default:()=>[]},filteredValue:{type:Array,default:()=>[]},filterMultiple:{type:Boolean,default:!0},locale:{type:Object,default:()=>({})},onConfirm:{type:Function,required:!0}},setup(e){const c=C([...e.filteredValue.filter(f=>typeof f=="string"||typeof f=="number")]),s=(f,J)=>{e.filterMultiple?J?c.value=[...c.value,f]:c.value=c.value.filter(S=>S!==f):c.value=J?[f]:[]},i=()=>{e.onConfirm(c.value)},n=()=>{c.value=[],e.onConfirm([])},l=()=>e.filters.map(f=>{const J=c.value.includes(f.value);return a("div",{key:String(f.value),class:`${e.prefixCls}-dropdown-menu-item`},[a(ge,{checked:J,onChange:S=>s(f.value,S)},{default:()=>[f.text]})])});return()=>a("div",{class:`${e.prefixCls}-dropdown`},[a("div",{class:`${e.prefixCls}-dropdown-menu`},[l()]),a("div",{class:`${e.prefixCls}-dropdown-btns`},[a(de,{size:"small",onClick:n},{default:()=>[e.locale.filterReset||"重置"]}),a(de,{type:"primary",size:"small",onClick:i},{default:()=>[e.locale.filterConfirm||"确定"]})])])}}),fn={xs:0,sm:576,md:768,lg:992,xl:1200,xxl:1600},$=z({name:"Table",props:{dataSource:{type:Array,default:()=>[]},columns:{type:Array,default:()=>[]},rowKey:[String,Function],loading:Boolean,bordered:Boolean,size:{type:String,default:"default"},scroll:Object,pagination:{type:[Boolean,Object],default:void 0},rowSelection:Object,expandable:Object,locale:Object,showHeader:{type:Boolean,default:!0},sticky:[Boolean,Object],summary:Function,title:[String,Function],footer:[String,Function],onRow:Function,onHeaderRow:Function,onChange:Function,classNames:Object,styles:Object,rootClassName:String},emits:["change"],setup(e,{emit:c}){var Re,qe,_e;const s=sn("table"),i=on(),n=C(),l=C(0),f=C(new Map),J=54,S=M(()=>{var t;return!!((t=e.scroll)!=null&&t.y&&e.dataSource&&e.dataSource.length>20)}),D=M(()=>{var t;return(t=e.scroll)!=null&&t.y?typeof e.scroll.y=="number"?e.scroll.y:parseInt(e.scroll.y)||400:0}),I=(t,o)=>{const p=Y(t,o);return f.value.get(p)||J},H=C("xxl"),ke=()=>{var p;const t=window.innerWidth,o=((p=Object.entries(fn).reverse().find(([u,m])=>t>=m))==null?void 0:p[0])||"xs";H.value=o};ln(()=>{ke(),window.addEventListener("resize",ke)}),dn(()=>{window.removeEventListener("resize",ke)});const X=M(()=>{var t;return((t=e.columns)==null?void 0:t.filter(o=>!o.responsive||o.responsive.length===0?!0:o.responsive.includes(H.value)))??[]}),K=C([]),O=C({}),we=C(1),Se=C(10);be(()=>X.value,t=>{t&&t.forEach(o=>{const p=o.key??o.dataIndex??"";o.filteredValue!==void 0&&o.filteredValue!==null&&(O.value[p]=o.filteredValue)})},{immediate:!0});const Y=(t,o)=>typeof e.rowKey=="function"?e.rowKey(t):typeof e.rowKey=="string"?t[e.rowKey]:t.key??String(o),Ie=(t,o)=>{if(o.dataIndex)return t[o.dataIndex]},Ce=M(()=>{let t=[...e.dataSource??[]];return X.value.forEach(o=>{const p=o.key??o.dataIndex??"",u=O.value[p];u!=null&&u.length&&o.onFilter&&(t=t.filter(m=>u.some(y=>o.onFilter(y,m))))}),t}),te=M(()=>{const t=[...Ce.value];return K.value.length===0||t.sort((o,p)=>{for(const u of K.value){const m=u.column;if(!m.sorter||!u.order)continue;const y=typeof m.sorter=="function"?m.sorter:void 0;if(!y)continue;const g=y(o,p);if(g!==0)return u.order==="descend"?-g:g}return 0}),t}),R=M(()=>{if(e.pagination===!1)return null;const t=typeof e.pagination=="object"?e.pagination:{};return{pageSize:(t==null?void 0:t.pageSize)??Se.value,current:(t==null?void 0:t.current)??we.value,total:(t==null?void 0:t.total)??te.value.length,onChange:t==null?void 0:t.onChange,showQuickJumper:t==null?void 0:t.showQuickJumper,showSizeChanger:t==null?void 0:t.showSizeChanger,showTotal:t==null?void 0:t.showTotal,pageSizeOptions:t==null?void 0:t.pageSizeOptions}}),x=M(()=>{if(!R.value)return te.value;const{current:t,pageSize:o}=R.value,p=(t-1)*o;return te.value.slice(p,p+o)}),ye=M(()=>{if(!S.value)return 0;let t=0,o=0;const p=5;for(;o<x.value.length;o++){if(t>=l.value)return Math.max(0,o-p);t+=I(x.value[o],o)}return 0}),fe=M(()=>{if(!S.value)return x.value.length;let t=0,o=0;const p=5,u=l.value+D.value;for(let m=0;m<x.value.length;m++)if(t+=I(x.value[m],m),t>=u){o=m;break}return Math.min(x.value.length,o+p+1)}),Xe=M(()=>S.value?x.value.slice(ye.value,fe.value):x.value),Te=M(()=>{if(!S.value)return 0;let t=0;for(let o=0;o<ye.value;o++)t+=I(x.value[o],o);return t}),Ze=t=>{if(!S.value)return;const o=t.target;l.value=o.scrollTop},$e=(t,o)=>{var j;if(!t.sorter)return;const p=t.key??t.dataIndex??"",u=(o==null?void 0:o.shiftKey)||typeof t.sorter=="object"&&"multiple"in t.sorter,m=K.value.findIndex(h=>h.key===p);if(m>=0){const h=K.value[m];h.order==="ascend"?K.value[m]={key:p,order:"descend",column:t}:h.order==="descend"&&(K.value=K.value.filter((ae,W)=>W!==m))}else{const h={key:p,order:"ascend",column:t};u?K.value=[...K.value,h]:K.value=[h]}const y=K.value.map(h=>({column:h.column,order:h.order,field:h.column.dataIndex,columnKey:h.key})),g={currentDataSource:te.value,action:"sort"},q=y.length===1?y[0]:y;c("change",R.value,O.value,q,g),(j=e.onChange)==null||j.call(e,R.value,O.value,q,g)},en=(t,o)=>{var g,q,j;we.value=t,Se.value=o,(q=(g=R.value)==null?void 0:g.onChange)==null||q.call(g,t,o);const p={currentDataSource:x.value,action:"paginate"},u=K.value.map(h=>({column:h.column,order:h.order,field:h.column.dataIndex,columnKey:h.key})),m=u.length===1?u[0]:u,y={...R.value,current:t,pageSize:o};c("change",y,O.value,m,p),(j=e.onChange)==null||j.call(e,y,O.value,m,p)},V=C(((Re=e.rowSelection)==null?void 0:Re.selectedRowKeys)??[]);be(()=>{var t;return(t=e.rowSelection)==null?void 0:t.selectedRowKeys},t=>{t&&(V.value=t)});const Q=C(((qe=e.expandable)==null?void 0:qe.expandedRowKeys)??((_e=e.expandable)==null?void 0:_e.defaultExpandedRowKeys)??[]);be(()=>{var t;return(t=e.expandable)==null?void 0:t.expandedRowKeys},t=>{t!==void 0&&(Q.value=t)});const De=(t,o)=>{var u,m,y,g;const p=Y(o,0);t?Q.value=[...Q.value,p]:Q.value=Q.value.filter(q=>q!==p),(m=(u=e.expandable)==null?void 0:u.onExpand)==null||m.call(u,t,o),(g=(y=e.expandable)==null?void 0:y.onExpandedRowsChange)==null||g.call(y,Q.value)},nn=(t,o)=>{var y;O.value[t]=o;const p={currentDataSource:Ce.value,action:"filter"},u=K.value.map(g=>({column:g.column,order:g.order,field:g.column.dataIndex,columnKey:g.key})),m=u.length===1?u[0]:u;c("change",R.value,O.value,m,p),(y=e.onChange)==null||y.call(e,R.value,O.value,m,p)},ce=(t,o,p)=>{var g,q,j,h,ae;if(!e.rowSelection)return;let u,m="single";e.rowSelection.type==="radio"?u=p?[t]:[]:(u=p?[...V.value,t]:V.value.filter(W=>W!==t),m="multiple"),V.value=u;const y=((g=e.dataSource)==null?void 0:g.filter((W,ie)=>u.includes(Y(W,ie))))??[];(j=(q=e.rowSelection).onChange)==null||j.call(q,u,y,{type:m}),(ae=(h=e.rowSelection).onSelect)==null||ae.call(h,o,p,y,new Event("change"))},tn=t=>{var u,m,y,g;if(!e.rowSelection)return;const o=t?x.value.map((q,j)=>Y(q,j)):[];V.value=o;const p=t?[...x.value]:[];(m=(u=e.rowSelection).onChange)==null||m.call(u,o,p,{type:t?"all":"none"}),(g=(y=e.rowSelection).onSelectAll)==null||g.call(y,t,p,x.value)};return()=>{var ae,W,ie,Ne,Ae,Ee,Fe,Ke,ze,Be,Pe,Je,je,Le,Oe,Me,He,Ve,Ye;const t=x.value.length===0,o=!!e.rowSelection,p=((ae=e.rowSelection)==null?void 0:ae.type)==="radio",u=!!((W=e.expandable)!=null&&W.expandedRowRender),m=x.value.length>0&&x.value.every((r,b)=>V.value.includes(Y(r,b))),y=x.value.some((r,b)=>V.value.includes(Y(r,b))),g=(X.value.length??0)+(o?1:0)+(u?1:0),q=typeof e.sticky=="object"?e.sticky:e.sticky?{offsetHeader:0}:void 0,j=q?{position:"sticky",top:`${q.offsetHeader||0}px`,zIndex:3}:{},h=a("div",{class:F(s,`${s}-${e.size}`,{[`${s}-bordered`]:e.bordered,[`${s}-loading`]:e.loading,[`${s}-scroll-horizontal`]:!!((ie=e.scroll)!=null&&ie.x),[`${s}-sticky`]:!!q},e.rootClassName,(Ne=e.classNames)==null?void 0:Ne.root),style:(Ae=e.styles)==null?void 0:Ae.root,role:"region","aria-label":"Data table"},[e.title&&a("div",{class:`${s}-title`},[typeof e.title=="function"?e.title(te.value):e.title]),a("div",{class:`${s}-container`},[a("div",{ref:n,class:`${s}-content`,style:{...(Ee=e.scroll)!=null&&Ee.x?{overflowX:"auto"}:{},...S.value?{overflowY:"auto",maxHeight:typeof((Fe=e.scroll)==null?void 0:Fe.y)=="number"?`${e.scroll.y}px`:(Ke=e.scroll)==null?void 0:Ke.y}:{}},onScroll:Ze,role:"presentation"},[a("table",{role:"table","aria-rowcount":x.value.length,"aria-colcount":g,style:(ze=e.scroll)!=null&&ze.x?{minWidth:typeof e.scroll.x=="number"?`${e.scroll.x}px`:e.scroll.x}:{}},[e.showHeader&&a("thead",{class:F(`${s}-thead`,(Be=e.classNames)==null?void 0:Be.header),role:"rowgroup",style:{...j,...(Pe=e.styles)==null?void 0:Pe.header}},[a("tr",le(((Je=e.onHeaderRow)==null?void 0:Je.call(e,X.value??[],0))??{},{role:"row"}),[u&&a("th",{class:`${s}-cell ${s}-expand-icon-col`,style:{width:"48px"},role:"columnheader"},null),o&&a("th",{class:`${s}-cell ${s}-selection-column`,role:"columnheader","aria-label":"Row selection"},[!p&&a(ge,{checked:m,indeterminate:y&&!m,onChange:r=>tn(r)},null)]),X.value.map(r=>{var G;const b=r.key??r.dataIndex??"",v=K.value.find(w=>w.key===b),_=!!v,A=r.fixed==="left",B=r.fixed==="right",Z=r.filters&&r.filters.length>0,ee=((G=O.value[b])==null?void 0:G.length)>0;return a("th",{key:b,scope:"col",role:"columnheader","aria-sort":_?v.order==="ascend"?"ascending":"descending":r.sorter?"none":void 0,tabindex:r.sorter?0:void 0,onKeydown:w=>{r.sorter&&(w.key==="Enter"||w.key===" ")&&(w.preventDefault(),$e(r,w))},class:F(`${s}-cell`,{[`${s}-column-sort`]:_,[`${s}-column-has-sorters`]:!!r.sorter,[`${s}-cell-fix-left`]:A,[`${s}-cell-fix-right`]:B}),style:{width:r.width?typeof r.width=="number"?`${r.width}px`:r.width:void 0,textAlign:r.align??"left"},onClick:w=>r.sorter&&$e(r,w)},[a("div",{class:`${s}-column-title`},[r.title,r.sorter&&a("span",{class:`${s}-column-sorter`},[a("span",{class:F(`${s}-column-sorter-up`,{active:_&&(v==null?void 0:v.order)==="ascend"})},[T("▲")]),a("span",{class:F(`${s}-column-sorter-down`,{active:_&&(v==null?void 0:v.order)==="descend"})},[T("▼")])]),Z&&a(an,{trigger:["click"]},{default:()=>[a("span",{class:F(`${s}-filter-trigger`,{active:ee}),onClick:w=>w.stopPropagation()},[T("🔽")])],overlay:()=>a(yn,{prefixCls:s,filters:r.filters,filteredValue:O.value[b]||[],filterMultiple:r.filterMultiple??!0,locale:i.value.Table,onConfirm:w=>nn(b,w)},null)})])])})])]),a("tbody",{class:F(`${s}-tbody`,(je=e.classNames)==null?void 0:je.body),role:"rowgroup",style:(Le=e.styles)==null?void 0:Le.body},[t?a("tr",{class:`${s}-placeholder`,role:"row"},[a("td",{colspan:g,role:"cell"},[a(mn,{description:((Oe=e.locale)==null?void 0:Oe.emptyText)??i.value.Table.emptyText},null)])]):S.value?a(Ge,null,[Te.value>0&&a("tr",{style:{height:`${Te.value}px`},"aria-hidden":"true"},[a("td",{colspan:g},null)]),Xe.value.flatMap((r,b)=>{var ee,G,w,ne,se,N;const v=ye.value+b,_=Y(r,v),A=V.value.includes(_),B=Q.value.includes(_),Z=[a("tr",le({key:_,role:"row","aria-selected":o?A:void 0,"aria-expanded":u?B:void 0,class:F(`${s}-row`,{[`${s}-row-selected`]:A},(ee=e.classNames)==null?void 0:ee.row),style:(G=e.styles)==null?void 0:G.row},((w=e.onRow)==null?void 0:w.call(e,r,v))??{}),[u&&a("td",{class:`${s}-cell ${s}-expand-icon-cell`,role:"cell"},[a("button",{type:"button",class:F(`${s}-expand-icon`,{[`${s}-expand-icon-expanded`]:B}),onClick:()=>De(!B,r),"aria-label":B?"Collapse row":"Expand row","aria-expanded":B},[B?"▼":"▶"])]),o&&a("td",{class:`${s}-cell ${s}-selection-column`,role:"cell"},[p?a(We,{checked:A,onChange:E=>ce(_,r,E)},null):a(ge,le({checked:A,onChange:E=>ce(_,r,E)},((se=(ne=e.rowSelection)==null?void 0:ne.getCheckboxProps)==null?void 0:se.call(ne,r))??{}),null)]),X.value.map(E=>{var oe,Qe;const ue=E.key??E.dataIndex??"",pe=Ie(r,E),xe=E.render?E.render(pe,r,v):pe,he=E.fixed==="left",me=E.fixed==="right";return a("td",{key:ue,role:"cell",class:F(`${s}-cell`,{[`${s}-cell-ellipsis`]:E.ellipsis,[`${s}-cell-fix-left`]:he,[`${s}-cell-fix-right`]:me},(oe=e.classNames)==null?void 0:oe.cell),style:{textAlign:E.align??"left",...(Qe=e.styles)==null?void 0:Qe.cell}},[xe])})])];return u&&B&&((N=e.expandable)!=null&&N.expandedRowRender)&&Z.push(a("tr",{key:`${_}-expanded`,class:`${s}-expanded-row`,role:"row"},[a("td",{colspan:g,class:`${s}-cell`,role:"cell"},[e.expandable.expandedRowRender(r,v,0,B)])])),Z}),fe.value<x.value.length&&(()=>{let r=0;for(let b=fe.value;b<x.value.length;b++)r+=I(x.value[b],b);return r>0?a("tr",{style:{height:`${r}px`},"aria-hidden":"true"},[a("td",{colspan:g},null)]):null})()]):x.value.flatMap((r,b)=>{var Z,ee,G,w,ne,se;const v=Y(r,b),_=V.value.includes(v),A=Q.value.includes(v),B=[a("tr",le({key:v,role:"row","aria-selected":o?_:void 0,"aria-expanded":u?A:void 0,class:F(`${s}-row`,{[`${s}-row-selected`]:_},(Z=e.classNames)==null?void 0:Z.row),style:(ee=e.styles)==null?void 0:ee.row},((G=e.onRow)==null?void 0:G.call(e,r,b))??{}),[u&&a("td",{class:`${s}-cell ${s}-expand-icon-cell`,role:"cell"},[a("button",{type:"button",class:F(`${s}-expand-icon`,{[`${s}-expand-icon-expanded`]:A}),onClick:()=>De(!A,r),"aria-label":A?"Collapse row":"Expand row","aria-expanded":A},[A?"▼":"▶"])]),o&&a("td",{class:`${s}-cell ${s}-selection-column`,role:"cell"},[p?a(We,{checked:_,onChange:N=>ce(v,r,N)},null):a(ge,le({checked:_,onChange:N=>ce(v,r,N)},((ne=(w=e.rowSelection)==null?void 0:w.getCheckboxProps)==null?void 0:ne.call(w,r))??{}),null)]),X.value.map(N=>{var me,oe;const E=N.key??N.dataIndex??"",ue=Ie(r,N),pe=N.render?N.render(ue,r,b):ue,xe=N.fixed==="left",he=N.fixed==="right";return a("td",{key:E,role:"cell",class:F(`${s}-cell`,{[`${s}-cell-ellipsis`]:N.ellipsis,[`${s}-cell-fix-left`]:xe,[`${s}-cell-fix-right`]:he},(me=e.classNames)==null?void 0:me.cell),style:{textAlign:N.align??"left",...(oe=e.styles)==null?void 0:oe.cell}},[pe])})])];return u&&A&&((se=e.expandable)!=null&&se.expandedRowRender)&&B.push(a("tr",{key:`${v}-expanded`,class:`${s}-expanded-row`,role:"row"},[a("td",{colspan:g,class:`${s}-cell`,role:"cell"},[e.expandable.expandedRowRender(r,b,0,A)])])),B})]),e.summary&&!t&&a("tfoot",{class:`${s}-summary`},[e.summary(x.value)])])])]),e.footer&&a("div",{class:F(`${s}-footer`,(Me=e.classNames)==null?void 0:Me.footer),style:(He=e.styles)==null?void 0:He.footer},[typeof e.footer=="function"?e.footer(te.value):e.footer]),R.value&&!t&&a("div",{class:F(`${s}-pagination`,`${s}-pagination-right`,(Ve=e.classNames)==null?void 0:Ve.pagination),style:(Ye=e.styles)==null?void 0:Ye.pagination},[a(gn,{total:R.value.total,pageSize:R.value.pageSize,current:R.value.current,showQuickJumper:R.value.showQuickJumper,showSizeChanger:R.value.showSizeChanger,showTotal:R.value.showTotal,pageSizeOptions:R.value.pageSizeOptions,onChange:en},null)])]);return e.loading?a("div",{style:{position:"relative"}},[a(kn,{style:{position:"absolute",top:"50%",left:"50%",transform:"translate(-50%, -50%)",zIndex:10}},null),a("div",{style:{opacity:.5}},[h])]):h}}}),xn=z({__name:"TableBasic",setup(e){const c=[{key:"1",name:"胡彦斌",age:32,address:"西湖区湖底公园1号"},{key:"2",name:"胡彦祖",age:42,address:"西湖区湖底公园2号"}],s=[{title:"姓名",dataIndex:"name",key:"name"},{title:"年龄",dataIndex:"age",key:"age"},{title:"住址",dataIndex:"address",key:"address"}];return(i,n)=>(P(),U(k($),{"data-source":c,columns:s,"row-key":"key"}))}}),hn=`<template>
...
<\/script>
`,bn={class:"demo-table-classnames"},vn={class:"demo-section"},wn={class:"demo-section"},Sn={class:"demo-section"},In={class:"demo-section"},Cn={class:"demo-section"},Tn={class:"demo-section"},$n=z({__name:"TableClassNames",setup(e){const c=[{key:"1",name:"胡彦斌",age:32,address:"西湖区湖底公园1号"},{key:"2",name:"胡彦祖",age:42,address:"西湖区湖底公园2号"},{key:"3",name:"李小明",age:28,address:"上城区西湖大道3号"}],s=[...c,{key:"4",name:"王大锤",age:35,address:"滨江区江南大道4号"},{key:"5",name:"赵敏",age:24,address:"余杭区文一西路5号"}],i=[{title:"姓名",dataIndex:"name",key:"name"},{title:"年龄",dataIndex:"age",key:"age"},{title:"住址",dataIndex:"address",key:"address"}];return(n,l)=>(P(),re("div",bn,[d("section",vn,[l[0]||(l[0]=d("h3",null,"1. 自定义根节点样式",-1)),a(k($),{"data-source":c,columns:i,"row-key":"key","class-names":{root:"custom-root"}})]),d("section",wn,[l[1]||(l[1]=d("h3",null,"2. 自定义表头样式",-1)),a(k($),{"data-source":c,columns:i,"row-key":"key","class-names":{header:"custom-header"}})]),d("section",Sn,[l[2]||(l[2]=d("h3",null,"3. 自定义行与单元格样式",-1)),a(k($),{"data-source":c,columns:i,"row-key":"key","class-names":{row:"custom-row",cell:"custom-cell"}})]),d("section",In,[l[3]||(l[3]=d("h3",null,"4. 自定义底部与分页样式",-1)),a(k($),{"data-source":s,columns:i,"row-key":"key",footer:()=>"表格底部信息",pagination:{pageSize:3,total:s.length,current:1},"class-names":{footer:"custom-footer",pagination:"custom-pagination"}},null,8,["pagination"])]),d("section",Cn,[l[4]||(l[4]=d("h3",null,"5. 组合使用多个 classNames",-1)),a(k($),{"data-source":c,columns:i,"row-key":"key","class-names":{root:"combined-root",header:"combined-header",row:"combined-row",cell:"combined-cell"}})]),d("section",Tn,[l[5]||(l[5]=d("h3",null,"6. 使用 styles 动态样式",-1)),a(k($),{"data-source":c,columns:i,"row-key":"key",styles:{root:{border:"2px solid #1890ff",borderRadius:"12px",overflow:"hidden"},header:{background:"linear-gradient(135deg, #667eea 0%, #764ba2 100%)"},cell:{fontSize:"14px"}}})])]))}}),Dn=rn($n,[["__scopeId","data-v-317fec8f"]]),Rn=`<template>
...
`,qn=z({__name:"TableEditable",setup(e){const c=C([{key:1,name:"李明",age:28,address:"北京市朝阳区"},{key:2,name:"王芳",age:32,address:"上海市浦东新区"},{key:3,name:"张伟",age:25,address:"广州市天河区"}]),s=C(null),i=cn({}),n=D=>D.key===s.value,l=D=>{s.value=D.key,Object.assign(i,{...D})},f=D=>{const I=c.value.findIndex(H=>H.key===D);I>-1&&Object.assign(c.value[I],i),s.value=null},J=()=>{s.value=null},S=[{title:"姓名",dataIndex:"name",key:"name",width:200,render:(D,I)=>n(I)?a(ve,{value:i.name,onChange:H=>i.name=H.target.value},null):D},{title:"年龄",dataIndex:"age",key:"age",width:150,render:(D,I)=>n(I)?a(ve,{type:"number",value:i.age,onChange:H=>i.age=Number(H.target.value)},null):D},{title:"地址",dataIndex:"address",key:"address",render:(D,I)=>n(I)?a(ve,{value:i.address,onChange:H=>i.address=H.target.value},null):D},{title:"操作",key:"action",width:150,render:(D,I)=>n(I)?a("span",null,[a(de,{type:"link",onClick:()=>f(I.key),style:{marginRight:"8px"}},{default:()=>[T("保存")]}),a(de,{type:"link",onClick:J},{default:()=>[T("取消")]})]):a(de,{type:"link",onClick:()=>l(I),disabled:s.value!==null},{default:()=>[T("编辑")]})}];return(D,I)=>(P(),U(k($),{"data-source":c.value,columns:S,pagination:!1,bordered:""},null,8,["data-source"]))}}),_n=`<script setup lang="tsx">
...
<\/script>
`,Kn=z({__name:"TableFixedColumns",setup(e){const c=[{title:"Name",dataIndex:"name",key:"name",fixed:"left",width:100},{title:"Age",dataIndex:"age",key:"age",width:80},{title:"Column 1",dataIndex:"col1",key:"col1",width:150},{title:"Column 2",dataIndex:"col2",key:"col2",width:150},{title:"Column 3",dataIndex:"col3",key:"col3",width:150},{title:"Column 4",dataIndex:"col4",key:"col4",width:150},{title:"Action",key:"action",fixed:"right",width:100,render:()=>"Edit"}],s=[{key:"1",name:"Joe",age:32,col1:"Data 1",col2:"Data 2",col3:"Data 3",col4:"Data 4"},{key:"2",name:"Jim",age:28,col1:"Data 1",col2:"Data 2",col3:"Data 3",col4:"Data 4"},{key:"3",name:"Alice",age:35,col1:"Data 1",col2:"Data 2",col3:"Data 3",col4:"Data 4"}];return(i,n)=>(P(),U(k($),{columns:c,"data-source":s,scroll:{x:1200},bordered:""}))}}),zn=`<template>
...
<\/script>
`,Bn=z({__name:"TableResponsive",setup(e){const c=[{title:"Name",dataIndex:"name",key:"name"},{title:"Age",dataIndex:"age",key:"age",responsive:["sm","md","lg","xl","xxl"]},{title:"Email",dataIndex:"email",key:"email",responsive:["md","lg","xl","xxl"]},{title:"Phone",dataIndex:"phone",key:"phone",responsive:["lg","xl","xxl"]},{title:"Address",dataIndex:"address",key:"address",responsive:["xl","xxl"]}],s=[{key:"1",name:"Joe",age:32,email:"joe@example.com",phone:"123-456-7890",address:"New York No. 1 Lake Park"},{key:"2",name:"Jim",age:28,email:"jim@example.com",phone:"098-765-4321",address:"London No. 1 Lake Park"},{key:"3",name:"Alice",age:35,email:"alice@example.com",phone:"555-123-4567",address:"Sydney No. 1 Lake Park"}];return(i,n)=>(P(),U(k($),{columns:c,"data-source":s}))}}),Pn=`<template>
  <Table :columns="columns" :data-source="data" />
</template>
...
<\/script>
`,Jn=z({__name:"TableRowSelection",setup(e){const c=C([]),s={selectedRowKeys:c,onChange:l=>{c.value=l}},i=[{key:"1",name:"胡彦斌",age:32,address:"西湖区湖底公园1号"},{key:"2",name:"胡彦祖",age:42,address:"西湖区湖底公园2号"}],n=[{title:"姓名",dataIndex:"name",key:"name"},{title:"年龄",dataIndex:"age",key:"age"},{title:"住址",dataIndex:"address",key:"address"}];return(l,f)=>(P(),re(Ge,null,[a(k($),{"data-source":i,columns:n,"row-key":"key","row-selection":s}),d("p",null,"已选择："+Ue(c.value.join(", ")),1)],64))}}),jn=`<template>
...
<\/script>
`,Ln=z({__name:"TableSorter",setup(e){const c=[{key:"1",name:"胡彦斌",age:32,address:"西湖区湖底公园1号"},{key:"2",name:"胡彦祖",age:42,address:"西湖区湖底公园2号"},{key:"3",name:"李明",age:28,address:"朝阳区建国路88号"}],s=[{title:"姓名",dataIndex:"name",key:"name"},{title:"年龄",dataIndex:"age",key:"age",sorter:(i,n)=>i.age-n.age},{title:"住址",dataIndex:"address",key:"address"}];return(i,n)=>(P(),U(k($),{"data-source":c,columns:s,"row-key":"key"}))}}),On=`<template>
  <Table :data-source="dataSource" :columns="columns" row-key="key" />
</template>
...
<\/script>
`,Mn={style:{height:"600px",overflow:"auto"}},Hn=z({__name:"TableSticky",setup(e){const c=C(Array.from({length:100},(i,n)=>({key:n,name:`李明 ${n+1}`,age:20+n%50,address:`北京市朝阳区某街道 ${n+1} 号`,tags:n%2===0?["开发者","设计师"]:["产品经理"]}))),s=[{title:"姓名",dataIndex:"name",key:"name",width:150,fixed:"left"},{title:"年龄",dataIndex:"age",key:"age",width:100,sorter:(i,n)=>i.age-n.age},{title:"地址",dataIndex:"address",key:"address",width:300},{title:"标签",key:"tags",dataIndex:"tags",width:200,render:i=>i.join(", ")}];return(i,n)=>(P(),re("div",Mn,[n[0]||(n[0]=d("div",{style:{height:"300px",background:"#f0f0f0",display:"flex","align-items":"center","justify-content":"center","margin-bottom":"16px"}},[d("p",null,"向下滚动查看表头吸顶效果")],-1)),a(k($),{"data-source":c.value,columns:s,pagination:!1,scroll:{y:300},sticky:!0,bordered:""},null,8,["data-source"]),n[1]||(n[1]=d("div",{style:{height:"300px",background:"#f0f0f0",display:"flex","align-items":"center","justify-content":"center","margin-top":"16px"}},[d("p",null,"底部内容")],-1))]))}}),Vn=`<script setup lang="ts">
import { ref } from 'vue'
import { Table } from '@hmfw/ant-design'
import type { TableColumn } from '@hmfw/ant-design'
...
`,Yn=z({__name:"TableSummary",setup(e){const c=[{key:1,name:"笔记本电脑",category:"电子产品",price:5999,quantity:3},{key:2,name:"机械键盘",category:"电子产品",price:599,quantity:5},{key:3,name:"显示器",category:"电子产品",price:1999,quantity:2},{key:4,name:"鼠标",category:"电子产品",price:199,quantity:10},{key:5,name:"耳机",category:"电子产品",price:399,quantity:6}],s=[{title:"商品名称",dataIndex:"name",key:"name"},{title:"类别",dataIndex:"category",key:"category"},{title:"单价（元）",dataIndex:"price",key:"price",align:"right",render:n=>`¥${n.toFixed(2)}`},{title:"数量",dataIndex:"quantity",key:"quantity",align:"right"},{title:"总价（元）",key:"total",align:"right",render:(n,l)=>`¥${(l.price*l.quantity).toFixed(2)}`}],i=n=>{const l=n.reduce((J,S)=>J+S.quantity,0),f=n.reduce((J,S)=>J+S.price*S.quantity,0);return a("tr",null,[a("td",{colspan:"3",style:"text-align: right; font-weight: 600;"},[T("总计：")]),a("td",{style:"text-align: right; font-weight: 600;"},[l]),a("td",{style:"text-align: right; font-weight: 600;"},[T("¥"),f.toFixed(2)])])};return(n,l)=>(P(),U(k($),{"data-source":c,columns:s,pagination:!1,summary:i,bordered:""}))}}),Qn=`<script setup lang="tsx">
import { Table } from '@hmfw/ant-design'
import type { TableColumn } from '@hmfw/ant-design'
...
`,Wn={style:{"margin-bottom":"16px"}},Gn=z({__name:"TableVirtualScroll",setup(e){const s=C((n=>Array.from({length:n},(l,f)=>({key:f,name:`用户 ${f+1}`,age:20+f%50,address:`北京市朝阳区某街道 ${f+1} 号`,email:`user${f+1}@example.com`,phone:`138${String(f).padStart(8,"0")}`})))(1e3)),i=[{title:"姓名",dataIndex:"name",key:"name",width:120,fixed:"left"},{title:"年龄",dataIndex:"age",key:"age",width:80,sorter:(n,l)=>n.age-l.age},{title:"地址",dataIndex:"address",key:"address",width:300,ellipsis:!0},{title:"邮箱",dataIndex:"email",key:"email",width:200},{title:"手机号",dataIndex:"phone",key:"phone",width:150}];return(n,l)=>(P(),re("div",null,[d("p",Wn,[l[0]||(l[0]=T(" 共 ",-1)),d("strong",null,Ue(s.value.length),1),l[1]||(l[1]=T(" 条数据，使用虚拟滚动优化性能 ",-1))]),a(k($),{"data-source":s.value,columns:i,pagination:!1,scroll:{y:400,x:900},bordered:""},null,8,["data-source"])]))}}),Un=`<script setup lang="ts">
import { ref } from 'vue'
import { Table } from '@hmfw/ant-design'
import type { TableColumn } from '@hmfw/ant-design'
