import{B as ut}from"./Button-Dp-6_p5h.js";import{D as kt}from"./index-DTH53q2U.js";import{C as mt}from"./Checkbox-fyHNI1-K.js";import{D as yt}from"./DownOutlined-DVtmYEUj.js";import{D as vt}from"./DeleteOutlined-B_l9IXto.js";import{S as ht}from"./SearchOutlined-BSqGHJWp.js";import{I as bt}from"./Input-dzBIcKxa.js";import{c as $}from"./cls-S9IiI6wd.js";import{P as xt}from"./Pagination-B8ORz4kW.js";import{E as St}from"./Empty-BBd17taJ.js";import{o as _,E as x,P as tt,n as s,s as gt,F as rt,f as k,O as wt,N as Tt,A as E,i as X,L as u,k as ct,h as p,_ as Kt,K as Ct,H as qt,Q as U,m as H,l as At}from"./index-lneS_oZ6.js";import{R as It}from"./RightOutlined-aaxn8kYP.js";import{L as $t}from"./LeftOutlined-CzP5XxiT.js";import"./LoadingOutlined-BE1i3WFZ.js";import"./index-Dw7K-cx8.js";import"./Layout-DaEGADWy.js";import"./MinusOutlined-t2-FUj2c.js";import"./event-CMqgYmge.js";import"./Trigger-BYoaljTB.js";import"./Tooltip-VVOJahVd.js";import"./CloseOutlined-pIkoQNJR.js";import"./Select-C7VYRho5.js";import"./VirtualList-LHvRGlLj.js";function Dt(e){return!!e&&typeof e=="object"&&!("__v_isVNode"in e)&&"value"in e}function Nt(e,l){for(const c of[e,l.title,l.key]){if(typeof c=="string")return c;if(typeof c=="number")return String(c)}return""}function W(e){return e.filter(l=>!l.disabled).map(l=>l.key)}const ft=_({name:"TransferList",props:{prefixCls:{type:String,required:!0},direction:{type:String,required:!0},titleText:{type:[String,Object],default:""},dataSource:{type:Array,default:()=>[]},checkedKeys:{type:Array,default:()=>[]},disabled:Boolean,showSearch:{type:[Boolean,Object],default:!1},showSelectAll:{type:Boolean,default:!0},showRemove:Boolean,draggable:Boolean,pagination:{type:[Boolean,Object],default:void 0},selectAllLabel:{type:[String,Object,Function],default:void 0},render:Function,filterOption:Function,footer:Function,listStyle:{type:Object,default:()=>({})},classNames:{type:Object,default:()=>({})},styles:{type:Object,default:()=>({})},searchPlaceholder:{type:String,default:"请输入搜索内容"},notFoundContent:{type:[String,Object,Array],default:void 0},itemUnit:{type:String,default:"项"},itemsUnit:{type:String,default:"项"},selectAll:{type:String,default:"全选所有"},deselectAll:{type:String,default:"取消全选"},selectCurrent:{type:String,default:"全选当页"},selectInvert:{type:String,default:"反选当页"},removeAll:{type:String,default:"删除全部"},removeCurrent:{type:String,default:"删除当页"}},emits:["itemSelect","itemSelectAll","itemRemove","reorder","filter","scroll"],setup(e,{emit:l}){const c=k(()=>`${e.prefixCls}-list`),y=k(()=>`${e.prefixCls}-section`),n=k(()=>e.showSearch&&typeof e.showSearch=="object"?{defaultValue:"",placeholder:"",...e.showSearch}:{defaultValue:"",placeholder:""}),r=x(n.value.defaultValue||"");tt(()=>n.value.defaultValue,t=>{r.value=t||""});const T=x(1),h=k(()=>e.pagination?{simple:!0,showSizeChanger:!1,showLessItems:!1,pageSize:10,...typeof e.pagination=="object"?e.pagination:{}}:null);function F(t){const a=e.render?e.render(t):null,o=Dt(a),d=o?a.label:a,v=o?a.value:Nt(a,t);return{item:t,renderedEl:d??t.title??String(t.key),renderedText:v}}function i(t,a){return e.filterOption?e.filterOption(r.value,a,e.direction):t.toLowerCase().includes(r.value.toLowerCase())}const b=k(()=>{const t=[];return e.dataSource.forEach(a=>{const o=F(a);r.value&&!i(o.renderedText,a)||t.push(o)}),t}),O=k(()=>b.value.map(t=>t.item));tt([b,h],()=>{const t=h.value;if(t){const a=Math.max(1,Math.ceil(b.value.length/t.pageSize));T.value=Math.min(T.value,a)}});const R=k(()=>{const t=h.value;return t?b.value.slice((T.value-1)*t.pageSize,T.value*t.pageSize):b.value}),C=k(()=>O.value.filter(t=>e.checkedKeys.includes(t.key)&&!t.disabled)),K=k(()=>{if(C.value.length===0)return"none";const t=new Set(e.checkedKeys);return O.value.every(a=>t.has(a.key)||!!a.disabled)?"all":"part"});function V(t){r.value=t,l("filter",e.direction,t)}function Y(){const t=W(O.value);l("itemSelectAll",t,K.value!=="all")}function Q(t,a){const o=e.selectAllLabel;if(o)return typeof o=="function"?o({selectedCount:t,totalCount:a}):o;const d=a>1?e.itemsUnit:e.itemUnit;return`${t>0?`${t}/`:""}${a} ${d}`}const et=k(()=>{const t=h.value;return e.showRemove?[t&&{key:"removeCurrent",label:e.removeCurrent,onClick:()=>l("itemRemove",W(R.value.map(a=>a.item)))},{key:"removeAll",label:e.removeAll,onClick:()=>l("itemRemove",W(O.value))}].filter(Boolean):[{key:"selectAll",label:K.value==="all"?e.deselectAll:e.selectAll,onClick:()=>{const a=W(O.value);l("itemSelectAll",a,a.length!==e.checkedKeys.length)}},t&&{key:"selectCurrent",label:e.selectCurrent,onClick:()=>l("itemSelectAll",W(R.value.map(a=>a.item)),!0)},{key:"selectInvert",label:e.selectInvert,onClick:()=>{const a=W(R.value.map(d=>d.item)),o=new Set(e.checkedKeys);a.forEach(d=>o.has(d)?o.delete(d):o.add(d)),l("itemSelectAll",[...o],"replace")}}].filter(Boolean)});function A(t){return e.classNames[t]}function S(t){return e.styles[t]}const P=x(null),L=x(null),z=x(!1);function nt(t){return!!e.draggable&&!e.disabled&&!t.disabled}function at(t,a){if(P.value=a,t.dataTransfer){t.dataTransfer.effectAllowed="move";try{t.dataTransfer.setData("text/plain",String(a))}catch{}}}function st(t,a){if(P.value===null||P.value===a)return;t.preventDefault(),t.dataTransfer&&(t.dataTransfer.dropEffect="move");const d=t.currentTarget.getBoundingClientRect(),m=t.clientY-d.top>d.height/2;(L.value!==a||z.value!==m)&&(L.value=a,z.value=m)}function ot(t,a){L.value===a&&(L.value=null)}function G(t,a){t.preventDefault();const o=P.value,d=z.value;P.value=null,L.value=null,!(o===null||o===a)&&l("reorder",o,a,d)}function J(){P.value=null,L.value=null}return()=>{const t=c.value,a=e.dataSource.some(w=>!w.disabled),o=s(mt,{class:`${t}-checkbox`,disabled:!a||e.disabled,checked:K.value==="all",indeterminate:K.value==="part",onChange:Y},null),d=s(kt,{class:`${t}-header-dropdown`,disabled:e.disabled,menu:{items:et.value}},{default:()=>[s("span",{class:`${t}-header-dropdown-trigger`},[s(yt,{class:"hmfw-icon"},null)])]}),v=e.showSearch?s("div",{class:`${t}-body-search-wrapper`},[s(bt,{class:`${t}-search`,value:r.value,placeholder:n.value.placeholder||e.searchPlaceholder,disabled:e.disabled,allowClear:!0,prefix:s(ht,{class:"hmfw-icon"},null),onInput:w=>V(w.target.value),onClear:()=>V("")},null)]):null,m=R.value.map(({item:w,renderedEl:j})=>{const q=w.key,I=e.disabled||w.disabled,M=e.checkedKeys.includes(q),Z=P.value===q,lt=L.value===q,dt=nt(w)?{draggable:!0,onDragstart:B=>at(B,q),onDragover:B=>st(B,q),onDragleave:B=>ot(B,q),onDrop:B=>G(B,q),onDragend:()=>J()}:{},pt={[`${t}-content-item-draggable`]:!!e.draggable&&!I,[`${t}-content-item-dragging`]:Z,[`${t}-content-item-drag-over`]:lt&&!Z,[`${t}-content-item-drag-over-after`]:lt&&!Z&&z.value,[`${t}-content-item-drag-over-before`]:lt&&!Z&&!z.value},it=s("span",{class:$(`${t}-content-item-text`,A("itemContent")),style:S("itemContent")},[j]);return e.showRemove?s("li",gt({key:q,class:$(`${t}-content-item`,A("item"),pt,{[`${t}-content-item-disabled`]:I}),style:S("item")},dt),[it,s("button",{type:"button",disabled:I,class:`${t}-content-item-remove`,"aria-label":e.removeCurrent,onClick:()=>!I&&l("itemRemove",[q])},[s(vt,{class:"hmfw-icon"},null)])]):s("li",gt({key:q,class:$(`${t}-content-item`,A("item"),pt,{[`${t}-content-item-disabled`]:I,[`${t}-content-item-checked`]:M&&!I}),style:S("item")},dt,{onClick:B=>!I&&l("itemSelect",q,!M,B)}),[s(mt,{class:$(`${t}-checkbox`,A("itemIcon")),style:S("itemIcon"),checked:M,disabled:I},null),it])}),g=Array.isArray(e.notFoundContent)?e.notFoundContent[e.direction==="left"?0:1]:e.notFoundContent,f=R.value.length?s(rt,null,[s("ul",{class:$(`${t}-content`,A("list"),{[`${t}-content-show-remove`]:e.showRemove}),style:S("list"),onScroll:w=>l("scroll",e.direction,w)},[m]),h.value&&s(xt,{size:"small",disabled:e.disabled,simple:h.value.simple,pageSize:h.value.pageSize,showSizeChanger:h.value.showSizeChanger,class:`${t}-pagination`,total:b.value.length,current:T.value,onChange:w=>{T.value=w}},null)]):s("div",{class:`${t}-body-not-found`},[g??s(St,{description:!1},null)]),D=e.footer?e.footer({direction:e.direction,filteredItems:O.value,selectedKeys:e.checkedKeys,disabled:e.disabled}):null;return s("div",{class:$(y.value,A("section"),{[`${y.value}-with-pagination`]:!!h.value,[`${y.value}-with-footer`]:!!D}),style:{...e.listStyle,...S("section")}},[s("div",{class:$(`${t}-header`,A("header")),style:S("header")},[e.showSelectAll?s(rt,null,[!e.showRemove&&!h.value&&o,d]):null,s("span",{class:`${t}-header-selected`},[Q(C.value.length,O.value.length)]),s("span",{class:$(`${t}-header-title`,A("title")),style:S("title")},[e.titleText])]),s("div",{class:$(`${t}-body`,A("body"),{[`${t}-body-with-search`]:!!e.showSearch}),style:S("body")},[v,f]),D&&s("div",{class:$(`${t}-footer`,A("footer")),style:S("footer")},[D])])}}}),N=_({name:"Transfer",props:{dataSource:{type:Array,default:()=>[]},targetKeys:Array,defaultTargetKeys:{type:Array,default:()=>[]},selectedKeys:Array,defaultSelectedKeys:{type:Array,default:()=>[]},titles:{type:Array,default:()=>["",""]},operations:{type:Array,default:()=>[]},render:Function,rowKey:Function,showSearch:{type:[Boolean,Object],default:!1},filterOption:Function,footer:Function,listStyle:{type:[Object,Function],default:()=>({})},disabled:Boolean,showSelectAll:{type:Boolean,default:!0},selectAllLabels:{type:Array,default:()=>[]},oneWay:Boolean,draggable:Boolean,pagination:{type:[Boolean,Object],default:void 0},status:String,locale:{type:Object,default:()=>({})},rootClassName:String,classNames:{type:Object,default:()=>({})},styles:{type:Object,default:()=>({})}},emits:["update:targetKeys","change","update:selectedKeys","selectChange","search","scroll","reorder"],setup(e,{emit:l}){const c=wt("transfer"),y=Tt(),n=k(()=>({...y.value.Transfer,...e.locale})),r=x([...e.defaultTargetKeys]),T=x([...e.defaultSelectedKeys]);tt(()=>e.targetKeys,t=>{t&&(r.value=[...t])}),tt(()=>e.selectedKeys,t=>{t&&(T.value=[...t])});const h=k(()=>e.targetKeys??r.value),F=k(()=>e.selectedKeys??T.value),i=k(()=>e.dataSource.map(t=>({...t,key:e.rowKey?e.rowKey(t):t.key}))),b=k(()=>i.value.filter(t=>!h.value.includes(t.key))),O=k(()=>new Map(i.value.map(t=>[t.key,t]))),R=k(()=>h.value.map(t=>O.value.get(t)).filter(Boolean)),C=k(()=>F.value.filter(t=>b.value.some(a=>a.key===t))),K=k(()=>F.value.filter(t=>R.value.some(a=>a.key===t)));function V(t){T.value=t,l("update:selectedKeys",t)}function Y(t,a){const o=t==="left"?K.value:C.value,d=t==="left"?[...a,...o]:[...o,...a];V(d),t==="left"?l("selectChange",a,K.value):l("selectChange",C.value,a)}function Q(t){const a=t==="right"?C.value:K.value,o=new Set(i.value.filter(f=>f.disabled).map(f=>f.key)),d=a.filter(f=>!o.has(f)),v=new Set(d),m=t==="right"?[...d,...h.value]:h.value.filter(f=>!v.has(f));r.value=m,l("update:targetKeys",m);const g=t==="right"?K.value:C.value;V(g),t==="right"?l("selectChange",[],K.value):l("selectChange",C.value,[]),l("change",m,t,d)}const et=()=>Q("right"),A=()=>Q("left"),S={left:null,right:null};function P(t,a,o,d){var w;const v=t==="left",m=v?C.value:K.value,g=(v?b.value:R.value).filter(j=>!j.disabled),f=g.findIndex(j=>j.key===a),D=new Set(m);if(d&&S[t]!==null){const j=Math.min(S[t],f),q=Math.max(S[t],f);for(let I=j;I<=q;I++){const M=(w=g[I])==null?void 0:w.key;M!==void 0&&D.add(M)}}else D.has(a)&&D.delete(a),o&&D.add(a),S[t]=o?f:null;Y(t,[...D])}function L(t,a,o){const d=t==="left"?C.value:K.value;let v;if(o==="replace")v=a;else if(o)v=[...new Set([...d,...a])];else{const m=new Set(a);v=d.filter(g=>!m.has(g))}S[t]=null,Y(t,v)}function z(t){const a=new Set(t),o=h.value.filter(d=>!a.has(d));r.value=o,l("update:targetKeys",o),V(C.value),l("change",o,"left",[...t])}function nt(t,a,o){if(t===a)return;const d=[...h.value],v=d.indexOf(t),m=d.indexOf(a);if(v<0||m<0)return;const g=d.slice();g.splice(v,1);const f=g.indexOf(a),D=o?f+1:f;g.splice(D,0,t),r.value=g,l("update:targetKeys",g);const w={direction:"right",oldTargetKeys:d,newTargetKeys:g,activeKey:t,fromIndex:v,toIndex:g.indexOf(t)};l("reorder",w)}function at(t){return typeof e.listStyle=="function"?e.listStyle({direction:t}):e.listStyle}const st=k(()=>C.value.length>0),ot=k(()=>K.value.length>0),G=k(()=>e.operations||[]);function J(t){var d,v;const a=t==="left",o=n.value;return{prefixCls:c,direction:t,titleText:((d=e.titles)==null?void 0:d[a?0:1])??"",dataSource:a?b.value:R.value,checkedKeys:a?C.value:K.value,disabled:e.disabled,showSearch:e.showSearch,showSelectAll:e.showSelectAll,showRemove:e.oneWay&&!a,draggable:!!e.draggable&&!a,pagination:e.pagination,selectAllLabel:(v=e.selectAllLabels)==null?void 0:v[a?0:1],render:e.render,filterOption:e.filterOption,footer:e.footer,listStyle:at(t),classNames:e.classNames,styles:e.styles,searchPlaceholder:o.searchPlaceholder,notFoundContent:e.locale.notFoundContent??o.notFoundContent,itemUnit:o.itemUnit,itemsUnit:o.itemsUnit,selectAll:o.selectAll,deselectAll:o.deselectAll,selectCurrent:o.selectCurrent,selectInvert:o.selectInvert,removeAll:o.removeAll,removeCurrent:o.removeCurrent,onItemSelect:(m,g,f)=>P(t,m,g,f==null?void 0:f.shiftKey),onItemSelectAll:(m,g)=>L(t,m,g),onItemRemove:m=>z(m),onReorder:(m,g,f)=>nt(m,g,f),onFilter:(m,g)=>l("search",m,g),onScroll:(m,g)=>l("scroll",m,g)}}return()=>s("div",{class:$(c,e.rootClassName,e.classNames.root,{[`${c}-disabled`]:e.disabled,[`${c}-status-error`]:e.status==="error",[`${c}-status-warning`]:e.status==="warning"}),style:e.styles.root},[s(ft,J("left"),null),s("div",{class:$(`${c}-actions`,e.classNames.actions),style:e.styles.actions},[s(ut,{type:"primary",size:"small",icon:It,disabled:!st.value||e.disabled,onClick:et},{default:()=>[G.value[0]]}),!e.oneWay&&s(ut,{type:"primary",size:"small",icon:$t,disabled:!ot.value||e.disabled,onClick:A},{default:()=>[G.value[1]]})]),s(ft,J("right"),null)])}}),Ot=_({__name:"TransferBasic",setup(e){const l=Array.from({length:10},(y,n)=>({key:String(n),title:`选项 ${n+1}`,description:`描述 ${n+1}`,disabled:n===3})),c=x(["1","3","5"]);return(y,n)=>(E(),X(u(N),{"target-keys":c.value,"onUpdate:targetKeys":n[0]||(n[0]=r=>c.value=r),"data-source":u(l),titles:["待选","已选"],"show-search":""},null,8,["target-keys","data-source"]))}}),Rt=`<template>
...
<\/script>
`,Pt={style:{display:"flex","flex-direction":"column",gap:"24px"}},Lt=_({__name:"TransferClassNames",setup(e){const c=(()=>{const F=[];for(let i=1;i<=10;i++)F.push({key:`item-${i}`,title:`选项 ${i}`,description:`这是选项 ${i} 的描述`});return F})(),y=x(["item-2","item-4"]),n=x(["item-1","item-3"]),r=x(["item-5","item-6"]),T=x(["item-7","item-8"]),h=x(["item-9","item-10"]);return(F,i)=>(E(),ct("div",Pt,[p("div",null,[i[5]||(i[5]=p("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义列表容器和项：",-1)),s(u(N),{"target-keys":y.value,"onUpdate:targetKeys":i[0]||(i[0]=b=>y.value=b),"data-source":u(c),"class-names":{list:"custom-list",item:"custom-item"},titles:["源列表","目标列表"]},null,8,["target-keys","data-source"])]),p("div",null,[i[6]||(i[6]=p("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义头部和标题：",-1)),s(u(N),{"target-keys":n.value,"onUpdate:targetKeys":i[1]||(i[1]=b=>n.value=b),"data-source":u(c),"class-names":{header:"custom-header",title:"custom-title"},titles:["可选项","已选项"]},null,8,["target-keys","data-source"])]),p("div",null,[i[7]||(i[7]=p("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义操作按钮区：",-1)),s(u(N),{"target-keys":r.value,"onUpdate:targetKeys":i[2]||(i[2]=b=>r.value=b),"data-source":u(c),"class-names":{actions:"custom-actions"},titles:["左侧","右侧"]},null,8,["target-keys","data-source"])]),p("div",null,[i[8]||(i[8]=p("div",{style:{"margin-bottom":"8px",color:"#666"}},"完整自定义（组合使用）：",-1)),s(u(N),{"target-keys":T.value,"onUpdate:targetKeys":i[3]||(i[3]=b=>T.value=b),"data-source":u(c),"class-names":{root:"complete-root",section:"complete-section",header:"complete-header",title:"complete-title",body:"complete-body",list:"complete-list",item:"complete-item",actions:"complete-actions"},titles:["待选区","已选区"]},null,8,["target-keys","data-source"])]),p("div",null,[i[9]||(i[9]=p("div",{style:{"margin-bottom":"8px",color:"#666"}},"使用内联样式（styles）：",-1)),s(u(N),{"target-keys":h.value,"onUpdate:targetKeys":i[4]||(i[4]=b=>h.value=b),"data-source":u(c),styles:{section:{border:"2px solid #1890ff",borderRadius:"8px"},header:{background:"linear-gradient(135deg, #667eea 0%, #764ba2 100%)",color:"white",padding:"12px 16px"},list:{background:"#fafafa"},item:{padding:"12px 16px",borderRadius:"4px"}},titles:["来源","目标"]},null,8,["target-keys","data-source"])])]))}}),Bt=Kt(Lt,[["__scopeId","data-v-736c8795"]]),_t=`<template>
...
`,Ft=_({__name:"TransferCustom",setup(e){const l=Array.from({length:10},(y,n)=>({key:String(n),title:`选项 ${n+1}`})),c=x(["1","3"]);return(y,n)=>(E(),X(u(N),{"target-keys":c.value,"onUpdate:targetKeys":n[0]||(n[0]=r=>c.value=r),"data-source":u(l),titles:["待选","已选"],render:r=>`[${r.title}]`},null,8,["target-keys","data-source","render"]))}}),Et=`<template>
  <Transfer
...
<\/script>
`,zt={style:{"margin-top":"12px",color:"rgba(0, 0, 0, 0.45)","font-size":"12px"}},jt=_({__name:"TransferDraggable",setup(e){const l=Array.from({length:8},(n,r)=>({key:String(r),title:`Item ${r+1}`})),c=x(["0","1","2","3"]);function y(n){console.log("reorder",n)}return(n,r)=>(E(),ct(rt,null,[s(u(N),{"target-keys":c.value,"onUpdate:targetKeys":r[0]||(r[0]=T=>c.value=T),"data-source":u(l),titles:["源","目标（可拖拽排序）"],draggable:"",onReorder:y},null,8,["target-keys","data-source"]),p("p",zt," 当前顺序："+Ct(c.value.join(", ")||"（空）"),1)],64))}}),Ut=`<template>
  <Transfer
    v-model:target-keys="targetKeys"
    :data-source="dataSource"
    :titles="['源', '目标（可拖拽排序）']"
...
<\/script>
`,Vt=_({__name:"TransferOneWay",setup(e){const l=Array.from({length:10},(y,n)=>({key:String(n),title:`Item ${n+1}`})),c=x(["1","3"]);return(y,n)=>(E(),X(u(N),{"target-keys":c.value,"onUpdate:targetKeys":n[0]||(n[0]=r=>c.value=r),"data-source":u(l),titles:["源","目标"],"one-way":""},null,8,["target-keys","data-source"]))}}),Mt=`<template>
...
const targetKeys = ref<string[]>(['1', '3'])
<\/script>
`,Wt=_({__name:"TransferPagination",setup(e){const l=Array.from({length:20},(y,n)=>({key:String(n),title:`选项 ${n+1}`})),c=x(["2","5","8"]);return(y,n)=>(E(),X(u(N),{"target-keys":c.value,"onUpdate:targetKeys":n[0]||(n[0]=r=>c.value=r),"data-source":u(l),titles:["源","目标"],pagination:{pageSize:5}},null,8,["target-keys","data-source"]))}}),Ht=`<template>
  <Transfer
    v-model:target-keys="targetKeys"
    :data-source="dataSource"
    :titles="['源', '目标']"
...
<\/script>
`,Xt=_({__name:"TransferSearch",setup(e){const l=Array.from({length:20},(y,n)=>({key:String(n),title:`选项 ${n+1}`,description:`描述 ${n+1}`,disabled:n%8===3})),c=x(["1","3","5"]);return(y,n)=>(E(),X(u(N),{"target-keys":c.value,"onUpdate:targetKeys":n[0]||(n[0]=r=>c.value=r),"data-source":u(l),titles:["待选","已选"],"show-search":""},null,8,["target-keys","data-source"]))}}),Yt=`<template>
  <Transfer v-model:target-keys="targetKeys" :data-source="dataSource" :titles="['待选', '已选']" show-search />
</template>
