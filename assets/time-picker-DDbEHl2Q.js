import{m as S,L as X,B as m,O as Y,v as G,w as J,l as a,k as v,T as K,F as Q,d as g,y as $,i as H,I as p,f as o,H as W,E as Z,P as B,j as _}from"./index-CsoOETlJ.js";import{c as k}from"./cls-S9IiI6wd.js";function b(t){return String(t).padStart(2,"0")}function w(t){if(!t)return{h:0,m:0,s:0};const u=t.split(":").map(Number);return{h:u[0]??0,m:u[1]??0,s:u[2]??0}}function N(t,u,d,c="HH:mm:ss"){return c.replace("HH",b(t)).replace("mm",b(u)).replace("ss",b(d)).replace("H",String(t)).replace("m",String(u)).replace("s",String(d))}function ee(t="HH:mm:ss"){return t.includes("s")}const f=S({name:"TimePicker",props:{value:String,defaultValue:String,format:{type:String,default:"HH:mm:ss"},disabled:Boolean,size:{type:String,default:"middle"},placeholder:{type:String,default:"请选择时间"},allowClear:{type:Boolean,default:!0},hourStep:{type:Number,default:1},minuteStep:{type:Number,default:1},secondStep:{type:Number,default:1},disabledHours:Function,disabledMinutes:Function,disabledSeconds:Function,showNow:{type:Boolean,default:!0},use12Hours:Boolean,status:{type:String,default:""},open:{type:Boolean,default:void 0}},emits:["update:value","change","openChange"],setup(t,{emit:u}){const d=X("time-picker"),c=w(t.defaultValue??t.value),l=m(c.h),n=m(c.m),i=m(c.s),h=m(!1),y=m(),V=m(),U=g(()=>t.open!==void 0?t.open:h.value),D=g(()=>{if(t.value){const e=w(t.value);return N(e.h,e.m,e.s,t.format)}return h.value||l.value||n.value||i.value?N(l.value,n.value,i.value,t.format):""}),P=g(()=>{if(t.value){const e=w(t.value);return{h:e.h,m:e.m,s:e.s}}return{h:l.value,m:n.value,s:i.value}});Y(()=>t.value,e=>{if(e){const r=w(e);l.value=r.h,n.value=r.m,i.value=r.s}});const T=m({top:0,left:0}),E=()=>{if(!y.value)return;const e=y.value.getBoundingClientRect();T.value={top:e.bottom+window.scrollY+4,left:e.left+window.scrollX}},M=()=>{t.disabled||(E(),h.value=!0,u("openChange",!0))},F=()=>{h.value=!1,u("openChange",!1)},z=()=>{const e=N(l.value,n.value,i.value,t.format);u("update:value",e),u("change",e),F()},I=()=>{const e=new Date;l.value=e.getHours(),n.value=e.getMinutes(),i.value=e.getSeconds()},O=e=>{e.stopPropagation(),l.value=0,n.value=0,i.value=0,u("update:value",void 0),u("change",void 0)},A=e=>{var r,s;!((r=y.value)!=null&&r.contains(e.target))&&!((s=V.value)!=null&&s.contains(e.target))&&F()};G(()=>document.addEventListener("mousedown",A)),J(()=>document.removeEventListener("mousedown",A));const q=g(()=>{var r;const e=((r=t.disabledHours)==null?void 0:r.call(t))??[];return Array.from({length:t.use12Hours?12:24},(s,x)=>x*(t.hourStep??1)).filter(s=>!e.includes(s))}),L=g(()=>{var r;const e=((r=t.disabledMinutes)==null?void 0:r.call(t,P.value.h))??[];return Array.from({length:60},(s,x)=>x).filter(s=>s%(t.minuteStep??1)===0&&!e.includes(s))}),R=g(()=>{var r;const e=((r=t.disabledSeconds)==null?void 0:r.call(t,P.value.h,P.value.m))??[];return Array.from({length:60},(s,x)=>x).filter(s=>s%(t.secondStep??1)===0&&!e.includes(s))}),j=g(()=>ee(t.format)),C=(e,r)=>{if(!e)return;const s=e.querySelector(`[data-value="${r}"]`);s&&s.scrollIntoView({block:"nearest"})};return()=>a(Q,null,[a("div",{ref:y,class:k(d,`${d}-${t.size}`,{[`${d}-open`]:U.value,[`${d}-disabled`]:t.disabled,[`${d}-status-error`]:t.status==="error",[`${d}-status-warning`]:t.status==="warning"}),onClick:M},[a("span",{class:`${d}-input`},[a("input",{readonly:!0,placeholder:t.placeholder,value:D.value,disabled:t.disabled,class:`${d}-input-inner`},null),t.allowClear&&D.value&&!t.disabled&&a("span",{class:`${d}-clear`,onClick:O},[v("✕")]),a("span",{class:`${d}-suffix`},[v("🕐")])])]),U.value&&a(K,{to:"body"},{default:()=>[a("div",{ref:V,class:`${d}-panel-container`,style:{position:"absolute",top:`${T.value.top}px`,left:`${T.value.left}px`,zIndex:1050}},[a("div",{class:`${d}-panel`},[a("div",{class:`${d}-panel-inner`},[a("ul",{class:`${d}-panel-column`,ref:e=>C(e,l.value)},[q.value.map(e=>a("li",{key:e,"data-value":e,class:k(`${d}-panel-cell`,{[`${d}-panel-cell-selected`]:l.value===e}),onClick:()=>{l.value=e}},[b(e)]))]),a("ul",{class:`${d}-panel-column`,ref:e=>C(e,n.value)},[L.value.map(e=>a("li",{key:e,"data-value":e,class:k(`${d}-panel-cell`,{[`${d}-panel-cell-selected`]:n.value===e}),onClick:()=>{n.value=e}},[b(e)]))]),j.value&&a("ul",{class:`${d}-panel-column`,ref:e=>C(e,i.value)},[R.value.map(e=>a("li",{key:e,"data-value":e,class:k(`${d}-panel-cell`,{[`${d}-panel-cell-selected`]:i.value===e}),onClick:()=>{i.value=e}},[b(e)]))])]),a("div",{class:`${d}-panel-footer`},[t.showNow&&a("button",{class:`${d}-panel-footer-btn`,onClick:I},[v("此刻")]),a("button",{class:`${d}-panel-footer-btn ${d}-panel-footer-ok`,onClick:z},[v("确定")])])])])]})])}}),te={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"300px"}},ne=S({__name:"TimePickerBasic",setup(t){const u=m(""),d=m("10:30:00"),c=l=>{console.log("选中时间：",l)};return(l,n)=>($(),H("div",te,[a(p(f),{value:u.value,"onUpdate:value":n[0]||(n[0]=i=>u.value=i),placeholder:"请选择时间",onChange:c},null,8,["value"]),a(p(f),{value:d.value,"onUpdate:value":n[1]||(n[1]=i=>d.value=i),placeholder:"禁用状态",disabled:""},null,8,["value"]),o("p",null,"选中时间："+W(u.value),1)]))}}),le=`<template>
