import{o as v,N as L,E as _,Q as z,x as U,n as a,f as q,F,t as H,A as k,i as I,K as u,p as S,k as O,h as s,S as Q,O as W,H as J,l as R,R as x}from"./index-C7r7ERgN.js";import{c as w}from"./cls-S9IiI6wd.js";import{I as K}from"./Icon-Bn-1ylNX.js";import{C as X}from"./CloseOutlined-BOy0Oguu.js";import{P as Y}from"./PlusOutlined-BvodXwgk.js";import{a as Z,A as tt}from"./AppleOutlined-PZMNmIY_.js";const T=v({name:"Tabs",props:{activeKey:String,defaultActiveKey:String,type:{type:String,default:"line"},size:String,tabPosition:{type:String,default:"top"},centered:Boolean,items:Array,animated:{type:[Boolean,Object],default:!0},tabBarExtraContent:[Object,Function],tabBarGutter:Number,tabBarStyle:Object,hideAdd:Boolean,addIcon:Object,removeIcon:Object,destroyInactiveTabPane:Boolean},emits:["update:activeKey","change","tabClick","edit"],setup(t,{slots:d,emit:i}){var V,D;const n=L("tabs"),e=_(t.defaultActiveKey??((D=(V=t.items)==null?void 0:V[0])==null?void 0:D.key)??""),r=_(null),m=_(null);z(()=>t.activeKey,l=>{l!==void 0&&(e.value=l)});const f=q(()=>t.activeKey!==void 0?t.activeKey:e.value),$=q(()=>typeof t.animated=="boolean"?{inkBar:t.animated,tabPane:t.animated}:{inkBar:!0,tabPane:!1,...t.animated}),g=()=>{if(!r.value||!m.value||t.type!=="line")return;const l=r.value.querySelector(`.${n}-tab-active`);if(!l)return;t.tabPosition==="left"||t.tabPosition==="right"?(m.value.style.top=`${l.offsetTop}px`,m.value.style.height=`${l.offsetHeight}px`,m.value.style.width="2px",m.value.style.left=t.tabPosition==="left"?"auto":"0",m.value.style.right=t.tabPosition==="left"?"0":"auto"):(m.value.style.left=`${l.offsetLeft}px`,m.value.style.width=`${l.offsetWidth}px`,m.value.style.height="2px",m.value.style.top="auto",m.value.style.bottom="0")};z(f,()=>{H(g)}),U(()=>{g()});const N=(l,b)=>{e.value=l,i("update:activeKey",l),i("change",l),i("tabClick",l,b)},M=l=>{i("edit",l,"add")},j=(l,b)=>{b.stopPropagation(),i("edit",l,"remove")},G=(l,b,P)=>{var B,o,y;const p=t.items??[];let c=P;if(b.key==="ArrowLeft"||b.key==="ArrowUp")b.preventDefault(),c=P-1,c<0&&(c=p.length-1);else if(b.key==="ArrowRight"||b.key==="ArrowDown")b.preventDefault(),c=P+1,c>=p.length&&(c=0);else if(b.key==="Enter"||b.key===" "){b.preventDefault(),p[P].disabled||N(l,b);return}else return;let A=0;for(;(B=p[c])!=null&&B.disabled&&A<p.length;)c=b.key==="ArrowLeft"||b.key==="ArrowUp"?c-1:c+1,c<0&&(c=p.length-1),c>=p.length&&(c=0),A++;if(!((o=p[c])!=null&&o.disabled)){const h=(y=r.value)==null?void 0:y.querySelectorAll(`.${n}-tab`)[c];h==null||h.focus()}};return()=>{const l=t.items??[],b=t.type==="editable-card",P=t.size?`${n}-${t.size}`:"",p=t.tabPosition!=="top"?`${n}-${t.tabPosition}`:"",c=t.tabPosition==="left"||t.tabPosition==="right",A=t.tabBarGutter!==void 0?c?{marginBottom:`${t.tabBarGutter}px`}:{marginRight:`${t.tabBarGutter}px`}:{},B=()=>{if(!t.tabBarExtraContent)return null;if(typeof t.tabBarExtraContent=="object"&&"left"in t.tabBarExtraContent){const o=t.tabBarExtraContent;return a(F,null,[o.left&&a("div",{class:`${n}-extra-content-left`},[o.left]),o.right&&a("div",{class:`${n}-extra-content-right`},[o.right])])}return a("div",{class:`${n}-extra-content`},[t.tabBarExtraContent])};return a("div",{class:w(n,`${n}-${t.type}`,P,p,{[`${n}-centered`]:t.centered})},[a("div",{class:`${n}-nav`,style:t.tabBarStyle},[B(),a("div",{class:`${n}-nav-wrap`},[a("div",{ref:r,class:`${n}-nav-list`,role:"tablist","aria-orientation":c?"vertical":"horizontal"},[l.map((o,y)=>{const h=o.key===f.value,E=b&&o.closable!==!1;return a("div",{key:o.key,id:`tab-${o.key}`,class:w(`${n}-tab`,{[`${n}-tab-active`]:h,[`${n}-tab-disabled`]:o.disabled}),style:y<l.length-1?A:void 0,role:"tab","aria-selected":h,"aria-controls":`tabpanel-${o.key}`,"aria-disabled":o.disabled||void 0,tabindex:o.disabled?-1:h?0:-1,onClick:C=>!o.disabled&&N(o.key,C),onKeydown:C=>G(o.key,C,y)},[a("div",{class:`${n}-tab-btn`},[o.icon&&a("span",{class:`${n}-tab-icon`},[o.icon]),o.label,E&&a("button",{type:"button",class:`${n}-tab-remove`,"aria-label":"remove",tabindex:-1,onClick:C=>j(o.key,C)},[o.closeIcon||t.removeIcon||a(K,{component:X},null)])])])}),b&&!t.hideAdd&&a("button",{type:"button",class:`${n}-nav-add`,"aria-label":"add",onClick:M},[t.addIcon||a(K,{component:Y},null)])]),t.type==="line"&&a("div",{ref:m,class:w(`${n}-ink-bar`,{[`${n}-ink-bar-animated`]:$.value.inkBar})},null)])]),a("div",{class:`${n}-content-holder`},[a("div",{class:w(`${n}-content`,{[`${n}-content-animated`]:$.value.tabPane})},[l.map(o=>{var C;const y=o.key===f.value,h=y||o.forceRender||!t.destroyInactiveTabPane,E=t.destroyInactiveTabPane&&!y&&!o.forceRender;return a("div",{key:o.key,id:`tabpanel-${o.key}`,class:w(`${n}-tabpane`,{[`${n}-tabpane-active`]:y,[`${n}-tabpane-hidden`]:!y}),role:"tabpanel","aria-labelledby":`tab-${o.key}`,tabindex:y?0:-1,hidden:!y||void 0},[h&&!E&&(o.children??((C=d[o.key])==null?void 0:C.call(d)))])})])])])}}}),et=v({__name:"TabsBasic",setup(t){const d=[{key:"1",label:"Tab 1",children:"Content of Tab Pane 1"},{key:"2",label:"Tab 2",children:"Content of Tab Pane 2"},{key:"3",label:"Tab 3",children:"Content of Tab Pane 3"}],i=n=>{console.log("Active tab:",n)};return(n,e)=>(k(),I(u(T),{items:d,onChange:i}))}}),nt=`<template>
...
<\/script>
`,at=v({__name:"TabsCard",setup(t){const d=[{key:"1",label:"Tab 1",children:"Content of Tab Pane 1"},{key:"2",label:"Tab 2",children:"Content of Tab Pane 2"},{key:"3",label:"Tab 3",children:"Content of Tab Pane 3"}];return(i,n)=>(k(),I(u(T),{type:"card",items:d}))}}),ot=`<template>
...
<\/script>
`,dt=v({__name:"TabsCentered",setup(t){const d=[{key:"1",label:"Tab 1",children:"Content of Tab 1"},{key:"2",label:"Tab 2",children:"Content of Tab 2"},{key:"3",label:"Tab 3",children:"Content of Tab 3"}];return(i,n)=>(k(),I(u(T),{items:d,centered:""}))}}),lt=`<template>
...
<\/script>
`,ct=v({__name:"TabsIcon",setup(t){const d=[{key:"1",label:"Tab 1",icon:S(K,{component:Z}),children:"Content of Tab 1"},{key:"2",label:"Tab 2",icon:S(K,{component:tt}),children:"Content of Tab 2"}];return(i,n)=>(k(),I(u(T),{items:d}))}}),ut=`<template>
  <Tabs :items="items" />
</template>
...
<\/script>
`,mt={style:{"margin-bottom":"16px"}},ft=v({__name:"TabsPosition",setup(t){const d=_("top"),i=[{key:"1",label:"Tab 1",children:"Content of Tab 1"},{key:"2",label:"Tab 2",children:"Content of Tab 2"},{key:"3",label:"Tab 3",children:"Content of Tab 3"}];return(n,e)=>(k(),O("div",null,[s("div",mt,[e[2]||(e[2]=s("span",null,"Tab Position: ",-1)),Q(s("select",{"onUpdate:modelValue":e[0]||(e[0]=r=>d.value=r)},[...e[1]||(e[1]=[s("option",{value:"top"},"top",-1),s("option",{value:"bottom"},"bottom",-1),s("option",{value:"left"},"left",-1),s("option",{value:"right"},"right",-1)])],512),[[W,d.value]])]),a(u(T),{items:i,"tab-position":d.value},null,8,["tab-position"])]))}}),yt=`<template>
  <div>
...
<\/script>
`,pt=v({__name:"TabsSize",setup(t){const d=[{key:"1",label:"Tab 1",children:"Content of Tab 1"},{key:"2",label:"Tab 2",children:"Content of Tab 2"},{key:"3",label:"Tab 3",children:"Content of Tab 3"}];return(i,n)=>(k(),O("div",null,[a(u(T),{items:d,size:"small",style:{"margin-bottom":"16px"}}),a(u(T),{items:d,style:{"margin-bottom":"16px"}}),a(u(T),{items:d,size:"large"})]))}}),Tt=`<template>
  <div>
