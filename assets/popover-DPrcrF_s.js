...
<\/script>
`,Q={style:{display:"flex",gap:"24px","flex-wrap":"wrap"}},J=P({__name:"PopoverPurePanel",setup(n){return(l,p)=>(x(),h("div",Q,[e(s(c)._InternalPanelDoNotUseOrYouWillBeFired,{title:"标题",content:"这是直接内联渲染的气泡卡片面板"}),e(s(c)._InternalPanelDoNotUseOrYouWillBeFired,{title:"仅标题",placement:"bottom"}),e(s(c)._InternalPanelDoNotUseOrYouWillBeFired,{content:"无箭头 + 自定义背景色",arrow:!1,color:"#1677ff",styles:{content:{color:"#fff"}}})]))}}),X=`<template>
