import{d as B,u as on,D as ln,r as f,m as pn,c as s,a as v,F as cn,g as i,n as un,o as E,b as _,e as g,f as c,s as J,_ as rn,h as dn,w as I,i as kn}from"./index-dV6GQSVR.js";import{c as u}from"./cls-S9IiI6wd.js";import{C as mn}from"./CloseCircleFilled-r9gMBFNY.js";import{C as gn}from"./CalendarOutlined-CalkYXdD.js";import{T as vn}from"./Trigger-D06LQVmT.js";function z(a){return String(a).padStart(2,"0")}function sa(a,o="YYYY-MM-DD"){return o.replace("YYYY",String(a.getFullYear())).replace("MM",z(a.getMonth()+1)).replace("DD",z(a.getDate())).replace("HH",z(a.getHours())).replace("mm",z(a.getMinutes())).replace("ss",z(a.getSeconds()))}function Q(a){if(!a)return null;const o=new Date(a);return isNaN(o.getTime())?null:o}function Ta(a,o){return a.getFullYear()===o.getFullYear()&&a.getMonth()===o.getMonth()&&a.getDate()===o.getDate()}function yn(a,o){return a.getFullYear()===o.getFullYear()&&a.getMonth()===o.getMonth()}function hn(a,o){return a.getFullYear()===o.getFullYear()}function Ya(a,o){return new Date(a,o+1,0).getDate()}function fn(a,o){return new Date(a,o,1).getDay()}function bn(a,o){const n=[],r=fn(a,o),e=Ya(a,o),k=Ya(a,o-1);for(let p=r-1;p>=0;p--)n.push({date:new Date(a,o-1,k-p),inCurrentMonth:!1});for(let p=1;p<=e;p++)n.push({date:new Date(a,o,p),inCurrentMonth:!0});const y=42-n.length;for(let p=1;p<=y;p++)n.push({date:new Date(a,o+1,p),inCurrentMonth:!1});return n}const q=B({name:"DatePicker",props:{value:String,defaultValue:String,format:String,disabled:Boolean,size:{type:String,default:"middle"},placeholder:String,allowClear:{type:Boolean,default:!0},picker:{type:String,default:"date"},showTime:[Boolean,Object],showToday:{type:Boolean,default:!0},showNow:Boolean,disabledDate:Function,status:{type:String,default:""},open:{type:Boolean,default:void 0},defaultOpen:Boolean,presets:Array,minDate:String,maxDate:String,renderExtraFooter:Function,cellRender:Function,classNames:Object,styles:Object},emits:["update:value","change","openChange","panelChange"],setup(a,{emit:o}){var ca,ua,ra;const n=on("date-picker"),r=ln(),e=new Date,k=v(()=>a.format?a.format:a.picker==="year"?"YYYY":a.picker==="month"?"YYYY-MM":a.picker==="quarter"?"YYYY-[Q]Q":a.showTime?"YYYY-MM-DD HH:mm:ss":"YYYY-MM-DD"),y=v(()=>{if(a.placeholder)return a.placeholder;const t=r.value.DatePicker;return a.picker==="year"?t.yearPlaceholder:a.picker==="month"?t.monthPlaceholder:t.placeholder}),p=f(Q(a.defaultValue??a.value)),A=f(((ca=p.value)==null?void 0:ca.getHours())??0),R=f(((ua=p.value)==null?void 0:ua.getMinutes())??0),V=f(((ra=p.value)==null?void 0:ra.getSeconds())??0),O=v(()=>a.showTime?typeof a.showTime=="boolean"?{}:a.showTime:null),W=v(()=>!!a.showTime),S=f((p.value??e).getFullYear()),M=f((p.value??e).getMonth()),K=f(a.defaultOpen??!1),C=f(a.picker==="year"?"year":a.picker==="month"?"month":"date"),Fa=f(),ea=v(()=>a.open!==void 0?a.open:K.value),$=v(()=>a.value?Q(a.value):p.value),oa=v(()=>a.minDate?Q(a.minDate):null),la=v(()=>a.maxDate?Q(a.maxDate):null),pa=v(()=>{const t=$.value;if(!t)return"";if(a.picker==="quarter"){const l=Math.floor(t.getMonth()/3)+1;return`${t.getFullYear()}-Q${l}`}return sa(t,k.value)});pn(()=>a.value,t=>{p.value=Q(t)});const Ba=()=>{if(a.disabled)return;const t=$.value??e;S.value=t.getFullYear(),M.value=t.getMonth(),C.value=a.picker==="year"?"year":a.picker==="month"?"month":"date",W.value&&t&&(A.value=t.getHours(),R.value=t.getMinutes(),V.value=t.getSeconds()),K.value=!0,o("openChange",!0)},Z=()=>{K.value=!1,o("openChange",!1)},U=t=>{var d;if((d=a.disabledDate)!=null&&d.call(a,t)||oa.value&&t<oa.value||la.value&&t>la.value)return;if(W.value){const h=new Date(t.getFullYear(),t.getMonth(),t.getDate(),A.value,R.value,V.value);p.value=h;return}p.value=t;const l=a.picker==="quarter"?`${t.getFullYear()}-Q${Math.floor(t.getMonth()/3)+1}`:sa(t,k.value);o("update:value",l),o("change",l,t),Z()},Ea=t=>{if(A.value=t,p.value){const l=p.value;p.value=new Date(l.getFullYear(),l.getMonth(),l.getDate(),t,R.value,V.value)}},_a=t=>{if(R.value=t,p.value){const l=p.value;p.value=new Date(l.getFullYear(),l.getMonth(),l.getDate(),A.value,t,V.value)}},Oa=t=>{if(V.value=t,p.value){const l=p.value;p.value=new Date(l.getFullYear(),l.getMonth(),l.getDate(),A.value,R.value,t)}},Ha=()=>{if(!p.value)return;const t=sa(p.value,k.value);o("update:value",t),o("change",t,p.value),Z()},Ia=t=>{t.stopPropagation(),p.value=null,o("update:value",void 0),o("change",void 0,null)},Aa=t=>{const l=typeof t.value=="function"?t.value():t.value,d=Q(l);d&&U(d)},Ra=()=>{M.value===0?(S.value--,M.value=11):M.value--,o("panelChange",null,C.value)},Va=()=>{M.value===11?(S.value++,M.value=0):M.value++,o("panelChange",null,C.value)},aa=()=>{S.value--,o("panelChange",null,C.value)},na=()=>{S.value++,o("panelChange",null,C.value)},Ua=v(()=>bn(S.value,M.value)),ja=v(()=>{const t=O.value;return t&&typeof t=="object"&&"hourStep"in t&&t.hourStep?t.hourStep:1}),Qa=v(()=>{const t=O.value;return t&&typeof t=="object"&&"minuteStep"in t&&t.minuteStep?t.minuteStep:1}),za=v(()=>{const t=O.value;return t&&typeof t=="object"&&"secondStep"in t&&t.secondStep?t.secondStep:1}),Wa=v(()=>{const t=[];for(let l=0;l<24;l+=ja.value)t.push(l);return t}),La=v(()=>{const t=[];for(let l=0;l<60;l+=Qa.value)t.push(l);return t}),Xa=v(()=>{const t=[];for(let l=0;l<60;l+=za.value)t.push(l);return t}),Ga=v(()=>{if(!W.value)return!1;const t=O.value&&"format"in O.value&&O.value.format?O.value.format:k.value;return t.includes("ss")||t.includes("s")}),X=v(()=>{const t=Math.floor(S.value/10)*10;return Array.from({length:10},(l,d)=>t+d)}),Ja=(t,l)=>{t&&un(()=>{const d=t.querySelector(`[data-value="${l}"]`);d&&typeof d.scrollIntoView=="function"&&d.scrollIntoView({block:"nearest"})})},ta=(t,l,d)=>{var h,w;return s("ul",{class:u(`${n}-time-column`,(h=a.classNames)==null?void 0:h.timeColumn),style:(w=a.styles)==null?void 0:w.timeColumn,ref:m=>Ja(m,l)},[t.map(m=>{var x,D;return s("li",{key:m,"data-value":m,class:u(`${n}-time-cell`,{[`${n}-time-cell-selected`]:l===m},(x=a.classNames)==null?void 0:x.timeCell),style:(D=a.styles)==null?void 0:D.timeCell,onClick:()=>d(m)},[z(m)])})])},Ka=()=>{var t,l,d,h,w,m,x,D,b,P,T,Y,F,L,da,ia,ka,ma,ga,va,ya,ha,fa,ba,wa,xa,Da,Sa,qa;return s("div",{class:u(`${n}-panel`,{[`${n}-panel-has-time`]:W.value},(t=a.classNames)==null?void 0:t.panel),style:(l=a.styles)==null?void 0:l.panel},[s("div",{class:`${n}-panel-layout`},[s("div",{class:`${n}-date-panel`},[s("div",{class:u(`${n}-panel-header`,(d=a.classNames)==null?void 0:d.panelHeader),style:(h=a.styles)==null?void 0:h.panelHeader},[s("button",{class:`${n}-panel-header-btn`,onClick:aa},[i("«")]),s("button",{class:`${n}-panel-header-btn`,onClick:Ra},[i("‹")]),s("span",{class:`${n}-panel-header-title`},[s("button",{class:`${n}-panel-header-title-btn`,onClick:()=>{C.value="year",o("panelChange",null,"year")}},[S.value,i("年")]),s("button",{class:`${n}-panel-header-title-btn`,onClick:()=>{C.value="month",o("panelChange",null,"month")}},[r.value.DatePicker.months[M.value]])]),s("button",{class:`${n}-panel-header-btn`,onClick:Va},[i("›")]),s("button",{class:`${n}-panel-header-btn`,onClick:na},[i("»")])]),s("div",{class:u(`${n}-panel-body`,(w=a.classNames)==null?void 0:w.panelBody),style:(m=a.styles)==null?void 0:m.panelBody},[s("div",{class:u(`${n}-weekdays`,(x=a.classNames)==null?void 0:x.weekdays),style:(D=a.styles)==null?void 0:D.weekdays},[r.value.DatePicker.weekdays.map(N=>{var j,H;return s("span",{key:N,class:u(`${n}-weekday`,(j=a.classNames)==null?void 0:j.weekday),style:(H=a.styles)==null?void 0:H.weekday},[N])})]),s("div",{class:u(`${n}-days`,(b=a.classNames)==null?void 0:b.days),style:(P=a.styles)==null?void 0:P.days},[Ua.value.map(({date:N,inCurrentMonth:j},H)=>{var Na,$a,Ma;const G=Ta(N,e),sn=$.value?Ta(N,$.value):!1,Ca=((Na=a.disabledDate)==null?void 0:Na.call(a,N))??!1,Pa=s("span",null,[N.getDate()]),en=a.cellRender?a.cellRender(N,{originNode:Pa,today:e,type:"date"}):Pa;return s("button",{key:H,class:u(`${n}-day`,{[`${n}-day-other-month`]:!j,[`${n}-day-today`]:G,[`${n}-day-selected`]:sn,[`${n}-day-disabled`]:Ca},($a=a.classNames)==null?void 0:$a.day),style:(Ma=a.styles)==null?void 0:Ma.day,disabled:Ca,onClick:()=>U(N)},[en])})])])]),W.value&&s("div",{class:u(`${n}-time-panel`,(T=a.classNames)==null?void 0:T.timePanel),style:(Y=a.styles)==null?void 0:Y.timePanel},[s("div",{class:u(`${n}-time-content`,(F=a.classNames)==null?void 0:F.timeContent),style:(L=a.styles)==null?void 0:L.timeContent},[ta(Wa.value,A.value,Ea),ta(La.value,R.value,_a),Ga.value&&ta(Xa.value,V.value,Oa)])])]),(a.showToday||a.showNow||a.showTime||((da=a.presets)==null?void 0:da.length)||a.renderExtraFooter)&&s("div",{class:u(`${n}-panel-footer`,(ia=a.classNames)==null?void 0:ia.panelFooter),style:(ka=a.styles)==null?void 0:ka.panelFooter},[s("div",{class:u(`${n}-panel-footer-extra`,(ma=a.classNames)==null?void 0:ma.panelFooterExtra),style:(ga=a.styles)==null?void 0:ga.panelFooterExtra},[((va=a.presets)==null?void 0:va.length)&&s("div",{class:u(`${n}-presets`,(ya=a.classNames)==null?void 0:ya.presets),style:(ha=a.styles)==null?void 0:ha.presets},[a.presets.map((N,j)=>{var H,G;return s("button",{key:j,class:u(`${n}-preset-btn`,(H=a.classNames)==null?void 0:H.presetBtn),style:(G=a.styles)==null?void 0:G.presetBtn,onClick:()=>Aa(N)},[N.label])})]),(fa=a.renderExtraFooter)==null?void 0:fa.call(a)]),s("div",{class:u(`${n}-panel-footer-actions`,(ba=a.classNames)==null?void 0:ba.panelFooterActions),style:(wa=a.styles)==null?void 0:wa.panelFooterActions},[(a.showToday||a.showNow)&&s("button",{class:u(`${n}-panel-footer-today`,(xa=a.classNames)==null?void 0:xa.today),style:(Da=a.styles)==null?void 0:Da.today,onClick:()=>U(new Date)},[a.showNow?r.value.DatePicker.now:r.value.DatePicker.today]),a.showTime&&s("button",{class:u(`${n}-panel-footer-ok`,(Sa=a.classNames)==null?void 0:Sa.ok),style:(qa=a.styles)==null?void 0:qa.ok,onClick:Ha},[r.value.DatePicker.ok])])])])},Za=()=>{var t,l,d,h,w,m,x,D;return s("div",{class:u(`${n}-panel`,(t=a.classNames)==null?void 0:t.panel),style:(l=a.styles)==null?void 0:l.panel},[s("div",{class:u(`${n}-panel-header`,(d=a.classNames)==null?void 0:d.panelHeader),style:(h=a.styles)==null?void 0:h.panelHeader},[s("button",{class:`${n}-panel-header-btn`,onClick:aa},[i("«")]),s("span",{class:`${n}-panel-header-title`},[s("button",{class:`${n}-panel-header-title-btn`,onClick:()=>{C.value="year",o("panelChange",null,"year")}},[S.value,i("年")])]),s("button",{class:`${n}-panel-header-btn`,onClick:na},[i("»")])]),s("div",{class:u(`${n}-panel-body`,(w=a.classNames)==null?void 0:w.panelBody),style:(m=a.styles)==null?void 0:m.panelBody},[s("div",{class:u(`${n}-months`,(x=a.classNames)==null?void 0:x.months),style:(D=a.styles)==null?void 0:D.months},[r.value.DatePicker.months.map((b,P)=>{var F,L;const T=new Date(S.value,P,1),Y=$.value?yn(T,$.value):!1;return s("button",{key:P,class:u(`${n}-month`,{[`${n}-month-selected`]:Y},(F=a.classNames)==null?void 0:F.month),style:(L=a.styles)==null?void 0:L.month,onClick:()=>{M.value=P,a.picker==="month"?U(T):(C.value="date",o("panelChange",null,"date"))}},[b])})])])])},an=()=>{var t,l,d,h,w,m,x,D;return s("div",{class:u(`${n}-panel`,(t=a.classNames)==null?void 0:t.panel),style:(l=a.styles)==null?void 0:l.panel},[s("div",{class:u(`${n}-panel-header`,(d=a.classNames)==null?void 0:d.panelHeader),style:(h=a.styles)==null?void 0:h.panelHeader},[s("button",{class:`${n}-panel-header-btn`,onClick:()=>{S.value-=10}},[i("«")]),s("span",{class:`${n}-panel-header-title`},[X.value[0],i("年 - "),X.value[X.value.length-1],i("年")]),s("button",{class:`${n}-panel-header-btn`,onClick:()=>{S.value+=10}},[i("»")])]),s("div",{class:u(`${n}-panel-body`,(w=a.classNames)==null?void 0:w.panelBody),style:(m=a.styles)==null?void 0:m.panelBody},[s("div",{class:u(`${n}-years`,(x=a.classNames)==null?void 0:x.years),style:(D=a.styles)==null?void 0:D.years},[X.value.map(b=>{var T,Y;const P=$.value?hn(new Date(b,0,1),$.value):!1;return s("button",{key:b,class:u(`${n}-year`,{[`${n}-year-selected`]:P},(T=a.classNames)==null?void 0:T.year),style:(Y=a.styles)==null?void 0:Y.year,onClick:()=>{S.value=b,a.picker==="year"?U(new Date(b,0,1)):(C.value="month",o("panelChange",null,"month"))}},[b,i("年")])})])])])},nn=()=>{var t,l,d,h,w,m,x,D;return s("div",{class:u(`${n}-panel`,(t=a.classNames)==null?void 0:t.panel),style:(l=a.styles)==null?void 0:l.panel},[s("div",{class:u(`${n}-panel-header`,(d=a.classNames)==null?void 0:d.panelHeader),style:(h=a.styles)==null?void 0:h.panelHeader},[s("button",{class:`${n}-panel-header-btn`,onClick:aa},[i("«")]),s("span",{class:`${n}-panel-header-title`},[S.value,i("年")]),s("button",{class:`${n}-panel-header-btn`,onClick:na},[i("»")])]),s("div",{class:u(`${n}-panel-body`,(w=a.classNames)==null?void 0:w.panelBody),style:(m=a.styles)==null?void 0:m.panelBody},[s("div",{class:u(`${n}-quarters`,(x=a.classNames)==null?void 0:x.quarters),style:(D=a.styles)==null?void 0:D.quarters},[[1,2,3,4].map(b=>{var Y,F;const P=new Date(S.value,(b-1)*3,1),T=$.value?$.value.getFullYear()===S.value&&Math.floor($.value.getMonth()/3)+1===b:!1;return s("button",{key:b,class:u(`${n}-quarter`,{[`${n}-quarter-selected`]:T},(Y=a.classNames)==null?void 0:Y.quarter),style:(F=a.styles)==null?void 0:F.quarter,onClick:()=>U(P)},[i("Q"),b])})])])])},tn=()=>s(cn,null,[C.value==="date"&&a.picker!=="quarter"&&Ka(),C.value==="month"&&Za(),C.value==="year"&&an(),a.picker==="quarter"&&C.value==="date"&&nn()]);return()=>{var t,l;return s(vn,{open:ea.value,trigger:"click",placement:"bottomLeft",disabled:a.disabled,destroyOnHidden:!0,popupClass:u(`${n}-popup`,(t=a.classNames)==null?void 0:t.popup),popupStyle:(l=a.styles)==null?void 0:l.popup,onOpenChange:d=>{d?Ba():Z()}},{default:()=>{var d,h,w,m,x,D,b,P;return s("div",{ref:Fa,class:u(n,`${n}-${a.size}`,{[`${n}-open`]:ea.value,[`${n}-disabled`]:a.disabled,[`${n}-status-error`]:a.status==="error",[`${n}-status-warning`]:a.status==="warning"},(d=a.classNames)==null?void 0:d.root),style:(h=a.styles)==null?void 0:h.root},[s("span",{class:u(`${n}-input`,(w=a.classNames)==null?void 0:w.input),style:(m=a.styles)==null?void 0:m.input},[s("input",{readonly:!0,value:pa.value,placeholder:y.value,disabled:a.disabled,class:`${n}-input-inner`},null),a.allowClear&&pa.value&&!a.disabled&&s("span",{class:u(`${n}-clear`,(x=a.classNames)==null?void 0:x.clear),style:(D=a.styles)==null?void 0:D.clear,onClick:Ia},[s(mn,null,null)]),s("span",{class:u(`${n}-suffix`,(b=a.classNames)==null?void 0:b.suffix),style:(P=a.styles)==null?void 0:P.suffix},[s(gn,null,null)])])])},popup:({placement:d})=>tn()})}}}),wn={style:{display:"flex","flex-direction":"column",gap:"16px",width:"300px"}},xn=B({__name:"DatePickerBasic",setup(a){const o=f(""),n=r=>{console.log("选中日期：",r)};return(r,e)=>(E(),_("div",wn,[s(g(q),{value:o.value,"onUpdate:value":e[0]||(e[0]=k=>o.value=k),placeholder:"请选择日期",onChange:n},null,8,["value"]),c("p",null,"选中日期："+J(o.value),1)]))}}),Dn=`<template>
...
<\/script>
`,Sn={style:{display:"flex","flex-direction":"column",gap:"24px"}},qn=B({__name:"DatePickerClassNames",setup(a){return(o,n)=>(E(),_("div",Sn,[c("div",null,[n[0]||(n[0]=c("div",{style:{"margin-bottom":"8px",color:"#666"}},"渐变触发器：",-1)),s(g(q),{placeholder:"选择日期","class-names":{root:"custom-root",input:"custom-input",suffix:"custom-suffix"}})]),c("div",null,[n[1]||(n[1]=c("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义弹层面板：",-1)),s(g(q),{placeholder:"选择日期","class-names":{popup:"custom-popup",panel:"custom-panel",panelHeader:"custom-header"}})]),c("div",null,[n[2]||(n[2]=c("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义日期单元格：",-1)),s(g(q),{placeholder:"选择日期","class-names":{day:"custom-day",weekday:"custom-weekday"}})]),c("div",null,[n[3]||(n[3]=c("div",{style:{"margin-bottom":"8px",color:"#666"}},"带时间选择：",-1)),s(g(q),{placeholder:"选择日期时间","show-time":!0,"class-names":{root:"custom-datetime-root",timePanel:"custom-time-panel",timeColumn:"custom-time-column",timeCell:"custom-time-cell"}})]),c("div",null,[n[4]||(n[4]=c("div",{style:{"margin-bottom":"8px",color:"#666"}},"使用内联样式：",-1)),s(g(q),{placeholder:"选择日期",styles:{root:{borderRadius:"20px",borderColor:"#722ed1"},input:{color:"#722ed1",fontWeight:500},popup:{borderRadius:"16px"},panel:{boxShadow:"0 8px 24px rgba(114, 46, 209, 0.15)"}}})])]))}}),Cn=rn(qn,[["__scopeId","data-v-71e3ca16"]]),Pn=`<template>
...
`,Nn={style:{display:"flex","flex-direction":"column",gap:"16px",width:"300px"}},$n=B({__name:"DatePickerDisabledDate",setup(a){const o=f(""),n=f(""),r=k=>new Date(k)<new Date(new Date().toDateString()),e=k=>new Date(k)>new Date(new Date().toDateString());return(k,y)=>(E(),_("div",Nn,[s(g(q),{value:o.value,"onUpdate:value":y[0]||(y[0]=p=>o.value=p),"disabled-date":r,placeholder:"不可选择过去日期"},null,8,["value"]),s(g(q),{value:n.value,"onUpdate:value":y[1]||(y[1]=p=>n.value=p),"disabled-date":e,placeholder:"不可选择未来日期"},null,8,["value"])]))}}),Mn=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; width: 300px">
...
<\/script>
`,Tn={style:{display:"flex","flex-direction":"column",gap:"16px",width:"300px"}},Yn=B({__name:"DatePickerMinMax",setup(a){const o=f(""),n=v(()=>{const e=new Date;return e.setDate(1),e.toISOString().split("T")[0]}),r=v(()=>{const e=new Date;return e.setMonth(e.getMonth()+1,0),e.toISOString().split("T")[0]});return(e,k)=>(E(),_("div",Tn,[s(g(q),{value:o.value,"onUpdate:value":k[0]||(k[0]=y=>o.value=y),"min-date":n.value,"max-date":r.value,placeholder:"只能选择本月"},null,8,["value","min-date","max-date"]),c("p",null,"选中日期："+J(o.value),1)]))}}),Fn=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; width: 300px">
...
<\/script>
`,Bn={style:{display:"flex","flex-direction":"column",gap:"16px",width:"300px"}},En=B({__name:"DatePickerPicker",setup(a){const o=f(""),n=f(""),r=f(""),e=f("");return(k,y)=>(E(),_("div",Bn,[s(g(q),{value:o.value,"onUpdate:value":y[0]||(y[0]=p=>o.value=p),picker:"date",placeholder:"选择日期"},null,8,["value"]),s(g(q),{value:n.value,"onUpdate:value":y[1]||(y[1]=p=>n.value=p),picker:"month",placeholder:"选择月份"},null,8,["value"]),s(g(q),{value:r.value,"onUpdate:value":y[2]||(y[2]=p=>r.value=p),picker:"quarter",placeholder:"选择季度"},null,8,["value"]),s(g(q),{value:e.value,"onUpdate:value":y[3]||(y[3]=p=>e.value=p),picker:"year",placeholder:"选择年份"},null,8,["value"])]))}}),_n=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; width: 300px">
...
const year = ref('')
<\/script>
`,On={style:{display:"flex","flex-direction":"column",gap:"16px",width:"300px"}},Hn=B({__name:"DatePickerPresets",setup(a){const o=f(""),n=[{label:"昨天",value:()=>{const r=new Date;return r.setDate(r.getDate()-1),r.toISOString().split("T")[0]}},{label:"今天",value:()=>new Date().toISOString().split("T")[0]},{label:"明天",value:()=>{const r=new Date;return r.setDate(r.getDate()+1),r.toISOString().split("T")[0]}},{label:"一周后",value:()=>{const r=new Date;return r.setDate(r.getDate()+7),r.toISOString().split("T")[0]}}];return(r,e)=>(E(),_("div",On,[s(g(q),{value:o.value,"onUpdate:value":e[0]||(e[0]=k=>o.value=k),presets:n,placeholder:"选择日期"},null,8,["value"]),c("p",null,"选中日期："+J(o.value),1)]))}}),In=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; width: 300px">
...
<\/script>
`,An={style:{width:"300px"}},Rn={style:{"margin-top":"8px"}},Vn=B({__name:"DatePickerShowTime",setup(a){const o=f(""),n=r=>{console.log("选中日期时间：",r)};return(r,e)=>(E(),_("div",An,[s(g(q),{value:o.value,"onUpdate:value":e[0]||(e[0]=k=>o.value=k),"show-time":!0,placeholder:"选择日期和时间",onChange:n},null,8,["value"]),c("p",Rn,"选中："+J(o.value),1)]))}}),Un=`<template>
...
<span class="token comment">/* popup/panel 通过 Teleport 渲染到 body，必须使用 :global() */</span>
<span class="token selector">:global(.my-date-picker-panel)</span> <span class="token punctuation">{</span>
  <span class="token property">border-radius</span><span class="token punctuation">:</span> 12px<span class="token punctuation">;</span>
  <span class="token property">box-shadow</span><span class="token punctuation">:</span> 0 6px 24px <span class="token function">rgba</span><span class="token punctuation">(</span>102<span class="token punctuation">,</span> 126<span class="token punctuation">,</span> 234<span class="token punctuation">,</span> 0.2<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>

<span class="token selector">:global(.my-date-picker-day:hover)</span> <span class="token punctuation">{</span>
...
<span class="token selector">:deep(.my-date-picker-root)</span> <span class="token punctuation">{</span>
...
<span class="token selector">:deep(.my-date-picker-root:hover)</span> <span class="token punctuation">{</span>
