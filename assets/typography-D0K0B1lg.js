import{M as nt,x as st,w as at,Q as et,n as s,t as X,E,r as A,f as I,o as v,N as j,A as w,k as q,h as r,K as l,R as p,m as o,_ as ot,i as L,J as lt,H as pt,l as Z}from"./index-DVYL9B-3.js";import{c as D}from"./cls-S9IiI6wd.js";import{C as rt}from"./CheckOutlined-HfOow00M.js";import{T as _}from"./Tooltip-CTJVv1IP.js";import{S as $}from"./Space-DvJIwRnu.js";function ct(n){return typeof n=="function"||Object.prototype.toString.call(n)==="[object Object]"&&!A(n)}const it=()=>s("svg",{viewBox:"0 0 1024 1024",width:"1em",height:"1em",fill:"currentColor",focusable:"false"},[s("path",{d:"M832 64H296c-4.4 0-8 3.6-8 8v56c0 4.4 3.6 8 8 8h496v688c0 4.4 3.6 8 8 8h56c4.4 0 8-3.6 8-8V96c0-17.7-14.3-32-32-32zM704 192H192c-17.7 0-32 14.3-32 32v530.7c0 8.5 3.4 16.6 9.4 22.6l173.3 173.3c2.2 2.2 4.7 4 7.4 5.5v1.9h4.2c3.5 1.3 7.2 2 11 2H704c17.7 0 32-14.3 32-32V224c0-17.7-14.3-32-32-32zM350 856.2L263.9 770H350v86.2zM664 888H414V746c0-22.1-17.9-40-40-40H232V264h432v624z"},null)]),O={type:{type:String,default:void 0},disabled:{type:Boolean,default:!1},mark:{type:Boolean,default:!1},code:{type:Boolean,default:!1},keyboard:{type:Boolean,default:!1},underline:{type:Boolean,default:!1},delete:{type:Boolean,default:!1},strong:{type:Boolean,default:!1},italic:{type:Boolean,default:!1},copyable:{type:[Boolean,Object],default:!1},ellipsis:{type:[Boolean,Object],default:!1}};function G(n){return n?n===!0?1:n.rows&&n.rows>0?n.rows:1:0}function B(n){return!n||n===!0?{}:n}function z(n,a,t){const y=G(a.ellipsis);return D(n,t,{[`${n}-${a.type}`]:!!a.type,[`${n}-disabled`]:a.disabled,[`${n}-ellipsis`]:y===1,[`${n}-ellipsis-multiple-line`]:y>1})}function H(n){const a=G(n.ellipsis);if(a>1)return{"-webkit-line-clamp":String(a)}}function V(n,a){let t=a;return n.code&&(t=s("code",null,[t])),n.mark&&(t=s("mark",null,[t])),n.keyboard&&(t=s("kbd",null,[t])),n.underline&&(t=s("u",null,[t])),n.delete&&(t=s("del",null,[t])),n.strong&&(t=s("strong",null,[t])),n.italic&&(t=s("i",null,[t])),t}function P(n){if(n==null||typeof n=="boolean")return"";if(typeof n=="string"||typeof n=="number")return String(n);if(Array.isArray(n))return n.map(P).join("");const a=n.children;return typeof a=="string"?a:Array.isArray(a)?a.map(P).join(""):""}async function dt(n){var t;if(typeof navigator<"u"&&((t=navigator.clipboard)!=null&&t.writeText)){await navigator.clipboard.writeText(n);return}const a=document.createElement("textarea");a.value=n,a.style.position="fixed",a.style.opacity="0",document.body.appendChild(a),a.select();try{document.execCommand("copy")}finally{document.body.removeChild(a)}}function R(n){const a=E(!1),t=nt();let y;return{renderCopy:(i,f)=>{var S,U,Y,J;if(!i.copyable)return null;const g=typeof i.copyable=="object"?i.copyable:{},d=t.value.Typography,x=Array.isArray(g.tooltips)?g.tooltips:null,T=x?x[0]:(d==null?void 0:d.copy)??"Copy",u=x?x[1]:(d==null?void 0:d.copied)??"Copied",c=((S=g.icon)==null?void 0:S[0])??s(it,null,null),b=((U=g.icon)==null?void 0:U[1])??s(rt,null,null),h=async K=>{var Q;K.stopPropagation();const tt=g.text??f();try{await dt(tt),a.value=!0,(Q=g.onCopy)==null||Q.call(g,K),y&&clearTimeout(y),y=setTimeout(()=>{a.value=!1},3e3)}catch{}},m=s("button",{type:"button",class:D(`${n}-copy`,(Y=i.classNames)==null?void 0:Y.copy,{[`${n}-copy-success`]:a.value}),style:(J=i.styles)==null?void 0:J.copy,"aria-label":a.value?u:T,title:a.value?u:T,onClick:h},[a.value?b:c]);return g.tooltips===!1?m:s(_,{title:a.value?u:T},ct(m)?m:{default:()=>[m]})}}}function M(n,a){const t=E(!1),y=I(()=>!!a.ellipsis),e=I(()=>B(a.ellipsis)),i=I(()=>G(a.ellipsis));let f=null,g=!1;const d=()=>{var b,h,m,S;if(!y.value){g&&(g=!1,t.value=!1,(h=(b=e.value).onEllipsis)==null||h.call(b,!1));return}const u=n.value;if(!u)return;let c=!1;i.value<=1?c=u.scrollWidth>u.clientWidth+1:c=u.scrollHeight>u.clientHeight+1,c!==g?(g=c,t.value=c,(S=(m=e.value).onEllipsis)==null||S.call(m,c)):t.value=c},x=()=>{if(T(),!y.value)return;const u=n.value;u&&(typeof ResizeObserver<"u"&&(f=new ResizeObserver(()=>d()),f.observe(u)),X(d))},T=()=>{f&&(f.disconnect(),f=null)};return st(()=>x()),at(()=>T()),et(()=>[y.value,i.value],()=>{x(),X(d)}),{isEllipsis:t,measure:d}}function F(n,a){return n===!1||n===void 0?null:n===!0?{title:a}:typeof n=="string"||typeof n=="number"?{title:n}:typeof n=="object"?{title:a,...n}:null}function ut(n){return typeof n=="function"||Object.prototype.toString.call(n)==="[object Object]"&&!A(n)}const k=v({name:"TypographyText",props:{...O,classNames:{type:Object,default:void 0},styles:{type:Object,default:void 0}},setup(n,{slots:a}){const t=j("typography"),{renderCopy:y}=R(t),e=E(null),{isEllipsis:i}=M(e,n);return()=>{var b,h,m;const f=(b=a.default)==null?void 0:b.call(a),g=V(n,f),d=P(f),x=y(n,()=>d),T=B(n.ellipsis),u=i.value?F(T.tooltip,d):null,c=s("span",{ref:e,class:D(z(t,n),(h=n.classNames)==null?void 0:h.root),style:{...H(n),...(m=n.styles)==null?void 0:m.root}},[g,x]);return u?s(_,u,ut(c)?c:{default:()=>[c]}):c}}});function yt(n){return typeof n=="function"||Object.prototype.toString.call(n)==="[object Object]"&&!A(n)}const N=v({name:"TypographyTitle",props:{...O,level:{type:Number,default:1},classNames:{type:Object,default:void 0},styles:{type:Object,default:void 0}},setup(n,{slots:a}){const t=j("typography"),{renderCopy:y}=R(t),e=E(null),{isEllipsis:i}=M(e,n);return()=>{var h,m,S;const f=(h=a.default)==null?void 0:h.call(a),g=V(n,f),d=P(f),x=y(n,()=>d),T=`h${n.level}`,u=B(n.ellipsis),c=i.value?F(u.tooltip,d):null,b=s(T,{ref:e,class:D(z(t,n,`${t}-h${n.level}`),(m=n.classNames)==null?void 0:m.root),style:{...H(n),...(S=n.styles)==null?void 0:S.root}},{default:()=>[g,x]});return c?s(_,c,yt(b)?b:{default:()=>[b]}):b}}});function gt(n){return typeof n=="function"||Object.prototype.toString.call(n)==="[object Object]"&&!A(n)}const C=v({name:"TypographyParagraph",props:{...O,classNames:{type:Object,default:void 0},styles:{type:Object,default:void 0}},setup(n,{slots:a}){const t=j("typography"),{renderCopy:y}=R(t),e=E(null),{isEllipsis:i}=M(e,n);return()=>{var b,h,m;const f=(b=a.default)==null?void 0:b.call(a),g=V(n,f),d=P(f),x=y(n,()=>d),T=B(n.ellipsis),u=i.value?F(T.tooltip,d):null,c=s("p",{ref:e,class:D(z(t,n),(h=n.classNames)==null?void 0:h.root),style:{...H(n),...(m=n.styles)==null?void 0:m.root}},[g,x]);return u?s(_,u,gt(c)?c:{default:()=>[c]}):c}}});function ft(n){return typeof n=="function"||Object.prototype.toString.call(n)==="[object Object]"&&!A(n)}const W=v({name:"TypographyLink",props:{...O,href:{type:String,default:void 0},target:{type:String,default:void 0},classNames:{type:Object,default:void 0},styles:{type:Object,default:void 0}},setup(n,{slots:a}){const t=j("typography"),{renderCopy:y}=R(t),e=E(null),{isEllipsis:i}=M(e,n);return()=>{var b,h,m;const f=(b=a.default)==null?void 0:b.call(a),g=V(n,f),d=P(f),x=y(n,()=>d),T=B(n.ellipsis),u=i.value?F(T.tooltip,d):null,c=s("a",{ref:e,class:D(z(t,n,`${t}-link`),(h=n.classNames)==null?void 0:h.root),style:{...H(n),...(m=n.styles)==null?void 0:m.root},href:n.disabled?void 0:n.href,target:n.target,"aria-disabled":n.disabled||void 0},[g,x]);return u?s(_,u,ft(c)?c:{default:()=>[c]}):c}}}),mt={style:{display:"flex","flex-direction":"column",gap:"32px"}},kt=v({__name:"TypographyClassNames",setup(n){return(a,t)=>(w(),q("div",mt,[r("div",null,[t[1]||(t[1]=r("div",{style:{"margin-bottom":"8px",color:"#666"}},"Text 自定义根节点样式：",-1)),s(l(k),{"class-names":{root:"custom-text-root"}},{default:p(()=>[...t[0]||(t[0]=[o(" 渐变文字效果 ",-1)])]),_:1})]),r("div",null,[t[3]||(t[3]=r("div",{style:{"margin-bottom":"8px",color:"#666"}},"Title 自定义复制按钮：",-1)),s(l(N),{level:3,copyable:"","class-names":{copy:"custom-copy-btn"}},{default:p(()=>[...t[2]||(t[2]=[o(" 可复制的标题 ",-1)])]),_:1})]),r("div",null,[t[5]||(t[5]=r("div",{style:{"margin-bottom":"8px",color:"#666"}},"Paragraph 组合 classNames：",-1)),s(l(C),{copyable:"","class-names":{root:"custom-paragraph",copy:"custom-paragraph-copy"}},{default:p(()=>[...t[4]||(t[4]=[o(" 这是一段带有自定义样式的段落文字，同时复制按钮也应用了自定义样式。点击右侧按钮即可复制全部内容。 ",-1)])]),_:1})]),r("div",null,[t[7]||(t[7]=r("div",{style:{"margin-bottom":"8px",color:"#666"}},"Link 使用内联样式：",-1)),s(l(W),{href:"https://github.com",target:"_blank",styles:{root:{fontSize:"16px",fontWeight:600,textDecoration:"underline",textDecorationColor:"#52c41a",textDecorationThickness:"2px"}}},{default:p(()=>[...t[6]||(t[6]=[o(" GitHub 官网 ",-1)])]),_:1})]),r("div",null,[t[9]||(t[9]=r("div",{style:{"margin-bottom":"8px",color:"#666"}},"组合使用 classNames 和 styles：",-1)),s(l(k),{copyable:"","class-names":{root:"combined-text"},styles:{copy:{fontSize:"18px",color:"#faad14"}}},{default:p(()=>[...t[8]||(t[8]=[o(" classNames 控制文字，styles 控制按钮 ",-1)])]),_:1})])]))}}),bt=ot(kt,[["__scopeId","data-v-f6500058"]]),ht=`<template>
...
`,xt=v({__name:"TypographyCopyable",setup(n){return(a,t)=>(w(),q("div",null,[s(l(C),{copyable:""},{default:p(()=>[...t[0]||(t[0]=[o(" 这段文字可以复制。 ",-1)])]),_:1}),s(l(C),{copyable:{text:"自定义复制内容"}},{default:p(()=>[...t[1]||(t[1]=[o(" 显示文字与复制内容不同。 ",-1)])]),_:1}),s(l(k),{copyable:""},{default:p(()=>[...t[2]||(t[2]=[o(" 行内可复制文本 ",-1)])]),_:1})]))}}),Tt=`<template>
  <div>
...
<\/script>
`,St={style:{"max-width":"240px"}},Ct=v({__name:"TypographyEllipsis",setup(n){return(a,t)=>(w(),q("div",St,[s(l(k),{ellipsis:""},{default:p(()=>[...t[0]||(t[0]=[o(" 这是一段很长的文本，超出容器宽度时会以省略号结尾，不会换行显示。 ",-1)])]),_:1})]))}}),Et=`<template>
...
<\/script>
`,Nt={style:{display:"flex","flex-direction":"column",gap:"12px","max-width":"240px"}},Pt={style:{"font-size":"12px",color:"#999"}},qt=v({__name:"TypographyEllipsisTooltip",setup(n){const a=E(!1);function t(y){a.value=y}return(y,e)=>(w(),q("div",Nt,[s(l(k),{ellipsis:{tooltip:!0}},{default:p(()=>[...e[0]||(e[0]=[o(" 这是一段很长的文本，鼠标悬停时会通过 Tooltip 显示完整内容。 ",-1)])]),_:1}),s(l(k),{ellipsis:{tooltip:"自定义 Tooltip 文案"}},{default:p(()=>[...e[1]||(e[1]=[o(" 显示文字与 Tooltip 内容不同。 ",-1)])]),_:1}),s(l(C),{ellipsis:{rows:2,tooltip:{placement:"topLeft",color:"#1677ff"},onEllipsis:t}},{default:p(()=>[...e[2]||(e[2]=[o(" 多行省略时，可以传入完整的 Tooltip 配置（placement、color 等），并通过 onEllipsis 监听省略状态变化。 ",-1)])]),_:1},8,["ellipsis"]),r("div",Pt,"省略状态: "+lt(a.value),1)]))}}),Dt=`<template>
...
<\/script>
`,At=v({__name:"TypographyLink",setup(n){return(a,t)=>(w(),q("div",null,[s(l(W),{href:"https://ant.design",target:"_blank"},{default:p(()=>[...t[0]||(t[0]=[o(" Ant Design 链接 ",-1)])]),_:1}),t[2]||(t[2]=r("br",null,null,-1)),s(l(W),{href:"https://ant.design",disabled:""},{default:p(()=>[...t[1]||(t[1]=[o(" 禁用链接 ",-1)])]),_:1})]))}}),_t=`<template>
  <div>
...
<\/script>
`,Bt=v({__name:"TypographyParagraph",setup(n){return(a,t)=>(w(),L(l($),{direction:"vertical",size:16},{default:p(()=>[s(l(C),null,{default:p(()=>[...t[0]||(t[0]=[o(" 这是一段普通的段落文本。Ant Design 是一套企业级 UI 设计语言和 React 组件库。 ",-1)])]),_:1}),s(l(C),{copyable:""},{default:p(()=>[...t[1]||(t[1]=[o(" 这段文本可以复制。点击右侧图标复制内容。 ",-1)])]),_:1}),s(l(C),{ellipsis:{rows:2}},{default:p(()=>[...t[2]||(t[2]=[o(" 这是一段很长的文本,会被省略显示。当文本超过指定行数时,会自动显示省略号。 这是一段很长的文本,会被省略显示。当文本超过指定行数时,会自动显示省略号。 这是一段很长的文本,会被省略显示。当文本超过指定行数时,会自动显示省略号。 ",-1)])]),_:1})]),_:1}))}}),jt=`<template>
