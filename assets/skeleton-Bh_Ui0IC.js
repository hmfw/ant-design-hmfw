import{S as r,a as m,b}from"./index-BX7ajAlU.js";import{n as c,z as i,h as f,J as o,j as h,m as d,Q as l,g as e,D as v,G as k,k as g}from"./index-bv5A37HL.js";import"./cls-S9IiI6wd.js";const x=c({__name:"SkeletonActive",setup(s){return(n,a)=>(i(),f(o(r),{active:""}))}}),S=`<template>
  <Skeleton active />
</template>
...
<\/script>
`,y={style:{display:"flex","flex-direction":"column",gap:"16px"}},_=c({__name:"SkeletonAvatar",setup(s){return(n,a)=>(i(),h("div",y,[d(o(r).Avatar,{active:""}),d(o(r).Avatar,{active:"",size:"large"}),d(o(r).Avatar,{active:"",shape:"square"})]))}}),w=`<template>
...
import { Skeleton } from 'ant-design-hmfw'
<\/script>
`,B=c({__name:"SkeletonBasic",setup(s){return(n,a)=>(i(),f(o(r)))}}),P=`<template>
  <Skeleton />
</template>
...
import { Skeleton } from 'ant-design-hmfw'
<\/script>
`,A={style:{display:"flex","flex-direction":"column",gap:"16px"}},I=c({__name:"SkeletonButtonInput",setup(s){return(n,a)=>(i(),h("div",A,[d(o(m),{active:""}),d(o(m),{active:"",size:"small"}),d(o(m),{active:"",shape:"round"}),d(o(b),{active:""}),d(o(b),{active:"",size:"small"})]))}}),z=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px">
...
<\/script>
`,N={style:{display:"flex",gap:"16px"}},$=c({__name:"SkeletonImageNode",setup(s){return(n,a)=>(i(),h("div",N,[d(o(r).Image,{active:""}),d(o(r).Node,{active:""},{default:l(()=>[...a[0]||(a[0]=[e("div",{style:{width:"96px",height:"96px",display:"flex","align-items":"center","justify-content":"center",color:"#bfbfbf"}}," Node ",-1)])]),_:1})]))}}),C=`<template>
...
import { Skeleton } from 'ant-design-hmfw'
<\/script>
`,q=c({__name:"SkeletonWithChildren",setup(s){const n=v(!0);return(a,u)=>(i(),h("div",null,[e("button",{onClick:u[0]||(u[0]=t=>n.value=!n.value)},"切换加载状态"),d(o(r),{loading:n.value,active:"",avatar:""},{default:l(()=>[...u[1]||(u[1]=[e("div",{style:{display:"flex",gap:"12px","margin-top":"16px"}},[e("img",{src:"https://api.dicebear.com/7.x/miniavs/svg?seed=1",style:{width:"40px",height:"40px","border-radius":"50%"}}),e("div",null,[e("p",{style:{"font-weight":"bold"}},"用户名称"),e("p",null,"这是一段描述信息，用于展示骨架屏效果。")])],-1)])]),_:1},8,["loading"])]))}}),j=`<template>
  <div>
