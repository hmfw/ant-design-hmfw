...
`,Tt={class:"back-top-demo__inner"},Et=f({__name:"FloatButtonBackTopDemo",setup(n){const e=x(null),d=()=>e.value,p={position:"absolute",insetInlineEnd:"24px",insetBlockEnd:"24px"};return(o,i)=>(g(),B("div",{ref_key:"containerRef",ref:e,class:"back-top-demo"},[s("div",Tt,[(g(),B(P,null,z(30,m=>s("p",{key:m},"向下滚动这块区域，第 "+C(m)+" 行…",1)),64))]),a(t(l).BackTop,{target:d,"visibility-height":80,tooltip:"回到顶部",style:p})],512))}}),It=O(Et,[["__scopeId","data-v-8cfb5f52"]]),$t=`<template>
...
`,Mt={style:{display:"flex","flex-direction":"column",gap:"24px"}},Rt={class:"demo-box"},At={class:"demo-box"},Ht={class:"demo-box"},jt={class:"demo-box"},Vt={class:"demo-box"},Qt=f({__name:"FloatButtonClassNames",setup(n){const e={position:"absolute",insetInlineEnd:"24px",insetBlockEnd:"24px"};return(d,p)=>(g(),B("div",Mt,[s("div",null,[p[0]||(p[0]=s("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义根节点（渐变背景）：",-1)),s("div",Rt,[a(t(l),{icon:t(K),"class-names":{root:"custom-root"},tooltip:"帮助",style:e},null,8,["icon"])])]),s("div",null,[p[1]||(p[1]=s("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义图标容器（放大图标）：",-1)),s("div",At,[a(t(l),{type:"primary",icon:t(it),"class-names":{icon:"custom-icon"},tooltip:"客服",style:e},null,8,["icon"])])]),s("div",null,[p[2]||(p[2]=s("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义内容区域（square 形状）：",-1)),s("div",Ht,[a(t(l),{shape:"square",icon:t(dt),content:"反馈","class-names":{body:"custom-body",content:"custom-content"},style:e},null,8,["icon"])])]),s("div",null,[p[3]||(p[3]=s("div",{style:{"margin-bottom":"8px",color:"#666"}},"组合自定义（多个 key）：",-1)),s("div",jt,[a(t(l),{shape:"square",icon:t(T),content:"编辑","class-names":{root:"custom-combined-root",body:"custom-combined-body",icon:"custom-combined-icon",content:"custom-combined-content"},style:e},null,8,["icon"])])]),s("div",null,[p[4]||(p[4]=s("div",{style:{"margin-bottom":"8px",color:"#666"}},"使用内联样式：",-1)),s("div",Vt,[a(t(l),{type:"primary",shape:"square",icon:t(ut),content:"启动",styles:{root:{borderRadius:"12px",boxShadow:"0 4px 16px rgba(22, 119, 255, 0.3)"},body:{padding:"8px"},icon:{fontSize:"20px"},content:{fontWeight:"bold"}},style:e},null,8,["icon"])])])]))}}),Ut=O(Qt,[["__scopeId","data-v-0f18fa00"]]),Wt=`<template>
...
`,Yt=f({__name:"FloatButtonDisabled",setup(n){const e={position:"static"};return(d,p)=>(g(),D(t(G),{size:24},{default:u(()=>[a(t(l),{icon:t(T),disabled:"",tooltip:"禁用态",style:e},null,8,["icon"]),a(t(l),{type:"primary",icon:t(M),disabled:"",style:e},null,8,["icon"]),a(t(l),{href:"https://example.com",target:"_blank",disabled:"",icon:t(X),tooltip:"禁用的链接（不跳转）",style:e},null,8,["icon"])]),_:1}))}}),Jt=`<template>
  <Space :size="24">
...
`,on={class:"float-btn-demo"},sn=f({__name:"FloatButtonGroupDemo",setup(n){const e={position:"absolute",insetInlineEnd:"24px",insetBlockEnd:"24px"};return(d,p)=>(g(),B("div",on,[a(t(N),{shape:"circle",style:e},{default:u(()=>[a(t(l),{icon:t(T),tooltip:"编辑"},null,8,["icon"]),a(t(l),{icon:t(M),tooltip:"删除"},null,8,["icon"]),a(t(l),{icon:t(A),tooltip:"搜索"},null,8,["icon"])]),_:1})]))}}),an=O(sn,[["__scopeId","data-v-9b697206"]]),en=`<template>
  <div class="float-btn-demo">
...
const s = { position: 'static' } as const
<\/script>
`,cn={class:"float-btn-demo"},dn=f({__name:"FloatButtonMenu",setup(n){const e={position:"absolute",insetInlineEnd:"120px",insetBlockEnd:"24px"},d={position:"absolute",insetInlineEnd:"24px",insetBlockEnd:"24px"};return(p,o)=>(g(),B("div",cn,[a(t(N),{trigger:"click",type:"primary",icon:t(w),style:e},{default:u(()=>[a(t(l),{icon:t(T),tooltip:"编辑"},null,8,["icon"]),a(t(l),{icon:t(A),tooltip:"搜索"},null,8,["icon"])]),_:1},8,["icon"]),a(t(N),{trigger:"hover",style:d},{default:u(()=>[a(t(l),{icon:t(T),tooltip:"编辑"},null,8,["icon"]),a(t(l),{icon:t(M),tooltip:"删除"},null,8,["icon"])]),_:1})]))}}),un=O(dn,[["__scopeId","data-v-a6c8d123"]]),rn=`<template>
  <div class="float-btn-demo">
