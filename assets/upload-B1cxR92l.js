...
<\/script>
`,dt={key:0},at=F({__name:"UploadPictureCard",setup(t){const d=L([{uid:"-1",name:"image.png",status:"done",url:"https://zos.alipayobjects.com/rmsportal/jkjgkEfvpUPVyRjUImniVslZfWPnJuuZ.png"}]),s=l=>{console.log("预览：",l.url||l.thumbUrl)},n=l=>{d.value=l.fileList};return(l,i)=>(x(),B(U(_),{"file-list":d.value,"onUpdate:fileList":i[0]||(i[0]=a=>d.value=a),action:"https://run.mocky.io/v3/435e224c-44fb-4773-9faf-380c5e6a2188","list-type":"picture-card","max-count":8,onPreview:s,onChange:n},{default:b(()=>[d.value.length<8?(x(),N("div",dt,[...i[1]||(i[1]=[u("div",null,"+ 上传",-1)])])):K("",!0)]),_:1},8,["file-list"]))}}),st=`<template>
  <Upload
    v-model:file-list="fileList"
    action="https://run.mocky.io/v3/435e224c-44fb-4773-9faf-380c5e6a2188"
