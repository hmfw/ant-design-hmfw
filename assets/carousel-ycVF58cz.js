import{B as z}from"./Button-CgFQ9v8N.js";import{o as k,N as Y,E as S,x as W,w as Z,Q as F,n as a,F as j,f as u,t as tt,A as b,i as A,R as m,h as d,K as p,k as T,G as I,J as L,H as et,m as y,l as dt}from"./index-DJdGgqDu.js";import{c as x}from"./cls-S9IiI6wd.js";import{L as ot}from"./LeftOutlined-4DgjoKfH.js";import{R as lt}from"./RightOutlined-Dj0MXUzR.js";import"./Icon-B3Sy0DYw.js";import"./LoadingOutlined-D4bpgc9j.js";const _=k({name:"Carousel",props:{autoplay:{type:[Boolean,Object],default:!1},autoplaySpeed:{type:Number,default:3e3},dots:{type:[Boolean,Object],default:!0},dotPosition:String,dotPlacement:String,effect:{type:String,default:"scrollx"},fade:Boolean,infinite:{type:Boolean,default:!0},speed:{type:Number,default:500},easing:{type:String,default:"ease"},initialSlide:{type:Number,default:0},arrows:{type:Boolean,default:!1},prevArrow:Object,nextArrow:Object,waitForAnimate:{type:Boolean,default:!1},adaptiveHeight:{type:Boolean,default:!1},rootClassName:String},emits:["beforeChange","afterChange"],setup(e,{slots:f,emit:s,expose:h}){const t=Y("carousel"),o=S(e.initialSlide),v=S(!1),G=S(),w=S(),$=S(void 0);let N=null,g=null;const B=u(()=>{var c;return(((c=f.default)==null?void 0:c.call(f))??[]).flatMap(n=>Array.isArray(n.children)?n.children:[n])}),i=u(()=>B.value.length),V=u(()=>{const l=e.dotPlacement??e.dotPosition??"bottom";return l==="left"?"start":l==="right"?"end":l}),P=u(()=>{const l=V.value;return l==="start"||l==="end"}),J=u(()=>e.fade?"fade":e.effect),D=u(()=>J.value==="fade"),K=u(()=>!!e.dots),Q=u(()=>typeof e.dots=="object"&&e.dots.className?e.dots.className:""),U=u(()=>!!e.autoplay),H=u(()=>!!(typeof e.autoplay=="object"&&e.autoplay.dotDuration));function q(){if(!e.adaptiveHeight||P.value||!w.value){$.value=void 0;return}tt(()=>{if(!w.value)return;const c=w.value.querySelectorAll(`.${t}-slide`)[o.value];c&&($.value=c.offsetHeight)})}function C(l,c=!1){if(i.value===0||!c&&e.waitForAnimate&&v.value)return;let n=l;e.infinite?n=(l%i.value+i.value)%i.value:n=Math.max(0,Math.min(l,i.value-1)),n!==o.value&&(s("beforeChange",o.value,n),c?(o.value=n,s("afterChange",n)):(g&&(clearTimeout(g),g=null),v.value=!0,o.value=n,g=setTimeout(()=>{v.value=!1,s("afterChange",n),g=null},e.speed)))}const R=()=>C(o.value-1),O=()=>C(o.value+1);function E(){!U.value||i.value<=1||(N=setInterval(()=>C(o.value+1),e.autoplaySpeed))}function M(){N&&(clearInterval(N),N=null),g&&(clearTimeout(g),g=null)}W(()=>{if(i.value>0&&e.initialSlide>0){const l=e.infinite?e.initialSlide%i.value:Math.min(e.initialSlide,i.value-1);o.value=l}q(),E()}),Z(M),F(()=>e.autoplay,l=>{l?E():M()}),F(o,()=>{q()}),F(()=>e.adaptiveHeight,()=>{q()}),h({goTo:C,next:O,prev:R});const X=u(()=>{const l=V.value;return l==="start"?"left":l==="end"?"right":l});return()=>{if(i.value===0)return a("div",{class:x(t,e.rootClassName)},null);const l=`${e.speed/1e3}s`,c=H.value?{"--carousel-dot-duration":`${e.autoplaySpeed}ms`}:{};return a("div",{class:x(t,e.rootClassName,{[`${t}-vertical`]:P.value,[`${t}-fade`]:D.value}),style:c,role:"region","aria-roledescription":"carousel","aria-label":"Carousel"},[a("div",{ref:G,class:`${t}-list`,style:e.adaptiveHeight&&$.value!==void 0?{height:`${$.value}px`,transition:v.value?`height ${l} ${e.easing}`:"none"}:{}},[a("div",{ref:w,class:`${t}-track`,style:D.value?{}:{transform:P.value?`translateY(-${o.value*100}%)`:`translateX(-${o.value*100}%)`,transition:v.value?`transform ${l} ${e.easing}`:"none"}},[B.value.map((n,r)=>a("div",{key:r,class:x(`${t}-slide`,{[`${t}-slide-active`]:r===o.value}),style:D.value?{opacity:r===o.value?1:0,transform:"translate3d(0, 0, 0)",transition:`opacity ${l} ${e.easing}`,position:r===o.value?"relative":"absolute",inset:r===o.value?"auto":"0",contentVisibility:(r===o.value,"auto")}:{contentVisibility:(r===o.value,"auto")},role:"group","aria-roledescription":"slide","aria-label":`${r+1} / ${i.value}`,"aria-hidden":r!==o.value},[n]))])]),e.arrows&&i.value>1&&a(j,null,[e.prevArrow??a(z,{class:x(`${t}-arrow`,`${t}-arrow-left`),type:"text",icon:ot,onClick:R,disabled:e.waitForAnimate&&v.value,"aria-label":"Previous slide"},null),e.nextArrow??a(z,{class:x(`${t}-arrow`,`${t}-arrow-right`),type:"text",icon:lt,onClick:O,disabled:e.waitForAnimate&&v.value,"aria-label":"Next slide"},null)]),K.value&&i.value>1&&a("ul",{class:x(`${t}-dots`,`${t}-dots-${X.value}`,Q.value,{[`${t}-dots-progress`]:H.value,[`${t}-dots-disabled`]:e.waitForAnimate&&v.value})},[B.value.map((n,r)=>a("li",{key:r,class:x({[`${t}-dot-active`]:r===o.value}),onClick:()=>C(r)},[a("button",{"aria-label":`Go to slide ${r+1}`},null)]))])])}}}),at=k({__name:"CarouselArrows",setup(e){return(f,s)=>(b(),A(p(_),{arrows:""},{default:m(()=>[...s[0]||(s[0]=[d("div",{class:"carousel-item",style:{background:"#364d79",color:"#fff",height:"160px","line-height":"160px","text-align":"center"}}," Slide 1 ",-1),d("div",{class:"carousel-item",style:{background:"#7dbcea",color:"#fff",height:"160px","line-height":"160px","text-align":"center"}}," Slide 2 ",-1),d("div",{class:"carousel-item",style:{background:"#00a0e9",color:"#fff",height:"160px","line-height":"160px","text-align":"center"}}," Slide 3 ",-1),d("div",{class:"carousel-item",style:{background:"#1890ff",color:"#fff",height:"160px","line-height":"160px","text-align":"center"}}," Slide 4 ",-1)])]),_:1}))}}),nt=`<template>
  <Carousel arrows>
    <div
      class="carousel-item"
...
<\/script>
`,rt=k({__name:"CarouselBasic",setup(e){return(f,s)=>(b(),A(p(_),{style:{height:"160px",background:"#364d79","border-radius":"4px",overflow:"hidden"}},{default:m(()=>[(b(),T(j,null,I(4,h=>d("div",{key:h,style:{height:"160px",display:"flex","align-items":"center","justify-content":"center",color:"#fff","font-size":"24px"}},L(h),1)),64))]),_:1}))}}),it=`<template>
...
import { Carousel } from 'ant-design-hmfw'
<\/script>
`,st=k({__name:"CarouselFade",setup(e){return(f,s)=>(b(),A(p(_),{effect:"fade",style:{height:"160px",background:"#364d79","border-radius":"4px",overflow:"hidden"}},{default:m(()=>[(b(),T(j,null,I(4,h=>d("div",{key:h,style:{height:"160px",display:"flex","align-items":"center","justify-content":"center",color:"#fff","font-size":"24px"}},L(h),1)),64))]),_:1}))}}),ut=`<template>
