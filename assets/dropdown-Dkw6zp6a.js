...
<\/script>
`,A={style:{display:"flex",gap:"16px","flex-wrap":"wrap"}},C=b({__name:"DropdownButton",setup(m){const u={items:[{key:"1",label:"Action 1"},{key:"2",label:"Action 2"},{key:"3",label:"Action 3"}]};return(i,e)=>(s(),f("div",A,[t(d(p).Button,{menu:u},{default:n(()=>[...e[0]||(e[0]=[r(" Dropdown ",-1)])]),_:1}),t(d(p).Button,{menu:u,type:"primary"},{default:n(()=>[...e[1]||(e[1]=[r(" Primary ",-1)])]),_:1}),t(d(p).Button,{menu:u,danger:""},{default:n(()=>[...e[2]||(e[2]=[r(" Danger ",-1)])]),_:1}),t(d(p).Button,{menu:u,disabled:""},{default:n(()=>[...e[3]||(e[3]=[r(" Disabled ",-1)])]),_:1})]))}}),N=`<template>
...
<\/script>
`,S=b({__name:"DropdownDanger",setup(m){const u={items:[{key:"edit",label:"编辑"},{key:"copy",label:"复制"},{type:"divider"},{key:"delete",label:"删除",danger:!0}],onClick:({key:i})=>{console.log("点击了:",i)}};return(i,e)=>(s(),w(d(p),{menu:u,trigger:"click"},{default:n(()=>[t(d(a),null,{default:n(()=>[...e[0]||(e[0]=[r("操作菜单",-1)])]),_:1})]),_:1}))}}),P=`<template>
...
<\/script>
`,R=b({__name:"DropdownTrigger",setup(m){const u={items:[{key:"1",label:"菜单项一"},{key:"2",label:"菜单项二"},{key:"3",label:"菜单项三"}]};return(i,e)=>(s(),w(d(y),null,{default:n(()=>[t(d(p),{menu:u,trigger:"hover"},{default:n(()=>[t(d(a),null,{default:n(()=>[...e[0]||(e[0]=[r("悬停触发",-1)])]),_:1})]),_:1}),t(d(p),{menu:u,trigger:"click"},{default:n(()=>[t(d(a),null,{default:n(()=>[...e[1]||(e[1]=[r("点击触发",-1)])]),_:1})]),_:1})]),_:1}))}}),I=`<template>
  <Space>
