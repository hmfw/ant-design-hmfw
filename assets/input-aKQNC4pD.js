import{I as m,T as b,a as I,b as y}from"./Input-Ba9GGOpG.js";import{o as g,A as f,k as x,n as e,K as o,E as s,h as n,R as v,m as S,J as w,j as E,_ as T,H as A,l as P}from"./index-C7r7ERgN.js";import{S as C}from"./Space-CYS8Qg3Y.js";import"./cls-S9IiI6wd.js";import"./CloseOutlined-BOy0Oguu.js";import"./EyeOutlined-BsTkzzPM.js";import"./LoadingOutlined-CFTLq47r.js";import"./SearchOutlined-DqDpqZlu.js";const N={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"400px"}},V=g({__name:"InputAddon",setup(h){const a=s(""),u=s(""),r=s("");return(t,d)=>(f(),x("div",N,[e(o(m),{value:a.value,"onUpdate:value":d[0]||(d[0]=p=>a.value=p),placeholder:"请输入用户名",prefix:"👤"},null,8,["value"]),e(o(m),{value:u.value,"onUpdate:value":d[1]||(d[1]=p=>u.value=p),placeholder:"请输入金额",prefix:"¥",suffix:"元"},null,8,["value"]),e(o(m),{value:r.value,"onUpdate:value":d[2]||(d[2]=p=>r.value=p),placeholder:"支持清除","allow-clear":""},null,8,["value"])]))}}),k=`<template>
...
const value4 = ref('')
<\/script>
`,U={class:"input-advanced-demo"},W={key:0,style:{padding:"8px",background:"#f0f9ff","border-radius":"4px"}},R=g({__name:"InputAdvanced",setup(h){const a=s(""),u=s(""),r=s(""),t=s(""),d=s(0),p=c=>{!c.ctrlKey&&!c.metaKey&&!c.shiftKey&&d.value++};return(c,l)=>(f(),x("div",U,[l[6]||(l[6]=n("h4",null,"细粒度样式控制（classNames / styles）",-1)),e(o(C),{direction:"vertical",style:{width:"100%","max-width":"400px"}},{default:v(()=>[e(o(m),{value:a.value,"onUpdate:value":l[0]||(l[0]=i=>a.value=i),placeholder:"自定义样式的 Input","class-names":{affixWrapper:"custom-wrapper",input:"custom-input",prefix:"custom-prefix",suffix:"custom-suffix"},styles:{affixWrapper:{border:"2px solid #1890ff",borderRadius:"8px"},input:{color:"#1890ff",fontWeight:"bold"}},prefix:"🔍",suffix:"✨"},null,8,["value"]),e(o(m),{value:u.value,"onUpdate:value":l[1]||(l[1]=i=>u.value=i),placeholder:"带字符计数","max-length":50,"show-count":!0,"class-names":{count:"custom-count"},styles:{count:{color:"#52c41a",fontWeight:"bold"}}},null,8,["value"])]),_:1}),l[7]||(l[7]=n("h4",{style:{"margin-top":"32px"}},"TextArea 按键事件",-1)),e(o(C),{direction:"vertical",style:{width:"100%","max-width":"400px"}},{default:v(()=>[e(o(b),{value:r.value,"onUpdate:value":l[2]||(l[2]=i=>r.value=i),placeholder:"按 Enter 键触发事件（可以用 Ctrl+Enter 换行）",rows:4,onPressEnter:p},null,8,["value"]),d.value>0?(f(),x("div",W,[n("span",null,[l[4]||(l[4]=S("Enter 键被按下了 ",-1)),n("strong",null,w(d.value),1),l[5]||(l[5]=S(" 次",-1))])])):E("",!0)]),_:1}),l[8]||(l[8]=n("h4",{style:{"margin-top":"32px"}},"TextArea 自定义样式",-1)),e(o(b),{value:t.value,"onUpdate:value":l[3]||(l[3]=i=>t.value=i),placeholder:"带样式的 TextArea",rows:3,"show-count":!0,"max-length":200,"class-names":{textarea:"custom-textarea",count:"custom-count"},styles:{textarea:{borderColor:"#722ed1",borderRadius:"8px"},count:{color:"#722ed1",fontSize:"14px"}}},null,8,["value"])]))}}),$=T(R,[["__scopeId","data-v-3c1e3a90"]]),K=`<template>
...
const value = ref('')
<\/script>
`,D={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"400px"}},L=g({__name:"InputPassword",setup(h){const a=s(""),u=s("");return(r,t)=>(f(),x("div",D,[e(o(I),{value:a.value,"onUpdate:value":t[0]||(t[0]=d=>a.value=d),placeholder:"请输入密码"},null,8,["value"]),e(o(I),{value:u.value,"onUpdate:value":t[1]||(t[1]=d=>u.value=d),placeholder:"不可切换可见性","visibility-toggle":!1},null,8,["value"]),n("p",null,"密码："+w(a.value),1)]))}}),M=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; max-width: 400px">
...
<\/script>
`,J={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"400px"}},q=g({__name:"InputTextArea",setup(h){const a=s(""),u=s(""),r=s("");return(t,d)=>(f(),x("div",J,[e(o(b),{value:a.value,"onUpdate:value":d[0]||(d[0]=p=>a.value=p),placeholder:"固定行数",rows:4},null,8,["value"]),e(o(b),{value:u.value,"onUpdate:value":d[1]||(d[1]=p=>u.value=p),placeholder:"自适应高度","auto-size":{minRows:2,maxRows:6}},null,8,["value"]),e(o(b),{value:r.value,"onUpdate:value":d[2]||(d[2]=p=>r.value=p),placeholder:"显示字数",maxlength:100,"show-count":!0},null,8,["value"])]))}}),G=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; max-width: 400px">
