import{E as l,P as f}from"./Empty-wju8mHb9.js";import{n as a,z as s,h as u,Q as r,g as e,J as n,G as _,j as y,m as o,l as c,k as b}from"./index-BIkAb7lZ.js";import"./cls-S9IiI6wd.js";const S=a({__name:"EmptyAction",setup(p){function d(){console.log("创建")}return(i,E)=>(s(),u(n(l),{description:"暂无数据"},{default:r(()=>[e("button",{onClick:d},"立即创建")]),_:1}))}}),g=`<template>
...
<\/script>
`,x=a({__name:"EmptyBasic",setup(p){return(d,i)=>(s(),u(n(l)))}}),P=`<template>
  <Empty />
</template>
...
import { Empty } from 'ant-design-hmfw'
<\/script>
`,h=a({__name:"EmptyCustomDescription",setup(p){return(d,i)=>(s(),u(n(l),{description:"暂无数据，请稍后再试"}))}}),I=`<template>
...
import { Empty } from 'ant-design-hmfw'
<\/script>
`,D=a({__name:"EmptySimple",setup(p){return(d,i)=>(s(),u(n(l),{image:n(f),description:"简约空状态"},null,8,["image"]))}}),M=`<template>
