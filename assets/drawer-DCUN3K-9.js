import{k as b,I as $,z as p,L as h,j as r,a as C,i as D,T as B,c as g,w as v,g as w,F as x,d as o,G as f,M as m,B as S,h as E}from"./index-DvxRruME.js";import{c as O}from"./cls-S9IiI6wd.js";const T='a[href],button:not([disabled]),input:not([disabled]),select:not([disabled]),textarea:not([disabled]),[tabindex]:not([tabindex="-1"])';function N(e){var t;const d=document.activeElement,u=()=>Array.from(e.querySelectorAll(T));(t=u()[0])==null||t.focus();const n=a=>{if(a.key!=="Tab")return;const i=u();if(!i.length)return;const l=i[0],s=i[i.length-1];a.shiftKey?document.activeElement===l&&(a.preventDefault(),s.focus()):document.activeElement===s&&(a.preventDefault(),l.focus())};return e.addEventListener("keydown",n),()=>{e.removeEventListener("keydown",n),d==null||d.focus()}}const y=b({name:"Drawer",props:{open:{type:Boolean,default:void 0},defaultOpen:Boolean,title:String,placement:{type:String,default:"right"},width:{type:[Number,String],default:378},height:{type:[Number,String],default:378},closable:{type:Boolean,default:!0},maskClosable:{type:Boolean,default:!0},mask:{type:Boolean,default:!0},zIndex:{type:Number,default:1e3},destroyOnClose:Boolean},emits:["update:open","close"],setup(e,{slots:d,emit:u}){const n=$("drawer"),t=p(e.defaultOpen??!1),a=p(null);let i=null;h(()=>e.open,c=>{c!==void 0&&(t.value=c)});const l=g(()=>e.open!==void 0?e.open:t.value);h(l,async c=>{c?(await Promise.resolve(),a.value&&(i=N(a.value))):(i==null||i(),i=null)});const s=()=>{t.value=!1,u("update:open",!1),u("close")},k=g(()=>e.placement==="left"||e.placement==="right"?{width:typeof e.width=="number"?`${e.width}px`:e.width}:{height:typeof e.height=="number"?`${e.height}px`:e.height});return()=>r(B,{to:"body"},{default:()=>[r(C,{name:`hmfw-drawer-${e.placement}`},{default:()=>{var c;return l.value&&r("div",{class:`${n}-root`,style:{zIndex:e.zIndex}},[e.mask&&r("div",{class:`${n}-mask`,onClick:()=>e.maskClosable&&s()},null),r("div",{ref:a,class:O(`${n}-content-wrapper`,`${n}-${e.placement}`),style:k.value,role:"dialog","aria-modal":"true","aria-labelledby":e.title?`${n}-title`:void 0},[r("div",{class:`${n}-content`},[r("div",{class:`${n}-header`},[e.title&&r("div",{id:`${n}-title`,class:`${n}-title`},[e.title]),e.closable&&r("button",{class:`${n}-close`,onClick:s,"aria-label":"Close"},[D("×")])]),r("div",{class:`${n}-body`},[(!e.destroyOnClose||l.value)&&((c=d.default)==null?void 0:c.call(d))]),d.footer&&r("div",{class:`${n}-footer`},[d.footer()])])])])}})]})}}),P=b({__name:"DrawerBasic",setup(e){const d=p(!1);return(u,n)=>(v(),w(x,null,[o("button",{onClick:n[0]||(n[0]=t=>d.value=!0)},"打开抽屉"),r(f(y),{open:d.value,"onUpdate:open":n[1]||(n[1]=t=>d.value=t),title:"基础抽屉"},{default:m(()=>[...n[2]||(n[2]=[o("p",null,"抽屉内容",-1),o("p",null,"抽屉内容",-1),o("p",null,"抽屉内容",-1)])]),_:1},8,["open"])],64))}}),V=`<template>
...
<\/script>
`,z={style:{display:"flex",gap:"8px"}},I=b({__name:"DrawerPlacement",setup(e){const d=p(!1),u=p("right"),n=p("右侧"),t={top:"顶部",right:"右侧",bottom:"底部",left:"左侧"};function a(i){u.value=i,n.value=t[i],d.value=!0}return(i,l)=>(v(),w(x,null,[o("div",z,[o("button",{onClick:l[0]||(l[0]=s=>a("top"))},"上"),o("button",{onClick:l[1]||(l[1]=s=>a("right"))},"右"),o("button",{onClick:l[2]||(l[2]=s=>a("bottom"))},"下"),o("button",{onClick:l[3]||(l[3]=s=>a("left"))},"左")]),r(f(y),{open:d.value,"onUpdate:open":l[4]||(l[4]=s=>d.value=s),placement:u.value,title:`从${n.value}滑出`},{default:m(()=>[...l[5]||(l[5]=[o("p",null,"抽屉内容",-1)])]),_:1},8,["open","placement","title"])],64))}}),M=`<template>
