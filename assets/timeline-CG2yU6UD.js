import{U as P}from"./icons-DrnBibzR.js";import{n as m,M as j,m as d,C as F,F as z,z as u,h as g,J as s,j as C,g as i,G as A,Q as p,l as f,k as D}from"./index-bv5A37HL.js";import{c as x}from"./cls-S9IiI6wd.js";import{I as L}from"./Icon-K3gH4Ffy.js";function M(e){return e==="left"?"start":e==="right"?"end":e==="start"||e==="end"||e==="alternate"?e:"start"}function H(e,o,n){return e.placement?e.placement:e.position==="left"?"start":e.position==="right"?"end":n==="alternate"?o%2===0?"start":"end":n}function N(e){if(!e)return[];const o=[];for(const n of e)if(n&&n.type!==F){if(n.type===z&&Array.isArray(n.children)){o.push(...N(n.children));continue}n.props&&o.push(n.props)}return o}const E=m({name:"TimelineItem",props:{title:[String,Object],content:[String,Object],icon:[String,Object],placement:String,loading:Boolean,label:[String,Object],children:null,dot:[String,Object],position:String,color:String,className:String,style:Object},setup(e,{slots:o}){return()=>{var n;return(n=o.default)==null?void 0:n.call(o)}}}),G=m({name:"Timeline",props:{items:Array,mode:{type:String,default:"left"},orientation:{type:String,default:"vertical"},variant:{type:String,default:"outlined"},reverse:Boolean,titleSpan:[Number,String],pending:[Boolean,String,Object],pendingDot:[String,Object]},setup(e,{slots:o}){const n=j("timeline");return()=>{const l=M(e.mode);let t=[];if(e.items)t=[...e.items];else if(o.default){const r=o.default();t=N(r)}if(e.pending){const r=typeof e.pending=="string"?e.pending:e.pending===!0?void 0:e.pending;t.push({content:r,icon:e.pendingDot,loading:!e.pendingDot,color:"gray"})}const c=e.reverse?[...t].reverse():t,w=x(n,{[`${n}-${e.orientation}`]:e.orientation==="horizontal",[`${n}-${l}`]:l!=="start",[`${n}-${e.variant}`]:e.variant!=="outlined",[`${n}-pending`]:!!e.pending,[`${n}-reverse`]:e.reverse}),T={};return e.titleSpan!==void 0&&l!=="alternate"&&(typeof e.titleSpan=="number"?T["--hmfw-timeline-title-span"]=`${e.titleSpan}px`:T["--hmfw-timeline-title-span"]=e.titleSpan),d("ul",{class:w,style:T},[c.map((r,y)=>{const V=y===c.length-1,v=H(r,y,l),$=r.title??r.label,I=r.content??r.children;let b=r.icon??r.dot;r.loading&&!b&&(b=d(L,{component:P,spin:!0},null));const h=r.color??"blue",S=["blue","red","green","gray"].includes(h),k=!!b||r.loading,B=x(`${n}-item`,{[`${n}-item-last`]:V,[`${n}-item-${v}`]:v==="end",[`${n}-item-loading`]:r.loading},r.className),O=x(`${n}-item-head`,{[`${n}-item-head-${h}`]:S,[`${n}-item-head-custom`]:k||!S}),_={...r.style};return S||(_.borderColor=h,_.color=h),d("li",{key:r.key??y,class:B},[$&&d("div",{class:`${n}-item-label`},[$]),d("div",{class:`${n}-item-tail`},null),d("div",{class:O,style:_},[b]),d("div",{class:`${n}-item-content`},[I])])})])}}}),a=G;a.Item=E;const J=m({__name:"TimelineAlternate",setup(e){const o=[{content:"创建服务现场 2015-09-01"},{content:"初步排除网络异常 2015-09-01"},{content:"技术测试异常 2015-09-01"},{content:"网络异常正在修复 2015-09-01"}];return(n,l)=>(u(),g(s(a),{mode:"alternate",items:o}))}}),Q=`<template>
...
<\/script>
`,U=m({__name:"TimelineBasic",setup(e){const o=[{content:"创建服务现场 2015-09-01"},{content:"初步排除网络异常 2015-09-01"},{content:"技术测试异常 2015-09-01"},{content:"网络异常正在修复 2015-09-01"}];return(n,l)=>(u(),g(s(a),{items:o}))}}),q=`<template>
...
<\/script>
`,K=m({__name:"TimelineCustomColor",setup(e){const o=[{content:"成功事件",color:"green"},{content:"失败事件",color:"red"},{content:"警告事件",color:"gray"},{content:"自定义颜色",color:"#00CCFF"}];return(n,l)=>(u(),g(s(a),{items:o}))}}),R=`<template>
  <Timeline :items="items" />
</template>
