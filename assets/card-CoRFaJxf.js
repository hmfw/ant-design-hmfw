import{C as d,a as h}from"./index-CWQbqXru.js";import{o as u,A as i,i as b,R as s,h as t,K as o,k as g,n as e,_ as y,m as l,E as f,J as x,H as C,l as v}from"./index-Y1x_vdlx.js";import"./cls-S9IiI6wd.js";const w=u({__name:"CardBasic",setup(c){return(p,n)=>(i(),b(o(d),{title:"卡片标题",style:{width:"300px"}},{default:s(()=>[...n[0]||(n[0]=[t("p",null,"卡片内容",-1),t("p",null,"卡片内容",-1),t("p",null,"卡片内容",-1)])]),_:1}))}}),S=`<template>
...
`,z=u({__name:"CardCover",setup(c){return(p,n)=>(i(),b(o(d),{style:{width:"300px"}},{cover:s(()=>[...n[0]||(n[0]=[t("img",{alt:"example",src:"https://gw.alipayobjects.com/zos/rmsportal/JiqGstEfoWAOHiTxclqi.png",style:{width:"100%"}},null,-1)])]),default:s(()=>[e(o(h),{title:"卡片标题",description:"这是卡片的描述信息"})]),_:1}))}}),L=`<template>
...
import { Card } from 'ant-design-hmfw'
<\/script>
`,I=u({__name:"CardInner",setup(c){return(p,n)=>(i(),b(o(d),{type:"inner",title:"内部卡片"},{default:s(()=>[...n[0]||(n[0]=[t("p",null,'type="inner" 用于卡片内部嵌套展示。',-1)])]),_:1}))}}),V=`<template>
