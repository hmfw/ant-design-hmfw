import{S as b}from"./Space-Bktr5yjC.js";import{I as o}from"./Icon-CTmWlmQC.js";import{S as P}from"./SearchOutlined-kq83buNV.js";import{C as $}from"./CloseOutlined-CLskzqDI.js";import{C as G}from"./CheckOutlined-Bitdf6sz.js";import{iR as j,jf as q,jj as N,jh as W,jg as T}from"./utils-C1ZT00VP.js";import{I as Q,E as Z}from"./RocketOutlined-BKDIExJm.js";import{L as A}from"./LoadingOutlined-BeJ6caQM.js";import{U as J}from"./UpOutlined-DWB3uTKG.js";import{D as K}from"./DownOutlined-tg5fCTck.js";import{L as X}from"./LeftOutlined-D5bVAbV7.js";import{R as Y}from"./RightOutlined-C3qkDrSf.js";import{P as nn}from"./PlusOutlined-Cuj-XGu6.js";import{M as tn}from"./MinusOutlined-CES9SPad.js";import{D as en}from"./DeleteOutlined-DNJrr07t.js";import{E as sn}from"./EyeOutlined-BXDLLdEz.js";import{H as g}from"./HomeOutlined-Cu7MN5MF.js";import{U as h}from"./UserOutlined-jH9nhEg4.js";import{S as H}from"./SettingOutlined-CGK8VqEB.js";import{o as v,A as p,i as w,R as k,n as t,K as n,k as u,h as s,S as on,P as an,F as C,G as _,u as L,J as y,j as R,m,E as S,f as D,_ as ln,H as pn,l as cn}from"./index-X2tFbSxS.js";import"./cls-S9IiI6wd.js";import"./AppleOutlined-B9T2CRuq.js";import"./PictureOutlined-ByDba8dk.js";import"./CloseCircleFilled-peD9LDEH.js";import"./CloseCircleOutlined-Dp8uLZGr.js";import"./DownloadOutlined-C4RnRo0S.js";import"./ExclamationCircleFilled-Dmpf6FC4.js";import"./UploadOutlined-B5No-dvm.js";import"./InfoCircleFilled-BXKxsHtX.js";import"./ZoomOutOutlined-Cik2gJR3.js";import"./WarningFilled-DyhuhDZT.js";const un=v({__name:"IconBasic",setup(x){return(d,r)=>(p(),w(n(b),{size:16,wrap:""},{default:k(()=>[t(n(o),{component:n(P)},null,8,["component"]),t(n(o),{component:n($)},null,8,["component"]),t(n(o),{component:n(G)},null,8,["component"]),t(n(o),{component:n(j)},null,8,["component"]),t(n(o),{component:n(Q)},null,8,["component"]),t(n(o),{component:n(A)},null,8,["component"]),t(n(o),{component:n(J)},null,8,["component"]),t(n(o),{component:n(K)},null,8,["component"]),t(n(o),{component:n(X)},null,8,["component"]),t(n(o),{component:n(Y)},null,8,["component"]),t(n(o),{component:n(nn)},null,8,["component"]),t(n(o),{component:n(tn)},null,8,["component"]),t(n(o),{component:n(Z)},null,8,["component"]),t(n(o),{component:n(en)},null,8,["component"]),t(n(o),{component:n(sn)},null,8,["component"]),t(n(o),{component:n(g)},null,8,["component"]),t(n(o),{component:n(h)},null,8,["component"]),t(n(o),{component:n(H)},null,8,["component"])]),_:1}))}}),dn=`<template>
  <Space :size="16" wrap>
...
<\/script>
`,rn={class:"icon-browser"},mn={class:"search-wrapper"},kn={class:"category-tabs"},On=["onClick"],fn={key:0,class:"icon-stats"},gn={class:"stats-text"},hn={class:"style-switch"},xn=["onClick"],In={key:1,class:"icon-groups"},yn={class:"group-title"},vn={class:"icon-list"},Cn=["onClick"],_n={class:"icon-label"},Sn={key:0,class:"copied-badge"},bn={key:2,class:"empty-state"},wn=v({__name:"IconBrowser",setup(x){const d=S(""),r=S("all"),I=S(""),e=S("all"),f=[{value:"all",label:"全部"},{value:"outlined",label:"线形"},{value:"filled",label:"实底"}],M=D(()=>["all",...q()]),U=c=>e.value==="filled"?c.filter(a=>a.name.endsWith("-filled")):e.value==="outlined"?c.filter(a=>!a.name.endsWith("-filled")):c,E=D(()=>{const c={};let a=[];if(d.value.trim())return{"Search Results":U(N(d.value))};r.value!=="all"?a=W(r.value):a=T(),a=U(a),a.forEach(i=>{c[i.category]||(c[i.category]=[]),c[i.category].push(i)});const l={};return q().forEach(i=>{c[i]&&(l[i]=c[i])}),l}),z=D(()=>Object.values(E.value).reduce((c,a)=>c+a.length,0)),V=c=>{const l=c.name.split("-").map(F=>F.charAt(0).toUpperCase()+F.slice(1)).join(""),i=c.name.includes("filled")?"Filled":"Outlined",B=`<Icon :component="${l.replace(/filled$/i,"")+i}" />`;navigator.clipboard.writeText(B).then(()=>{I.value=c.name,setTimeout(()=>{I.value=""},2e3)})};return(c,a)=>(p(),u("div",rn,[s("div",mn,[on(s("input",{"onUpdate:modelValue":a[0]||(a[0]=l=>d.value=l),type:"text",placeholder:"在此搜索图标，点击图标可复制代码",class:"search-input"},null,512),[[an,d.value]])]),s("div",kn,[(p(!0),u(C,null,_(M.value,l=>(p(),u("button",{key:l,class:L(["category-tab",{active:r.value===l}]),onClick:i=>r.value=l},y(l==="all"?"全部图标":l),11,On))),128))]),z.value>0?(p(),u("div",fn,[s("span",gn,"共 "+y(z.value)+" 个图标",1),s("div",hn,[(p(),u(C,null,_(f,l=>s("button",{key:l.value,class:L(["style-switch__item",{active:e.value===l.value}]),onClick:i=>e.value=l.value},y(l.label),11,xn)),64))])])):R("",!0),z.value>0?(p(),u("div",In,[(p(!0),u(C,null,_(E.value,(l,i)=>(p(),u("div",{key:i,class:"icon-group"},[s("h4",yn,y(i),1),s("ul",vn,[(p(!0),u(C,null,_(l,O=>(p(),u("li",{key:O.name,class:L(["icon-item",{copied:I.value===O.name}]),onClick:B=>V(O)},[t(n(o),{component:O.component,class:"icon-svg"},null,8,["component"]),s("span",_n,y(O.name),1),I.value===O.name?(p(),u("span",Sn,[...a[1]||(a[1]=[s("svg",{viewBox:"64 64 896 896",width:"1em",height:"1em",fill:"currentColor"},[s("path",{d:"M912 190h-69.9c-9.8 0-19.1 4.5-25.1 12.2L404.7 724.5 207 474a32 32 0 00-25.1-12.2H112c-6.7 0-10.4 7.7-6.3 12.9l273.9 347c12.8 16.2 37.4 16.2 50.3 0l488.4-618.9c4.1-5.1.4-12.8-6.3-12.8z"})],-1),m(" Copied! ",-1)])])):R("",!0)],10,Cn))),128))])]))),128))])):(p(),u("div",bn,[...a[2]||(a[2]=[s("svg",{viewBox:"64 64 896 896",width:"64",height:"64",fill:"currentColor",opacity:"0.3"},[s("path",{d:"M893.6 693.2L730.4 530c-9.4-9.4-24.6-9.4-33.9 0l-63.7 63.7-96.6-96.6L762.9 270.4c1.8-1.9 3.3-4 4.5-6.2l86.8-158.8c2.8-5.1.9-11.5-4.2-14.3-5.1-2.8-11.5-.9-14.3 4.2L749 253.9c-1.2 2.2-2.7 4.3-4.5 6.2L518.2 486.4 282 250.2c-9.4-9.4-24.6-9.4-33.9 0L64.4 433.9c-9.4 9.4-9.4 24.6 0 33.9l464.6 464.6c9.4 9.4 24.6 9.4 33.9 0l330.7-330.8c9.4-9.4 9.4-24.6 0-33.9z"})],-1),s("p",{class:"empty-text"},"未找到相关图标",-1)])]))]))}}),zn=ln(wn,[["__scopeId","data-v-6dd1d407"]]),Ln=v({__name:"IconColor",setup(x){return(d,r)=>(p(),w(n(b),{size:16},{default:k(()=>[t(n(o),{component:n(h),style:{"font-size":"24px",color:"#1677ff"}},null,8,["component"]),t(n(o),{component:n(h),style:{"font-size":"24px",color:"#52c41a"}},null,8,["component"]),t(n(o),{component:n(h),style:{"font-size":"24px",color:"#faad14"}},null,8,["component"]),t(n(o),{component:n(h),style:{"font-size":"24px",color:"#ff4d4f"}},null,8,["component"]),t(n(o),{component:n(h),style:{"font-size":"24px",color:"#722ed1"}},null,8,["component"])]),_:1}))}}),Dn=`<template>
  <Space :size="16">
...
<\/script>
`,Bn=v({__name:"IconSpin",setup(x){return(d,r)=>(p(),w(n(b),{size:16},{default:k(()=>[t(n(o),{component:n(A),style:{"font-size":"24px"},spin:""},null,8,["component"]),t(n(o),{component:n(H),style:{"font-size":"24px"},spin:""},null,8,["component"])]),_:1}))}}),Fn=`<template>
  <Space :size="16">
