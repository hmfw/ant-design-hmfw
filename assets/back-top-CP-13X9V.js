import{o as y,L as D,N as E,E as v,x as H,w as N,n as a,c as F,f as L,A as p,k as m,h as s,F as k,G as T,J as w,K as u,R as x,H as A,l as _}from"./index-DJdGgqDu.js";import{I as M}from"./Icon-B3Sy0DYw.js";import{U as $}from"./UpOutlined-WMhYm-4q.js";import{c as q}from"./cls-S9IiI6wd.js";function I(t){let n=null;const d=function(...o){n===null&&(n=requestAnimationFrame(()=>{t.apply(this,o),n=null}))};return d.cancel=()=>{n!==null&&(cancelAnimationFrame(n),n=null)},d}function S(t){return typeof window>"u"||!t?0:t===window||t.window===t?t.pageYOffset:t instanceof Document?t.documentElement.scrollTop:t instanceof HTMLElement?t.scrollTop:0}function R(t,n,d,o){const e=d-n;return t/=o/2,t<1?e/2*t*t*t+n:(t-=2,e/2*(t*t*t+2)+n)}function O(t,n={}){const{getContainer:d=()=>window,duration:o=450,callback:e}=n,i=d(),b=S(i),f=Date.now();let c;const h=()=>{const g=Date.now()-f,r=R(g>o?o:g,b,t,o);i===window||i.window===i?i.scrollTo(window.pageXOffset,r):i instanceof Document?i.documentElement.scrollTop=r:i instanceof HTMLElement&&(i.scrollTop=r),g<o?c=requestAnimationFrame(h):e&&e()};return c=requestAnimationFrame(h),()=>{cancelAnimationFrame(c)}}const B=y({name:"BackTop",props:{visibilityHeight:{type:Number,default:400},target:Function,duration:{type:Number,default:450},className:String,rootClassName:String,style:[String,Object],prefixCls:String},emits:["click"],setup(t,{slots:n,emit:d}){const o=D(),e=t.prefixCls||E("back-top"),i=v(t.visibilityHeight===0),b=v(),f=()=>{var r;return((r=b.value)==null?void 0:r.ownerDocument)||window},c=I(r=>{const l=S(r.target);i.value=l>=t.visibilityHeight}),h=r=>{const l=t.target||f;O(0,{getContainer:l,duration:t.duration}),d("click",r)};H(()=>{const l=(t.target||f)();c({target:l}),l==null||l.addEventListener("scroll",c)}),N(()=>{const l=(t.target||f)();c.cancel(),l==null||l.removeEventListener("scroll",c)});const C=L(()=>q(e,{[`${e}-rtl`]:o.value.direction==="rtl"},t.className,t.rootClassName)),g=()=>a("div",{class:`${e}-content`},[a("div",{class:`${e}-icon`},[a(M,{component:$},null)])]);return()=>a("div",{ref:b,class:C.value,style:t.style,onClick:h},[a(F,{name:"hmfw-fade"},{default:()=>{var r;return[i.value&&(((r=n.default)==null?void 0:r.call(n))||g())]}})])}}),z={style:{height:"1500px",padding:"20px",background:"linear-gradient(to bottom, #fff, #f0f0f0)"}},P=y({__name:"BackTopBasic",setup(t){return(n,d)=>(p(),m("div",z,[d[0]||(d[0]=s("p",{style:{"margin-bottom":"20px"}},"向下滚动页面，右下角会出现回到顶部按钮。",-1)),d[1]||(d[1]=s("p",{style:{"margin-bottom":"20px"}},"默认当页面滚动超过 400px 时显示。",-1)),(p(),m(k,null,T(50,o=>s("div",{key:o,style:{"margin-bottom":"10px"}},"内容行 "+w(o),1)),64)),a(u(B))]))}}),j=`<template>
