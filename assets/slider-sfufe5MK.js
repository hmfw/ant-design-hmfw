import{n as C,M as q,P as Z,m as i,D as b,e as Y,z as T,j as w,g as d,I as _,J as m,G as ee,k as F,Q as E,l as $}from"./index-BIkAb7lZ.js";import{c as B}from"./cls-S9IiI6wd.js";import{K as U}from"./event-CZUxRbwU.js";const h=C({name:"Slider",props:{value:[Number,Array],defaultValue:[Number,Array],min:{type:Number,default:0},max:{type:Number,default:100},step:{type:Number,default:1},disabled:Boolean,range:Boolean,vertical:Boolean,reverse:Boolean,marks:Object,tooltip:{type:Object},included:{type:Boolean,default:!0},dots:Boolean,keyboard:{type:Boolean,default:!0}},emits:["update:value","change","afterChange"],setup(e,{emit:s}){const l=q("slider"),x=b(null),t=b(null),o=b(null),p=n=>Math.min(e.max,Math.max(e.min,n)),R=n=>{if(e.range){const a=Array.isArray(n)?n:[e.min,e.min],[r,c]=a,v=p(r),f=p(c);return[Math.min(v,f),Math.max(v,f)]}return p(typeof n=="number"?n:e.min)},H=R(e.defaultValue??e.value??(e.range?[0,0]:0)),L=b(H),I=Y(()=>e.value!==void 0),k=Y(()=>{const n=I.value?e.value:L.value;return R(n)});Z(()=>e.value,n=>{n!==void 0&&(L.value=R(n))});const X=()=>e.marks?Object.keys(e.marks).map(Number).sort((n,a)=>n-a):[],j=n=>{if(e.step===null){const r=X();return[e.min,...r,e.max].reduce((f,y)=>Math.abs(y-n)<Math.abs(f-n)?y:f)}const a=Math.round((n-e.min)/e.step);return p(e.min+a*e.step)},P=n=>(n-e.min)/(e.max-e.min)*100,z=n=>{if(!x.value)return 0;const a=x.value.getBoundingClientRect(),r="touches"in n?n.touches[0].clientX:n.clientX,c="touches"in n?n.touches[0].clientY:n.clientY;let v;return e.vertical?v=e.reverse?(c-a.top)/a.height:1-(c-a.top)/a.height:v=e.reverse?1-(r-a.left)/a.width:(r-a.left)/a.width,v=Math.max(0,Math.min(1,v)),j(e.min+v*(e.max-e.min))},S=n=>{const a=R(n);L.value=a,s("update:value",a),s("change",a)},G=n=>{if(e.disabled)return;const a=z(n);if(e.range){const[r,c]=k.value,v=Math.abs(a-r),f=Math.abs(a-c);v<=f?S([a,c]):S([r,a])}else S(a)},N=n=>a=>{if(e.disabled)return;a.preventDefault(),t.value=n,o.value=n;const r=v=>{const f=z(v);if(e.range){const[y,V]=k.value;S(n==="start"?[Math.min(f,V),V]:[y,Math.max(f,y)])}else S(f)},c=()=>{t.value=null,o.value=null,s("afterChange",k.value),document.removeEventListener("mousemove",r),document.removeEventListener("mouseup",c),document.removeEventListener("touchmove",r),document.removeEventListener("touchend",c)};document.addEventListener("mousemove",r),document.addEventListener("mouseup",c),document.addEventListener("touchmove",r),document.addEventListener("touchend",c)},D=n=>{var a,r;return((a=e.tooltip)==null?void 0:a.formatter)===null?null:(r=e.tooltip)!=null&&r.formatter?e.tooltip.formatter(n):String(n)},K=n=>{var a;return((a=e.tooltip)==null?void 0:a.open)!==void 0?e.tooltip.open:o.value===n},W=n=>a=>{if(e.disabled||!e.keyboard)return;const r=e.range?n==="start"?k.value[0]:k.value[1]:k.value;let c=0;const v=e.step===null?1:e.step;switch(a.key){case U.ARROW_RIGHT:case U.ARROW_UP:c=v;break;case U.ARROW_LEFT:case U.ARROW_DOWN:c=-v;break;case U.HOME:c=e.min-r;break;case U.END:c=e.max-r;break;default:return}a.preventDefault();const f=j(r+c);if(e.range){const[y,V]=k.value;S(n==="start"?[Math.min(f,V),V]:[y,Math.max(f,y)])}else S(f)};return()=>{const n=k.value,a=e.range?n[0]:n,r=e.range?n[1]:n,c=P(a),v=P(r),f=e.vertical?e.included?{bottom:`${e.range?c:0}%`,height:`${e.range?v-c:v}%`}:{}:e.included?{left:`${e.range?c:0}%`,width:`${e.range?v-c:v}%`}:{},y=e.marks?Object.entries(e.marks).map(([u,g])=>({value:Number(u),label:typeof g=="string"?g:g.label,style:typeof g=="object"&&g.style?g.style:void 0})):[],V=[];if(e.dots&&e.step!==null&&e.step>0)for(let u=e.min;u<=e.max;u+=e.step)V.push(u);const J=u=>{if(!e.disabled)if(e.range){const[g,M]=k.value,O=Math.abs(u-g),A=Math.abs(u-M);O<=A?S([u,M]):S([g,u])}else S(u)};return i("div",{class:B(l,{[`${l}-disabled`]:e.disabled,[`${l}-vertical`]:e.vertical,[`${l}-with-marks`]:y.length>0})},[i("div",{ref:x,class:`${l}-rail`,onClick:G},[i("div",{class:`${l}-track`,style:f},null),y.map(({value:u})=>{const g=P(u),M=e.vertical?{bottom:`${g}%`}:{left:`${g}%`};return i("span",{key:u,class:B(`${l}-dot`,{[`${l}-dot-active`]:e.range?u>=a&&u<=r:u<=r}),style:M},null)}),V.map(u=>{const g=P(u),M=e.vertical?{bottom:`${g}%`}:{left:`${g}%`};return i("span",{key:u,class:B(`${l}-dot`,{[`${l}-dot-active`]:e.range?u>=a&&u<=r:u<=r}),style:M},null)}),e.range&&i("div",{class:B(`${l}-handle`,`${l}-handle-1`,{[`${l}-handle-dragging`]:t.value==="start"}),style:e.vertical?{bottom:`${c}%`}:{left:`${c}%`},role:"slider","aria-label":"最小值","aria-orientation":e.vertical?"vertical":"horizontal","aria-valuemin":e.min,"aria-valuemax":r,"aria-valuenow":a,"aria-disabled":e.disabled,tabindex:e.disabled?-1:0,onMousedown:N("start"),onTouchstart:N("start"),onMouseenter:()=>{o.value="start"},onMouseleave:()=>{t.value!=="start"&&(o.value=null)},onKeydown:W("start")},[K("start")&&D(a)!==null&&i("div",{class:`${l}-tooltip`},[D(a)])]),i("div",{class:B(`${l}-handle`,e.range?`${l}-handle-2`:"",{[`${l}-handle-dragging`]:t.value==="end"||!e.range&&t.value!==null}),style:e.vertical?{bottom:`${v}%`}:{left:`${v}%`},role:"slider","aria-label":e.range?"最大值":"滑块","aria-orientation":e.vertical?"vertical":"horizontal","aria-valuemin":e.range?a:e.min,"aria-valuemax":e.max,"aria-valuenow":r,"aria-disabled":e.disabled,tabindex:e.disabled?-1:0,onMousedown:N((e.range,"end")),onTouchstart:N((e.range,"end")),onMouseenter:()=>{o.value="end"},onMouseleave:()=>{t.value!=="end"&&(o.value=null)},onKeydown:W(e.range?"end":"start")},[K("end")&&D(r)!==null&&i("div",{class:`${l}-tooltip`},[D(r)])])]),y.length>0&&i("div",{class:`${l}-mark`},[y.map(({value:u,label:g,style:M})=>{const O=P(u),A=e.vertical?{bottom:`${O}%`}:{left:`${O}%`},Q=M?{...A,...M}:A;return i("span",{key:u,class:B(`${l}-mark-text`,{[`${l}-mark-text-active`]:e.range?u>=a&&u<=r:u<=r}),style:Q,onClick:()=>J(u)},[g])})])])}}}),te={style:{display:"flex","flex-direction":"column",gap:"24px",padding:"0 16px"}},ne={style:{"margin-bottom":"8px"}},le=C({__name:"SliderBasic",setup(e){const s=b(30),l=b(50);return(x,t)=>(T(),w("div",te,[d("div",null,[d("p",ne,"基础滑块："+_(s.value),1),i(m(h),{value:s.value,"onUpdate:value":t[0]||(t[0]=o=>s.value=o)},null,8,["value"])]),d("div",null,[t[2]||(t[2]=d("p",{style:{"margin-bottom":"8px"}},"禁用状态：",-1)),i(m(h),{value:l.value,"onUpdate:value":t[1]||(t[1]=o=>l.value=o),disabled:""},null,8,["value"])])]))}}),ae=`<template>
...
const value3 = ref(70)
<\/script>
`,Ve={style:{display:"flex",gap:"48px",padding:"0 16px"}},Ce={style:{height:"300px"}},Te={style:{"margin-bottom":"8px"}},we={style:{height:"300px"}},Ee={style:{"margin-bottom":"8px"}},Be=C({__name:"SliderVertical",setup(e){const s=b(30),l=b([20,50]);return(x,t)=>(T(),w("div",Ve,[d("div",Ce,[d("p",Te,"垂直滑块："+_(s.value),1),i(m(h),{value:s.value,"onUpdate:value":t[0]||(t[0]=o=>s.value=o),vertical:""},null,8,["value"])]),d("div",we,[d("p",Ee,"垂直范围选择："+_(l.value),1),i(m(h),{value:l.value,"onUpdate:value":t[1]||(t[1]=o=>l.value=o),vertical:"",range:"",step:10},null,8,["value"])])]))}}),Ue=`<template>
