import{I as f,T as v,a as I,b as q}from"./Input-fgyoHGwZ.js";import{d as y,o as g,b as k,c as a,e as s,r as d,f as e,w as x,g as b,A as S,K as E,_ as N,h as U,i as P}from"./index-DZWA4HiS.js";import{S as C}from"./Space-DxoCbPXb.js";import{C as W}from"./CloseCircleOutlined-D59UmevV.js";import{S as A}from"./SearchOutlined-ChywRtum.js";import{U as V}from"./UserOutlined-DNkh_kwG.js";import"./cls-S9IiI6wd.js";import"./CloseOutlined-Kr3orOYj.js";import"./LoadingOutlined-_M72e6LV.js";const z={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"400px"}},$=y({__name:"InputAddon",setup(h){const p=d(""),u=d(""),r=d("");return(t,l)=>(g(),k("div",z,[a(s(f),{value:p.value,"onUpdate:value":l[0]||(l[0]=i=>p.value=i),placeholder:"请输入用户名",prefix:"👤"},null,8,["value"]),a(s(f),{value:u.value,"onUpdate:value":l[1]||(l[1]=i=>u.value=i),placeholder:"请输入金额",prefix:"¥",suffix:"元"},null,8,["value"]),a(s(f),{value:r.value,"onUpdate:value":l[2]||(l[2]=i=>r.value=i),placeholder:"支持清除","allow-clear":""},null,8,["value"])]))}}),B=`<template>
...
const value4 = ref('')
<\/script>
`,O={class:"input-advanced-demo"},R={key:0,style:{padding:"8px",background:"#f0f9ff","border-radius":"4px"}},F=y({__name:"InputAdvanced",setup(h){const p=d(""),u=d(""),r=d(""),t=d(""),l=d(0),i=m=>{!m.ctrlKey&&!m.metaKey&&!m.shiftKey&&l.value++};return(m,n)=>(g(),k("div",O,[n[6]||(n[6]=e("h4",null,"细粒度样式控制（classNames / styles）",-1)),a(s(C),{direction:"vertical",style:{width:"100%","max-width":"400px"}},{default:x(()=>[a(s(f),{value:p.value,"onUpdate:value":n[0]||(n[0]=o=>p.value=o),placeholder:"自定义样式的 Input","class-names":{affixWrapper:"custom-wrapper",input:"custom-input",prefix:"custom-prefix",suffix:"custom-suffix"},styles:{affixWrapper:{border:"2px solid #1890ff",borderRadius:"8px"},input:{color:"#1890ff",fontWeight:"bold"}},prefix:"🔍",suffix:"✨"},null,8,["value"]),a(s(f),{value:u.value,"onUpdate:value":n[1]||(n[1]=o=>u.value=o),placeholder:"带字符计数","max-length":50,"show-count":!0,"class-names":{count:"custom-count"},styles:{count:{color:"#52c41a",fontWeight:"bold"}}},null,8,["value"])]),_:1}),n[7]||(n[7]=e("h4",{style:{"margin-top":"32px"}},"TextArea 按键事件",-1)),a(s(C),{direction:"vertical",style:{width:"100%","max-width":"400px"}},{default:x(()=>[a(s(v),{value:r.value,"onUpdate:value":n[2]||(n[2]=o=>r.value=o),placeholder:"按 Enter 键触发事件（可以用 Ctrl+Enter 换行）",rows:4,onPressEnter:i},null,8,["value"]),l.value>0?(g(),k("div",R,[e("span",null,[n[4]||(n[4]=b("Enter 键被按下了 ",-1)),e("strong",null,S(l.value),1),n[5]||(n[5]=b(" 次",-1))])])):E("",!0)]),_:1}),n[8]||(n[8]=e("h4",{style:{"margin-top":"32px"}},"TextArea 自定义样式",-1)),a(s(v),{value:t.value,"onUpdate:value":n[3]||(n[3]=o=>t.value=o),placeholder:"带样式的 TextArea",rows:3,"show-count":!0,"max-length":200,"class-names":{textarea:"custom-textarea",count:"custom-count"},styles:{textarea:{borderColor:"#722ed1",borderRadius:"8px"},count:{color:"#722ed1",fontSize:"14px"}}},null,8,["value"])]))}}),D=N(F,[["__scopeId","data-v-d7a03139"]]),K=`<template>
...
`,L={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"400px"}},M=y({__name:"InputBasic",setup(h){const p=d("");return(u,r)=>(g(),k("div",L,[a(s(f),{value:p.value,"onUpdate:value":r[0]||(r[0]=t=>p.value=t),placeholder:"请输入内容"},null,8,["value"]),a(s(f),{value:p.value,"onUpdate:value":r[1]||(r[1]=t=>p.value=t),placeholder:"禁用状态",disabled:""},null,8,["value"]),a(s(f),{value:p.value,"onUpdate:value":r[2]||(r[2]=t=>p.value=t),placeholder:"只读状态",readonly:""},null,8,["value"]),e("p",null,"当前值："+S(p.value),1)]))}}),j=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; max-width: 400px">
...
const value = ref('')
<\/script>
`,G={style:{display:"flex","flex-direction":"column",gap:"20px"}},H=y({__name:"InputClassNames",setup(h){const p=d(""),u=d(""),r=d(""),t=d(""),l=d(""),i=d("");return(m,n)=>(g(),k("div",G,[e("div",null,[n[6]||(n[6]=e("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义前缀和后缀图标样式：",-1)),a(s(f),{value:p.value,"onUpdate:value":n[0]||(n[0]=o=>p.value=o),placeholder:"搜索内容",prefix:s(A),suffix:s(W),"class-names":{prefix:"custom-prefix",suffix:"custom-suffix"},style:{width:"300px"}},null,8,["value","prefix","suffix"])]),e("div",null,[n[7]||(n[7]=e("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义输入框样式：",-1)),a(s(f),{value:u.value,"onUpdate:value":n[1]||(n[1]=o=>u.value=o),placeholder:"特殊样式输入框","class-names":{input:"custom-input"},style:{width:"300px"}},null,8,["value"])]),e("div",null,[n[8]||(n[8]=e("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义外层容器样式：",-1)),a(s(f),{value:r.value,"onUpdate:value":n[2]||(n[2]=o=>r.value=o),placeholder:"渐变边框",prefix:s(V),"class-names":{affixWrapper:"custom-wrapper"},style:{width:"300px"}},null,8,["value","prefix"])]),e("div",null,[n[9]||(n[9]=e("div",{style:{"margin-bottom":"8px",color:"#666"}},"自定义字数统计样式：",-1)),a(s(f),{value:t.value,"onUpdate:value":n[3]||(n[3]=o=>t.value=o),placeholder:"最多 50 字","max-length":50,"show-count":"","class-names":{count:"custom-count"},style:{width:"300px"}},null,8,["value"])]),e("div",null,[n[10]||(n[10]=e("div",{style:{"margin-bottom":"8px",color:"#666"}},"使用内联样式（styles）：",-1)),a(s(f),{value:l.value,"onUpdate:value":n[4]||(n[4]=o=>l.value=o),placeholder:"内联样式控制",prefix:s(A),styles:{affixWrapper:{borderColor:"#722ed1",borderRadius:"8px"},prefix:{color:"#722ed1",fontSize:"16px"},input:{fontWeight:"500"}},style:{width:"300px"}},null,8,["value","prefix"])]),e("div",null,[n[11]||(n[11]=e("div",{style:{"margin-bottom":"8px",color:"#666"}},"TextArea 自定义样式：",-1)),a(s(v),{value:i.value,"onUpdate:value":n[5]||(n[5]=o=>i.value=o),placeholder:"多行文本输入",rows:4,"max-length":200,"show-count":"","class-names":{textarea:"custom-textarea",count:"custom-textarea-count"},style:{width:"400px"}},null,8,["value"])])]))}}),J=N(H,[["__scopeId","data-v-cc1c8761"]]),Q=`<template>
...
`,X={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"400px"}},Y=y({__name:"InputPassword",setup(h){const p=d(""),u=d("");return(r,t)=>(g(),k("div",X,[a(s(I),{value:p.value,"onUpdate:value":t[0]||(t[0]=l=>p.value=l),placeholder:"请输入密码"},null,8,["value"]),a(s(I),{value:u.value,"onUpdate:value":t[1]||(t[1]=l=>u.value=l),placeholder:"不可切换可见性","visibility-toggle":!1},null,8,["value"]),e("p",null,"密码："+S(p.value),1)]))}}),Z=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; max-width: 400px">
...
const password2 = ref('')
<\/script>
`,_={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"400px"}},tt=y({__name:"InputSearch",setup(h){const p=d(""),u=d(""),r=d(""),t=d(!1),l=m=>{console.log("搜索：",m)},i=m=>{t.value=!0,setTimeout(()=>{t.value=!1,console.log("搜索完成：",m)},1500)};return(m,n)=>(g(),k("div",_,[a(s(q),{value:p.value,"onUpdate:value":n[0]||(n[0]=o=>p.value=o),placeholder:"请输入搜索内容",onSearch:l},null,8,["value"]),a(s(q),{value:u.value,"onUpdate:value":n[1]||(n[1]=o=>u.value=o),placeholder:"带按钮的搜索框","enter-button":"",onSearch:l},null,8,["value"]),a(s(q),{value:r.value,"onUpdate:value":n[2]||(n[2]=o=>r.value=o),placeholder:"加载中","enter-button":"",loading:t.value,onSearch:i},null,8,["value","loading"])]))}}),nt=`<template>
  <div style="display: flex; flex-direction: column; gap: 16px; max-width: 400px">
...
<\/script>
`,at={style:{display:"flex","flex-direction":"column",gap:"16px","max-width":"600px"}},et=y({__name:"InputTextArea",setup(h){const p=d(""),u=d(""),r=d(`第一行
第二行
第三行`),t=d(""),l=d("测试"),i=d(""),m=d("");return(n,o)=>(g(),k("div",at,[a(s(v),{value:p.value,"onUpdate:value":o[0]||(o[0]=c=>p.value=c),placeholder:"基础文本域，固定 4 行",rows:4},null,8,["value"]),a(s(v),{value:u.value,"onUpdate:value":o[1]||(o[1]=c=>u.value=c),placeholder:"自适应高度（内容变化时自动调整）","auto-size":""},null,8,["value"]),a(s(v),{value:r.value,"onUpdate:value":o[2]||(o[2]=c=>r.value=c),placeholder:"限制高度：最少 2 行，最多 6 行","auto-size":{minRows:2,maxRows:6}},null,8,["value"]),a(s(v),{value:t.value,"onUpdate:value":o[3]||(o[3]=c=>t.value=c),placeholder:"显示字符计数",maxlength:100,"show-count":""},null,8,["value"]),a(s(v),{value:l.value,"onUpdate:value":o[4]||(o[4]=c=>l.value=c),placeholder:"按字节计数（中文算2字符，最多20字节）",count:{show:!0,max:20,strategy:c=>c.split("").reduce((w,T)=>w+(T.charCodeAt(0)>255?2:1),0)}},null,8,["value","count"]),a(s(v),{value:i.value,"onUpdate:value":o[5]||(o[5]=c=>i.value=c),placeholder:"自定义计数显示格式",count:{show:!0,max:50,showFormatter:({count:c,maxLength:w})=>`已输入 ${c} / ${w} 字符`}},null,8,["value","count"]),a(s(v),{value:m.value,"onUpdate:value":o[6]||(o[6]=c=>m.value=c),placeholder:"组合功能：自适应高度 + 字符计数 + 清除按钮","auto-size":"","show-count":"","allow-clear":"",maxlength:200},null,8,["value"])]))}}),st=`<template>
...
</code></pre><p><strong>count 使用示例：</strong></p><pre class="language-vue"><code class="language-vue">&lt;!-- 按字节数计数（中文算2字符） --&gt;
&lt;TextArea
  :count=&quot;{
    show: true,
    max: 20,
