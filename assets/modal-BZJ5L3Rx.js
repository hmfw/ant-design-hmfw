import{B as r}from"./Button-DUAUyor1.js";import{M as i}from"./index-BYgvuhOQ.js";import{d as v,o as m,b as g,F as y,c as t,e,w as o,g as l,f as p,r as b,_ as M,A as w,v as x,h as C,i as h}from"./index-D624MvcT.js";import"./cls-S9IiI6wd.js";import"./LoadingOutlined-YZYQjBMp.js";import"./index-CNWFrspi.js";import"./CloseOutlined-BVCBReO7.js";import"./ExclamationCircleFilled-BTPTYg5w.js";import"./CheckCircleFilled-1JMJDz9z.js";import"./CloseCircleFilled-BkPSf2w8.js";import"./InfoCircleFilled-DcG4HFtO.js";const B=v({__name:"ModalBasic",setup(f){const a=b(!1);function u(){console.log("确认"),a.value=!1}function c(){console.log("取消"),a.value=!1}return(n,s)=>(m(),g(y,null,[t(e(r),{onClick:s[0]||(s[0]=d=>a.value=!0)},{default:o(()=>[...s[2]||(s[2]=[l("打开对话框",-1)])]),_:1}),t(e(i),{open:a.value,"onUpdate:open":s[1]||(s[1]=d=>a.value=d),title:"基础对话框",onOk:u,onCancel:c},{default:o(()=>[...s[3]||(s[3]=[p("p",null,"对话框内容",-1),p("p",null,"对话框内容",-1),p("p",null,"对话框内容",-1)])]),_:1},8,["open"])],64))}}),N=`<template>
...
`,E=v({__name:"ModalConfirm",setup(f){function a(){i.confirm({title:"确认删除？",content:"该操作不可撤销。",okType:"danger",onOk:()=>{console.log("OK")},onCancel:()=>{console.log("Cancel")}})}function u(){i.info({title:"提示",content:"这是一条信息。"})}function c(){i.success({title:"操作成功",content:"保存完成。"})}function n(){i.error({title:"操作失败",content:"请重试。"})}function s(){i.warning({title:"注意",content:"即将关闭。"})}function d(){i.confirm({title:"提交中？",content:"OK 按钮会显示 loading 直到 Promise resolve。",onOk:()=>new Promise(q=>setTimeout(q,1500))})}return(q,k)=>(m(),g(y,null,[t(e(r),{onClick:a},{default:o(()=>[...k[0]||(k[0]=[l(" 删除项目 ",-1)])]),_:1}),t(e(r),{onClick:u},{default:o(()=>[...k[1]||(k[1]=[l(" 提示信息 ",-1)])]),_:1}),t(e(r),{onClick:c},{default:o(()=>[...k[2]||(k[2]=[l(" 成功 ",-1)])]),_:1}),t(e(r),{onClick:n},{default:o(()=>[...k[3]||(k[3]=[l(" 错误 ",-1)])]),_:1}),t(e(r),{onClick:s},{default:o(()=>[...k[4]||(k[4]=[l(" 警告 ",-1)])]),_:1}),t(e(r),{onClick:d},{default:o(()=>[...k[5]||(k[5]=[l(" 异步确认 ",-1)])]),_:1})],64))}}),R=`<template>
...
<\/script>
`,I=v({__name:"ModalCustomFooter",setup(f){const a=b(!1),u=b(!1),c=b("内容将在两秒后更新");function n(){c.value="正在提交...",u.value=!0,setTimeout(()=>{a.value=!1,u.value=!1},2e3)}return(s,d)=>(m(),g(y,null,[t(e(r),{onClick:d[0]||(d[0]=q=>a.value=!0)},{default:o(()=>[...d[3]||(d[3]=[l("打开对话框",-1)])]),_:1}),t(e(i),{open:a.value,"onUpdate:open":d[2]||(d[2]=q=>a.value=q),title:"自定义页脚","confirm-loading":u.value,onOk:n},{footer:o(()=>[t(e(r),{onClick:d[1]||(d[1]=q=>a.value=!1)},{default:o(()=>[...d[4]||(d[4]=[l("取消",-1)])]),_:1}),t(e(r),{onClick:n},{default:o(()=>[...d[5]||(d[5]=[l("确认",-1)])]),_:1})]),default:o(()=>[p("p",null,w(c.value),1)]),_:1},8,["open","confirm-loading"])],64))}}),$=`<template>
  <Button @click="open = true">打开对话框</Button>
...
<\/script>
`,A=v({__name:"ModalCustomIcon",setup(f){function a(){i.info({title:"自定义图标",content:"这个对话框使用了自定义的 VNode 作为图标。",icon:x("span",{style:{fontSize:"24px",color:"#1890ff"}},"🎨")})}function u(){i.confirm({title:"无图标确认",content:"通过设置 icon 为 null 可以隐藏图标。",icon:null})}return(c,n)=>(m(),g(y,null,[t(e(r),{onClick:a},{default:o(()=>[...n[0]||(n[0]=[l(" 使用自定义 VNode 图标 ",-1)])]),_:1}),t(e(r),{onClick:u},{default:o(()=>[...n[1]||(n[1]=[l(" 隐藏图标 ",-1)])]),_:1})],64))}}),F=`<template>
...
<\/script>
`,_=v({__name:"ModalRender",setup(f){const a=b(!1);function u(n){return x("div",{style:{padding:"20px",background:"linear-gradient(135deg, #667eea 0%, #764ba2 100%)",borderRadius:"12px"}},[n])}function c(){console.log("确认"),a.value=!1}return(n,s)=>(m(),g(y,null,[t(e(r),{onClick:s[0]||(s[0]=d=>a.value=!0)},{default:o(()=>[...s[2]||(s[2]=[l(" 打开自定义容器 ",-1)])]),_:1}),t(e(i),{open:a.value,"onUpdate:open":s[1]||(s[1]=d=>a.value=d),title:"自定义渲染容器","modal-render":u,onOk:c},{default:o(()=>[...s[3]||(s[3]=[p("p",null,"这是对话框内容。",-1),p("p",null,"外层容器已通过 modalRender 自定义渲染。",-1)])]),_:1},8,["open"])],64))}}),z=`<template>
