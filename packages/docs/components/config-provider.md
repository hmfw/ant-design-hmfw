...
<script setup>
import ConfigProviderTheme from '../demos/config-provider/ConfigProviderTheme.vue'
import ConfigProviderThemeSource from '../demos/config-provider/ConfigProviderTheme.vue?raw'
import ConfigProviderLocale from '../demos/config-provider/ConfigProviderLocale.vue'
import ConfigProviderLocaleSource from '../demos/config-provider/ConfigProviderLocale.vue?raw'
import ConfigProviderSize from '../demos/config-provider/ConfigProviderSize.vue'
import ConfigProviderSizeSource from '../demos/config-provider/ConfigProviderSize.vue?raw'
</script>
